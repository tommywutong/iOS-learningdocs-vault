...
Discover how to use class inheritance to model your data. Learn how to optimize queries and seamlessly migrate your app's data to use...
...
- [Introduction](/videos/play/wwdc2025/291/?time=0)
- [Harness class inheritance](/videos/play/wwdc2025/291/?time=131)
- [Evolving data with migration](/videos/play/wwdc2025/291/?time=459)
- [Tailoring fetched data](/videos/play/wwdc2025/291/?time=687)
- [Observing changes to data](/videos/play/wwdc2025/291/?time=834)
- [Next steps](/videos/play/wwdc2025/291/?time=1108)

## Resources

- [Introduction](https://developer.apple.com/videos/play/wwdc2025/291/?time=0)
- [Harness class inheritance](https://developer.apple.com/videos/play/wwdc2025/291/?time=131)
- [Evolving data with migration](https://developer.apple.com/videos/play/wwdc2025/291/?time=459)
- [Tailoring fetched data](https://developer.apple.com/videos/play/wwdc2025/291/?time=687)
- [Observing changes to data](https://developer.apple.com/videos/play/wwdc2025/291/?time=834)
- [Next steps](https://developer.apple.com/videos/play/wwdc2025/291/?time=1108)
...
- [HD Video](https://devstreaming-cdn.apple.com/videos/wwdc/2025/291/4/446be11b-b8d3-42dd-b981-a22010ddbbe9/downloads/wwdc2025-291_hd.mp4?dl=1)
- [SD Video](https://devstreaming-cdn.apple.com/videos/wwdc/2025/291/4/446be11b-b8d3-42dd-b981-a22010ddbbe9/downloads/wwdc2025-291_sd.mp4?dl=1)
...
- [Import SwiftData and add @Model](https://developer.apple.com/videos/play/wwdc2025/291/?time=67)
- [Add modelContainer modifier](https://developer.apple.com/videos/play/wwdc2025/291/?time=78)
- [Adopt @Query](https://developer.apple.com/videos/play/wwdc2025/291/?time=90)
- [Add subclasses to Trip](https://developer.apple.com/videos/play/wwdc2025/291/?time=208)
- [Update modelContainer modifier](https://developer.apple.com/videos/play/wwdc2025/291/?time=243)
- [Add segmented control to drive a predicate to filter by Type](https://developer.apple.com/videos/play/wwdc2025/291/?time=426)
- [SampleTrips Versioned Schema 2.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=506)
- [SampleTrips Custom Migration Stage from Version 1.0 to 2.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=521)
- [SampleTrips Versioned Schema 3.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=549)
- [SampleTrips Custom Migration Stage from Version 2.0 to 3.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=573)
- [SampleTrips Versioned Schema 4.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=590)
- [SampleTrips Lightweight Migration Stage from Version 3.0 to 4.0](https://developer.apple.com/videos/play/wwdc2025/291/?time=603)
- [SampleTrips Schema Migration Plan](https://developer.apple.com/videos/play/wwdc2025/291/?time=624)
- [Use Schema Migration Plan with ModelContainer](https://developer.apple.com/videos/play/wwdc2025/291/?time=651)
- [Add search predicate to Query](https://developer.apple.com/videos/play/wwdc2025/291/?time=708)
- [Tailor SwiftData Fetch in Custom Migration Stage](https://developer.apple.com/videos/play/wwdc2025/291/?time=751)
- [Add relationshipsToPrefetch in Custom Migration Stage](https://developer.apple.com/videos/play/wwdc2025/291/?time=791)
- [Update Widget to harness fetchLimit](https://developer.apple.com/videos/play/wwdc2025/291/?time=808)
- [Fetch the last transaction efficiently](https://developer.apple.com/videos/play/wwdc2025/291/?time=984)
- [Fetch History after the given token and only for the entities of concern](https://developer.apple.com/videos/play/wwdc2025/291/?time=1049)
...
Hello, my name is Rishi Verma, and I’m an engineer on the SwiftData team. And I would like to welcome you to “SwiftData: Dive into inheritance and schema migration.” SwiftData was introduced in iOS 17 and allows you to model and persist your app’s data in Swift across all of Apple's platforms. It lets you write code that is fast, efficient, and safe by harnessing modern Swift language features.
