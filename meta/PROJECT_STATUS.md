...
**归档主体已经完成，翻译只完成了一部分。** Claude 会话中断前留下的 36 篇
Apple 文档译文已恢复，当前 441 篇 Apple 译文全部通过机械校验；这 36 篇尚未经过
另一名 AI 的独立语言审校，因此属于“结构与代码已验收、语言质量待抽查”的状态。
...
| 来源 | 已归档 | 当前中文状态 |
|---|---:|---:|
| Apple 现行文档 | 95,634 页，其中成篇文章 3,746 篇 | 441 篇译文 |
...
| 来源 | 需译 | 已译 | 待译 | 待译字符 |
|---|---:|---:|---:|---:|
| Apple 现行文档 | 3,746 | 441 | 3,305 | 17,343,547 |
| WWDC | 178 | 23 | 155 | 4,378,813 |
| 英文博客 | 2,263 | 61 | 2,202 | 25,177,241 |
| **合计** | **6,187** | **525** | **5,662** | — |

这里的 525 只统计“英文文件旁边存在同路径中文译文”，不包含 681 篇原生中文博客。
...
| 部分 | 待译 | 待译字符 |
|---|---:|---:|
| core Apple 文档 + WWDC | 2,056 篇 | 12,412,033 |
| 第三方英文博客（排除 objc.io 149 篇） | 2,053 篇 | 22,404,127 |
| **A 方案合计** | **4,109 篇** | **34,816,160** |
