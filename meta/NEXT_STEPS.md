...
| 优先级 | 内容 | 待译 | 字符 | 状态 |
|---|---|---:|---:|---|
| B0 | 暑期计划点名的高价值英文博客 | 41 | 666,822 | 下一步 |
| O1 | 暑期计划点名的 Apple 现行文档 | 24 | 280,211 | B0 后执行 |
| O2 | 暑期计划点名的 WWDC | 4 | 139,289 | O1 后执行 |
| — | **合计** | **69** | **1,086,322** | 待执行 |
...
验收后提交一个或两个 PR。优先保证技术术语和源码描述准确，不追求一次塞入全部 19 篇。
...
当前 69 篇共 1,086,322 个英文字符。根据 `core-r03` / `core-r04-all` 的真实调用记录：

- 预计模型 Token：约 440 万；
- 给博客长文、Pro 审校和失败重试留余量：440–550 万；
- DeepSeek API 费用外推：约 1.2–2 美元。
...
| — | `summer-b0-r01` | 高价值博客第一轮 | — | — | — | 下一步 |

## 7. 完成定义

69 篇白名单完成并通过三道质量关后，本轮项目即完成。仓库中仍有数千篇英文资料没有中文
版属于预期状态，不再作为“欠账”。
