...
1. 合并本轮 B1 补强与 36 篇补审 PR 后，在 `main` 重跑全仓校验和链接检查；
2. 审核 WWDC Session 416 幻灯片样板；仓库必须保持私有；
...
关键词或目录前缀替代白名单。当前调度器已支持 `summer`、`summer-b1` 和
`legacy-review` 三个显式范围。
...
0.1579 美元。新增译文与补审合计估算 1.5923 美元。
...
| 2026-07-28 | `summer-b1-r01` | 高价值博客补强 | 32 | DeepSeek Pro 独立审校 | 博客 134 / 134 | 本轮 PR |
| 2026-07-28 | `legacy-review-r01` | 最早恢复的 Apple 译文 | 0（补审 36） | 36 / 36，35 篇修改 | Apple 991 / 991 | 本轮 PR |

## 7. 完成定义

101 篇白名单已经通过三道质量关，36 篇早期译文的独立审校质量债也已清零，本轮项目完成。
