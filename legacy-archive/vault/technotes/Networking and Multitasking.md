---
title: Networking and Multitasking
apple_id: DTS40010841
...
archived_at: '2026-07-26T19:54:10.049428Z'
---
...
[Introduction](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjukq2ujfhu4mi)[The Basics](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjukq2ujfhu4mq)[Listening Socket](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyza)[Data Socket](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyzq)[Higher-Level APIs](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjy2a)[Implementation Details](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjukq2ujfhu4nq)[Beware of the Dog!](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjy3a)[Concurrency](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjy3q)[Run Loops](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjy4a)[Testing Socket Reclaim](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjy4q)[Beyond The Basics](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjukq2ujfhu4mjr)[Background Tasks](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyytc)[Resumable Transfers](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyyte)[Multitasking Superpowers](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjukq2ujfhu4mju)[Background Execution](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyyti)[VoIP Sockets](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewugsbrfvjvkqstivbviskpjyytk)[Document Revision History](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaytaobugewvezlwnfzws33ojbuxg5dpoj4s2rdpnz2ey2lonncwyzlnmvxhiskel4yq)
...
Before going any further, you should familiarize yourself with the iOS app lifecycle, as described in the [iOS Application Programming Guide](https://developer.apple.com/library/ios/#documentation/iPhone/Conceptual/iPhoneOSProgrammingGuide/Introduction/Introduction.html). Specifically, this technote uses the terms __foreground__, __background__ and __suspended__ in the technical sense defined in that document.

Finally, the bulk of this technote is aimed at developers who are creating apps that have no special multitasking capabilities. However, if your app fits into one of the multitasking categories described in the [iOS Application Programming Guide](https://developer.apple.com/library/ios/#documentation/iPhone/Conceptual/iPhoneOSProgrammingGuide/Introduction/Introduction.html), you should make sure to read the information in Multitasking Superpowers.
...
- __listening sockets__ — A listening socket is used to accept incoming TCP connections.
- __data sockets__ — A data socket is used to transfer data over the network. Data sockets typically represent a TCP connection or give you access to a UDP port.
...
__Note:__ To understand more about the watchdog, read [Technical Note TN2151, 'Understanding and Analyzing iPhone OS Application Crash Reports'](https://developer.apple.com/technotes/tn2008/tn2151.html) and [Technical Q&A QA1693, 'Synchronous Networking On The Main Thread'](https://developer.apple.com/qa/qa2010/qa1693.html).
...
Implementing resumable downloads is typically easy. If you're using HTTP, most servers support entity tags and byte ranges, the fundamental building blocks of resumable downloads. Moreover, it's easy to use these features from NSURLConnection. You should read the HTTP protocol specification ([RFC 2616](http://www.ietf.org/rfc/rfc2616.txt)) to learn more about these facilities.
...
CFFTPStream does not support resumable FTP uploads
(r. [4086998](rdar://problem/4086998))
. Then again, given FTP's poor security features (the user name, password and data are all transferred as plaintext) it's hard to imagine any use of FTP uploads that is suitable for the modern Internet.
...
For more information about how to create a VoIP app, see the [iOS Application Programming Guide](https://developer.apple.com/library/ios/#documentation/iPhone/Conceptual/iPhoneOSProgrammingGuide/Introduction/Introduction.html).
...
| __Date__ | __Notes__ |
| 2011-03-30 | New document that explains how best to handle multitasking in a network application. |
