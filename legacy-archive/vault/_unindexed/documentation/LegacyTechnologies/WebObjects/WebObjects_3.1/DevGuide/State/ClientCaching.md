...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.1/DevGuide/State/ClientCaching.html
archived_at: '2026-07-15T07:47:38.864735Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](ManagingState.book.md)
[!Previous Section](PageWithName.md)
...
Sometimes, however, you need to make sure the user is seeing the most up-to-date information, so you must disable client-side caching. WOApplication provides the __setPageRefreshOnBacktrackEnabled:__ method for this purpose. In general, you send this message in the __init__ method of your application script (__Application.wos__):
...
[!Table of Contents](ManagingState.book.md)
[!Next Section](WODisplayGroupAndRefresh.md)
