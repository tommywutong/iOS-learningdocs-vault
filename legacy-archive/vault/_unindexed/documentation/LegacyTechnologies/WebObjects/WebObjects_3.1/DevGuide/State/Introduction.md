...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.1/DevGuide/State/Introduction.html
archived_at: '2026-07-15T07:47:45.385316Z'
---
...
- Storing state information on the client's machine. With each transaction the client passes the state information back to the server, in effect "reminding" the server of the client's identity and the state information associated with that client. (This approach includes storing _state in the page_ and using _cookies_, as explained later in this chapter.)
...
- [When Do You Need to Store State?](WhenStore.md)
- [Objects and State](ObjectsAndState.md)
- [State Management and the Request-Response Loop](StateAndRRLoop.md)
- [State Storage Strategies](StorageStratsIntro.md)
- [Controlling Session State](ControllingSessionState.md)
- [Controlling Component State](ControllingComponentState.md)

[!Table of Contents](ManagingState.book.md)
[!Next Section](WhenStore.md)
