...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.1/Reference/WOFClasses/ObjC/Description.html
archived_at: '2026-07-15T07:49:50.726295Z'
---
...
The WebObjects Framework (installed in _NEXT_ROOT___/NextLibrary/Frameworks/WebObjects.framework__) helps you build dynamic server-side World Wide Web applications that can access standard relational databases.
...
To learn more about the concepts, architecture, and mechanisms of WebObjects, and particularly how the classes and interfaces of the WebObjects Framework fit together, see the [_WebObjects Developers Guide_](../../../DevGuide/DevGuide.md).
