...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.1/Reference/DynamicElements/WOGenericContainer.html
archived_at: '2026-07-15T07:49:39.696419Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](DynamicElements.book.md)
[!Previous Section](WOFrame.md)

---

# __WOGenericContainer__

### Synopsis

__WOGenericContainer__ __{__ __elementName__ = _`aConstantString`___;__ ... __};
...
[Support for unknown container elements](http://wofapps4.apple.com/cgi-bin/WebObjects-3/DynamicElements?ExamplePage=GenericContainerEx1)

[!Table of Contents](DynamicElements.book.md)
[!Next Section](WOGenericElement.md)
