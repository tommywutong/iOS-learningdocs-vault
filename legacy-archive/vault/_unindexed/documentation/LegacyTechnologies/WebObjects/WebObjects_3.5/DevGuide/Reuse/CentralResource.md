...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/Reuse/CentralResource.html
archived_at: '2026-07-15T07:52:03.467362Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](ReuseTOC.md) [!Previous Section](Benes.md)
...
Suppose you want to display a navigational control like the one shown in [Figure 27](#apple-giyti) at the bottom of each page of your application.
...
[!Table of Contents](ReuseTOC.md) [!Next Section](SimpleInterface.md)
