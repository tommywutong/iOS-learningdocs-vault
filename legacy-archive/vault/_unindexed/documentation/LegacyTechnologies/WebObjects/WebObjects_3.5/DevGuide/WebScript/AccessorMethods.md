...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/WebScript/AccessorMethods.html
archived_at: '2026-07-15T07:52:26.640040Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](WebScript.md) [!Previous Section](Messaging.md)
...
For example, the __Application.wos__ script in the Visitors example declares this instance variable, which keeps track of the number of visitors:
...
(You don't see these methods in the script file.) The __Main.wos__ script access the application's __visitorNum__ variable using these statements:
...
__Note:__  __self__ is a keyword that represents the current object. For more information, see ["Reserved Words"](ReservedWords.md#apple-ha4tsna).
...
[!Table of Contents](WebScript.md) [!Next Section](MessageToClass.md)
