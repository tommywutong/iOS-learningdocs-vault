...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/WebScript/ReservedWords.html
archived_at: '2026-07-15T07:52:33.782128Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](WebScript.md) [!Previous Section](StatementsOperators.md)
...
The __nil__ word represents an empty object. Any object before it is initialized has the value __nil__. __nil__ is similar to a null pointer in C. For example, to test whether an object has been allocated and initialized, you do this:
...
[!Table of Contents](WebScript.md) [!Next Section](ModernSyntax.md)
