...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/DynEl/Bindings.html
archived_at: '2026-07-15T07:51:27.618965Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](DynElTOC.md) [!Previous Section](HowServerSideWork.md)
...
In this case, WOComponent (Component in Java) defines the __application__ method, which returns the WOApplication object (WebApplication in Java).
...
For example, dictionary objects store key-value pairs. Suppose you declare a __person__ dictionary that has the keys __name__, __address__, and __phone__. These keys aren't really instance variables in the dictionary, but because WebObjects accesses values using key-value coding, the following binding works:
...
[!Table of Contents](DynElTOC.md) [!Next Section](DeclarationsFile.md)
