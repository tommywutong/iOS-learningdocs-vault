...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/WebScript/StatementsOperators.html
archived_at: '2026-07-15T07:52:34.744569Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](WebScript.md) [!Previous Section](DataTypes.md)
...
WebScript handles logical operators slightly differently from C. In C, Boolean expressions _short-circuit_. For example, in this statement:
...
In C, an expression is only evaluated up to the point where the outcome can be surmised. That is, if __!a__ is true, the other side of the || expression is not evaluated because the || operator only requires one side of the statement to be true. Likewise, if the && statement is evaluated and __a__ is false, the second half of the && expression is not evaluated because the && operator does require both sides to be true.
...
[!Table of Contents](WebScript.md) [!Next Section](ReservedWords.md)
