...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/DevGuide/Reuse/Intercom.html
archived_at: '2026-07-15T07:52:04.843432Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](ReuseTOC.md) [!Previous Section](SimpleInterface.md)
...
In the AlertPanel example shown in [Figure 28](SimpleInterface.md#apple-he4tg), you saw how the parent component, in its declarations file, sets the attributes of the child component:
...
Consider an AlertPanel component like the one described above, but with the added ability to accept user input and relay that input to a parent component. The panel might look like the one in [Figure 29](#apple-g42dq).
...
_Child's Template File (excerpt)_
...
_Child's Declarations File (excerpt)_
...
_Child's Script File (excerpt)_
...
[!Table of Contents](ReuseTOC.md) [!Next Section](Synchronize.md)
