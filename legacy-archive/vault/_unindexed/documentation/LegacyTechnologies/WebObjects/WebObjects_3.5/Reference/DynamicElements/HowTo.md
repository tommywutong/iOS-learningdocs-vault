...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/Reference/DynamicElements/HowTo.html
archived_at: '2026-07-15T07:55:19.660575Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](DynamicElementsTOC.md) [!Previous Section](DynamicElementsTOC.md)
...
- __Bold__ denotes words or characters that are to be taken literally (typed as they appear). For example, the __action__ and __value__ attributes are to be take literally in the synopsis above.
...
[!Table of Contents](DynamicElementsTOC.md) [!Next Section](WOActiveImage.md)
