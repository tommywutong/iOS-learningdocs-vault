...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/Reference/DynamicElements/WOImage.html
archived_at: '2026-07-15T07:55:27.838547Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](DynamicElementsTOC.md) [!Previous Section](WOHyperlink.md)

## WOImage

### Synopsis

__WOImage__ __{__ __src__=_aURL_ | __value__=_imageData___;__ | __filename__= _imageFileName___;__ [__framework__ = _frameworkBaseName_|__"app" ;__] ... __};__
...
[Shared image](http://localhost/cgi-bin/WebObjects/Examples/WebScript/DynamicElements?ExamplePage=ImagesEx1)

[Daily image](http://localhost/cgi-bin/WebObjects/Examples/WebScript/DynamicElements?ExamplePage=ImagesEx2)

[Image data from a file](http://localhost/cgi-bin/WebObjects/Examples/WebScript/DynamicElements?ExamplePage=ImagesEx3)

[!Table of Contents](DynamicElementsTOC.md) [!Next Section](WOImageButton.md)
