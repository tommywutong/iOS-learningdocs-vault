...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/GettingStarted/GuestBook/GuestBook12.html
archived_at: '2026-07-15T07:53:19.064937Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](GuestBookTOC.md) [!Previous Section](GuestBook11.md)
...
- In the object browser, click the __comments__ variable and drag the cursor into the Comments text area. Then release the mouse button.
  !
...
[!Table of Contents](GuestBookTOC.md) [!Next Section](GuestBook13.md)
