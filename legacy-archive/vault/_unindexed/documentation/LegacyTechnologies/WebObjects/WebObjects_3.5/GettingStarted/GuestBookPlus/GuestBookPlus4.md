...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/GettingStarted/GuestBookPlus/GuestBookPlus4.html
archived_at: '2026-07-15T07:53:55.787619Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](GuestBookPlusTOC.md) [!Previous Section](GuestBookPlus3.md)
...
__Note:__ It isn't necessary to adjust the height of the columns, since they expand at run time to accommodate the size of the text being displayed.

[!Table of Contents](GuestBookPlusTOC.md) [!Next Section](GuestBookPlus5.md)
