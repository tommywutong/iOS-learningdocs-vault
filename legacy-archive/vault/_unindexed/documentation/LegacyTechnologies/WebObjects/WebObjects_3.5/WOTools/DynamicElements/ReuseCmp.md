...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_3.5/WOTools/DynamicElements/ReuseCmp.htm
archived_at: '2026-07-15T07:56:41.971374Z'
---
> 导航：[总目录](../../../../../../../README.md) · 未编入索引的页面


[!Table of Contents](DynElTOC.md) [!Previous Section](WOApplet.md)
...
See ["Frameworks"](../SettingUp/Framewrk.md#apple-gu4tcnq) for information on creating frameworks and adding them to a project. To add a component directly to a project, you can:
...
- Use the toolbar to add a custom WebObject element (see ["Custom WebObjects"](CustomWO.md#apple-he3dsmi)) to your page, then use the Inspector to set its type to the name of the reusable component.
- Drag a component that has been stored on a palette to the component window (see ["Palettes"](../Editing/Pallette.md#apple-geytcnjv)).
...
__Note:__ When you create a component that is specifically designed to be used within other pages, specify "Partial document" in the Page Attributes Inspector popup list (see ["Setting Page Attributes"](../Editing/PgAttrib.md#apple-gu4dsni)). This way WebObjects Builder does not wrap <HTML>, <HEAD>, and <BODY> tags around your component.

For more information, see ["Reusable Components"](../../DevGuide/Reuse/ReuseTOC.md) in the _WebObjects Developer's Guide_.
