...
source_url: https://developer.apple.com/library/archive/documentation/DataManagement/Conceptual/CloudKitWebServicesReference/DiscoveringUserIdentities(usersdiscover).html
archived_at: '2026-07-15T07:23:32.251961Z'
---
...
| Key | Description |
| --- | --- |
| `lookupInfos` | An array of user identity lookup dictionaries, described in [User Identity Lookup Information Dictionary](Types.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge2tenbqfvbuqmznknltemi), specifying the users to fetch. |
