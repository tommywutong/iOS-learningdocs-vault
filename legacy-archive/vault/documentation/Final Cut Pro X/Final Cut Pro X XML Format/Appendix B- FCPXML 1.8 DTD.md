...
source_url: https://developer.apple.com/library/archive/documentation/FinalCutProX/Reference/FinalCutProXXMLFormat/FCPXMLDTD/FCPXMLDTD.html
archived_at: '2026-07-27T06:57:08.698376Z'
---
...
[Next](Document%20Revision%20History.md)[Previous](Appendix%20A-%20FCPXML%20Supported%20Identifiers.md)

# Appendix B: FCPXML 1.8 DTD

The following DTD applies to Final Cut Pro X XML Interchange Format 1.8.

__Note:__ Even though an imported FCPXML document matches this DTD, import errors may still occur due to invalid data. If the document does not match the DTD, Final Cut Pro X rejects the import operation completely.
