...
source_url: https://developer.apple.com/library/archive/documentation/HardwareDrivers/Conceptual/iMac_0609_SuperDrive/Articles/MiMac_arch.html
archived_at: '2026-07-15T07:41:14.538735Z'
---
...
This note describes the iMac with SuperDrive computers, introduced in September 2006, based on the Intel Core 2 Duo microprocessor. It includes information about distinguishing features of the computers, including components on the main logic board: the microprocessor, the other main ICs, and the buses that connect them to each other and to the I/O interfaces.

The iMac comes with Mac OS X version 10.4.7 installed.

The value of the 17-inch and 20-inch iMac model identifier string is `iMac5,1`.

The value of the 24-inch iMac model identifier string is `iMac6,1`.
...
![This block diagram shows the memory controller and I/O controller ICs and the buses that connect them on the main logic board. Each component in the block diagram is defined in text.](attachments/Art/060583011316_01.jpg)
...
- 17-inch iMac: 2.0 or configure-to-order 2.16 GHz dual-core processor
- 20-inch iMac: 2.16 or configure-to-order 2.33 GHz dual-core processor
- 24-inch iMac: 2.16 or configure-to-order 2.33 GHz dual-core processor
...
In the iMac, the South Bridge controller provides an Ultra ATA/100 interface to the slim slot drive, SuperDrive that operates at UATA/33. The drive can read and write CD media and read DVD media as shown in [Table 1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqga2dqmrxfvjvomq).

__Table 1__  Types of media read and written by the SuperDrive

| Media type | Reading speed | Writing speed |
| DVD+/-R | 6x (CAV max) | 8x, 4x, 2x, 1x (ZCLV) single-layer, depending on media |
| DVD+R DL | 6x (CAV max) | 2.4x (ZCLV) double-layer, depending on media |
| DVD-ROM | 8x DVD5 (CAV max); 6x DVD9 (CAV max) | – |
| DVD-RW | 8x (CAV max) | 4x, 2x, 1x (ZCLV) depending on media |
| DVD+RW | 6x (CAV max) | 4x, 2.4x (ZCLV) depending on media |
| CD-R | 24x (CAV max) | 24x PCAV (ZCLV) |
...
The 17-inch and 20-inch iMacs support two IEEE-1394a FireWire 400 ports at transfer rates of 100, 200, and 400 Mbps. The 24-inch iMac supports one IEEE-1394a FireWire 400 port at transfer rates of 100, 200, and 400 Mbps and one IEEE-1394b FireWire 800 port at transfer rates of 100, 200, 400, and 800 Mbps. For more information, see _[FireWire Developer Note](../FireWire%20Developer%20Note/Introduction%20to%20FireWire%20Developer%20Note.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqgaztamry)_.
