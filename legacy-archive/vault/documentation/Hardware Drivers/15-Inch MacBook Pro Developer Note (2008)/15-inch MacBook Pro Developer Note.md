...
source_url: https://developer.apple.com/library/archive/documentation/HardwareDrivers/Conceptual/15inMacBookPro_0802/Articles/ProductDeveloperNote.html
archived_at: '2026-07-15T07:40:55.647402Z'
---
...
This note describes the 15-inch MacBook Pro computers introduced in February 2008, incorporating the Intel Core 2 Duo processor on 45 nm process technology. This note includes information about distinguishing features of the computer, including components on the main logic board: the microprocessor, the other main ICs, and the buses that connect them to each other and to the I/O interfaces.
...
- USB 2.0 controller supporting: the Bluetooth module, IR receiver, built-in iSight camera, built-in trackpad and keyboard, ExpressCard 34 mm slot, and 2 high-powered, external USB 2.0 ports
...
[Figure 1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqga3tgnbyfvbegskhifaugsq) provides a simplified block diagram of the North Bridge and South Bridge and the buses that connect them together.

__Figure 1__  Block diagram

![This block diagram shows the memory controller and I/O controller ICs and the buses that connect them on the main logic board. Each component in the block diagram is defined in text.](attachments/Art/071178001313_01.jpg)

The 15-inch MacBook Pro computer includes a built-in iSight video camera and an integrated IR receiver. The Apple Remote is available separately. For a complete list of user-visible features, see the 15-inch MacBook Pro specification sheet at Apple's [Specifications](http://www.info.apple.com/support/applespec.html) site. Other features are described in this section.

The microprocessors in the 15-inch MacBook Pro are Intel Core 2 Duo processor on 45 nm process technology. The features are as follows:

- 2.4 GHz or 2.5 GHz microprocessors
- Optional 2.6 GHz microprocessor
- 6 MB shared L2 cache in 2.5 GHz or 2.6 GHz models
- 3 MB shared L2 cache in 2.4 GHz model
...
Depending on the configuration, the 15-inch MacBook Pro comes with a 200 GB or 250 GB 5400 rpm Serial ATA (SATA) Gen-I (1.5 Gbps) hard disk drive (optional: a 250 GB 5400 rpm or 200 GB 7200 rpm). The SATA hard disk drives operate through an AHCI 1.1 controller that supports advanced SATA-II features such as Native Command Queuing (NCQ) and PHY power management.
...
In the 15-inch MacBook Pro computer, the South Bridge controller provides an Ultra ATA/100 interface (running at UATA/66) to the 9.5 mm high slot-loading, SuperDrive. The drive can read and write DVD media and CD media, as shown in Table 1.
...
| CD-RW | 24x (CAV) | 10x CLV (high speed media), 16x CLV (ultra speed media) |
| CD-ROM | 24x (CAV) | - |
