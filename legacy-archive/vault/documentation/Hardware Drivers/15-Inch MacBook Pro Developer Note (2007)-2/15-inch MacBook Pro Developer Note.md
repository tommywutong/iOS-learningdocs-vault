...
source_url: https://developer.apple.com/library/archive/documentation/HardwareDrivers/Conceptual/15inMacBookPro_0711/Articles/ProductDeveloperNote.html
archived_at: '2026-07-15T07:40:55.133514Z'
---
...
[Figure 1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridsmbqga2tgmzsfvbegskhifaugsq) provides a simplified block diagram of the North Bridge and South Bridge and the buses that connect them together.

__Figure 1__  Block diagram

![This block diagram shows the memory controller and I/O controller ICs and the buses that connect them on the main logic board. Each component in the block diagram is defined in text.](attachments/Art/070257011321_01.jpg)
...
The microprocessor in the 15-inch MacBook Pro is an Intel Core 2 Duo with a clock speed of 2.2 GHz or 2.4 GHz. A 2.6 GHz configuration is available as a build-to-order option. The 15-inch MacBook Pro has the following features:
...
The 15-inch MacBook Pro comes with a 120 GB 5400 rpm or a 160 GB 5400 rpm (optionally, a 250 GB 5400 rpm or 200 GB 7200 rpm) Serial ATA (SATA) Gen-I (1.5 Gbps) hard disk drive. The SATA hard disk drives operate through an AHCI 1.1 controller that supports advanced SATA-II features such as Native Command Queuing (NCQ) and PHY power management.
...
The South Bridge includes an integrated USB 2.0 controller supporting the Bluetooth module, IR receiver, built-in iSight camera, built-in trackpad and keyboard, ExpressCard/34 slot, and 2 high-powered external USB 2.0 ports. The USB ports comply with the Universal Serial Bus Specification 2.0. For more information, see _[Universal Serial Bus Developer Note](../Universal%20Serial%20Bus%20Developer%20Note/Introduction%20to%20Universal%20Serial%20Bus%20Developer%20Note.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqgaztamrw)_.
