...
source_url: https://developer.apple.com/library/archive/documentation/HardwareDrivers/Conceptual/MacBook_0705/Articles/MacBookDeveloperNote.html
archived_at: '2026-07-15T07:41:05.094169Z'
---
...
![This block diagram shows the memory controller and I/O controller ICs and the buses that connect them on the main logic board. Each component in the block diagram is defined in text.](attachments/Art/070324021321_01.jpg)
...
- 2.0 GHz or 2.16 GHz Intel Core 2 Duo microprocessor
- 4 MB shared, on-chip L2 cache for all configurations
- Intel Advanced Digital Media Boost
- Connection to the North Bridge over a 667 MHz frontside bus
...
The processor bus is an up-to-667 MHz bus connecting the processor to the North Bridge. The bus has 32-bit wide data running in both directions. The processor has 32-bit addressing.

The point-to-point architecture provides each subsystem with dedicated bandwidth to main memory. The North Bridge implements an independent processor interface. The input clock to the processor PLL is 166 MHz.
...
In the MacBook computer, the South Bridge controller provides an Ultra ATA/100 interface (running at UATA/66) to the slot-loading SuperDrive or Combo drive. The drive can read and write optical media, as shown in [Table 1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqga3dmmrsfvjvomy) and [Table 2](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqga3dmmrsfvjvona).
...
| CD-RW | 24x (CAV) | 16x ZCLV (ultra speed media)  10x CLV (high speed media)  4x ZCLV (standard speed media) |
| CD-ROM | 24x (CAV) | - |
...
The South Bridge includes an integrated USB 2.0 controller supporting the Bluetooth module, IR receiver, built-in iSight camera, built-in trackpad and keyboard, and 2 external USB 2.0 ports. The USB ports comply with the Universal Serial Bus Specification 2.0. For more information, see _[Universal Serial Bus Developer Note](../Universal%20Serial%20Bus%20Developer%20Note/Introduction%20to%20Universal%20Serial%20Bus%20Developer%20Note.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqgaztamrw)_.
