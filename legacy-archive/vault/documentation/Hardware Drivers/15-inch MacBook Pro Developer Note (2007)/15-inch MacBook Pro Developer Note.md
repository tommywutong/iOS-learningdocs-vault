...
source_url: https://developer.apple.com/library/archive/documentation/HardwareDrivers/Conceptual/15inMacBookPro_0706/Articles/MacBookPro.html
archived_at: '2026-07-15T07:40:54.469225Z'
---
...
This note describes the 15-inch MacBook Pro computers based on the 2.2 GHz or 2.4 GHz Intel Core 2 Duo microprocessor and introduced in June 2007. It includes information about distinguishing features of the computer, including components on the main logic board: the microprocessor, the other main ICs, and the buses that connect them to each other and to the I/O interfaces.

The computer comes with Mac OS X version 10.4.9 installed.

The value of the 15-inch MacBook Pro model identifier string is `MacBookPro3,1`.
...
[Figure 1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqga2tgmzqfvbegskhifaugsq) provides a simplified block diagram of the North Bridge and South Bridge and the buses that connect them together.

__Figure 1__  Block diagram

![This block diagram shows the memory controller and I/O controller ICs and the buses that connect them on the main logic board. Each component in the block diagram is defined in text.](attachments/Art/070257001321_01.jpg)
...
The microprocessor in the 15-inch MacBook Pro is an Intel Core 2 Duo with a clock speed of 2.2 GHz or 2.4 GHz. It has the following features:

- 2.2 GHz or 2.4 GHz dual core processors
...
The 15-inch MacBook Pro comes with a minimum of 120 GB 5400 rpm Serial ATA (SATA) Gen-I (1.5 Gbps) hard disk drive. The SATA hard disk drives operate through an AHCI 1.1 controller that supports advanced SATA-II features such as Native Command Queuing (NCQ) and PHY power management.

The 15-inch MacBook Pro has the following hard disk drive configure-to-order options: 160 GB 5400 rpm, 160 GB 7200 rpm, or 200 GB 4200 rpm.
