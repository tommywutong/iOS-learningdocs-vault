...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Substitutions.html
archived_at: '2026-07-15T07:31:02.929210Z'
---
...
When GCC replaces some :macro with :mode, it will scan
each string and mode in the pattern for sequences of the form
`<`macro`:`attr`>`, where attr is the name of a
