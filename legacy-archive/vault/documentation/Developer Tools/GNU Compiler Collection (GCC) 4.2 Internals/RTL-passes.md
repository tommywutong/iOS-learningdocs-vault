...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/RTL-passes.html
archived_at: '2026-07-15T07:31:02.659785Z'
---
...
- Optimize mode switching
  ...
  The source is located in `mode-switching.c`.
