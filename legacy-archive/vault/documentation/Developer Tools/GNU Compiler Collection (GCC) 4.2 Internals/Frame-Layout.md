...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Frame-Layout.html
archived_at: '2026-07-15T07:31:01.896476Z'
---
...
— Macro: __FRAME_ADDR_RTX__ (frameaddr)
> A C expression whose value is RTL representing the value of the frame
> address for the current frame. frameaddr is the frame pointer
...
— Macro: __FRAME_POINTER_CFA_OFFSET__ (fundecl)
...
— Macro: __CFA_FRAME_BASE_OFFSET__ (fundecl)
> If defined, a C expression whose value is an integer giving the offset
