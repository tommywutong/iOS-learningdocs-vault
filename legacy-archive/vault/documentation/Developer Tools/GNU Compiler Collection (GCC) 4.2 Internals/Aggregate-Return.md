...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Aggregate-Return.html
archived_at: '2026-07-15T07:31:01.163194Z'
---
...
`TARGET_FUNCTION_VALUE` (see [Scalar Return](Scalar-Return.md#apple-knrwc3dboiwvezluovzg4)). Instead, the
