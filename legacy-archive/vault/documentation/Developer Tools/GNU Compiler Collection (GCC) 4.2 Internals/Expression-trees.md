...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Expression-trees.html
archived_at: '2026-07-15T07:31:01.816103Z'
---
...
clauses used by the OpenMP API [http://www.openmp.org/](http://www.openmp.org/).
...
**`OMP_FOR`**
: Represents `#pragma omp for [clause1 ... clauseN]`. It
has 5 operands:
