...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Special-Accessors.html
archived_at: '2026-07-15T07:31:02.827510Z'
---
...
: If ``SYMBOL_REF_HAS_BLOCK_INFO_P (x)`', this is the offset of x
from the first object in ``SYMBOL_REF_BLOCK (x)`'. The value is
negative if x has not yet been assigned to a block, or it has not
