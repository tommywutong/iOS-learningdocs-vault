...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Function-Entry.html
archived_at: '2026-07-15T07:31:01.946490Z'
---
...
> emitted. See [prologue instruction pattern](https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/prologue-instruction-pattern.html#prologue-instruction-pattern).

— Target Hook: void __TARGET_ASM_FUNCTION_BEGIN_EPILOGUE__ (FILE \*file)
> If defined, a function that outputs assembler code at the start of an
> epilogue. This should be used when the function epilogue is being
> emitted as RTL, and you have some extra assembler that needs to be
> emitted. See [epilogue instruction pattern](https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/epilogue-instruction-pattern.html#epilogue-instruction-pattern).
