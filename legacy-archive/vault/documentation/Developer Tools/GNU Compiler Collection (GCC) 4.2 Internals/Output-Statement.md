...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Output-Statement.html
archived_at: '2026-07-15T07:31:02.531654Z'
---
> 导航：[总目录](../../../README.md) · [documentation](../../../_indexes/documentation.md) · [GNU Compiler Collection (GCC) 4.2 Internals](index.md)



Next: [Predicates](Predicates.md#apple-kbzgkzdjmnqxizlt),
Previous: [Output Template](Output-Template.md#apple-j52xi4dvoqwvizlnobwgc5df),
...
pattern's constraint alternatives (see [Multi-Alternative](Multi_002dAlternative.md#apple-jv2wy5djl4ydamteifwhizlsnzqxi2lwmu)). For example,
...
_solely_ determined by the alternative, could also have been specified
as follows, having the output control string start with a ``@`':
