...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Tree_002dSSA-passes.html
archived_at: '2026-07-15T07:31:03.030450Z'
---
...
- Mudflap declaration registration
  ...
  If mudflap (see [-fmudflap -fmudflapth -fmudflapir](https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gcc/Optimize-Options.html#Optimize-Options)) is
...
- Tree level if-conversion for vectorizer
  ...
  at GIMPLE level. This pass is located in `tree-if-conv.c` and is
  described by `pass_if_conversion`.
