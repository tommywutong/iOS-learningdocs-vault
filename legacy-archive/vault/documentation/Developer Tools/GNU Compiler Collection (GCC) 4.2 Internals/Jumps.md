...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/gccint/Jumps.html
archived_at: '2026-07-15T07:31:02.169263Z'
---
...
`RESULT_DECL`, or a `MODIFY_EXPR` which sets the return value. It
would be nice to move the `MODIFY_EXPR` into a separate statement, but the
special return semantics in `expand_return` make that difficult. It may
