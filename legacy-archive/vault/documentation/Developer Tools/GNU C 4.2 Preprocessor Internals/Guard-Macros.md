...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.2.1/cppinternals/Guard-Macros.html
archived_at: '2026-07-15T07:31:01.093883Z'
---
...
Previous: [Line Numbering](Line-Numbering.md#apple-jruw4zjnjz2w2ytfojuw4zy),
...
2. There must be no directives outside the controlling directive pair, but
   the null directive (a line containing nothing other than a single
   ``#`' and possibly whitespace) is permitted.
...
``end-of-directive`' occur in order in a `#if` expression. If
