...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.0.1/gccint/Standard-Names.html
archived_at: '2026-07-15T07:31:00.785908Z'
---
...
them. See [Register Classes](Register-Classes.md#apple-kjswo2ltorsxelkdnrqxg43fom).
...
See [TARGET_SHIFT_TRUNCATION_MASK](https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.0.1/gccint/TARGET_005fSHIFT_005fTRUNCATION_005fMASK.html#TARGET_005fSHIFT_005fTRUNCATION_005fMASK).
...
number of bytes to clear is the second operand, in mode m. See
...
The use for multiple `clrmem`m is as for `movmem`m.
