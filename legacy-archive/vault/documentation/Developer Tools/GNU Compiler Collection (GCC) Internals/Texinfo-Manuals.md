...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.0.1/gccint/Texinfo-Manuals.html
archived_at: '2026-07-15T07:31:00.917144Z'
---
...
`texi2dvi` (via the Makefile macro `$(TEXI2DVI)`). HTML
