...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.0.1/gccint/Files.html
archived_at: '2026-07-15T07:30:59.849561Z'
---
...
2. If the file was a header file, you'll need to check that it's included
   ...
   `Makefile`!
3. If a new `gt-path.h` file is needed, you need to arrange to
   add a `Makefile` rule that will ensure this file can be built.
   This is done by making it a dependency of `s-gtype`, like this:
...
It will need `Makefile` rules just like the other generated files.
