...
source_url: https://developer.apple.com/library/archive/documentation/DeveloperTools/gcc-4.0.1/gccint/Processor-pipeline-description.html
archived_at: '2026-07-15T07:31:00.548010Z'
---
...
description that VLIW ``slot0`' can not be reserved after
``slot1`' or ``slot2`' reservation. We could describe it by the
