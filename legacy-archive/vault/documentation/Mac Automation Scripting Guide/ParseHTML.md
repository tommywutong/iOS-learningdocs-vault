...
source_url: https://developer.apple.com/library/archive/documentation/LanguagesUtilities/Conceptual/MacAutomationScriptingGuide/ParseHTML.html
archived_at: '2026-07-15T07:45:58.980429Z'
---
...
The process of reading an HTML file is no different than the process of reading a standard text file—see [Reading a File](ReadandWriteFiles.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3demzzfvbuqnjyfvjvomq) to learn how to do it. However, it’s often necessary to extract specific bits of information from HTML files, such as links, images, and table data, for further processing.
...
__Listing 33-1__AppleScript: Handler that parses an HTML file for specific tagged content
...
__Listing 33-2__AppleScript: Calling a handler to parse an HTML file for URLs
...
__Listing 33-3__AppleScript: Calling a handler to parse an HTML file for URLs
...
__Listing 33-4__AppleScript: Calling a handler to parse an HTML file for images
...
__Listing 33-5__AppleScript: Calling a handler to parse an HTML file for tables
...
__Listing 33-6__AppleScript: Handler that parses an HTML tag for content
...
__Listing 33-7__AppleScript: Calling a handler to parse an HTML tag for content
