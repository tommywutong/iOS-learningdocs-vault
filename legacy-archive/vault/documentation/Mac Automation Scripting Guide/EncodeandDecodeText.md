...
archived_at: '2026-07-15T07:45:38.448502Z'
---
...
__Listing 32-1__AppleScript: Handler that URL encodes a character
...
__Listing 32-2__AppleScript: Calling a handler to URL encode a character
...
__Listing 32-3__AppleScript: Handler that URL encodes text
...
__Listing 32-4__AppleScript: Calling a handler to URL encode high-level ASCII characters in text
...
__Listing 32-5__AppleScript: Calling a handler to URL encode high- and low-level ASCII characters in text
...
__Listing 32-6__AppleScript: Calling a handler to URL encode high- and low-level ASCII characters in text with certain exclusions
...
__Listing 32-8__AppleScript: Handler that decodes an encoded character hex string
...
__Listing 32-9__AppleScript: Calling a handler to decode an encoded character hex string
...
__Listing 32-10__AppleScript: Handler that decodes any encoded character hex strings in specified text
...
__Listing 32-11__AppleScript: Calling a handler to decode any encoded character hex strings in specified text
...
[Parsing HTML](ParseHTML.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3demzzfvbuqnjqfvjvomi)
