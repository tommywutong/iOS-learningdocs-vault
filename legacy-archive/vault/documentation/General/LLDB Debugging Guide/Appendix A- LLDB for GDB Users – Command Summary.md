...
source_url: https://developer.apple.com/library/archive/documentation/General/Conceptual/lldb-guide/chapters/A3-GDB-Summary.html
archived_at: '2026-07-15T07:34:42.532651Z'
---
> 导航：[总目录](../../../README.md) · [documentation](../../../_indexes/documentation.md) · [LLDB Debugging Guide](About%20LLDB%20and%20Debugging.md)


[Next](Document%20Revision%20History.md)[Previous](Examining%20the%20Call%20Stack.md)
...
| `(gdb) x argv[0]` | `` (lldb) memory read `argv[0]` ``    Note that any command can inline a scalar expression result (as long as the target is stopped) using back ticks (``` `` ```) around any expression:  `` (lldb) memory read --size `sizeof(int)` `argv[0]` `` |
