...
source_url: https://developer.apple.com/library/archive/documentation/Performance/Conceptual/Accelerate_sse_migration/migration_sse_overview/migration_sse_overview.html
archived_at: '2026-07-18T01:39:31.481420Z'
---
...
[Next](Programming%20SSE%20in%20C.md)[Previous](Introduction%20to%20AltiVec-SSE%20Migration%20Guide.md)
...
However, there are some key differences between the two. For a broad overview of general tips and techniques for writing universal binaries, please see:[Universal Binary Programming Guidelines](../../Mac%20OSX/Universal%20Binary%20Programming%20Guidelines%2C%20Second%20Edition/Introduction.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqgazdemjx).

A good source of x86 specific tuning advice and architectural documentation is Intel's web site. In particular, please see the processor optimization reference manual and accompanying software developers manuals: [Intel Pentium References](http://www.intel.com/design/pentium4/manuals/index_new.htm)
...
Before we begin, we would like to strongly urge developers who are starting the process of porting AltiVec code to SSE to look to see if this work has already been done for you in Accelerate.framework. There has been a large body of work added to Accelerate.framework in recent years that you may not have been able to take advantage of previously, for reasons that may no longer exist. We recommend taking a few minutes to take a look. Accelerate.framework does signal processing ([vDSP.h](https://developer.apple.com/documentation/Performance/Conceptual/vDSP/index.html?http://developer.apple.com/documentation/Performance/Conceptual/vDSP/intro_chap/chapter_1_section_1.html)), image processing ([vImage.h](https://developer.apple.com/documentation/Performance/Conceptual/vImage/Chapter1/chapter_1_section_1.html)), linear algebra ([BLAS](https://developer.apple.com/hardwaredrivers/ve/vector_libraries.html#BLAS)/[LAPACK](https://developer.apple.com/hardwaredrivers/ve/vector_libraries.html#LAPACK)), vector math library ([vMathLib](https://developer.apple.com/hardwaredrivers/ve/vector_libraries.html#vMathLib)), and large integer computation ([vBasicOps.h](https://developer.apple.com/hardwaredrivers/ve/vector_libraries.html#vBasicOps), [vBigNum.h](https://developer.apple.com/hardwaredrivers/ve/vector_libraries.html#vBigNum)). The framework will transparently select the best code for the appropriate CPU, be that G3, G4, G5 or Pentium. In many cases, you don't have to know anything about vector programming to use Accelerate.framework.
...
_Pipelines, Latencies and Unrolling_
