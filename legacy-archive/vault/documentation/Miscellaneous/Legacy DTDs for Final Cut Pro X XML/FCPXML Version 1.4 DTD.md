...
source_url: https://developer.apple.com/library/archive/documentation/Miscellaneous/Conceptual/LegacyDTDsFinalCutPro/FCPXMLDTDv1.4/FCPXMLDTDv1.4.html
archived_at: '2026-07-15T08:16:48.408977Z'
---
...
[Next](FCPXML%20Version%201.5%20DTD.md)[Previous](FCPXML%20Version%201.3%20DTD.md)

# FCPXML Version 1.4 DTD

The following is the DTD for the Final Cut Pro X XML Interchange Format v1.4.

```
<!-- FCP X Interchange Format, Version 1.4 -->
<!-- Copyright (c) 2011-2014 Apple Inc. All rights reserved. -->

<!-- FCPXML -->
<!ELEMENT fcpxml (import-options?, resources?, library)>
<!ATTLIST fcpxml version CDATA #FIXED "1.4">
...
<!ELEMENT audition (audio | video | title | ref-clip | clip)+ >
...
<!ELEMENT title (param*, text*, text-style-def*, note?, %intrinsic-params-video;, (%anchor_item;)*, (%marker_item;)*, filter-video*, metadata?)>
...
<!ATTLIST conform-rate frameSampling (floor | nearest-neighbor | frame-blending | optical-flow) "floor">
