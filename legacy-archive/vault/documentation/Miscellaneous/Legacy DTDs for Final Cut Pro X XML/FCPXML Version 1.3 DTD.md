...
source_url: https://developer.apple.com/library/archive/documentation/Miscellaneous/Conceptual/LegacyDTDsFinalCutPro/FCPXMLDTDv1.3/FCPXMLDTDv1.3.html
archived_at: '2026-07-15T08:16:48.352712Z'
---
...
[Next](FCPXML%20Version%201.4%20DTD.md)[Previous](FCPXML%20Version%201.2%20DTD.md)

# FCPXML Version 1.3 DTD

The following is the DTD for the Final Cut Pro X XML Interchange Format v1.3.

```
<!-- FCP X Interchange Format, Version 1.3 -->
<!-- Copyright (c) 2011-2013 Apple Inc. All rights reserved. -->

<!-- FCPXML -->
<!ELEMENT fcpxml (import-options?, project)>
<!ATTLIST fcpxml version CDATA #FIXED "1.3">
...
<!ELEMENT project (resources, (sequence | (clip | audition | mc-clip | ref-clip | %collection_item;)*))>
...
<!ENTITY % intrinsic-params-video "(info-asc-cdl?, adjust-color?, adjust-crop?, adjust-corners?, adjust-conform?, adjust-transform?, adjust-blend?, adjust-stabilization?, adjust-rollingShutter?)">
<!ENTITY % intrinsic-params-audio "(adjust-loudness?, adjust-noiseReduction?, adjust-humReduction?, (adjust-EQ | adjust-matchEQ)?, adjust-volume?, adjust-panner?)">
...
<!ENTITY % timing-params "(rateConform?, timeMap?)">
...
<!ENTITY % marker_item "(marker | chapter-marker | rating | keyword | scene-type)">
...
<!ELEMENT audio-source (%intrinsic-params-audio;, filter-audio*, mute*)>
...
<!ELEMENT audio-aux-source (%intrinsic-params-audio;, filter-audio*, mute*)>
...
<!ELEMENT mc-clip (note?, %timing-params;, %intrinsic-params;, filter-audio*, mc-source*, (%anchor_item;)*, (%marker_item;)*, metadata?)>
...
<!ELEMENT mc-source (%audio_comp_items;, filter-video*)>
...
<!ELEMENT clip (note?, %timing-params;, %intrinsic-params;, (spine | (%clip_item;))*, (%marker_item;)*, %audio_comp_items;, filter-video*, filter-audio*, metadata?)>
...
<!-- Use 'audioStart' and 'audioDuration' to define J/L cuts (i.e., split edits) on composite A/V clips. -->
<!ELEMENT ref-clip (note?, %timing-params;, %intrinsic-params;, (%anchor_item;)*, (%marker_item;)*, %audio_comp_items;, filter-video*, filter-audio*, metadata?)>
...
<!ELEMENT audio (note?, %timing-params;, %intrinsic-params-audio;, (%anchor_item;)*, (%marker_item;)*, filter-audio*)>
...
<!ELEMENT video (param*, note?, %timing-params;, %intrinsic-params-video;, (%anchor_item;)*, (%marker_item;)*, filter-video*, reserved?)>
...
<!ELEMENT title (param*, note?, %timing-params;, %intrinsic-params-video;, (%anchor_item;)*, (%marker_item;)*, filter-video*, metadata?, text*, text-style-def*)>
...
<!ATTLIST text-style alignment (left | center | right) #IMPLIED>
...
<!-- A 'rateConform' defines how the clip's frame rate should be conformed to the sequence frame rate -->
<!ELEMENT rateConform EMPTY>
<!ATTLIST rateConform scaleEnabled (0 | 1) "1">
<!ATTLIST rateConform srcFrameRate (23.98 | 24 | 25 | 29.97 | 30 | 60 | 47.95 | 48 | 50 | 59.94) #IMPLIED>
<!ATTLIST rateConform frameSampling (floor | nearest-neighbor | frame-blending | optical-flow) "floor">
...
<!ATTLIST timeMap frameSampling (floor | frame-blending | optical-flow) "floor">
...
<!ATTLIST timept interp (smooth2 | linear | smooth) #REQUIRED> <!-- interpolation type for point. 'smooth' has been deprecated -->
...
<!ELEMENT scene-type (shot-type)*>
<!ATTLIST scene-type start %time; #IMPLIED>
<!ATTLIST scene-type duration %time; #IMPLIED>
...
<!-- SMART COLLECTIONS -->
<!ELEMENT smart-collection ((match-text | match-ratings | match-media | match-clip | match-stabilization | match-keywords | match-sceneType | match-property | match-time | match-timeRange | match-roles)*)>
...
<!ELEMENT match-sceneType (shot-type*)>
<!ATTLIST match-sceneType enabled (0 | 1) "1">
<!ATTLIST match-sceneType rule (includesAny | includesAll | doesNotIncludeAny | doesNotIncludeAll) "includesAny">
