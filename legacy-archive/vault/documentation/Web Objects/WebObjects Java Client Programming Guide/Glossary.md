...
source_url: https://developer.apple.com/library/archive/documentation/WebObjects/DesktopApplications/Glossary/Glossary.html
archived_at: '2026-07-18T02:17:44.558023Z'
---
...
[Previous](Controllers%20and%20Actions%20Reference.md)
...
- __attribute__
  ...
  In Entity-Relationship modeling, an identifiable characteristic of an entity. For example, `lastName` can be an attribute of an Employee entity. An attribute typically corresponds to a column in a database table. See also [entity](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjjdecq2d); [relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcivfegskj).
...
- __enterprise object__
  ...
  A Java object that conforms to the key-value coding protocol and whose properties (instance data) can map to stored data. An enterprise object brings together stored data with methods for operating on that data. It allows this data to persist in memory. See also [key-value coding](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcivdukqki); [property](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkciveeussj).
...
- __foreign key__
  ...
  An attribute in an entity that gives it access to rows in another entity. This attribute must be the primary key of the related entity. For example, an Employee entity can contain the foreign key `deptID`, which matches the primary key in the entity Department. You can then use `deptID` as the source attribute in Employee and as the destination attribute in Department to form a relationship between the entities. See also [primary key](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjbeucrke); [relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcivfegskj).
...
- __prefetching__
  ...
  A feature in Enterprise Object that allows you to suppress fault creation for an entity’s relationships. Instead of creating faults, the relationship data is fetched when the entity is first fetched. See also [faulting](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcirbeercj).

- __property__

  In Entity-Relationship modeling, an attribute or relationship. See also [attribute](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjfdusscd); [relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcivfegskj).
...
- __relationship__
  ...
  A link between two entities that’s based on attributes of the entities. For example, the Department and Employee entities can have a relationship based on the `deptID` attribute as a foreign key in Employee, and as the primary key in Department (note that although the join attribute `deptID` is the same for the source and destination entities in this example, it doesn’t have to be). This relationship would make it possible to find the employees for a given department. See also [foreign key](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcindeqr2e); [primary key](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjbeucrke); [many-to-many relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjbeuqqsc); [to-many relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcivbeqrcc); [to-one relationship](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjfcuurki).
...
- __request__
  ...
  A message conforming to the Hypertext Transfer Protocol (HTTP) sent from the user’s Web browser to a Web server that asks for a resource like a Web page. See also [response](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcizcekqkf).
...
- __response__
  ...
  A message conforming to the Hypertext Transfer Protocol (HTTP) sent from the Web server to the user’s Web browser that contains the resource specified by the corresponding request. The response is typically a Web page. See also [request](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytamjxfvbuqmzsgqwueqkcjjeueq2g).
