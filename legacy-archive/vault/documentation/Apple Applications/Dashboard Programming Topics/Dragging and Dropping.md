...
source_url: https://developer.apple.com/library/archive/documentation/AppleApplications/Conceptual/Dashboard_ProgTopics/DragAndDrop.html
archived_at: '2026-07-15T05:17:34.786102Z'
---
...
[Next](Localizing%20Widgets.md)[Previous](Cutting%2C%20Copying%2C%20and%20Pasting.md)
...
The `effectAllowed` property tells WebKit what types of operation the source element supports. You would typically set this property in your `ondragstart` event handler. The value for this property is a string, whose value can be one of those listed in Table 15.

__Table 15__  Options for dragging and dropping an element
