...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Library/Frameworks/EOAccess.framework/Resources/English.lproj/Documentation/Reference/Java/EOAccess.html
archived_at: '2026-07-15T08:01:47.624669Z'
---
...
The EOAccess class hierarchy is rooted in the Foundation Framework's NSObject class (see [Figure 1](#apple-gi4tinq)). The remainder of the EOAccess Framework consists of several related groups of classes, a few miscellaneous classes, and a number of interfaces.
...
A number of EOAccess classes delegate behavior. The delegate methods are defined in these Java interfaces:
...
- __Miscellaneous Interfaces__ `EOCustomClassArchiving` is an informal protocol that defines methods that can write any object that conforms to NSCoding to the database as binary data, as generated by NSArchiver.
