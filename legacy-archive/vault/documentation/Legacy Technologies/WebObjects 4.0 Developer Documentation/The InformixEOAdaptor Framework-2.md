...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Library/Frameworks/InformixEOAdaptor.framework/Resources/English.lproj/Documentation/Reference/ObjC_classic/Classes/InformixEOAdaptor.html
archived_at: '2026-07-15T08:02:01.548171Z'
---
...
The type mapping methods-[`externalTypesWithModel:`](InformixAdaptor.md#apple-gm2tgnq), [`internalTypeForExternalType:model:`](InformixAdaptor.md#apple-gm2tioi), and [`isValidQualifierType:model:`](InformixAdaptor.md#apple-gm3dcmi)-allow for an adaptor to supplement its set of type mappings with additional mappings for user-defined database types. InformixAdaptor does not make use of the model argument if one is provided.
...
- [bindVariableDictionaryForAttribute:value:](InformixSQLExpression-2.md#apple-gm2tsmq)
- [mustUseBindVariableForAttribute:](InformixSQLExpression-2.md#apple-gm3dema)
- [shouldUseBindVariableForAttribute:](InformixSQLExpression-2.md#apple-gm3dgmq)

---

[[TOC]](https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Library/Frameworks/InformixEOAdaptor.framework/Resources/English.lproj/Documentation/Reference/ObjC_classic/frameset.html) [Prev] [[Next]](InformixAdaptor.md)
