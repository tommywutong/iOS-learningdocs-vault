...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Documentation/Developer/WebObjects/Topics/Locking_on_a_Column.html
archived_at: '2026-07-15T08:01:15.413672Z'
---
...
```
\xA0\xA0\xA0\xA0id lockingObject;
```
...
```
    lockingObject = [aContext faultForGlobalId:[[self editingContext]
         globalIDForObject:self] editingContext:aContext];
```
...
You can combine two columns for locking, one to store the user ID (or name) and the other to store the date. This technique combines the strengths of the two approaches described earlier ("[See Using a Date in the Locked Column.](#apple-gi4tqmrt)
" and "[See Using a User Identifier.](#apple-gm4dinbz)
