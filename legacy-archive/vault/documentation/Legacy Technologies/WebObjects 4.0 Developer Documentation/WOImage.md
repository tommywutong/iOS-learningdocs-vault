...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Documentation/Developer/WebObjects/Reference/DynamicElements/WOImage.html
archived_at: '2026-07-15T08:00:41.443986Z'
---
...
WOImage { src=_aURL_; | value=_imageData_; | filename= _imageFileName_; [framework = _frameworkBaseName_|"app" ;] | data=_dataObject_; mimeType=_typeString_; [key=_cacheKey_;]... };
...
A string designating a MIME resource type, such as "image/gif", to be put in the contnet-type header; this type tells the client what to do with data. If you provide data but no MIME type, WebObjects will raise.
