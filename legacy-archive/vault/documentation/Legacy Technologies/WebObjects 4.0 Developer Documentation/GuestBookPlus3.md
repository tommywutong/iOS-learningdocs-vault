...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.0/System/Documentation/Developer/WebObjects/GettingStarted/GuestBookPlus/GuestBookPlus3.html
archived_at: '2026-07-18T01:21:36.829246Z'
---
...
[!Table of Contents](Enhancing%20Your%20Application.md) [!Previous Section](Creating%20a%20Custom%20Guest%20Class.md)
...
- Make a connection from __guestName__ in the second column of the object browser (next to __currentGuest__ ) to the Name text field (press the mouse button down on the variable, drag to the element, and release the mouse button).
...
[!Table of Contents](Enhancing%20Your%20Application.md) [!Next Section](GuestBookPlus4.md)
