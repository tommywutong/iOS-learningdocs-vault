...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_5/Topics/ProgrammingTopics.2.html
archived_at: '2026-07-15T08:14:52.300309Z'
---
...
[![Up](attachments/Topics/up.gif)](TopicsTOC.md) [![Previous](attachments/Topics/previous.gif)](TopicsTOC.md) [![Next](attachments/Topics/next.gif)](ProgrammingTopics.3.md)
...
method engages the natural language processing logic directly, bypassing any attempt at matching to a format string).
...
(on the server, it inherits from NSFormatter). Although the NSGregorianDateFormatter is essentially the same class on both the client and the server, the client-side version doesn't support natural language processing.
...
[![Up](attachments/Topics/up.gif)](TopicsTOC.md) [![Previous](attachments/Topics/previous.gif)](TopicsTOC.md) [![Next](attachments/Topics/next.gif)](ProgrammingTopics.3.md)[an error occurred while processing this directive]
