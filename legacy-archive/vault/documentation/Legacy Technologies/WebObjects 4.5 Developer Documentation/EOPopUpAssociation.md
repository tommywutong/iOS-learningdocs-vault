...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOInterface.framework/Java/Classes/EOPopUpAssociation.html
archived_at: '2026-07-15T08:11:44.923838Z'
---
...
the NSPopUpButton can be bound by one of three aspects: `selectedTitle`,
which is useful for values representable as strings; `selectedTag`,
for integer values; and `selectedObject`,
...
using [setTagValueForOther](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6rkpkbxxavlqifzxg33dnfqxi2lpnyxxgzlukrqwovtbnr2wkrtpojhxi2dfoi).
...
Creates a new EOPopUpAssociation to monitor
and update the values in  _aDisplayObject,_
an NSPopUpList (Application Kit).
