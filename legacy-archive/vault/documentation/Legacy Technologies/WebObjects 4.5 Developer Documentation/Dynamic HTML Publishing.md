...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Documentation/Developer/WebObjects/DevGuide/WhatIsWebObjects1.html
archived_at: '2026-07-15T08:06:38.264592Z'
---
...
[!Table of Contents](What%20Is%20a%20WebObjects%20Application.md) [!Previous Section](What%20Is%20a%20WebObjects%20Application.md)
...
WebObjects' development tools allow you to quickly and easily create web applications. WebObjects supplies a large number of pre-built _components_-web pages, or portions of web pages, from which you can build up your web application's interface. These components range from simple UI widgets (such as drop-down list boxes, tables, and the like) to complex ones that, for instance, present a tool bar. And the set of components that you can use with WebObjects is extensible, so you can create components that can then be re-used across all of your web applications.
...
[!Table of Contents](What%20Is%20a%20WebObjects%20Application.md) [!Next Section](Java%20Client.md)
