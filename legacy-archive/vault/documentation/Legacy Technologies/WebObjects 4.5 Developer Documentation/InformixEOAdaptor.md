...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/InformixEOAdaptor.framework/Java/Introduction.html
archived_at: '2026-07-15T08:11:45.843200Z'
---
...
- [dbNameKey](InformixAdaptor.md#apple-ijbukrsgizfei)
- [userNameKey](InformixAdaptor.md#apple-ijbukrkejjeec)
- [passwordKey](InformixAdaptor.md#apple-ijbukscejbdus)

See the [InformixAdaptor](InformixAdaptor.md#apple-ijbukrkgjbbes) class specification
...
- You send the adaptor channel a __selectAttributes__ message
  with `true` specified as
  the value for the __lock__ parameter.
...
the mapping used by InformixAdaptor.
...
| `FLOAT` | Number |
| `SMALLFLOAT` | Number |
| `DATETIME YEAR TO SECOND` | NSGregorianDate |
| `INTERVAL` | String |
...
| `date` | `DATETIME YEAR TO SECOND` | NSGregorianDate | `columnName = ""` |
| `longText` | `TEXT` | String |  |
| `money` | `INTEGER` | BigDecimal | `columnName = ""` |
...
from __primaryKeyForNewRow__ and returns the
