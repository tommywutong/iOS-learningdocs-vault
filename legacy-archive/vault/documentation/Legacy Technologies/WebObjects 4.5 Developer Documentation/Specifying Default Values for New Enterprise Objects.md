...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Documentation/Developer/WebObjects/GettingStarted/GettingStarted.3b.html
archived_at: '2026-07-15T08:07:53.582459Z'
---
...
[!](Refining%20Main.wo.md) [!](Specifying%20a%20Sort%20Order.md) [!](Setting%20a%20Date%20Format.md)
...
For a particular situation, one of the approaches is usually better than the other. If the default values are intrinsic to the enterprise object, assign them in the enterprise object class. For example, consider a Member class with a __memberSince__ property. It's likely that you would automatically assign the current date to __memberSince__ instead of forcing a user to supply a value. You'll see how to use this technique in [Adding Behavior to Your Enterprise Objects](Adding%20Behavior%20to%20Your%20Enterprise%20Objects.md#apple-gqzdomrz)
.
