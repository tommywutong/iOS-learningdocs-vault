...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/WebObjects.framework/Java/Classes/WOEvent.html
archived_at: '2026-07-15T08:11:46.918560Z'
---
...
the description of the "info" instance variable which is passed
at log time. This method can be overridden by subclasses to provide
...
`public Object signatureOfType(int type)`
...
This method is required for proper functioning of the event logging
display.
