...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Documentation/Developer/WebObjects/DevGuide/Intro.html
archived_at: '2026-07-15T08:05:37.540896Z'
---
...
There are no prerequisites for learning WebObjects; however, it does help if you understand object-oriented programming concepts and are familiar with either Java or Objective-C. If you aren't familiar with Java or Objective-C, you might want to pay special attention to Part 3 of this book. Part 3 provides a very brief introduction to object-oriented concepts-enough to get you started. Later, you'll want to round out your knowledge either by reading the book _Object-Oriented Programming and the Objective-C Language_ or any other book on object-oriented programming.
[!Table of Contents](Introduction-2.md) [!Next Section](Other%20Useful%20Documentation.md)
