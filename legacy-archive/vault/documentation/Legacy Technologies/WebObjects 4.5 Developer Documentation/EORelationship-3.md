...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOAccess.framework/ObjC_classic/Classes/More/EORelationship.html
archived_at: '2026-07-15T08:11:35.853500Z'
---
...
set to be to-one. Finally, in the __setJoinSemantic:__ line, [EOInnerJoin](https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOAccess.framework/ObjC_classic/Classes/EORelationship.html#CHJIHGEA) indicates that only objects
...
attributes in its joins. You can use the [referencesProperty:](https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOAccess.framework/ObjC_classic/Classes/EORelationship.html#//apple_ref/occ/instm/EORelationship/referencesProperty:) method
...
> ```
> EOEntity *movieEntity;   // Assume this exists.
> EORelationship *toDirectorsRelationship = [[[EORelationship alloc] init] autorelease];
>
...
its components, no [setToMany:](https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOAccess.framework/ObjC_classic/Classes/EORelationship.html#//apple_ref/occ/instm/EORelationship/setToMany:) message is required here.

A simple relationship is considered to reference all of the
relationships in its definition, plus every attribute referenced
by the component relationships. You can use the [referencesProperty:](https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/EOAccess.framework/ObjC_classic/Classes/EORelationship.html#//apple_ref/occ/instm/EORelationship/referencesProperty:) method
