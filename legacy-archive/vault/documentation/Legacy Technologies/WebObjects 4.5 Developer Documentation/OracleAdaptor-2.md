...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/OracleEOAdaptor.framework/ObjC_classic/Classes/OracleAdaptor.html
archived_at: '2026-07-15T08:11:46.307766Z'
---
...
> __Declared in:__  OracleEOAdaptor/OracleAdaptor.h
...
See ["The Connection Dictionary" (page 6)](OracleEOAdaptor%20Framework-2.md#apple-ijeugrkiijees) in
...
key in an exception's userInfo dictionary (see [raiseOracleError](OracleChannel-2.md#apple-f4xwc4dqnrsv64tfmyxw6y3df5uw443unuxu64tbmnwgkq3imfxg4zlmf5zgc2ltmvhxeyldnrsuk4tsn5za) in the OracleChannel class
specification).

|  |  |
| --- | --- |
| __Constant__ | __Corresponding value in an exception's userInfo dictionary__ |
| OracleErrorKey | The Oracle OCI client library error code. The value is an NSNumber with the error code as its __intValue__, a positive number. |
...
Returns an NSNumber based on _numberValue_ that
