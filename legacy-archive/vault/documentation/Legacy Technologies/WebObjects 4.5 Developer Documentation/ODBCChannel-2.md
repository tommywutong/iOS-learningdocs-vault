...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/ODBCEOAdaptor.framework/ObjC_classic/Classes/ODBCChannel.html
archived_at: '2026-07-15T08:11:46.123338Z'
---
...
> __Declared in:__  ODBCEOAdaptor/ODBCChannel.h
...
The features ODBCChannel adds to EOAdaptorChannel are methods
for returning the ODBC Statement Handle (HSTMT), and for returning
a dictionary-formatted result from `SQLTypeInfo()`.
...
Returns the ODBC Statement Handle HSTMT as a __void\*__;
you must cast the returned value to HSTMT to work with it.
