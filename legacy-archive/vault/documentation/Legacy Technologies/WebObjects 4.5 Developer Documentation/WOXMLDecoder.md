...
source_url: https://developer.apple.com/library/archive/documentation/LegacyTechnologies/WebObjects/WebObjects_4.5/System/Library/Frameworks/XML.framework/Java/Classes/WOXMLDecoder.html
archived_at: '2026-07-15T08:11:47.957328Z'
---
...
Use this class to construct ("decode") an object from
...
necessary. For more information on the mapping model, see the ["The Format of the Mapping Model"](XML.md#apple-ijaucsshjfauq) in
the framework introduction.

## Decoding XML Without a Mapping Model

On its own, without a mapping model, [WOXMLDecoder](#apple-k5hug33oorsxq5a) is able to decode any
object as long as the object and all of its children either implement
the [WOXMLCoding](WOXMLCoding.md#apple-k5hug33oorsxq5a) interface
...
To construct an object from XML data, invoke one of the [decodeRootObject](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsve33porhwe2tfmn2a) methods.

Objects that implement the WOXMLCoding interface
must also implement a single-argument constructor that takes a [WOXMLDecoder](#apple-k5hug33oorsxq5a) object
as the single argument if they are to be decoded. Within this constructor
you decode your object's instance variables using [WOXMLDecoder](#apple-k5hug33oorsxq5a)'s
various __decode...ForKey__ methods.

The following simple "Person" class implements both the
single-argument constructor needed to decode objects of this class
and the WOXMLCoding interface.
...
The mapping decoder gives you much greater control over the
...
to decode XML that wasn't generated by the [WOXMLCoder](WOXMLCoder.md#apple-k5hug33oorsxq5a).
...
Futher suppose that you wanted to decode the above XML into
...
The WOXMLDecoder will do the job for
you given the following mapping model:
...
The above is a simple example; see the RelatedLinks example
...
> : [decoder](#apple-f4xwc4dqnrsv64tfmyxwuylwmexwg3dnf5lu6wcnjrcgky3pmrsxel3emvrw6zdfoi)
> : [decoderWithMapping](#apple-f4xwc4dqnrsv64tfmyxwuylwmexwg3dnf5lu6wcnjrcgky3pmrsxel3emvrw6zdfojlws5dijvqxa4djnztq)
>
> **Decoding XML**
> : [decodeRootObject](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsve33porhwe2tfmn2a)
>
> **Reconstructing an object's
> contents without a mapping model**
> : [decodeBooleanForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsue33pnrswc3sgn5zewzlz)
> : [decodeDoubleForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsui33vmjwgkrtpojfwk6i)
> : [decodeFloatForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsum3dpmf2em33sjnsxs)
> : [decodeIntForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsus3tuizxxes3fpe)
> : [decodeObjectForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsu6ytkmvrxirtpojfwk6i)
>
> **Working with the XML
> parser**
> : [parser](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvza)
> : [parserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvzeg3dbonzu4ylnmu)
> : [setParserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5zwk5cqmfzhgzlsinwgc43tjzqw2zi)
...
Creates and returns a new [WOXMLDecoder](#apple-k5hug33oorsxq5a) object
that decodes XML based upon the mapping model specified by _mappingURL_.
For more information, see ["Decoding XML With a Mapping Model"](#apple-iraumr2cjfbeu).
...
Invoke this method from within in your
...
to extract the marital status from the following XML:
...
to the value of the key element within the XML being decoded.

__See
Also:__  [decodeIntForKey](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsus3tuizxxes3fpe)
...
example, to extract the number of children from the following XML:
...
decoded must meet the same criteria outlined in [decodeRootObject](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsve33porhwe2tfmn2a); if not, or if an
error arises during the construction of the object, __decodeObjectForKey__ throws
a WOXMLException.
...
a corresponding object. __decodeRootObject__ accepts
XML either in an NSData object, in a file, or through an InputSource.
If the XML resides within a file, _XMLfileURL_ should
...
In
the above example, `xmlString` is
a String object that contains the XML for an encoded NSMutableArray
object.

Each object encoded within the XML must have
a type attribute that indicates the object's
class. Each encoded object must be one of the following:
...
Objects
that implement the [WOXMLCoding](WOXMLCoding.md#apple-k5hug33oorsxq5a) interface
must also implement a special constructor; see ["Decoding XML Without a Mapping Model"](#apple-ineeerkejbcek) for
more information and an example.

If the parser
is unable to parse the supplied XML, __decodeRootObject__ throws
a WOXMLException that encloses either a SAXException or an IOException.
...
Returns the XML parser (instantiating
...
cannot be created. The default parser is the SAX parser (com.ibm.xml.parsers.SAXParser).

This
method is invoked by [decodeRootObject](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5sgky3pmrsve33porhwe2tfmn2a).

__See
Also:__  [parserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvzeg3dbonzu4ylnmu), [setParserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5zwk5cqmfzhgzlsinwgc43tjzqw2zi)
...
Returns the name of the XML parser's
class. By default, this is "com.ibm.xml.parsers.SAXParser".

__See
Also:__  [parser](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvza), [setParserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5zwk5cqmfzhgzlsinwgc43tjzqw2zi)
...
the [parser](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvza) method);
once the parser has been instantiated, [setParserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5zwk5cqmfzhgzlsinwgc43tjzqw2zi) has no effect.

__See
Also:__  [parser](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvza), [parserClassName](#apple-f4xwc4dqnrsv64tfmyxwuylwmexws3ttorws6v2plbguyrdfmnxwizlsf5ygc4ttmvzeg3dbonzu4ylnmu)
