...
source_url: https://developer.apple.com/library/archive/documentation/Cocoa/Reference/CocoaBindingsRef/BindingsText/NSBox.html
archived_at: '2026-07-15T07:21:30.549146Z'
---
...
[Next](NSBrowser%20Bindings.md)[Previous](NSArrayController%20Bindings.md)

# NSBox Bindings

|  |  |
| --- | --- |
| __Related class__ | [NSBox](https://developer.apple.com/documentation/appkit/nsbox) |
...
A `Boolean` value that indicates whether the `NSBox` background is transparent. If `YES` the background is transparent.
