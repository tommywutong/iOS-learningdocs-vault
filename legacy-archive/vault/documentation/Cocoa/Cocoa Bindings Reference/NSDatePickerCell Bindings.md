...
source_url: https://developer.apple.com/library/archive/documentation/Cocoa/Reference/CocoaBindingsRef/BindingsText/NSDatePickerCell.html
archived_at: '2026-07-15T07:21:35.527474Z'
---
...
[Next](NSDictionaryController%20Bindings.md)[Previous](NSDatePicker%20Bindings.md)

# NSDatePickerCell Bindings

|  |  |
| --- | --- |
| __Related class__ | [NSDatePickerCell](https://developer.apple.com/documentation/appkit/nsdatepickercell) |
| __Availability__ | Available in OS X v10.4 and later. |

A multiple-value binding that determines if the `NSDatePickerCell` is editable in the user interface.
...
The contents of the `NSDatePickerCell` are editable if a logical AND operation on all the `editable` bindings results in a Boolean value of `YES`.
...
A multiple-value binding that determines if the `NSDatePickerCell` is enabled in the user interface.
...
The `NSDatePickerCell` is enabled if a logical AND operation on all the `enabled` bindings results in a Boolean value of `YES`.
...
An NSFont used to display the `NSDatePickerCell`.
...
A Boolean value that determines if the NSFont used to display the `NSDatePickerCell` is bold. If `fontBold` evaluates to `YES`, the bold attribute is added to the font.
...
An NSString that specifies the family name of the NSFont used to display the contents of the `NSDatePickerCell`.
...
A Boolean value that determines if the NSFont used to display the `NSDatePickerCell` is italic. If `fontItalic` evaluates to `YES`, the italic attribute is added to the font.
...
An NSString that specifies the full name of the NSFont that is used to display the contents of the `NSDatePickerCell`. The full font name includes the family and the style of the font — for example, "Helvetica-Bold".
...
An integer value that determines the size, in points, of the font used to display the `NSDatePickerCell`.
...
An NSColor that specifies the color used to display the text of the `NSDatePickerCell`.
...
An NSDate instance that specifies the maximum date value allowed by the `NSDatePickerCell`.
...
| Description | Placeholder constant | Value class |
| --- | --- | --- |
| Multiple Values Placeholder | [NSMultipleValuesPlaceholderBindingOption](Binding%20Options.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpgiydambsgmydilktk4zq) | NSDate |
| No Selection Placeholder | [NSNoSelectionPlaceholderBindingOption](Binding%20Options.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpgiydambsgmydilktk42a) | NSDate |
| Not Applicable Placeholder | [NSNotApplicablePlaceholderBindingOption](Binding%20Options.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpgiydambsgmydilktk42q) | NSDate |
| Null Placeholder | [NSNullPlaceholderBindingOption](Binding%20Options.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpgiydambsgmydiljsgaztonzw) | NSDate |

An NSDate instance that specifies the minimum date value allowed by the `NSDatePickerCell`.
...
An NSDate instance to be displayed in the `NSDatePickerCell`.
