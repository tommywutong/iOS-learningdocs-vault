...
source_url: https://developer.apple.com/library/archive/documentation/Carbon/Conceptual/ProvidingUserAssitAppleHelp/using_ah_functions/using_ah_functions.html
archived_at: '2026-07-15T05:24:31.860826Z'
---
...
[Next](Apple%20Help%20Meta%20Tag%20Properties.md)[Previous](Help%20Book%20Registration.md)
...
- [openHelpAnchor:inBook:](https://developer.apple.com/documentation/appkit/nshelpmanager/1500908-openhelpanchor) opens a location in your help book identified by an anchor.
- [findString:inBook:](https://developer.apple.com/documentation/appkit/nshelpmanager/1500904-findstring) searches your help book for a term or phrase.

`NSHelpManager` methods are fully documented in _[NSHelpManager Class Reference](https://developer.apple.com/documentation/appkit/nshelpmanager)_.

If you specify anchor locations in your help book, as described in [Indexing Your Help Book](Authoring%20Apple%20Help.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaydsmbtfvbuqmrqgywugskijbdeqqkg), you can use the Apple Help function `AHLookupAnchor` or the `NSHelpManager` method `openHelpAnchor:inBook:` to find and display help content by anchor name. `AHLookupAnchor` and `openHelpAnchor:inBook:` allow you to search for a particular help topic without knowing the path to the page that it is on. If you are implementing contextually sensitive help, you can load it by anchor, without having to track the path to every help page you may access.
...
Here is an example of how you could call the `MyGotoHelpAnchor` function described in [Listing 4-1](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaydsmbtfvbuqmrqhawugsceivdeiqsb):
...
Here is an example of how you could call the function shown in [Listing 4-2](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaydsmbtfvbuqmrqhawugscejfceqssb) to search your help book for information on printing. You can use a phrase for your query, such as “print a document” or you can search for a term, such as “print”.
...
Here are three examples of how you could call the `MyGotoHelpPage` function described in [Listing 4-3](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaydsmbtfvbuqmrqhawugsceivdumrki):
