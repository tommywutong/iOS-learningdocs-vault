...
source_url: https://developer.apple.com/library/archive/documentation/Darwin/Reference/usr_APIs/tidyenum/CompositePage.html
archived_at: '2026-07-15T07:23:28.852591Z'
---
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| tidyenum.h | tidyenum.h | tidyenum.h | tidyenum.h | tidyenum.h |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyAttrId | TidyAttrId | TidyAttrId | TidyAttrId | TidyAttrId |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyConfigCategory | TidyConfigCategory | TidyConfigCategory | TidyConfigCategory | TidyConfigCategory |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyDoctypeModes | TidyDoctypeModes | TidyDoctypeModes | TidyDoctypeModes | TidyDoctypeModes |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyDupAttrModes | TidyDupAttrModes | TidyDupAttrModes | TidyDupAttrModes | TidyDupAttrModes |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyLineEnding | TidyLineEnding | TidyLineEnding | TidyLineEnding | TidyLineEnding |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyNodeType | TidyNodeType | TidyNodeType | TidyNodeType | TidyNodeType |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyOptionId | TidyOptionId | TidyOptionId | TidyOptionId | TidyOptionId |
...
typedef enum {
    ...
    #if SUPPORT_ASIAN_ENCODINGS TidyLanguage, /**< Language property: not used for anything yet */
    TidyNCR, /**< Allow numeric character references */
    #else TidyLanguageNotUsed,
    TidyNCRNotUsed,
    #endif #if SUPPORT_UTF16_ENCODINGS TidyOutputBOM, /**< Output a Byte Order Mark (BOM) for UTF-16 encodings */
    /**< auto: if input stream has BOM, we output a BOM */
    #else TidyOutputBOMNotUsed,
    #endif  TidyReplaceColor, /**< Replace hex color attribute values with names */
    ...
    #if SUPPORT_ASIAN_ENCODINGS TidyPunctWrap, /**< consider punctuation and breaking spaces for wrapping */
    #else TidyPunctWrapNotUsed,
    #endif TidyMergeDivs, /**< Merge multiple DIVs */
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyOptionType | TidyOptionType | TidyOptionType | TidyOptionType | TidyOptionType |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyReportLevel | TidyReportLevel | TidyReportLevel | TidyReportLevel | TidyReportLevel |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyTagId | TidyTagId | TidyTagId | TidyTagId | TidyTagId |
...
|  |  |  |  |  |
| --- | --- | --- | --- | --- |
| TidyTriState | TidyTriState | TidyTriState | TidyTriState | TidyTriState |
