...
source_url: https://developer.apple.com/library/archive/documentation/GraphicsImaging/Conceptual/CoreImaging/ci_filer_recipes/ci_filter_recipes.html
archived_at: '2026-07-15T07:35:33.713024Z'
---
> 导航：[总目录](../../../README.md) · [documentation](../../../_indexes/documentation.md) · [Core Image Programming Guide](About%20Core%20Image.md)


[Next](Getting%20the%20Best%20Performance.md)[Previous](Querying%20the%20System%20for%20Filters.md)
...
This chapter shows how Core Image subclasses `CIFilter` to create the `CIColorInvert` filter. Then it describes recipes for chaining together a variety of filters to achieve interesting effects. By following the subclassing procedure in [Subclassing CIFilter to Create the CIColorInvert Filter](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytcobvfvbuqnbnknltg), you should be able to create filters from the recipes in this chapter or venture forth to create your own interesting combinations of the built-in filters provided by Core Image.
...
__Listing 5-1__  The interface for the CIColorInvert filter
...
__Listing 5-2__  The outputImage method for the CIColorInvert filter
...
__Figure 5-1__  The Chroma Key filter processing chain
...
__Listing 5-3__  The color cube in code
...
__Figure 5-2__  The White Vignette filter processing chain
...
__Listing 5-4__  Using CIDetector to locate one face
...
- Set the `inputCenter` to the center of the face bounds that you computed with [Listing 5-4](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridgmbqgaytcobvfvbuqnbnknltcmi).
...
__Figure 5-3__  The Tilt-Shift filter processing chain
...
__Figure 5-4__  The Anonymous Faces filter processing chain
...
Set the input parameters of the `[CIPixellate](../../../Reference/CoreImageFilterReference/index.md#apple-f4xwc4dqnrsv64tfmyxwi33df5tgs3dumvzc6y3jf5busudjpbswy3dborsq)` filter as follows:
...
- Use the `[CIRadialGradient](../../../Reference/CoreImageFilterReference/index.md#apple-f4xwc4dqnrsv64tfmyxwi33df5tgs3dumvzc6y3jf5busutbmruwc3chojqwi2lfnz2a)` filter to create a circle that surrounds the face.
- Use the `[CISourceOverCompositing](../../../Reference/CoreImageFilterReference/index.md#apple-f4xwc4dqnrsv64tfmyxwi33df5tgs3dumvzc6y3jf5busu3povzggzkpozsxeq3pnvyg643joruw4zy)` filter to add the gradient to the mask.

__Listing 5-5__  Building a mask for the faces detected in an image
...
__Figure 5-5__  The Pixellate Transition filter processing chain
...
__Figure 5-6__  The Old Film filter processing chain
