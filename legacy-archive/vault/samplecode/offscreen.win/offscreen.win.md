...
source_url: https://developer.apple.com/library/archive/samplecode/offscreen.win/Introduction/Intro.html
archived_at: '2026-07-18T03:29:53.444469Z'
---
...
|  |  |
| --- | --- |
| __Last Revision:__ | Version 1.0, 2003-01-14 Uses NewGWorldFromHBITMAP to wrap a gworld around an existing DIB, then draws movie frames into this gworld. |
| __Build Requirements:__ | Windows |
| __Runtime Requirements:__ | Windows |
