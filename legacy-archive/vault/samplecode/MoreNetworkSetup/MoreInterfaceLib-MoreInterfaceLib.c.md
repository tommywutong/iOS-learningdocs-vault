...
source_url: https://developer.apple.com/library/archive/samplecode/MoreNetworkSetup/Listings/MoreInterfaceLib_MoreInterfaceLib_c.html
archived_at: '2026-07-18T03:15:47.393663Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MoreNetworkSetup](MoreNetworkSetup.md)


[Next](MoreInterfaceLib-MoreInterfaceLib.h.md)[Previous](MoreNetworkSetup.md)

# MoreInterfaceLib/MoreInterfaceLib.c
...
extern pascal OSErr MoreInstallTimeTask(QElemPtr tmTaskPtr)
{
    ...
    // MoreAssertQ(uppInsTimeTaskProcInfo == 0x????????);
...
extern pascal OSErr MorePrimeTimeTask(QElemPtr tmTaskPtr, long count)
{
    ...
    // MoreAssertQ(uppPrimeTimeTaskProcInfo == 0x????????);
...
extern pascal OSErr MoreRemoveTimeTask(QElemPtr tmTaskPtr)
{
    ...
    // MoreAssertQ(uppRemoveTimeTaskProcInfo == 0x????????);
