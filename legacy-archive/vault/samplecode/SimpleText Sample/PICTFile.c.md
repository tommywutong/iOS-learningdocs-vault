...
source_url: https://developer.apple.com/library/archive/samplecode/SimpleText_Sample/Listings/PICTFile_c.html
archived_at: '2026-07-18T03:24:18.135388Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SimpleText Sample](SimpleText%20Sample.md)


[Next](PICTFile.h.md)[Previous](MovieFile.r.md)
...
static OSErr GetSelectedPicture(WindowDataPtr pData, PicHandle *pResult)
{
    ...
    {
    Point   offset = {0,0};
    anErr = DiskPictureDraw(pData, true, false, &offset);
    }
