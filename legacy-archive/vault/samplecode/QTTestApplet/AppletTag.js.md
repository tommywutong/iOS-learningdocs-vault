---
title: QTTestApplet
apple_id: DTS10000984
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-01-14'
source_url: https://developer.apple.com/library/archive/samplecode/QTTestApplet/Listings/AppletTag_js.html
archived_at: '2026-07-18T03:21:21.333437Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [QTTestApplet](QTTestApplet.md)


[Next](classes-test.html.md)[Previous](README.txt.md)
...
function printThis (jreTag, is) {
    if (is.win32) {
        if (is.nav4up){ // Netscape 4 and up
             document.write("<EMBED type=\"application/x-java-applet;version=1.1\" ");
             document.write("PLUGINSPAGE=\"http://java.sun.com/products/plugin/1.1/plugin-install.html\" ");
           ...
           document.write("CODEBASE=\"http://java.sun.com/products/plugin/1.1/jinstall-11-win32.cab#Version=1,1,0,0\"> ");
           document.write("<PARAM NAME=\"type\" VALUE=\"application/x-java-applet;version=1.1\"> ");
