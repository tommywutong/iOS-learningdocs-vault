---
title: MakeITable
apple_id: DTS10000090
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-07-22'
source_url: https://developer.apple.com/library/archive/samplecode/MakeITable/Listings/MakeITable_c.html
archived_at: '2026-07-18T03:14:20.846547Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MakeITable](MakeITable.md)


[Next](Document%20Revision%20History.md)[Previous](MakeITable.md)
...
/*
    ...
    Contains:   This is a very boring app which just forces QuickDraw to update the ITable of
                all the monitors.  The Resolution will end up at 5 bits.  The ITable will change
                when you select start from the file menu.
