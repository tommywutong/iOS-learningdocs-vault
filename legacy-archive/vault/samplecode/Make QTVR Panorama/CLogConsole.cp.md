...
source_url: https://developer.apple.com/library/archive/samplecode/Make_QTVR_Panorama/Listings/CLogConsole_cp.html
archived_at: '2026-07-18T03:14:24.986687Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Make QTVR Panorama](Make%20QTVR%20Panorama.md)


[Next](CMovieMaker.cp.md)[Previous](CKeyFilters.h.md)

# CLogConsole.cp

```c
/*
    This file of empty stubs, copied from one included with CodeWarrior,
    eliminates the need to include the Sioux libraries.
*/
