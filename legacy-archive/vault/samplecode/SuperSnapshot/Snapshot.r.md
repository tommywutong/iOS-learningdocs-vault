---
title: SuperSnapshot
apple_id: DTS10000171
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-10-10'
source_url: https://developer.apple.com/library/archive/samplecode/SuperSnapshot/Listings/Snapshot_r.html
archived_at: '2026-07-18T03:25:48.793786Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SuperSnapshot](SuperSnapshot.md)


[Next](Document%20Revision%20History.md)[Previous](Snapshot.h.md)
...
data 'MBAR' (128) {
    $"0004 0080 0081 0083 0084"                           /* ...... */
};

data 'MBAR' (129) {
```
| ```     $"0004 0080 0082 0083 0085"                           /* ......
 */ ``` |
```
};
...
data 'MENU' (129) {
    ...
    $"696C 650C 4E65 7720 536E 6170 7368 6F74"            /* ile.New Snapshot */
    $"004E 0000 0752 6566 7265 7368 0052 0000"            /* .N...Refresh.R.. */
    $"0543 6C6F 7365 0057 0000 0453 6176 6500"            /* .Close.W...Save. */
    $"5300 0004 5175 6974 0051 0000 00"                   /* S...Quit.Q... */
};

data 'MENU' (130) {
    $"0082 0000 0000 0000 0000 FFFF FFFF 0446"            /* .........ÿÿÿÿ.F */
    $"696C 650C 4E65 7720 536E 6170 7368 6F74"            /* ile.New Snapshot */
    $"004E 0000 0752 6566 7265 7368 0052 0000"            /* .N...Refresh.R.. */
    $"0543 6C6F 7365 0057 0000 0453 6176 6500"            /* .Close.W...Save. */
    $"5300 0000"                                          /* S... */
...
data 'MENU' (128) {
    ...
    $"1141 626F 7574 2053 6E61 7073 686F 742E"            /* .About Snapshot. */
    $"2E2E 0000 0000 00"                                  /* ....... */
};

data 'MENU' (131) {
    $"0083 0000 0000 0000 0000 FFFF FFFF 0C50"            /* .........ÿÿÿÿ.P */
    $"6963 7475 7265 2053 697A 650C 5175 6172"            /* icture Size.Quar */
    $"7465 7220 5369 7A65 0031 0000 0948 616C"            /* ter Size.1..ÆHal */
    $"6620 5369 7A65 0032 0000 0946 756C 6C20"            /* f Size.2..ÆFull  */
    $"5369 7A65 0033 0000 00"                             /* Size.3... */
};

data 'MENU' (132) {
    $"0084 0000 0000 0000 0000 FFFF FFFF 0744"            /* .........ÿÿÿÿ.D */
    $"6573 6B74 6F70 1353 6574 2044 6573 6B74"            /* esktop.Set Deskt */
    $"6F70 2050 6963 7475 7265 0000 0000 00"              /* op Picture..... */
};

data 'MENU' (133) {
```
| ```     $"0085 0000 0000 0000 0000 FFFF FFFF 1156"            /* .
........ÿÿÿÿ.V */ ``` |
```
    $"6572 7920 4269 6720 536E 6170 7368 6F74"            /* ery Big Snapshot */
    $"1444 6973 706C 6179 2042 6967 2053 6E61"            /* .Display Big Sna */
    $"7073 686F 7400 0000 0000"                           /* pshot..... */
};

data 'DITL' (128, purgeable) {
    $"0001 0000 0000 0098 00EF 00AC 0133 0402"            /* ........ï.¬.3.. */
    $"4F4B 0000 0000 0011 0038 008E 013D 8870"            /* OK.......8..=p */
    $"5375 7065 7220 536E 6170 7368 6F74 2053"            /* Super Snapshot S */
    $"616D 706C 6520 5072 6F67 7261 6D0D 0D41"            /* ample ProgramÂÂA */
    $"7070 6C65 2044 6576 656C 6F70 6572 2054"            /* pple Developer T */
    $"6563 686E 6963 616C 2053 7570 706F 7274"            /* echnical Support */
    $"0D64 7473 4061 7070 6C65 2E63 6F6D 0D0D"            /* Âdts@apple.comÂÂ */
    $"4A65 6666 2074 6865 2049 6E74 6572 6E20"            /* Jeff the Intern  */
    $"7761 7320 6865 7265 2E2E 2E2E 2E3A 2D29"            /* was here.....:-) */
};

data 'DLOG' (128, purgeable) {
    $"004A 002F 010B 019C 0005 0100 0100 0000"            /* .J./........... */
    $"0000 0080 0000 280A"                                /* .....(. */
};
```
