...
source_url: https://developer.apple.com/library/archive/samplecode/DTSCPlusLibrary/Listings/Sources_TimerTest_cp.html
archived_at: '2026-07-18T03:05:59.368752Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [DTSCPlusLibrary](DTSCPlusLibrary.md)


[Next](Sources-Toolbox.cp.md)[Previous](Sources-Timer.cp.md)

# Sources/TimerTest.cp
...
void main(void)
{
    ...
    printf("Get Lap time = %i ticks\n",myTimer.GetLap());

    myTimer.SetLap(3);                          // set the third lap counter    
    Delay(kSecond * 2, NULL);
    myTimer.Stop();                             // 2 second delay

    printf("Time between start and stop = %i ticks\n",myTimer.GetTicks());
    printf("Or in seconds = %is\n",myTimer.GetSeconds());
    printf("Lap counter 3 is = %i ticks\n",myTimer.GetLap(3));
