...
source_url: https://developer.apple.com/library/archive/samplecode/SceneKitMaterialEditor/Listings/SceneKitMaterialEditor_resources_earth_diffuse_txt.html
archived_at: '2026-07-18T03:23:11.405073Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SceneKit Material Editor](Scene%20Kit%20Material%20Editor.md)


[Next](SceneKitMaterialEditor-resources-Envmap-Envmap.txt.md)[Previous](SceneKitMaterialEditor-main.m.md)

# SceneKitMaterialEditor/resources/earth-diffuse.txt

```
The Scene Kit Material Editor texture

   earth-diffuse.jpg

was obtained from the USGS web site at

   http://astrogeology.usgs.gov/Projects/PlanetaryPhotojournal/

The description and credits for this imags are as follows:
