...
apple_id: DTS40008191
resource_type: Sample Code
platform: macOS
topic: Performance
technology: OpenCL
published: '2009-10-09'
source_url: https://developer.apple.com/library/archive/samplecode/OpenCL_Procedural_Noise_Example/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:17:57.219426Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [OpenCL Procedural Noise Example](OpenCL%20Procedural%20Noise%20Example.md)


[Next](noise.c.md)[Previous](OpenCL%20Procedural%20Noise%20Example.md)
