...
source_url: https://developer.apple.com/library/archive/samplecode/qtcapture.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:52:38.888663Z'
---
...
extern Boolean          gUseBottleneck;
extern Boolean          gUseDataProc;
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        case IDM_SHOW_VIDEO_SETTINGS:
            QTCap_GetVideoSettings();
            myIsHandled = true;
            break;

        case IDM_SHOW_SOUND_SETTINGS:
