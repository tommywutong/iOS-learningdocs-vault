...
source_url: https://developer.apple.com/library/archive/samplecode/PickOne/Listings/sources_PickOne_main_c.html
archived_at: '2026-07-18T03:18:58.976018Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [PickOne](PickOne.md)


[Next](sources-PickOnemenu.c.md)[Previous](sources-PickOneevent.c.md)

# sources/PickOne_main.c

```c
/*  main.c                                                                          

  This is PickOne, a sample app designed to show how getting UV data from
