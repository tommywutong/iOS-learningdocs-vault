...
source_url: https://developer.apple.com/library/archive/samplecode/TCP_Server/Listings/interface_h.html
archived_at: '2026-07-18T03:26:02.051251Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [TCP Server](TCP%20Server.md)


[Next](network.c.md)[Previous](interface.c.md)
