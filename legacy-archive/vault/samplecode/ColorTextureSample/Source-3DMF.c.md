...
source_url: https://developer.apple.com/library/archive/samplecode/ColorTextureSample/Listings/Source_3DMF_c.html
archived_at: '2026-07-18T03:04:01.991803Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [ColorTextureSample](ColorTextureSample.md)


[Next](Source-Events.c.md)[Previous](ColorTextureSample.md)
...
TQ3Object       myObject;
    ...
    SetPort((GrafPtr)gBreakdownWindow);
    Home();
    DoCR();
    ...
    *viewHints = *model = nil;                                          // assume return nothing
    ...
    do
    {
        ...
        QD3D_DisplayObjectInfo(myObject);
        ...
        if (Q3Object_IsDrawable(myObject))                              // see if is a drawable object
        {
            if (myGroup)                                                // if group exists
            {
                ...
                ForeColor(blueColor);
                WriteString("\p---> Add Object to Group");
                DoCR();
            }
            else
            ...
            {
                ForeColor(redColor);
                WriteString("\pMAKE NEW GROUP & ADD EXISTING TO IT");
                DoCR();
...
TQ3FileMode         fileMode;
    ...
    {
        if (gSaveAsBinary)                                  // set binary or text output
