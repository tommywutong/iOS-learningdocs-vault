...
source_url: https://developer.apple.com/library/archive/samplecode/qtbigscreen.win/Listings/Common_Files_ComFramework_h.html
archived_at: '2026-07-26T19:52:45.826065Z'
---
...
// constants for 'ptv ' user data item data
enum {
    kSizeNormal                             = 0,
    kSizeDouble,
    kSizeHalf,
...
// structure of 'ptv ' user data item data
typedef struct {
    UInt16          fSize;
    UInt16          fDelayBefore;
    UInt16          fDelayAfter;
