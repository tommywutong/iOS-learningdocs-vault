...
source_url: https://developer.apple.com/library/archive/samplecode/ViewerOptBtnSample/Listings/Source_Events_c.html
archived_at: '2026-07-18T03:28:00.873982Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [ViewerOptBtnSample](ViewerOptBtnSample.md)


[Next](Source-Main.c.md)[Previous](Headers-process.h.md)
...
GrafPtr oldPort;
    ...
    WaitNextEvent(everyEvent,&gTheEvent, 0, 0);
                ...
                /* SEE IF VIEWER HANDLES EVENT */

    if (Q3ViewerEvent(gViewer, &gTheEvent))
        return;


            /* NOPE, LET'S HANDLE IT OURSELVES */

    switch (gTheEvent.what)
    {
        case    nullEvent:
                Q3ViewerAdjustCursor(gViewer, &gTheEvent.where);
