...
source_url: https://developer.apple.com/library/archive/samplecode/qtmusic.win/Listings/Application_Files_ComResource_h.html
archived_at: '2026-07-26T19:52:51.188991Z'
---
...
#define IDM_PLAY_SOME_NOTES             33537   // ((kTestMenuResID<<8)+(1))
#define IDM_PLAY_BENT_NOTES             33538   // ((kTestMenuResID<<8)+(2))
#define IDM_PLAY_SHEPARD_MELODY         33539   // ((kTestMenuResID<<8)+(3))
#define IDM_PICK_THEN_PLAY              33540   // ((kTestMenuResID<<8)+(4))
#define IDM_PICK_THEN_PLAY_CUSTOM       33541   // ((kTestMenuResID<<8)+(5))
#define IDM_BUILD_AND_PLAY_SEQUENCE     33543   // ((kTestMenuResID<<8)+(7))
#define IDM_BUILD_MUSIC_MOVIE           33544   // ((kTestMenuResID<<8)+(8))
#define IDM_BUILD_MUSIC_MOVIE_CUSTOM    33545   // ((kTestMenuResID<<8)+(9))
#define IDM_USE_MIDI_INPUT              33547   // ((kTestMenuResID<<8)+(11))
