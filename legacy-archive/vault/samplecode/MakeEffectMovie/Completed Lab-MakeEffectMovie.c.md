...
source_url: https://developer.apple.com/library/archive/samplecode/MakeEffectMovie/Listings/Completed_Lab_MakeEffectMovie_c.html
archived_at: '2026-07-18T03:14:14.528239Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MakeEffectMovie](MakeEffectMovie.md)


[Next](Completed%20Lab-MakeEffectMovie.h.md)[Previous](Common%20Files-WinPrefix.h.md)

# Completed Lab/MakeEffectMovie.c
...
void QTEffects_RespondToDialogSelection (OSErr theErr)
{
    ...
    // which tracks in the movie are affected
        ...
        // set the input map for the media
        if (gSpecCount > 0)
