...
source_url: https://developer.apple.com/library/archive/samplecode/MakeEffectMovie/Listings/Start_Code_Common_Files_ComFramework_c.html
archived_at: '2026-07-18T03:14:15.144794Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MakeEffectMovie](MakeEffectMovie.md)


[Next](Start%20Code-Common%20Files-ComFramework.h.md)[Previous](Start%20Code-Application%20Files-ComResource.h.md)

# Start Code/Common Files/ComFramework.c
...
// UNCOMMENT THESE LINES WHEN THE OS X PDF IMPORTER STOPS THINKING IT CAN OPEN MOVIE FILES (RADAR 2443744)
...
OSErr QTFrame_PutFile (ConstStr255Param thePrompt, ConstStr255Param theFileName, FSSpecPtr theFSSpecPtr, Boolean *theIsSelected, Boolean *theIsReplacing)
{
    ...
    NavEventUPP         myEventUPP = NewNavEventProc(QTFrame_HandleNavEvent);
#endif
    OSErr               myErr = noErr;
