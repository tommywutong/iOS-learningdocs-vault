...
source_url: https://developer.apple.com/library/archive/samplecode/BackGround/Listings/BackGroundSupport_c.html
archived_at: '2026-07-18T03:01:42.046685Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [BackGround](BackGround.md)


[Next](BackGroundSupport.h.md)[Previous](BackGroundShell.h.md)
...
TQ3DrawContextObject MyNewDrawContext(GWorldPtr theGWorld)
{
    ...
    clearColor.r = kClearColor.red / factor ;
    clearColor.g = kClearColor.green / factor ;
    clearColor.b = kClearColor.blue / factor ;
...
TQ3GroupObject MyNewModelFromFile(FSSpec *theFileSpec)
{
    ...
    TQ3FileMode         myFileMode = 0L;    // we are reading the file
    TQ3FileObject       theFile = kQ3FileModeNormal;
...
//-------------------------------------------------------------------------------------------
//
Boolean PictureFileSpecify( FSSpec *theFile )
{
    StandardFileReply   theSFReply ;
