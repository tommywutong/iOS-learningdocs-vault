...
source_url: https://developer.apple.com/library/archive/samplecode/BackGround/Listings/BackGroundSupport_h.html
archived_at: '2026-07-18T03:01:42.243172Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [BackGround](BackGround.md)


[Next](Document%20Revision%20History.md)[Previous](BackGroundSupport.c.md)
...
struct _documentRecord {
    ...
    GWorldPtr       fBgPicture ;            // stores the background pict
    GWorldPtr       fCompositeBuffer ;      // to composite the bg with the 3d picture
};
...
extern const RGBColor   kClearColor ;
