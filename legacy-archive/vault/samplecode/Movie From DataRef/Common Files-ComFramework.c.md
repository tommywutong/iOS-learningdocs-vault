...
source_url: https://developer.apple.com/library/archive/samplecode/Movie_From_DataRef/Listings/Common_Files_ComFramework_c.html
archived_at: '2026-07-18T03:16:21.732546Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Movie From DataRef](Movie%20From%20DataRef.md)


[Next](Common%20Files-ComFramework.h.md)[Previous](Clippings-CreateMovie.c-CreateMovieFromDataRef.txt.md)
...
void QTFrame_HandleFileMenuItem (WindowReference theWindow, UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        ...
        case IDM_FILENEW:
            CreateAMovie(); // QTFrame_CreateNewMovie();
            break;
