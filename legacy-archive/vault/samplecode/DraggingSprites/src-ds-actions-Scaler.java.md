...
source_url: https://developer.apple.com/library/archive/samplecode/DraggingSprites/Listings/src_ds_actions_Scaler_java.html
archived_at: '2026-07-18T03:07:12.105364Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [DraggingSprites](DraggingSprites.md)


[Next](src-ds-actions-Skewer.java.md)[Previous](src-ds-actions-RotateAction.java.md)

# src/ds/actions/Scaler.java
