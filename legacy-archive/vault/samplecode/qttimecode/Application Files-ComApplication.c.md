...
source_url: https://developer.apple.com/library/archive/samplecode/qttimecode/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:53:09.226088Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [qttimecode](qttimecode.md)


[Next](Application%20Files-ComApplication.h.md)[Previous](qttimecode.md)
...
extern UserItemUPP      gOptionsUserItemProcUPP;                // UPP to our options dialog user item procedure
...
#pragma unused(theMenu)
    ...
    QTFrame_SetMenuItemState(myMenu, IDM_TOGGLE_TIMECODE_DISPLAY, kDisableMenuItem);
    ...
    if ((myMovie != NULL) && QTTC_MovieHasTimeCodeTrack(myMovie)) {
        ...
        QTFrame_SetMenuItemState(myMenu, IDM_GET_TIMECODE_SOURCE, kEnableMenuItem);
        QTFrame_SetMenuItemState(myMenu, IDM_TOGGLE_TIMECODE_DISPLAY, kEnableMenuItem);
    }
