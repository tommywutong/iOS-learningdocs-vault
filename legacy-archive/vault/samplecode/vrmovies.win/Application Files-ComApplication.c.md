...
source_url: https://developer.apple.com/library/archive/samplecode/vrmovies.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:53:00.892689Z'
---
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        ...
        case IDM_SET_WIDTH:
            VRMoov_SetEmbeddedMovieWidth(myWindowObject, QTVRUtils_DegreesToRadians(10.0));
            QTVRUpdate((**myWindowObject).fInstance, kQTVRCurrentMode);
            myIsHandled = true;
            break;
        ...
        case IDM_USE_BUFFER: {
            ...
            if (myAppData == NULL)
                break;
            (**myAppData).fUseOffscreenGWorld = !(**myAppData).fUseOffscreenGWorld;
            myIsHandled = true;
            break;
        }
...
void QTApp_RemoveWindowObject (WindowObject theWindowObject)
{
    ...
    if (myAppData != NULL) {
        VRMoov_DumpWindowData(theWindowObject);
