...
source_url: https://developer.apple.com/library/archive/samplecode/vrmovies.win/Listings/Application_Files_ComResource_h.html
archived_at: '2026-07-26T19:53:00.959579Z'
---
...
#define IDM_LOAD_MOVIE                  33537   //((kTestMenuResID<<8)+(1))
#define IDM_SET_CENTER                  33539   //((kTestMenuResID<<8)+(3))
#define IDM_SET_WIDTH                   33540   //((kTestMenuResID<<8)+(4))
#define IDM_SET_SCALE                   33541   //((kTestMenuResID<<8)+(5))
#define IDM_SPIN_MOVIE                  33542   //((kTestMenuResID<<8)+(6))
#define IDM_USE_BUFFER                  33544   //((kTestMenuResID<<8)+(8))
#define IDM_USE_WND_CENTER              33545   //((kTestMenuResID<<8)+(9))
#define IDM_COMPOSITE                   33546   //((kTestMenuResID<<8)+(10))
#define IDM_SET_CHROMA                  33548   //((kTestMenuResID<<8)+(12))
