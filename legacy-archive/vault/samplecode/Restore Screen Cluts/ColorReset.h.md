...
source_url: https://developer.apple.com/library/archive/samplecode/Restore_Screen_Cluts/Listings/ColorReset_h.html
archived_at: '2026-07-18T03:22:10.667272Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Restore Screen Cluts](Restore%20Screen%20Cluts.md)


[Next](EmergMem.c.md)[Previous](ColorReset.c.md)
...
#define rSaveAlertID     6012 /* Resource ID of Save/Cancel/DonÕt Save alert */

/* Button item numbers */
#define kSaveButton       1 /* Item number of Save button */
#define kCancelSaveButton 2 /* Item number of Cancel button for saves */
#define kDontSaveButton   3 /* Item number of DonÕt Save button */
...
* activated.  ItÕs FALSE if the window is becoming inactive.
\******************************************************************************/
...
* believe that itÕs the best that can be done.  ThereÕs no reliable way to tell
...
* ÒDrawing Into an Off-Screen BitMap.
\******************************************************************************/
...
* GrafPort itself are normal non-relocatable blocks of memory, so theyÕre just
...
* already have the default set of colors are unaffected.  ItÕs assumed that
...
* quits.  ItÕs assumed that Color QuickDraw is available, and 32-Bit QuickDraw
