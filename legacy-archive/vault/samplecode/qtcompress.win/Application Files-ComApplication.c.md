...
source_url: https://developer.apple.com/library/archive/samplecode/qtcompress.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:52:29.319772Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [qtcompress.win](qtcompress.win.md)


[Next](Application%20Files-ComApplication.h.md)[Previous](qtcompress.win.md)
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    myWindow = (**myWindowObject).fWindow;
...
#pragma unused(theMenu)
    ...
    if (myWindowObject == NULL) {
        QTFrame_SetMenuItemState(myMenu, IDM_COMPRESS, kDisableMenuItem);
    } else {
        QTFrame_SetMenuItemState(myMenu, IDM_COMPRESS, kEnableMenuItem);
    }
}
...
Boolean QTApp_HandleEvent (EventRecord *theEvent)
{
    ...
    DialogItemIndex     myItem;
    Boolean             myEventHandled = false;

    if (IsDialogEvent(theEvent)) {
        if (theEvent->what == updateEvt)
            myEventHandled = DialogSelect(theEvent, &myDialog, &myItem);
    }
