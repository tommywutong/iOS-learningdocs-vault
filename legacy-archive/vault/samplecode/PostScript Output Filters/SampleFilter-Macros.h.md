...
source_url: https://developer.apple.com/library/archive/samplecode/PostScript_Output_Filters/Listings/SampleFilter_Macros_h.html
archived_at: '2026-07-18T03:19:26.787400Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [PostScript Output Filters](PostScript%20Output%20Filters.md)


[Next](SampleFilter-NoDebug.h.md)[Previous](SampleFilter-LibraryStuff-PSStreams.h.md)

# SampleFilter/Macros.h

```
/*
**  File:           Macros.h
**
**  Description:    Some useful macros for use with the SampleFilter code.
**
**  Version:        
**
