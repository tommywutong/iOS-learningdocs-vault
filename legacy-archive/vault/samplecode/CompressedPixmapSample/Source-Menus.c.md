...
source_url: https://developer.apple.com/library/archive/samplecode/CompressedPixmapSample/Listings/Source_Menus_c.html
archived_at: '2026-07-18T03:04:10.916160Z'
---
...
void HandleFileChoice(short theItem)
{
    ...
    {
        case    SAVE_ITEM:
                Save3DMFModel(&gModelViewInfo, nil, DrawTheGeometry);
                break;              
