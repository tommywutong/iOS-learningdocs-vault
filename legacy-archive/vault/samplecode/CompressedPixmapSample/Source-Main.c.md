...
source_url: https://developer.apple.com/library/archive/samplecode/CompressedPixmapSample/Listings/Source_Main_c.html
archived_at: '2026-07-18T03:04:10.863874Z'
---
...
long response;
    ...
    {   
        ...
        if (response < 0x10500)                     // must be using 1.6 or better
        {
err:        
            DoFatalAlert("\pQuickDraw 3D version 1.6 or better is required to run this application!");
        }
