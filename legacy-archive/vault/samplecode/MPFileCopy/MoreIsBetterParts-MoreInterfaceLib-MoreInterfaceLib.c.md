---
title: MPFileCopy
apple_id: DTS10000475
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-01-14'
source_url: https://developer.apple.com/library/archive/samplecode/MPFileCopy/Listings/MoreIsBetterParts_MoreInterfaceLib_MoreInterfaceLib_c.html
archived_at: '2026-07-18T03:13:57.633578Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MPFileCopy](MPFileCopy.md)


[Next](MoreIsBetterParts-MoreInterfaceLib-MoreInterfaceLib.h.md)[Previous](ReadMe.html.md)

# MoreIsBetterParts/MoreInterfaceLib/MoreInterfaceLib.c
                                 ...
                                 FCBRecPtr *            fileCtrlBlockPtr)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppUTLocateFCBProcInfo == 0x03FFE8);
                                 ...
                                 FCBRecPtr *            fileCtrlBlockPtr)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppUTLocateNextFCBProcInfo == 0x03FFE8);
                                 ...
                                 FCBRecPtr *            fileCtrlBlockPtr)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppUTIndexFCBProcInfo == 0x03FE8);
                                 ...
                                 FCBRecPtr *            fileCtrlBlockPtr)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppUTResolveFCBProcInfo == 0x0EE8);
                                     ...
                                     unsigned long *        actSize)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppDIXFormatProcInfo == 0x0000F6AE);
                                     ...
                                     void *                 extendedInfoPtr)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppDIXZeroProcInfo == 0x003EAEAE);
                                     ...
                                     ConstStr255Param       msgText)
{
    ...
    #endif
        {
            ...
            MoreAssert(uppDIReformatProcInfo == 0x0000FAAE);
