...
source_url: https://developer.apple.com/library/archive/samplecode/Box/Listings/BoxShell_c.html
archived_at: '2026-07-18T03:02:13.585227Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Box](Box.md)


[Next](BoxShell.h.md)[Previous](Box3DSupport.h.md)
...
void MainEventLoop()
{
    ...
    while( !gQuitFlag )
    {
        if (WaitNextEvent( everyEvent, &event, 0, nil ))
        {
            ...
            Q3Matrix4x4_SetRotate_XYZ(&tmp, 0.05, 0.06, 0.04);
