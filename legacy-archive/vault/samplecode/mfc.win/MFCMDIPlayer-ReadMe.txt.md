...
source_url: https://developer.apple.com/library/archive/samplecode/mfc.win/Listings/MFCMDIPlayer_ReadMe_txt.html
archived_at: '2026-07-18T03:29:51.865769Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [mfc.win](mfc.win.md)


[Next](MFCMDIPlayer-Resource.h.md)[Previous](MFCMDIPlayer-MFCMDIPlayerView.h.md)

# MFCMDIPlayer/ReadMe.txt

```
========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : MFCMDIPlayer
========================================================================


AppWizard has created this MFCMDIPlayer application for you.  This application
