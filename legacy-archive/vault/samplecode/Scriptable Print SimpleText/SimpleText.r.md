...
source_url: https://developer.apple.com/library/archive/samplecode/Scriptable_Print_SimpleText/Listings/SimpleText_r.html
archived_at: '2026-07-18T03:23:30.916081Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Scriptable Print SimpleText](Scriptable%20Print%20SimpleText.md)


[Next](TextDrag.c.md)[Previous](SimpleText.h.md)
...
// Codewarrior rez doesn't let us specify this on the command line
...
resource 'MENU' (mEdit, EDITMENU, preload) {
    ...
    enabled, EDITMENU,
    {
        ...
        FINDSELECTIONITEM, noicon,      FINDSELECTIONKEY, nomark, plain;
...
resource 'WIND' (kDefaultWindowID) {
    {40, 40, 215, 400}, zoomDocProc, invisible, goAway, 0, NEWDOCUMENTTITLE, noAutoCenter
};
...
resource 'DITL' (kFindWindowID, purgeable) {
    {   
        /* [1] */
        {BUTTONY, 278, BUTTONY+20, 350},
            Button { enabled, FINDBUTTON },

        /* [2] */
        {BUTTONY, 195, BUTTONY+20, 265},
...
resource 'DITL' (kReplaceWindowID, purgeable) {
    {   
        /* [1] */
        {BUTTONY, 280, BUTTONY+20, 352},
            Button { enabled, REPLACEBUTTON },

        /* [2] */
        {BUTTONY, 197, BUTTONY+20, 267},
            Button { enabled, FINDCANCELBUTTON },
...
resource 'BNDL' (128) {
    'ttxt', 0, {
        'ICN#', {0,128; 1,129; 2,130; 3,131; 4,132; 5,133; 6,134; 7,135; 8,136; 9,134; 10,138; };
        'FREF', {0,128; 1,129; 2,130; 3,131; 4,132; 5,133; 6,134; 7,135; 8,136; 9,137; 10,138; }
    }
};
...
resource 'FREF' (131) { 'PICT', 3, "" };
resource 'FREF' (132) { 'sEXT', 4, "" };
resource 'FREF' (133) { 'MooV', 5, "" };
resource 'FREF' (134) { 'tjob', 6, "" };
resource 'FREF' (135) { 'qjob', 7, "" };
resource 'FREF' (136) { 'sjob', 8, "" };
resource 'FREF' (138) { '3DMF', 10, "" };

// these share icons with the 'tjob'
resource 'FREF' (137) { 'rjob', 9, "" };
