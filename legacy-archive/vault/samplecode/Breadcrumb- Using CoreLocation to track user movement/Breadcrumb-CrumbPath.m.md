...
source_url: https://developer.apple.com/library/archive/samplecode/Breadcrumb/Listings/Breadcrumb_CrumbPath_m.html
archived_at: '2026-07-27T06:57:01.853034Z'
---
...
[Next](Breadcrumb-SettingsKeys.h.md)[Previous](Breadcrumb-BreadcrumbAppDelegate.h.md)

# Breadcrumb/CrumbPath.m
...
- (instancetype)init
{
    NSAssert(NO, @"Invalid use of init; use initWithCenterCoordinate");
    return [self init];
}
...
- (MKMapRect)growOverlayBounds:(MKMapRect)overlayBounds toInclude:(MKMapRect)otherRect
{
    ...
    //
    double oneKilometerInMapPoints =
        1000 * MKMapPointsPerMeterAtLatitude(MKCoordinateForMapPoint(otherRect.origin).latitude);
