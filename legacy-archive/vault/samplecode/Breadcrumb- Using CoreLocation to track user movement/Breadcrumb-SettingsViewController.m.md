...
source_url: https://developer.apple.com/library/archive/samplecode/Breadcrumb/Listings/Breadcrumb_SettingsViewController_m.html
archived_at: '2026-07-27T06:57:01.921739Z'
---
...
[Next](Breadcrumb-BreadcrumbAppDelegate.m.md)[Previous](Breadcrumb-BreadcrumbViewController.m.md)

# Breadcrumb/SettingsViewController.m
...
/*
 ...
 Abstract:
 Handles configuring location tracking and other options.
 */
...
- (NSDictionary *)accuracyTitleAndValueForRow:(NSInteger)row
{
    ...
    return @{kAccuracyTitleKey: title, kAccuracyValueKey: @(accuracyValue)};
}
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    // ultimately calling BreadcrumbViewController's - (void)settingsDidChange:(NSNotification *)notification.
    //
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([option isKindOfClass:[AccuracyPickerOption class]])
    {
        PickerOptionTableViewCell *pickerCell =
            (PickerOptionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:PickerOptionCellID];
    ...
    {
        SwitchOptionTableViewCell *switchCell =
            (SwitchOptionTableViewCell *)[tableView dequeueReusableCellWithIdentifier:SwitchOptionCellID];
