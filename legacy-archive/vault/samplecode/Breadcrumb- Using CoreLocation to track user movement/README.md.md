...
source_url: https://developer.apple.com/library/archive/samplecode/Breadcrumb/Listings/README_md.html
archived_at: '2026-07-27T06:57:01.822980Z'
---
...
[Next](Breadcrumb-CrumbPathRenderer.m.md)[Previous](Breadcrumb-main.m.md)
...
Demonstrates how to draw a path using the `MapKit` overlay, `MKOverlayView`, that follows and tracks the user's current location.  The included `CrumbPath` and `CrumbPathView` overlay and overlay view classes can be used for any path of points that are expected to change over time.
