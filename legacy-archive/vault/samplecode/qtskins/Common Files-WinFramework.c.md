...
source_url: https://developer.apple.com/library/archive/samplecode/qtskins/Listings/Common_Files_WinFramework_c.html
archived_at: '2026-07-26T19:52:47.459061Z'
---
...
extern Boolean QTSkin_IsSkinnedMovie (Movie theMovie);
    ...
    switch (theMessage) {
        ...
        case WM_LBUTTONDOWN:
            ...
            if (QTSkin_IsSkinnedMovie(myMovie))
                if (QTApp_HandleEvent(&myMacEvent)) {
