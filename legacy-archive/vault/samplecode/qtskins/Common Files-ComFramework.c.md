...
source_url: https://developer.apple.com/library/archive/samplecode/qtskins/Listings/Common_Files_ComFramework_c.html
archived_at: '2026-07-26T19:52:47.163247Z'
---
...
gotImageFile:
    ...
    if (QTSkin_IsSkinnedMovie(myMovie))
        myWindow = QTSkin_CreateSkinsWindow(myMovie);
    else
#endif
