...
source_url: https://developer.apple.com/library/archive/samplecode/HTMLSample/Listings/RenderingWindow_c.html
archived_at: '2026-07-18T03:11:38.718918Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [HTMLSample](HTMLSample.md)


[Next](RenderingWindow.h.md)[Previous](HTMLSample.r.md)
...
void RWActivate(WindowPtr rWin, Boolean activate) {
    ...
    Rect r, windowBounds;
        /* set up locals */
    rwv = (RWindowHandle) GetWRefCon(rWin);
        /* verify we're making a change */
        if ((**rwv).isActive != activate) {
