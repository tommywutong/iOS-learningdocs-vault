...
source_url: https://developer.apple.com/library/archive/samplecode/CreateMovie/Listings/Common_Files_ComFramework_h.html
archived_at: '2026-07-18T03:05:09.917798Z'
---
...
//     
//     <3>      05/01/01    srk     made changes to get things running under Mac OS X
...
//////////
    ...
    #if TARGET_OS_WIN32
        #include <WinPrefix.h>
    #elif TARGET_OS_MAC || defined(__APPLE_CC__)
        #include <MacPrefix.h>
    #endif
#endif
...
#else
    enum { sigMoviePlayer = FOUR_CHAR_CODE('TVOD')};
#endif
...
void                        QTApp_Draw (WindowReference theWindow, Rect *theRefrehArea);
