...
source_url: https://developer.apple.com/library/archive/samplecode/CreateMovie/Listings/Start_Code_CreateMovie_c.html
archived_at: '2026-07-18T03:05:12.844504Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CreateMovie](CreateMovie.md)


[Next](Start%20Code-QTFlatten.c.md)[Previous](Completed%20Lab-QTVideo.h.md)
...
// Step 2.
// Build CreateMyVideoTrack function in QTVideo.c
        QTVideo_CreateMyVideoTrack(theMovie);

// Step 3.
// Build CreateMySoundTrack function in QTSound.c
...
// Step 4.
// Insert "AddMediaResource.clp" here
