...
source_url: https://developer.apple.com/library/archive/samplecode/SimpleGestureRecognizers/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:24:02.704433Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Simple Gesture Recognizers](Simple%20Gesture%20Recognizers.md)


[Next](SimpleGestureRecognizers-APLGestureRecognizerViewController.h.md)[Previous](Simple%20Gesture%20Recognizers.md)
...
The functionality is implemented in the GestureRecognizerViewController class -- a view controller that manages a view and gesture recognizers.
