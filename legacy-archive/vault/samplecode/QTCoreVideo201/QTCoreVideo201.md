...
source_url: https://developer.apple.com/library/archive/samplecode/QTCoreVideo201/Introduction/Intro.html
archived_at: '2026-07-18T03:20:25.557024Z'
---
...
|  |  |
| --- | --- |
| __Last Revision:__ | Version 3.1, 2011-06-27 Removed duplicate references in the Xcode project. Removed obsolete build settings in the Xcode project. [(Full Revision History)](Document%20Revision%20History.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaydonzygqwvezlwnfzws33ojbuxg5dpoj4s2rdpnz2ey2lonncwyzlnmvxhiskel4yq) |
| __Build Requirements:__ | Xcode 4 |
| __Runtime Requirements:__ | Snow Leopard 10.6 |

QTCoreVideo201 is a Cocoa sample demonstrating how to render a QuickTime Movie using OpenGL frame buffer objects, QuickTime visual context, and the Core Video pixel buffer pipeline.

This is the third application in the series that includes QTCoreVideo102, QTCoreVideo103, QTCoreVideo202, and Denoise that leverage a common graphics and media utility toolkits for Snow Leopard.
