---
title: QTVector
apple_id: DTS10000987
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-01-14'
source_url: https://developer.apple.com/library/archive/samplecode/QTVector/Listings/README_txt.html
archived_at: '2026-07-18T03:21:21.557590Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [QTVector](QTVector.md)


[Next](src-QTVector.java.md)[Previous](QTVector.md)

# README.txt

```
=============================================================================
QuickTime for Java SDK                              Updated: 12 May 1999

Read Me Notes to "QTVector" Demo and Sample Code
...
Currently we build the image Data by constructing raw atoms representing the point data. QuickTime 4.0 added
API's that simplify this tremendously, however those API's are not currently accessible from QTJava. Support for  
