...
source_url: https://developer.apple.com/library/archive/samplecode/CopyBits_vs._CopyMask/Listings/Sample_h.html
archived_at: '2026-07-18T03:04:19.749011Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CopyBits vs. CopyMask](CopyBits%20vs.%20CopyMask.md)


[Next](SampleInit.c.md)[Previous](Sample.c.md)
...
#include <Dialogs.h>
#include <Fonts.h>
/* In MPW 3.0 and THINK C we can use actual prototypes for parameter type checking. */
...
#define rWindow     1000            /* application's window */
