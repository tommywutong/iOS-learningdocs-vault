---
title: CardFlip
apple_id: DTS40007646
resource_type: Sample Code
platform: Safari|iOS
topic: null
technology: null
published: '2008-06-19'
source_url: https://developer.apple.com/library/archive/samplecode/CardFlip/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:03:17.838045Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CardFlip](CardFlip.md)


[Next](CardFlip.css.md)[Previous](CardFlip.md)
...
Using the Sample
Place this sampleÕs files on your own webserver (eg. Mac OS X Personal Web Server). Open index.html in an iPhone or iPod touch running OS 2.0 or iPhone Simulator with iPhone OS 2.0 (/Developer/Platforms/AspenSimulator.platform/Developer/Applications).  Tap anywhere on the card to see it flipped. 
