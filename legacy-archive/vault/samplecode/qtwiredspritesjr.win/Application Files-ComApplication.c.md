...
source_url: https://developer.apple.com/library/archive/samplecode/qtwiredspritesjr.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:53:31.451335Z'
---
...
#pragma unused(theMenu)
    ...
    QTFrame_SetMenuItemState(myMenu, IDM_ADD_CONTROLS_TO_MOVIE, myMC == NULL ? kDisableMenuItem : kEnableMenuItem);
}
