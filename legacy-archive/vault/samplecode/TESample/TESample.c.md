...
source_url: https://developer.apple.com/library/archive/samplecode/TESample/Listings/TESample_c.html
archived_at: '2026-07-18T03:26:03.574929Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [TESample](TESample.md)


[Next](TESample.h.md)[Previous](TCTESampleGlue.c.md)
...
#else
   void CVActionProc(ControlHandle control, short part)
#endif
{
    short       amount;
    WindowPtr   window;
...
#else
   void CHActionProc(ControlHandle control, short part)
#endif
{
    short       amount;
    WindowPtr   window;
