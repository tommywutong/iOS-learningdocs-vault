...
source_url: https://developer.apple.com/library/archive/samplecode/SoundPlayer.win/Listings/Common_Files_ComFramework_c.html
archived_at: '2026-07-18T03:25:05.544498Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SoundPlayer.win](SoundPlayer.win.md)


[Next](Common%20Files-ComFramework.h.md)[Previous](AtomInfo.h.md)
...
void QTFrame_ConvertMacToWinMenuItemLabel (MovieController theMC, MenuReference theWinMenu, long theModifiers, UInt16 theMenuItem)
{
    ...
    myLabelText = (char *)malloc(myLabelSize);
    if (myLabelText == NULL)
        return;
