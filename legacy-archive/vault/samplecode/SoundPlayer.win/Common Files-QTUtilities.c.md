...
source_url: https://developer.apple.com/library/archive/samplecode/SoundPlayer.win/Listings/Common_Files_QTUtilities_c.html
archived_at: '2026-07-18T03:25:06.224375Z'
---
...
char *QTUtils_GetTrackName (Track theTrack)
{
    ...
    if (myUserData != NULL) {
        ...
        if (myErr == noErr) {
            ...
            if (myLength > 0) {
                myString = (char *)malloc(myLength + 1);
                if (myString != NULL) {
...
char *QTUtils_MakeTrackNameByType (Track theTrack)
{
    ...
    if (myMedia != NULL) {
        ...
        if (myErr == noErr) {
            ...
            if (myName[0] > 0) {
                myString = (char *)malloc(myName[0] + 1);
                if (myString != NULL) {
