...
source_url: https://developer.apple.com/library/archive/samplecode/SoundPlayer.win/Listings/Common_Files_WinPrefix_h.html
archived_at: '2026-07-18T03:25:07.121979Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SoundPlayer.win](SoundPlayer.win.md)


[Next](MacApplication.r.md)[Previous](Common%20Files-WinFramework.h.md)
...
// if we're being compiled by Microsoft Visual C++, turn off some warnings
    ...
    #pragma warning(disable:4390)       // ignore empty control statement
    #pragma warning(disable:4065)       // ignore case statement with default but no 'case' labels
#endif
