...
source_url: https://developer.apple.com/library/archive/samplecode/SoundPlayer.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-18T03:25:05.226798Z'
---
...
//          OSType              myTypeList[] = {kQTFileTypeMovie,kQTFileTypeSystemSevenSound};
            FSSpec              myFSSpec;
            OSErr               myErr = noErr;

            // elicit a new sound file from the user
            myErr = QTFrame_GetOneFileWithPreview(0, NULL/*(QTFrameTypeListPtr)myTypeList*/, &myFSSpec, NULL);
            if (myErr == noErr)
            {
                OSErr err = DoPlaySound(&myFSSpec);
            }
