...
source_url: https://developer.apple.com/library/archive/samplecode/MacCalendar/Listings/MacCalendar_r.html
archived_at: '2026-07-18T03:14:08.415847Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MacCalendar](MacCalendar.md)


[Next](MacCalendarCommon.h.md)[Previous](MacCalendar.h.md)
...
resource 'STR#' (STRN_Info) {
    {
        "MacCalendar\n\n"
            "This Control Strip module displays the current monthÕs calendar",
...
resource 'hfdr' (kHMHelpID) {
    HelpMgrVersion, hmDefaultOptions, 0, 0,
    {
        HMStringItem    {
            "MacCalendar\n\n"
             "This Control Strip module draws this monthÕs calendar.  To use this"
