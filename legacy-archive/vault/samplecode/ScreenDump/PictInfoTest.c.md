...
source_url: https://developer.apple.com/library/archive/samplecode/ScreenDump/Listings/PictInfoTest_c.html
archived_at: '2026-07-18T03:23:26.476336Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [ScreenDump](ScreenDump.md)


[Next](RubberBandit.c.md)[Previous](DumpScreen.c.md)
...
//--------------------------- T E S T   R O U T I N E ---------------------------------
            if( menuItem == 1 ) {
                ...
                PicHandle DumpScreenArea( Rect *area ) ;        // prototype
                ...
                thePicture = DumpScreenArea( &area ) ;
