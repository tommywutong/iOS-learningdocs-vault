...
source_url: https://developer.apple.com/library/archive/samplecode/vrbackbuffer.win/Listings/Application_Files_ComResource_h.html
archived_at: '2026-07-26T19:52:55.466842Z'
---
...
#define IDM_ROT_PICT_HORIZ_OFF          33537   // ((kTestMenuResID<<8)+(1))
#define IDM_ROT_PICT_HORIZ_ON           33538   // ((kTestMenuResID<<8)+(2))
#define IDM_NORM_PICT_HORIZ_ON          33539   // ((kTestMenuResID<<8)+(3))
#define IDM_NORM_PICT_HORIZ_OFF         33540   // ((kTestMenuResID<<8)+(4))
#define IDM_UNINSTALL_BBUF              33541   // ((kTestMenuResID<<8)+(5))
#define IDM_AM_I_HORIZ                  33543   // ((kTestMenuResID<<8)+(7))
