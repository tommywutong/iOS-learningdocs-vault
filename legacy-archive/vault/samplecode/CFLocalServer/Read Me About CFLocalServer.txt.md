...
source_url: https://developer.apple.com/library/archive/samplecode/CFLocalServer/Listings/Read_Me_About_CFLocalServer_txt.html
archived_at: '2026-07-18T03:02:27.611043Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CFLocalServer](CFLocalServer.md)


[Next](Server.c.md)[Previous](Protocol.h.md)

# Read Me About CFLocalServer.txt
