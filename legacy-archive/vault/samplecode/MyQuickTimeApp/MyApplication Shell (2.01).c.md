...
source_url: https://developer.apple.com/library/archive/samplecode/MyQuickTimeApp/Listings/MyApplication_Shell__2_01__c.html
archived_at: '2026-07-18T03:16:43.237055Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MyQuickTimeApp](MyQuickTimeApp.md)


[Next](MyApplication%20Shell%20%282.01%29.h.md)[Previous](MyQuickTimeApp.md)

# MyApplication Shell (2.01).c

```c
/*
    File:       MyApplication Shell (2.01).c
    ...
    Change History (most recent first):
        ...
        <2>     04/19/94    JW      Added changes to init routine to create large master pointer blocks.
...
void Initialize()
{
    ...
    MaxApplZone();
    curZone = LMGetTheZone();
    oldMoreMast = curZone->moreMast;
