...
source_url: https://developer.apple.com/library/archive/samplecode/qtvectors.win/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:53:10.412573Z'
---
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        ...
        case IDM_CREATE_VECTOR_MOVIE_RAW:
            QTVectors_CreateVectorMovie(kUseRawDataStream);
            myIsHandled = true;
            break;

        case IDM_CREATE_VECTOR_MOVIE_UTIL:
            QTVectors_CreateVectorMovie(kUseCurveUtilities);
            myIsHandled = true;
            break;
...
#pragma unused(theMenu)
    ...
    QTFrame_SetMenuItemState(myMenu, IDM_CREATE_VECTOR_MOVIE_RAW, kEnableMenuItem);
    QTFrame_SetMenuItemState(myMenu, IDM_CREATE_VECTOR_MOVIE_UTIL, kEnableMenuItem);
}
