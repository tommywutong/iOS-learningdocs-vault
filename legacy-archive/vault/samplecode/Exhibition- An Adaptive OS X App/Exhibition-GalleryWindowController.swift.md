...
source_url: https://developer.apple.com/library/archive/samplecode/Exhibition/Listings/Exhibition_GalleryWindowController_swift.html
archived_at: '2026-07-18T03:08:00.657198Z'
---
...
[Next](Exhibition-AppDelegate.swift.md)[Previous](Exhibition-ImageCollectionViewItem.swift.md)

# Exhibition/GalleryWindowController.swift
...
class GalleryWindowController: NSWindowController {
    ...
    */
    lazy var sidebarController: ImageCollectionListController = {
        ...
        */
        let desktopPicturesURL = URL(fileURLWithPath: "/Library/Desktop Pictures/", isDirectory: true)
    ...
    */
    ...
    @IBAction func addImageCollection(_ sender: AnyObject?) {
