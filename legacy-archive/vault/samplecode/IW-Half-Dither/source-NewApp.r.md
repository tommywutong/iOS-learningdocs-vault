...
source_url: https://developer.apple.com/library/archive/samplecode/IW-Half-Dither/Listings/source_NewApp_r.html
archived_at: '2026-07-18T03:12:13.176918Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [IW-Half-Dither](IW-Half-Dither.md)


[Next](source-NewDriverProtos.h.md)[Previous](source-NewApp.c.md)
...
resource 'idft' (gxPrintingDriverBaseID, sysheap, purgeable) {
    ...
    noBack,     rawChar,    $45;    Back,       rawChar,    $27;        // 
...
```
    ...
    noBack,     Italian,    $7B;    noBack,     rawChar,    noChar;     // 
    noBack,     rawChar,    $61;    Back,       rawChar,    $5E;        // 
    noBack,     German,     $7B;    noBack,     rawChar,    noChar;     // 
    noBack,     rawChar,    $61;    Back,       rawChar,    $7E;        // 
    noBack,     Danish,     $7D;    noBack,     rawChar,    noChar;     // 
    noBack,     French,     $5C;    noBack,     rawChar,    noChar;     // 
    noBack,     French,     $7B;    noBack,     rawChar,    noChar;     // 
    ...
    noBack,     Swedish,    $7C;    noBack,     rawChar,    noChar;     // 
    noBack,     rawChar,    $6F;    Back,       rawChar,    $7E;        // 
    noBack,     rawChar,    $75;    Back,       rawChar,    $27;        // 
    noBack,     French,     $7C;    noBack,     rawChar,    noChar;     // 
    noBack,     rawChar,    $75;    Back,       rawChar,    $5E;        // 
    noBack,     German,     $7D;    noBack,     rawChar,    noChar;     // 
