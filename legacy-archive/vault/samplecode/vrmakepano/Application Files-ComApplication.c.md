...
source_url: https://developer.apple.com/library/archive/samplecode/vrmakepano/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:52:58.507712Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [vrmakepano](vrmakepano.md)


[Next](Application%20Files-ComApplication.h.md)[Previous](vrmakepano.md)
...
//
//     <2>      03/21/00    rtm     made changes to get things running under CarbonLib
...
extern UInt32           gVersionToCreate;                       // the version of the file format we create
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        case IDM_MAKE_PANO_MOVIE:
            if (gVersionToCreate == kCubicQTVR)
                VRPano_PromptUserForFacesFileAndMakeCubic();    // make a cubic movie
            else
                VRPano_PromptUserForImageFileAndMakeMovie();    // make a version 1 or 2 cylindrical movie
            myIsHandled = true;
            break;

        case IDM_CREATE_VERSION_1x0:
            gVersionToCreate = kQTVRVersion1;
            myIsHandled = true;
            break;

        case IDM_CREATE_VERSION_2x0:
            gVersionToCreate = kQTVRVersion2;
            myIsHandled = true;
            break;

        case IDM_CREATE_CUBIC_MOVIE:
            gVersionToCreate = kCubicQTVR;
            myIsHandled = true;
            break;
...
#pragma unused(theMenu)
    ...
    QTFrame_SetMenuItemCheck(myMenu, IDM_CREATE_VERSION_1x0, (gVersionToCreate == kQTVRVersion1));
    QTFrame_SetMenuItemCheck(myMenu, IDM_CREATE_VERSION_2x0, (gVersionToCreate == kQTVRVersion2));
    QTFrame_SetMenuItemCheck(myMenu, IDM_CREATE_CUBIC_MOVIE, (gVersionToCreate == kCubicQTVR));
}
