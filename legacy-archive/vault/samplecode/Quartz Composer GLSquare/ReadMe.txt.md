...
apple_id: DTS40009318
resource_type: Sample Code
platform: macOS
topic: Graphics & Animation
technology: Quartz
published: '2009-10-27'
source_url: https://developer.apple.com/library/archive/samplecode/GLSquare/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:10:31.317300Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Quartz Composer GLSquare](Quartz%20Composer%20GLSquare.md)


[Next](GLSquarePlugIn.h.md)[Previous](Quartz%20Composer%20GLSquare.md)
...
GLSquare                    A Quartz Composer plug-in that renders a colored square.
...
About the sample                A Quartz Composer plug-in that implements a custom 
                        consumer patch that renders a square using OpenGL.
...
Using the Sample                Open the project using the Xcode editor which can be found 
                        ...
                        The image connected to the input parameter "Image" is 
                        displayed in a quad. The image color and location can be 
                        set in the plug-in input parameters "Color", "X Position" 
                        and "Y Position".
