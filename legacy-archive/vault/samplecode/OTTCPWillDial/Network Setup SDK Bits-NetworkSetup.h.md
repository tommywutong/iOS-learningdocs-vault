...
source_url: https://developer.apple.com/library/archive/samplecode/OTTCPWillDial/Listings/Network_Setup_SDK_Bits_NetworkSetup_h.html
archived_at: '2026-07-18T03:17:25.677578Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [OTTCPWillDial](OTTCPWillDial.md)


[Next](Network%20Setup%20SDK%20Bits-NetworkSetupBigPicture.html.md)[Previous](OTTCPWillDial.md)

# Network Setup SDK Bits/NetworkSetup.h
...
/*
    ...
    Sets the current area. If the area doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    Deletes the specified area. If the area doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    making this call. If either area doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
/*  -------------------------------------------------------------------------
...
/*
    ...
    Opens the specified area for reading. If the area doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    Closes an area opened for reading. If the area doesnÕt exist kCfgAreaNotFoundErr is returned.  
...
/*
    ...
    access the original unmodified data. If the area doesnÕt exist kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    area.  If the area doesnÕt exist or the wrong id is passed, kCfgAreaNotFoundErr is returned.
*/
EXTERN_API( OSStatus )
...
/*
    ...
    the original area. If the area doesnÕt exist or the wrong id is passed kCfgAreaNotFoundErr is 
    returned.
*/
/*
...
/*
    ...
    the area doesnÕt exist or the wrong id is passed kCfgAreaNotFoundErr is returned.
*/
...
/*
    ...
    enough to hold count entries. If the area doesnÕt exist or the wrong id is passed 
...
/*
    ...
    area doesnÕt exist or the wrong id is passed kCfgAreaNotFoundErr is returned. If there is already 
...
/*
    ...
    Duplicates the specified entity. Both entities should exit. If any entity doesnÕt exist 
...
/*
    ...
    Renames the specified entity. If the entity doesnÕt exist kCfgEntityNotfoundErr is returned. If 
