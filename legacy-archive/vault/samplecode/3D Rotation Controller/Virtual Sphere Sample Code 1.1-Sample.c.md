...
source_url: https://developer.apple.com/library/archive/samplecode/3D_Rotation_Controller/Listings/Virtual_Sphere_Sample_Code_1_1_Sample_c.html
archived_at: '2026-07-18T02:59:14.973526Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [3D Rotation Controller](3D%20Rotation%20Controller.md)


[Next](Virtual%20Sphere%20Sample%20Code%201.1-Sample.h.md)[Previous](Virtual%20Sphere%20Sample%20Code%201.1-Offscreen.h.md)

# Virtual Sphere Sample Code 1.1/Sample.c
...
/*void DoContentClick( WindowPtr window );                              <MC> */
            ...
            switch ( part ) {
                ...
                case inContent:
                    if ( window != FrontWindow() ) {
                        ...
                        DoContentClick(window, event);      /* <MC> */
                    break;
                case inDrag:                /* pass screenBits.bounds to get all gDevices */
                    DragWindow(window, event->where, &qd.screenBits.bounds);
                    InvalRect(&window->portRect);   /* Causes a check to see if GWorld needs to be reallocated <MC> */
                    break;
                case inGrow:
                    InvalRect(&window->portRect);   /* Causes a check to see if GWorld needs to be reallocated <MC> */
                    break;
    ...
    long        menuResult;
{
    ...
    DoAdditionalMenuCommand (menuResult);   /* New <MC> */
...
void Initialize()
{
    ...
    /* New code to quit if system configuration is not right <MC> */
    ...
    if (gMac.hasColorQD) {                                      /* Color window if possible <MC> */
        window = (WindowPtr) NewPtr(sizeof(CWindowRecord));
    ...
    Initialize3D (window);      /* Initialize Graf3D, etc <MC> */
