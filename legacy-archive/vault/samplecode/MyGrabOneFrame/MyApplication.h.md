...
apple_id: DTS10000328
resource_type: Sample Code
platform: macOS
topic: null
technology: null
published: '2003-01-14'
source_url: https://developer.apple.com/library/archive/samplecode/MyGrabOneFrame/Listings/MyApplication_h.html
archived_at: '2026-07-18T03:16:36.805521Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MyGrabOneFrame](MyGrabOneFrame.md)
...
#define     kMYEVENTDEF         0   //  2 is per window.  1 is once per eventloop.  0 is never.
#define     kMYIDLEDEF          0   //  2 is per window.  1 is once per eventloop.  0 is never.
