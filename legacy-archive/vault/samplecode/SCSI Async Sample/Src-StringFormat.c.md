...
source_url: https://developer.apple.com/library/archive/samplecode/SCSI_Async_Sample/Listings/Src_StringFormat_c.html
archived_at: '2026-07-18T03:22:33.268243Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [SCSI Async Sample](SCSI%20Async%20Sample.md)


[Next](Src-WindowUtilities.c.md)[Previous](Src-SpinCursor.c.md)
    ...
    )
{
         ...
         */     
        sprintf(tempValue, "%.*f", decimalPlaces, value);
        AppendCString(result, tempValue, 255);
}
...
/*
 * AppendPascalString (just pstrcat with a different name).
 */
void
AppendPascalString(
        StringPtr               result,
    ...
    )
{
        ...
        length = 255 - destination[0];
        if (length > source[0])
            length = source[0];
        BlockMove(&source[1], &destination[1] + destination[0], length);
