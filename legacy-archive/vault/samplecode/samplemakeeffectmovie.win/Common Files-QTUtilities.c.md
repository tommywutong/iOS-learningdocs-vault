...
source_url: https://developer.apple.com/library/archive/samplecode/samplemakeeffectmovie.win/Listings/Common_Files_QTUtilities_c.html
archived_at: '2026-07-26T19:52:44.616698Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [samplemakeeffectmovie.win](samplemakeeffectmovie.win.md)


[Next](Common%20Files-QTUtilities.h.md)[Previous](Common%20Files-ComFramework.h.md)
...
//////////
//
// QTUtils_IsPlayAllFramesMovie
// Get the play-all-frames state of a movie file.
//
//////////

Boolean QTUtils_IsPlayAllFramesMovie (Movie theMovie)
{
    UserData        myUserData = NULL;
    Boolean         myPlayAllF = false;
    OSErr           myErr = paramErr;
    ...
    myUserData = GetMovieUserData(theMovie);
    if (myUserData != NULL) {
        myErr = GetUserDataItem(myUserData, &myPlayAllF, sizeof(myPlayAllF), FOUR_CHAR_CODE('AllF'), 0);
        if (myErr != noErr)
            myPlayAllF = false;
    }
