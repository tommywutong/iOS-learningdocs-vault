...
source_url: https://developer.apple.com/library/archive/samplecode/MovieSprites/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-18T03:16:09.029019Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MovieSprites](MovieSprites.md)


[Next](Application%20Files-ComApplication.h.md)[Previous](MovieSprites.md)
...
extern Boolean          gUseBackgroundPicture;
...
void QTApp_SetupWindowObject (WindowObject theWindowObject)
{
    ...
    myAppData = QTSprites_InitWindowData(theWindowObject);
...
#pragma unused(theWindowObject)
    ...
    if (theWindowObject != NULL)
        QTSprites_DumpWindowData(theWindowObject);
...
#pragma unused(theMC, theParams)
    ...
    switch (theAction) {
        ...
        case mcActionMouseDown:
            isHandled = QTSprites_HitTestSprites(myWindowObject, (EventRecord *)theParams);
            break;
