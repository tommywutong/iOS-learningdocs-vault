...
source_url: https://developer.apple.com/library/archive/samplecode/MoofWarsOld/Listings/MoofEncoder_GridTilesFormat_h.html
archived_at: '2026-07-18T03:15:01.999512Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MoofWarsOld](MoofWarsOld.md)


[Next](MoofEncoder-ICL8Encode.cp.md)[Previous](MoofEncoder-GridEncode.h.md)

# MoofEncoder/GridTilesFormat.h

```
/*
    File:       GridTilesFormat.h

    Contains:   This file describes the formats of a TileCollection and a TileGrid.
                We provide them both here so that our applications that build compiled
                files can also access the resource format.
