...
source_url: https://developer.apple.com/library/archive/samplecode/JavaSprites/Listings/src_cdf_CaptureDukeFrame_java.html
archived_at: '2026-07-18T03:13:19.365952Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [JavaSprites](JavaSprites.md)


[Next](src-cdf-MultipleImagePainter.java.md)[Previous](README.txt.md)

# src/cdf/CaptureDukeFrame.java
