...
source_url: https://developer.apple.com/library/archive/samplecode/JavaSprites/Listings/src_cdf_MultipleImagePainter_java.html
archived_at: '2026-07-18T03:13:19.425524Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [JavaSprites](JavaSprites.md)


[Next](src-JavaDuke.java.md)[Previous](src-cdf-CaptureDukeFrame.java.md)

# src/cdf/MultipleImagePainter.java
