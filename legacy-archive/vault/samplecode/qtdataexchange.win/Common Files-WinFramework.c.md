...
source_url: https://developer.apple.com/library/archive/samplecode/qtdataexchange.win/Listings/Common_Files_WinFramework_c.html
archived_at: '2026-07-26T19:52:49.169200Z'
---
            ...
            while (*myCmdLine != '\0') {
                ...
                for (myIndex = 0; *myCmdLine != '\0'; myIndex++, myCmdLine++) {
                    ...
                    if (*myCmdLine == ' ') {
                        ...
                        strcpy_s(myBuffName, MAX_PATH, myTempName);
...
void QTFrame_GetDisplayName (char *thePathName, short bufSize, char *theDispName)
{
    SHFILEINFO          myFileInfo;
    DWORD               myResult;
    ...
    if (myResult != 0) {
        ...
        strcpy_s(theDispName, bufSize, myFileInfo.szDisplayName);
