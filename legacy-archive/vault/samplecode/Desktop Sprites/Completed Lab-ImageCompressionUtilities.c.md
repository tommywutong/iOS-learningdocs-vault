...
source_url: https://developer.apple.com/library/archive/samplecode/Desktop_Sprites/Listings/Completed_Lab_ImageCompressionUtilities_c.html
archived_at: '2026-07-18T03:06:46.600019Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Desktop Sprites](Desktop%20Sprites.md)


[Next](Completed%20Lab-ImageCompressionUtilities.h.md)[Previous](Completed%20Lab-dispsprite.h.md)

# Completed Lab/ImageCompressionUtilities.c
...
OSErr ExtractCompressData( PicHandle thePict, Handle *dataOut, ImageDescriptionHandle *idh )
{
    ...
    SetStdCProcs( &procs );
    procs.newProc1 = (UniversalProcPtr)/*NewStdPixProc*/NewStdPixUPP(extractStdPix);
    SetPortGrafProcs(state.tempPort, &procs);

    state.data = nil;
    state.idh = nil;

    MacSetPort( state.tempPort );
    HidePen();
