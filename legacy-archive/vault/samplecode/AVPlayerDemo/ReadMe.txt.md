...
source_url: https://developer.apple.com/library/archive/samplecode/AVPlayerDemo/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:00:27.443425Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [AVPlayerDemo](AVPlayerDemo.md)


[Next](main.m.md)[Previous](AVPlayerDemo.md)
...
4. Wait until the itemÕs status indicates that itÕs ready to play.
