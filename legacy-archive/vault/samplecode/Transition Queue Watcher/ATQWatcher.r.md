...
source_url: https://developer.apple.com/library/archive/samplecode/Transition_Queue_Watcher/Listings/ATQWatcher_r.html
archived_at: '2026-07-18T03:27:11.839322Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Transition Queue Watcher](Transition%20Queue%20Watcher.md)


[Next](ATQWatcherGlue.a.md)[Previous](ATQWatcher.h.md)
...
resource 'MBAR' (rMenuBar, preload) {
    { mApple, mFile, mEdit, mControl };     /* three menus */
};
...
resource 'MENU' (mControl, preload) {
    mControl, textMenuProc,
    0b0000000000000000000000000000011,  /* enable everything, program does the changing */
    enabled, "Control",
     {
        "Prohibit .MPP Closure",
            noicon, nokey, nomark, plain;
...
resource 'STR#' (kErrStrings, purgeable) {
    ...
    "Cannot do Paste";
    "Cannot install Transition Queue Handler"
    }
};
...
resource 'STR ' (128) {
    ".MPP Open Transition occured at"
};

resource 'STR ' (129) {
    ".MPP Close Transition occured at"
};

resource 'STR ' (130) {
    ".MPP Close Request Transition occured at"
};

resource 'STR ' (131) {
    ".MPP Close Request cancelled at"
};

resource 'STR ' (132) {
    "Network Transition event occured at"
};

resource 'STR ' (133) {
    "Flagship Name Transition occured at"
};

resource 'STR ' (134) {
    "Flagship Name Change requested at"
};

resource 'STR ' (135) {
    "Flagship Name Change cancelled at"
};

resource 'STR ' (136) {
    "Cable Range Transition occured at"
};

resource 'STR ' (137) {
    "CPU Speed Change Transition occured at"
};

resource 'STR ' (138) {
    "New Flagship name is "
};

resource 'STR ' (139) {
    "Reverting Flagship name to "
};

resource 'STR ' (140) {
    "Cable Range begins at "
};
