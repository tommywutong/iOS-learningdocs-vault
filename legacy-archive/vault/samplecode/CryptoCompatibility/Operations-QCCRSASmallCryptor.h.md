...
source_url: https://developer.apple.com/library/archive/samplecode/CryptoCompatibility/Listings/Operations_QCCRSASmallCryptor_h.html
archived_at: '2026-07-18T03:05:20.994060Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CryptoCompatibility](CryptoCompatibility.md)


[Next](Operations-QCCRSASmallCryptorCompat.h.md)[Previous](Operations-QCCPBKDF2SHAKeyDerivation.m.md)

# Operations/QCCRSASmallCryptor.h
...
typedef NS_ENUM(NSInteger, QCCRSASmallCryptorPadding) {
    QCCRSASmallCryptorPaddingPKCS1, 
    QCCRSASmallCryptorPaddingOAEP
};
...
@interface QCCRSASmallCryptor : NSOperation
...
@property (atomic, assign, readwrite) QCCRSASmallCryptorPadding         padding;
