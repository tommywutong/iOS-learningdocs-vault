...
source_url: https://developer.apple.com/library/archive/samplecode/QTCoreVideo102/Introduction/Intro.html
archived_at: '2026-07-18T03:20:04.741310Z'
---
...
|  |  |
| --- | --- |
| __Last Revision:__ | Version 2.1, 2011-06-27 Removed duplicate references in the Xcode project. Removed obsolete build settings in the Xcode project. [(Full Revision History)](Document%20Revision%20History.md#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpirkfgnbqgaydonzygmwvezlwnfzws33ojbuxg5dpoj4s2rdpnz2ey2lonncwyzlnmvxhiskel4yq) |
| __Build Requirements:__ | Xcode 4 |
| __Runtime Requirements:__ | Snow Leopard 10.6 |

QTCoreVideo102 is a Cocoa sample demonstrating how to render a QuickTime Movie using OpenGL texture 2D, QuickTime visual context, and the Core Video pixel buffer pipeline.

This is the first application in the series that will include QTCoreVideo103, QTCoreVideo201, QTCoreVideo202, and Denoise that leverage a common graphics and media utility toolkits for Snow Leopard.
