...
source_url: https://developer.apple.com/library/archive/samplecode/Play_Movie_with_Controller/Listings/Common_Files_MacFramework_c.html
archived_at: '2026-07-18T03:19:11.460538Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Play Movie with Controller](Play%20Movie%20with%20Controller.md)


[Next](Common%20Files-MacFramework.h.md)[Previous](Common%20Files-ComFramework.h.md)
    ...
    switch (theEvent->what) {
        ...
        case activateEvt:
            ...
            if (QTFrame_IsAppWindow(myWindow))
                ActivateController(myWindow, ((theEvent->modifiers & activeFlag) != 0 ));
            break;
        ...
        case osEvt:
            switch ((theEvent->message >> 24) & 0x00ff) {       // get high byte of message
                case suspendResumeMessage:
                    ...
                    if (myWindow != NULL)
                        ActivateController(myWindow, gAppInForeground);
                    break;
...
void QTFrame_HandleMenuCommand (long theMenuResult)
{
    ...
    switch (myMenuID) {
        ...
        case kEditMenuResID:
            HandleEditMenuItem(QTFrame_GetFrontMovieWindow(), MENU_IDENTIFIER(myMenuID, myMenuItem));
            break;
...
void QTFrame_ShowAboutBox (void)
{
    ...
    ActivateController(QTFrame_GetFrontMovieWindow(), false);
...
void QTFrame_ShowWarning (const Str255 theMessage, OSErr theErr)
{
    Str255              myString;
    short               mySavedResFile;
