...
source_url: https://developer.apple.com/library/archive/samplecode/Play_Movie_with_Controller/Listings/Start_Code_MCActionFilter_c.html
archived_at: '2026-07-18T03:19:13.348137Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Play Movie with Controller](Play%20Movie%20with%20Controller.md)


[Next](Start%20Code-OpenMovieInWindow.c.md)[Previous](Start%20Code-Events.c.md)
...
#pragma unused(theMC, theParams)
    ...
    switch (theAction) {
// Step 1. Insert SwitchActions.clp here...
