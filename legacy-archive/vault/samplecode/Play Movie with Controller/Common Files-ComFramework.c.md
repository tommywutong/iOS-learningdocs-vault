...
source_url: https://developer.apple.com/library/archive/samplecode/Play_Movie_with_Controller/Listings/Common_Files_ComFramework_c.html
archived_at: '2026-07-18T03:19:10.832493Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Play Movie with Controller](Play%20Movie%20with%20Controller.md)


[Next](Common%20Files-ComFramework.h.md)[Previous](Clippings-SetupController.c-SetupController.txt.md)
...
Boolean QTFrame_CreateNewMovie (void)
{
    ...
    return(OpenMovieInWindow(myMovie, &myFSSpec));
}
...
OSErr QTFrame_SaveAsMovieFile (WindowReference theWindow)
{
    ...
    if (myIsSelected) {
        ...
        myErr = CreateMovieFile(&myFile, FOUR_CHAR_CODE('TVOD'), smSystemScript, myFlags, NULL, NULL);
        if (myErr != noErr)
            goto bail;
        ...
        myMC = CreateController(myNewMovie, theWindow, false);
