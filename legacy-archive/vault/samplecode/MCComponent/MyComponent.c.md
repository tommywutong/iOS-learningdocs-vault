---
title: MCComponent
apple_id: DTS10000817
resource_type: Sample Code
platform: macOS
topic: null
technology: QuickTime
published: '2003-01-14'
source_url: https://developer.apple.com/library/archive/samplecode/MCComponent/Listings/MyComponent_c.html
archived_at: '2026-07-18T03:13:50.746253Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [MCComponent](MCComponent.md)


[Next](MyComponent.h.md)[Previous](HideMenuBar.h.md)
...
pascal ComponentResult main(ComponentParameters *params, char **storage)
{
    ...
    if ( params->what < 0 ) { 
        ...
        switch ( params->what ) {
            case kMCIsPlayerEventSelect:    
                return ( CallComponentFunctionWithStorage(storage, params,
                        (ComponentFunctionUPP) MyIsPlayerEvent) );
...
pascal ComponentResult MyOpen(ComponentInstance self)
{
    ...
    searchComp.componentType = 'play';
    searchComp.componentSubType = 0;
    ...
    stdPlayer = FindNextComponent(nil, &searchComp);
    if (stdPlayer == nil) {
        DebugStr("\pCould not find standard movie controller.");
    }
    if ((myComp = OpenComponent(stdPlayer)) == nil) {
    ...
    (**myPrivateGlobals).fadeStatus = false;
    (**myPrivateGlobals).firstTime = false;
...
pascal ComponentResult MyClose(Handle storage, ComponentInstance self)
{
    ...
    //  Make normal again.
    if ((**myPrivateGlobals).fadeStatus == true)
        SwapWindow(myPrivateGlobals);
