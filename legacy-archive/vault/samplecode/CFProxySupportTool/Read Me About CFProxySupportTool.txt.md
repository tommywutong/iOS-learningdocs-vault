...
apple_id: DTS10004495
resource_type: Sample Code
platform: macOS
topic: Networking, Internet, & Web
technology: CoreServices
published: '2007-10-29'
source_url: https://developer.apple.com/library/archive/samplecode/CFProxySupportTool/Listings/Read_Me_About_CFProxySupportTool_txt.html
archived_at: '2026-07-18T03:02:29.740437Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [CFProxySupportTool](CFProxySupportTool.md)


[Next](Document%20Revision%20History.md)[Previous](CFProxySupportTool.c.md)

# Read Me About CFProxySupportTool.txt
