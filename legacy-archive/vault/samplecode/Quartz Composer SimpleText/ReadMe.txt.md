...
apple_id: DTS40009324
resource_type: Sample Code
platform: macOS
topic: Graphics & Animation
technology: Quartz
published: '2009-10-27'
source_url: https://developer.apple.com/library/archive/samplecode/SimpleText/Listings/ReadMe_txt.html
archived_at: '2026-07-18T03:24:14.936093Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [Quartz Composer SimpleText](Quartz%20Composer%20SimpleText.md)


[Next](SimpleTextPlugIn.h.md)[Previous](Quartz%20Composer%20SimpleText.md)
...
SimpleText                  A Quartz Composer plug-in that outputs a simple text.
...
About the sample                A Quartz Composer plug-in that implements a custom 
                        processor patch with internal settings and a user 
...
Using the Sample                Open the project using the Xcode editor which can be found 
                        ...
                        To set the content of the output string, open the 
                        "Patch Inspector" window and put the text in the 
                        "Settings" pane.
