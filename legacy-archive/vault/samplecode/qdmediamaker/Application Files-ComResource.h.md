...
source_url: https://developer.apple.com/library/archive/samplecode/qdmediamaker/Listings/Application_Files_ComResource_h.html
archived_at: '2026-07-18T03:29:58.576089Z'
---
...
#define IDM_ROWS                        33537   // ((kTestMenuResID<<8)+(1))
#define IDM_LINES                       33538   // ((kTestMenuResID<<8)+(2))
#define IDM_BOXES                       33539   // ((kTestMenuResID<<8)+(3))
#define IDM_BALL                        33540   // ((kTestMenuResID<<8)+(4))
