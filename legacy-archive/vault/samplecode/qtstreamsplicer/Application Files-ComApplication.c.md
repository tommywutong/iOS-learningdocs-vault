...
source_url: https://developer.apple.com/library/archive/samplecode/qtstreamsplicer/Listings/Application_Files_ComApplication_c.html
archived_at: '2026-07-26T19:53:07.339829Z'
---
> 导航：[总目录](../../README.md) · [samplecode](../../_indexes/samplecode.md) · [qtstreamsplicer](qtstreamsplicer.md)


[Next](Application%20Files-ComApplication.h.md)[Previous](qtstreamsplicer.md)
...
Boolean QTApp_HandleMenu (UInt16 theMenuItem)
{
    ...
    switch (theMenuItem) {
        case IDM_SPLICEIMAGE_ONTOSTREAM:
            QTSplicer_SpliceImageOntoStream();
            myIsHandled = true;
            break;

        case IDM_SPLICEIMAGE_OVERSTREAM:
...
#pragma unused(theMenu)
    ...
    QTFrame_SetMenuItemState(myMenu, IDM_SPLICEIMAGE_ONTOSTREAM, kEnableMenuItem);
    QTFrame_SetMenuItemState(myMenu, IDM_SPLICEIMAGE_OVERSTREAM, kEnableMenuItem);
}
