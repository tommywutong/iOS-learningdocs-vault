...
source_url: https://developer.apple.com/library/archive/releasenotes/General/iOS90APIDiffs/Swift/CFNetwork.html
archived_at: '2026-07-18T02:56:41.977494Z'
---
...
| To | ``` func CFFTPCreateParsedResourceListing(_ alloc: CFAllocator?, _ buffer: UnsafePointer<UInt8>, _ bufferLength: CFIndex, _ parsed: UnsafeMutablePointer<Unmanaged<CFDictionary>?>) -> CFIndex ``` | iOS 9.0 |
...
|  | Declaration | Deprecation |
| --- | --- | --- |
| From | ``` func CFReadStreamCreateForHTTPRequest(_ alloc: CFAllocator!, _ request: CFHTTPMessage!) -> Unmanaged<CFReadStream>! ``` | -- |
| To | ``` func CFReadStreamCreateForHTTPRequest(_ alloc: CFAllocator?, _ request: CFHTTPMessage) -> Unmanaged<CFReadStream> ``` | iOS 9.0 |
...
| To | ``` func CFReadStreamCreateForStreamedHTTPRequest(_ alloc: CFAllocator?, _ requestHeaders: CFHTTPMessage, _ requestBody: CFReadStream) -> Unmanaged<CFReadStream> ``` | iOS 9.0 |
...
| To | ``` func CFReadStreamCreateWithFTPURL(_ alloc: CFAllocator?, _ ftpURL: CFURL) -> Unmanaged<CFReadStream> ``` | iOS 9.0 |
...
| To | ``` func CFWriteStreamCreateWithFTPURL(_ alloc: CFAllocator?, _ ftpURL: CFURL) -> Unmanaged<CFWriteStream> ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceGroup: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceLink: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceModDate: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceMode: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceName: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceOwner: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceSize: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFFTPResourceType: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamNetworkServiceTypeVoIP: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPAttemptPersistentConnection: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPFetchResourceInfo: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPFileTransferOffset: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPPassword: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPProxy: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPProxyHost: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPProxyPassword: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPProxyPort: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPProxyUser: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPResourceSize: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPUsePassiveMode: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyFTPUserName: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPAttemptPersistentConnection: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPFinalRequest: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPFinalURL: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPProxy: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPProxyHost: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPProxyPort: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPRequestBytesWrittenCount: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPResponseHeader: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPShouldAutoredirect: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPSProxyHost: CFString ``` | iOS 9.0 |
...
| To | ``` let kCFStreamPropertyHTTPSProxyPort: CFString ``` | iOS 9.0 |
