...
source_url: https://developer.apple.com/library/archive/releasenotes/General/tvOS10APIDiffs/Swift/CoreLocation.html
archived_at: '2026-07-18T02:57:39.454337Z'
---
...
| --- | --- | --- |
| From | ``` case DeferredAccuracyTooLow ``` | tvOS 9.0 |
| To | ``` case deferredAccuracyTooLow ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case HeadingFailure ``` | tvOS 9.0 |
| To | ``` case headingFailure ``` | tvOS 10.0 |
