...
source_url: https://developer.apple.com/library/archive/releasenotes/General/tvOS10APIDiffs/Swift/SpriteKit.html
archived_at: '2026-07-18T02:57:55.842228Z'
---
...
| To | ``` init(name name: String, float value: GLKVector3) ``` | tvOS 10.0 |
...
| To | ``` init(name name: String, float value: GLKVector4) ``` | tvOS 10.0 |
...
| To | ``` init(name name: String, float value: GLKMatrix2) ``` | tvOS 10.0 |
...
| To | ``` init(name name: String, float value: GLKMatrix3) ``` | tvOS 10.0 |
...
| To | ``` init(name name: String, float value: GLKMatrix4) ``` | tvOS 10.0 |
...
| To | ``` init(name name: String, float value: GLKVector2) ``` | tvOS 10.0 |
