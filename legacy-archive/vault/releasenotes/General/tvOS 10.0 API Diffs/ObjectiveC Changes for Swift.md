...
source_url: https://developer.apple.com/library/archive/releasenotes/General/tvOS10APIDiffs/Swift/ObjectiveC.html
archived_at: '2026-07-18T02:57:53.097308Z'
---
...
| To | ``` func objc_finalizeOnMainThread(_ cls: Swift.AnyClass!) ``` | tvOS 10.0 |
...
| To | ``` func objc_is_finalized(_ ptr: UnsafeMutableRawPointer!) -> Bool ``` | tvOS 10.0 |
...
| To | ``` func objc_memmove_collectable(_ dst: UnsafeMutableRawPointer!, _ src: UnsafeRawPointer!, _ size: Int) -> UnsafeMutableRawPointer! ``` | tvOS 10.0 |
