...
source_url: https://developer.apple.com/library/archive/releasenotes/General/tvOS10APIDiffs/Swift/CoreBluetooth.html
archived_at: '2026-07-18T02:57:36.479212Z'
---
...
| --- | --- | --- |
| From | ``` case AttributeNotFound ``` | tvOS 9.0 |
| To | ``` case attributeNotFound ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case AttributeNotLong ``` | tvOS 9.0 |
| To | ``` case attributeNotLong ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case InsufficientAuthorization ``` | tvOS 9.0 |
| To | ``` case insufficientAuthorization ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case InsufficientEncryptionKeySize ``` | tvOS 9.0 |
| To | ``` case insufficientEncryptionKeySize ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case ReadNotPermitted ``` | tvOS 9.0 |
| To | ``` case readNotPermitted ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case Success ``` | tvOS 9.0 |
| To | ``` case success ``` | tvOS 10.0 |
...
| To | ``` enum CBCentralManagerState : Int {     case unknown     case resetting     case unsupported     case unauthorized     case poweredOff     case poweredOn } ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case ConnectionTimeout ``` | tvOS 9.0 |
| To | ``` case connectionTimeout ``` | tvOS 10.0 |
...
| To | ``` enum CBPeripheralManagerState : Int {     case unknown     case resetting     case unsupported     case unauthorized     case poweredOff     case poweredOn } ``` | tvOS 10.0 |
