...
source_url: https://developer.apple.com/library/archive/releasenotes/General/tvOS10APIDiffs/Swift/GLKit.html
archived_at: '2026-07-18T02:57:48.395616Z'
---
...
| --- | --- | --- |
| From | ``` case IncompatibleFormatSRGB ``` | tvOS 9.0 |
| To | ``` case incompatibleFormatSRGB ``` | tvOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case ReorientationFailure ``` | tvOS 9.0 |
| To | ``` case reorientationFailure ``` | tvOS 10.0 |
