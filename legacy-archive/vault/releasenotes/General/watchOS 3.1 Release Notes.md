---
title: watchOS 3.1 Release Notes
apple_id: TP40017563
...
source_url: https://developer.apple.com/library/archive/releasenotes/General/RN-watchOSSDK-3.1/index.html
archived_at: '2026-07-18T02:54:43.795494Z'
---
...
- [Introduction](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3tknrtfvbuqmjnirxw45cmnfxgwrlmmvwwk3tujfcf6mi)
- [Bug Reporting](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3tknrtfvbuqmjnirxw45cmnfxgwrlmmvwwk3tujfcf6mq)
- [Notes and Known Issues](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3tknrtfvbuqmjnknltc)
...
For issues not mentioned in [Notes and Known Issues](#apple-f4xwc4dqnrsv64tfmyxwi33df52wszbpkridimbqge3tknrtfvbuqmjnknltc), please file bugs through the Apple Developer website [https://developer.apple.com/bug-reporting/](https://developer.apple.com/bug-reporting/). Additionally, you may discuss these issues and watchOS SDK 3.1 in the Apple Developer Forums at [http://devforums.apple.com](http://devforums.apple.com/).
...
- If a SceneKit scene is backgrounded for over a minute, the scene is paused instead of automatically resumed when it comes back to the foreground.
  ...
  __Workaround:__ Resume the [SCNScene](https://developer.apple.com/documentation/scenekit/scnscene) object in your interface controller’s [willActivate](https://developer.apple.com/documentation/watchkit/wkinterfacecontroller/1619547-willactivate) call.
- Some third-party apps that use an iMessage app extension may not launch on Apple Watch.

  __Workaround:__ Uninstall and reinstall the app from the Apple Watch app on your iPhone.
...
- CloudKit usage is blocked in watchOS Simulator. Running any test will throw a “Not Authenticated” error even though you are signed in via the paired iOS Simulator.
  ...
  __Workaround:__ Use CloudKit on paired devices with watchOS 3 and iOS 10.
...
- `NSLog()` messages are not printed in Xcode’s debug console when running on Apple Watch.
  ...
  __Workaround:__ Install the `sysdiagnose` logging profile on Apple Watch to reinstate logging. To learn more, see `sysdiagnose` on the [Profiles and Logs](https://developer.apple.com/bug-reporting/profiles-and-logs/?platform=watchos) webpage.
