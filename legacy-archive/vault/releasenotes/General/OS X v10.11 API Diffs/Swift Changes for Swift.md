...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOSX10_11/Swift/Swift.html
archived_at: '2026-07-18T02:53:44.533823Z'
---
...
| --- | --- | --- |
| From | ``` static func abs(_ x: Self) -> Self ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     static func abs(_ x: Self) -> Self ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func append(_ newElement: T) ``` | OS X 10.10 |
| To | ``` mutating func append(_ newElement: Element) ``` | OS X 10.11 |
...
| --- | --- | --- | --- | --- |
| From | ``` init<S : SequenceType where T == T>(_ s: S) ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` init<S : SequenceType where S.Generator.Element == _Buffer.Element>(_ s: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == _Buffer.Element ``` | S |

Modified Array.init(arrayLiteral: Element)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(arrayLiteral elements: T...) ``` | OS X 10.10 |
| To | ``` init(arrayLiteral elements: Element...) ``` | OS X 10.11 |

Modified Array.init(count: Int, repeatedValue: Element)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(count count: Int, repeatedValue repeatedValue: T) ``` | OS X 10.10 |
| To | ``` init(count count: Int, repeatedValue repeatedValue: Element) ``` | OS X 10.11 |

Modified Array.insert(_: Element, atIndex: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func insert(_ newElement: T, atIndex i: Int) ``` | OS X 10.10 |
| To | ``` mutating func insert(_ newElement: Element, atIndex i: Int) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func removeAtIndex(_ index: Int) -> T ``` | OS X 10.10 |
| To | ``` mutating func removeAtIndex(_ index: Int) -> Element ``` | OS X 10.11 |

Modified Array.removeLast() -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func removeLast() -> T ``` | OS X 10.10 |
| To | ``` mutating func removeLast() -> Element ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (index: Int) -> T ``` | OS X 10.10.3 |
| To | ``` subscript (_ index: Int) -> Element ``` | OS X 10.11 |

Modified Array.subscript(_: Range<Int>) -> ArraySlice<Element>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (subRange: Range<Int>) -> ArraySlice<T> ``` | OS X 10.10.3 |
| To | ``` subscript (_ subRange: Range<Int>) -> ArraySlice<Element> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(arrayLiteral elements: Element...) ``` | OS X 10.10 |
| To | ``` init(arrayLiteral elements: Self.Element...) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func append(_ newElement: T) ``` | OS X 10.10.3 |
| To | ``` mutating func append(_ newElement: Element) ``` | OS X 10.11 |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` init<S : SequenceType where T == T>(_ s: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` init<S : SequenceType where S.Generator.Element == _Buffer.Element>(_ s: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == _Buffer.Element ``` | S |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(arrayLiteral elements: T...) ``` | OS X 10.10.3 |
| To | ``` init(arrayLiteral elements: Element...) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(count count: Int, repeatedValue repeatedValue: T) ``` | OS X 10.10.3 |
| To | ``` init(count count: Int, repeatedValue repeatedValue: Element) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func insert(_ newElement: T, atIndex i: Int) ``` | OS X 10.10.3 |
| To | ``` mutating func insert(_ newElement: Element, atIndex i: Int) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func removeAtIndex(_ index: Int) -> T ``` | OS X 10.10.3 |
| To | ``` mutating func removeAtIndex(_ index: Int) -> Element ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func removeLast() -> T ``` | OS X 10.10.3 |
| To | ``` mutating func removeLast() -> Element ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var memory: T { get nonmutating set } ``` | OS X 10.10 |
| To | ``` var memory: Memory { get nonmutating set } ``` | OS X 10.11 |

Modified AutoreleasingUnsafeMutablePointer.subscript(_: Int) -> Memory

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (i: Int) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ i: Int) -> Memory { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(booleanLiteral value: BooleanLiteralType) ``` | OS X 10.10 |
| To | ``` init(booleanLiteral value: Self.BooleanLiteralType) ``` | OS X 10.11 |
...
| --- | --- | --- | --- |
| From | OS X 10.10.3 | ```  ``` | -- |
| To | OS X 10.11 | ``` Target : OutputStreamType ``` | Target |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func clamp(_ intervalToClamp: ClosedInterval<T>) -> ClosedInterval<T> ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func clamp(_ intervalToClamp: ClosedInterval<Bound>) -> ClosedInterval<Bound> ``` | OS X 10.11 |

Modified ClosedInterval.contains(_: Bound) -> Bool

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func contains(_ x: T) -> Bool ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func contains(_ x: Bound) -> Bool ``` | OS X 10.11 |

Modified ClosedInterval.end

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var end: T { get } ``` | OS X 10.10 |
| To | ``` var end: Bound { get } ``` | OS X 10.11 |

Modified ClosedInterval.init(_: ClosedInterval<Bound>)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ x: ClosedInterval<T>) ``` | OS X 10.10 |
| To | ``` init(_ x: ClosedInterval<Bound>) ``` | OS X 10.11 |

Modified ClosedInterval.init(_: Bound, _: Bound)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ start: T, _ end: T) ``` | OS X 10.10 |
| To | ``` init(_ start: Bound, _ end: Bound) ``` | OS X 10.11 |

Modified ClosedInterval.start

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var start: T { get } ``` | OS X 10.10 |
| To | ``` var start: Bound { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> GeneratorOfOne<T> ``` | OS X 10.10 |
| To | ``` func generate() -> GeneratorOfOne<Element> ``` | OS X 10.11 |

Modified CollectionOfOne.init(_: Element)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ element: T) ``` | OS X 10.10 |
| To | ``` init(_ element: Element) ``` | OS X 10.11 |

Modified CollectionOfOne.subscript(_: Index) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (position: Index) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ position: Index) -> Element { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func indexForKey(_ key: Key) -> DictionaryIndex<Key, Value>? ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func indexForKey(_ key: Key) -> DictionaryIndex<Key, Value>? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (position: DictionaryIndex<Key, Value>) -> (Key, Value) { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ position: DictionaryIndex<Key, Value>) -> (Key, Value) { get } ``` | OS X 10.11 |

Modified Dictionary.subscript(_: Key) -> Value?

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (key: Key) -> Value? ``` | OS X 10.10.3 |
| To | ``` subscript (_ key: Key) -> Value? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(dictionaryLiteral elements: (Key, Value)...) ``` | OS X 10.10 |
| To | ``` init(dictionaryLiteral elements: (Self.Key, Self.Value)...) ``` | OS X 10.11 |

Modified [Double [struct]](https://developer.apple.com/documentation/swift/double)

|  | Declaration | Protocols |
| --- | --- | --- |
| From | ``` struct Double {     var value: Builtin.FPIEEE64     init()     init(_bits v: Builtin.FPIEEE64)     init(_ value: Double) } extension Double {     init(_ value: CGFloat) } extension Double : _ObjectiveCBridgeable {     init(_ number: NSNumber) } extension Double : Printable {     var description: String { get } } extension Double : FloatingPointType {     static var infinity: Double { get }     static var NaN: Double { get }     static var quietNaN: Double { get }     var isSignMinus: Bool { get }     var isNormal: Bool { get }     var isFinite: Bool { get }     var isZero: Bool { get }     var isSubnormal: Bool { get }     var isInfinite: Bool { get }     var isNaN: Bool { get }     var isSignaling: Bool { get } } extension Double {     var floatingPointClass: FloatingPointClassification { get } } extension Double : IntegerLiteralConvertible {     init(_builtinIntegerLiteral value: Builtin.Int2048)     init(integerLiteral value: Int64) } extension Double {     init(_builtinFloatLiteral value: Builtin.FPIEEE80) } extension Double : FloatLiteralConvertible {     init(floatLiteral value: Double) } extension Double : Comparable { } extension Double : Hashable {     var hashValue: Int { get } } extension Double : AbsoluteValuable {     static func abs(_ x: Double) -> Double } extension Double {     init(_ v: UInt8)     init(_ v: Int8)     init(_ v: UInt16)     init(_ v: Int16)     init(_ v: UInt32)     init(_ v: Int32)     init(_ v: UInt64)     init(_ v: Int64)     init(_ v: UInt)     init(_ v: Int) } extension Double {     init(_ other: Float)     init(_ other: Float80) } extension Double : Strideable {     func distanceTo(_ other: Double) -> Double     func advancedBy(_ amount: Double) -> Double } extension Double : Reflectable {     func getMirror() -> MirrorType } extension Double : _CVarArgPassedAsDouble {     func encode() -> [Word] } ``` | AbsoluteValuable, Comparable, FloatLiteralConvertible, FloatingPointType, Hashable, IntegerLiteralConvertible, Printable, Reflectable, Strideable |
| To | ``` struct Double {     var value: Builtin.FPIEEE64     init()     init(_bits v: Builtin.FPIEEE64)     init(_ value: Double) } extension Double {     init(_ value: CGFloat) } extension Double : _ObjectiveCBridgeable {     init(_ number: NSNumber) } extension Double : CustomStringConvertible {     var description: String { get } } extension Double : FloatingPointType {     static var infinity: Double { get }     static var NaN: Double { get }     static var quietNaN: Double { get }     var isSignMinus: Bool { get }     var isNormal: Bool { get }     var isFinite: Bool { get }     var isZero: Bool { get }     var isSubnormal: Bool { get }     var isInfinite: Bool { get }     var isNaN: Bool { get }     var isSignaling: Bool { get } } extension Double {     var floatingPointClass: FloatingPointClassification { get } } extension Double : IntegerLiteralConvertible {     init(_builtinIntegerLiteral value: Builtin.Int2048)     init(integerLiteral value: Int64) } extension Double {     init(_builtinFloatLiteral value: Builtin.FPIEEE80) } extension Double : FloatLiteralConvertible {     init(floatLiteral value: Double) } extension Double : Comparable, Equatable { } extension Double : Hashable {     var hashValue: Int { get } } extension Double : SignedNumberType, AbsoluteValuable {     @warn_unused_result     static func abs(_ x: Double) -> Double } extension Double {     init(_ v: UInt8)     init(_ v: Int8)     init(_ v: UInt16)     init(_ v: Int16)     init(_ v: UInt32)     init(_ v: Int32)     init(_ v: UInt64)     init(_ v: Int64)     init(_ v: UInt)     init(_ v: Int) } extension Double {     init(_ other: Float)     init(_ other: Float80) } extension Double : Strideable, _Strideable {     func distanceTo(_ other: Double) -> Double     func advancedBy(_ amount: Double) -> Double } extension Double {     init?(_ text: String) } extension Double : _Reflectable { } extension Double : _CVarArgPassedAsDouble, CVarArgType, _CVarArgAlignedType { } ``` | AbsoluteValuable, CVarArgType, Comparable, CustomStringConvertible, Equatable, FloatLiteralConvertible, FloatingPointType, Hashable, IntegerLiteralConvertible, SignedNumberType, Strideable |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> EmptyGenerator<T> ``` | OS X 10.10 |
| To | ``` func generate() -> EmptyGenerator<Element> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func next() -> T? ``` | OS X 10.10 |
| To | ``` mutating func next() -> Element? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func next() -> Element? ``` | OS X 10.10 |
| To | ``` mutating func next() -> (index: Int, element: Base.Element)? ``` | OS X 10.11 |
...
|  | Declaration | Protocols |
| --- | --- | --- |
| From | ``` struct Float80 {     var value: Builtin.FPIEEE80     init()     init(_bits v: Builtin.FPIEEE80)     init(_ value: Float80) } extension Float80 : Printable {     var description: String { get } } extension Float80 : IntegerLiteralConvertible {     init(_builtinIntegerLiteral value: Builtin.Int2048)     init(integerLiteral value: Int64) } extension Float80 {     init(_builtinFloatLiteral value: Builtin.FPIEEE80) } extension Float80 : FloatLiteralConvertible {     init(floatLiteral value: Float80) } extension Float80 : Comparable { } extension Float80 : Hashable {     var hashValue: Int { get } } extension Float80 : AbsoluteValuable {     static func abs(_ x: Float80) -> Float80 } extension Float80 {     init(_ v: UInt8)     init(_ v: Int8)     init(_ v: UInt16)     init(_ v: Int16)     init(_ v: UInt32)     init(_ v: Int32)     init(_ v: UInt64)     init(_ v: Int64)     init(_ v: UInt)     init(_ v: Int) } extension Float80 {     init(_ other: Float)     init(_ other: Double) } extension Float80 : Strideable {     func distanceTo(_ other: Float80) -> Float80     func advancedBy(_ amount: Float80) -> Float80 } ``` | AbsoluteValuable, Comparable, FloatLiteralConvertible, Hashable, IntegerLiteralConvertible, Printable, Strideable |
| To | ``` struct Float80 {     var value: Builtin.FPIEEE80     init()     init(_bits v: Builtin.FPIEEE80)     init(_ value: Float80) } extension Float80 : CustomStringConvertible {     var description: String { get } } extension Float80 : IntegerLiteralConvertible {     init(_builtinIntegerLiteral value: Builtin.Int2048)     init(integerLiteral value: Int64) } extension Float80 {     init(_builtinFloatLiteral value: Builtin.FPIEEE80) } extension Float80 : FloatLiteralConvertible {     init(floatLiteral value: Float80) } extension Float80 : Comparable, Equatable { } extension Float80 : Hashable {     var hashValue: Int { get } } extension Float80 : AbsoluteValuable, SignedNumberType {     @warn_unused_result     static func abs(_ x: Float80) -> Float80 } extension Float80 {     init(_ v: UInt8)     init(_ v: Int8)     init(_ v: UInt16)     init(_ v: Int16)     init(_ v: UInt32)     init(_ v: Int32)     init(_ v: UInt64)     init(_ v: Int64)     init(_ v: UInt)     init(_ v: Int) } extension Float80 {     init(_ other: Float)     init(_ other: Double) } extension Float80 : Strideable, _Strideable {     func distanceTo(_ other: Float80) -> Float80     func advancedBy(_ amount: Float80) -> Float80 } extension Float80 {     init?(_ text: String) } ``` | AbsoluteValuable, Comparable, CustomStringConvertible, Equatable, FloatLiteralConvertible, Hashable, IntegerLiteralConvertible, SignedNumberType, Strideable |

Modified Float80.abs(_: Float80) -> Float80 [static]

|  | Declaration |
| --- | --- |
| From | ``` static func abs(_ x: Float80) -> Float80 ``` |
| To | ``` @warn_unused_result     static func abs(_ x: Float80) -> Float80 ``` |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(floatLiteral value: FloatLiteralType) ``` | OS X 10.10 |
| To | ``` init(floatLiteral value: Self.FloatLiteralType) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ base: G) ``` | OS X 10.10 |
| To | ``` init(_ base: Base) ``` | OS X 10.11 |

Modified GeneratorSequence.next() -> Base.Element?

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func next() -> G.Element? ``` | OS X 10.10 |
| To | ``` mutating func next() -> Base.Element? ``` | OS X 10.11 |
...
| --- | --- | --- |
| From | ``` mutating func next() -> Element? ``` | OS X 10.10 |
| To | ``` @warn_unused_result     mutating func next() -> Self.Element? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func clamp(_ intervalToClamp: HalfOpenInterval<T>) -> HalfOpenInterval<T> ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func clamp(_ intervalToClamp: HalfOpenInterval<Bound>) -> HalfOpenInterval<Bound> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ x: HalfOpenInterval<T>) ``` | OS X 10.10 |
| To | ``` init(_ x: HalfOpenInterval<Bound>) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ v: T?) ``` | OS X 10.10 |
| To | ``` init(_ v: Wrapped?) ``` | OS X 10.11 |

Modified ImplicitlyUnwrappedOptional.init(_: Wrapped)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ some: T) ``` | OS X 10.10 |
| To | ``` init(_ some: Wrapped) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case Some(T) ``` | OS X 10.10 |
| To | ``` case Some(Wrapped) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func samePositionIn(_ utf8: String.UTF8View) -> String.UTF8View.Index ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func samePositionIn(_ utf8: String.UTF8View) -> String.UTF8View.Index ``` | OS X 10.11 |

Modified Index.samePositionIn(_: String.UTF16View) -> String.UTF16View.Index

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func samePositionIn(_ utf16: String.UTF16View) -> String.UTF16View.Index ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func samePositionIn(_ utf16: String.UTF16View) -> String.UTF16View.Index ``` | OS X 10.11 |

Modified Index.samePositionIn(_: String.UnicodeScalarView) -> String.UnicodeScalarView.Index

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func samePositionIn(_ unicodeScalars: String.UnicodeScalarView) -> String.UnicodeScalarView.Index ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func samePositionIn(_ unicodeScalars: String.UnicodeScalarView) -> String.UnicodeScalarView.Index ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func toIntMax() -> IntMax ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func toIntMax() -> IntMax ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(integerLiteral value: IntegerLiteralType) ``` | OS X 10.10 |
| To | ``` init(integerLiteral value: Self.IntegerLiteralType) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func clamp(_ intervalToClamp: Self) -> Self ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func clamp(_ intervalToClamp: Self) -> Self ``` | OS X 10.11 |

Modified IntervalType.contains(_: Self.Bound) -> Bool

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func contains(_ value: Bound) -> Bool ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func contains(_ value: Self.Bound) -> Bool ``` | OS X 10.11 |

Modified IntervalType.end

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var end: Bound { get } ``` | OS X 10.10 |
| To | ``` var end: Self.Bound { get } ``` | OS X 10.11 |

Modified IntervalType.start

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var start: Bound { get } ``` | OS X 10.10 |
| To | ``` var start: Self.Bound { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var endIndex: T ``` | OS X 10.10 |
| To | ``` var endIndex: Element ``` | OS X 10.11 |

Modified Range.generate() -> RangeGenerator<Element>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> RangeGenerator<T> ``` | OS X 10.10 |
| To | ``` func generate() -> RangeGenerator<Element> ``` | OS X 10.11 |

Modified Range.init(_: Range<Element>)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ x: Range<T>) ``` | OS X 10.10 |
| To | ``` init(_ x: Range<Element>) ``` | OS X 10.11 |

Modified Range.init(start: Element, end: Element)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(start start: T, end end: T) ``` | OS X 10.10 |
| To | ``` init(start start: Element, end end: Element) ``` | OS X 10.11 |

Modified Range.startIndex

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var startIndex: T ``` | OS X 10.10 |
| To | ``` var startIndex: Element ``` | OS X 10.11 |

Modified Range.subscript(_: Element) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (position: T) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ position: Element) -> Element { get } ``` | OS X 10.11 |

Modified Range.subscript(_: Element._DisabledRangeIndex) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (_: T._DisabledRangeIndex) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ _: Element._DisabledRangeIndex) -> Element { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(_ bounds: Range<T>) ``` | OS X 10.10 |
| To | ``` init(_ bounds: Range<Element>) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init?(rawValue rawValue: RawValue) ``` | OS X 10.10 |
| To | ``` init?(rawValue rawValue: Self.RawValue) ``` | OS X 10.11 |

Modified RawRepresentable.rawValue

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var rawValue: RawValue { get } ``` | OS X 10.10 |
| To | ``` var rawValue: Self.RawValue { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` let repeatedValue: T ``` | OS X 10.10 |
| To | ``` let repeatedValue: Element ``` | OS X 10.11 |

Modified Repeat.subscript(_: Int) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (position: Int) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ position: Int) -> Element { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func advancedBy(_ amount: I.Distance) -> ReverseRandomAccessIndex<I> ``` | OS X 10.10 |
| To | ``` func advancedBy(_ n: Base.Distance) -> ReverseRandomAccessIndex<Base> ``` | OS X 10.11 |

Modified ReverseRandomAccessIndex.distanceTo(_: ReverseRandomAccessIndex<Base>) -> Base.Distance

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func distanceTo(_ other: ReverseRandomAccessIndex<I>) -> I.Distance ``` | OS X 10.10 |
| To | ``` func distanceTo(_ other: ReverseRandomAccessIndex<Base>) -> Base.Distance ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> Generator ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func generate() -> Self.Generator ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func contains(_ member: T) -> Bool ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func contains(_ member: Element) -> Bool ``` | OS X 10.11 |

Modified Set.endIndex

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var endIndex: SetIndex<T> { get } ``` | OS X 10.10.3 |
| To | ``` var endIndex: SetIndex<Element> { get } ``` | OS X 10.11 |

Modified Set.exclusiveOr<S : SequenceType where S.Generator.Element == Element>(_: S) -> Set<Element>

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func exclusiveOr<S : SequenceType where T == T>(_ sequence: S) -> Set<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func exclusiveOr<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Set<Element> ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.exclusiveOrInPlace<S : SequenceType where S.Generator.Element == Element>(_: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func exclusiveOrInPlace<S : SequenceType where T == T>(_ sequence: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` mutating func exclusiveOrInPlace<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.first

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var first: T? { get } ``` | OS X 10.10.3 |
| To | ``` var first: Element? { get } ``` | OS X 10.11 |

Modified Set.generate() -> SetGenerator<Element>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> SetGenerator<T> ``` | OS X 10.10.3 |
| To | ``` func generate() -> SetGenerator<Element> ``` | OS X 10.11 |

Modified Set.indexOf(_: Element) -> SetIndex<Element>?

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func indexOf(_ member: T) -> SetIndex<T>? ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func indexOf(_ member: Element) -> SetIndex<Element>? ``` | OS X 10.11 |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` init<S : SequenceType where T == T>(_ sequence: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` init<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func insert(_ member: T) ``` | OS X 10.10.3 |
| To | ``` mutating func insert(_ member: Element) ``` | OS X 10.11 |

Modified Set.intersect<S : SequenceType where S.Generator.Element == Element>(_: S) -> Set<Element>

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func intersect<S : SequenceType where T == T>(_ sequence: S) -> Set<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func intersect<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Set<Element> ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.intersectInPlace<S : SequenceType where S.Generator.Element == Element>(_: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func intersectInPlace<S : SequenceType where T == T>(_ sequence: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` mutating func intersectInPlace<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.isDisjointWith<S : SequenceType where S.Generator.Element == Element>(_: S) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func isDisjointWith<S : SequenceType where T == T>(_ sequence: S) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func isDisjointWith<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Bool ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.isStrictSubsetOf<S : SequenceType where S.Generator.Element == Element>(_: S) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func isStrictSubsetOf<S : SequenceType where T == T>(_ sequence: S) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func isStrictSubsetOf<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Bool ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.isStrictSupersetOf<S : SequenceType where S.Generator.Element == Element>(_: S) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func isStrictSupersetOf<S : SequenceType where T == T>(_ sequence: S) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func isStrictSupersetOf<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Bool ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.isSubsetOf<S : SequenceType where S.Generator.Element == Element>(_: S) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func isSubsetOf<S : SequenceType where T == T>(_ sequence: S) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func isSubsetOf<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Bool ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.isSupersetOf<S : SequenceType where S.Generator.Element == Element>(_: S) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func isSupersetOf<S : SequenceType where T == T>(_ sequence: S) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func isSupersetOf<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Bool ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.remove(_: Element) -> Element?

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func remove(_ member: T) -> T? ``` | OS X 10.10.3 |
| To | ``` mutating func remove(_ member: Element) -> Element? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func removeFirst() -> T ``` | OS X 10.10.3 |
| To | ``` mutating func removeFirst() -> Element ``` | OS X 10.11 |

Modified Set.startIndex

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var startIndex: SetIndex<T> { get } ``` | OS X 10.10.3 |
| To | ``` var startIndex: SetIndex<Element> { get } ``` | OS X 10.11 |

Modified Set.subscript(_: SetIndex<Element>) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (position: SetIndex<T>) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ position: SetIndex<Element>) -> Element { get } ``` | OS X 10.11 |

Modified Set.subtract<S : SequenceType where S.Generator.Element == Element>(_: S) -> Set<Element>

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func subtract<S : SequenceType where T == T>(_ sequence: S) -> Set<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func subtract<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Set<Element> ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.subtractInPlace<S : SequenceType where S.Generator.Element == Element>(_: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func subtractInPlace<S : SequenceType where T == T>(_ sequence: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` mutating func subtractInPlace<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.union<S : SequenceType where S.Generator.Element == Element>(_: S) -> Set<Element>

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func union<S : SequenceType where T == T>(_ sequence: S) -> Set<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     func union<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) -> Set<Element> ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |

Modified Set.unionInPlace<S : SequenceType where S.Generator.Element == Element>(_: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func unionInPlace<S : SequenceType where T == T>(_ sequence: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` mutating func unionInPlace<S : SequenceType where S.Generator.Element == Element>(_ sequence: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | S |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` mutating func next() -> T? ``` | OS X 10.10.3 |
| To | ``` mutating func next() -> Element? ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func successor() -> SetIndex<T> ``` | OS X 10.10.3 |
| To | ``` func successor() -> SetIndex<Element> ``` | OS X 10.11 |
...
| --- | --- | --- | --- |
| From | ``` func withUTF8Buffer<R>(_ body: @noescape (UnsafeBufferPointer<UInt8>) -> R) -> R ``` | OS X 10.10 | -- |
| To | ``` func withUTF8Buffer<R>(@noescape _ body: (UnsafeBufferPointer<UInt8>) -> R) -> R ``` | OS X 10.11 | R |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> StrideThroughGenerator<T> ``` | OS X 10.10 |
| To | ``` func generate() -> StrideThroughGenerator<Element> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> StrideToGenerator<T> ``` | OS X 10.10 |
| To | ``` func generate() -> StrideToGenerator<Element> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var endIndex: String.Index { get } ``` | OS X 10.10 |
| To | ``` var endIndex: Index { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` init<S : SequenceType where Character == Character>(_ characters: S) ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` init<S : SequenceType where S.Generator.Element == Character>(_ characters: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Character ``` | S |
...
| --- | --- | --- | --- |
| From | OS X 10.10 | ```  ``` | -- |
| To | OS X 10.11 | ``` T : _SignedIntegerType ``` | T |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var startIndex: String.Index { get } ``` | OS X 10.10 |
| To | ``` var startIndex: Index { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func predecessor() -> String.UTF16View.Index ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func predecessor() -> String.UTF16View.Index ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func samePositionIn(_ unicodeScalars: String.UnicodeScalarView) -> UnicodeScalarIndex? ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func samePositionIn(_ unicodeScalars: String.UnicodeScalarView) -> UnicodeScalarIndex? ``` | OS X 10.11 |

Modified String.UTF16View.Index.successor() -> String.UTF16View.Index

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func successor() -> String.UTF16View.Index ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func successor() -> String.UTF16View.Index ``` | OS X 10.11 |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func decode<G : GeneratorType where Self.CodeUnit == CodeUnit>(inout _ next: G) -> UnicodeDecodingResult ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` mutating func decode<G : GeneratorType where G.Element == CodeUnit>(inout _ next: G) -> UnicodeDecodingResult ``` | OS X 10.11 | ``` G : GeneratorType, G.Element == CodeUnit ``` | G |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(unicodeScalarLiteral value: UnicodeScalarLiteralType) ``` | OS X 10.10 |
| To | ``` init(unicodeScalarLiteral value: Self.UnicodeScalarLiteralType) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func autorelease() -> Unmanaged<T> ``` | OS X 10.10 |
| To | ``` func autorelease() -> Unmanaged<Instance> ``` | OS X 10.11 |

Modified Unmanaged.fromOpaque(_: COpaquePointer) -> Unmanaged<Instance> [static]

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` static func fromOpaque(_ value: COpaquePointer) -> Unmanaged<T> ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     static func fromOpaque(_ value: COpaquePointer) -> Unmanaged<Instance> ``` | OS X 10.11 |

Modified Unmanaged.passRetained(_: Instance) -> Unmanaged<Instance> [static]

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` static func passRetained(_ value: T) -> Unmanaged<T> ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     static func passRetained(_ value: Instance) -> Unmanaged<Instance> ``` | OS X 10.11 |

Modified Unmanaged.passUnretained(_: Instance) -> Unmanaged<Instance> [static]

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` static func passUnretained(_ value: T) -> Unmanaged<T> ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     static func passUnretained(_ value: Instance) -> Unmanaged<Instance> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func retain() -> Unmanaged<T> ``` | OS X 10.10 |
| To | ``` func retain() -> Unmanaged<Instance> ``` | OS X 10.11 |

Modified Unmanaged.takeRetainedValue() -> Instance

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func takeRetainedValue() -> T ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func takeRetainedValue() -> Instance ``` | OS X 10.11 |

Modified Unmanaged.takeUnretainedValue() -> Instance

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func takeUnretainedValue() -> T ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func takeUnretainedValue() -> Instance ``` | OS X 10.11 |

Modified Unmanaged.toOpaque() -> COpaquePointer

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func toOpaque() -> COpaquePointer ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func toOpaque() -> COpaquePointer ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var baseAddress: UnsafePointer<T> { get } ``` | OS X 10.10 |
| To | ``` var baseAddress: UnsafePointer<Element> { get } ``` | OS X 10.11 |

Modified UnsafeBufferPointer.generate() -> UnsafeBufferPointerGenerator<Element>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func generate() -> UnsafeBufferPointerGenerator<T> ``` | OS X 10.10 |
| To | ``` func generate() -> UnsafeBufferPointerGenerator<Element> ``` | OS X 10.11 |

Modified UnsafeBufferPointer.init(start: UnsafePointer<Element>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(start start: UnsafePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` init(start start: UnsafePointer<Element>, count count: Int) ``` | OS X 10.11 |
...
| --- | --- | --- |
| From | ``` subscript (i: Int) -> T { get } ``` | OS X 10.10.3 |
| To | ``` subscript (_ i: Int) -> Element { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var baseAddress: UnsafeMutablePointer<T> { get } ``` | OS X 10.10 |
| To | ``` var baseAddress: UnsafeMutablePointer<Element> { get } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(start start: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` init(start start: UnsafeMutablePointer<Element>, count count: Int) ``` | OS X 10.11 |

Modified UnsafeMutableBufferPointer.subscript(_: Int) -> Element

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` subscript (i: Int) -> T { get nonmutating set } ``` | OS X 10.10.3 |
| To | ``` subscript (_ i: Int) -> Element { get nonmutating set } ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func advancedBy(_ n: Int) -> UnsafeMutablePointer<T> ``` | OS X 10.10 |
| To | ``` func advancedBy(_ n: Int) -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 |

Modified UnsafeMutablePointer.alloc(_: Int) -> UnsafeMutablePointer<Memory> [static]

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` static func alloc(_ num: Int) -> UnsafeMutablePointer<T> ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     static func alloc(_ num: Int) -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 |

Modified UnsafeMutablePointer.assignBackwardFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func assignBackwardFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func assignBackwardFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.assignFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func assignFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func assignFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func distanceTo(_ x: UnsafeMutablePointer<T>) -> Int ``` | OS X 10.10 |
| To | ``` func distanceTo(_ x: UnsafeMutablePointer<Memory>) -> Int ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(bitPattern bitPattern: Word) ``` | OS X 10.10 |
| To | ``` init(bitPattern bitPattern: Int) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.init(bitPattern: UInt)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` init(bitPattern bitPattern: UWord) ``` | OS X 10.10 |
| To | ``` init(bitPattern bitPattern: UInt) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func initialize(_ newvalue: T) ``` | OS X 10.10 |
| To | ``` func initialize(_ newvalue: Memory) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.initializeFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func initializeFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func initializeFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func move() -> T ``` | OS X 10.10 |
| To | ``` @warn_unused_result     func move() -> Memory ``` | OS X 10.11 |

Modified UnsafeMutablePointer.moveAssignFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func moveAssignFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func moveAssignFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.moveInitializeBackwardFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func moveInitializeBackwardFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func moveInitializeBackwardFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.moveInitializeFrom(_: UnsafeMutablePointer<Memory>, count: Int)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func moveInitializeFrom(_ source: UnsafeMutablePointer<T>, count count: Int) ``` | OS X 10.10 |
| To | ``` func moveInitializeFrom(_ source: UnsafeMutablePointer<Memory>, count count: Int) ``` | OS X 10.11 |

Modified UnsafeMutablePointer.predecessor() -> UnsafeMutablePointer<Memory>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func predecessor() -> UnsafeMutablePointer<T> ``` | OS X 10.10 |
| To | ``` func predecessor() -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 |
...
| --- | --- | --- |
| From | ``` subscript (i: Int) -> T { get nonmutating set } ``` | OS X 10.10.3 |
| To | ``` subscript (_ i: Int) -> Memory { get nonmutating set } ``` | OS X 10.11 |

Modified UnsafeMutablePointer.successor() -> UnsafeMutablePointer<Memory>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func successor() -> UnsafeMutablePointer<T> ``` | OS X 10.10 |
| To | ``` func successor() -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func advancedBy(_ n: Int) -> UnsafePointer<T> ``` | OS X 10.10 |
| To | ``` func advancedBy(_ n: Int) -> UnsafePointer<Memory> ``` | OS X 10.11 |

Modified UnsafePointer.distanceTo(_: UnsafePointer<Memory>) -> Int

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func distanceTo(_ x: UnsafePointer<T>) -> Int ``` | OS X 10.10 |
| To | ``` func distanceTo(_ x: UnsafePointer<Memory>) -> Int ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` var memory: T { get } ``` | OS X 10.10 |
| To | ``` var memory: Memory { get } ``` | OS X 10.11 |

Modified UnsafePointer.predecessor() -> UnsafePointer<Memory>

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func predecessor() -> UnsafePointer<T> ``` | OS X 10.10 |
| To | ``` func predecessor() -> UnsafePointer<Memory> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func successor() -> UnsafePointer<T> ``` | OS X 10.10 |
| To | ``` func successor() -> UnsafePointer<Memory> ``` | OS X 10.11 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` func toUIntMax() -> UIntMax ``` | OS X 10.10.3 |
| To | ``` @warn_unused_result     func toUIntMax() -> UIntMax ``` | OS X 10.11 |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func decode<G : GeneratorType where CodeUnit == CodeUnit>(inout _ input: G) -> UnicodeDecodingResult ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` mutating func decode<G : GeneratorType where G.Element == CodeUnit>(inout _ input: G) -> UnicodeDecodingResult ``` | OS X 10.11 | ``` G : GeneratorType, G.Element == CodeUnit ``` | G |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` static func measure<Encoding : UnicodeCodecType, Input : GeneratorType where Encoding.CodeUnit == Encoding.CodeUnit>(_ _: Encoding.Type, input input: Input, repairIllFormedSequences repairIllFormedSequences: Bool) -> (Int, Bool)? ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result     static func measure<Encoding : UnicodeCodecType, Input : GeneratorType where Encoding.CodeUnit == Input.Element>(_ _: Encoding.Type, input input: Input, repairIllFormedSequences repairIllFormedSequences: Bool) -> (Int, Bool)? ``` | OS X 10.11 | ``` Encoding : UnicodeCodecType, Input : GeneratorType, Encoding.CodeUnit == Input.Element ``` | Encoding, Input |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` mutating func decode<G : GeneratorType where CodeUnit == CodeUnit>(inout _ next: G) -> UnicodeDecodingResult ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` mutating func decode<G : GeneratorType where G.Element == CodeUnit>(inout _ next: G) -> UnicodeDecodingResult ``` | OS X 10.11 | ``` G : GeneratorType, G.Element == CodeUnit ``` | G |
...
|  | Declaration |
| --- | --- |
| From | ``` final class VaListBuilder {     struct Header {         var gp_offset: UInt32         var fp_offset: UInt32         var overflow_arg_area: UnsafeMutablePointer<Word>         var reg_save_area: UnsafeMutablePointer<Word>     }     init()     func append(_ arg: CVarArgType)     func va_list() -> CVaListPointer     var gpRegistersUsed: Int     var sseRegistersUsed: Int     final var header: VaListBuilder.Header     var storage: [Word] } ``` |
...
| --- | --- | --- | --- | --- | --- |
| From | ``` prefix func !<T : BooleanType>(_ a: T) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- | -- |
| To | ``` @warn_unused_result prefix func !<T : BooleanType>(_ a: T) -> Bool ``` | OS X 10.11 | ``` T : BooleanType ``` | T | prefix |

Modified !=(_: T?, _: _OptionalNilComparisonType) -> Bool

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func !=<T>(_ lhs: T?, _ rhs: _OptionalNilComparisonType) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func !=<T>(_ lhs: T?, _ rhs: _OptionalNilComparisonType) -> Bool ``` | OS X 10.11 | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func !=<T : Equatable>(_ lhs: T?, _ rhs: T?) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<T : Equatable>(_ lhs: T?, _ rhs: T?) -> Bool ``` | OS X 10.11 | ``` T : Equatable ``` | T |
...
| --- | --- | --- | --- | --- |
| From | ``` func !=<T : Equatable>(_ lhs: [T], _ rhs: [T]) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<Element : Equatable>(_ lhs: [Element], _ rhs: [Element]) -> Bool ``` | OS X 10.11 | ``` Element : Equatable ``` | Element |
...
| --- | --- | --- | --- | --- |
| From | ``` func !=<T : Equatable>(_ lhs: T, _ rhs: T) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<T : RawRepresentable where T.RawValue : Equatable>(_ lhs: T, _ rhs: T) -> Bool ``` | OS X 10.11 | ``` T : RawRepresentable, T.RawValue : Equatable ``` | T |

Modified !=(_: _OptionalNilComparisonType, _: T?) -> Bool

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func !=<T>(_ lhs: _OptionalNilComparisonType, _ rhs: T?) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func !=<T>(_ lhs: _OptionalNilComparisonType, _ rhs: T?) -> Bool ``` | OS X 10.11 | T |
...
Modified !=(_: Float80, _: Float80) -> Bool

|  | Declaration |
| --- | --- |
| From | ``` func !=(_ lhs: Float80, _ rhs: Float80) -> Bool ``` |
| To | ``` @warn_unused_result func !=(_ lhs: Float80, _ rhs: Float80) -> Bool ``` |

Modified !=(_: ContiguousArray<Element>, _: ContiguousArray<Element>) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func !=<T : Equatable>(_ lhs: ContiguousArray<T>, _ rhs: ContiguousArray<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<Element : Equatable>(_ lhs: ContiguousArray<Element>, _ rhs: ContiguousArray<Element>) -> Bool ``` | OS X 10.11 | ``` Element : Equatable ``` | Element |

Modified !=(_: [Key : Value], _: [Key : Value]) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func !=<Key : Equatable, Value : Equatable>(_ lhs: [Key : Value], _ rhs: [Key : Value]) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<Key : Equatable, Value : Equatable>(_ lhs: [Key : Value], _ rhs: [Key : Value]) -> Bool ``` | OS X 10.11 | ``` Key : Equatable, Value : Equatable ``` | Key, Value |

Modified !=(_: ArraySlice<Element>, _: ArraySlice<Element>) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func !=<T : Equatable>(_ lhs: ArraySlice<T>, _ rhs: ArraySlice<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func !=<Element : Equatable>(_ lhs: ArraySlice<Element>, _ rhs: ArraySlice<Element>) -> Bool ``` | OS X 10.11 | ``` Element : Equatable ``` | Element |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func %<T : _IntegerArithmeticType>(_ lhs: T, _ rhs: T) -> T ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func %<T : _IntegerArithmeticType>(_ lhs: T, _ rhs: T) -> T ``` | OS X 10.11 | ``` T : _IntegerArithmeticType ``` | T |
...
Modified %(_: Float80, _: Float80) -> Float80

|  | Declaration |
| --- | --- |
| From | ``` func %(_ lhs: Float80, _ rhs: Float80) -> Float80 ``` |
| To | ``` @warn_unused_result func %(_ lhs: Float80, _ rhs: Float80) -> Float80 ``` |
...
| --- | --- | --- | --- |
| From | OS X 10.10.3 | ```  ``` | -- |
| To | OS X 10.11 | ``` T : _IntegerArithmeticType ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func &=<T : BitwiseOperationsType>(inout _ lhs: T, _ rhs: T) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func &=<T : BitwiseOperationsType>(inout _ lhs: T, _ rhs: T) ``` | OS X 10.11 | ``` T : BitwiseOperationsType ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] | Operator Fixity |
| --- | --- | --- | --- | --- | --- |
| From | ``` prefix func +<T : _SignedNumberType>(_ x: T) -> T ``` | OS X 10.10.3 | ```  ``` | -- | -- |
| To | ``` prefix func +<T : SignedNumberType>(_ x: T) -> T ``` | OS X 10.11 | ``` T : SignedNumberType ``` | T | prefix |

Modified +(_: Float80) -> Float80

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func +(_ x: Float80) -> Float80 ``` | -- |
| To | ``` @warn_unused_result prefix func +(_ x: Float80) -> Float80 ``` | prefix |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +<T>(_ lhs: Int, _ rhs: UnsafeMutablePointer<T>) -> UnsafeMutablePointer<T> ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func +<Memory>(_ lhs: Int, _ rhs: UnsafeMutablePointer<Memory>) -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 | Memory |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +<T>(_ lhs: UnsafePointer<T>, _ rhs: Int) -> UnsafePointer<T> ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func +<Memory>(_ lhs: UnsafePointer<Memory>, _ rhs: Int) -> UnsafePointer<Memory> ``` | OS X 10.11 | Memory |

Modified +(_: Int, _: UnsafePointer<Memory>) -> UnsafePointer<Memory>

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +<T>(_ lhs: Int, _ rhs: UnsafePointer<T>) -> UnsafePointer<T> ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func +<Memory>(_ lhs: Int, _ rhs: UnsafePointer<Memory>) -> UnsafePointer<Memory> ``` | OS X 10.11 | Memory |

Modified +(_: T, _: T._DisallowMixedSignArithmetic) -> T

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +<T : _UnsignedIntegerType>(_ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) -> T ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +<T : UnsignedIntegerType>(_ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) -> T ``` | OS X 10.11 | ``` T : UnsignedIntegerType ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +<T : _UnsignedIntegerType>(_ lhs: T._DisallowMixedSignArithmetic, _ rhs: T) -> T ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +<T : UnsignedIntegerType>(_ lhs: T._DisallowMixedSignArithmetic, _ rhs: T) -> T ``` | OS X 10.11 | ``` T : UnsignedIntegerType ``` | T |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +<T>(_ lhs: UnsafeMutablePointer<T>, _ rhs: Int) -> UnsafeMutablePointer<T> ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func +<Memory>(_ lhs: UnsafeMutablePointer<Memory>, _ rhs: Int) -> UnsafeMutablePointer<Memory> ``` | OS X 10.11 | Memory |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +=<T : _UnsignedIntegerType>(inout _ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +=<T : UnsignedIntegerType>(inout _ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) ``` | OS X 10.11 | ``` T : UnsignedIntegerType ``` | T |

Modified +=(_: [Element], _: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +=<T, S : SequenceType where T == T>(inout _ lhs: [T], _ rhs: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +=<Element, S : SequenceType where S.Generator.Element == Element>(inout _ lhs: [Element], _ rhs: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | Element, S |

Modified +=(_: UnsafeMutablePointer<Memory>, _: Int)

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +=<T>(inout _ lhs: UnsafeMutablePointer<T>, _ rhs: Int) ``` | OS X 10.10.3 | -- |
| To | ``` func +=<Memory>(inout _ lhs: UnsafeMutablePointer<Memory>, _ rhs: Int) ``` | OS X 10.11 | Memory |

Modified +=(_: UnsafePointer<Memory>, _: Int)

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func +=<T>(inout _ lhs: UnsafePointer<T>, _ rhs: Int) ``` | OS X 10.10.3 | -- |
| To | ``` func +=<Memory>(inout _ lhs: UnsafePointer<Memory>, _ rhs: Int) ``` | OS X 10.11 | Memory |

Modified +=(_: ContiguousArray<Element>, _: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +=<T, S : SequenceType where T == T>(inout _ lhs: ContiguousArray<T>, _ rhs: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +=<Element, S : SequenceType where S.Generator.Element == Element>(inout _ lhs: ContiguousArray<Element>, _ rhs: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | Element, S |

Modified +=(_: ArraySlice<Element>, _: S)

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func +=<T, S : SequenceType where T == T>(inout _ lhs: ArraySlice<T>, _ rhs: S) ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func +=<Element, S : SequenceType where S.Generator.Element == Element>(inout _ lhs: ArraySlice<Element>, _ rhs: S) ``` | OS X 10.11 | ``` S : SequenceType, S.Generator.Element == Element ``` | Element, S |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func -<T : _UnsignedIntegerType>(_ lhs: T, _ rhs: T) -> T._DisallowMixedSignArithmetic ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func -<T : _DisallowMixedSignArithmetic>(_ lhs: T, _ rhs: T) -> T._DisallowMixedSignArithmetic ``` | OS X 10.11 | ``` T : _DisallowMixedSignArithmetic ``` | T |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func -<T>(_ lhs: UnsafePointer<T>, _ rhs: UnsafePointer<T>) -> Int ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func -<Memory>(_ lhs: UnsafePointer<Memory>, _ rhs: UnsafePointer<Memory>) -> Int ``` | OS X 10.11 | Memory |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func -<T>(_ lhs: UnsafeMutablePointer<T>, _ rhs: UnsafeMutablePointer<T>) -> Int ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func -<Memory>(_ lhs: UnsafeMutablePointer<Memory>, _ rhs: UnsafeMutablePointer<Memory>) -> Int ``` | OS X 10.11 | Memory |
...
| --- | --- | --- | --- | --- |
| From | ``` func -<T : _UnsignedIntegerType>(_ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) -> T ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` func -<T : _DisallowMixedSignArithmetic>(_ lhs: T, _ rhs: T._DisallowMixedSignArithmetic) -> T ``` | OS X 10.11 | ``` T : _DisallowMixedSignArithmetic ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ...<T : Comparable>(_ start: T, _ end: T) -> ClosedInterval<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ...<Bound : Comparable>(_ start: Bound, _ end: Bound) -> ClosedInterval<Bound> ``` | OS X 10.11 | ``` Bound : Comparable ``` | Bound |

Modified ..<(_: Bound, _: Bound) -> HalfOpenInterval<Bound>

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ..<<T : Comparable>(_ start: T, _ end: T) -> HalfOpenInterval<T> ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ..<<Bound : Comparable>(_ start: Bound, _ end: Bound) -> HalfOpenInterval<Bound> ``` | OS X 10.11 | ``` Bound : Comparable ``` | Bound |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func <<Key : Hashable, Value>(_ lhs: DictionaryIndex<Key, Value>, _ rhs: DictionaryIndex<Key, Value>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func <<Key : Hashable, Value>(_ lhs: DictionaryIndex<Key, Value>, _ rhs: DictionaryIndex<Key, Value>) -> Bool ``` | OS X 10.11 | ``` Key : Hashable ``` | Key, Value |

Modified <(_: T?, _: T?) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func <<T : _Comparable>(_ lhs: T?, _ rhs: T?) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func <<T : Comparable>(_ lhs: T?, _ rhs: T?) -> Bool ``` | OS X 10.11 | ``` T : Comparable ``` | T |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func <<T>(_ lhs: UnsafePointer<T>, _ rhs: UnsafePointer<T>) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func <<Memory>(_ lhs: UnsafePointer<Memory>, _ rhs: UnsafePointer<Memory>) -> Bool ``` | OS X 10.11 | Memory |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func <<T>(_ lhs: UnsafeMutablePointer<T>, _ rhs: UnsafeMutablePointer<T>) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func <<Memory>(_ lhs: UnsafeMutablePointer<Memory>, _ rhs: UnsafeMutablePointer<Memory>) -> Bool ``` | OS X 10.11 | Memory |

Modified <(_: SetIndex<Element>, _: SetIndex<Element>) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func <<T : Hashable>(_ lhs: SetIndex<T>, _ rhs: SetIndex<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func <<Element : Hashable>(_ lhs: SetIndex<Element>, _ rhs: SetIndex<Element>) -> Bool ``` | OS X 10.11 | ``` Element : Hashable ``` | Element |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ==<T : Comparable>(_ lhs: ClosedInterval<T>, _ rhs: ClosedInterval<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ==<Bound : Comparable>(_ lhs: ClosedInterval<Bound>, _ rhs: ClosedInterval<Bound>) -> Bool ``` | OS X 10.11 | ``` Bound : Comparable ``` | Bound |

Modified ==(_: HalfOpenInterval<Bound>, _: HalfOpenInterval<Bound>) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ==<T : Comparable>(_ lhs: HalfOpenInterval<T>, _ rhs: HalfOpenInterval<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ==<Bound : Comparable>(_ lhs: HalfOpenInterval<Bound>, _ rhs: HalfOpenInterval<Bound>) -> Bool ``` | OS X 10.11 | ``` Bound : Comparable ``` | Bound |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func ==<T>(_ lhs: Range<T>, _ rhs: Range<T>) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func ==<Element>(_ lhs: Range<Element>, _ rhs: Range<Element>) -> Bool ``` | OS X 10.11 | Element |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func ==<T>(_ lhs: AutoreleasingUnsafeMutablePointer<T>, _ rhs: AutoreleasingUnsafeMutablePointer<T>) -> Bool ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func ==<Memory>(_ lhs: AutoreleasingUnsafeMutablePointer<Memory>, _ rhs: AutoreleasingUnsafeMutablePointer<Memory>) -> Bool ``` | OS X 10.11 | Memory |

Modified ==(_: Set<Element>, _: Set<Element>) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ==<T : Hashable>(_ lhs: Set<T>, _ rhs: Set<T>) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ==<Element : Hashable>(_ lhs: Set<Element>, _ rhs: Set<Element>) -> Bool ``` | OS X 10.11 | ``` Element : Hashable ``` | Element |
...
| --- | --- | --- | --- |
| From | OS X 10.10 | ```  ``` | -- |
| To | OS X 10.11 | ``` T : SignedNumberType ``` | T |

Modified alignof<T>(_: T.Type) -> Int

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func alignof<T>(_ _: T.Type) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func alignof<T>(_ _: T.Type) -> Int ``` | OS X 10.11 | T |

Modified alignofValue<T>(_: T) -> Int

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func alignofValue<T>(_ _: T) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func alignofValue<T>(_ _: T) -> Int ``` | OS X 10.11 | T |
...
| --- | --- | --- | --- |
| From | OS X 10.10 | ```  ``` | -- |
| To | OS X 10.11 | ``` TargetStream : OutputStreamType ``` | T, TargetStream |
...
| --- | --- | --- | --- |
| From | OS X 10.10.3 | ```  ``` | -- |
| To | OS X 10.11 | ``` T : NonObjectiveCBase ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func max<T : Comparable>(_ x: T, _ y: T) -> T ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func max<T : Comparable>(_ x: T, _ y: T) -> T ``` | OS X 10.11 | ``` T : Comparable ``` | T |

Modified max<T : Comparable>(_: T, _: T, _: T, _: T) -> T

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func max<T : Comparable>(_ x: T, _ y: T, _ z: T, _ rest: T...) -> T ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func max<T : Comparable>(_ x: T, _ y: T, _ z: T, _ rest: T...) -> T ``` | OS X 10.11 | ``` T : Comparable ``` | T |

Modified min<T : Comparable>(_: T, _: T) -> T

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func min<T : Comparable>(_ x: T, _ y: T) -> T ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func min<T : Comparable>(_ x: T, _ y: T) -> T ``` | OS X 10.11 | ``` T : Comparable ``` | T |

Modified min<T : Comparable>(_: T, _: T, _: T, _: T) -> T

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func min<T : Comparable>(_ x: T, _ y: T, _ z: T, _ rest: T...) -> T ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func min<T : Comparable>(_ x: T, _ y: T, _ z: T, _ rest: T...) -> T ``` | OS X 10.11 | ``` T : Comparable ``` | T |

Modified numericCast<T : _SignedIntegerType, U : _SignedIntegerType>(_: T) -> U

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func numericCast<T : _SignedIntegerType, U : _SignedIntegerType>(_ x: T) -> U ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func numericCast<T : _SignedIntegerType, U : _SignedIntegerType>(_ x: T) -> U ``` | OS X 10.11 | ``` T : _SignedIntegerType, U : _SignedIntegerType ``` | T, U |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func sizeof<T>(_ _: T.Type) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func sizeof<T>(_ _: T.Type) -> Int ``` | OS X 10.11 | T |

Modified sizeofValue<T>(_: T) -> Int

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func sizeofValue<T>(_ _: T) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func sizeofValue<T>(_ _: T) -> Int ``` | OS X 10.11 | T |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func strideof<T>(_ _: T.Type) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func strideof<T>(_ _: T.Type) -> Int ``` | OS X 10.11 | T |

Modified strideofValue<T>(_: T) -> Int

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func strideofValue<T>(_ _: T) -> Int ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func strideofValue<T>(_ _: T) -> Int ``` | OS X 10.11 | T |
...
|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func unsafeBitCast<T, U>(_ x: T, _ _: U.Type) -> U ``` | OS X 10.10 | -- |
| To | ``` @warn_unused_result func unsafeBitCast<T, U>(_ x: T, _ _: U.Type) -> U ``` | OS X 10.11 | T, U |

Modified unsafeDowncast<T>(_: AnyObject) -> T

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func unsafeDowncast<T>(_ x: AnyObject) -> T ``` | OS X 10.10 | ```  ``` | -- |
| To | ``` @warn_unused_result func unsafeDowncast<T>(_ x: AnyObject) -> T ``` | OS X 10.11 | ``` T : AnyObject ``` | T |

Modified unsafeUnwrap<T>(_: T?) -> T

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` @inline(__always) func unsafeUnwrap<T>(_ nonEmpty: T?) -> T ``` | OS X 10.10.3 | -- |
| To | ``` @warn_unused_result func unsafeUnwrap<T>(_ nonEmpty: T?) -> T ``` | OS X 10.11 | T |

Modified withVaList<R>(_: [CVarArgType], _: CVaListPointer -> R) -> R

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func withVaList<R>(_ args: [CVarArgType], _ f: @noescape CVaListPointer -> R) -> R ``` | OS X 10.10 | -- |
| To | ``` func withVaList<R>(_ args: [CVarArgType], @noescape _ f: CVaListPointer -> R) -> R ``` | OS X 10.11 | R |

Modified withVaList<R>(_: VaListBuilder, _: CVaListPointer -> R) -> R

|  | Declaration | Introduction | Generics[Parameters] |
| --- | --- | --- | --- |
| From | ``` func withVaList<R>(_ builder: VaListBuilder, _ f: @noescape CVaListPointer -> R) -> R ``` | OS X 10.10 | -- |
| To | ``` func withVaList<R>(_ builder: VaListBuilder, @noescape _ f: CVaListPointer -> R) -> R ``` | OS X 10.11 | R |

Modified |(_: UInt8, _: UInt8) -> UInt8

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: UInt8, _ rhs: UInt8) -> UInt8 ``` |
| To | ``` func |(_ lhs: UInt8, _ rhs: UInt8) -> UInt8 ``` |

Modified |(_: UInt16, _: UInt16) -> UInt16

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: UInt16, _ rhs: UInt16) -> UInt16 ``` |
| To | ``` func |(_ lhs: UInt16, _ rhs: UInt16) -> UInt16 ``` |

Modified |(_: UInt32, _: UInt32) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: UInt32, _ rhs: UInt32) -> UInt32 ``` |
| To | ``` func |(_ lhs: UInt32, _ rhs: UInt32) -> UInt32 ``` |

Modified |(_: Int8, _: Int8) -> Int8

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: Int8, _ rhs: Int8) -> Int8 ``` |
| To | ``` func |(_ lhs: Int8, _ rhs: Int8) -> Int8 ``` |

Modified |(_: UInt, _: UInt) -> UInt

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: UInt, _ rhs: UInt) -> UInt ``` |
| To | ``` func |(_ lhs: UInt, _ rhs: UInt) -> UInt ``` |

Modified |(_: Int32, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: Int32, _ rhs: Int32) -> Int32 ``` |
| To | ``` func |(_ lhs: Int32, _ rhs: Int32) -> Int32 ``` |

Modified |(_: Int, _: Int) -> Int

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: Int, _ rhs: Int) -> Int ``` |
| To | ``` func |(_ lhs: Int, _ rhs: Int) -> Int ``` |

Modified |(_: UInt64, _: UInt64) -> UInt64

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: UInt64, _ rhs: UInt64) -> UInt64 ``` |
| To | ``` func |(_ lhs: UInt64, _ rhs: UInt64) -> UInt64 ``` |

Modified |(_: Int64, _: Int64) -> Int64

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: Int64, _ rhs: Int64) -> Int64 ``` |
| To | ``` func |(_ lhs: Int64, _ rhs: Int64) -> Int64 ``` |

Modified |(_: Int16, _: Int16) -> Int16

|  | Declaration |
| --- | --- |
| From | ``` func |(_ lhs: Int16, _ rhs: Int16) -> Int16 ``` |
| To | ``` func |(_ lhs: Int16, _ rhs: Int16) -> Int16 ``` |
...
| To | ``` func |=(inout _ lhs: UInt16, _ rhs: UInt16) ``` |
...
| To | ``` func |=(inout _ lhs: Int, _ rhs: Int) ``` |
...
| To | ``` func |=(inout _ lhs: Int32, _ rhs: Int32) ``` |
...
| To | ``` func |=(inout _ lhs: UInt64, _ rhs: UInt64) ``` |
...
| To | ``` func |=(inout _ lhs: UInt, _ rhs: UInt) ``` |
...
| To | ``` func |=(inout _ lhs: Int8, _ rhs: Int8) ``` |
...
| To | ``` func |=(inout _ lhs: Int16, _ rhs: Int16) ``` |
...
| To | ``` func |=(inout _ lhs: UInt8, _ rhs: UInt8) ``` |
...
| To | ``` func |=(inout _ lhs: UInt32, _ rhs: UInt32) ``` |
...
| To | ``` func |=(inout _ lhs: Int64, _ rhs: Int64) ``` |

Modified ~(_: Int64) -> Int64

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: Int64) -> Int64 ``` | -- |
| To | ``` prefix func ~(_ rhs: Int64) -> Int64 ``` | prefix |

Modified ~(_: UInt16) -> UInt16

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: UInt16) -> UInt16 ``` | -- |
| To | ``` prefix func ~(_ rhs: UInt16) -> UInt16 ``` | prefix |

Modified ~(_: Int) -> Int

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: Int) -> Int ``` | -- |
| To | ``` prefix func ~(_ rhs: Int) -> Int ``` | prefix |

Modified ~(_: Int8) -> Int8

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: Int8) -> Int8 ``` | -- |
| To | ``` prefix func ~(_ rhs: Int8) -> Int8 ``` | prefix |

Modified ~(_: UInt64) -> UInt64

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: UInt64) -> UInt64 ``` | -- |
| To | ``` prefix func ~(_ rhs: UInt64) -> UInt64 ``` | prefix |

Modified ~(_: Int16) -> Int16

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: Int16) -> Int16 ``` | -- |
| To | ``` prefix func ~(_ rhs: Int16) -> Int16 ``` | prefix |

Modified ~(_: UInt8) -> UInt8

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: UInt8) -> UInt8 ``` | -- |
| To | ``` prefix func ~(_ rhs: UInt8) -> UInt8 ``` | prefix |

Modified ~(_: UInt) -> UInt

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: UInt) -> UInt ``` | -- |
| To | ``` prefix func ~(_ rhs: UInt) -> UInt ``` | prefix |

Modified ~(_: Int32) -> Int32

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: Int32) -> Int32 ``` | -- |
| To | ``` prefix func ~(_ rhs: Int32) -> Int32 ``` | prefix |

Modified ~(_: UInt32) -> UInt32

|  | Declaration | Operator Fixity |
| --- | --- | --- |
| From | ``` prefix func ~(_ rhs: UInt32) -> UInt32 ``` | -- |
| To | ``` prefix func ~(_ rhs: UInt32) -> UInt32 ``` | prefix |

Modified ~=(_: T, _: T) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ~=<T : Equatable>(_ a: T, _ b: T) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ~=<T : Equatable>(_ a: T, _ b: T) -> Bool ``` | OS X 10.11 | ``` T : Equatable ``` | T |
...
|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ~=<I : ForwardIndexType where I : Comparable>(_ pattern: Range<I>, _ value: I) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ~=<I : ForwardIndexType where I : Comparable>(_ pattern: Range<I>, _ value: I) -> Bool ``` | OS X 10.11 | ``` I : ForwardIndexType, I : Comparable ``` | I |

Modified ~=(_: I, _: I.Bound) -> Bool

|  | Declaration | Introduction | Generics[Constraints] | Generics[Parameters] |
| --- | --- | --- | --- | --- |
| From | ``` func ~=<I : IntervalType>(_ pattern: I, _ value: I.Bound) -> Bool ``` | OS X 10.10.3 | ```  ``` | -- |
| To | ``` @warn_unused_result func ~=<I : IntervalType>(_ pattern: I, _ value: I.Bound) -> Bool ``` | OS X 10.11 | ``` I : IntervalType ``` | I |
