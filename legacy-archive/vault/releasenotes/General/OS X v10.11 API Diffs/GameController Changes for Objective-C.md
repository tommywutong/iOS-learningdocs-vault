...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOSX10_11/Objective-C/GameController.html
archived_at: '2026-07-18T02:53:06.845630Z'
---
...
Modified [+[GCController startWirelessControllerDiscoveryWithCompletionHandler:]](https://developer.apple.com/documentation/gamecontroller/gccontroller/1458879-startwirelesscontrollerdiscovery)

|  | Declaration |
| --- | --- |
| From | ``` + (void)startWirelessControllerDiscoveryWithCompletionHandler:(void (^)(void))completionHandler ``` |
| To | ``` + (void)startWirelessControllerDiscoveryWithCompletionHandler:(void (^ _Nullable)(void))completionHandler ``` |
...
Modified [-[GCExtendedGamepad saveSnapshot]](https://developer.apple.com/documentation/gamecontroller/gcextendedgamepad/1522447-savesnapshot)

|  | Declaration |
| --- | --- |
| From | ``` - (GCExtendedGamepadSnapshot *)saveSnapshot ``` |
| To | ``` - (GCExtendedGamepadSnapshot * _Nonnull)saveSnapshot ``` |
...
Modified [-[GCExtendedGamepadSnapshot initWithController:snapshotData:]](https://developer.apple.com/documentation/gamecontroller/gcextendedgamepadsnapshot/1522527-init)

|  | Declaration |
| --- | --- |
| From | ``` - (instancetype)initWithController:(GCController *)controller snapshotData:(NSData *)data ``` |
| To | ``` - (instancetype _Nonnull)initWithController:(GCController * _Nonnull)controller snapshotData:(NSData * _Nonnull)data ``` |

Modified [-[GCExtendedGamepadSnapshot initWithSnapshotData:]](https://developer.apple.com/documentation/gamecontroller/gcextendedgamepadsnapshot/1522554-initwithsnapshotdata)

|  | Declaration |
| --- | --- |
| From | ``` - (instancetype)initWithSnapshotData:(NSData *)data ``` |
| To | ``` - (instancetype _Nonnull)initWithSnapshotData:(NSData * _Nonnull)data ``` |
...
Modified [GCExtendedGamepadSnapShotDataV100FromNSData()](https://developer.apple.com/documentation/gamecontroller/1522439-gcextendedgamepadsnapshotdatav10)

|  | Declaration |
| --- | --- |
| From | ``` BOOL GCExtendedGamepadSnapShotDataV100FromNSData (     GCExtendedGamepadSnapShotDataV100 *snapshotData,     NSData *data ); ``` |
| To | ``` BOOL GCExtendedGamepadSnapShotDataV100FromNSData (     GCExtendedGamepadSnapShotDataV100 * _Nullable snapshotData,     NSData * _Nullable data ); ``` |

Modified [NSDataFromGCExtendedGamepadSnapShotDataV100()](https://developer.apple.com/documentation/gamecontroller/1522471-nsdatafromgcextendedgamepadsnaps)

|  | Declaration |
| --- | --- |
| From | ``` NSData * NSDataFromGCExtendedGamepadSnapShotDataV100 (     GCExtendedGamepadSnapShotDataV100 *snapshotData ); ``` |
| To | ``` NSData * _Nullable NSDataFromGCExtendedGamepadSnapShotDataV100 (     GCExtendedGamepadSnapShotDataV100 * _Nullable snapshotData ); ``` |
...
Modified [-[GCGamepad saveSnapshot]](https://developer.apple.com/documentation/gamecontroller/gcgamepad/1497415-savesnapshot)

|  | Declaration |
| --- | --- |
| From | ``` - (GCGamepadSnapshot *)saveSnapshot ``` |
| To | ``` - (GCGamepadSnapshot * _Nonnull)saveSnapshot ``` |
...
Modified [-[GCGamepadSnapshot initWithController:snapshotData:]](https://developer.apple.com/documentation/gamecontroller/gcgamepadsnapshot/1493915-init)
...
Modified [-[GCGamepadSnapshot initWithSnapshotData:]](https://developer.apple.com/documentation/gamecontroller/gcgamepadsnapshot/1493933-init)
...
Modified [GCGamepadSnapShotDataV100FromNSData()](https://developer.apple.com/documentation/gamecontroller/1493934-gcgamepadsnapshotdatav100fromnsd)

|  | Declaration |
| --- | --- |
| From | ``` BOOL GCGamepadSnapShotDataV100FromNSData (     GCGamepadSnapShotDataV100 *snapshotData,     NSData *data ); ``` |
| To | ``` BOOL GCGamepadSnapShotDataV100FromNSData (     GCGamepadSnapShotDataV100 * _Nullable snapshotData,     NSData * _Nullable data ); ``` |

Modified [NSDataFromGCGamepadSnapShotDataV100()](https://developer.apple.com/documentation/gamecontroller/1493914-nsdatafromgcgamepadsnapshotdatav)

|  | Declaration |
| --- | --- |
| From | ``` NSData * NSDataFromGCGamepadSnapShotDataV100 (     GCGamepadSnapShotDataV100 *snapshotData ); ``` |
| To | ``` NSData * _Nullable NSDataFromGCGamepadSnapShotDataV100 (     GCGamepadSnapShotDataV100 * _Nullable snapshotData ); ``` |
