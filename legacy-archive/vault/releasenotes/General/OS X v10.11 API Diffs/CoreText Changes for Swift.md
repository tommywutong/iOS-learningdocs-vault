...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOSX10_11/Swift/CoreText.html
archived_at: '2026-07-18T02:53:29.578114Z'
---
...
| --- | --- | --- |
| From | ``` case CharacterCollectionAdobeCNS1 ``` | OS X 10.10 |
| To | ``` case AdobeCNS1 ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case CharacterCollectionAdobeGB1 ``` | OS X 10.10 |
| To | ``` case AdobeGB1 ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case CharacterCollectionAdobeJapan1 ``` | OS X 10.10 |
| To | ``` case AdobeJapan1 ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case CharacterCollectionAdobeJapan2 ``` | OS X 10.10 |
| To | ``` case AdobeJapan2 ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case CharacterCollectionAdobeKorea1 ``` | OS X 10.10 |
| To | ``` case AdobeKorea1 ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case CharacterCollectionIdentityMapping ``` | OS X 10.10 |
| To | ``` case IdentityMapping ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontAlertHeader ``` | OS X 10.10 |
| To | ``` case AlertHeader ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontApplication ``` | OS X 10.10 |
| To | ``` case Application ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontControlContent ``` | OS X 10.10 |
| To | ``` case ControlContent ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontEmphasizedSystem ``` | OS X 10.10 |
| To | ``` case EmphasizedSystem ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontMenuItemCmdKey ``` | OS X 10.10 |
| To | ``` case MenuItemCmdKey ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontMenuItemMark ``` | OS X 10.10 |
| To | ``` case MenuItemMark ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontMenuTitle ``` | OS X 10.10 |
| To | ``` case MenuTitle ``` | OS X 10.8 |

Modified [CTFontUIFontType.Message](https://developer.apple.com/documentation/coretext/ctfontuifonttype/kctfontuifontmessage)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontMessage ``` | OS X 10.10 |
| To | ``` case Message ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontSmallEmphasizedSystem ``` | OS X 10.10 |
| To | ``` case SmallEmphasizedSystem ``` | OS X 10.8 |

Modified [CTFontUIFontType.SmallSystem](https://developer.apple.com/documentation/coretext/ctfontuifonttype/smallsystem)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontSmallSystem ``` | OS X 10.10 |
| To | ``` case SmallSystem ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontSmallToolbar ``` | OS X 10.10 |
| To | ``` case SmallToolbar ``` | OS X 10.8 |

Modified [CTFontUIFontType.System](https://developer.apple.com/documentation/coretext/ctfontuifonttype/kctfontuifontsystem)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontSystem ``` | OS X 10.10 |
| To | ``` case System ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case UIFontUserFixedPitch ``` | OS X 10.10 |
| To | ``` case UserFixedPitch ``` | OS X 10.8 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case TextAlignmentNatural ``` | OS X 10.10 |
| To | ``` case Natural ``` | OS X 10.8 |

Modified [CTTextAlignment.Right](https://developer.apple.com/documentation/coretext/cttextalignment/right)

|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case TextAlignmentRight ``` | OS X 10.10 |
| To | ``` case Right ``` | OS X 10.8 |
...
Modified [CTFontCollectionCopyExclusionDescriptors(_: CTFontCollection) -> CFArray?](https://developer.apple.com/documentation/coretext/1510000-ctfontcollectioncopyexclusiondes)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCopyExclusionDescriptors(_ collection: CTFontCollection!) -> CFArray! ``` |
| To | ``` func CTFontCollectionCopyExclusionDescriptors(_ collection: CTFontCollection) -> CFArray? ``` |

Modified [CTFontCollectionCopyFontAttribute(_: CTFontCollection, _: CFString, _: CTFontCollectionCopyOptions) -> CFArray](https://developer.apple.com/documentation/coretext/1509577-ctfontcollectioncopyfontattribut)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCopyFontAttribute(_ collection: CTFontCollection!, _ attributeName: CFString!, _ options: CTFontCollectionCopyOptions) -> CFArray! ``` |
| To | ``` func CTFontCollectionCopyFontAttribute(_ collection: CTFontCollection, _ attributeName: CFString, _ options: CTFontCollectionCopyOptions) -> CFArray ``` |

Modified [CTFontCollectionCopyFontAttributes(_: CTFontCollection, _: CFSet, _: CTFontCollectionCopyOptions) -> CFArray](https://developer.apple.com/documentation/coretext/1511083-ctfontcollectioncopyfontattribut)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCopyFontAttributes(_ collection: CTFontCollection!, _ attributeNames: CFSet!, _ options: CTFontCollectionCopyOptions) -> CFArray! ``` |
| To | ``` func CTFontCollectionCopyFontAttributes(_ collection: CTFontCollection, _ attributeNames: CFSet, _ options: CTFontCollectionCopyOptions) -> CFArray ``` |

Modified [CTFontCollectionCopyQueryDescriptors(_: CTFontCollection) -> CFArray?](https://developer.apple.com/documentation/coretext/1510010-ctfontcollectioncopyquerydescrip)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCopyQueryDescriptors(_ collection: CTFontCollection!) -> CFArray! ``` |
| To | ``` func CTFontCollectionCopyQueryDescriptors(_ collection: CTFontCollection) -> CFArray? ``` |
...
Modified [CTFontCollectionCreateMatchingFontDescriptorsForFamily(_: CTFontCollection, _: CFString, _: CFDictionary?) -> CFArray?](https://developer.apple.com/documentation/coretext/1508637-ctfontcollectioncreatematchingfo)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCreateMatchingFontDescriptorsForFamily(_ collection: CTFontCollection!, _ familyName: CFString!, _ options: CFDictionary!) -> CFArray! ``` |
| To | ``` func CTFontCollectionCreateMatchingFontDescriptorsForFamily(_ collection: CTFontCollection, _ familyName: CFString, _ options: CFDictionary?) -> CFArray? ``` |
...
Modified [CTFontCollectionCreateMatchingFontDescriptorsWithOptions(_: CTFontCollection, _: CFDictionary?) -> CFArray?](https://developer.apple.com/documentation/coretext/1509397-ctfontcollectioncreatematchingfo)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCreateMatchingFontDescriptorsWithOptions(_ collection: CTFontCollection!, _ options: CFDictionary!) -> CFArray! ``` |
| To | ``` func CTFontCollectionCreateMatchingFontDescriptorsWithOptions(_ collection: CTFontCollection, _ options: CFDictionary?) -> CFArray? ``` |

Modified [CTFontCollectionCreateMutableCopy(_: CTFontCollection) -> CTMutableFontCollection](https://developer.apple.com/documentation/coretext/1509247-ctfontcollectioncreatemutablecop)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionCreateMutableCopy(_ original: CTFontCollection!) -> CTMutableFontCollection! ``` |
| To | ``` func CTFontCollectionCreateMutableCopy(_ original: CTFontCollection) -> CTMutableFontCollection ``` |
...
Modified [CTFontCollectionSetExclusionDescriptors(_: CTMutableFontCollection, _: CFArray?)](https://developer.apple.com/documentation/coretext/1509406-ctfontcollectionsetexclusiondesc)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionSetExclusionDescriptors(_ collection: CTMutableFontCollection!, _ descriptors: CFArray!) ``` |
| To | ``` func CTFontCollectionSetExclusionDescriptors(_ collection: CTMutableFontCollection, _ descriptors: CFArray?) ``` |

Modified [CTFontCollectionSetQueryDescriptors(_: CTMutableFontCollection, _: CFArray?)](https://developer.apple.com/documentation/coretext/1509060-ctfontcollectionsetquerydescript)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCollectionSetQueryDescriptors(_ collection: CTMutableFontCollection!, _ descriptors: CFArray!) ``` |
| To | ``` func CTFontCollectionSetQueryDescriptors(_ collection: CTMutableFontCollection, _ descriptors: CFArray?) ``` |
...
Modified [CTFontCreateWithPlatformFont(_: ATSFontRef, _: CGFloat, _: UnsafePointer<CGAffineTransform>, _: CTFontDescriptor?) -> CTFont?](https://developer.apple.com/documentation/coretext/1510362-ctfontcreatewithplatformfont)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCreateWithPlatformFont(_ platformFont: ATSFontRef, _ size: CGFloat, _ matrix: UnsafePointer<CGAffineTransform>, _ attributes: CTFontDescriptor!) -> CTFont! ``` |
| To | ``` func CTFontCreateWithPlatformFont(_ platformFont: ATSFontRef, _ size: CGFloat, _ matrix: UnsafePointer<CGAffineTransform>, _ attributes: CTFontDescriptor?) -> CTFont? ``` |

Modified [CTFontCreateWithQuickdrawInstance(_: ConstStr255Param, _: Int16, _: UInt8, _: CGFloat) -> CTFont](https://developer.apple.com/documentation/coretext/1509337-ctfontcreatewithquickdrawinstanc)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontCreateWithQuickdrawInstance(_ name: ConstStr255Param, _ identifier: Int16, _ style: UInt8, _ size: CGFloat) -> CTFont! ``` |
| To | ``` func CTFontCreateWithQuickdrawInstance(_ name: ConstStr255Param, _ identifier: Int16, _ style: UInt8, _ size: CGFloat) -> CTFont ``` |
...
Modified [CTFontGetPlatformFont(_: CTFont, _: UnsafeMutablePointer<Unmanaged<CTFontDescriptor>?>) -> ATSFontRef](https://developer.apple.com/documentation/coretext/1510544-ctfontgetplatformfont)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontGetPlatformFont(_ font: CTFont!, _ attributes: UnsafeMutablePointer<Unmanaged<CTFontDescriptor>?>) -> ATSFontRef ``` |
| To | ``` func CTFontGetPlatformFont(_ font: CTFont, _ attributes: UnsafeMutablePointer<Unmanaged<CTFontDescriptor>?>) -> ATSFontRef ``` |
...
Modified [CTFontManagerCopyAvailableFontFamilyNames() -> CFArray](https://developer.apple.com/documentation/coretext/1499494-ctfontmanagercopyavailablefontfa)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerCopyAvailableFontFamilyNames() -> CFArray! ``` |
| To | ``` func CTFontManagerCopyAvailableFontFamilyNames() -> CFArray ``` |

Modified [CTFontManagerCopyAvailableFontURLs() -> CFArray](https://developer.apple.com/documentation/coretext/1499478-ctfontmanagercopyavailablefontur)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerCopyAvailableFontURLs() -> CFArray! ``` |
| To | ``` func CTFontManagerCopyAvailableFontURLs() -> CFArray ``` |

Modified [CTFontManagerCopyAvailablePostScriptNames() -> CFArray](https://developer.apple.com/documentation/coretext/1499516-ctfontmanagercopyavailablepostsc)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerCopyAvailablePostScriptNames() -> CFArray! ``` |
| To | ``` func CTFontManagerCopyAvailablePostScriptNames() -> CFArray ``` |
...
Modified [CTFontManagerCreateFontRequestRunLoopSource(_: CFIndex, _: (CFDictionary, pid_t) -> Unmanaged<CFArray>) -> CFRunLoopSource?](https://developer.apple.com/documentation/coretext/1499507-ctfontmanagercreatefontrequestru)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerCreateFontRequestRunLoopSource(_ sourceOrder: CFIndex, _ createMatchesCallback: ((CFDictionary!, pid_t) -> Unmanaged<CFArray>!)!) -> CFRunLoopSource! ``` |
| To | ``` func CTFontManagerCreateFontRequestRunLoopSource(_ sourceOrder: CFIndex, _ createMatchesCallback: (CFDictionary, pid_t) -> Unmanaged<CFArray>) -> CFRunLoopSource? ``` |

Modified [CTFontManagerEnableFontDescriptors(_: CFArray, _: Bool)](https://developer.apple.com/documentation/coretext/1499515-ctfontmanagerenablefontdescripto)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerEnableFontDescriptors(_ descriptors: CFArray!, _ enable: Bool) ``` |
| To | ``` func CTFontManagerEnableFontDescriptors(_ descriptors: CFArray, _ enable: Bool) ``` |

Modified [CTFontManagerGetAutoActivationSetting(_: CFString?) -> CTFontManagerAutoActivationSetting](https://developer.apple.com/documentation/coretext/1499473-ctfontmanagergetautoactivationse)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerGetAutoActivationSetting(_ bundleIdentifier: CFString!) -> CTFontManagerAutoActivationSetting ``` |
| To | ``` func CTFontManagerGetAutoActivationSetting(_ bundleIdentifier: CFString?) -> CTFontManagerAutoActivationSetting ``` |

Modified [CTFontManagerGetScopeForURL(_: CFURL) -> CTFontManagerScope](https://developer.apple.com/documentation/coretext/1499506-ctfontmanagergetscopeforurl)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerGetScopeForURL(_ fontURL: CFURL!) -> CTFontManagerScope ``` |
| To | ``` func CTFontManagerGetScopeForURL(_ fontURL: CFURL) -> CTFontManagerScope ``` |

Modified [CTFontManagerIsSupportedFont(_: CFURL) -> Bool](https://developer.apple.com/documentation/coretext/1499491-ctfontmanagerissupportedfont)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerIsSupportedFont(_ fontURL: CFURL!) -> Bool ``` |
| To | ``` func CTFontManagerIsSupportedFont(_ fontURL: CFURL) -> Bool ``` |
...
Modified [CTFontManagerSetAutoActivationSetting(_: CFString?, _: CTFontManagerAutoActivationSetting)](https://developer.apple.com/documentation/coretext/1499481-ctfontmanagersetautoactivationse)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerSetAutoActivationSetting(_ bundleIdentifier: CFString!, _ setting: CTFontManagerAutoActivationSetting) ``` |
| To | ``` func CTFontManagerSetAutoActivationSetting(_ bundleIdentifier: CFString?, _ setting: CTFontManagerAutoActivationSetting) ``` |
...
| To | ``` let kCTCharacterShapeAttributeName: CFString ``` | OS X 10.11 |
...
Modified [kCTFontCollectionDisallowAutoActivationOption](https://developer.apple.com/documentation/coretext/kctfontcollectiondisallowautoactivationoption)

|  | Declaration |
| --- | --- |
| From | ``` let kCTFontCollectionDisallowAutoActivationOption: CFString! ``` |
| To | ``` let kCTFontCollectionDisallowAutoActivationOption: CFString ``` |

Modified [kCTFontCollectionIncludeDisabledFontsOption](https://developer.apple.com/documentation/coretext/kctfontcollectionincludedisabledfontsoption)

|  | Declaration |
| --- | --- |
| From | ``` let kCTFontCollectionIncludeDisabledFontsOption: CFString! ``` |
| To | ``` let kCTFontCollectionIncludeDisabledFontsOption: CFString ``` |
...
Modified [kCTFontManagerBundleIdentifier](https://developer.apple.com/documentation/coretext/kctfontmanagerbundleidentifier)

|  | Declaration |
| --- | --- |
| From | ``` let kCTFontManagerBundleIdentifier: CFString! ``` |
| To | ``` let kCTFontManagerBundleIdentifier: CFString ``` |
