...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOSX10_11/Swift/Dispatch.html
archived_at: '2026-07-18T02:53:31.981275Z'
---
...
| To | ``` @warn_unused_result func dispatch_get_global_queue(_ identifier: qos_class_t, _ flags: UInt) -> dispatch_queue_t ``` | OS X 10.11 |
