...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/CoreText.html
archived_at: '2026-07-18T02:51:12.072438Z'
---
...
Modified [CTFontCollectionCopyOptions [struct]](https://developer.apple.com/documentation/coretext/ctfontcollectioncopyoptions)

|  | Declaration | Protocols |
| --- | --- | --- |
| From | ``` struct CTFontCollectionCopyOptions : OptionSetType {     init(rawValue rawValue: UInt32)     static var DefaultOptions: CTFontCollectionCopyOptions { get }     static var Unique: CTFontCollectionCopyOptions { get }     static var StandardSort: CTFontCollectionCopyOptions { get } } ``` | OptionSetType |
| To | ``` struct CTFontCollectionCopyOptions : OptionSet {     init(rawValue rawValue: UInt32)     static var defaultOptions: CTFontCollectionCopyOptions { get }     static var unique: CTFontCollectionCopyOptions { get }     static var standardSort: CTFontCollectionCopyOptions { get }     func intersect(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions     func exclusiveOr(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions     mutating func unionInPlace(_ other: CTFontCollectionCopyOptions)     mutating func intersectInPlace(_ other: CTFontCollectionCopyOptions)     mutating func exclusiveOrInPlace(_ other: CTFontCollectionCopyOptions)     func isSubsetOf(_ other: CTFontCollectionCopyOptions) -> Bool     func isDisjointWith(_ other: CTFontCollectionCopyOptions) -> Bool     func isSupersetOf(_ other: CTFontCollectionCopyOptions) -> Bool     mutating func subtractInPlace(_ other: CTFontCollectionCopyOptions)     func isStrictSupersetOf(_ other: CTFontCollectionCopyOptions) -> Bool     func isStrictSubsetOf(_ other: CTFontCollectionCopyOptions) -> Bool } extension CTFontCollectionCopyOptions {     func union(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions     func intersection(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions     func symmetricDifference(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions } extension CTFontCollectionCopyOptions {     func contains(_ member: CTFontCollectionCopyOptions) -> Bool     mutating func insert(_ newMember: CTFontCollectionCopyOptions) -> (inserted: Bool, memberAfterInsert: CTFontCollectionCopyOptions)     mutating func remove(_ member: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions?     mutating func update(with newMember: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions? } extension CTFontCollectionCopyOptions {     convenience init()     mutating func formUnion(_ other: CTFontCollectionCopyOptions)     mutating func formIntersection(_ other: CTFontCollectionCopyOptions)     mutating func formSymmetricDifference(_ other: CTFontCollectionCopyOptions) } extension CTFontCollectionCopyOptions {     convenience init<S : Sequence where S.Iterator.Element == CTFontCollectionCopyOptions>(_ sequence: S)     convenience init(arrayLiteral arrayLiteral: CTFontCollectionCopyOptions...)     mutating func subtract(_ other: CTFontCollectionCopyOptions)     func isSubset(of other: CTFontCollectionCopyOptions) -> Bool     func isSuperset(of other: CTFontCollectionCopyOptions) -> Bool     func isDisjoint(with other: CTFontCollectionCopyOptions) -> Bool     func subtracting(_ other: CTFontCollectionCopyOptions) -> CTFontCollectionCopyOptions     var isEmpty: Bool { get }     func isStrictSuperset(of other: CTFontCollectionCopyOptions) -> Bool     func isStrictSubset(of other: CTFontCollectionCopyOptions) -> Bool } ``` | OptionSet |

Modified [CTFontCollectionCopyOptions.standardSort](https://developer.apple.com/documentation/coretext/ctfontcollectioncopyoptions/1509424-standardsort)

|  | Declaration |
| --- | --- |
| From | ``` static var StandardSort: CTFontCollectionCopyOptions { get } ``` |
| To | ``` static var standardSort: CTFontCollectionCopyOptions { get } ``` |

Modified [CTFontCollectionCopyOptions.unique](https://developer.apple.com/documentation/coretext/ctfontcollectioncopyoptions/1508774-unique)

|  | Declaration |
| --- | --- |
| From | ``` static var Unique: CTFontCollectionCopyOptions { get } ``` |
| To | ``` static var unique: CTFontCollectionCopyOptions { get } ``` |
...
Modified [CTFontManagerCompareFontFamilyNames(_: UnsafeRawPointer, _: UnsafeRawPointer, _: UnsafeMutableRawPointer?) -> CFComparisonResult](https://developer.apple.com/documentation/coretext/1499513-ctfontmanagercomparefontfamilyna)

|  | Declaration |
| --- | --- |
| From | ``` func CTFontManagerCompareFontFamilyNames(_ family1: UnsafePointer<Void>, _ family2: UnsafePointer<Void>, _ context: UnsafeMutablePointer<Void>) -> CFComparisonResult ``` |
| To | ``` func CTFontManagerCompareFontFamilyNames(_ family1: UnsafeRawPointer, _ family2: UnsafeRawPointer, _ context: UnsafeMutableRawPointer?) -> CFComparisonResult ``` |
...
| To | ``` func CTFontManagerCreateFontRequestRunLoopSource(_ sourceOrder: CFIndex, _ createMatchesCallback: @escaping (CFDictionary, pid_t) -> Unmanaged<CFArray>) -> CFRunLoopSource? ``` |
