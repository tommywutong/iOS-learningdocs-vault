...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/AudioToolbox.html
archived_at: '2026-07-18T02:50:57.722135Z'
---
...
Modified [AUAudioUnit.setDeviceID(_: AudioObjectID) throws](https://developer.apple.com/documentation/audiotoolbox/auaudiounit/1387608-setdeviceid)
...
| To | ``` class AUAudioUnitBus : NSObject {     var format: AVAudioFormat { get }     func setFormat(_ format: AVAudioFormat) throws     var isEnabled: Bool     var name: String?     var index: Int { get }     var busType: AUAudioUnitBusType { get }     unowned(unsafe) var ownerAudioUnit: AUAudioUnit { get }     var supportedChannelLayoutTags: [NSNumber]? { get }     var contextPresentationLatency: TimeInterval     init(format format: AVAudioFormat) throws     var supportedChannelCounts: [NSNumber]?     var maximumChannelCount: AUAudioChannelCount     func scriptingIsEqual(to object: Any) -> Bool     func scriptingIsLessThanOrEqual(to object: Any) -> Bool     func scriptingIsLessThan(_ object: Any) -> Bool     func scriptingIsGreaterThanOrEqual(to object: Any) -> Bool     func scriptingIsGreaterThan(_ object: Any) -> Bool     func scriptingBegins(with object: Any) -> Bool     func scriptingEnds(with object: Any) -> Bool     func scriptingContains(_ object: Any) -> Bool     func isEqual(to object: Any?) -> Bool     func isLessThanOrEqual(to object: Any?) -> Bool     func isLessThan(_ object: Any?) -> Bool     func isGreaterThanOrEqual(to object: Any?) -> Bool     func isGreaterThan(_ object: Any?) -> Bool     func isNotEqual(to object: Any?) -> Bool     func doesContain(_ object: Any) -> Bool     func isLike(_ object: String) -> Bool     func isCaseInsensitiveLike(_ object: String) -> Bool     var objectSpecifier: NSScriptObjectSpecifier? { get }     func indicesOfObjects(byEvaluatingObjectSpecifier specifier: NSScriptObjectSpecifier) -> [NSNumber]?     func value(at index: Int, inPropertyWithKey key: String) -> Any?     func value(withName name: String, inPropertyWithKey key: String) -> Any?     func value(withUniqueID uniqueID: Any, inPropertyWithKey key: String) -> Any?     func insertValue(_ value: Any, at index: Int, inPropertyWithKey key: String)     func removeValue(at index: Int, fromPropertyWithKey key: String)     func replaceValue(at index: Int, inPropertyWithKey key: String, withValue value: Any)     func insertValue(_ value: Any, inPropertyWithKey key: String)     func coerceValue(_ value: Any?, forKey key: String) -> Any?     var classCode: FourCharCode { get }     var className: String { get }     func scriptingValue(for objectSpecifier: NSScriptObjectSpecifier) -> Any?     var scriptingProperties: [String : Any]?     func copyScriptingValue(_ value: Any, forKey key: String, withProperties properties: [String : Any]) -> Any?     func newScriptingObject(of objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: Any?, properties properties: [String : Any]) -> Any?     @NSCopying var classDescription: NSClassDescription { get }     var attributeKeys: [String] { get }     var toOneRelationshipKeys: [String] { get }     var toManyRelationshipKeys: [String] { get }     func inverse(forRelationshipKey relationshipKey: String) -> String?     var classForPortCoder: AnyClass { get }     func replacementObject(for coder: NSPortCoder) -> Any?     var classForArchiver: AnyClass? { get }     func replacementObject(for archiver: NSArchiver) -> Any?     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool)     func performSelector(inBackground aSelector: Selector, with arg: Any?)     class func classForKeyedUnarchiver() -> AnyClass     var classForKeyedArchiver: AnyClass? { get }     func replacementObject(for archiver: NSKeyedArchiver) -> Any?     class func classFallbacksForKeyedArchiver() -> [String]     class func setKeys(_ keys: [Any], triggerChangeNotificationsForDependentKey dependentKey: String)     class func keyPathsForValuesAffectingValue(forKey key: String) -> Set<String>     class func automaticallyNotifiesObservers(forKey key: String) -> Bool     var observationInfo: UnsafeMutableRawPointer?     func willChangeValue(forKey key: String)     func didChangeValue(forKey key: String)     func willChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func didChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func willChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func didChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func addObserver(_ observer: NSObject, forKeyPath keyPath: String, options options: NSKeyValueObservingOptions = [], context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String, context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String)     func observeValue(forKeyPath keyPath: String?, of object: Any?, change change: [NSKeyValueChangeKey : Any]?, context context: UnsafeMutableRawPointer?)     class func useStoredAccessor() -> Bool     func storedValue(forKey key: String) -> Any?     func takeStoredValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKeyPath keyPath: String)     func handleQuery(withUnboundKey key: String) -> Any?     func handleTakeValue(_ value: Any?, forUnboundKey key: String)     func unableToSetNil(forKey key: String)     func values(forKeys keys: [Any]) -> [AnyHashable : Any]     func takeValues(from properties: [AnyHashable : Any])     class var accessInstanceVariablesDirectly: Bool { get }     func value(forKey key: String) -> Any?     func setValue(_ value: Any?, forKey key: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKey inKey: String) throws     func mutableArrayValue(forKey key: String) -> NSMutableArray     func mutableOrderedSetValue(forKey key: String) -> NSMutableOrderedSet     func mutableSetValue(forKey key: String) -> NSMutableSet     func value(forKeyPath keyPath: String) -> Any?     func setValue(_ value: Any?, forKeyPath keyPath: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKeyPath inKeyPath: String) throws     func mutableArrayValue(forKeyPath keyPath: String) -> NSMutableArray     func mutableOrderedSetValue(forKeyPath keyPath: String) -> NSMutableOrderedSet     func mutableSetValue(forKeyPath keyPath: String) -> NSMutableSet     func value(forUndefinedKey key: String) -> Any?     func setValue(_ value: Any?, forUndefinedKey key: String)     func setNilValueForKey(_ key: String)     func dictionaryWithValues(forKeys keys: [String]) -> [String : Any]     func setValuesForKeys(_ keyedValues: [String : Any])     func fileManager(_ fm: FileManager, shouldProceedAfterError errorInfo: [AnyHashable : Any]) -> Bool     func fileManager(_ fm: FileManager, willProcessPath path: String)     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval, inModes modes: [RunLoopMode])     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval)     class func cancelPreviousPerformRequests(withTarget aTarget: Any, selector aSelector: Selector, object anArgument: Any?)     class func cancelPreviousPerformRequests(withTarget aTarget: Any)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int, delegate delegate: Any?, didRecoverSelector didRecoverSelector: Selector?, contextInfo contextInfo: UnsafeMutableRawPointer?)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int) -> Bool     var autoContentAccessingProxy: Any { get }     class func pose(as aClass: AnyClass)     class func version() -> Int     class func setVersion(_ aVersion: Int)     var classForCoder: AnyClass { get }     func replacementObject(for aCoder: NSCoder) -> Any?     func awakeAfter(using aDecoder: NSCoder) -> Any? } extension AUAudioUnitBus : CVarArg { } extension AUAudioUnitBus : Equatable, Hashable {     var hashValue: Int { get } } extension AUAudioUnitBus {     init(format format: AVAudioFormat) throws     var supportedChannelCounts: [NSNumber]?     var maximumChannelCount: AUAudioChannelCount } ``` | CVarArg, Equatable, Hashable | AudioToolbox |
...
| To | ``` class AUAudioUnitBusArray : NSObject, NSFastEnumeration {     convenience init()     init(audioUnit owner: AUAudioUnit, busType busType: AUAudioUnitBusType, busses busArray: [AUAudioUnitBus])     convenience init(audioUnit owner: AUAudioUnit, busType busType: AUAudioUnitBusType)     var count: Int { get }     subscript(_ index: Int) -> AUAudioUnitBus { get }     func objectAtIndexedSubscript(_ index: Int) -> AUAudioUnitBus     var isCountChangeable: Bool { get }     func setBusCount(_ count: Int) throws     func addObserver(toAllBusses observer: NSObject, forKeyPath keyPath: String, options options: NSKeyValueObservingOptions = [], context context: UnsafeMutableRawPointer?)     func removeObserver(fromAllBusses observer: NSObject, forKeyPath keyPath: String, context context: UnsafeMutableRawPointer?)     unowned(unsafe) var ownerAudioUnit: AUAudioUnit { get }     var busType: AUAudioUnitBusType { get }     func replaceBusses(_ busArray: [AUAudioUnitBus])     func scriptingIsEqual(to object: Any) -> Bool     func scriptingIsLessThanOrEqual(to object: Any) -> Bool     func scriptingIsLessThan(_ object: Any) -> Bool     func scriptingIsGreaterThanOrEqual(to object: Any) -> Bool     func scriptingIsGreaterThan(_ object: Any) -> Bool     func scriptingBegins(with object: Any) -> Bool     func scriptingEnds(with object: Any) -> Bool     func scriptingContains(_ object: Any) -> Bool     func isEqual(to object: Any?) -> Bool     func isLessThanOrEqual(to object: Any?) -> Bool     func isLessThan(_ object: Any?) -> Bool     func isGreaterThanOrEqual(to object: Any?) -> Bool     func isGreaterThan(_ object: Any?) -> Bool     func isNotEqual(to object: Any?) -> Bool     func doesContain(_ object: Any) -> Bool     func isLike(_ object: String) -> Bool     func isCaseInsensitiveLike(_ object: String) -> Bool     var objectSpecifier: NSScriptObjectSpecifier? { get }     func indicesOfObjects(byEvaluatingObjectSpecifier specifier: NSScriptObjectSpecifier) -> [NSNumber]?     func value(at index: Int, inPropertyWithKey key: String) -> Any?     func value(withName name: String, inPropertyWithKey key: String) -> Any?     func value(withUniqueID uniqueID: Any, inPropertyWithKey key: String) -> Any?     func insertValue(_ value: Any, at index: Int, inPropertyWithKey key: String)     func removeValue(at index: Int, fromPropertyWithKey key: String)     func replaceValue(at index: Int, inPropertyWithKey key: String, withValue value: Any)     func insertValue(_ value: Any, inPropertyWithKey key: String)     func coerceValue(_ value: Any?, forKey key: String) -> Any?     var classCode: FourCharCode { get }     var className: String { get }     func scriptingValue(for objectSpecifier: NSScriptObjectSpecifier) -> Any?     var scriptingProperties: [String : Any]?     func copyScriptingValue(_ value: Any, forKey key: String, withProperties properties: [String : Any]) -> Any?     func newScriptingObject(of objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: Any?, properties properties: [String : Any]) -> Any?     @NSCopying var classDescription: NSClassDescription { get }     var attributeKeys: [String] { get }     var toOneRelationshipKeys: [String] { get }     var toManyRelationshipKeys: [String] { get }     func inverse(forRelationshipKey relationshipKey: String) -> String?     var classForPortCoder: AnyClass { get }     func replacementObject(for coder: NSPortCoder) -> Any?     var classForArchiver: AnyClass? { get }     func replacementObject(for archiver: NSArchiver) -> Any?     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool)     func performSelector(inBackground aSelector: Selector, with arg: Any?)     class func classForKeyedUnarchiver() -> AnyClass     var classForKeyedArchiver: AnyClass? { get }     func replacementObject(for archiver: NSKeyedArchiver) -> Any?     class func classFallbacksForKeyedArchiver() -> [String]     class func setKeys(_ keys: [Any], triggerChangeNotificationsForDependentKey dependentKey: String)     class func keyPathsForValuesAffectingValue(forKey key: String) -> Set<String>     class func automaticallyNotifiesObservers(forKey key: String) -> Bool     var observationInfo: UnsafeMutableRawPointer?     func willChangeValue(forKey key: String)     func didChangeValue(forKey key: String)     func willChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func didChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func willChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func didChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func addObserver(_ observer: NSObject, forKeyPath keyPath: String, options options: NSKeyValueObservingOptions = [], context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String, context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String)     func observeValue(forKeyPath keyPath: String?, of object: Any?, change change: [NSKeyValueChangeKey : Any]?, context context: UnsafeMutableRawPointer?)     class func useStoredAccessor() -> Bool     func storedValue(forKey key: String) -> Any?     func takeStoredValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKeyPath keyPath: String)     func handleQuery(withUnboundKey key: String) -> Any?     func handleTakeValue(_ value: Any?, forUnboundKey key: String)     func unableToSetNil(forKey key: String)     func values(forKeys keys: [Any]) -> [AnyHashable : Any]     func takeValues(from properties: [AnyHashable : Any])     class var accessInstanceVariablesDirectly: Bool { get }     func value(forKey key: String) -> Any?     func setValue(_ value: Any?, forKey key: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKey inKey: String) throws     func mutableArrayValue(forKey key: String) -> NSMutableArray     func mutableOrderedSetValue(forKey key: String) -> NSMutableOrderedSet     func mutableSetValue(forKey key: String) -> NSMutableSet     func value(forKeyPath keyPath: String) -> Any?     func setValue(_ value: Any?, forKeyPath keyPath: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKeyPath inKeyPath: String) throws     func mutableArrayValue(forKeyPath keyPath: String) -> NSMutableArray     func mutableOrderedSetValue(forKeyPath keyPath: String) -> NSMutableOrderedSet     func mutableSetValue(forKeyPath keyPath: String) -> NSMutableSet     func value(forUndefinedKey key: String) -> Any?     func setValue(_ value: Any?, forUndefinedKey key: String)     func setNilValueForKey(_ key: String)     func dictionaryWithValues(forKeys keys: [String]) -> [String : Any]     func setValuesForKeys(_ keyedValues: [String : Any])     func fileManager(_ fm: FileManager, shouldProceedAfterError errorInfo: [AnyHashable : Any]) -> Bool     func fileManager(_ fm: FileManager, willProcessPath path: String)     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval, inModes modes: [RunLoopMode])     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval)     class func cancelPreviousPerformRequests(withTarget aTarget: Any, selector aSelector: Selector, object anArgument: Any?)     class func cancelPreviousPerformRequests(withTarget aTarget: Any)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int, delegate delegate: Any?, didRecoverSelector didRecoverSelector: Selector?, contextInfo contextInfo: UnsafeMutableRawPointer?)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int) -> Bool     var autoContentAccessingProxy: Any { get }     class func pose(as aClass: AnyClass)     class func version() -> Int     class func setVersion(_ aVersion: Int)     var classForCoder: AnyClass { get }     func replacementObject(for aCoder: NSCoder) -> Any?     func awakeAfter(using aDecoder: NSCoder) -> Any? } extension AUAudioUnitBusArray : CVarArg { } extension AUAudioUnitBusArray : Equatable, Hashable {     var hashValue: Int { get } } extension AUAudioUnitBusArray {     func replaceBusses(_ busArray: [AUAudioUnitBus]) } ``` | CVarArg, Equatable, Hashable, NSFastEnumeration | AudioToolbox |
...
| To | ``` class AUAudioUnitPreset : NSObject, NSSecureCoding {     var number: Int     var name: String     func scriptingIsEqual(to object: Any) -> Bool     func scriptingIsLessThanOrEqual(to object: Any) -> Bool     func scriptingIsLessThan(_ object: Any) -> Bool     func scriptingIsGreaterThanOrEqual(to object: Any) -> Bool     func scriptingIsGreaterThan(_ object: Any) -> Bool     func scriptingBegins(with object: Any) -> Bool     func scriptingEnds(with object: Any) -> Bool     func scriptingContains(_ object: Any) -> Bool     func isEqual(to object: Any?) -> Bool     func isLessThanOrEqual(to object: Any?) -> Bool     func isLessThan(_ object: Any?) -> Bool     func isGreaterThanOrEqual(to object: Any?) -> Bool     func isGreaterThan(_ object: Any?) -> Bool     func isNotEqual(to object: Any?) -> Bool     func doesContain(_ object: Any) -> Bool     func isLike(_ object: String) -> Bool     func isCaseInsensitiveLike(_ object: String) -> Bool     var objectSpecifier: NSScriptObjectSpecifier? { get }     func indicesOfObjects(byEvaluatingObjectSpecifier specifier: NSScriptObjectSpecifier) -> [NSNumber]?     func value(at index: Int, inPropertyWithKey key: String) -> Any?     func value(withName name: String, inPropertyWithKey key: String) -> Any?     func value(withUniqueID uniqueID: Any, inPropertyWithKey key: String) -> Any?     func insertValue(_ value: Any, at index: Int, inPropertyWithKey key: String)     func removeValue(at index: Int, fromPropertyWithKey key: String)     func replaceValue(at index: Int, inPropertyWithKey key: String, withValue value: Any)     func insertValue(_ value: Any, inPropertyWithKey key: String)     func coerceValue(_ value: Any?, forKey key: String) -> Any?     var classCode: FourCharCode { get }     var className: String { get }     func scriptingValue(for objectSpecifier: NSScriptObjectSpecifier) -> Any?     var scriptingProperties: [String : Any]?     func copyScriptingValue(_ value: Any, forKey key: String, withProperties properties: [String : Any]) -> Any?     func newScriptingObject(of objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: Any?, properties properties: [String : Any]) -> Any?     @NSCopying var classDescription: NSClassDescription { get }     var attributeKeys: [String] { get }     var toOneRelationshipKeys: [String] { get }     var toManyRelationshipKeys: [String] { get }     func inverse(forRelationshipKey relationshipKey: String) -> String?     var classForPortCoder: AnyClass { get }     func replacementObject(for coder: NSPortCoder) -> Any?     var classForArchiver: AnyClass? { get }     func replacementObject(for archiver: NSArchiver) -> Any?     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool)     func performSelector(inBackground aSelector: Selector, with arg: Any?)     class func classForKeyedUnarchiver() -> AnyClass     var classForKeyedArchiver: AnyClass? { get }     func replacementObject(for archiver: NSKeyedArchiver) -> Any?     class func classFallbacksForKeyedArchiver() -> [String]     class func setKeys(_ keys: [Any], triggerChangeNotificationsForDependentKey dependentKey: String)     class func keyPathsForValuesAffectingValue(forKey key: String) -> Set<String>     class func automaticallyNotifiesObservers(forKey key: String) -> Bool     var observationInfo: UnsafeMutableRawPointer?     func willChangeValue(forKey key: String)     func didChangeValue(forKey key: String)     func willChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func didChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func willChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func didChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func addObserver(_ observer: NSObject, forKeyPath keyPath: String, options options: NSKeyValueObservingOptions = [], context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String, context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String)     func observeValue(forKeyPath keyPath: String?, of object: Any?, change change: [NSKeyValueChangeKey : Any]?, context context: UnsafeMutableRawPointer?)     class func useStoredAccessor() -> Bool     func storedValue(forKey key: String) -> Any?     func takeStoredValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKeyPath keyPath: String)     func handleQuery(withUnboundKey key: String) -> Any?     func handleTakeValue(_ value: Any?, forUnboundKey key: String)     func unableToSetNil(forKey key: String)     func values(forKeys keys: [Any]) -> [AnyHashable : Any]     func takeValues(from properties: [AnyHashable : Any])     class var accessInstanceVariablesDirectly: Bool { get }     func value(forKey key: String) -> Any?     func setValue(_ value: Any?, forKey key: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKey inKey: String) throws     func mutableArrayValue(forKey key: String) -> NSMutableArray     func mutableOrderedSetValue(forKey key: String) -> NSMutableOrderedSet     func mutableSetValue(forKey key: String) -> NSMutableSet     func value(forKeyPath keyPath: String) -> Any?     func setValue(_ value: Any?, forKeyPath keyPath: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKeyPath inKeyPath: String) throws     func mutableArrayValue(forKeyPath keyPath: String) -> NSMutableArray     func mutableOrderedSetValue(forKeyPath keyPath: String) -> NSMutableOrderedSet     func mutableSetValue(forKeyPath keyPath: String) -> NSMutableSet     func value(forUndefinedKey key: String) -> Any?     func setValue(_ value: Any?, forUndefinedKey key: String)     func setNilValueForKey(_ key: String)     func dictionaryWithValues(forKeys keys: [String]) -> [String : Any]     func setValuesForKeys(_ keyedValues: [String : Any])     func fileManager(_ fm: FileManager, shouldProceedAfterError errorInfo: [AnyHashable : Any]) -> Bool     func fileManager(_ fm: FileManager, willProcessPath path: String)     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval, inModes modes: [RunLoopMode])     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval)     class func cancelPreviousPerformRequests(withTarget aTarget: Any, selector aSelector: Selector, object anArgument: Any?)     class func cancelPreviousPerformRequests(withTarget aTarget: Any)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int, delegate delegate: Any?, didRecoverSelector didRecoverSelector: Selector?, contextInfo contextInfo: UnsafeMutableRawPointer?)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int) -> Bool     var autoContentAccessingProxy: Any { get }     class func pose(as aClass: AnyClass)     class func version() -> Int     class func setVersion(_ aVersion: Int)     var classForCoder: AnyClass { get }     func replacementObject(for aCoder: NSCoder) -> Any?     func awakeAfter(using aDecoder: NSCoder) -> Any? } extension AUAudioUnitPreset : CVarArg { } extension AUAudioUnitPreset : Equatable, Hashable {     var hashValue: Int { get } } ``` | CVarArg, Equatable, Hashable, NSSecureCoding | AudioToolbox |
...
Modified [AudioCodecMagicCookieInfo [struct]](https://developer.apple.com/documentation/audiotoolbox/audiocodecmagiccookieinfo)

|  | Declaration | Module |
| --- | --- | --- |
| From | ``` struct AudioCodecMagicCookieInfo {     var mMagicCookieSize: UInt32     var mMagicCookie: UnsafePointer<Void>     init()     init(mMagicCookieSize mMagicCookieSize: UInt32, mMagicCookie mMagicCookie: UnsafePointer<Void>) } ``` | AudioUnit |
| To | ``` struct AudioCodecMagicCookieInfo {     var mMagicCookieSize: UInt32     var mMagicCookie: UnsafeRawPointer?     init()     init(mMagicCookieSize mMagicCookieSize: UInt32, mMagicCookie mMagicCookie: UnsafeRawPointer?) } ``` | AudioToolbox |

Modified [AudioCodecMagicCookieInfo.init()](https://developer.apple.com/documentation/audiotoolbox/audiocodecmagiccookieinfo/1440355-init)
...
Modified [AudioCodecMagicCookieInfo.mMagicCookie](https://developer.apple.com/documentation/audiotoolbox/audiocodecmagiccookieinfo/1440899-mmagiccookie)
...
Modified [AudioCodecMagicCookieInfo.mMagicCookieSize](https://developer.apple.com/documentation/audiotoolbox/audiocodecmagiccookieinfo/1438503-mmagiccookiesize)
...
Modified [AudioCodecPrimeInfo [struct]](https://developer.apple.com/documentation/audiotoolbox/audiocodecprimeinfo)
...
Modified [AudioCodecPrimeInfo.init()](https://developer.apple.com/documentation/audiotoolbox/audiocodecprimeinfo/1439210-init)
...
Modified [AudioCodecPrimeInfo.init(leadingFrames: UInt32, trailingFrames: UInt32)](https://developer.apple.com/documentation/audiotoolbox/audiocodecprimeinfo/1440969-init)
...
Modified [AudioCodecPrimeInfo.leadingFrames](https://developer.apple.com/documentation/audiotoolbox/audiocodecprimeinfo/1439955-leadingframes)
...
Modified [AudioCodecPrimeInfo.trailingFrames](https://developer.apple.com/documentation/audiotoolbox/audiocodecprimeinfo/1440173-trailingframes)
...
Modified [AudioComponentInstantiationOptions.loadInProcess](https://developer.apple.com/documentation/audiotoolbox/audiocomponentinstantiationoptions/kaudiocomponentinstantiation_loadinprocess)
...
Modified [AudioSettingsFlags [struct]](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags)

|  | Declaration | Protocols | Module |
| --- | --- | --- | --- |
| From | ``` struct AudioSettingsFlags : OptionSetType {     init(rawValue rawValue: UInt32)     static var ExpertParameter: AudioSettingsFlags { get }     static var InvisibleParameter: AudioSettingsFlags { get }     static var MetaParameter: AudioSettingsFlags { get }     static var UserInterfaceParameter: AudioSettingsFlags { get } } ``` | OptionSetType | AudioUnit |
| To | ``` struct AudioSettingsFlags : OptionSet {     init(rawValue rawValue: UInt32)     static var expertParameter: AudioSettingsFlags { get }     static var invisibleParameter: AudioSettingsFlags { get }     static var metaParameter: AudioSettingsFlags { get }     static var userInterfaceParameter: AudioSettingsFlags { get }     func intersect(_ other: AudioSettingsFlags) -> AudioSettingsFlags     func exclusiveOr(_ other: AudioSettingsFlags) -> AudioSettingsFlags     mutating func unionInPlace(_ other: AudioSettingsFlags)     mutating func intersectInPlace(_ other: AudioSettingsFlags)     mutating func exclusiveOrInPlace(_ other: AudioSettingsFlags)     func isSubsetOf(_ other: AudioSettingsFlags) -> Bool     func isDisjointWith(_ other: AudioSettingsFlags) -> Bool     func isSupersetOf(_ other: AudioSettingsFlags) -> Bool     mutating func subtractInPlace(_ other: AudioSettingsFlags)     func isStrictSupersetOf(_ other: AudioSettingsFlags) -> Bool     func isStrictSubsetOf(_ other: AudioSettingsFlags) -> Bool } extension AudioSettingsFlags {     func union(_ other: AudioSettingsFlags) -> AudioSettingsFlags     func intersection(_ other: AudioSettingsFlags) -> AudioSettingsFlags     func symmetricDifference(_ other: AudioSettingsFlags) -> AudioSettingsFlags } extension AudioSettingsFlags {     func contains(_ member: AudioSettingsFlags) -> Bool     mutating func insert(_ newMember: AudioSettingsFlags) -> (inserted: Bool, memberAfterInsert: AudioSettingsFlags)     mutating func remove(_ member: AudioSettingsFlags) -> AudioSettingsFlags?     mutating func update(with newMember: AudioSettingsFlags) -> AudioSettingsFlags? } extension AudioSettingsFlags {     convenience init()     mutating func formUnion(_ other: AudioSettingsFlags)     mutating func formIntersection(_ other: AudioSettingsFlags)     mutating func formSymmetricDifference(_ other: AudioSettingsFlags) } extension AudioSettingsFlags {     convenience init<S : Sequence where S.Iterator.Element == AudioSettingsFlags>(_ sequence: S)     convenience init(arrayLiteral arrayLiteral: AudioSettingsFlags...)     mutating func subtract(_ other: AudioSettingsFlags)     func isSubset(of other: AudioSettingsFlags) -> Bool     func isSuperset(of other: AudioSettingsFlags) -> Bool     func isDisjoint(with other: AudioSettingsFlags) -> Bool     func subtracting(_ other: AudioSettingsFlags) -> AudioSettingsFlags     var isEmpty: Bool { get }     func isStrictSuperset(of other: AudioSettingsFlags) -> Bool     func isStrictSubset(of other: AudioSettingsFlags) -> Bool } ``` | OptionSet | AudioToolbox |

Modified [AudioSettingsFlags.expertParameter](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags/kaudiosettingsflags_expertparameter)
...
Modified [AudioSettingsFlags.init(rawValue: UInt32)](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags/1439062-init)
...
Modified [AudioSettingsFlags.invisibleParameter](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags/kaudiosettingsflags_invisibleparameter)
...
Modified [AudioSettingsFlags.metaParameter](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags/1438677-metaparameter)
...
Modified [AudioSettingsFlags.userInterfaceParameter](https://developer.apple.com/documentation/audiotoolbox/audiosettingsflags/kaudiosettingsflags_userinterfaceparameter)
...
|  | Declaration | Module |
| --- | --- | --- |
| From | ``` struct AudioUnitCocoaViewInfo {     var mCocoaAUViewBundleLocation: Unmanaged<CFURL>     var mCocoaAUViewClass: (Unmanaged<CFString>?) } ``` | AudioUnit |
| To | ``` struct AudioUnitCocoaViewInfo {     var mCocoaAUViewBundleLocation: Unmanaged<CFURL>     var mCocoaAUViewClass: (Unmanaged<CFString>) } ``` | AudioToolbox |
...
Modified [AudioUnitCocoaViewInfo.mCocoaAUViewClass](https://developer.apple.com/documentation/audiotoolbox/audiounitcocoaviewinfo/1439876-mcocoaauviewclass)
...
Modified [AudioUnitEventType [enum]](https://developer.apple.com/documentation/audiotoolbox/audiouniteventtype)

|  | Declaration |
| --- | --- |
| From | ``` enum AudioUnitEventType : UInt32 {     case ParameterValueChange     case BeginParameterChangeGesture     case EndParameterChangeGesture     case PropertyChange } ``` |
| To | ``` enum AudioUnitEventType : UInt32 {     case parameterValueChange     case beginParameterChangeGesture     case endParameterChangeGesture     case propertyChange } ``` |

Modified [AudioUnitEventType.beginParameterChangeGesture](https://developer.apple.com/documentation/audiotoolbox/audiouniteventtype/kaudiounitevent_beginparameterchangegesture)
...
Modified [AudioUnitEventType.endParameterChangeGesture](https://developer.apple.com/documentation/audiotoolbox/audiouniteventtype/endparameterchangegesture)
...
Modified [AudioUnitEventType.parameterValueChange](https://developer.apple.com/documentation/audiotoolbox/audiouniteventtype/parametervaluechange)
...
Modified [AudioUnitEventType.propertyChange](https://developer.apple.com/documentation/audiotoolbox/audiouniteventtype/propertychange)
...
Modified [AudioUnitMIDIControlMapping [struct]](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping)
...
Modified [AudioUnitMIDIControlMapping.element](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1438726-element)
...
Modified [AudioUnitMIDIControlMapping.init()](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1439976-init)
...
Modified [AudioUnitMIDIControlMapping.init(midiNRPN: UInt16, midiControl: UInt8, scope: UInt8, element: AudioUnitElement, parameter: AudioUnitParameterID)](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1438319-init)
...
Modified [AudioUnitMIDIControlMapping.midiControl](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1438497-midicontrol)
...
Modified [AudioUnitMIDIControlMapping.midiNRPN](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1440001-midinrpn)
...
Modified [AudioUnitMIDIControlMapping.parameter](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1439327-parameter)
...
Modified [AudioUnitMIDIControlMapping.scope](https://developer.apple.com/documentation/audiotoolbox/audiounitmidicontrolmapping/1439545-scope)
...
Modified [AudioUnitOtherPluginDesc [struct]](https://developer.apple.com/documentation/audiotoolbox/audiounitotherplugindesc)
...
Modified [AudioUnitOtherPluginDesc.format](https://developer.apple.com/documentation/audiotoolbox/audiounitotherplugindesc/1440224-format)
...
Modified [AudioUnitOtherPluginDesc.init()](https://developer.apple.com/documentation/audiotoolbox/audiounitotherplugindesc/1438689-init)
...
Modified [AudioUnitOtherPluginDesc.init(format: UInt32, plugin: AudioClassDescription)](https://developer.apple.com/documentation/audiotoolbox/audiounitotherplugindesc/1438799-init)
...
Modified [AudioUnitOtherPluginDesc.plugin](https://developer.apple.com/documentation/audiotoolbox/audiounitotherplugindesc/1439880-plugin)
...
Modified [AudioUnitParameterValueName.inParamID](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluename/1440501-inparamid)
...
Modified [AudioUnitParameterValueName.inValue](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluename/1440549-invalue)
...
Modified [AudioUnitParameterValueTranslation [struct]](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation)
...
Modified [AudioUnitParameterValueTranslation.auParamID](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1439031-auparamid)
...
Modified [AudioUnitParameterValueTranslation.auValue](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1439704-auvalue)
...
Modified [AudioUnitParameterValueTranslation.init()](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1438811-init)
...
Modified [AudioUnitParameterValueTranslation.init(otherDesc: AudioUnitOtherPluginDesc, otherParamID: UInt32, otherValue: Float32, auParamID: AudioUnitParameterID, auValue: AudioUnitParameterValue)](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1439649-init)
...
Modified [AudioUnitParameterValueTranslation.otherDesc](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1438720-otherdesc)
...
Modified [AudioUnitParameterValueTranslation.otherParamID](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1439212-otherparamid)
...
Modified [AudioUnitParameterValueTranslation.otherValue](https://developer.apple.com/documentation/audiotoolbox/audiounitparametervaluetranslation/1441000-othervalue)
...
Modified [AudioUnitPresetMAS_SettingData [struct]](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata)
...
Modified [AudioUnitPresetMAS_SettingData.data](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1439940-data)
...
Modified [AudioUnitPresetMAS_SettingData.dataLen](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1439472-datalen)
...
Modified [AudioUnitPresetMAS_SettingData.init()](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1438388-init)
...
Modified [AudioUnitPresetMAS_SettingData.init(isStockSetting: UInt32, settingID: UInt32, dataLen: UInt32, data: (UInt8))](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1440087-init)
...
Modified [AudioUnitPresetMAS_SettingData.isStockSetting](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1439549-isstocksetting)
...
Modified [AudioUnitPresetMAS_SettingData.settingID](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settingdata/1438943-settingid)
...
Modified [AudioUnitPresetMAS_Settings [struct]](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings)
...
Modified [AudioUnitPresetMAS_Settings.effectID](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1439749-effectid)
...
Modified [AudioUnitPresetMAS_Settings.init()](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1439365-init)
...
Modified [AudioUnitPresetMAS_Settings.init(manufacturerID: UInt32, effectID: UInt32, variantID: UInt32, settingsVersion: UInt32, numberOfSettings: UInt32, settings: (AudioUnitPresetMAS_SettingData))](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1440677-init)
...
Modified [AudioUnitPresetMAS_Settings.manufacturerID](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1439371-manufacturerid)
...
Modified [AudioUnitPresetMAS_Settings.numberOfSettings](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1439248-numberofsettings)
...
Modified [AudioUnitPresetMAS_Settings.settings](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1439009-settings)
...
Modified [AudioUnitPresetMAS_Settings.settingsVersion](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1438712-settingsversion)
...
Modified [AudioUnitPresetMAS_Settings.variantID](https://developer.apple.com/documentation/audiotoolbox/audiounitpresetmas_settings/1440523-variantid)
...
Modified [AUDistanceAttenuationData.init()](https://developer.apple.com/documentation/audiotoolbox/audistanceattenuationdata/1440920-init)
...
Modified [AUHostIdentifier.hostVersion](https://developer.apple.com/documentation/audiotoolbox/auhostidentifier/1439163-hostversion)
...
Modified [AUHostVersionIdentifier.hostVersion](https://developer.apple.com/documentation/audiotoolbox/auhostversionidentifier/1439587-hostversion)
...
|  | Declaration | Module |
| --- | --- | --- |
| From | ``` struct AUMIDIOutputCallbackStruct {     var midiOutputCallback: AUMIDIOutputCallback     var userData: UnsafeMutablePointer<Void> } ``` | AudioUnit |
| To | ``` struct AUMIDIOutputCallbackStruct {     var midiOutputCallback: AudioToolbox.AUMIDIOutputCallback     var userData: UnsafeMutableRawPointer? } ``` | AudioToolbox |

Modified [AUMIDIOutputCallbackStruct.midiOutputCallback](https://developer.apple.com/documentation/audiotoolbox/aumidioutputcallbackstruct/1440602-midioutputcallback)
...
Modified [AUMIDIOutputCallbackStruct.userData](https://developer.apple.com/documentation/audiotoolbox/aumidioutputcallbackstruct/1438324-userdata)
...
Modified [AUNumVersion [struct]](https://developer.apple.com/documentation/audiotoolbox/aunumversion)
...
Modified [AUNumVersion.init()](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1440440-init)
...
Modified [AUNumVersion.init(nonRelRev: UInt8, stage: UInt8, minorAndBugRev: UInt8, majorRev: UInt8)](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1440541-init)
...
Modified [AUNumVersion.majorRev](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1440998-majorrev)
...
Modified [AUNumVersion.minorAndBugRev](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1440137-minorandbugrev)
...
Modified [AUNumVersion.nonRelRev](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1439808-nonrelrev)
...
Modified [AUNumVersion.stage](https://developer.apple.com/documentation/audiotoolbox/aunumversion/1439500-stage)
...
| To | ``` class AUParameter : AUParameterNode, NSSecureCoding {     var minValue: AUValue { get }     var maxValue: AUValue { get }     var unit: AudioUnitParameterUnit { get }     var unitName: String? { get }     var flags: AudioUnitParameterOptions { get }     var address: AUParameterAddress { get }     var valueStrings: [String]? { get }     var dependentParameters: [NSNumber]? { get }     var value: AUValue     func setValue(_ value: AUValue, originator originator: AUParameterObserverToken?)     func setValue(_ value: AUValue, originator originator: AUParameterObserverToken?, atHostTime hostTime: UInt64)     func setValue(_ value: AUValue, originator originator: AUParameterObserverToken?, atHostTime hostTime: UInt64, eventType eventType: AUParameterAutomationEventType)     func string(fromValue value: UnsafePointer<AUValue>?) -> String     func value(from string: String) -> AUValue     var implementorValueObserver: AUImplementorValueObserver     var implementorValueProvider: AUImplementorValueProvider     var implementorStringFromValueCallback: AUImplementorStringFromValueCallback     var implementorValueFromStringCallback: AUImplementorValueFromStringCallback     var implementorDisplayNameWithLengthCallback: AUImplementorDisplayNameWithLengthCallback     func scriptingIsEqual(to object: Any) -> Bool     func scriptingIsLessThanOrEqual(to object: Any) -> Bool     func scriptingIsLessThan(_ object: Any) -> Bool     func scriptingIsGreaterThanOrEqual(to object: Any) -> Bool     func scriptingIsGreaterThan(_ object: Any) -> Bool     func scriptingBegins(with object: Any) -> Bool     func scriptingEnds(with object: Any) -> Bool     func scriptingContains(_ object: Any) -> Bool     func isEqual(to object: Any?) -> Bool     func isLessThanOrEqual(to object: Any?) -> Bool     func isLessThan(_ object: Any?) -> Bool     func isGreaterThanOrEqual(to object: Any?) -> Bool     func isGreaterThan(_ object: Any?) -> Bool     func isNotEqual(to object: Any?) -> Bool     func doesContain(_ object: Any) -> Bool     func isLike(_ object: String) -> Bool     func isCaseInsensitiveLike(_ object: String) -> Bool     var objectSpecifier: NSScriptObjectSpecifier? { get }     func indicesOfObjects(byEvaluatingObjectSpecifier specifier: NSScriptObjectSpecifier) -> [NSNumber]?     func value(at index: Int, inPropertyWithKey key: String) -> Any?     func value(withName name: String, inPropertyWithKey key: String) -> Any?     func value(withUniqueID uniqueID: Any, inPropertyWithKey key: String) -> Any?     func insertValue(_ value: Any, at index: Int, inPropertyWithKey key: String)     func removeValue(at index: Int, fromPropertyWithKey key: String)     func replaceValue(at index: Int, inPropertyWithKey key: String, withValue value: Any)     func insertValue(_ value: Any, inPropertyWithKey key: String)     func coerceValue(_ value: Any?, forKey key: String) -> Any?     var classCode: FourCharCode { get }     var className: String { get }     func scriptingValue(for objectSpecifier: NSScriptObjectSpecifier) -> Any?     var scriptingProperties: [String : Any]?     func copyScriptingValue(_ value: Any, forKey key: String, withProperties properties: [String : Any]) -> Any?     func newScriptingObject(of objectClass: AnyClass, forValueForKey key: String, withContentsValue contentsValue: Any?, properties properties: [String : Any]) -> Any?     @NSCopying var classDescription: NSClassDescription { get }     var attributeKeys: [String] { get }     var toOneRelationshipKeys: [String] { get }     var toManyRelationshipKeys: [String] { get }     func inverse(forRelationshipKey relationshipKey: String) -> String?     var classForPortCoder: AnyClass { get }     func replacementObject(for coder: NSPortCoder) -> Any?     var classForArchiver: AnyClass? { get }     func replacementObject(for archiver: NSArchiver) -> Any?     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func performSelector(onMainThread aSelector: Selector, with arg: Any?, waitUntilDone wait: Bool)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool, modes array: [String]?)     func perform(_ aSelector: Selector, on thr: Thread, with arg: Any?, waitUntilDone wait: Bool)     func performSelector(inBackground aSelector: Selector, with arg: Any?)     class func classForKeyedUnarchiver() -> AnyClass     var classForKeyedArchiver: AnyClass? { get }     func replacementObject(for archiver: NSKeyedArchiver) -> Any?     class func classFallbacksForKeyedArchiver() -> [String]     class func setKeys(_ keys: [Any], triggerChangeNotificationsForDependentKey dependentKey: String)     class func keyPathsForValuesAffectingValue(forKey key: String) -> Set<String>     class func automaticallyNotifiesObservers(forKey key: String) -> Bool     var observationInfo: UnsafeMutableRawPointer?     func willChangeValue(forKey key: String)     func didChangeValue(forKey key: String)     func willChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func didChange(_ changeKind: NSKeyValueChange, valuesAt indexes: IndexSet, forKey key: String)     func willChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func didChangeValue(forKey key: String, withSetMutation mutationKind: NSKeyValueSetMutationKind, using objects: Set<AnyHashable>)     func addObserver(_ observer: NSObject, forKeyPath keyPath: String, options options: NSKeyValueObservingOptions = [], context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String, context context: UnsafeMutableRawPointer?)     func removeObserver(_ observer: NSObject, forKeyPath keyPath: String)     func observeValue(forKeyPath keyPath: String?, of object: Any?, change change: [NSKeyValueChangeKey : Any]?, context context: UnsafeMutableRawPointer?)     class func useStoredAccessor() -> Bool     func storedValue(forKey key: String) -> Any?     func takeStoredValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKey key: String)     func takeValue(_ value: Any?, forKeyPath keyPath: String)     func handleQuery(withUnboundKey key: String) -> Any?     func handleTakeValue(_ value: Any?, forUnboundKey key: String)     func unableToSetNil(forKey key: String)     func values(forKeys keys: [Any]) -> [AnyHashable : Any]     func takeValues(from properties: [AnyHashable : Any])     class var accessInstanceVariablesDirectly: Bool { get }     func value(forKey key: String) -> Any?     func setValue(_ value: Any?, forKey key: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKey inKey: String) throws     func mutableArrayValue(forKey key: String) -> NSMutableArray     func mutableOrderedSetValue(forKey key: String) -> NSMutableOrderedSet     func mutableSetValue(forKey key: String) -> NSMutableSet     func value(forKeyPath keyPath: String) -> Any?     func setValue(_ value: Any?, forKeyPath keyPath: String)     func validateValue(_ ioValue: AutoreleasingUnsafeMutablePointer<AnyObject?>, forKeyPath inKeyPath: String) throws     func mutableArrayValue(forKeyPath keyPath: String) -> NSMutableArray     func mutableOrderedSetValue(forKeyPath keyPath: String) -> NSMutableOrderedSet     func mutableSetValue(forKeyPath keyPath: String) -> NSMutableSet     func value(forUndefinedKey key: String) -> Any?     func setValue(_ value: Any?, forUndefinedKey key: String)     func setNilValueForKey(_ key: String)     func dictionaryWithValues(forKeys keys: [String]) -> [String : Any]     func setValuesForKeys(_ keyedValues: [String : Any])     func fileManager(_ fm: FileManager, shouldProceedAfterError errorInfo: [AnyHashable : Any]) -> Bool     func fileManager(_ fm: FileManager, willProcessPath path: String)     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval, inModes modes: [RunLoopMode])     func perform(_ aSelector: Selector, with anArgument: Any?, afterDelay delay: TimeInterval)     class func cancelPreviousPerformRequests(withTarget aTarget: Any, selector aSelector: Selector, object anArgument: Any?)     class func cancelPreviousPerformRequests(withTarget aTarget: Any)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int, delegate delegate: Any?, didRecoverSelector didRecoverSelector: Selector?, contextInfo contextInfo: UnsafeMutableRawPointer?)     func attemptRecovery(fromError error: Error, optionIndex recoveryOptionIndex: Int) -> Bool     var autoContentAccessingProxy: Any { get }     class func pose(as aClass: AnyClass)     class func version() -> Int     class func setVersion(_ aVersion: Int)     var classForCoder: AnyClass { get }     func replacementObject(for aCoder: NSCoder) -> Any?     func awakeAfter(using aDecoder: NSCoder) -> Any? } extension AUParameter : CVarArg { } extension AUParameter : Equatable, Hashable {     var hashValue: Int { get } } ``` | CVarArg, Equatable, Hashable, NSSecureCoding | AudioToolbox |
...
Modified [AUParameterMIDIMapping.init()](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1439874-init)
...
Modified [AUParameterMIDIMapping.init(mScope: AudioUnitScope, mElement: AudioUnitElement, mParameterID: AudioUnitParameterID, mFlags: AUParameterMIDIMappingFlags, mSubRangeMin: AudioUnitParameterValue, mSubRangeMax: AudioUnitParameterValue, mStatus: UInt8, mData1: UInt8, reserved1: UInt8, reserved2: UInt8, reserved3: UInt32)](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1439953-init)
...
Modified [AUParameterMIDIMapping.mData1](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1440343-mdata1)
...
Modified [AUParameterMIDIMapping.mElement](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1439774-melement)
...
Modified [AUParameterMIDIMapping.mParameterID](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1440569-mparameterid)
...
Modified [AUParameterMIDIMapping.mScope](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1440077-mscope)
...
Modified [AUParameterMIDIMapping.mStatus](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1439882-mstatus)
...
Modified [AUParameterMIDIMapping.mSubRangeMax](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1438338-msubrangemax)
...
Modified [AUParameterMIDIMapping.mSubRangeMin](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1438733-msubrangemin)
...
Modified [AUParameterMIDIMapping.reserved1](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1438985-reserved1)
...
Modified [AUParameterMIDIMapping.reserved2](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1439484-reserved2)
...
Modified [AUParameterMIDIMapping.reserved3](https://developer.apple.com/documentation/audiotoolbox/auparametermidimapping/1440732-reserved3)
...
Modified [AUParameterMIDIMappingFlags [struct]](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags)

|  | Declaration | Protocols | Module |
| --- | --- | --- | --- |
| From | ``` struct AUParameterMIDIMappingFlags : OptionSetType {     init(rawValue rawValue: UInt32)     static var AnyChannelFlag: AUParameterMIDIMappingFlags { get }     static var AnyNoteFlag: AUParameterMIDIMappingFlags { get }     static var SubRange: AUParameterMIDIMappingFlags { get }     static var Toggle: AUParameterMIDIMappingFlags { get }     static var Bipolar: AUParameterMIDIMappingFlags { get }     static var Bipolar_On: AUParameterMIDIMappingFlags { get } } ``` | OptionSetType | AudioUnit |
| To | ``` struct AUParameterMIDIMappingFlags : OptionSet {     init(rawValue rawValue: UInt32)     static var anyChannelFlag: AUParameterMIDIMappingFlags { get }     static var anyNoteFlag: AUParameterMIDIMappingFlags { get }     static var subRange: AUParameterMIDIMappingFlags { get }     static var toggle: AUParameterMIDIMappingFlags { get }     static var bipolar: AUParameterMIDIMappingFlags { get }     static var bipolar_On: AUParameterMIDIMappingFlags { get }     func intersect(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags     func exclusiveOr(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags     mutating func unionInPlace(_ other: AUParameterMIDIMappingFlags)     mutating func intersectInPlace(_ other: AUParameterMIDIMappingFlags)     mutating func exclusiveOrInPlace(_ other: AUParameterMIDIMappingFlags)     func isSubsetOf(_ other: AUParameterMIDIMappingFlags) -> Bool     func isDisjointWith(_ other: AUParameterMIDIMappingFlags) -> Bool     func isSupersetOf(_ other: AUParameterMIDIMappingFlags) -> Bool     mutating func subtractInPlace(_ other: AUParameterMIDIMappingFlags)     func isStrictSupersetOf(_ other: AUParameterMIDIMappingFlags) -> Bool     func isStrictSubsetOf(_ other: AUParameterMIDIMappingFlags) -> Bool } extension AUParameterMIDIMappingFlags {     func union(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags     func intersection(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags     func symmetricDifference(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags } extension AUParameterMIDIMappingFlags {     func contains(_ member: AUParameterMIDIMappingFlags) -> Bool     mutating func insert(_ newMember: AUParameterMIDIMappingFlags) -> (inserted: Bool, memberAfterInsert: AUParameterMIDIMappingFlags)     mutating func remove(_ member: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags?     mutating func update(with newMember: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags? } extension AUParameterMIDIMappingFlags {     convenience init()     mutating func formUnion(_ other: AUParameterMIDIMappingFlags)     mutating func formIntersection(_ other: AUParameterMIDIMappingFlags)     mutating func formSymmetricDifference(_ other: AUParameterMIDIMappingFlags) } extension AUParameterMIDIMappingFlags {     convenience init<S : Sequence where S.Iterator.Element == AUParameterMIDIMappingFlags>(_ sequence: S)     convenience init(arrayLiteral arrayLiteral: AUParameterMIDIMappingFlags...)     mutating func subtract(_ other: AUParameterMIDIMappingFlags)     func isSubset(of other: AUParameterMIDIMappingFlags) -> Bool     func isSuperset(of other: AUParameterMIDIMappingFlags) -> Bool     func isDisjoint(with other: AUParameterMIDIMappingFlags) -> Bool     func subtracting(_ other: AUParameterMIDIMappingFlags) -> AUParameterMIDIMappingFlags     var isEmpty: Bool { get }     func isStrictSuperset(of other: AUParameterMIDIMappingFlags) -> Bool     func isStrictSubset(of other: AUParameterMIDIMappingFlags) -> Bool } ``` | OptionSet | AudioToolbox |

Modified [AUParameterMIDIMappingFlags.anyChannelFlag](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/kauparametermidimapping_anychannelflag)
...
Modified [AUParameterMIDIMappingFlags.anyNoteFlag](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/1438606-anynoteflag)
...
Modified [AUParameterMIDIMappingFlags.bipolar](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/kauparametermidimapping_bipolar)
...
Modified [AUParameterMIDIMappingFlags.bipolar_On](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/1438313-bipolar_on)
...
Modified [AUParameterMIDIMappingFlags.init(rawValue: UInt32)](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/1439567-init)
...
Modified [AUParameterMIDIMappingFlags.subRange](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/kauparametermidimapping_subrange)
...
Modified [AUParameterMIDIMappingFlags.toggle](https://developer.apple.com/documentation/audiotoolbox/auparametermidimappingflags/kauparametermidimapping_toggle)
...
Modified [CAClockMessage [enum]](https://developer.apple.com/documentation/audiotoolbox/caclockmessage)

|  | Declaration |
| --- | --- |
| From | ``` enum CAClockMessage : UInt32 {     case StartTimeSet     case Started     case Stopped     case Armed     case Disarmed     case PropertyChanged     case WrongSMPTEFormat } ``` |
| To | ``` enum CAClockMessage : UInt32 {     case startTimeSet     case started     case stopped     case armed     case disarmed     case propertyChanged     case wrongSMPTEFormat } ``` |

Modified [CAClockMessage.armed](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/kcaclockmessage_armed)
...
Modified [CAClockMessage.disarmed](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/disarmed)
...
Modified [CAClockMessage.propertyChanged](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/propertychanged)
...
Modified [CAClockMessage.started](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/kcaclockmessage_started)
...
Modified [CAClockMessage.startTimeSet](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/starttimeset)
...
Modified [CAClockMessage.stopped](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/stopped)
...
Modified [CAClockMessage.wrongSMPTEFormat](https://developer.apple.com/documentation/audiotoolbox/caclockmessage/wrongsmpteformat)
...
Modified [CAClockPropertyID [enum]](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid)

|  | Declaration |
| --- | --- |
| From | ``` enum CAClockPropertyID : UInt32 {     case InternalTimebase     case TimebaseSource     case SyncMode     case SyncSource     case SMPTEFormat     case SMPTEOffset     case MIDIClockDestinations     case MTCDestinations     case MTCFreewheelTime     case TempoMap     case MeterTrack     case Name     case SendMIDISPP } ``` |
| To | ``` enum CAClockPropertyID : UInt32 {     case internalTimebase     case timebaseSource     case syncMode     case syncSource     case smpteFormat     case smpteOffset     case midiClockDestinations     case mtcDestinations     case mtcFreewheelTime     case tempoMap     case meterTrack     case name     case sendMIDISPP } ``` |

Modified [CAClockPropertyID.internalTimebase](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_internaltimebase)
...
Modified [CAClockPropertyID.meterTrack](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_metertrack)
...
Modified [CAClockPropertyID.midiClockDestinations](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/midiclockdestinations)
...
Modified [CAClockPropertyID.mtcDestinations](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_mtcdestinations)
...
Modified [CAClockPropertyID.mtcFreewheelTime](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_mtcfreewheeltime)
...
Modified [CAClockPropertyID.name](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/name)
...
Modified [CAClockPropertyID.sendMIDISPP](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_sendmidispp)
...
Modified [CAClockPropertyID.smpteFormat](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/smpteformat)
...
Modified [CAClockPropertyID.smpteOffset](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/smpteoffset)
...
Modified [CAClockPropertyID.syncMode](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_syncmode)
...
Modified [CAClockPropertyID.syncSource](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/kcaclockproperty_syncsource)
...
Modified [CAClockPropertyID.tempoMap](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/tempomap)
...
Modified [CAClockPropertyID.timebaseSource](https://developer.apple.com/documentation/audiotoolbox/caclockpropertyid/timebasesource)
...
Modified [CAClockSyncMode [enum]](https://developer.apple.com/documentation/audiotoolbox/caclocksyncmode)

|  | Declaration |
| --- | --- |
| From | ``` enum CAClockSyncMode : UInt32 {     case Internal     case MIDIClockTransport     case MTCTransport } ``` |
| To | ``` enum CAClockSyncMode : UInt32 {     case `internal`     case midiClockTransport     case mtcTransport } ``` |

Modified [CAClockSyncMode.internal](https://developer.apple.com/documentation/audiotoolbox/caclocksyncmode/kcaclocksyncmode_internal)
...
Modified [CAClockSyncMode.midiClockTransport](https://developer.apple.com/documentation/audiotoolbox/caclocksyncmode/midiclocktransport)
...
Modified [CAClockSyncMode.mtcTransport](https://developer.apple.com/documentation/audiotoolbox/caclocksyncmode/mtctransport)
...
Modified [CAClockTimebase [enum]](https://developer.apple.com/documentation/audiotoolbox/caclocktimebase)

|  | Declaration |
| --- | --- |
| From | ``` enum CAClockTimebase : UInt32 {     case HostTime     case AudioDevice     case AudioOutputUnit } ``` |
| To | ``` enum CAClockTimebase : UInt32 {     case hostTime     case audioDevice     case audioOutputUnit } ``` |

Modified [CAClockTimebase.audioDevice](https://developer.apple.com/documentation/audiotoolbox/caclocktimebase/kcaclocktimebase_audiodevice)
...
Modified [CAClockTimebase.audioOutputUnit](https://developer.apple.com/documentation/audiotoolbox/caclocktimebase/kcaclocktimebase_audiooutputunit)
...
Modified [CAClockTimebase.hostTime](https://developer.apple.com/documentation/audiotoolbox/caclocktimebase/hosttime)
...
Modified [CAClockTimeFormat [enum]](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat)

|  | Declaration |
| --- | --- |
| From | ``` enum CAClockTimeFormat : UInt32 {     case HostTime     case Samples     case Beats     case Seconds     case SMPTESeconds     case SMPTETime     case AbsoluteSeconds } ``` |
| To | ``` enum CAClockTimeFormat : UInt32 {     case hostTime     case samples     case beats     case seconds     case smpteSeconds     case smpteTime     case absoluteSeconds } ``` |

Modified [CAClockTimeFormat.absoluteSeconds](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/kcaclocktimeformat_absoluteseconds)
...
Modified [CAClockTimeFormat.beats](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/kcaclocktimeformat_beats)
...
Modified [CAClockTimeFormat.hostTime](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/hosttime)
...
Modified [CAClockTimeFormat.samples](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/samples)
...
Modified [CAClockTimeFormat.seconds](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/seconds)
...
Modified [CAClockTimeFormat.smpteSeconds](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/smpteseconds)
...
Modified [CAClockTimeFormat.smpteTime](https://developer.apple.com/documentation/audiotoolbox/caclocktimeformat/kcaclocktimeformat_smptetime)
...
Modified [AudioCodecAppendInputBufferList(_: AudioCodec, _: UnsafePointer<AudioBufferList>, _: UnsafeMutablePointer<UInt32>, _: UnsafePointer<AudioStreamPacketDescription>?, _: UnsafeMutablePointer<UInt32>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439811-audiocodecappendinputbufferlist)
...
Modified [AudioCodecAppendInputData(_: AudioCodec, _: UnsafeRawPointer, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<UInt32>, _: UnsafePointer<AudioStreamPacketDescription>?) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1438536-audiocodecappendinputdata)
...
Modified [AudioCodecGetProperty(_: AudioCodec, _: AudioCodecPropertyID, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439429-audiocodecgetproperty)
...
Modified [AudioCodecInitialize(_: AudioCodec, _: UnsafePointer<AudioStreamBasicDescription>?, _: UnsafePointer<AudioStreamBasicDescription>?, _: UnsafeRawPointer?, _: UInt32) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1440177-audiocodecinitialize)
...
Modified [AudioCodecProduceOutputBufferList(_: AudioCodec, _: UnsafeMutablePointer<AudioBufferList>, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<AudioStreamPacketDescription>?, _: UnsafeMutablePointer<UInt32>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439926-audiocodecproduceoutputbufferlis)
...
Modified [AudioCodecProduceOutputPackets(_: AudioCodec, _: UnsafeMutableRawPointer, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<AudioStreamPacketDescription>?, _: UnsafeMutablePointer<UInt32>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1440558-audiocodecproduceoutputpackets)
...
Modified [AudioCodecReset(_: AudioCodec) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439087-audiocodecreset)
...
Modified [AudioCodecSetProperty(_: AudioCodec, _: AudioCodecPropertyID, _: UInt32, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439355-audiocodecsetproperty)
...
Modified [AudioCodecUninitialize(_: AudioCodec) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1439079-audiocodecuninitialize)
...
Modified [AudioComponentCopyConfigurationInfo(_: AudioComponent, _: UnsafeMutablePointer<Unmanaged<CFDictionary>?>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1410525-audiocomponentcopyconfigurationi)
...
Modified [AudioComponentGetIcon(_: AudioComponent) -> NSImage?](https://developer.apple.com/documentation/audiotoolbox/1410443-audiocomponentgeticon)
...
Modified [AudioComponentValidate(_: AudioComponent, _: CFDictionary?, _: UnsafeMutablePointer<AudioComponentValidationResult>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1410466-audiocomponentvalidate)
...
Modified [AudioFileComponentFileDataIsThisFormat(_: AudioFileComponent, _: UInt32, _: UnsafeRawPointer, _: UnsafeMutablePointer<UInt32>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404210-audiofilecomponentfiledataisthis)
...
Modified [AudioFileComponentGetGlobalInfo(_: AudioFileComponent, _: AudioFileComponentPropertyID, _: UInt32, _: UnsafeRawPointer?, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404156-audiofilecomponentgetglobalinfo)
...
Modified [AudioFileComponentGetGlobalInfoSize(_: AudioFileComponent, _: AudioFileComponentPropertyID, _: UInt32, _: UnsafeRawPointer?, _: UnsafeMutablePointer<UInt32>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404136-audiofilecomponentgetglobalinfos)
...
Modified [AudioFileComponentGetProperty(_: AudioFileComponent, _: AudioFileComponentPropertyID, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1403983-audiofilecomponentgetproperty)
...
Modified [AudioFileComponentGetPropertyInfo(_: AudioFileComponent, _: AudioFileComponentPropertyID, _: UnsafeMutablePointer<UInt32>?, _: UnsafeMutablePointer<UInt32>?) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404104-audiofilecomponentgetpropertyinf)
...
Modified [AudioFileComponentGetUserData(_: AudioFileComponent, _: UInt32, _: UInt32, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404098-audiofilecomponentgetuserdata)
...
Modified [AudioFileComponentReadBytes(_: AudioFileComponent, _: Bool, _: Int64, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404218-audiofilecomponentreadbytes)
...
Modified [AudioFileComponentReadPacketData(_: AudioFileComponent, _: Bool, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<AudioStreamPacketDescription>?, _: Int64, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404083-audiofilecomponentreadpacketdata)
...
Modified [AudioFileComponentReadPackets(_: AudioFileComponent, _: Bool, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutablePointer<AudioStreamPacketDescription>?, _: Int64, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404067-audiofilecomponentreadpackets)
...
Modified [AudioFileComponentSetProperty(_: AudioFileComponent, _: AudioFileComponentPropertyID, _: UInt32, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404188-audiofilecomponentsetproperty)
...
Modified [AudioFileComponentSetUserData(_: AudioFileComponent, _: UInt32, _: UInt32, _: UInt32, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1403993-audiofilecomponentsetuserdata)
...
Modified [AudioFileComponentWriteBytes(_: AudioFileComponent, _: Bool, _: Int64, _: UnsafeMutablePointer<UInt32>, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1404118-audiofilecomponentwritebytes)
...
Modified [AudioFileComponentWritePackets(_: AudioFileComponent, _: Bool, _: UInt32, _: UnsafePointer<AudioStreamPacketDescription>?, _: Int64, _: UnsafeMutablePointer<UInt32>, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1403969-audiofilecomponentwritepackets)
...
Modified [AudioHardwareServiceAddPropertyListener(_: AudioObjectID, _: UnsafePointer<AudioObjectPropertyAddress>!, _: CoreAudio.AudioObjectPropertyListenerProc!, _: UnsafeMutableRawPointer!) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1405236-audiohardwareserviceaddpropertyl)
...
Modified [AudioHardwareServiceGetPropertyData(_: AudioObjectID, _: UnsafePointer<AudioObjectPropertyAddress>!, _: UInt32, _: UnsafeRawPointer!, _: UnsafeMutablePointer<UInt32>!, _: UnsafeMutableRawPointer!) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1405234-audiohardwareservicegetpropertyd)
...
Modified [AudioHardwareServiceGetPropertyDataSize(_: AudioObjectID, _: UnsafePointer<AudioObjectPropertyAddress>!, _: UInt32, _: UnsafeRawPointer!, _: UnsafeMutablePointer<UInt32>!) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1405196-audiohardwareservicegetpropertyd)
...
Modified [AudioHardwareServiceRemovePropertyListener(_: AudioObjectID, _: UnsafePointer<AudioObjectPropertyAddress>!, _: CoreAudio.AudioObjectPropertyListenerProc!, _: UnsafeMutableRawPointer!) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1405266-audiohardwareserviceremoveproper)
...
Modified [AudioHardwareServiceSetPropertyData(_: AudioObjectID, _: UnsafePointer<AudioObjectPropertyAddress>!, _: UInt32, _: UnsafeRawPointer!, _: UInt32, _: UnsafeRawPointer!) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1405250-audiohardwareservicesetpropertyd)
...
Modified [AudioQueueInputCallbackBlock](https://developer.apple.com/documentation/audiotoolbox/audioqueueinputcallbackblock)
...
Modified [AudioQueueOutputCallbackBlock](https://developer.apple.com/documentation/audiotoolbox/audioqueueoutputcallbackblock)
...
Modified [AUEventListenerAddEventType(_: AUEventListenerRef, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitEvent>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1501987-aueventlisteneraddeventtype)
...
Modified [AUEventListenerBlock](https://developer.apple.com/documentation/audiotoolbox/aueventlistenerblock)
...
Modified [AUEventListenerNotify(_: AUEventListenerRef?, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitEvent>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1503031-aueventlistenernotify)
...
Modified [AUEventListenerRemoveEventType(_: AUEventListenerRef, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitEvent>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1502857-aueventlistenerremoveeventtype)
...
Modified [AUGraphGetNodeInfoSubGraph(_: AUGraph, _: AUNode, _: UnsafeMutablePointer<AUGraph?>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1503000-augraphgetnodeinfosubgraph)
...
Modified [AUListenerAddParameter(_: AUParameterListenerRef, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitParameter>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1503093-aulisteneraddparameter)
...
Modified [AUListenerRemoveParameter(_: AUParameterListenerRef, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitParameter>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1501781-aulistenerremoveparameter)
...
Modified [AUParameterListenerBlock](https://developer.apple.com/documentation/audiotoolbox/auparameterlistenerblock)
...
Modified [AUParameterListenerNotify(_: AUParameterListenerRef?, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitParameter>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1501642-auparameterlistenernotify)
...
Modified [AUParameterListenerRef](https://developer.apple.com/documentation/audiotoolbox/auparameterlistenerref)
...
Modified [AUParameterSet(_: AUParameterListenerRef?, _: UnsafeMutableRawPointer?, _: UnsafePointer<AudioUnitParameter>, _: AudioUnitParameterValue, _: UInt32) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1502261-auparameterset)
...
Modified [CAClockGetCurrentTempo(_: CAClockRef, _: UnsafeMutablePointer<CAClockTempo>, _: UnsafeMutablePointer<CAClockTime>?) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1503295-caclockgetcurrenttempo)
...
Modified [CAClockGetProperty(_: CAClockRef, _: CAClockPropertyID, _: UnsafeMutablePointer<UInt32>, _: UnsafeMutableRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1503318-caclockgetproperty)
...
Modified [CAClockNew(_: UInt32, _: UnsafeMutablePointer<CAClockRef?>) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1501709-caclocknew)
...
Modified [CAClockRef](https://developer.apple.com/documentation/audiotoolbox/caclockref)
...
Modified [CAClockSetCurrentTempo(_: CAClockRef, _: CAClockTempo, _: UnsafePointer<CAClockTime>?) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1502209-caclocksetcurrenttempo)
...
Modified [CAClockSetProperty(_: CAClockRef, _: CAClockPropertyID, _: UInt32, _: UnsafeRawPointer) -> OSStatus](https://developer.apple.com/documentation/audiotoolbox/1502700-caclocksetproperty)
...
Modified [k3DMixerParam_PostAveragePower](https://developer.apple.com/documentation/audiotoolbox/1389763-3d_mixer_unit_parameters/k3dmixerparam_postaveragepower)
...
Modified [k3DMixerParam_PostPeakHoldLevel](https://developer.apple.com/documentation/audiotoolbox/k3dmixerparam_postpeakholdlevel)
...
Modified [k3DMixerParam_PreAveragePower](https://developer.apple.com/documentation/audiotoolbox/k3dmixerparam_preaveragepower)
...
Modified [kAudioCodecBadPropertySizeError](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecbadpropertysizeerror)
...
Modified [kAudioCodecBitRateControlMode_Constant](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecbitratecontrolmode_constant)
...
Modified [kAudioCodecBitRateControlMode_Variable](https://developer.apple.com/documentation/audiotoolbox/1494144-bit_rate_control_mode_constants/kaudiocodecbitratecontrolmode_variable)
...
Modified [kAudioCodecBitRateFormat](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecbitrateformat)
...
Modified [kAudioCodecBitRateFormat_ABR](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecbitrateformat_abr)
...
Modified [kAudioCodecBitRateFormat_VBR](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecbitrateformat_vbr)
...
Modified [kAudioCodecGetPropertyInfoSelect](https://developer.apple.com/documentation/audiotoolbox/1494074-audio_codec_routine_selectors/kaudiocodecgetpropertyinfoselect)
...
Modified [kAudioCodecGetPropertySelect](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecgetpropertyselect)
...
Modified [kAudioCodecIllegalOperationError](https://developer.apple.com/documentation/audiotoolbox/1494076-anonymous/kaudiocodecillegaloperationerror)
...
Modified [kAudioCodecOutputPrecedence](https://developer.apple.com/documentation/audiotoolbox/1494107-deprecated_audio_codec_propertie/kaudiocodecoutputprecedence)
...
Modified [kAudioCodecOutputPrecedenceBitRate](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecoutputprecedencebitrate)
...
Modified [kAudioCodecOutputPrecedenceNone](https://developer.apple.com/documentation/audiotoolbox/1494070-deprecated_constants_used_with_k/kaudiocodecoutputprecedencenone)
...
Modified [kAudioCodecOutputPrecedenceSampleRate](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecoutputprecedencesamplerate)
...
Modified [kAudioCodecPrimeMethod_None](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecprimemethod_none)
...
Modified [kAudioCodecProduceOutputDataSelect](https://developer.apple.com/documentation/audiotoolbox/1494074-audio_codec_routine_selectors/kaudiocodecproduceoutputdataselect)
...
Modified [kAudioCodecProduceOutputPacketNeedsMoreInputData](https://developer.apple.com/documentation/audiotoolbox/1494122-output_status_constants/kaudiocodecproduceoutputpacketneedsmoreinputdata)
...
Modified [kAudioCodecProduceOutputPacketSuccess](https://developer.apple.com/documentation/audiotoolbox/1494122-output_status_constants/kaudiocodecproduceoutputpacketsuccess)
...
Modified [kAudioCodecPropertyApplicableBitRateRange](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertyapplicablebitraterange)
...
Modified [kAudioCodecPropertyApplicableInputSampleRates](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyapplicableinputsamplerates)
...
Modified [kAudioCodecPropertyApplicableOutputSampleRates](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyapplicableoutputsamplerates)
...
Modified [kAudioCodecPropertyAvailableBitRateRange](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyavailablebitraterange)
...
Modified [kAudioCodecPropertyAvailableBitRates](https://developer.apple.com/documentation/audiotoolbox/1494107-deprecated_audio_codec_propertie/kaudiocodecpropertyavailablebitrates)
...
Modified [kAudioCodecPropertyAvailableInputChannelLayoutTags](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyavailableinputchannellayouttags)
...
Modified [kAudioCodecPropertyAvailableInputSampleRates](https://developer.apple.com/documentation/audiotoolbox/1494068-anonymous/kaudiocodecpropertyavailableinputsamplerates)
...
Modified [kAudioCodecPropertyAvailableOutputChannelLayouts](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyavailableoutputchannellayouts)
...
Modified [kAudioCodecPropertyCurrentInputFormat](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertycurrentinputformat)
...
Modified [kAudioCodecPropertyCurrentInputSampleRate](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertycurrentinputsamplerate)
...
Modified [kAudioCodecPropertyCurrentOutputFormat](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertycurrentoutputformat)
...
Modified [kAudioCodecPropertyCurrentTargetBitRate](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertycurrenttargetbitrate)
...
Modified [kAudioCodecPropertyDelayMode](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertydelaymode)
...
Modified [kAudioCodecPropertyFormatCFString](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyformatcfstring)
...
Modified [kAudioCodecPropertyFormatInfo](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyformatinfo)
...
Modified [kAudioCodecPropertyMagicCookie](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertymagiccookie)
...
Modified [kAudioCodecPropertyManufacturerCFString](https://developer.apple.com/documentation/audiotoolbox/1494121-global_codec_properties/kaudiocodecpropertymanufacturercfstring)
...
Modified [kAudioCodecPropertyMinimumNumberInputPackets](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyminimumnumberinputpackets)
...
Modified [kAudioCodecPropertyPacketSizeLimitForVBR](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertypacketsizelimitforvbr)
...
Modified [kAudioCodecPropertyPaddedZeros](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertypaddedzeros)
...
Modified [kAudioCodecPropertyPrimeInfo](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertyprimeinfo)
...
Modified [kAudioCodecPropertyProgramTargetLevel](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertyprogramtargetlevel)
...
Modified [kAudioCodecPropertyProgramTargetLevelConstant](https://developer.apple.com/documentation/audiotoolbox/1494111-instance_codec_properties/kaudiocodecpropertyprogramtargetlevelconstant)
...
Modified [kAudioCodecPropertySoundQualityForVBR](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertysoundqualityforvbr)
...
Modified [kAudioCodecPropertyZeroFramesPadded](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecpropertyzeroframespadded)
...
Modified [kAudioCodecQuality_Low](https://developer.apple.com/documentation/audiotoolbox/1494130-audio_codec_quality_constants/kaudiocodecquality_low)
...
Modified [kAudioCodecQuality_Max](https://developer.apple.com/documentation/audiotoolbox/1494130-audio_codec_quality_constants/kaudiocodecquality_max)
...
Modified [kAudioCodecQuality_Medium](https://developer.apple.com/documentation/audiotoolbox/1494130-audio_codec_quality_constants/kaudiocodecquality_medium)
...
Modified [kAudioCodecQuality_Min](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecquality_min)
...
Modified [kAudioCodecResetSelect](https://developer.apple.com/documentation/audiotoolbox/1494074-audio_codec_routine_selectors/kaudiocodecresetselect)
...
Modified [kAudioCodecSetPropertySelect](https://developer.apple.com/documentation/audiotoolbox/1494074-audio_codec_routine_selectors/kaudiocodecsetpropertyselect)
...
Modified [kAudioCodecStateError](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecstateerror)
...
Modified [kAudioCodecUnknownPropertyError](https://developer.apple.com/documentation/audiotoolbox/1494076-anonymous/kaudiocodecunknownpropertyerror)
...
Modified [kAudioCodecUnspecifiedError](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecunspecifiederror)
...
Modified [kAudioCodecUseRecommendedSampleRate](https://developer.apple.com/documentation/audiotoolbox/kaudiocodecuserecommendedsamplerate)
...
Modified [kAudioOfflineUnitProperty_OutputSize](https://developer.apple.com/documentation/audiotoolbox/1533969-anonymous/kaudioofflineunitproperty_outputsize)
...
Modified [kAudioSettings_AvailableValues](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_availablevalues)
...
Modified [kAudioSettings_CurrentValue](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_currentvalue)
...
Modified [kAudioSettings_Hint](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_hint)
...
Modified [kAudioSettings_LimitedValues](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_limitedvalues)
...
Modified [kAudioSettings_Parameters](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_parameters)
...
Modified [kAudioSettings_SettingKey](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_settingkey)
...
Modified [kAudioSettings_SettingName](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_settingname)
...
Modified [kAudioSettings_Summary](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_summary)
...
Modified [kAudioSettings_TopLevelKey](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_toplevelkey)
...
Modified [kAudioSettings_Unit](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_unit)
...
Modified [kAudioSettings_ValueType](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_valuetype)
...
Modified [kAudioSettings_Version](https://developer.apple.com/documentation/audiotoolbox/kaudiosettings_version)
...
Modified [kAudioUnitMigrateProperty_FromPlugin](https://developer.apple.com/documentation/audiotoolbox/1534149-anonymous/kaudiounitmigrateproperty_fromplugin)
...
Modified [kAudioUnitMigrateProperty_OldAutomation](https://developer.apple.com/documentation/audiotoolbox/kaudiounitmigrateproperty_oldautomation)
...
Modified [kAudioUnitOfflineProperty_InputSize](https://developer.apple.com/documentation/audiotoolbox/kaudiounitofflineproperty_inputsize)
...
Modified [kAudioUnitOfflineProperty_PreflightRequirements](https://developer.apple.com/documentation/audiotoolbox/1534054-offline_audio_unit_properties/kaudiounitofflineproperty_preflightrequirements)
...
Modified [kAudioUnitParameterFlag_Global](https://developer.apple.com/documentation/audiotoolbox/kaudiounitparameterflag_global)
...
Modified [kAudioUnitParameterFlag_Input](https://developer.apple.com/documentation/audiotoolbox/kaudiounitparameterflag_input)
...
Modified [kAudioUnitParameterFlag_Output](https://developer.apple.com/documentation/audiotoolbox/1534035-anonymous/kaudiounitparameterflag_output)
...
Modified [kAudioUnitProperty_AUHostIdentifier](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_auhostidentifier)
...
Modified [kAudioUnitProperty_CocoaUI](https://developer.apple.com/documentation/audiotoolbox/1534199-generic_audio_unit_properties/kaudiounitproperty_cocoaui)
...
Modified [kAudioUnitProperty_IconLocation](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_iconlocation)
...
Modified [kAudioUnitProperty_MIDIControlMapping](https://developer.apple.com/documentation/audiotoolbox/1533969-anonymous/kaudiounitproperty_midicontrolmapping)
...
Modified [kAudioUnitProperty_MIDIOutputCallbackInfo](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_midioutputcallbackinfo)
...
Modified [kAudioUnitProperty_ParameterValueName](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_parametervaluename)
...
Modified [kAudioUnitProperty_RemoveParameterMIDIMapping](https://developer.apple.com/documentation/audiotoolbox/kaudiounitproperty_removeparametermidimapping)
...
Modified [kAudioUnitProperty_SpeakerConfiguration](https://developer.apple.com/documentation/audiotoolbox/1534225-anonymous/kaudiounitproperty_speakerconfiguration)
...
Modified [kAudioUnitSRCAlgorithm_MediumQuality](https://developer.apple.com/documentation/audiotoolbox/kaudiounitsrcalgorithm_mediumquality)
...
Modified [kAudioUnitSubType_AudioFilePlayer](https://developer.apple.com/documentation/audiotoolbox/kaudiounitsubtype_audiofileplayer)
...
Modified [kAudioUnitSubType_DLSSynth](https://developer.apple.com/documentation/audiotoolbox/1584149-music_instrument_audio_unit_subt/kaudiounitsubtype_dlssynth)
...
Modified [kAudioUnitSubType_GraphicEQ](https://developer.apple.com/documentation/audiotoolbox/kaudiounitsubtype_graphiceq)
...
Modified [kAudioUnitSubType_HRTFPanner](https://developer.apple.com/documentation/audiotoolbox/kaudiounitsubtype_hrtfpanner)
...
Modified [kAudioUnitSubType_MultiBandCompressor](https://developer.apple.com/documentation/audiotoolbox/1584153-anonymous/kaudiounitsubtype_multibandcompressor)
...
Modified [kAudioUnitSubType_RogerBeep](https://developer.apple.com/documentation/audiotoolbox/1584153-anonymous/kaudiounitsubtype_rogerbeep)
...
Modified [kAudioUnitSubType_SphericalHeadPanner](https://developer.apple.com/documentation/audiotoolbox/1584151-anonymous/kaudiounitsubtype_sphericalheadpanner)
...
Modified [kAudioUnitSubType_TimePitch](https://developer.apple.com/documentation/audiotoolbox/kaudiounitsubtype_timepitch)
...
Modified [kAUNetReceiveParam_NumParameters](https://developer.apple.com/documentation/audiotoolbox/kaunetreceiveparam_numparameters)
...
Modified [kAUNetReceiveParam_Status](https://developer.apple.com/documentation/audiotoolbox/1389920-anonymous/kaunetreceiveparam_status)
...
Modified [kAUNetReceiveProperty_Hostname](https://developer.apple.com/documentation/audiotoolbox/1534109-anonymous/kaunetreceiveproperty_hostname)
...
Modified [kAUNetReceiveProperty_Password](https://developer.apple.com/documentation/audiotoolbox/1534109-anonymous/kaunetreceiveproperty_password)
...
Modified [kAUNetSendParam_NumParameters](https://developer.apple.com/documentation/audiotoolbox/kaunetsendparam_numparameters)
...
Modified [kAUNetSendPresetFormat_AAC_128kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_128kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_32kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_32kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_40kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_40kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_48kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_48kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_64kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_64kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_80kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_80kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_LD_40kbpspc](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_aac_ld_40kbpspc)
...
Modified [kAUNetSendPresetFormat_AAC_LD_48kbpspc](https://developer.apple.com/documentation/audiotoolbox/1534212-anonymous/kaunetsendpresetformat_aac_ld_48kbpspc)
...
Modified [kAUNetSendPresetFormat_IMA4](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_ima4)
...
Modified [kAUNetSendPresetFormat_Lossless16](https://developer.apple.com/documentation/audiotoolbox/1534212-anonymous/kaunetsendpresetformat_lossless16)
...
Modified [kAUNetSendPresetFormat_PCMFloat32](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_pcmfloat32)
...
Modified [kAUNetSendPresetFormat_PCMInt16](https://developer.apple.com/documentation/audiotoolbox/kaunetsendpresetformat_pcmint16)
...
Modified [kAUNetSendProperty_Disconnect](https://developer.apple.com/documentation/audiotoolbox/1534207-anonymous/kaunetsendproperty_disconnect)
...
Modified [kAUNetSendProperty_Password](https://developer.apple.com/documentation/audiotoolbox/kaunetsendproperty_password)
...
Modified [kAUNetStatus_Listening](https://developer.apple.com/documentation/audiotoolbox/1389891-anonymous/kaunetstatus_listening)
...
Modified [kAUNetStatus_Overflow](https://developer.apple.com/documentation/audiotoolbox/1389891-anonymous/kaunetstatus_overflow)
...
Modified [kAUPresetMASDataKey](https://developer.apple.com/documentation/audiotoolbox/kaupresetmasdatakey)
...
Modified [kAUPresetVSTDataKey](https://developer.apple.com/documentation/audiotoolbox/kaupresetvstdatakey)
...
Modified [kAUPresetVSTPresetKey](https://developer.apple.com/documentation/audiotoolbox/kaupresetvstpresetkey)
...
Modified [kAUVoiceIOErr_UnexpectedNumberOfInputChannels](https://developer.apple.com/documentation/audiotoolbox/1534085-anonymous/kauvoiceioerr_unexpectednumberofinputchannels)
...
Modified [kDynamicRangeControlMode_Heavy](https://developer.apple.com/documentation/audiotoolbox/1494094-anonymous/kdynamicrangecontrolmode_heavy)
...
Modified [kDynamicRangeControlMode_Light](https://developer.apple.com/documentation/audiotoolbox/1494094-anonymous/kdynamicrangecontrolmode_light)
...
Modified [kGraphicEQParam_NumberOfBands](https://developer.apple.com/documentation/audiotoolbox/kgraphiceqparam_numberofbands)
...
Modified [kHintAdvanced](https://developer.apple.com/documentation/audiotoolbox/1494142-deprecated_constants_used_with_k/khintadvanced)
...
Modified [kHintBasic](https://developer.apple.com/documentation/audiotoolbox/khintbasic)
...
Modified [kMultibandCompressorParam_CompressionAmount1](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_compressionamount1)
...
Modified [kMultibandCompressorParam_CompressionAmount3](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_compressionamount3)
...
Modified [kMultibandCompressorParam_Crossover2](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_crossover2)
...
Modified [kMultibandCompressorParam_EQ1](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_eq1)
...
Modified [kMultibandCompressorParam_EQ4](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_eq4)
...
Modified [kMultibandCompressorParam_Headroom1](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_headroom1)
...
Modified [kMultibandCompressorParam_Headroom2](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_headroom2)
...
Modified [kMultibandCompressorParam_Headroom4](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_headroom4)
...
Modified [kMultibandCompressorParam_InputAmplitude3](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_inputamplitude3)
...
Modified [kMultibandCompressorParam_InputAmplitude4](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_inputamplitude4)
...
Modified [kMultibandCompressorParam_OutputAmplitude1](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_outputamplitude1)
...
Modified [kMultibandCompressorParam_Pregain](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_pregain)
...
Modified [kMultibandCompressorParam_ReleaseTime](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_releasetime)
...
Modified [kMultibandCompressorParam_Threshold1](https://developer.apple.com/documentation/audiotoolbox/1389781-anonymous/kmultibandcompressorparam_threshold1)
...
Modified [kMultibandCompressorParam_Threshold3](https://developer.apple.com/documentation/audiotoolbox/kmultibandcompressorparam_threshold3)
...
Modified [kMultibandFilter_Bandwidth2](https://developer.apple.com/documentation/audiotoolbox/kmultibandfilter_bandwidth2)
...
Modified [kMultibandFilter_CenterFreq2](https://developer.apple.com/documentation/audiotoolbox/kmultibandfilter_centerfreq2)
...
Modified [kMultibandFilter_CenterFreq3](https://developer.apple.com/documentation/audiotoolbox/kmultibandfilter_centerfreq3)
...
Modified [kMultibandFilter_CenterGain1](https://developer.apple.com/documentation/audiotoolbox/kmultibandfilter_centergain1)
...
Modified [kMultibandFilter_LowFilterType](https://developer.apple.com/documentation/audiotoolbox/kmultibandfilter_lowfiltertype)
...
Modified [kMusicDeviceParam_ReverbVolume](https://developer.apple.com/documentation/audiotoolbox/1389667-anonymous/kmusicdeviceparam_reverbvolume)
...
Modified [kMusicDeviceParam_Volume](https://developer.apple.com/documentation/audiotoolbox/1389667-anonymous/kmusicdeviceparam_volume)
...
Modified [kMusicDeviceProperty_SoundBankData](https://developer.apple.com/documentation/audiotoolbox/kmusicdeviceproperty_soundbankdata)
...
Modified [kOfflinePreflight_NotRequired](https://developer.apple.com/documentation/audiotoolbox/1534010-anonymous/kofflinepreflight_notrequired)
...
Modified [kOfflinePreflight_Optional](https://developer.apple.com/documentation/audiotoolbox/1534010-anonymous/kofflinepreflight_optional)
...
Modified [kOfflinePreflight_Required](https://developer.apple.com/documentation/audiotoolbox/1534010-anonymous/kofflinepreflight_required)
...
Modified [kOtherPluginFormat_kMAS](https://developer.apple.com/documentation/audiotoolbox/1534082-anonymous/kotherpluginformat_kmas)
...
Modified [kPannerParam_Elevation](https://developer.apple.com/documentation/audiotoolbox/kpannerparam_elevation)
...
Modified [kPannerParam_RefDistance](https://developer.apple.com/documentation/audiotoolbox/1389991-anonymous/kpannerparam_refdistance)
...
Modified [kProgramTargetLevel_Minus31dB](https://developer.apple.com/documentation/audiotoolbox/1494116-anonymous/kprogramtargetlevel_minus31db)
...
Modified [kReverbParam_DryWetMix](https://developer.apple.com/documentation/audiotoolbox/kreverbparam_drywetmix)
...
Modified [kReverbParam_LargeBrightness](https://developer.apple.com/documentation/audiotoolbox/kreverbparam_largebrightness)
...
Modified [kReverbParam_LargeDelay](https://developer.apple.com/documentation/audiotoolbox/kreverbparam_largedelay)
...
Modified [kReverbParam_LargeDelayRange](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_largedelayrange)
...
Modified [kReverbParam_LargeDensity](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_largedensity)
...
Modified [kReverbParam_LargeSize](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_largesize)
...
Modified [kReverbParam_ModulationRate](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_modulationrate)
...
Modified [kReverbParam_SmallBrightness](https://developer.apple.com/documentation/audiotoolbox/kreverbparam_smallbrightness)
...
Modified [kReverbParam_SmallDelayRange](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_smalldelayrange)
...
Modified [kReverbParam_SmallLargeMix](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_smalllargemix)
...
Modified [kReverbParam_SmallSize](https://developer.apple.com/documentation/audiotoolbox/1389801-anonymous/kreverbparam_smallsize)
...
Modified [kRogerBeepParam_InGateThreshold](https://developer.apple.com/documentation/audiotoolbox/krogerbeepparam_ingatethreshold)
...
Modified [kRogerBeepParam_InGateThresholdTime](https://developer.apple.com/documentation/audiotoolbox/krogerbeepparam_ingatethresholdtime)
...
Modified [kRogerBeepParam_OutGateThreshold](https://developer.apple.com/documentation/audiotoolbox/krogerbeepparam_outgatethreshold)
...
Modified [kRogerBeepParam_OutGateThresholdTime](https://developer.apple.com/documentation/audiotoolbox/krogerbeepparam_outgatethresholdtime)
...
Modified [kRogerBeepParam_RogerGain](https://developer.apple.com/documentation/audiotoolbox/1389727-anonymous/krogerbeepparam_rogergain)
...
Modified [kRogerBeepParam_Sensitivity](https://developer.apple.com/documentation/audiotoolbox/krogerbeepparam_sensitivity)
...
Modified [kRoundTripAACParam_BitRate](https://developer.apple.com/documentation/audiotoolbox/kroundtripaacparam_bitrate)
...
Modified [kRoundTripAACParam_CompressedFormatSampleRate](https://developer.apple.com/documentation/audiotoolbox/1389808-anonymous/kroundtripaacparam_compressedformatsamplerate)
...
Modified [kSpeakerConfiguration_5_1](https://developer.apple.com/documentation/audiotoolbox/1533960-anonymous/kspeakerconfiguration_5_1)
...
Modified [kSpeakerConfiguration_HeadPhones](https://developer.apple.com/documentation/audiotoolbox/kspeakerconfiguration_headphones)
...
Modified [kSpeakerConfiguration_Stereo](https://developer.apple.com/documentation/audiotoolbox/1533960-anonymous/kspeakerconfiguration_stereo)
...
Modified [kStereoMixerParam_Pan](https://developer.apple.com/documentation/audiotoolbox/1389928-anonymous/kstereomixerparam_pan)
...
Modified [kStereoMixerParam_PostAveragePower](https://developer.apple.com/documentation/audiotoolbox/kstereomixerparam_postaveragepower)
...
Modified [kStereoMixerParam_PostPeakHoldLevel](https://developer.apple.com/documentation/audiotoolbox/kstereomixerparam_postpeakholdlevel)
...
Modified [kStereoMixerParam_Volume](https://developer.apple.com/documentation/audiotoolbox/kstereomixerparam_volume)
...
Modified [kTimePitchParam_EffectBlend](https://developer.apple.com/documentation/audiotoolbox/ktimepitchparam_effectblend)
