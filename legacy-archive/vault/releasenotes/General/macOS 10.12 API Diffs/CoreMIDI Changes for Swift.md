...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/CoreMIDI.html
archived_at: '2026-07-18T02:51:09.755639Z'
---
...
|  | Declaration |
| --- | --- |
| From | ``` func MIDIDriverEnableMonitoring(_ driver: MIDIDriverRef, _ enabled: Bool) -> OSStatus ``` |
