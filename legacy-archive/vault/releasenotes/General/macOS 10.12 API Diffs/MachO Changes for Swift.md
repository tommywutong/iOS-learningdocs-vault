...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/MachO.html
archived_at: '2026-07-18T02:51:28.115790Z'
---
...
|  | Declaration |
| --- | --- |
| From | ``` func getsectbyname(_ segname: UnsafePointer<Int8>, _ sectname: UnsafePointer<Int8>) -> UnsafePointer<section_64> ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getsectiondata(_ mhp: UnsafePointer<mach_header_64>, _ segname: UnsafePointer<Int8>, _ sectname: UnsafePointer<Int8>, _ size: UnsafeMutablePointer<UInt>) -> UnsafeMutablePointer<UInt8> ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getsegbyname(_ segname: UnsafePointer<Int8>) -> UnsafePointer<segment_command_64> ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getsegmentdata(_ mhp: UnsafePointer<mach_header_64>, _ segname: UnsafePointer<Int8>, _ size: UnsafeMutablePointer<UInt>) -> UnsafeMutablePointer<UInt8> ``` |
