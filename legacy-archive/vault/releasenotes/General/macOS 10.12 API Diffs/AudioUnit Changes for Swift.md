...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/AudioUnit.html
archived_at: '2026-07-18T02:51:00.091006Z'
---
...
Removed [AUCocoaUIBase](https://developer.apple.com/documentation/audiotoolbox/aucocoauibase)Removed [AUCocoaUIBase.interfaceVersion() -> UInt32](https://developer.apple.com/documentation/audiotoolbox/aucocoauibase/1395990-interfaceversion)Removed [AUCocoaUIBase.uiViewForAudioUnit(_: AudioUnit, withSize: NSSize) -> NSView?](https://developer.apple.com/documentation/audiotoolbox/aucocoauibase/1395992-uiviewforaudiounit)Removed [AudioCodecMagicCookieInfo.init(mMagicCookieSize: UInt32, mMagicCookie: UnsafePointer<Void>)](https://developer.apple.com/documentation/audiotoolbox/audiocodecmagiccookieinfo/1439097-init)Removed [AUMIDIEvent.init(next: UnsafeMutablePointer<AURenderEvent>, eventSampleTime: AUEventSampleTime, eventType: AURenderEventType, reserved: UInt8, length: UInt16, cable: UInt8, data: (UInt8, UInt8, UInt8))](https://developer.apple.com/documentation/audiotoolbox/aumidievent/1438938-init)Removed [AUParameterEvent.init(next: UnsafeMutablePointer<AURenderEvent>, eventSampleTime: AUEventSampleTime, eventType: AURenderEventType, reserved: (UInt8, UInt8, UInt8), rampDurationSampleFrames: AUAudioFrameCount, parameterAddress: AUParameterAddress, value: AUValue)](https://developer.apple.com/documentation/audiotoolbox/auparameterevent/1439312-init)Removed [AURenderEventHeader.init(next: UnsafeMutablePointer<AURenderEvent>, eventSampleTime: AUEventSampleTime, eventType: AURenderEventType, reserved: UInt8)](https://developer.apple.com/documentation/audiotoolbox/aurendereventheader/1438623-init)Removed [HostCallbackInfo.init(hostUserData: UnsafeMutablePointer<Void>, beatAndTempoProc: HostCallback_GetBeatAndTempo?, musicalTimeLocationProc: HostCallback_GetMusicalTimeLocation?, transportStateProc: HostCallback_GetTransportState?, transportStateProc2: HostCallback_GetTransportState2?)](https://developer.apple.com/documentation/audiotoolbox/hostcallbackinfo/1439353-init)Modified [AU3DMixerAttenuationCurve [enum]](https://developer.apple.com/documentation/audiotoolbox/au3dmixerattenuationcurve)
