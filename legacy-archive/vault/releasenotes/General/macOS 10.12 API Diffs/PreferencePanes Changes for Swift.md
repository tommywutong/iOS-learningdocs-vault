...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/PreferencePanes.html
archived_at: '2026-07-18T02:51:32.317453Z'
---
...
Added NSNotification.Name.NSPreferencePaneSwitchToPaneAdded NSNotification.Name.NSPreferencePaneUpdateHelpMenuAdded NSNotification.Name.NSPreferencePrefPaneIsAvailableModified NSNotification.Name.NSPreferencePaneCancelUnselect

|  | Name | Declaration |
| --- | --- | --- |
| From | NSPreferencePaneCancelUnselectNotification | ``` let NSPreferencePaneCancelUnselectNotification: String ``` |
| To | NSPreferencePaneCancelUnselect | ``` static let NSPreferencePaneCancelUnselect: NSNotification.Name ``` |

Modified NSNotification.Name.NSPreferencePaneDoUnselect

|  | Name | Declaration |
| --- | --- | --- |
| From | NSPreferencePaneDoUnselectNotification | ``` let NSPreferencePaneDoUnselectNotification: String ``` |
| To | NSPreferencePaneDoUnselect | ``` static let NSPreferencePaneDoUnselect: NSNotification.Name ``` |
...
Modified NSPreferencePane.init(bundle: Bundle)

|  | Declaration |
| --- | --- |
| From | ``` init(bundle bundle: NSBundle) ``` |
| To | ``` init(bundle bundle: Bundle) ``` |

Modified NSPreferencePane.isSelected
...
Modified NSPreferencePane.reply(toShouldUnselect: Bool)

|  | Declaration |
| --- | --- |
| From | ``` func replyToShouldUnselect(_ shouldUnselect: Bool) ``` |
| To | ``` func reply(toShouldUnselect shouldUnselect: Bool) ``` |

Modified NSPreferencePane.updateHelpMenu(with: [[String : String]]?)

|  | Declaration |
| --- | --- |
| From | ``` func updateHelpMenuWithArray(_ inArrayOfMenuItems: [[String : String]]?) ``` |
| To | ``` func updateHelpMenu(with inArrayOfMenuItems: [[String : String]]?) ``` |

Modified NSPreferencePaneUnselectReply [enum]

|  | Declaration |
| --- | --- |
| From | ``` enum NSPreferencePaneUnselectReply : UInt {     case UnselectCancel     case UnselectNow     case UnselectLater } ``` |
| To | ``` enum NSPreferencePaneUnselectReply : UInt {     case unselectCancel     case unselectNow     case unselectLater } ``` |

Modified NSPreferencePaneUnselectReply.unselectCancel

|  | Declaration |
| --- | --- |
| From | ``` case UnselectCancel ``` |
| To | ``` case unselectCancel ``` |

Modified NSPreferencePaneUnselectReply.unselectLater

|  | Declaration |
| --- | --- |
| From | ``` case UnselectLater ``` |
| To | ``` case unselectLater ``` |

Modified NSPreferencePaneUnselectReply.unselectNow

|  | Declaration |
| --- | --- |
| From | ``` case UnselectNow ``` |
| To | ``` case unselectNow ``` |
