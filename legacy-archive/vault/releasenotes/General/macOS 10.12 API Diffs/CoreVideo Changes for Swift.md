...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/CoreVideo.html
archived_at: '2026-07-18T02:51:12.635204Z'
---
...
|  | Declaration |
| --- | --- |
| From | ``` typealias CVDisplayLinkOutputCallback = (CVDisplayLink, UnsafePointer<CVTimeStamp>, UnsafePointer<CVTimeStamp>, CVOptionFlags, UnsafeMutablePointer<CVOptionFlags>, UnsafeMutablePointer<Void>) -> CVReturn ``` |
| To | ``` typealias CVDisplayLinkOutputCallback = (CVDisplayLink, UnsafePointer<CVTimeStamp>, UnsafePointer<CVTimeStamp>, CVOptionFlags, UnsafeMutablePointer<CVOptionFlags>, UnsafeMutableRawPointer?) -> CVReturn ``` |

Modified [CVDisplayLinkSetOutputCallback(_: CVDisplayLink, _: CoreVideo.CVDisplayLinkOutputCallback?, _: UnsafeMutableRawPointer?) -> CVReturn](https://developer.apple.com/documentation/corevideo/1457096-cvdisplaylinksetoutputcallback)
...
| To | ``` func CVDisplayLinkSetOutputCallback(_ displayLink: CVDisplayLink, _ callback: CoreVideo.CVDisplayLinkOutputCallback?, _ userInfo: UnsafeMutableRawPointer?) -> CVReturn ``` |

Modified [CVDisplayLinkSetOutputHandler(_: CVDisplayLink, _: CoreVideo.CVDisplayLinkOutputHandler) -> CVReturn](https://developer.apple.com/documentation/corevideo/1456927-cvdisplaylinksetoutputhandler)

|  | Declaration |
| --- | --- |
| From | ``` func CVDisplayLinkSetOutputHandler(_ displayLink: CVDisplayLink, _ handler: CVDisplayLinkOutputHandler) -> CVReturn ``` |
| To | ``` func CVDisplayLinkSetOutputHandler(_ displayLink: CVDisplayLink, _ handler: CoreVideo.CVDisplayLinkOutputHandler) -> CVReturn ``` |
...
Modified [CVOpenGLBuffer](https://developer.apple.com/documentation/corevideo/cvopenglbuffer)

|  | Declaration |
| --- | --- |
| From | ``` typealias CVOpenGLBufferRef = CVOpenGLBuffer ``` |
| To | ``` typealias CVOpenGLBuffer = CVImageBuffer ``` |
...
Modified [CVPixelBufferCreateWithIOSurface(_: CFAllocator?, _: IOSurfaceRef, _: CFDictionary?, _: UnsafeMutablePointer<Unmanaged<CVPixelBuffer>?>) -> CVReturn](https://developer.apple.com/documentation/corevideo/1456968-cvpixelbuffercreatewithiosurface)
...
| To | ``` func CVPixelBufferCreateWithIOSurface(_ allocator: CFAllocator?, _ surface: IOSurfaceRef, _ pixelBufferAttributes: CFDictionary?, _ pixelBufferOut: UnsafeMutablePointer<Unmanaged<CVPixelBuffer>?>) -> CVReturn ``` |
...
Modified [CVPixelBufferGetIOSurface(_: CVPixelBuffer?) -> Unmanaged<IOSurfaceRef>?](https://developer.apple.com/documentation/corevideo/1456690-cvpixelbuffergetiosurface)

|  | Declaration |
| --- | --- |
| From | ``` func CVPixelBufferGetIOSurface(_ pixelBuffer: CVPixelBuffer?) -> Unmanaged<IOSurface>? ``` |
| To | ``` func CVPixelBufferGetIOSurface(_ pixelBuffer: CVPixelBuffer?) -> Unmanaged<IOSurfaceRef>? ``` |
