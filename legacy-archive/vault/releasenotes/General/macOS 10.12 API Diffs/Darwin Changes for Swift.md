...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12/Swift/Darwin.html
archived_at: '2026-07-18T02:51:13.445079Z'
---
...
Modified au_arb_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_arb_t {     var howtopr: u_char     var bu: u_char     var uc: u_char     var data: UnsafeMutablePointer<u_char>     init()     init(howtopr howtopr: u_char, bu bu: u_char, uc uc: u_char, data data: UnsafeMutablePointer<u_char>) } ``` |
| To | ``` struct au_arb_t {     var howtopr: u_char     var bu: u_char     var uc: u_char     var data: UnsafeMutablePointer<u_char>!     init()     init(howtopr howtopr: u_char, bu bu: u_char, uc uc: u_char, data data: UnsafeMutablePointer<u_char>!) } ``` |

Modified au_arb_t.data

|  | Declaration |
| --- | --- |
| From | ``` var data: UnsafeMutablePointer<u_char> ``` |
| To | ``` var data: UnsafeMutablePointer<u_char>! ``` |

Modified au_arg32_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_arg32_t {     var no: u_char     var val: UInt32     var len: UInt16     var text: UnsafeMutablePointer<Int8>     init()     init(no no: u_char, val val: UInt32, len len: UInt16, text text: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_arg32_t {     var no: u_char     var val: UInt32     var len: UInt16     var text: UnsafeMutablePointer<Int8>!     init()     init(no no: u_char, val val: UInt32, len len: UInt16, text text: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_arg32_t.text

|  | Declaration |
| --- | --- |
| From | ``` var text: UnsafeMutablePointer<Int8> ``` |
| To | ``` var text: UnsafeMutablePointer<Int8>! ``` |

Modified au_arg64_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_arg64_t {     var no: u_char     var val: UInt64     var len: UInt16     var text: UnsafeMutablePointer<Int8>     init()     init(no no: u_char, val val: UInt64, len len: UInt16, text text: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_arg64_t {     var no: u_char     var val: UInt64     var len: UInt16     var text: UnsafeMutablePointer<Int8>!     init()     init(no no: u_char, val val: UInt64, len len: UInt16, text text: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_arg64_t.text
...
Modified au_class_ent [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_class_ent {     var ac_name: UnsafeMutablePointer<Int8>     var ac_class: au_class_t     var ac_desc: UnsafeMutablePointer<Int8>     init()     init(ac_name ac_name: UnsafeMutablePointer<Int8>, ac_class ac_class: au_class_t, ac_desc ac_desc: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_class_ent {     var ac_name: UnsafeMutablePointer<Int8>!     var ac_class: au_class_t     var ac_desc: UnsafeMutablePointer<Int8>!     init()     init(ac_name ac_name: UnsafeMutablePointer<Int8>!, ac_class ac_class: au_class_t, ac_desc ac_desc: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_class_ent.ac_desc

|  | Declaration |
| --- | --- |
| From | ``` var ac_desc: UnsafeMutablePointer<Int8> ``` |
| To | ``` var ac_desc: UnsafeMutablePointer<Int8>! ``` |

Modified au_class_ent.ac_name

|  | Declaration |
| --- | --- |
| From | ``` var ac_name: UnsafeMutablePointer<Int8> ``` |
| To | ``` var ac_name: UnsafeMutablePointer<Int8>! ``` |

Modified au_event_ent [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_event_ent {     var ae_number: au_event_t     var ae_name: UnsafeMutablePointer<Int8>     var ae_desc: UnsafeMutablePointer<Int8>     var ae_class: au_class_t     init()     init(ae_number ae_number: au_event_t, ae_name ae_name: UnsafeMutablePointer<Int8>, ae_desc ae_desc: UnsafeMutablePointer<Int8>, ae_class ae_class: au_class_t) } ``` |
| To | ``` struct au_event_ent {     var ae_number: au_event_t     var ae_name: UnsafeMutablePointer<Int8>!     var ae_desc: UnsafeMutablePointer<Int8>!     var ae_class: au_class_t     init()     init(ae_number ae_number: au_event_t, ae_name ae_name: UnsafeMutablePointer<Int8>!, ae_desc ae_desc: UnsafeMutablePointer<Int8>!, ae_class ae_class: au_class_t) } ``` |

Modified au_event_ent.ae_desc

|  | Declaration |
| --- | --- |
| From | ``` var ae_desc: UnsafeMutablePointer<Int8> ``` |
| To | ``` var ae_desc: UnsafeMutablePointer<Int8>! ``` |

Modified au_event_ent.ae_name

|  | Declaration |
| --- | --- |
| From | ``` var ae_name: UnsafeMutablePointer<Int8> ``` |
| To | ``` var ae_name: UnsafeMutablePointer<Int8>! ``` |

Modified au_execarg_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_execarg_t {     var count: UInt32     var text: (UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>)     init()     init(count count: UInt32, text text: (UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>)) } ``` |
| To | ``` struct au_execarg_t {     var count: UInt32     var text: (UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?)     init()     init(count count: UInt32, text text: (UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?)) } ``` |

Modified au_execarg_t.text

|  | Declaration |
| --- | --- |
| From | ``` var text: (UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>) ``` |
| To | ``` var text: (UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?) ``` |

Modified au_execenv_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_execenv_t {     var count: UInt32     var text: (UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>)     init()     init(count count: UInt32, text text: (UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>, UnsafeMutablePointer<Int8>)) } ``` |
| To | ``` struct au_execenv_t {     var count: UInt32     var text: (UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?)     init()     init(count count: UInt32, text text: (UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?, UnsafeMutablePointer<Int8>?)) } ``` |

Modified au_execenv_t.text
...
Modified au_file_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_file_t {     var s: UInt32     var ms: UInt32     var len: UInt16     var name: UnsafeMutablePointer<Int8>     init()     init(s s: UInt32, ms ms: UInt32, len len: UInt16, name name: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_file_t {     var s: UInt32     var ms: UInt32     var len: UInt16     var name: UnsafeMutablePointer<Int8>!     init()     init(s s: UInt32, ms ms: UInt32, len len: UInt16, name name: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_file_t.name
...
Modified au_invalid_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_invalid_t {     var length: UInt16     var data: UnsafeMutablePointer<Int8>     init()     init(length length: UInt16, data data: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_invalid_t {     var length: UInt16     var data: UnsafeMutablePointer<Int8>!     init()     init(length length: UInt16, data data: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_invalid_t.data

|  | Declaration |
| --- | --- |
| From | ``` var data: UnsafeMutablePointer<Int8> ``` |
| To | ``` var data: UnsafeMutablePointer<Int8>! ``` |

Modified au_opaque_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_opaque_t {     var size: UInt16     var data: UnsafeMutablePointer<Int8>     init()     init(size size: UInt16, data data: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_opaque_t {     var size: UInt16     var data: UnsafeMutablePointer<Int8>!     init()     init(size size: UInt16, data data: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_opaque_t.data
...
Modified au_path_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_path_t {     var len: UInt16     var path: UnsafeMutablePointer<Int8>     init()     init(len len: UInt16, path path: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_path_t {     var len: UInt16     var path: UnsafeMutablePointer<Int8>!     init()     init(len len: UInt16, path path: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_path_t.path

|  | Declaration |
| --- | --- |
| From | ``` var path: UnsafeMutablePointer<Int8> ``` |
| To | ``` var path: UnsafeMutablePointer<Int8>! ``` |
...
Modified au_text_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_text_t {     var len: UInt16     var text: UnsafeMutablePointer<Int8>     init()     init(len len: UInt16, text text: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_text_t {     var len: UInt16     var text: UnsafeMutablePointer<Int8>!     init()     init(len len: UInt16, text text: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_text_t.text
...
Modified au_user_ent [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_user_ent {     var au_name: UnsafeMutablePointer<Int8>     var au_always: au_mask_t     var au_never: au_mask_t     init()     init(au_name au_name: UnsafeMutablePointer<Int8>, au_always au_always: au_mask_t, au_never au_never: au_mask_t) } ``` |
| To | ``` struct au_user_ent {     var au_name: UnsafeMutablePointer<Int8>!     var au_always: au_mask_t     var au_never: au_mask_t     init()     init(au_name au_name: UnsafeMutablePointer<Int8>!, au_always au_always: au_mask_t, au_never au_never: au_mask_t) } ``` |

Modified au_user_ent.au_name

|  | Declaration |
| --- | --- |
| From | ``` var au_name: UnsafeMutablePointer<Int8> ``` |
| To | ``` var au_name: UnsafeMutablePointer<Int8>! ``` |

Modified au_zonename_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct au_zonename_t {     var len: UInt16     var zonename: UnsafeMutablePointer<Int8>     init()     init(len len: UInt16, zonename zonename: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct au_zonename_t {     var len: UInt16     var zonename: UnsafeMutablePointer<Int8>!     init()     init(len len: UInt16, zonename zonename: UnsafeMutablePointer<Int8>!) } ``` |

Modified au_zonename_t.zonename

|  | Declaration |
| --- | --- |
| From | ``` var zonename: UnsafeMutablePointer<Int8> ``` |
| To | ``` var zonename: UnsafeMutablePointer<Int8>! ``` |
...
Modified dk_format_capacities_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct dk_format_capacities_t {     var capacities: UnsafeMutablePointer<dk_format_capacity_t>     var capacitiesCount: UInt32     var reserved0096: (UInt8, UInt8, UInt8, UInt8)     init()     init(capacities capacities: UnsafeMutablePointer<dk_format_capacity_t>, capacitiesCount capacitiesCount: UInt32, reserved0096 reserved0096: (UInt8, UInt8, UInt8, UInt8)) } ``` |
| To | ``` struct dk_format_capacities_t {     var capacities: UnsafeMutablePointer<dk_format_capacity_t>!     var capacitiesCount: UInt32     var reserved0096: (UInt8, UInt8, UInt8, UInt8)     init()     init(capacities capacities: UnsafeMutablePointer<dk_format_capacity_t>!, capacitiesCount capacitiesCount: UInt32, reserved0096 reserved0096: (UInt8, UInt8, UInt8, UInt8)) } ``` |

Modified dk_format_capacities_t.capacities

|  | Declaration |
| --- | --- |
| From | ``` var capacities: UnsafeMutablePointer<dk_format_capacity_t> ``` |
| To | ``` var capacities: UnsafeMutablePointer<dk_format_capacity_t>! ``` |

Modified dk_unmap_t [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct dk_unmap_t {     var extents: UnsafeMutablePointer<dk_extent_t>     var extentsCount: UInt32     var options: UInt32     init()     init(extents extents: UnsafeMutablePointer<dk_extent_t>, extentsCount extentsCount: UInt32, options options: UInt32) } ``` |
| To | ``` struct dk_unmap_t {     var extents: UnsafeMutablePointer<dk_extent_t>!     var extentsCount: UInt32     var options: UInt32     init()     init(extents extents: UnsafeMutablePointer<dk_extent_t>!, extentsCount extentsCount: UInt32, options options: UInt32) } ``` |

Modified dk_unmap_t.extents

|  | Declaration |
| --- | --- |
| From | ``` var extents: UnsafeMutablePointer<dk_extent_t> ``` |
| To | ``` var extents: UnsafeMutablePointer<dk_extent_t>! ``` |
...
Modified eventreq [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct eventreq {     var er_type: Int32     var er_handle: Int32     var er_data: UnsafeMutablePointer<Void>     var er_rcnt: Int32     var er_wcnt: Int32     var er_ecnt: Int32     var er_eventbits: Int32     init()     init(er_type er_type: Int32, er_handle er_handle: Int32, er_data er_data: UnsafeMutablePointer<Void>, er_rcnt er_rcnt: Int32, er_wcnt er_wcnt: Int32, er_ecnt er_ecnt: Int32, er_eventbits er_eventbits: Int32) } ``` |
| To | ``` struct eventreq {     var er_type: Int32     var er_handle: Int32     var er_data: UnsafeMutableRawPointer!     var er_rcnt: Int32     var er_wcnt: Int32     var er_ecnt: Int32     var er_eventbits: Int32     init()     init(er_type er_type: Int32, er_handle er_handle: Int32, er_data er_data: UnsafeMutableRawPointer!, er_rcnt er_rcnt: Int32, er_wcnt er_wcnt: Int32, er_ecnt er_ecnt: Int32, er_eventbits er_eventbits: Int32) } ``` |

Modified eventreq.er_data

|  | Declaration |
| --- | --- |
| From | ``` var er_data: UnsafeMutablePointer<Void> ``` |
| To | ``` var er_data: UnsafeMutableRawPointer! ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` var p_addr: UnsafeMutablePointer<user> ``` |
| To | ``` var p_addr: UnsafeMutablePointer<user>! ``` |
...
Modified gmonparam [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct gmonparam {     var state: Int32     var kcount: UnsafeMutablePointer<u_short>     var kcountsize: u_long     var froms: UnsafeMutablePointer<u_short>     var fromssize: u_long     var tos: UnsafeMutablePointer<tostruct_t>     var tossize: u_long     var tolimit: Int     var lowpc: u_long     var highpc: u_long     var textsize: u_long     var hashfraction: u_long     init()     init(state state: Int32, kcount kcount: UnsafeMutablePointer<u_short>, kcountsize kcountsize: u_long, froms froms: UnsafeMutablePointer<u_short>, fromssize fromssize: u_long, tos tos: UnsafeMutablePointer<tostruct_t>, tossize tossize: u_long, tolimit tolimit: Int, lowpc lowpc: u_long, highpc highpc: u_long, textsize textsize: u_long, hashfraction hashfraction: u_long) } ``` |
| To | ``` struct gmonparam {     var state: Int32     var kcount: UnsafeMutablePointer<u_short>!     var kcountsize: u_long     var froms: UnsafeMutablePointer<u_short>!     var fromssize: u_long     var tos: UnsafeMutablePointer<tostruct_t>!     var tossize: u_long     var tolimit: Int     var lowpc: u_long     var highpc: u_long     var textsize: u_long     var hashfraction: u_long     init()     init(state state: Int32, kcount kcount: UnsafeMutablePointer<u_short>!, kcountsize kcountsize: u_long, froms froms: UnsafeMutablePointer<u_short>!, fromssize fromssize: u_long, tos tos: UnsafeMutablePointer<tostruct_t>!, tossize tossize: u_long, tolimit tolimit: Int, lowpc lowpc: u_long, highpc highpc: u_long, textsize textsize: u_long, hashfraction hashfraction: u_long) } ``` |

Modified gmonparam.froms

|  | Declaration |
| --- | --- |
| From | ``` var froms: UnsafeMutablePointer<u_short> ``` |
| To | ``` var froms: UnsafeMutablePointer<u_short>! ``` |

Modified gmonparam.kcount

|  | Declaration |
| --- | --- |
| From | ``` var kcount: UnsafeMutablePointer<u_short> ``` |
| To | ``` var kcount: UnsafeMutablePointer<u_short>! ``` |

Modified gmonparam.tos

|  | Declaration |
| --- | --- |
| From | ``` var tos: UnsafeMutablePointer<tostruct_t> ``` |
| To | ``` var tos: UnsafeMutablePointer<tostruct_t>! ``` |
...
Modified hfs_mount_args [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct hfs_mount_args {     var fspec: UnsafeMutablePointer<Int8>     var hfs_uid: uid_t     var hfs_gid: gid_t     var hfs_mask: mode_t     var hfs_encoding: UInt32     var hfs_timezone: timezone     var flags: Int32     var journal_tbuffer_size: Int32     var journal_flags: Int32     var journal_disable: Int32     init()     init(fspec fspec: UnsafeMutablePointer<Int8>, hfs_uid hfs_uid: uid_t, hfs_gid hfs_gid: gid_t, hfs_mask hfs_mask: mode_t, hfs_encoding hfs_encoding: UInt32, hfs_timezone hfs_timezone: timezone, flags flags: Int32, journal_tbuffer_size journal_tbuffer_size: Int32, journal_flags journal_flags: Int32, journal_disable journal_disable: Int32) } ``` |
| To | ``` struct hfs_mount_args {     var fspec: UnsafeMutablePointer<Int8>!     var hfs_uid: uid_t     var hfs_gid: gid_t     var hfs_mask: mode_t     var hfs_encoding: UInt32     var hfs_timezone: timezone     var flags: Int32     var journal_tbuffer_size: Int32     var journal_flags: Int32     var journal_disable: Int32     init()     init(fspec fspec: UnsafeMutablePointer<Int8>!, hfs_uid hfs_uid: uid_t, hfs_gid hfs_gid: gid_t, hfs_mask hfs_mask: mode_t, hfs_encoding hfs_encoding: UInt32, hfs_timezone hfs_timezone: timezone, flags flags: Int32, journal_tbuffer_size journal_tbuffer_size: Int32, journal_flags journal_flags: Int32, journal_disable journal_disable: Int32) } ``` |

Modified hfs_mount_args.fspec

|  | Declaration |
| --- | --- |
| From | ``` var fspec: UnsafeMutablePointer<Int8> ``` |
| To | ``` var fspec: UnsafeMutablePointer<Int8>! ``` |

Modified HFSCatalogFile [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct HFSCatalogFile {     var recordType: Int16     var flags: UInt8     var fileType: Int8     var userInfo: FndrFileInfo     var fileID: UInt32     var dataStartBlock: UInt16     var dataLogicalSize: Int32     var dataPhysicalSize: Int32     var rsrcStartBlock: UInt16     var rsrcLogicalSize: Int32     var rsrcPhysicalSize: Int32     var createDate: UInt32     var modifyDate: UInt32     var backupDate: UInt32     var finderInfo: FndrOpaqueInfo     var clumpSize: UInt16     var dataExtents: HFSExtentRecord     var rsrcExtents: HFSExtentRecord     var reserved: UInt32     init()     init(recordType recordType: Int16, flags flags: UInt8, fileType fileType: Int8, userInfo userInfo: FndrFileInfo, fileID fileID: UInt32, dataStartBlock dataStartBlock: UInt16, dataLogicalSize dataLogicalSize: Int32, dataPhysicalSize dataPhysicalSize: Int32, rsrcStartBlock rsrcStartBlock: UInt16, rsrcLogicalSize rsrcLogicalSize: Int32, rsrcPhysicalSize rsrcPhysicalSize: Int32, createDate createDate: UInt32, modifyDate modifyDate: UInt32, backupDate backupDate: UInt32, finderInfo finderInfo: FndrOpaqueInfo, clumpSize clumpSize: UInt16, dataExtents dataExtents: HFSExtentRecord, rsrcExtents rsrcExtents: HFSExtentRecord, reserved reserved: UInt32) } ``` |
| To | ``` struct HFSCatalogFile {     var recordType: Int16     var flags: UInt8     var fileType: Int8     var userInfo: FndrFileInfo     var fileID: UInt32     var dataStartBlock: UInt16     var dataLogicalSize: Int32     var dataPhysicalSize: Int32     var rsrcStartBlock: UInt16     var rsrcLogicalSize: Int32     var rsrcPhysicalSize: Int32     var createDate: UInt32     var modifyDate: UInt32     var backupDate: UInt32     var finderInfo: FndrOpaqueInfo     var clumpSize: UInt16     var dataExtents: Darwin.HFSExtentRecord     var rsrcExtents: Darwin.HFSExtentRecord     var reserved: UInt32     init()     init(recordType recordType: Int16, flags flags: UInt8, fileType fileType: Int8, userInfo userInfo: FndrFileInfo, fileID fileID: UInt32, dataStartBlock dataStartBlock: UInt16, dataLogicalSize dataLogicalSize: Int32, dataPhysicalSize dataPhysicalSize: Int32, rsrcStartBlock rsrcStartBlock: UInt16, rsrcLogicalSize rsrcLogicalSize: Int32, rsrcPhysicalSize rsrcPhysicalSize: Int32, createDate createDate: UInt32, modifyDate modifyDate: UInt32, backupDate backupDate: UInt32, finderInfo finderInfo: FndrOpaqueInfo, clumpSize clumpSize: UInt16, dataExtents dataExtents: Darwin.HFSExtentRecord, rsrcExtents rsrcExtents: Darwin.HFSExtentRecord, reserved reserved: UInt32) } ``` |

Modified HFSCatalogFile.dataExtents

|  | Declaration |
| --- | --- |
| From | ``` var dataExtents: HFSExtentRecord ``` |
| To | ``` var dataExtents: Darwin.HFSExtentRecord ``` |

Modified HFSCatalogFile.init(recordType: Int16, flags: UInt8, fileType: Int8, userInfo: FndrFileInfo, fileID: UInt32, dataStartBlock: UInt16, dataLogicalSize: Int32, dataPhysicalSize: Int32, rsrcStartBlock: UInt16, rsrcLogicalSize: Int32, rsrcPhysicalSize: Int32, createDate: UInt32, modifyDate: UInt32, backupDate: UInt32, finderInfo: FndrOpaqueInfo, clumpSize: UInt16, dataExtents: Darwin.HFSExtentRecord, rsrcExtents: Darwin.HFSExtentRecord, reserved: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` init(recordType recordType: Int16, flags flags: UInt8, fileType fileType: Int8, userInfo userInfo: FndrFileInfo, fileID fileID: UInt32, dataStartBlock dataStartBlock: UInt16, dataLogicalSize dataLogicalSize: Int32, dataPhysicalSize dataPhysicalSize: Int32, rsrcStartBlock rsrcStartBlock: UInt16, rsrcLogicalSize rsrcLogicalSize: Int32, rsrcPhysicalSize rsrcPhysicalSize: Int32, createDate createDate: UInt32, modifyDate modifyDate: UInt32, backupDate backupDate: UInt32, finderInfo finderInfo: FndrOpaqueInfo, clumpSize clumpSize: UInt16, dataExtents dataExtents: HFSExtentRecord, rsrcExtents rsrcExtents: HFSExtentRecord, reserved reserved: UInt32) ``` |
| To | ``` init(recordType recordType: Int16, flags flags: UInt8, fileType fileType: Int8, userInfo userInfo: FndrFileInfo, fileID fileID: UInt32, dataStartBlock dataStartBlock: UInt16, dataLogicalSize dataLogicalSize: Int32, dataPhysicalSize dataPhysicalSize: Int32, rsrcStartBlock rsrcStartBlock: UInt16, rsrcLogicalSize rsrcLogicalSize: Int32, rsrcPhysicalSize rsrcPhysicalSize: Int32, createDate createDate: UInt32, modifyDate modifyDate: UInt32, backupDate backupDate: UInt32, finderInfo finderInfo: FndrOpaqueInfo, clumpSize clumpSize: UInt16, dataExtents dataExtents: Darwin.HFSExtentRecord, rsrcExtents rsrcExtents: Darwin.HFSExtentRecord, reserved reserved: UInt32) ``` |

Modified HFSCatalogFile.rsrcExtents

|  | Declaration |
| --- | --- |
| From | ``` var rsrcExtents: HFSExtentRecord ``` |
| To | ``` var rsrcExtents: Darwin.HFSExtentRecord ``` |

Modified HFSMasterDirectoryBlock [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct HFSMasterDirectoryBlock {     var drSigWord: UInt16     var drCrDate: UInt32     var drLsMod: UInt32     var drAtrb: UInt16     var drNmFls: UInt16     var drVBMSt: UInt16     var drAllocPtr: UInt16     var drNmAlBlks: UInt16     var drAlBlkSiz: UInt32     var drClpSiz: UInt32     var drAlBlSt: UInt16     var drNxtCNID: UInt32     var drFreeBks: UInt16     var drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)     var drVolBkUp: UInt32     var drVSeqNum: UInt16     var drWrCnt: UInt32     var drXTClpSiz: UInt32     var drCTClpSiz: UInt32     var drNmRtDirs: UInt16     var drFilCnt: UInt32     var drDirCnt: UInt32     var drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32)     var drEmbedSigWord: UInt16     var drEmbedExtent: HFSExtentDescriptor     var drXTFlSize: UInt32     var drXTExtRec: HFSExtentRecord     var drCTFlSize: UInt32     var drCTExtRec: HFSExtentRecord     init()     init(drSigWord drSigWord: UInt16, drCrDate drCrDate: UInt32, drLsMod drLsMod: UInt32, drAtrb drAtrb: UInt16, drNmFls drNmFls: UInt16, drVBMSt drVBMSt: UInt16, drAllocPtr drAllocPtr: UInt16, drNmAlBlks drNmAlBlks: UInt16, drAlBlkSiz drAlBlkSiz: UInt32, drClpSiz drClpSiz: UInt32, drAlBlSt drAlBlSt: UInt16, drNxtCNID drNxtCNID: UInt32, drFreeBks drFreeBks: UInt16, drVN drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), drVolBkUp drVolBkUp: UInt32, drVSeqNum drVSeqNum: UInt16, drWrCnt drWrCnt: UInt32, drXTClpSiz drXTClpSiz: UInt32, drCTClpSiz drCTClpSiz: UInt32, drNmRtDirs drNmRtDirs: UInt16, drFilCnt drFilCnt: UInt32, drDirCnt drDirCnt: UInt32, drFndrInfo drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), drEmbedSigWord drEmbedSigWord: UInt16, drEmbedExtent drEmbedExtent: HFSExtentDescriptor, drXTFlSize drXTFlSize: UInt32, drXTExtRec drXTExtRec: HFSExtentRecord, drCTFlSize drCTFlSize: UInt32, drCTExtRec drCTExtRec: HFSExtentRecord) } ``` |
| To | ``` struct HFSMasterDirectoryBlock {     var drSigWord: UInt16     var drCrDate: UInt32     var drLsMod: UInt32     var drAtrb: UInt16     var drNmFls: UInt16     var drVBMSt: UInt16     var drAllocPtr: UInt16     var drNmAlBlks: UInt16     var drAlBlkSiz: UInt32     var drClpSiz: UInt32     var drAlBlSt: UInt16     var drNxtCNID: UInt32     var drFreeBks: UInt16     var drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8)     var drVolBkUp: UInt32     var drVSeqNum: UInt16     var drWrCnt: UInt32     var drXTClpSiz: UInt32     var drCTClpSiz: UInt32     var drNmRtDirs: UInt16     var drFilCnt: UInt32     var drDirCnt: UInt32     var drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32)     var drEmbedSigWord: UInt16     var drEmbedExtent: HFSExtentDescriptor     var drXTFlSize: UInt32     var drXTExtRec: Darwin.HFSExtentRecord     var drCTFlSize: UInt32     var drCTExtRec: Darwin.HFSExtentRecord     init()     init(drSigWord drSigWord: UInt16, drCrDate drCrDate: UInt32, drLsMod drLsMod: UInt32, drAtrb drAtrb: UInt16, drNmFls drNmFls: UInt16, drVBMSt drVBMSt: UInt16, drAllocPtr drAllocPtr: UInt16, drNmAlBlks drNmAlBlks: UInt16, drAlBlkSiz drAlBlkSiz: UInt32, drClpSiz drClpSiz: UInt32, drAlBlSt drAlBlSt: UInt16, drNxtCNID drNxtCNID: UInt32, drFreeBks drFreeBks: UInt16, drVN drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), drVolBkUp drVolBkUp: UInt32, drVSeqNum drVSeqNum: UInt16, drWrCnt drWrCnt: UInt32, drXTClpSiz drXTClpSiz: UInt32, drCTClpSiz drCTClpSiz: UInt32, drNmRtDirs drNmRtDirs: UInt16, drFilCnt drFilCnt: UInt32, drDirCnt drDirCnt: UInt32, drFndrInfo drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), drEmbedSigWord drEmbedSigWord: UInt16, drEmbedExtent drEmbedExtent: HFSExtentDescriptor, drXTFlSize drXTFlSize: UInt32, drXTExtRec drXTExtRec: Darwin.HFSExtentRecord, drCTFlSize drCTFlSize: UInt32, drCTExtRec drCTExtRec: Darwin.HFSExtentRecord) } ``` |

Modified HFSMasterDirectoryBlock.drCTExtRec

|  | Declaration |
| --- | --- |
| From | ``` var drCTExtRec: HFSExtentRecord ``` |
| To | ``` var drCTExtRec: Darwin.HFSExtentRecord ``` |

Modified HFSMasterDirectoryBlock.drXTExtRec

|  | Declaration |
| --- | --- |
| From | ``` var drXTExtRec: HFSExtentRecord ``` |
| To | ``` var drXTExtRec: Darwin.HFSExtentRecord ``` |

Modified HFSMasterDirectoryBlock.init(drSigWord: UInt16, drCrDate: UInt32, drLsMod: UInt32, drAtrb: UInt16, drNmFls: UInt16, drVBMSt: UInt16, drAllocPtr: UInt16, drNmAlBlks: UInt16, drAlBlkSiz: UInt32, drClpSiz: UInt32, drAlBlSt: UInt16, drNxtCNID: UInt32, drFreeBks: UInt16, drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), drVolBkUp: UInt32, drVSeqNum: UInt16, drWrCnt: UInt32, drXTClpSiz: UInt32, drCTClpSiz: UInt32, drNmRtDirs: UInt16, drFilCnt: UInt32, drDirCnt: UInt32, drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), drEmbedSigWord: UInt16, drEmbedExtent: HFSExtentDescriptor, drXTFlSize: UInt32, drXTExtRec: Darwin.HFSExtentRecord, drCTFlSize: UInt32, drCTExtRec: Darwin.HFSExtentRecord)

|  | Declaration |
| --- | --- |
| From | ``` init(drSigWord drSigWord: UInt16, drCrDate drCrDate: UInt32, drLsMod drLsMod: UInt32, drAtrb drAtrb: UInt16, drNmFls drNmFls: UInt16, drVBMSt drVBMSt: UInt16, drAllocPtr drAllocPtr: UInt16, drNmAlBlks drNmAlBlks: UInt16, drAlBlkSiz drAlBlkSiz: UInt32, drClpSiz drClpSiz: UInt32, drAlBlSt drAlBlSt: UInt16, drNxtCNID drNxtCNID: UInt32, drFreeBks drFreeBks: UInt16, drVN drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), drVolBkUp drVolBkUp: UInt32, drVSeqNum drVSeqNum: UInt16, drWrCnt drWrCnt: UInt32, drXTClpSiz drXTClpSiz: UInt32, drCTClpSiz drCTClpSiz: UInt32, drNmRtDirs drNmRtDirs: UInt16, drFilCnt drFilCnt: UInt32, drDirCnt drDirCnt: UInt32, drFndrInfo drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), drEmbedSigWord drEmbedSigWord: UInt16, drEmbedExtent drEmbedExtent: HFSExtentDescriptor, drXTFlSize drXTFlSize: UInt32, drXTExtRec drXTExtRec: HFSExtentRecord, drCTFlSize drCTFlSize: UInt32, drCTExtRec drCTExtRec: HFSExtentRecord) ``` |
| To | ``` init(drSigWord drSigWord: UInt16, drCrDate drCrDate: UInt32, drLsMod drLsMod: UInt32, drAtrb drAtrb: UInt16, drNmFls drNmFls: UInt16, drVBMSt drVBMSt: UInt16, drAllocPtr drAllocPtr: UInt16, drNmAlBlks drNmAlBlks: UInt16, drAlBlkSiz drAlBlkSiz: UInt32, drClpSiz drClpSiz: UInt32, drAlBlSt drAlBlSt: UInt16, drNxtCNID drNxtCNID: UInt32, drFreeBks drFreeBks: UInt16, drVN drVN: (UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8, UInt8), drVolBkUp drVolBkUp: UInt32, drVSeqNum drVSeqNum: UInt16, drWrCnt drWrCnt: UInt32, drXTClpSiz drXTClpSiz: UInt32, drCTClpSiz drCTClpSiz: UInt32, drNmRtDirs drNmRtDirs: UInt16, drFilCnt drFilCnt: UInt32, drDirCnt drDirCnt: UInt32, drFndrInfo drFndrInfo: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), drEmbedSigWord drEmbedSigWord: UInt16, drEmbedExtent drEmbedExtent: HFSExtentDescriptor, drXTFlSize drXTFlSize: UInt32, drXTExtRec drXTExtRec: Darwin.HFSExtentRecord, drCTFlSize drCTFlSize: UInt32, drCTExtRec drCTExtRec: Darwin.HFSExtentRecord) ``` |

Modified HFSPlusAttrExtents [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct HFSPlusAttrExtents {     var recordType: UInt32     var reserved: UInt32     var extents: HFSPlusExtentRecord     init()     init(recordType recordType: UInt32, reserved reserved: UInt32, extents extents: HFSPlusExtentRecord) } ``` |
| To | ``` struct HFSPlusAttrExtents {     var recordType: UInt32     var reserved: UInt32     var extents: Darwin.HFSPlusExtentRecord     init()     init(recordType recordType: UInt32, reserved reserved: UInt32, extents extents: Darwin.HFSPlusExtentRecord) } ``` |

Modified HFSPlusAttrExtents.extents

|  | Declaration |
| --- | --- |
| From | ``` var extents: HFSPlusExtentRecord ``` |
| To | ``` var extents: Darwin.HFSPlusExtentRecord ``` |

Modified HFSPlusAttrExtents.init(recordType: UInt32, reserved: UInt32, extents: Darwin.HFSPlusExtentRecord)

|  | Declaration |
| --- | --- |
| From | ``` init(recordType recordType: UInt32, reserved reserved: UInt32, extents extents: HFSPlusExtentRecord) ``` |
| To | ``` init(recordType recordType: UInt32, reserved reserved: UInt32, extents extents: Darwin.HFSPlusExtentRecord) ``` |

Modified HFSPlusForkData [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct HFSPlusForkData {     var logicalSize: UInt64     var clumpSize: UInt32     var totalBlocks: UInt32     var extents: HFSPlusExtentRecord     init()     init(logicalSize logicalSize: UInt64, clumpSize clumpSize: UInt32, totalBlocks totalBlocks: UInt32, extents extents: HFSPlusExtentRecord) } ``` |
| To | ``` struct HFSPlusForkData {     var logicalSize: UInt64     var clumpSize: UInt32     var totalBlocks: UInt32     var extents: Darwin.HFSPlusExtentRecord     init()     init(logicalSize logicalSize: UInt64, clumpSize clumpSize: UInt32, totalBlocks totalBlocks: UInt32, extents extents: Darwin.HFSPlusExtentRecord) } ``` |

Modified HFSPlusForkData.extents
...
Modified HFSPlusForkData.init(logicalSize: UInt64, clumpSize: UInt32, totalBlocks: UInt32, extents: Darwin.HFSPlusExtentRecord)

|  | Declaration |
| --- | --- |
| From | ``` init(logicalSize logicalSize: UInt64, clumpSize clumpSize: UInt32, totalBlocks totalBlocks: UInt32, extents extents: HFSPlusExtentRecord) ``` |
| To | ``` init(logicalSize logicalSize: UInt64, clumpSize clumpSize: UInt32, totalBlocks totalBlocks: UInt32, extents extents: Darwin.HFSPlusExtentRecord) ``` |
...
Modified ifmedia_description [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct ifmedia_description {     var ifmt_word: Int32     var ifmt_string: UnsafePointer<Int8>     init()     init(ifmt_word ifmt_word: Int32, ifmt_string ifmt_string: UnsafePointer<Int8>) } ``` |
| To | ``` struct ifmedia_description {     var ifmt_word: Int32     var ifmt_string: UnsafePointer<Int8>!     init()     init(ifmt_word ifmt_word: Int32, ifmt_string ifmt_string: UnsafePointer<Int8>!) } ``` |

Modified ifmedia_description.ifmt_string

|  | Declaration |
| --- | --- |
| From | ``` var ifmt_string: UnsafePointer<Int8> ``` |
| To | ``` var ifmt_string: UnsafePointer<Int8>! ``` |
...
Modified JournalInfoBlock [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct JournalInfoBlock {     var flags: UInt32     var device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32)     var offset: UInt64     var size: UInt64     var ext_jnl_uuid: uuid_string_t     var machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     init()     init(flags flags: UInt32, device_signature device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), offset offset: UInt64, size size: UInt64, ext_jnl_uuid ext_jnl_uuid: uuid_string_t, machine_serial_num machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), reserved reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)) } ``` |
| To | ``` struct JournalInfoBlock {     var flags: UInt32     var device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32)     var offset: UInt64     var size: UInt64     var ext_jnl_uuid: Darwin.uuid_string_t     var machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     init()     init(flags flags: UInt32, device_signature device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), offset offset: UInt64, size size: UInt64, ext_jnl_uuid ext_jnl_uuid: Darwin.uuid_string_t, machine_serial_num machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), reserved reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)) } ``` |

Modified JournalInfoBlock.ext_jnl_uuid

|  | Declaration |
| --- | --- |
| From | ``` var ext_jnl_uuid: uuid_string_t ``` |
| To | ``` var ext_jnl_uuid: Darwin.uuid_string_t ``` |

Modified JournalInfoBlock.init(flags: UInt32, device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), offset: UInt64, size: UInt64, ext_jnl_uuid: Darwin.uuid_string_t, machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8))

|  | Declaration |
| --- | --- |
| From | ``` init(flags flags: UInt32, device_signature device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), offset offset: UInt64, size size: UInt64, ext_jnl_uuid ext_jnl_uuid: uuid_string_t, machine_serial_num machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), reserved reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)) ``` |
| To | ``` init(flags flags: UInt32, device_signature device_signature: (UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32, UInt32), offset offset: UInt64, size size: UInt64, ext_jnl_uuid ext_jnl_uuid: Darwin.uuid_string_t, machine_serial_num machine_serial_num: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), reserved reserved: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)) ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` struct mach_msg_ool_descriptor_t {     var address: UnsafeMutablePointer<Void>     var deallocate: boolean_t     var copy: mach_msg_copy_options_t     var pad1: UInt32     var type: mach_msg_descriptor_type_t     var size: mach_msg_size_t     init()     init(address address: UnsafeMutablePointer<Void>, deallocate deallocate: boolean_t, copy copy: mach_msg_copy_options_t, pad1 pad1: UInt32, type type: mach_msg_descriptor_type_t, size size: mach_msg_size_t) } ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` struct mach_msg_ool_ports_descriptor_t {     var address: UnsafeMutablePointer<Void>     var deallocate: boolean_t     var copy: mach_msg_copy_options_t     var disposition: mach_msg_type_name_t     var type: mach_msg_descriptor_type_t     var count: mach_msg_size_t     init()     init(address address: UnsafeMutablePointer<Void>, deallocate deallocate: boolean_t, copy copy: mach_msg_copy_options_t, disposition disposition: mach_msg_type_name_t, type type: mach_msg_descriptor_type_t, count count: mach_msg_size_t) } ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` struct msg {     var msg_next: UnsafeMutablePointer<msg>     var msg_type: Int     var msg_ts: UInt16     var msg_spot: Int16     var label: COpaquePointer     init()     init(msg_next msg_next: UnsafeMutablePointer<msg>, msg_type msg_type: Int, msg_ts msg_ts: UInt16, msg_spot msg_spot: Int16, label label: COpaquePointer) } ``` |
| To | ``` struct msg {     var msg_next: UnsafeMutablePointer<msg>!     var msg_type: Int     var msg_ts: UInt16     var msg_spot: Int16     var label: OpaquePointer!     init()     init(msg_next msg_next: UnsafeMutablePointer<msg>!, msg_type msg_type: Int, msg_ts msg_ts: UInt16, msg_spot msg_spot: Int16, label label: OpaquePointer!) } ``` |
...
Modified msgbuf [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct msgbuf {     var msg_magic: Int32     var msg_size: Int32     var msg_bufx: Int32     var msg_bufr: Int32     var msg_bufc: UnsafeMutablePointer<Int8>     init()     init(msg_magic msg_magic: Int32, msg_size msg_size: Int32, msg_bufx msg_bufx: Int32, msg_bufr msg_bufr: Int32, msg_bufc msg_bufc: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct msgbuf {     var msg_magic: Int32     var msg_size: Int32     var msg_bufx: Int32     var msg_bufr: Int32     var msg_bufc: UnsafeMutablePointer<Int8>!     init()     init(msg_magic msg_magic: Int32, msg_size msg_size: Int32, msg_bufx msg_bufx: Int32, msg_bufr msg_bufr: Int32, msg_bufc msg_bufc: UnsafeMutablePointer<Int8>!) } ``` |

Modified msgbuf.msg_bufc

|  | Declaration |
| --- | --- |
| From | ``` var msg_bufc: UnsafeMutablePointer<Int8> ``` |
| To | ``` var msg_bufc: UnsafeMutablePointer<Int8>! ``` |
...
Modified pipebuf.buffer

|  | Declaration |
| --- | --- |
| From | ``` var buffer: caddr_t ``` |
| To | ``` var buffer: caddr_t! ``` |
...
Modified pseminfo [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct pseminfo {     var psem_flags: UInt32     var psem_usecount: UInt32     var psem_mode: mode_t     var psem_uid: uid_t     var psem_gid: gid_t     var psem_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var psem_semobject: UnsafeMutablePointer<Void>     var psem_label: COpaquePointer     var psem_creator_pid: pid_t     var psem_creator_uniqueid: UInt64     init()     init(psem_flags psem_flags: UInt32, psem_usecount psem_usecount: UInt32, psem_mode psem_mode: mode_t, psem_uid psem_uid: uid_t, psem_gid psem_gid: gid_t, psem_name psem_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), psem_semobject psem_semobject: UnsafeMutablePointer<Void>, psem_label psem_label: COpaquePointer, psem_creator_pid psem_creator_pid: pid_t, psem_creator_uniqueid psem_creator_uniqueid: UInt64) } ``` |
| To | ``` struct pseminfo {     var psem_flags: UInt32     var psem_usecount: UInt32     var psem_mode: mode_t     var psem_uid: uid_t     var psem_gid: gid_t     var psem_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var psem_semobject: UnsafeMutableRawPointer!     var psem_label: OpaquePointer!     var psem_creator_pid: pid_t     var psem_creator_uniqueid: UInt64     init()     init(psem_flags psem_flags: UInt32, psem_usecount psem_usecount: UInt32, psem_mode psem_mode: mode_t, psem_uid psem_uid: uid_t, psem_gid psem_gid: gid_t, psem_name psem_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), psem_semobject psem_semobject: UnsafeMutableRawPointer!, psem_label psem_label: OpaquePointer!, psem_creator_pid psem_creator_pid: pid_t, psem_creator_uniqueid psem_creator_uniqueid: UInt64) } ``` |

Modified pseminfo.psem_label

|  | Declaration |
| --- | --- |
| From | ``` var psem_label: COpaquePointer ``` |
| To | ``` var psem_label: OpaquePointer! ``` |

Modified pseminfo.psem_semobject

|  | Declaration |
| --- | --- |
| From | ``` var psem_semobject: UnsafeMutablePointer<Void> ``` |
| To | ``` var psem_semobject: UnsafeMutableRawPointer! ``` |

Modified pshminfo [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct pshminfo {     var pshm_flags: UInt32     var pshm_usecount: UInt32     var pshm_length: off_t     var pshm_mode: mode_t     var pshm_uid: uid_t     var pshm_gid: gid_t     var pshm_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var pshm_memobject: UnsafeMutablePointer<Void>     var pshm_label: COpaquePointer     init()     init(pshm_flags pshm_flags: UInt32, pshm_usecount pshm_usecount: UInt32, pshm_length pshm_length: off_t, pshm_mode pshm_mode: mode_t, pshm_uid pshm_uid: uid_t, pshm_gid pshm_gid: gid_t, pshm_name pshm_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), pshm_memobject pshm_memobject: UnsafeMutablePointer<Void>, pshm_label pshm_label: COpaquePointer) } ``` |
| To | ``` struct pshminfo {     var pshm_flags: UInt32     var pshm_usecount: UInt32     var pshm_length: off_t     var pshm_mode: mode_t     var pshm_uid: uid_t     var pshm_gid: gid_t     var pshm_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8)     var pshm_memobject: UnsafeMutableRawPointer!     var pshm_label: OpaquePointer!     init()     init(pshm_flags pshm_flags: UInt32, pshm_usecount pshm_usecount: UInt32, pshm_length pshm_length: off_t, pshm_mode pshm_mode: mode_t, pshm_uid pshm_uid: uid_t, pshm_gid pshm_gid: gid_t, pshm_name pshm_name: (Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8, Int8), pshm_memobject pshm_memobject: UnsafeMutableRawPointer!, pshm_label pshm_label: OpaquePointer!) } ``` |

Modified pshminfo.pshm_label

|  | Declaration |
| --- | --- |
| From | ``` var pshm_label: COpaquePointer ``` |
| To | ``` var pshm_label: OpaquePointer! ``` |

Modified pshminfo.pshm_memobject

|  | Declaration |
| --- | --- |
| From | ``` var pshm_memobject: UnsafeMutablePointer<Void> ``` |
| To | ``` var pshm_memobject: UnsafeMutableRawPointer! ``` |

Modified qelem [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct qelem {     var q_forw: UnsafeMutablePointer<qelem>     var q_back: UnsafeMutablePointer<qelem>     var q_data: UnsafeMutablePointer<Int8>     init()     init(q_forw q_forw: UnsafeMutablePointer<qelem>, q_back q_back: UnsafeMutablePointer<qelem>, q_data q_data: UnsafeMutablePointer<Int8>) } ``` |
| To | ``` struct qelem {     var q_forw: UnsafeMutablePointer<qelem>!     var q_back: UnsafeMutablePointer<qelem>!     var q_data: UnsafeMutablePointer<Int8>!     init()     init(q_forw q_forw: UnsafeMutablePointer<qelem>!, q_back q_back: UnsafeMutablePointer<qelem>!, q_data q_data: UnsafeMutablePointer<Int8>!) } ``` |

Modified qelem.q_back

|  | Declaration |
| --- | --- |
| From | ``` var q_back: UnsafeMutablePointer<qelem> ``` |
| To | ``` var q_back: UnsafeMutablePointer<qelem>! ``` |

Modified qelem.q_data

|  | Declaration |
| --- | --- |
| From | ``` var q_data: UnsafeMutablePointer<Int8> ``` |
| To | ``` var q_data: UnsafeMutablePointer<Int8>! ``` |

Modified qelem.q_forw

|  | Declaration |
| --- | --- |
| From | ``` var q_forw: UnsafeMutablePointer<qelem> ``` |
| To | ``` var q_forw: UnsafeMutablePointer<qelem>! ``` |
...
Modified rt_addrinfo [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct rt_addrinfo {     var rti_addrs: Int32     var rti_info: (UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>)     init()     init(rti_addrs rti_addrs: Int32, rti_info rti_info: (UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>)) } ``` |
| To | ``` struct rt_addrinfo {     var rti_addrs: Int32     var rti_info: (UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?)     init()     init(rti_addrs rti_addrs: Int32, rti_info rti_info: (UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?)) } ``` |

Modified rt_addrinfo.rti_info

|  | Declaration |
| --- | --- |
| From | ``` var rti_info: (UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>, UnsafeMutablePointer<sockaddr>) ``` |
| To | ``` var rti_info: (UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?, UnsafeMutablePointer<sockaddr>?) ``` |
...
Modified sbuf [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct sbuf {     var s_buf: UnsafeMutablePointer<Int8>     var s_unused: UnsafeMutablePointer<Void>     var s_size: Int32     var s_len: Int32     var s_flags: Int32     init()     init(s_buf s_buf: UnsafeMutablePointer<Int8>, s_unused s_unused: UnsafeMutablePointer<Void>, s_size s_size: Int32, s_len s_len: Int32, s_flags s_flags: Int32) } ``` |
| To | ``` struct sbuf {     var s_buf: UnsafeMutablePointer<Int8>!     var s_unused: UnsafeMutableRawPointer!     var s_size: Int32     var s_len: Int32     var s_flags: Int32     init()     init(s_buf s_buf: UnsafeMutablePointer<Int8>!, s_unused s_unused: UnsafeMutableRawPointer!, s_size s_size: Int32, s_len s_len: Int32, s_flags s_flags: Int32) } ``` |

Modified sbuf.s_buf

|  | Declaration |
| --- | --- |
| From | ``` var s_buf: UnsafeMutablePointer<Int8> ``` |
| To | ``` var s_buf: UnsafeMutablePointer<Int8>! ``` |

Modified sbuf.s_unused

|  | Declaration |
| --- | --- |
| From | ``` var s_unused: UnsafeMutablePointer<Void> ``` |
| To | ``` var s_unused: UnsafeMutableRawPointer! ``` |
...
Modified uprof [struct]

|  | Declaration |
| --- | --- |
| From | ``` struct uprof {     var pr_next: UnsafeMutablePointer<uprof>     var pr_base: caddr_t     var pr_size: UInt32     var pr_off: UInt32     var pr_scale: UInt32     var pr_addr: UInt32     var pr_ticks: UInt32     init()     init(pr_next pr_next: UnsafeMutablePointer<uprof>, pr_base pr_base: caddr_t, pr_size pr_size: UInt32, pr_off pr_off: UInt32, pr_scale pr_scale: UInt32, pr_addr pr_addr: UInt32, pr_ticks pr_ticks: UInt32) } ``` |
| To | ``` struct uprof {     var pr_next: UnsafeMutablePointer<uprof>!     var pr_base: caddr_t!     var pr_size: UInt32     var pr_off: UInt32     var pr_scale: UInt32     var pr_addr: UInt32     var pr_ticks: UInt32     init()     init(pr_next pr_next: UnsafeMutablePointer<uprof>!, pr_base pr_base: caddr_t!, pr_size pr_size: UInt32, pr_off pr_off: UInt32, pr_scale pr_scale: UInt32, pr_addr pr_addr: UInt32, pr_ticks pr_ticks: UInt32) } ``` |

Modified uprof.pr_base

|  | Declaration |
| --- | --- |
| From | ``` var pr_base: caddr_t ``` |
| To | ``` var pr_base: caddr_t! ``` |

Modified uprof.pr_next

|  | Declaration |
| --- | --- |
| From | ``` var pr_next: UnsafeMutablePointer<uprof> ``` |
| To | ``` var pr_next: UnsafeMutablePointer<uprof>! ``` |
...
| --- | --- | --- |
| From | ``` func arc4random_addrandom(_ _: UnsafeMutablePointer<UInt8>, _ _: Int32) ``` | OS X 10.10 |
| To | ``` func arc4random_addrandom(_ _: UnsafeMutablePointer<UInt8>!, _ _: Int32) ``` | OS X 10.0 |
...
Modified au_bsm_to_domain(_: u_short, _: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_bsm_to_domain(_ bsm_domain: u_short, _ local_domainp: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func au_bsm_to_domain(_ bsm_domain: u_short, _ local_domainp: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified au_bsm_to_errno(_: u_char, _: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_bsm_to_errno(_ bsm_error: u_char, _ errorp: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func au_bsm_to_errno(_ bsm_error: u_char, _ errorp: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified au_bsm_to_fcntl_cmd(_: u_short, _: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_bsm_to_fcntl_cmd(_ bsm_fcntl_cmd: u_short, _ local_fcntl_cmdp: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func au_bsm_to_fcntl_cmd(_ bsm_fcntl_cmd: u_short, _ local_fcntl_cmdp: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified au_bsm_to_socket_type(_: u_short, _: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_bsm_to_socket_type(_ bsm_socket_type: u_short, _ local_socket_typep: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func au_bsm_to_socket_type(_ bsm_socket_type: u_short, _ local_socket_typep: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified au_close_buffer(_: Int32, _: Int16, _: UnsafeMutablePointer<u_char>!, _: UnsafeMutablePointer<Int>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_close_buffer(_ d: Int32, _ event: Int16, _ buffer: UnsafeMutablePointer<u_char>, _ buflen: UnsafeMutablePointer<Int>) -> Int32 ``` |
| To | ``` func au_close_buffer(_ d: Int32, _ event: Int16, _ buffer: UnsafeMutablePointer<u_char>!, _ buflen: UnsafeMutablePointer<Int>!) -> Int32 ``` |

Modified au_close_token(_: OpaquePointer!, _: UnsafeMutablePointer<u_char>!, _: UnsafeMutablePointer<Int>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_close_token(_ tok: COpaquePointer, _ buffer: UnsafeMutablePointer<u_char>, _ buflen: UnsafeMutablePointer<Int>) -> Int32 ``` |
| To | ``` func au_close_token(_ tok: OpaquePointer!, _ buffer: UnsafeMutablePointer<u_char>!, _ buflen: UnsafeMutablePointer<Int>!) -> Int32 ``` |

Modified au_fetch_tok(_: UnsafeMutablePointer<tokenstr_t>!, _: UnsafeMutablePointer<u_char>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_fetch_tok(_ tok: UnsafeMutablePointer<tokenstr_t>, _ buf: UnsafeMutablePointer<u_char>, _ len: Int32) -> Int32 ``` |
| To | ``` func au_fetch_tok(_ tok: UnsafeMutablePointer<tokenstr_t>!, _ buf: UnsafeMutablePointer<u_char>!, _ len: Int32) -> Int32 ``` |

Modified au_free_token(_: OpaquePointer!)

|  | Declaration |
| --- | --- |
| From | ``` func au_free_token(_ tok: COpaquePointer) ``` |
| To | ``` func au_free_token(_ tok: OpaquePointer!) ``` |

Modified au_poltostr(_: Int32, _: Int, _: UnsafeMutablePointer<Int8>!) -> Int

|  | Declaration |
| --- | --- |
| From | ``` func au_poltostr(_ policy: Int32, _ maxsize: Int, _ buf: UnsafeMutablePointer<Int8>) -> Int ``` |
| To | ``` func au_poltostr(_ policy: Int32, _ maxsize: Int, _ buf: UnsafeMutablePointer<Int8>!) -> Int ``` |

Modified au_preselect(_: au_event_t, _: UnsafeMutablePointer<au_mask_t>!, _: Int32, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_preselect(_ event: au_event_t, _ mask_p: UnsafeMutablePointer<au_mask_t>, _ sorf: Int32, _ flag: Int32) -> Int32 ``` |
| To | ``` func au_preselect(_ event: au_event_t, _ mask_p: UnsafeMutablePointer<au_mask_t>!, _ sorf: Int32, _ flag: Int32) -> Int32 ``` |

Modified au_print_flags_tok(_: UnsafeMutablePointer<FILE>!, _: UnsafeMutablePointer<tokenstr_t>!, _: UnsafeMutablePointer<Int8>!, _: Int32)

|  | Declaration |
| --- | --- |
| From | ``` func au_print_flags_tok(_ outfp: UnsafeMutablePointer<FILE>, _ tok: UnsafeMutablePointer<tokenstr_t>, _ del: UnsafeMutablePointer<Int8>, _ oflags: Int32) ``` |
| To | ``` func au_print_flags_tok(_ outfp: UnsafeMutablePointer<FILE>!, _ tok: UnsafeMutablePointer<tokenstr_t>!, _ del: UnsafeMutablePointer<Int8>!, _ oflags: Int32) ``` |

Modified au_print_tok(_: UnsafeMutablePointer<FILE>!, _: UnsafeMutablePointer<tokenstr_t>!, _: UnsafeMutablePointer<Int8>!, _: Int8, _: Int8)

|  | Declaration |
| --- | --- |
| From | ``` func au_print_tok(_ outfp: UnsafeMutablePointer<FILE>, _ tok: UnsafeMutablePointer<tokenstr_t>, _ del: UnsafeMutablePointer<Int8>, _ raw: Int8, _ sfrm: Int8) ``` |
| To | ``` func au_print_tok(_ outfp: UnsafeMutablePointer<FILE>!, _ tok: UnsafeMutablePointer<tokenstr_t>!, _ del: UnsafeMutablePointer<Int8>!, _ raw: Int8, _ sfrm: Int8) ``` |

Modified au_print_tok_xml(_: UnsafeMutablePointer<FILE>!, _: UnsafeMutablePointer<tokenstr_t>!, _: UnsafeMutablePointer<Int8>!, _: Int8, _: Int8)

|  | Declaration |
| --- | --- |
| From | ``` func au_print_tok_xml(_ outfp: UnsafeMutablePointer<FILE>, _ tok: UnsafeMutablePointer<tokenstr_t>, _ del: UnsafeMutablePointer<Int8>, _ raw: Int8, _ sfrm: Int8) ``` |
| To | ``` func au_print_tok_xml(_ outfp: UnsafeMutablePointer<FILE>!, _ tok: UnsafeMutablePointer<tokenstr_t>!, _ del: UnsafeMutablePointer<Int8>!, _ raw: Int8, _ sfrm: Int8) ``` |

Modified au_print_xml_footer(_: UnsafeMutablePointer<FILE>!)

|  | Declaration |
| --- | --- |
| From | ``` func au_print_xml_footer(_ outfp: UnsafeMutablePointer<FILE>) ``` |
| To | ``` func au_print_xml_footer(_ outfp: UnsafeMutablePointer<FILE>!) ``` |

Modified au_print_xml_header(_: UnsafeMutablePointer<FILE>!)

|  | Declaration |
| --- | --- |
| From | ``` func au_print_xml_header(_ outfp: UnsafeMutablePointer<FILE>) ``` |
| To | ``` func au_print_xml_header(_ outfp: UnsafeMutablePointer<FILE>!) ``` |

Modified au_read_rec(_: UnsafeMutablePointer<FILE>!, _: UnsafeMutablePointer<UnsafeMutablePointer<u_char>?>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_read_rec(_ fp: UnsafeMutablePointer<FILE>, _ buf: UnsafeMutablePointer<UnsafeMutablePointer<u_char>>) -> Int32 ``` |
| To | ``` func au_read_rec(_ fp: UnsafeMutablePointer<FILE>!, _ buf: UnsafeMutablePointer<UnsafeMutablePointer<u_char>?>!) -> Int32 ``` |

Modified au_sflagstostr(_: UInt64, _: Int, _: UnsafeMutablePointer<Int8>!) -> Int

|  | Declaration |
| --- | --- |
| From | ``` func au_sflagstostr(_ flags: UInt64, _ maxsize: Int, _ buf: UnsafeMutablePointer<Int8>) -> Int ``` |
| To | ``` func au_sflagstostr(_ flags: UInt64, _ maxsize: Int, _ buf: UnsafeMutablePointer<Int8>!) -> Int ``` |

Modified au_strerror(_: u_char) -> UnsafePointer<Int8>!

|  | Declaration |
| --- | --- |
| From | ``` func au_strerror(_ bsm_error: u_char) -> UnsafePointer<Int8> ``` |
| To | ``` func au_strerror(_ bsm_error: u_char) -> UnsafePointer<Int8>! ``` |

Modified au_strtopol(_: UnsafePointer<Int8>!, _: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_strtopol(_ polstr: UnsafePointer<Int8>, _ policy: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func au_strtopol(_ polstr: UnsafePointer<Int8>!, _ policy: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified au_strtosflags(_: UnsafePointer<Int8>!, _: UnsafeMutablePointer<UInt64>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_strtosflags(_ sflagsstr: UnsafePointer<Int8>, _ flags: UnsafeMutablePointer<UInt64>) -> Int32 ``` |
| To | ``` func au_strtosflags(_ sflagsstr: UnsafePointer<Int8>!, _ flags: UnsafeMutablePointer<UInt64>!) -> Int32 ``` |

Modified au_to_arg(_: Int8, _: UnsafePointer<Int8>!, _: UInt32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_arg(_ n: Int8, _ text: UnsafePointer<Int8>, _ v: UInt32) -> COpaquePointer ``` |
| To | ``` func au_to_arg(_ n: Int8, _ text: UnsafePointer<Int8>!, _ v: UInt32) -> OpaquePointer! ``` |

Modified au_to_arg32(_: Int8, _: UnsafePointer<Int8>!, _: UInt32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_arg32(_ n: Int8, _ text: UnsafePointer<Int8>, _ v: UInt32) -> COpaquePointer ``` |
| To | ``` func au_to_arg32(_ n: Int8, _ text: UnsafePointer<Int8>!, _ v: UInt32) -> OpaquePointer! ``` |

Modified au_to_arg64(_: Int8, _: UnsafePointer<Int8>!, _: UInt64) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_arg64(_ n: Int8, _ text: UnsafePointer<Int8>, _ v: UInt64) -> COpaquePointer ``` |
| To | ``` func au_to_arg64(_ n: Int8, _ text: UnsafePointer<Int8>!, _ v: UInt64) -> OpaquePointer! ``` |

Modified au_to_data(_: Int8, _: Int8, _: Int8, _: UnsafePointer<Int8>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_data(_ unit_print: Int8, _ unit_type: Int8, _ unit_count: Int8, _ p: UnsafePointer<Int8>) -> COpaquePointer ``` |
| To | ``` func au_to_data(_ unit_print: Int8, _ unit_type: Int8, _ unit_count: Int8, _ p: UnsafePointer<Int8>!) -> OpaquePointer! ``` |

Modified au_to_exec_args(_: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_exec_args(_ argv: UnsafeMutablePointer<UnsafeMutablePointer<Int8>>) -> COpaquePointer ``` |
| To | ``` func au_to_exec_args(_ argv: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!) -> OpaquePointer! ``` |

Modified au_to_exec_env(_: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_exec_env(_ envp: UnsafeMutablePointer<UnsafeMutablePointer<Int8>>) -> COpaquePointer ``` |
| To | ``` func au_to_exec_env(_ envp: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!) -> OpaquePointer! ``` |

Modified au_to_exit(_: Int32, _: Int32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_exit(_ retval: Int32, _ err: Int32) -> COpaquePointer ``` |
| To | ``` func au_to_exit(_ retval: Int32, _ err: Int32) -> OpaquePointer! ``` |

Modified au_to_file(_: UnsafePointer<Int8>!, _: timeval) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_file(_ file: UnsafePointer<Int8>, _ tm: timeval) -> COpaquePointer ``` |
| To | ``` func au_to_file(_ file: UnsafePointer<Int8>!, _ tm: timeval) -> OpaquePointer! ``` |

Modified au_to_groups(_: UnsafeMutablePointer<Int32>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_groups(_ groups: UnsafeMutablePointer<Int32>) -> COpaquePointer ``` |
| To | ``` func au_to_groups(_ groups: UnsafeMutablePointer<Int32>!) -> OpaquePointer! ``` |

Modified au_to_header(_: Int32, _: au_event_t, _: au_emod_t) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> COpaquePointer ``` |
| To | ``` func au_to_header(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> OpaquePointer! ``` |

Modified au_to_header32(_: Int32, _: au_event_t, _: au_emod_t) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header32(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> COpaquePointer ``` |
| To | ``` func au_to_header32(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> OpaquePointer! ``` |

Modified au_to_header32_ex(_: Int32, _: au_event_t, _: au_emod_t) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header32_ex(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> COpaquePointer ``` |
| To | ``` func au_to_header32_ex(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> OpaquePointer! ``` |

Modified au_to_header32_ex_tm(_: Int32, _: au_event_t, _: au_emod_t, _: timeval, _: UnsafeMutablePointer<auditinfo_addr>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header32_ex_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval, _ aia: UnsafeMutablePointer<auditinfo_addr>) -> COpaquePointer ``` |
| To | ``` func au_to_header32_ex_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval, _ aia: UnsafeMutablePointer<auditinfo_addr>!) -> OpaquePointer! ``` |

Modified au_to_header32_tm(_: Int32, _: au_event_t, _: au_emod_t, _: timeval) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header32_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval) -> COpaquePointer ``` |
| To | ``` func au_to_header32_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval) -> OpaquePointer! ``` |

Modified au_to_header64(_: Int32, _: au_event_t, _: au_emod_t) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header64(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> COpaquePointer ``` |
| To | ``` func au_to_header64(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> OpaquePointer! ``` |

Modified au_to_header64_tm(_: Int32, _: au_event_t, _: au_emod_t, _: timeval) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header64_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval) -> COpaquePointer ``` |
| To | ``` func au_to_header64_tm(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t, _ tm: timeval) -> OpaquePointer! ``` |

Modified au_to_header_ex(_: Int32, _: au_event_t, _: au_emod_t) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_header_ex(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> COpaquePointer ``` |
| To | ``` func au_to_header_ex(_ rec_size: Int32, _ e_type: au_event_t, _ e_mod: au_emod_t) -> OpaquePointer! ``` |

Modified au_to_in_addr(_: UnsafeMutablePointer<in_addr>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_in_addr(_ internet_addr: UnsafeMutablePointer<in_addr>) -> COpaquePointer ``` |
| To | ``` func au_to_in_addr(_ internet_addr: UnsafeMutablePointer<in_addr>!) -> OpaquePointer! ``` |

Modified au_to_in_addr_ex(_: UnsafeMutablePointer<in6_addr>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_in_addr_ex(_ internet_addr: UnsafeMutablePointer<in6_addr>) -> COpaquePointer ``` |
| To | ``` func au_to_in_addr_ex(_ internet_addr: UnsafeMutablePointer<in6_addr>!) -> OpaquePointer! ``` |

Modified au_to_ip(_: OpaquePointer!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_ip(_ ip: COpaquePointer) -> COpaquePointer ``` |
| To | ``` func au_to_ip(_ ip: OpaquePointer!) -> OpaquePointer! ``` |

Modified au_to_ipc(_: Int8, _: Int32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_ipc(_ type: Int8, _ id: Int32) -> COpaquePointer ``` |
| To | ``` func au_to_ipc(_ type: Int8, _ id: Int32) -> OpaquePointer! ``` |

Modified au_to_ipc_perm(_: UnsafeMutablePointer<ipc_perm>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_ipc_perm(_ perm: UnsafeMutablePointer<ipc_perm>) -> COpaquePointer ``` |
| To | ``` func au_to_ipc_perm(_ perm: UnsafeMutablePointer<ipc_perm>!) -> OpaquePointer! ``` |

Modified au_to_iport(_: UInt16) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_iport(_ iport: UInt16) -> COpaquePointer ``` |
| To | ``` func au_to_iport(_ iport: UInt16) -> OpaquePointer! ``` |

Modified au_to_kevent(_: UnsafeMutablePointer<kevent>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_kevent(_ kev: UnsafeMutablePointer<kevent>) -> COpaquePointer ``` |
| To | ``` func au_to_kevent(_ kev: UnsafeMutablePointer<kevent>!) -> OpaquePointer! ``` |

Modified au_to_me() -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_me() -> COpaquePointer ``` |
| To | ``` func au_to_me() -> OpaquePointer! ``` |

Modified au_to_newgroups(_: UInt16, _: UnsafeMutablePointer<gid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_newgroups(_ n: UInt16, _ groups: UnsafeMutablePointer<gid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_newgroups(_ n: UInt16, _ groups: UnsafeMutablePointer<gid_t>!) -> OpaquePointer! ``` |

Modified au_to_opaque(_: UnsafePointer<Int8>!, _: UInt16) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_opaque(_ data: UnsafePointer<Int8>, _ bytes: UInt16) -> COpaquePointer ``` |
| To | ``` func au_to_opaque(_ data: UnsafePointer<Int8>!, _ bytes: UInt16) -> OpaquePointer! ``` |

Modified au_to_path(_: UnsafePointer<Int8>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_path(_ path: UnsafePointer<Int8>) -> COpaquePointer ``` |
| To | ``` func au_to_path(_ path: UnsafePointer<Int8>!) -> OpaquePointer! ``` |

Modified au_to_process(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_process32(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process32(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process32(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_process32_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process32_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process32_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_process64(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process64(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process64(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_process64_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process64_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process64_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_process_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_process_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_process_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_return(_: Int8, _: UInt32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_return(_ status: Int8, _ ret: UInt32) -> COpaquePointer ``` |
| To | ``` func au_to_return(_ status: Int8, _ ret: UInt32) -> OpaquePointer! ``` |

Modified au_to_return32(_: Int8, _: UInt32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_return32(_ status: Int8, _ ret: UInt32) -> COpaquePointer ``` |
| To | ``` func au_to_return32(_ status: Int8, _ ret: UInt32) -> OpaquePointer! ``` |

Modified au_to_return64(_: Int8, _: UInt64) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_return64(_ status: Int8, _ ret: UInt64) -> COpaquePointer ``` |
| To | ``` func au_to_return64(_ status: Int8, _ ret: UInt64) -> OpaquePointer! ``` |

Modified au_to_seq(_: Int) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_seq(_ audit_count: Int) -> COpaquePointer ``` |
| To | ``` func au_to_seq(_ audit_count: Int) -> OpaquePointer! ``` |

Modified au_to_sock_inet(_: UnsafeMutablePointer<sockaddr_in>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_sock_inet(_ so: UnsafeMutablePointer<sockaddr_in>) -> COpaquePointer ``` |
| To | ``` func au_to_sock_inet(_ so: UnsafeMutablePointer<sockaddr_in>!) -> OpaquePointer! ``` |

Modified au_to_sock_inet128(_: UnsafeMutablePointer<sockaddr_in6>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_sock_inet128(_ so: UnsafeMutablePointer<sockaddr_in6>) -> COpaquePointer ``` |
| To | ``` func au_to_sock_inet128(_ so: UnsafeMutablePointer<sockaddr_in6>!) -> OpaquePointer! ``` |

Modified au_to_sock_inet32(_: UnsafeMutablePointer<sockaddr_in>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_sock_inet32(_ so: UnsafeMutablePointer<sockaddr_in>) -> COpaquePointer ``` |
| To | ``` func au_to_sock_inet32(_ so: UnsafeMutablePointer<sockaddr_in>!) -> OpaquePointer! ``` |

Modified au_to_sock_unix(_: UnsafeMutablePointer<sockaddr_un>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_sock_unix(_ so: UnsafeMutablePointer<sockaddr_un>) -> COpaquePointer ``` |
| To | ``` func au_to_sock_unix(_ so: UnsafeMutablePointer<sockaddr_un>!) -> OpaquePointer! ``` |

Modified au_to_socket_ex(_: u_short, _: u_short, _: UnsafeMutablePointer<sockaddr>!, _: UnsafeMutablePointer<sockaddr>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_socket_ex(_ so_domain: u_short, _ so_type: u_short, _ sa_local: UnsafeMutablePointer<sockaddr>, _ sa_remote: UnsafeMutablePointer<sockaddr>) -> COpaquePointer ``` |
| To | ``` func au_to_socket_ex(_ so_domain: u_short, _ so_type: u_short, _ sa_local: UnsafeMutablePointer<sockaddr>!, _ sa_remote: UnsafeMutablePointer<sockaddr>!) -> OpaquePointer! ``` |

Modified au_to_subject(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_subject32(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject32(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject32(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_subject32_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject32_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject32_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_subject64(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject64(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject64(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> OpaquePointer! ``` |

Modified au_to_subject64_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject64_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject64_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_subject_ex(_: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_subject_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> COpaquePointer ``` |
| To | ``` func au_to_subject_ex(_ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> OpaquePointer! ``` |

Modified au_to_text(_: UnsafePointer<Int8>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_text(_ text: UnsafePointer<Int8>) -> COpaquePointer ``` |
| To | ``` func au_to_text(_ text: UnsafePointer<Int8>!) -> OpaquePointer! ``` |

Modified au_to_trailer(_: Int32) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_trailer(_ rec_size: Int32) -> COpaquePointer ``` |
| To | ``` func au_to_trailer(_ rec_size: Int32) -> OpaquePointer! ``` |

Modified au_to_zonename(_: UnsafePointer<Int8>!) -> OpaquePointer!

|  | Declaration |
| --- | --- |
| From | ``` func au_to_zonename(_ zonename: UnsafePointer<Int8>) -> COpaquePointer ``` |
| To | ``` func au_to_zonename(_ zonename: UnsafePointer<Int8>!) -> OpaquePointer! ``` |

Modified au_user_mask(_: UnsafeMutablePointer<Int8>!, _: UnsafeMutablePointer<au_mask_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_user_mask(_ username: UnsafeMutablePointer<Int8>, _ mask_p: UnsafeMutablePointer<au_mask_t>) -> Int32 ``` |
| To | ``` func au_user_mask(_ username: UnsafeMutablePointer<Int8>!, _ mask_p: UnsafeMutablePointer<au_mask_t>!) -> Int32 ``` |

Modified au_write(_: Int32, _: OpaquePointer!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func au_write(_ d: Int32, _ m: COpaquePointer) -> Int32 ``` |
| To | ``` func au_write(_ d: Int32, _ m: OpaquePointer!) -> Int32 ``` |
...
Modified audit_get_car(_: UnsafeMutablePointer<Int8>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_car(_ path: UnsafeMutablePointer<Int8>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_car(_ path: UnsafeMutablePointer<Int8>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_class(_: UnsafeMutablePointer<au_evclass_map_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_class(_ evc_map: UnsafeMutablePointer<au_evclass_map_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_class(_ evc_map: UnsafeMutablePointer<au_evclass_map_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_cond(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_cond(_ cond: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func audit_get_cond(_ cond: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified audit_get_cwd(_: UnsafeMutablePointer<Int8>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_cwd(_ path: UnsafeMutablePointer<Int8>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_cwd(_ path: UnsafeMutablePointer<Int8>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_fsize(_: UnsafeMutablePointer<au_fstat_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_fsize(_ fstat: UnsafeMutablePointer<au_fstat_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_fsize(_ fstat: UnsafeMutablePointer<au_fstat_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_kaudit(_: UnsafeMutablePointer<auditinfo_addr_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_kaudit(_ aia: UnsafeMutablePointer<auditinfo_addr_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_kaudit(_ aia: UnsafeMutablePointer<auditinfo_addr_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_kmask(_: UnsafeMutablePointer<au_mask_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_kmask(_ kmask: UnsafeMutablePointer<au_mask_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_kmask(_ kmask: UnsafeMutablePointer<au_mask_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_pinfo(_: UnsafeMutablePointer<auditpinfo_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_pinfo(_ api: UnsafeMutablePointer<auditpinfo_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_pinfo(_ api: UnsafeMutablePointer<auditpinfo_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_pinfo_addr(_: UnsafeMutablePointer<auditpinfo_addr_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_pinfo_addr(_ apia: UnsafeMutablePointer<auditpinfo_addr_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_pinfo_addr(_ apia: UnsafeMutablePointer<auditpinfo_addr_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_policy(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_policy(_ policy: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func audit_get_policy(_ policy: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified audit_get_qctrl(_: UnsafeMutablePointer<au_qctrl_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_qctrl(_ qctrl: UnsafeMutablePointer<au_qctrl_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_qctrl(_ qctrl: UnsafeMutablePointer<au_qctrl_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_sflags(_: UnsafeMutablePointer<UInt64>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_sflags(_ flags: UnsafeMutablePointer<UInt64>) -> Int32 ``` |
| To | ``` func audit_get_sflags(_ flags: UnsafeMutablePointer<UInt64>!) -> Int32 ``` |

Modified audit_get_sflags_mask(_: UnsafePointer<Int8>!, _: UnsafeMutablePointer<UInt64>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_sflags_mask(_ which: UnsafePointer<Int8>, _ mask: UnsafeMutablePointer<UInt64>) -> Int32 ``` |
| To | ``` func audit_get_sflags_mask(_ which: UnsafePointer<Int8>!, _ mask: UnsafeMutablePointer<UInt64>!) -> Int32 ``` |

Modified audit_get_sinfo_addr(_: UnsafeMutablePointer<auditinfo_addr_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_sinfo_addr(_ aia: UnsafeMutablePointer<auditinfo_addr_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_sinfo_addr(_ aia: UnsafeMutablePointer<auditinfo_addr_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_get_stat(_: UnsafeMutablePointer<au_stat_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_get_stat(_ stats: UnsafeMutablePointer<au_stat_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_get_stat(_ stats: UnsafeMutablePointer<au_stat_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_send_trigger(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_send_trigger(_ trigger: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func audit_send_trigger(_ trigger: UnsafeMutablePointer<Int32>!) -> Int32 ``` |
...
Modified audit_set_class(_: UnsafeMutablePointer<au_evclass_map_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_class(_ evc_map: UnsafeMutablePointer<au_evclass_map_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_class(_ evc_map: UnsafeMutablePointer<au_evclass_map_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_cond(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_cond(_ cond: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func audit_set_cond(_ cond: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified audit_set_fsize(_: UnsafeMutablePointer<au_fstat_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_fsize(_ fstat: UnsafeMutablePointer<au_fstat_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_fsize(_ fstat: UnsafeMutablePointer<au_fstat_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_kaudit(_: UnsafeMutablePointer<auditinfo_addr_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_kaudit(_ aia: UnsafeMutablePointer<auditinfo_addr_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_kaudit(_ aia: UnsafeMutablePointer<auditinfo_addr_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_kmask(_: UnsafeMutablePointer<au_mask_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_kmask(_ kmask: UnsafeMutablePointer<au_mask_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_kmask(_ kmask: UnsafeMutablePointer<au_mask_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_pmask(_: UnsafeMutablePointer<auditpinfo_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_pmask(_ api: UnsafeMutablePointer<auditpinfo_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_pmask(_ api: UnsafeMutablePointer<auditpinfo_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_policy(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_policy(_ policy: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func audit_set_policy(_ policy: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified audit_set_qctrl(_: UnsafeMutablePointer<au_qctrl_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_qctrl(_ qctrl: UnsafeMutablePointer<au_qctrl_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_qctrl(_ qctrl: UnsafeMutablePointer<au_qctrl_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_sflags_mask(_: UnsafePointer<Int8>!, _: UInt64) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_sflags_mask(_ which: UnsafePointer<Int8>, _ mask: UInt64) -> Int32 ``` |
| To | ``` func audit_set_sflags_mask(_ which: UnsafePointer<Int8>!, _ mask: UInt64) -> Int32 ``` |

Modified audit_set_stat(_: UnsafeMutablePointer<au_stat_t>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_stat(_ stats: UnsafeMutablePointer<au_stat_t>, _ sz: Int) -> Int32 ``` |
| To | ``` func audit_set_stat(_ stats: UnsafeMutablePointer<au_stat_t>!, _ sz: Int) -> Int32 ``` |

Modified audit_set_terminal_id(_: UnsafeMutablePointer<au_tid_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_terminal_id(_ tid: UnsafeMutablePointer<au_tid_t>) -> Int32 ``` |
| To | ``` func audit_set_terminal_id(_ tid: UnsafeMutablePointer<au_tid_t>!) -> Int32 ``` |

Modified audit_set_terminal_id_ex(_: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_set_terminal_id_ex(_ tid: UnsafeMutablePointer<au_tid_addr_t>) -> Int32 ``` |
| To | ``` func audit_set_terminal_id_ex(_ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32 ``` |

Modified audit_token_to_au32(_: audit_token_t, _: UnsafeMutablePointer<uid_t>!, _: UnsafeMutablePointer<uid_t>!, _: UnsafeMutablePointer<gid_t>!, _: UnsafeMutablePointer<uid_t>!, _: UnsafeMutablePointer<gid_t>!, _: UnsafeMutablePointer<pid_t>!, _: UnsafeMutablePointer<au_asid_t>!, _: UnsafeMutablePointer<au_tid_t>!)

|  | Declaration |
| --- | --- |
| From | ``` func audit_token_to_au32(_ atoken: audit_token_t, _ auidp: UnsafeMutablePointer<uid_t>, _ euidp: UnsafeMutablePointer<uid_t>, _ egidp: UnsafeMutablePointer<gid_t>, _ ruidp: UnsafeMutablePointer<uid_t>, _ rgidp: UnsafeMutablePointer<gid_t>, _ pidp: UnsafeMutablePointer<pid_t>, _ asidp: UnsafeMutablePointer<au_asid_t>, _ tidp: UnsafeMutablePointer<au_tid_t>) ``` |
| To | ``` func audit_token_to_au32(_ atoken: audit_token_t, _ auidp: UnsafeMutablePointer<uid_t>!, _ euidp: UnsafeMutablePointer<uid_t>!, _ egidp: UnsafeMutablePointer<gid_t>!, _ ruidp: UnsafeMutablePointer<uid_t>!, _ rgidp: UnsafeMutablePointer<gid_t>!, _ pidp: UnsafeMutablePointer<pid_t>!, _ asidp: UnsafeMutablePointer<au_asid_t>!, _ tidp: UnsafeMutablePointer<au_tid_t>!) ``` |

Modified audit_write(_: Int16, _: OpaquePointer!, _: OpaquePointer!, _: Int8, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write(_ event_code: Int16, _ subject: COpaquePointer, _ misctok: COpaquePointer, _ retval: Int8, _ errcode: Int32) -> Int32 ``` |
| To | ``` func audit_write(_ event_code: Int16, _ subject: OpaquePointer!, _ misctok: OpaquePointer!, _ retval: Int8, _ errcode: Int32) -> Int32 ``` |

Modified audit_write_failure(_: Int16, _: UnsafeMutablePointer<Int8>!, _: Int32, _: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_failure(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>, _ errret: Int32, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> Int32 ``` |
| To | ``` func audit_write_failure(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>!, _ errret: Int32, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> Int32 ``` |

Modified audit_write_failure_ex(_: Int16, _: UnsafeMutablePointer<Int8>!, _: Int32, _: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_failure_ex(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>, _ errret: Int32, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> Int32 ``` |
| To | ``` func audit_write_failure_ex(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>!, _ errret: Int32, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32 ``` |

Modified audit_write_failure_na(_: Int16, _: UnsafeMutablePointer<Int8>!, _: Int32, _: uid_t, _: gid_t, _: pid_t, _: UnsafeMutablePointer<au_tid_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_failure_na(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>, _ errret: Int32, _ euid: uid_t, _ egid: gid_t, _ pid: pid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> Int32 ``` |
| To | ``` func audit_write_failure_na(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>!, _ errret: Int32, _ euid: uid_t, _ egid: gid_t, _ pid: pid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> Int32 ``` |

Modified audit_write_failure_na_ex(_: Int16, _: UnsafeMutablePointer<Int8>!, _: Int32, _: uid_t, _: gid_t, _: pid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_failure_na_ex(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>, _ errret: Int32, _ euid: uid_t, _ egid: gid_t, _ pid: pid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> Int32 ``` |
| To | ``` func audit_write_failure_na_ex(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>!, _ errret: Int32, _ euid: uid_t, _ egid: gid_t, _ pid: pid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32 ``` |

Modified audit_write_failure_self(_: Int16, _: UnsafeMutablePointer<Int8>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_failure_self(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>, _ errret: Int32) -> Int32 ``` |
| To | ``` func audit_write_failure_self(_ event_code: Int16, _ errmsg: UnsafeMutablePointer<Int8>!, _ errret: Int32) -> Int32 ``` |

Modified audit_write_success(_: Int16, _: OpaquePointer!, _: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_success(_ event_code: Int16, _ misctok: COpaquePointer, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>) -> Int32 ``` |
| To | ``` func audit_write_success(_ event_code: Int16, _ misctok: OpaquePointer!, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_t>!) -> Int32 ``` |

Modified audit_write_success_ex(_: Int16, _: OpaquePointer!, _: au_id_t, _: uid_t, _: gid_t, _: uid_t, _: gid_t, _: pid_t, _: au_asid_t, _: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_success_ex(_ event_code: Int16, _ misctok: COpaquePointer, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>) -> Int32 ``` |
| To | ``` func audit_write_success_ex(_ event_code: Int16, _ misctok: OpaquePointer!, _ auid: au_id_t, _ euid: uid_t, _ egid: gid_t, _ ruid: uid_t, _ rgid: gid_t, _ pid: pid_t, _ sid: au_asid_t, _ tid: UnsafeMutablePointer<au_tid_addr_t>!) -> Int32 ``` |

Modified audit_write_success_self(_: Int16, _: OpaquePointer!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func audit_write_success_self(_ event_code: Int16, _ misctok: COpaquePointer) -> Int32 ``` |
| To | ``` func audit_write_success_self(_ event_code: Int16, _ misctok: OpaquePointer!) -> Int32 ``` |
...
Modified buf_alloc(_: vnode_t!) -> buf_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_alloc(_ _: vnode_t) -> buf_t ``` |
| To | ``` func buf_alloc(_ vp: vnode_t!) -> buf_t! ``` |

Modified buf_attr(_: buf_t!) -> bufattr_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_attr(_ _: buf_t) -> bufattr_t ``` |
| To | ``` func buf_attr(_ bp: buf_t!) -> bufattr_t! ``` |

Modified buf_bawrite(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_bawrite(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_bawrite(_ bp: buf_t!) -> errno_t ``` |

Modified buf_bdwrite(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_bdwrite(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_bdwrite(_ bp: buf_t!) -> errno_t ``` |

Modified buf_biodone(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_biodone(_ _: buf_t) ``` |
| To | ``` func buf_biodone(_ bp: buf_t!) ``` |

Modified buf_biowait(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_biowait(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_biowait(_ bp: buf_t!) -> errno_t ``` |

Modified buf_blkno(_: buf_t!) -> daddr64_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_blkno(_ _: buf_t) -> daddr64_t ``` |
| To | ``` func buf_blkno(_ bp: buf_t!) -> daddr64_t ``` |

Modified buf_bread(_: vnode_t!, _: daddr64_t, _: Int32, _: kauth_cred_t!, _: UnsafeMutablePointer<buf_t?>!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_bread(_ _: vnode_t, _ _: daddr64_t, _ _: Int32, _ _: kauth_cred_t, _ _: UnsafeMutablePointer<buf_t>) -> errno_t ``` |
| To | ``` func buf_bread(_ vp: vnode_t!, _ blkno: daddr64_t, _ size: Int32, _ cred: kauth_cred_t!, _ bpp: UnsafeMutablePointer<buf_t?>!) -> errno_t ``` |

Modified buf_breadn(_: vnode_t!, _: daddr64_t, _: Int32, _: UnsafeMutablePointer<daddr64_t>!, _: UnsafeMutablePointer<Int32>!, _: Int32, _: kauth_cred_t!, _: UnsafeMutablePointer<buf_t?>!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_breadn(_ _: vnode_t, _ _: daddr64_t, _ _: Int32, _ _: UnsafeMutablePointer<daddr64_t>, _ _: UnsafeMutablePointer<Int32>, _ _: Int32, _ _: kauth_cred_t, _ _: UnsafeMutablePointer<buf_t>) -> errno_t ``` |
| To | ``` func buf_breadn(_ vp: vnode_t!, _ blkno: daddr64_t, _ size: Int32, _ rablks: UnsafeMutablePointer<daddr64_t>!, _ rasizes: UnsafeMutablePointer<Int32>!, _ nrablks: Int32, _ cred: kauth_cred_t!, _ bpp: UnsafeMutablePointer<buf_t?>!) -> errno_t ``` |

Modified buf_brelse(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_brelse(_ _: buf_t) ``` |
| To | ``` func buf_brelse(_ bp: buf_t!) ``` |

Modified buf_bwrite(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_bwrite(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_bwrite(_ bp: buf_t!) -> errno_t ``` |

Modified buf_callback(_: buf_t!) -> UnsafeMutableRawPointer!

|  | Declaration |
| --- | --- |
| From | ``` func buf_callback(_ _: buf_t) -> UnsafeMutablePointer<Void> ``` |
| To | ``` func buf_callback(_ bp: buf_t!) -> UnsafeMutableRawPointer! ``` |

Modified buf_clear(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_clear(_ _: buf_t) ``` |
| To | ``` func buf_clear(_ bp: buf_t!) ``` |

Modified buf_clear_redundancy_flags(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_clear_redundancy_flags(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_clear_redundancy_flags(_ bp: buf_t!, _ flags: UInt32) ``` |

Modified buf_clearflags(_: buf_t!, _: Int32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_clearflags(_ _: buf_t, _ _: Int32) ``` |
| To | ``` func buf_clearflags(_ bp: buf_t!, _ flags: Int32) ``` |

Modified buf_clone(_: buf_t!, _: Int32, _: Int32, _: ( (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _: UnsafeMutableRawPointer!) -> buf_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_clone(_ _: buf_t, _ _: Int32, _ _: Int32, _ _: ((buf_t, UnsafeMutablePointer<Void>) -> Void)!, _ _: UnsafeMutablePointer<Void>) -> buf_t ``` |
| To | ``` func buf_clone(_ bp: buf_t!, _ io_offset: Int32, _ io_size: Int32, _ iodone: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |

Modified buf_count(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_count(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_count(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_create_shadow(_: buf_t!, _: boolean_t, _: UInt, _: ( (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _: UnsafeMutableRawPointer!) -> buf_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_create_shadow(_ bp: buf_t, _ force_copy: boolean_t, _ external_storage: UInt, _ iodone: ((buf_t, UnsafeMutablePointer<Void>) -> Void)!, _ arg: UnsafeMutablePointer<Void>) -> buf_t ``` |
| To | ``` func buf_create_shadow(_ bp: buf_t!, _ force_copy: boolean_t, _ external_storage: UInt, _ iodone: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |

Modified buf_dataptr(_: buf_t!) -> UInt

|  | Declaration |
| --- | --- |
| From | ``` func buf_dataptr(_ _: buf_t) -> UInt ``` |
| To | ``` func buf_dataptr(_ bp: buf_t!) -> UInt ``` |

Modified buf_device(_: buf_t!) -> dev_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_device(_ _: buf_t) -> dev_t ``` |
| To | ``` func buf_device(_ bp: buf_t!) -> dev_t ``` |

Modified buf_dirtyend(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_dirtyend(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_dirtyend(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_dirtyoff(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_dirtyoff(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_dirtyoff(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_drvdata(_: buf_t!) -> UnsafeMutableRawPointer!

|  | Declaration |
| --- | --- |
| From | ``` func buf_drvdata(_ _: buf_t) -> UnsafeMutablePointer<Void> ``` |
| To | ``` func buf_drvdata(_ bp: buf_t!) -> UnsafeMutableRawPointer! ``` |

Modified buf_error(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_error(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_error(_ bp: buf_t!) -> errno_t ``` |

Modified buf_flags(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_flags(_ _: buf_t) -> Int32 ``` |
| To | ``` func buf_flags(_ bp: buf_t!) -> Int32 ``` |

Modified buf_flushdirtyblks(_: vnode_t!, _: Int32, _: Int32, _: UnsafePointer<Int8>!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_flushdirtyblks(_ _: vnode_t, _ _: Int32, _ _: Int32, _ _: UnsafePointer<Int8>) ``` |
| To | ``` func buf_flushdirtyblks(_ vp: vnode_t!, _ wait: Int32, _ flags: Int32, _ msg: UnsafePointer<Int8>!) ``` |

Modified buf_free(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_free(_ _: buf_t) ``` |
| To | ``` func buf_free(_ bp: buf_t!) ``` |

Modified buf_fromcache(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_fromcache(_ _: buf_t) -> Int32 ``` |
| To | ``` func buf_fromcache(_ bp: buf_t!) -> Int32 ``` |

Modified buf_fsprivate(_: buf_t!) -> UnsafeMutableRawPointer!

|  | Declaration |
| --- | --- |
| From | ``` func buf_fsprivate(_ _: buf_t) -> UnsafeMutablePointer<Void> ``` |
| To | ``` func buf_fsprivate(_ bp: buf_t!) -> UnsafeMutableRawPointer! ``` |

Modified buf_fua(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_fua(_ _: buf_t) -> Int32 ``` |
| To | ``` func buf_fua(_ bp: buf_t!) -> Int32 ``` |

Modified buf_getblk(_: vnode_t!, _: daddr64_t, _: Int32, _: Int32, _: Int32, _: Int32) -> buf_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_getblk(_ _: vnode_t, _ _: daddr64_t, _ _: Int32, _ _: Int32, _ _: Int32, _ _: Int32) -> buf_t ``` |
| To | ``` func buf_getblk(_ vp: vnode_t!, _ blkno: daddr64_t, _ size: Int32, _ slpflag: Int32, _ slptimeo: Int32, _ operation: Int32) -> buf_t! ``` |

Modified buf_geteblk(_: Int32) -> buf_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_geteblk(_ _: Int32) -> buf_t ``` |
| To | ``` func buf_geteblk(_ size: Int32) -> buf_t! ``` |

Modified buf_invalblkno(_: vnode_t!, _: daddr64_t, _: Int32) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_invalblkno(_ _: vnode_t, _ _: daddr64_t, _ _: Int32) -> errno_t ``` |
| To | ``` func buf_invalblkno(_ vp: vnode_t!, _ lblkno: daddr64_t, _ flags: Int32) -> errno_t ``` |

Modified buf_invalidateblks(_: vnode_t!, _: Int32, _: Int32, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_invalidateblks(_ _: vnode_t, _ _: Int32, _ _: Int32, _ _: Int32) -> Int32 ``` |
| To | ``` func buf_invalidateblks(_ vp: vnode_t!, _ flags: Int32, _ slpflag: Int32, _ slptimeo: Int32) -> Int32 ``` |

Modified buf_iterate(_: vnode_t!, _: ( (buf_t?, UnsafeMutableRawPointer?) -> Int32)!, _: Int32, _: UnsafeMutableRawPointer!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_iterate(_ _: vnode_t, _ _: ((buf_t, UnsafeMutablePointer<Void>) -> Int32)!, _ _: Int32, _ _: UnsafeMutablePointer<Void>) ``` |
| To | ``` func buf_iterate(_ vp: vnode_t!, _ callout: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Int32)!, _ flags: Int32, _ arg: UnsafeMutableRawPointer!) ``` |

Modified buf_lblkno(_: buf_t!) -> daddr64_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_lblkno(_ _: buf_t) -> daddr64_t ``` |
| To | ``` func buf_lblkno(_ bp: buf_t!) -> daddr64_t ``` |

Modified buf_map(_: buf_t!, _: UnsafeMutablePointer<caddr_t?>!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_map(_ _: buf_t, _ _: UnsafeMutablePointer<caddr_t>) -> errno_t ``` |
| To | ``` func buf_map(_ bp: buf_t!, _ io_addr: UnsafeMutablePointer<caddr_t?>!) -> errno_t ``` |

Modified buf_markaged(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markaged(_ _: buf_t) ``` |
| To | ``` func buf_markaged(_ bp: buf_t!) ``` |

Modified buf_markclean(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markclean(_ _: buf_t) ``` |
| To | ``` func buf_markclean(_ _: buf_t!) ``` |

Modified buf_markdelayed(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markdelayed(_ _: buf_t) ``` |
| To | ``` func buf_markdelayed(_ bp: buf_t!) ``` |

Modified buf_markeintr(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markeintr(_ _: buf_t) ``` |
| To | ``` func buf_markeintr(_ bp: buf_t!) ``` |

Modified buf_markfua(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markfua(_ _: buf_t) ``` |
| To | ``` func buf_markfua(_ bp: buf_t!) ``` |

Modified buf_markinvalid(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markinvalid(_ _: buf_t) ``` |
| To | ``` func buf_markinvalid(_ bp: buf_t!) ``` |

Modified buf_markstatic(_: buf_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_markstatic(_ _: buf_t) ``` |
| To | ``` func buf_markstatic(_ bp: buf_t!) ``` |

Modified buf_meta_bread(_: vnode_t!, _: daddr64_t, _: Int32, _: kauth_cred_t!, _: UnsafeMutablePointer<buf_t?>!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_meta_bread(_ _: vnode_t, _ _: daddr64_t, _ _: Int32, _ _: kauth_cred_t, _ _: UnsafeMutablePointer<buf_t>) -> errno_t ``` |
| To | ``` func buf_meta_bread(_ vp: vnode_t!, _ blkno: daddr64_t, _ size: Int32, _ cred: kauth_cred_t!, _ bpp: UnsafeMutablePointer<buf_t?>!) -> errno_t ``` |

Modified buf_meta_breadn(_: vnode_t!, _: daddr64_t, _: Int32, _: UnsafeMutablePointer<daddr64_t>!, _: UnsafeMutablePointer<Int32>!, _: Int32, _: kauth_cred_t!, _: UnsafeMutablePointer<buf_t?>!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_meta_breadn(_ _: vnode_t, _ _: daddr64_t, _ _: Int32, _ _: UnsafeMutablePointer<daddr64_t>, _ _: UnsafeMutablePointer<Int32>, _ _: Int32, _ _: kauth_cred_t, _ _: UnsafeMutablePointer<buf_t>) -> errno_t ``` |
| To | ``` func buf_meta_breadn(_ vp: vnode_t!, _ blkno: daddr64_t, _ size: Int32, _ rablks: UnsafeMutablePointer<daddr64_t>!, _ rasizes: UnsafeMutablePointer<Int32>!, _ nrablks: Int32, _ cred: kauth_cred_t!, _ bpp: UnsafeMutablePointer<buf_t?>!) -> errno_t ``` |

Modified buf_proc(_: buf_t!) -> proc_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_proc(_ _: buf_t) -> proc_t ``` |
| To | ``` func buf_proc(_ bp: buf_t!) -> proc_t! ``` |

Modified buf_rcred(_: buf_t!) -> kauth_cred_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_rcred(_ _: buf_t) -> kauth_cred_t ``` |
| To | ``` func buf_rcred(_ bp: buf_t!) -> kauth_cred_t! ``` |

Modified buf_redundancy_flags(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_redundancy_flags(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_redundancy_flags(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_reset(_: buf_t!, _: Int32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_reset(_ _: buf_t, _ _: Int32) ``` |
| To | ``` func buf_reset(_ bp: buf_t!, _ flags: Int32) ``` |

Modified buf_resid(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_resid(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_resid(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_set_redundancy_flags(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_set_redundancy_flags(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_set_redundancy_flags(_ bp: buf_t!, _ flags: UInt32) ``` |

Modified buf_setblkno(_: buf_t!, _: daddr64_t)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setblkno(_ _: buf_t, _ _: daddr64_t) ``` |
| To | ``` func buf_setblkno(_ bp: buf_t!, _ blkno: daddr64_t) ``` |

Modified buf_setcallback(_: buf_t!, _: ( (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _: UnsafeMutableRawPointer!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_setcallback(_ _: buf_t, _ _: ((buf_t, UnsafeMutablePointer<Void>) -> Void)!, _ _: UnsafeMutablePointer<Void>) -> errno_t ``` |
| To | ``` func buf_setcallback(_ bp: buf_t!, _ callback: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ transaction: UnsafeMutableRawPointer!) -> errno_t ``` |

Modified buf_setcount(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setcount(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_setcount(_ bp: buf_t!, _ bcount: UInt32) ``` |

Modified buf_setdataptr(_: buf_t!, _: UInt)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setdataptr(_ _: buf_t, _ _: UInt) ``` |
| To | ``` func buf_setdataptr(_ bp: buf_t!, _ data: UInt) ``` |

Modified buf_setdevice(_: buf_t!, _: vnode_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_setdevice(_ _: buf_t, _ _: vnode_t) -> errno_t ``` |
| To | ``` func buf_setdevice(_ bp: buf_t!, _ vp: vnode_t!) -> errno_t ``` |

Modified buf_setdirtyend(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setdirtyend(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_setdirtyend(_ bp: buf_t!, _ _: UInt32) ``` |

Modified buf_setdirtyoff(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setdirtyoff(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_setdirtyoff(_ bp: buf_t!, _ _: UInt32) ``` |

Modified buf_setdrvdata(_: buf_t!, _: UnsafeMutableRawPointer!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setdrvdata(_ _: buf_t, _ _: UnsafeMutablePointer<Void>) ``` |
| To | ``` func buf_setdrvdata(_ bp: buf_t!, _ drvdata: UnsafeMutableRawPointer!) ``` |

Modified buf_seterror(_: buf_t!, _: errno_t)

|  | Declaration |
| --- | --- |
| From | ``` func buf_seterror(_ _: buf_t, _ _: errno_t) ``` |
| To | ``` func buf_seterror(_ bp: buf_t!, _ _: errno_t) ``` |

Modified buf_setflags(_: buf_t!, _: Int32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setflags(_ _: buf_t, _ _: Int32) ``` |
| To | ``` func buf_setflags(_ bp: buf_t!, _ flags: Int32) ``` |

Modified buf_setfsprivate(_: buf_t!, _: UnsafeMutableRawPointer!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setfsprivate(_ _: buf_t, _ _: UnsafeMutablePointer<Void>) ``` |
| To | ``` func buf_setfsprivate(_ bp: buf_t!, _ fsprivate: UnsafeMutableRawPointer!) ``` |

Modified buf_setlblkno(_: buf_t!, _: daddr64_t)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setlblkno(_ _: buf_t, _ _: daddr64_t) ``` |
| To | ``` func buf_setlblkno(_ bp: buf_t!, _ lblkno: daddr64_t) ``` |

Modified buf_setresid(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setresid(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_setresid(_ bp: buf_t!, _ resid: UInt32) ``` |

Modified buf_setsize(_: buf_t!, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setsize(_ _: buf_t, _ _: UInt32) ``` |
| To | ``` func buf_setsize(_ bp: buf_t!, _ _: UInt32) ``` |

Modified buf_setupl(_: buf_t!, _: upl_t, _: UInt32) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_setupl(_ _: buf_t, _ _: upl_t, _ _: UInt32) -> errno_t ``` |
| To | ``` func buf_setupl(_ bp: buf_t!, _ upl: upl_t, _ offset: UInt32) -> errno_t ``` |

Modified buf_setvnode(_: buf_t!, _: vnode_t!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_setvnode(_ _: buf_t, _ _: vnode_t) ``` |
| To | ``` func buf_setvnode(_ bp: buf_t!, _ vp: vnode_t!) ``` |

Modified buf_shadow(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_shadow(_ bp: buf_t) -> Int32 ``` |
| To | ``` func buf_shadow(_ bp: buf_t!) -> Int32 ``` |

Modified buf_size(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_size(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_size(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_static(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_static(_ _: buf_t) -> Int32 ``` |
| To | ``` func buf_static(_ bp: buf_t!) -> Int32 ``` |

Modified buf_strategy(_: vnode_t!, _: UnsafeMutableRawPointer!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_strategy(_ _: vnode_t, _ _: UnsafeMutablePointer<Void>) -> errno_t ``` |
| To | ``` func buf_strategy(_ devvp: vnode_t!, _ ap: UnsafeMutableRawPointer!) -> errno_t ``` |

Modified buf_t

|  | Declaration |
| --- | --- |
| From | ``` typealias buf_t = COpaquePointer ``` |
| To | ``` typealias buf_t = OpaquePointer ``` |

Modified buf_unmap(_: buf_t!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_unmap(_ _: buf_t) -> errno_t ``` |
| To | ``` func buf_unmap(_ bp: buf_t!) -> errno_t ``` |

Modified buf_upl(_: buf_t!) -> UnsafeMutableRawPointer!

|  | Declaration |
| --- | --- |
| From | ``` func buf_upl(_ _: buf_t) -> UnsafeMutablePointer<Void> ``` |
| To | ``` func buf_upl(_ bp: buf_t!) -> UnsafeMutableRawPointer! ``` |

Modified buf_uploffset(_: buf_t!) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func buf_uploffset(_ _: buf_t) -> UInt32 ``` |
| To | ``` func buf_uploffset(_ bp: buf_t!) -> UInt32 ``` |

Modified buf_valid(_: buf_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func buf_valid(_ _: buf_t) -> Int32 ``` |
| To | ``` func buf_valid(_ bp: buf_t!) -> Int32 ``` |

Modified buf_vnode(_: buf_t!) -> vnode_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_vnode(_ _: buf_t) -> vnode_t ``` |
| To | ``` func buf_vnode(_ bp: buf_t!) -> vnode_t! ``` |

Modified buf_wcred(_: buf_t!) -> kauth_cred_t!

|  | Declaration |
| --- | --- |
| From | ``` func buf_wcred(_ _: buf_t) -> kauth_cred_t ``` |
| To | ``` func buf_wcred(_ bp: buf_t!) -> kauth_cred_t! ``` |

Modified bufattr_t

|  | Declaration |
| --- | --- |
| From | ``` typealias bufattr_t = COpaquePointer ``` |
| To | ``` typealias bufattr_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func exchangedata(_ _: UnsafePointer<Int8>, _ _: UnsafePointer<Int8>, _ _: UInt32) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func fgetattrlist(_ _: Int32, _ _: UnsafeMutablePointer<Void>, _ _: UnsafeMutablePointer<Void>, _ _: Int, _ _: UInt32) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias file_t = COpaquePointer ``` |
| To | ``` typealias file_t = OpaquePointer ``` |
...
| To | ``` func fpclassify(_ value: Double) -> Int ``` | OS X 10.12 |
...
| To | ``` func fpclassify(_ value: Float) -> Int ``` | OS X 10.12 |
...
|  | Declaration |
| --- | --- |
| From | ``` func fsetattrlist(_ _: Int32, _ _: UnsafeMutablePointer<Void>, _ _: UnsafeMutablePointer<Void>, _ _: Int, _ _: UInt32) -> Int32 ``` |
...
Modified getacdir(_: UnsafeMutablePointer<Int8>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacdir(_ name: UnsafeMutablePointer<Int8>, _ len: Int32) -> Int32 ``` |
| To | ``` func getacdir(_ name: UnsafeMutablePointer<Int8>!, _ len: Int32) -> Int32 ``` |

Modified getacexpire(_: UnsafeMutablePointer<Int32>!, _: UnsafeMutablePointer<time_t>!, _: UnsafeMutablePointer<Int>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacexpire(_ andflg: UnsafeMutablePointer<Int32>, _ age: UnsafeMutablePointer<time_t>, _ size: UnsafeMutablePointer<Int>) -> Int32 ``` |
| To | ``` func getacexpire(_ andflg: UnsafeMutablePointer<Int32>!, _ age: UnsafeMutablePointer<time_t>!, _ size: UnsafeMutablePointer<Int>!) -> Int32 ``` |

Modified getacfilesz(_: UnsafeMutablePointer<Int>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacfilesz(_ size_val: UnsafeMutablePointer<Int>) -> Int32 ``` |
| To | ``` func getacfilesz(_ size_val: UnsafeMutablePointer<Int>!) -> Int32 ``` |

Modified getacflg(_: UnsafeMutablePointer<Int8>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacflg(_ auditstr: UnsafeMutablePointer<Int8>, _ len: Int32) -> Int32 ``` |
| To | ``` func getacflg(_ auditstr: UnsafeMutablePointer<Int8>!, _ len: Int32) -> Int32 ``` |

Modified getachost(_: UnsafeMutablePointer<Int8>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getachost(_ auditstr: UnsafeMutablePointer<Int8>, _ len: Int) -> Int32 ``` |
| To | ``` func getachost(_ auditstr: UnsafeMutablePointer<Int8>!, _ len: Int) -> Int32 ``` |

Modified getacmin(_: UnsafeMutablePointer<Int32>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacmin(_ min_val: UnsafeMutablePointer<Int32>) -> Int32 ``` |
| To | ``` func getacmin(_ min_val: UnsafeMutablePointer<Int32>!) -> Int32 ``` |

Modified getacna(_: UnsafeMutablePointer<Int8>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacna(_ auditstr: UnsafeMutablePointer<Int8>, _ len: Int32) -> Int32 ``` |
| To | ``` func getacna(_ auditstr: UnsafeMutablePointer<Int8>!, _ len: Int32) -> Int32 ``` |

Modified getacpol(_: UnsafeMutablePointer<Int8>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacpol(_ auditstr: UnsafeMutablePointer<Int8>, _ len: Int) -> Int32 ``` |
| To | ``` func getacpol(_ auditstr: UnsafeMutablePointer<Int8>!, _ len: Int) -> Int32 ``` |

Modified getacsflagsmask(_: UnsafePointer<Int8>!, _: UnsafeMutablePointer<Int8>!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getacsflagsmask(_ which: UnsafePointer<Int8>, _ auditstr: UnsafeMutablePointer<Int8>, _ len: Int) -> Int32 ``` |
| To | ``` func getacsflagsmask(_ which: UnsafePointer<Int8>!, _ auditstr: UnsafeMutablePointer<Int8>!, _ len: Int) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getattrlist(_ _: UnsafePointer<Int8>, _ _: UnsafeMutablePointer<Void>, _ _: UnsafeMutablePointer<Void>, _ _: Int, _ _: UInt32) -> Int32 ``` |
...
Modified getauclassent() -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassent() -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassent() -> UnsafeMutablePointer<au_class_ent>! ``` |

Modified getauclassent_r(_: UnsafeMutablePointer<au_class_ent_t>!) -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassent_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>) -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassent_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>!) -> UnsafeMutablePointer<au_class_ent>! ``` |

Modified getauclassnam(_: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassnam(_ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassnam(_ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_class_ent>! ``` |

Modified getauclassnam_r(_: UnsafeMutablePointer<au_class_ent_t>!, _: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassnam_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>, _ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassnam_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>!, _ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_class_ent>! ``` |

Modified getauclassnum(_: au_class_t) -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassnum(_ class_number: au_class_t) -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassnum(_ class_number: au_class_t) -> UnsafeMutablePointer<au_class_ent>! ``` |

Modified getauclassnum_r(_: UnsafeMutablePointer<au_class_ent_t>!, _: au_class_t) -> UnsafeMutablePointer<au_class_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauclassnum_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>, _ class_number: au_class_t) -> UnsafeMutablePointer<au_class_ent> ``` |
| To | ``` func getauclassnum_r(_ class_int: UnsafeMutablePointer<au_class_ent_t>!, _ class_number: au_class_t) -> UnsafeMutablePointer<au_class_ent>! ``` |
...
Modified getauditflagsbin(_: UnsafeMutablePointer<Int8>!, _: UnsafeMutablePointer<au_mask_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getauditflagsbin(_ auditstr: UnsafeMutablePointer<Int8>, _ masks: UnsafeMutablePointer<au_mask_t>) -> Int32 ``` |
| To | ``` func getauditflagsbin(_ auditstr: UnsafeMutablePointer<Int8>!, _ masks: UnsafeMutablePointer<au_mask_t>!) -> Int32 ``` |

Modified getauditflagschar(_: UnsafeMutablePointer<Int8>!, _: UnsafeMutablePointer<au_mask_t>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getauditflagschar(_ auditstr: UnsafeMutablePointer<Int8>, _ masks: UnsafeMutablePointer<au_mask_t>, _ verbose: Int32) -> Int32 ``` |
| To | ``` func getauditflagschar(_ auditstr: UnsafeMutablePointer<Int8>!, _ masks: UnsafeMutablePointer<au_mask_t>!, _ verbose: Int32) -> Int32 ``` |

Modified getauevent() -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevent() -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevent() -> UnsafeMutablePointer<au_event_ent>! ``` |

Modified getauevent_r(_: UnsafeMutablePointer<au_event_ent>!) -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevent_r(_ e: UnsafeMutablePointer<au_event_ent>) -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevent_r(_ e: UnsafeMutablePointer<au_event_ent>!) -> UnsafeMutablePointer<au_event_ent>! ``` |

Modified getauevnam(_: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnam(_ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevnam(_ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_ent>! ``` |

Modified getauevnam_r(_: UnsafeMutablePointer<au_event_ent>!, _: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnam_r(_ e: UnsafeMutablePointer<au_event_ent>, _ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevnam_r(_ e: UnsafeMutablePointer<au_event_ent>!, _ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_ent>! ``` |

Modified getauevnonam(_: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_t>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnonam(_ event_name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_event_t> ``` |
| To | ``` func getauevnonam(_ event_name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_t>! ``` |

Modified getauevnonam_r(_: UnsafeMutablePointer<au_event_t>!, _: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_t>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnonam_r(_ ev: UnsafeMutablePointer<au_event_t>, _ event_name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_event_t> ``` |
| To | ``` func getauevnonam_r(_ ev: UnsafeMutablePointer<au_event_t>!, _ event_name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_event_t>! ``` |

Modified getauevnum(_: au_event_t) -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnum(_ event_number: au_event_t) -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevnum(_ event_number: au_event_t) -> UnsafeMutablePointer<au_event_ent>! ``` |

Modified getauevnum_r(_: UnsafeMutablePointer<au_event_ent>!, _: au_event_t) -> UnsafeMutablePointer<au_event_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauevnum_r(_ e: UnsafeMutablePointer<au_event_ent>, _ event_number: au_event_t) -> UnsafeMutablePointer<au_event_ent> ``` |
| To | ``` func getauevnum_r(_ e: UnsafeMutablePointer<au_event_ent>!, _ event_number: au_event_t) -> UnsafeMutablePointer<au_event_ent>! ``` |
...
Modified getauuserent() -> UnsafeMutablePointer<au_user_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauuserent() -> UnsafeMutablePointer<au_user_ent> ``` |
| To | ``` func getauuserent() -> UnsafeMutablePointer<au_user_ent>! ``` |

Modified getauuserent_r(_: UnsafeMutablePointer<au_user_ent>!) -> UnsafeMutablePointer<au_user_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauuserent_r(_ u: UnsafeMutablePointer<au_user_ent>) -> UnsafeMutablePointer<au_user_ent> ``` |
| To | ``` func getauuserent_r(_ u: UnsafeMutablePointer<au_user_ent>!) -> UnsafeMutablePointer<au_user_ent>! ``` |

Modified getauusernam(_: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_user_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauusernam(_ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_user_ent> ``` |
| To | ``` func getauusernam(_ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_user_ent>! ``` |

Modified getauusernam_r(_: UnsafeMutablePointer<au_user_ent>!, _: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_user_ent>!

|  | Declaration |
| --- | --- |
| From | ``` func getauusernam_r(_ u: UnsafeMutablePointer<au_user_ent>, _ name: UnsafePointer<Int8>) -> UnsafeMutablePointer<au_user_ent> ``` |
| To | ``` func getauusernam_r(_ u: UnsafeMutablePointer<au_user_ent>!, _ name: UnsafePointer<Int8>!) -> UnsafeMutablePointer<au_user_ent>! ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getdirentriesattr(_ _: Int32, _ _: UnsafeMutablePointer<Void>, _ _: UnsafeMutablePointer<Void>, _ _: Int, _ _: UnsafeMutablePointer<UInt32>, _ _: UnsafeMutablePointer<UInt32>, _ _: UnsafeMutablePointer<UInt32>, _ _: UInt32) -> Int32 ``` |
...
Modified getfauditflags(_: UnsafeMutablePointer<au_mask_t>!, _: UnsafeMutablePointer<au_mask_t>!, _: UnsafeMutablePointer<au_mask_t>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func getfauditflags(_ usremask: UnsafeMutablePointer<au_mask_t>, _ usrdmask: UnsafeMutablePointer<au_mask_t>, _ lastmask: UnsafeMutablePointer<au_mask_t>) -> Int32 ``` |
| To | ``` func getfauditflags(_ usremask: UnsafeMutablePointer<au_mask_t>!, _ usrdmask: UnsafeMutablePointer<au_mask_t>!, _ lastmask: UnsafeMutablePointer<au_mask_t>!) -> Int32 ``` |
...
Modified gethostuuid(_: UnsafeMutablePointer<UInt8>!, _: UnsafePointer<timespec>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func gethostuuid(_ _: UnsafeMutablePointer<UInt8>, _ _: UnsafePointer<timespec>) -> Int32 ``` |
| To | ``` func gethostuuid(_ _: UnsafeMutablePointer<UInt8>!, _ _: UnsafePointer<timespec>!) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func getrpcbynumber(_ number: Int32) -> UnsafeMutablePointer<rpcent> ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias if_clone_t = COpaquePointer ``` |
| To | ``` typealias if_clone_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias ifaddr_t = COpaquePointer ``` |
| To | ``` typealias ifaddr_t = OpaquePointer ``` |

Modified ifmultiaddr_t

|  | Declaration |
| --- | --- |
| From | ``` typealias ifmultiaddr_t = COpaquePointer ``` |
| To | ``` typealias ifmultiaddr_t = OpaquePointer ``` |

Modified ifnet_t

|  | Declaration |
| --- | --- |
| From | ``` typealias ifnet_t = COpaquePointer ``` |
| To | ``` typealias ifnet_t = OpaquePointer ``` |
...
Modified interface_filter_t

|  | Declaration |
| --- | --- |
| From | ``` typealias interface_filter_t = COpaquePointer ``` |
| To | ``` typealias interface_filter_t = OpaquePointer ``` |
...
| To | ``` func iruserok(_ _: UInt, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func iruserok_sa(_ _: UnsafeRawPointer!, _ _: Int32, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!) -> Int32 ``` | OS X 10.12 |
...
Modified mach_approximate_time() -> UInt64
...
Modified mach_vm_allocate(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_address_t>!, _: mach_vm_size_t, _: Int32) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_allocate(_ target: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>, _ size: mach_vm_size_t, _ flags: Int32) -> kern_return_t ``` |
| To | ``` func mach_vm_allocate(_ target: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>!, _ size: mach_vm_size_t, _ flags: Int32) -> kern_return_t ``` |

Modified mach_vm_machine_attribute(_: vm_map_t, _: mach_vm_address_t, _: mach_vm_size_t, _: vm_machine_attribute_t, _: UnsafeMutablePointer<vm_machine_attribute_val_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_machine_attribute(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ attribute: vm_machine_attribute_t, _ value: UnsafeMutablePointer<vm_machine_attribute_val_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_machine_attribute(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ attribute: vm_machine_attribute_t, _ value: UnsafeMutablePointer<vm_machine_attribute_val_t>!) -> kern_return_t ``` |

Modified mach_vm_map(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_address_t>!, _: mach_vm_size_t, _: mach_vm_offset_t, _: Int32, _: mem_entry_name_port_t, _: memory_object_offset_t, _: boolean_t, _: vm_prot_t, _: vm_prot_t, _: vm_inherit_t) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_map(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>, _ size: mach_vm_size_t, _ mask: mach_vm_offset_t, _ flags: Int32, _ object: mem_entry_name_port_t, _ offset: memory_object_offset_t, _ copy: boolean_t, _ cur_protection: vm_prot_t, _ max_protection: vm_prot_t, _ inheritance: vm_inherit_t) -> kern_return_t ``` |
| To | ``` func mach_vm_map(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>!, _ size: mach_vm_size_t, _ mask: mach_vm_offset_t, _ flags: Int32, _ object: mem_entry_name_port_t, _ offset: memory_object_offset_t, _ copy: boolean_t, _ cur_protection: vm_prot_t, _ max_protection: vm_prot_t, _ inheritance: vm_inherit_t) -> kern_return_t ``` |

Modified mach_vm_page_info(_: vm_map_t, _: mach_vm_address_t, _: vm_page_info_flavor_t, _: vm_page_info_t!, _: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_page_info(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ flavor: vm_page_info_flavor_t, _ info: vm_page_info_t, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_page_info(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ flavor: vm_page_info_flavor_t, _ info: vm_page_info_t!, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t ``` |

Modified mach_vm_page_query(_: vm_map_t, _: mach_vm_offset_t, _: UnsafeMutablePointer<integer_t>!, _: UnsafeMutablePointer<integer_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_page_query(_ target_map: vm_map_t, _ offset: mach_vm_offset_t, _ disposition: UnsafeMutablePointer<integer_t>, _ ref_count: UnsafeMutablePointer<integer_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_page_query(_ target_map: vm_map_t, _ offset: mach_vm_offset_t, _ disposition: UnsafeMutablePointer<integer_t>!, _ ref_count: UnsafeMutablePointer<integer_t>!) -> kern_return_t ``` |

Modified mach_vm_purgable_control(_: vm_map_t, _: mach_vm_address_t, _: vm_purgable_t, _: UnsafeMutablePointer<Int32>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_purgable_control(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ control: vm_purgable_t, _ state: UnsafeMutablePointer<Int32>) -> kern_return_t ``` |
| To | ``` func mach_vm_purgable_control(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ control: vm_purgable_t, _ state: UnsafeMutablePointer<Int32>!) -> kern_return_t ``` |

Modified mach_vm_read(_: vm_map_t, _: mach_vm_address_t, _: mach_vm_size_t, _: UnsafeMutablePointer<vm_offset_t>!, _: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_read(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ data: UnsafeMutablePointer<vm_offset_t>, _ dataCnt: UnsafeMutablePointer<mach_msg_type_number_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_read(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ data: UnsafeMutablePointer<vm_offset_t>!, _ dataCnt: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t ``` |

Modified mach_vm_read_list(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_read_entry>!, _: natural_t) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_read_list(_ target_task: vm_map_t, _ data_list: UnsafeMutablePointer<mach_vm_read_entry>, _ count: natural_t) -> kern_return_t ``` |
| To | ``` func mach_vm_read_list(_ target_task: vm_map_t, _ data_list: UnsafeMutablePointer<mach_vm_read_entry>!, _ count: natural_t) -> kern_return_t ``` |

Modified mach_vm_read_overwrite(_: vm_map_t, _: mach_vm_address_t, _: mach_vm_size_t, _: mach_vm_address_t, _: UnsafeMutablePointer<mach_vm_size_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_read_overwrite(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ data: mach_vm_address_t, _ outsize: UnsafeMutablePointer<mach_vm_size_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_read_overwrite(_ target_task: vm_map_t, _ address: mach_vm_address_t, _ size: mach_vm_size_t, _ data: mach_vm_address_t, _ outsize: UnsafeMutablePointer<mach_vm_size_t>!) -> kern_return_t ``` |

Modified mach_vm_region(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_address_t>!, _: UnsafeMutablePointer<mach_vm_size_t>!, _: vm_region_flavor_t, _: vm_region_info_t!, _: UnsafeMutablePointer<mach_msg_type_number_t>!, _: UnsafeMutablePointer<mach_port_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_region(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>, _ size: UnsafeMutablePointer<mach_vm_size_t>, _ flavor: vm_region_flavor_t, _ info: vm_region_info_t, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>, _ object_name: UnsafeMutablePointer<mach_port_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_region(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>!, _ size: UnsafeMutablePointer<mach_vm_size_t>!, _ flavor: vm_region_flavor_t, _ info: vm_region_info_t!, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>!, _ object_name: UnsafeMutablePointer<mach_port_t>!) -> kern_return_t ``` |
...
Modified mach_vm_region_recurse(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_address_t>!, _: UnsafeMutablePointer<mach_vm_size_t>!, _: UnsafeMutablePointer<natural_t>!, _: vm_region_recurse_info_t!, _: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_region_recurse(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>, _ size: UnsafeMutablePointer<mach_vm_size_t>, _ nesting_depth: UnsafeMutablePointer<natural_t>, _ info: vm_region_recurse_info_t, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>) -> kern_return_t ``` |
| To | ``` func mach_vm_region_recurse(_ target_task: vm_map_t, _ address: UnsafeMutablePointer<mach_vm_address_t>!, _ size: UnsafeMutablePointer<mach_vm_size_t>!, _ nesting_depth: UnsafeMutablePointer<natural_t>!, _ info: vm_region_recurse_info_t!, _ infoCnt: UnsafeMutablePointer<mach_msg_type_number_t>!) -> kern_return_t ``` |

Modified mach_vm_remap(_: vm_map_t, _: UnsafeMutablePointer<mach_vm_address_t>!, _: mach_vm_size_t, _: mach_vm_offset_t, _: Int32, _: vm_map_t, _: mach_vm_address_t, _: boolean_t, _: UnsafeMutablePointer<vm_prot_t>!, _: UnsafeMutablePointer<vm_prot_t>!, _: vm_inherit_t) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func mach_vm_remap(_ target_task: vm_map_t, _ target_address: UnsafeMutablePointer<mach_vm_address_t>, _ size: mach_vm_size_t, _ mask: mach_vm_offset_t, _ flags: Int32, _ src_task: vm_map_t, _ src_address: mach_vm_address_t, _ copy: boolean_t, _ cur_protection: UnsafeMutablePointer<vm_prot_t>, _ max_protection: UnsafeMutablePointer<vm_prot_t>, _ inheritance: vm_inherit_t) -> kern_return_t ``` |
| To | ``` func mach_vm_remap(_ target_task: vm_map_t, _ target_address: UnsafeMutablePointer<mach_vm_address_t>!, _ size: mach_vm_size_t, _ mask: mach_vm_offset_t, _ flags: Int32, _ src_task: vm_map_t, _ src_address: mach_vm_address_t, _ copy: boolean_t, _ cur_protection: UnsafeMutablePointer<vm_prot_t>!, _ max_protection: UnsafeMutablePointer<vm_prot_t>!, _ inheritance: vm_inherit_t) -> kern_return_t ``` |
...
Modified map_fd(_: Int32, _: vm_offset_t, _: UnsafeMutablePointer<vm_offset_t>!, _: boolean_t, _: vm_size_t) -> kern_return_t

|  | Declaration |
| --- | --- |
| From | ``` func map_fd(_ fd: Int32, _ offset: vm_offset_t, _ addr: UnsafeMutablePointer<vm_offset_t>, _ find_space: boolean_t, _ numbytes: vm_size_t) -> kern_return_t ``` |
| To | ``` func map_fd(_ fd: Int32, _ offset: vm_offset_t, _ addr: UnsafeMutablePointer<vm_offset_t>!, _ find_space: boolean_t, _ numbytes: vm_size_t) -> kern_return_t ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias mbuf_t = COpaquePointer ``` |
| To | ``` typealias mbuf_t = OpaquePointer ``` |
...
Modified minphys(_: buf_t!) -> u_int

|  | Declaration |
| --- | --- |
| From | ``` func minphys(_ bp: buf_t) -> u_int ``` |
| To | ``` func minphys(_ bp: buf_t!) -> u_int ``` |
...
Modified modwatch(_: er_t!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func modwatch(_ _: er_t, _ _: Int32) -> Int32 ``` |
| To | ``` func modwatch(_ _: er_t!, _ _: Int32) -> Int32 ``` |
...
| To | ``` func OSAtomicAdd32(_ __theAmount: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAdd32Barrier(_ __theAmount: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAdd64(_ __theAmount: Int64, _ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAdd64Barrier(_ __theAmount: Int64, _ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAnd32(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAnd32Barrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAnd32Orig(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicAnd32OrigBarrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwap32(_ __oldValue: Int32, _ __newValue: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwap32Barrier(_ __oldValue: Int32, _ __newValue: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwap64(_ __oldValue: Int64, _ __newValue: Int64, _ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwap64Barrier(_ __oldValue: Int64, _ __newValue: Int64, _ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapInt(_ __oldValue: Int32, _ __newValue: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapIntBarrier(_ __oldValue: Int32, _ __newValue: Int32, _ __theValue: UnsafeMutablePointer<Int32>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapLong(_ __oldValue: Int, _ __newValue: Int, _ __theValue: UnsafeMutablePointer<Int>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapLongBarrier(_ __oldValue: Int, _ __newValue: Int, _ __theValue: UnsafeMutablePointer<Int>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapPtr(_ __oldValue: UnsafeMutableRawPointer!, _ __newValue: UnsafeMutableRawPointer!, _ __theValue: UnsafeMutablePointer<UnsafeMutableRawPointer?>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicCompareAndSwapPtrBarrier(_ __oldValue: UnsafeMutableRawPointer!, _ __newValue: UnsafeMutableRawPointer!, _ __theValue: UnsafeMutablePointer<UnsafeMutableRawPointer?>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicDecrement32(_ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicDecrement32Barrier(_ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicDecrement64(_ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicDecrement64Barrier(_ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
Modified OSAtomicFifoDequeue(_: OpaquePointer!, _: Int) -> UnsafeMutableRawPointer!

|  | Declaration |
| --- | --- |
| From | ``` func OSAtomicFifoDequeue(_ __list: COpaquePointer, _ __offset: Int) -> UnsafeMutablePointer<Void> ``` |
| To | ``` func OSAtomicFifoDequeue(_ __list: OpaquePointer!, _ __offset: Int) -> UnsafeMutableRawPointer! ``` |

Modified OSAtomicFifoEnqueue(_: OpaquePointer!, _: UnsafeMutableRawPointer!, _: Int)

|  | Declaration |
| --- | --- |
| From | ``` func OSAtomicFifoEnqueue(_ __list: COpaquePointer, _ __new: UnsafeMutablePointer<Void>, _ __offset: Int) ``` |
| To | ``` func OSAtomicFifoEnqueue(_ __list: OpaquePointer!, _ __new: UnsafeMutableRawPointer!, _ __offset: Int) ``` |
...
| To | ``` func OSAtomicIncrement32(_ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicIncrement32Barrier(_ __theValue: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicIncrement64(_ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicIncrement64Barrier(_ __theValue: UnsafeMutablePointer<OSAtomic_int64_aligned64_t>!) -> Int64 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicOr32(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicOr32Barrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicOr32Orig(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicOr32OrigBarrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicTestAndClear(_ __n: UInt32, _ __theAddress: UnsafeMutableRawPointer!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicTestAndClearBarrier(_ __n: UInt32, _ __theAddress: UnsafeMutableRawPointer!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicTestAndSet(_ __n: UInt32, _ __theAddress: UnsafeMutableRawPointer!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicTestAndSetBarrier(_ __n: UInt32, _ __theAddress: UnsafeMutableRawPointer!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSAtomicXor32(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicXor32Barrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicXor32Orig(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func OSAtomicXor32OrigBarrier(_ __theMask: UInt32, _ __theValue: UnsafeMutablePointer<UInt32>!) -> Int32 ``` | OS X 10.12 |
...
|  | Declaration |
| --- | --- |
| From | ``` func OSReadSwapInt16(_ base: UnsafePointer<Void>, _ byteOffset: UInt) -> UInt16 ``` |
| To | ``` func OSReadSwapInt16(_ base: UnsafeRawPointer!, _ byteOffset: UInt) -> UInt16 ``` |

Modified OSReadSwapInt32(_: UnsafeRawPointer!, _: UInt) -> UInt32

|  | Declaration |
| --- | --- |
| From | ``` func OSReadSwapInt32(_ base: UnsafePointer<Void>, _ byteOffset: UInt) -> UInt32 ``` |
| To | ``` func OSReadSwapInt32(_ base: UnsafeRawPointer!, _ byteOffset: UInt) -> UInt32 ``` |

Modified OSReadSwapInt64(_: UnsafeRawPointer!, _: UInt) -> UInt64

|  | Declaration |
| --- | --- |
| From | ``` func OSReadSwapInt64(_ base: UnsafePointer<Void>, _ byteOffset: UInt) -> UInt64 ``` |
| To | ``` func OSReadSwapInt64(_ base: UnsafeRawPointer!, _ byteOffset: UInt) -> UInt64 ``` |
...
| To | ``` func OSSpinLockLock(_ __lock: UnsafeMutablePointer<OSSpinLock>!) ``` | OS X 10.12 |
...
| To | ``` func OSSpinLockTry(_ __lock: UnsafeMutablePointer<OSSpinLock>!) -> Bool ``` | OS X 10.12 |
...
| To | ``` func OSSpinLockUnlock(_ __lock: UnsafeMutablePointer<OSSpinLock>!) ``` | OS X 10.12 |

Modified OSWriteSwapInt16(_: UnsafeMutableRawPointer!, _: UInt, _: UInt16)

|  | Declaration |
| --- | --- |
| From | ``` func OSWriteSwapInt16(_ base: UnsafeMutablePointer<Void>, _ byteOffset: UInt, _ data: UInt16) ``` |
| To | ``` func OSWriteSwapInt16(_ base: UnsafeMutableRawPointer!, _ byteOffset: UInt, _ data: UInt16) ``` |

Modified OSWriteSwapInt32(_: UnsafeMutableRawPointer!, _: UInt, _: UInt32)

|  | Declaration |
| --- | --- |
| From | ``` func OSWriteSwapInt32(_ base: UnsafeMutablePointer<Void>, _ byteOffset: UInt, _ data: UInt32) ``` |
| To | ``` func OSWriteSwapInt32(_ base: UnsafeMutableRawPointer!, _ byteOffset: UInt, _ data: UInt32) ``` |

Modified OSWriteSwapInt64(_: UnsafeMutableRawPointer!, _: UInt, _: UInt64)

|  | Declaration |
| --- | --- |
| From | ``` func OSWriteSwapInt64(_ base: UnsafeMutablePointer<Void>, _ byteOffset: UInt, _ data: UInt64) ``` |
| To | ``` func OSWriteSwapInt64(_ base: UnsafeMutableRawPointer!, _ byteOffset: UInt, _ data: UInt64) ``` |
...
Modified physio(_: ( (buf_t?) -> Swift.Void)!, _: buf_t!, _: dev_t, _: Int32, _: ( (buf_t?) -> u_int)!, _: OpaquePointer!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func physio(_ _: ((buf_t) -> Void)!, _ _: buf_t, _ _: dev_t, _ _: Int32, _ _: ((buf_t) -> u_int)!, _ _: COpaquePointer, _ _: Int32) -> Int32 ``` |
| To | ``` func physio(_ f_strategy: (@escaping (buf_t?) -> Swift.Void)!, _ bp: buf_t!, _ dev: dev_t, _ flags: Int32, _ f_minphys: (@escaping (buf_t?) -> u_int)!, _ uio: OpaquePointer!, _ blocksize: Int32) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias pkthdr_t = COpaquePointer ``` |
| To | ``` typealias pkthdr_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias proc_t = COpaquePointer ``` |
| To | ``` typealias proc_t = OpaquePointer ``` |
...
| To | ``` func rcmd(_ _: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!, _ _: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func rcmd_af(_ _: UnsafeMutablePointer<UnsafeMutablePointer<Int8>?>!, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!, _ _: UnsafeMutablePointer<Int32>!, _ _: Int32) -> Int32 ``` | OS X 10.12 |
...
Modified regcomp_l(_: UnsafeMutablePointer<regex_t>!, _: UnsafePointer<Int8>!, _: Int32, _: locale_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func regcomp_l(_ _: UnsafeMutablePointer<regex_t>, _ _: UnsafePointer<Int8>, _ _: Int32, _ _: locale_t) -> Int32 ``` |
| To | ``` func regcomp_l(_ _: UnsafeMutablePointer<regex_t>!, _ _: UnsafePointer<Int8>!, _ _: Int32, _ _: locale_t!) -> Int32 ``` |
...
Modified regncomp_l(_: UnsafeMutablePointer<regex_t>!, _: UnsafePointer<Int8>!, _: Int, _: Int32, _: locale_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func regncomp_l(_ _: UnsafeMutablePointer<regex_t>, _ _: UnsafePointer<Int8>, _ _: Int, _ _: Int32, _ _: locale_t) -> Int32 ``` |
| To | ``` func regncomp_l(_ _: UnsafeMutablePointer<regex_t>!, _ _: UnsafePointer<Int8>!, _ _: Int, _ _: Int32, _ _: locale_t!) -> Int32 ``` |
...
Modified regwcomp_l(_: UnsafeMutablePointer<regex_t>!, _: UnsafePointer<wchar_t>!, _: Int32, _: locale_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func regwcomp_l(_ _: UnsafeMutablePointer<regex_t>, _ _: UnsafePointer<wchar_t>, _ _: Int32, _ _: locale_t) -> Int32 ``` |
| To | ``` func regwcomp_l(_ _: UnsafeMutablePointer<regex_t>!, _ _: UnsafePointer<wchar_t>!, _ _: Int32, _ _: locale_t!) -> Int32 ``` |
...
Modified regwnexec_l(_: UnsafePointer<regex_t>!, _: UnsafePointer<wchar_t>!, _: Int, _: Int, _: UnsafeMutablePointer<regmatch_t>!, _: Int32, _: locale_t!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func regwnexec_l(_ _: UnsafePointer<regex_t>, _ _: UnsafePointer<wchar_t>, _ _: Int, _ _: Int, _ __pmatch: UnsafeMutablePointer<regmatch_t>, _ _: Int32, _ _: locale_t) -> Int32 ``` |
| To | ``` func regwnexec_l(_ _: UnsafePointer<regex_t>!, _ _: UnsafePointer<wchar_t>!, _ _: Int, _ _: Int, _ __pmatch: UnsafeMutablePointer<regmatch_t>!, _ _: Int32, _ _: locale_t!) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias route_t = COpaquePointer ``` |
| To | ``` typealias route_t = OpaquePointer ``` |
...
| To | ``` func rresvport(_ _: UnsafeMutablePointer<Int32>!) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func rresvport_af(_ _: UnsafeMutablePointer<Int32>!, _ _: Int32) -> Int32 ``` | OS X 10.12 |
...
| To | ``` func ruserok(_ _: UnsafePointer<Int8>!, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: UnsafePointer<Int8>!) -> Int32 ``` | OS X 10.12 |
...
Modified sbuf_bcat(_: UnsafeMutablePointer<sbuf>!, _: UnsafeRawPointer!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_bcat(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafePointer<Void>, _ _: Int) -> Int32 ``` |
| To | ``` func sbuf_bcat(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafeRawPointer!, _ _: Int) -> Int32 ``` |

Modified sbuf_bcpy(_: UnsafeMutablePointer<sbuf>!, _: UnsafeRawPointer!, _: Int) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_bcpy(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafePointer<Void>, _ _: Int) -> Int32 ``` |
| To | ``` func sbuf_bcpy(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafeRawPointer!, _ _: Int) -> Int32 ``` |

Modified sbuf_cat(_: UnsafeMutablePointer<sbuf>!, _: UnsafePointer<Int8>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_cat(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafePointer<Int8>) -> Int32 ``` |
| To | ``` func sbuf_cat(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafePointer<Int8>!) -> Int32 ``` |

Modified sbuf_clear(_: UnsafeMutablePointer<sbuf>!)

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_clear(_ _: UnsafeMutablePointer<sbuf>) ``` |
| To | ``` func sbuf_clear(_ _: UnsafeMutablePointer<sbuf>!) ``` |

Modified sbuf_cpy(_: UnsafeMutablePointer<sbuf>!, _: UnsafePointer<Int8>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_cpy(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafePointer<Int8>) -> Int32 ``` |
| To | ``` func sbuf_cpy(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafePointer<Int8>!) -> Int32 ``` |

Modified sbuf_data(_: UnsafeMutablePointer<sbuf>!) -> UnsafeMutablePointer<Int8>!

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_data(_ _: UnsafeMutablePointer<sbuf>) -> UnsafeMutablePointer<Int8> ``` |
| To | ``` func sbuf_data(_ _: UnsafeMutablePointer<sbuf>!) -> UnsafeMutablePointer<Int8>! ``` |

Modified sbuf_delete(_: UnsafeMutablePointer<sbuf>!)

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_delete(_ _: UnsafeMutablePointer<sbuf>) ``` |
| To | ``` func sbuf_delete(_ _: UnsafeMutablePointer<sbuf>!) ``` |

Modified sbuf_done(_: UnsafeMutablePointer<sbuf>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_done(_ _: UnsafeMutablePointer<sbuf>) -> Int32 ``` |
| To | ``` func sbuf_done(_ _: UnsafeMutablePointer<sbuf>!) -> Int32 ``` |

Modified sbuf_finish(_: UnsafeMutablePointer<sbuf>!)

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_finish(_ _: UnsafeMutablePointer<sbuf>) ``` |
| To | ``` func sbuf_finish(_ _: UnsafeMutablePointer<sbuf>!) ``` |

Modified sbuf_len(_: UnsafeMutablePointer<sbuf>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_len(_ _: UnsafeMutablePointer<sbuf>) -> Int32 ``` |
| To | ``` func sbuf_len(_ _: UnsafeMutablePointer<sbuf>!) -> Int32 ``` |

Modified sbuf_new(_: UnsafeMutablePointer<sbuf>!, _: UnsafeMutablePointer<Int8>!, _: Int32, _: Int32) -> UnsafeMutablePointer<sbuf>!

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_new(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafeMutablePointer<Int8>, _ _: Int32, _ _: Int32) -> UnsafeMutablePointer<sbuf> ``` |
| To | ``` func sbuf_new(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafeMutablePointer<Int8>!, _ _: Int32, _ _: Int32) -> UnsafeMutablePointer<sbuf>! ``` |

Modified sbuf_overflowed(_: UnsafeMutablePointer<sbuf>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_overflowed(_ _: UnsafeMutablePointer<sbuf>) -> Int32 ``` |
| To | ``` func sbuf_overflowed(_ _: UnsafeMutablePointer<sbuf>!) -> Int32 ``` |

Modified sbuf_putc(_: UnsafeMutablePointer<sbuf>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_putc(_ _: UnsafeMutablePointer<sbuf>, _ _: Int32) -> Int32 ``` |
| To | ``` func sbuf_putc(_ _: UnsafeMutablePointer<sbuf>!, _ _: Int32) -> Int32 ``` |

Modified sbuf_setpos(_: UnsafeMutablePointer<sbuf>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_setpos(_ _: UnsafeMutablePointer<sbuf>, _ _: Int32) -> Int32 ``` |
| To | ``` func sbuf_setpos(_ _: UnsafeMutablePointer<sbuf>!, _ _: Int32) -> Int32 ``` |

Modified sbuf_trim(_: UnsafeMutablePointer<sbuf>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_trim(_ _: UnsafeMutablePointer<sbuf>) -> Int32 ``` |
| To | ``` func sbuf_trim(_ _: UnsafeMutablePointer<sbuf>!) -> Int32 ``` |

Modified sbuf_vprintf(_: UnsafeMutablePointer<sbuf>!, _: UnsafePointer<Int8>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func sbuf_vprintf(_ _: UnsafeMutablePointer<sbuf>, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func sbuf_vprintf(_ _: UnsafeMutablePointer<sbuf>!, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func setattrlist(_ _: UnsafePointer<Int8>, _ _: UnsafeMutablePointer<Void>, _ _: UnsafeMutablePointer<Void>, _ _: Int, _ _: UInt32) -> Int32 ``` |
...
Modified shared_region_check_np(_: UnsafeMutablePointer<UInt64>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func shared_region_check_np(_ startaddress: UnsafeMutablePointer<UInt64>) -> Int32 ``` |
| To | ``` func shared_region_check_np(_ startaddress: UnsafeMutablePointer<UInt64>!) -> Int32 ``` |

Modified shared_region_map_np(_: Int32, _: UInt32, _: UnsafePointer<shared_file_mapping_np>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func shared_region_map_np(_ fd: Int32, _ mappingCount: UInt32, _ mappings: UnsafePointer<shared_file_mapping_np>) -> Int32 ``` |
| To | ``` func shared_region_map_np(_ fd: Int32, _ mappingCount: UInt32, _ mappings: UnsafePointer<shared_file_mapping_np>!) -> Int32 ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias socket_t = COpaquePointer ``` |
| To | ``` typealias socket_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias sockopt_t = COpaquePointer ``` |
| To | ``` typealias sockopt_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias uio_t = COpaquePointer ``` |
| To | ``` typealias uio_t = OpaquePointer ``` |
...
Modified verr(_: Int32, _: UnsafePointer<Int8>!, _: CVaListPointer) -> Never

|  | Declaration |
| --- | --- |
| From | ``` @noreturn func verr(_ _: Int32, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func verr(_ _: Int32, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) -> Never ``` |

Modified verrc(_: Int32, _: Int32, _: UnsafePointer<Int8>!, _: CVaListPointer) -> Never

|  | Declaration |
| --- | --- |
| From | ``` @noreturn func verrc(_ _: Int32, _ _: Int32, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func verrc(_ _: Int32, _ _: Int32, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) -> Never ``` |

Modified verrx(_: Int32, _: UnsafePointer<Int8>!, _: CVaListPointer) -> Never

|  | Declaration |
| --- | --- |
| From | ``` @noreturn func verrx(_ _: Int32, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func verrx(_ _: Int32, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) -> Never ``` |
...
Modified vfs_context_t

|  | Declaration |
| --- | --- |
| From | ``` typealias vfs_context_t = COpaquePointer ``` |
| To | ``` typealias vfs_context_t = OpaquePointer ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` typealias vfstable_t = COpaquePointer ``` |
| To | ``` typealias vfstable_t = OpaquePointer ``` |

Modified vfwprintf(_: UnsafeMutablePointer<FILE>!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vfwprintf(_ _: UnsafeMutablePointer<FILE>, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vfwprintf(_ _: UnsafeMutablePointer<FILE>!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vfwprintf_l(_: UnsafeMutablePointer<FILE>!, _: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vfwprintf_l(_ _: UnsafeMutablePointer<FILE>, _ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vfwprintf_l(_ _: UnsafeMutablePointer<FILE>!, _ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vfwscanf(_: UnsafeMutablePointer<FILE>!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vfwscanf(_ _: UnsafeMutablePointer<FILE>, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vfwscanf(_ _: UnsafeMutablePointer<FILE>!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vfwscanf_l(_: UnsafeMutablePointer<FILE>!, _: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vfwscanf_l(_ _: UnsafeMutablePointer<FILE>, _ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vfwscanf_l(_ _: UnsafeMutablePointer<FILE>!, _ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |
...
Modified vswprintf(_: UnsafeMutablePointer<wchar_t>!, _: Int, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vswprintf(_ _: UnsafeMutablePointer<wchar_t>, _ _: Int, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vswprintf(_ _: UnsafeMutablePointer<wchar_t>!, _ _: Int, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vswprintf_l(_: UnsafeMutablePointer<wchar_t>!, _: Int, _: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vswprintf_l(_ _: UnsafeMutablePointer<wchar_t>, _ n: Int, _ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vswprintf_l(_ _: UnsafeMutablePointer<wchar_t>!, _ n: Int, _ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vswscanf(_: UnsafePointer<wchar_t>!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vswscanf(_ _: UnsafePointer<wchar_t>, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vswscanf(_ _: UnsafePointer<wchar_t>!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vswscanf_l(_: UnsafePointer<wchar_t>!, _: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vswscanf_l(_ _: UnsafePointer<wchar_t>, _ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vswscanf_l(_ _: UnsafePointer<wchar_t>!, _ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vsyslog(_: Int32, _: UnsafePointer<Int8>!, _: CVaListPointer)

|  | Declaration |
| --- | --- |
| From | ``` func vsyslog(_ _: Int32, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func vsyslog(_ _: Int32, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) ``` |

Modified vwarn(_: UnsafePointer<Int8>!, _: CVaListPointer)

|  | Declaration |
| --- | --- |
| From | ``` func vwarn(_ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func vwarn(_ _: UnsafePointer<Int8>!, _ _: CVaListPointer) ``` |

Modified vwarnc(_: Int32, _: UnsafePointer<Int8>!, _: CVaListPointer)

|  | Declaration |
| --- | --- |
| From | ``` func vwarnc(_ _: Int32, _ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func vwarnc(_ _: Int32, _ _: UnsafePointer<Int8>!, _ _: CVaListPointer) ``` |

Modified vwarnx(_: UnsafePointer<Int8>!, _: CVaListPointer)

|  | Declaration |
| --- | --- |
| From | ``` func vwarnx(_ _: UnsafePointer<Int8>, _ _: CVaListPointer) ``` |
| To | ``` func vwarnx(_ _: UnsafePointer<Int8>!, _ _: CVaListPointer) ``` |

Modified vwprintf(_: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vwprintf(_ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vwprintf(_ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vwprintf_l(_: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vwprintf_l(_ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vwprintf_l(_ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vwscanf(_: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vwscanf(_ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vwscanf(_ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |

Modified vwscanf_l(_: locale_t!, _: UnsafePointer<wchar_t>!, _: CVaListPointer) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func vwscanf_l(_ _: locale_t, _ _: UnsafePointer<wchar_t>, _ _: CVaListPointer) -> Int32 ``` |
| To | ``` func vwscanf_l(_ _: locale_t!, _ _: UnsafePointer<wchar_t>!, _ _: CVaListPointer) -> Int32 ``` |
...
Modified waitevent(_: er_t!, _: UnsafeMutablePointer<timeval>!) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func waitevent(_ _: er_t, _ _: UnsafeMutablePointer<timeval>) -> Int32 ``` |
| To | ``` func waitevent(_ _: er_t!, _ _: UnsafeMutablePointer<timeval>!) -> Int32 ``` |
...
Modified watchevent(_: er_t!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func watchevent(_ _: er_t, _ _: Int32) -> Int32 ``` |
| To | ``` func watchevent(_ _: er_t!, _ _: Int32) -> Int32 ``` |
...
Modified wordexp(_: UnsafePointer<Int8>!, _: UnsafeMutablePointer<wordexp_t>!, _: Int32) -> Int32

|  | Declaration |
| --- | --- |
| From | ``` func wordexp(_ _: UnsafePointer<Int8>, _ _: UnsafeMutablePointer<wordexp_t>, _ _: Int32) -> Int32 ``` |
| To | ``` func wordexp(_ _: UnsafePointer<Int8>!, _ _: UnsafeMutablePointer<wordexp_t>!, _ _: Int32) -> Int32 ``` |

Modified wordfree(_: UnsafeMutablePointer<wordexp_t>!)

|  | Declaration |
| --- | --- |
| From | ``` func wordfree(_ _: UnsafeMutablePointer<wordexp_t>) ``` |
| To | ``` func wordfree(_ _: UnsafeMutablePointer<wordexp_t>!) ``` |
