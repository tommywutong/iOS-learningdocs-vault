...
source_url: https://developer.apple.com/library/archive/releasenotes/General/iOS81APIDiffs/modules/HomeKit.html
archived_at: '2026-07-18T02:56:13.733654Z'
---
...
Modified HMCharacteristicWriteAction.init(characteristic: HMCharacteristic!, targetValue: AnyObject!)

|  | Declaration |
| --- | --- |
| From | ``` init(characteristic characteristic: HMCharacteristic!, targetValue targetValue: AnyObject!) ``` |
| To | ``` init!(characteristic characteristic: HMCharacteristic!, targetValue targetValue: AnyObject!) ``` |

Modified HMTimerTrigger.init(name: String!, fireDate: NSDate!, timeZone: NSTimeZone!, recurrence: NSDateComponents!, recurrenceCalendar: NSCalendar!)
