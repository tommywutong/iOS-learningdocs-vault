...
source_url: https://developer.apple.com/library/archive/releasenotes/General/watchOS30APIDiffs/Swift/EventKit.html
archived_at: '2026-07-18T02:58:23.936515Z'
---
...
Modified [EKCalendarItem.uuid](https://developer.apple.com/documentation/eventkit/ekcalendaritem/1623897-uuid)

|  | Declaration |
| --- | --- |
| From | ``` var UUID: String { get } ``` |
| To | ``` var uuid: String { get } ``` |
...
| --- | --- | --- |
| From | ``` case DatesInverted ``` | watchOS 2.0 |
| To | ``` case datesInverted ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case DurationGreaterThanRecurrence ``` | watchOS 2.0 |
| To | ``` case durationGreaterThanRecurrence ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case InvalidSpan ``` | watchOS 2.0 |
| To | ``` case invalidSpan ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case RecurringReminderRequiresDueDate ``` | watchOS 2.0 |
| To | ``` case recurringReminderRequiresDueDate ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case ReminderLocationsNotSupported ``` | watchOS 2.0 |
| To | ``` case reminderLocationsNotSupported ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case StructuredLocationsNotSupported ``` | watchOS 2.0 |
| To | ``` case structuredLocationsNotSupported ``` | watchOS 3.0 |
...
|  | Declaration |
| --- | --- |
| From | ``` class EKParticipant : EKObject, NSCopying {     var URL: NSURL { get }     var name: String? { get }     var participantStatus: EKParticipantStatus { get }     var participantRole: EKParticipantRole { get }     var participantType: EKParticipantType { get }     var currentUser: Bool { get }     var contactPredicate: NSPredicate { get } } ``` |
| To | ``` class EKParticipant : EKObject, NSCopying {     var url: URL { get }     var name: String? { get }     var participantStatus: EKParticipantStatus { get }     var participantRole: EKParticipantRole { get }     var participantType: EKParticipantType { get }     var isCurrentUser: Bool { get }     var contactPredicate: NSPredicate { get } } ``` |
