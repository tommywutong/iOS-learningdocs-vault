...
source_url: https://developer.apple.com/library/archive/releasenotes/General/watchOS30APIDiffs/Swift/Contacts.html
archived_at: '2026-07-18T02:58:17.224068Z'
---
...
| --- | --- | --- |
| From | ``` case InsertedRecordAlreadyExists ``` | watchOS 2.0 |
| To | ``` case insertedRecordAlreadyExists ``` | watchOS 3.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case ValidationTypeMismatch ``` | watchOS 2.0 |
| To | ``` case validationTypeMismatch ``` | watchOS 3.0 |
