...
source_url: https://developer.apple.com/library/archive/releasenotes/General/watchOS30APIDiffs/Swift/CoreFoundation.html
archived_at: '2026-07-18T02:58:18.230411Z'
---
...
Modified [CFURLBookmarkCreationOptions.preferFileIDResolutionMask](https://developer.apple.com/documentation/corefoundation/cfurlbookmarkcreationoptions/1584383-preferfileidresolutionmask)

|  | Declaration |
| --- | --- |
| From | ``` static var PreferFileIDResolutionMask: CFURLBookmarkCreationOptions { get } ``` |
| To | ``` static var preferFileIDResolutionMask: CFURLBookmarkCreationOptions { get } ``` |
...
Modified [CFURLError [enum]](https://developer.apple.com/documentation/corefoundation/cfurlerror)

|  | Declaration |
| --- | --- |
| From | ``` enum CFURLError : CFIndex {     case UnknownError     case UnknownSchemeError     case ResourceNotFoundError     case ResourceAccessViolationError     case RemoteHostUnavailableError     case ImproperArgumentsError     case UnknownPropertyKeyError     case PropertyKeyUnavailableError     case TimeoutError } ``` |
| To | ``` enum CFURLError : CFIndex {     case unknownError     case unknownSchemeError     case resourceNotFoundError     case resourceAccessViolationError     case remoteHostUnavailableError     case improperArgumentsError     case unknownPropertyKeyError     case propertyKeyUnavailableError     case timeoutError } ``` |

Modified [CFURLError.improperArgumentsError](https://developer.apple.com/documentation/corefoundation/cfurlerror/improperargumentserror)

|  | Declaration |
| --- | --- |
| From | ``` case ImproperArgumentsError ``` |
| To | ``` case improperArgumentsError ``` |

Modified [CFURLError.propertyKeyUnavailableError](https://developer.apple.com/documentation/corefoundation/cfurlerror/propertykeyunavailableerror)

|  | Declaration |
| --- | --- |
| From | ``` case PropertyKeyUnavailableError ``` |
| To | ``` case propertyKeyUnavailableError ``` |

Modified [CFURLError.remoteHostUnavailableError](https://developer.apple.com/documentation/corefoundation/cfurlerror/kcfurlremotehostunavailableerror)

|  | Declaration |
| --- | --- |
| From | ``` case RemoteHostUnavailableError ``` |
| To | ``` case remoteHostUnavailableError ``` |

Modified [CFURLError.resourceAccessViolationError](https://developer.apple.com/documentation/corefoundation/cfurlerror/resourceaccessviolationerror)

|  | Declaration |
| --- | --- |
| From | ``` case ResourceAccessViolationError ``` |
| To | ``` case resourceAccessViolationError ``` |

Modified [CFURLError.resourceNotFoundError](https://developer.apple.com/documentation/corefoundation/cfurlerror/resourcenotfounderror)

|  | Declaration |
| --- | --- |
| From | ``` case ResourceNotFoundError ``` |
| To | ``` case resourceNotFoundError ``` |

Modified [CFURLError.timeoutError](https://developer.apple.com/documentation/corefoundation/cfurlerror/timeouterror)

|  | Declaration |
| --- | --- |
| From | ``` case TimeoutError ``` |
| To | ``` case timeoutError ``` |

Modified [CFURLError.unknownError](https://developer.apple.com/documentation/corefoundation/cfurlerror/unknownerror)
...
Modified [CFURLError.unknownPropertyKeyError](https://developer.apple.com/documentation/corefoundation/cfurlerror/unknownpropertykeyerror)

|  | Declaration |
| --- | --- |
| From | ``` case UnknownPropertyKeyError ``` |
| To | ``` case unknownPropertyKeyError ``` |

Modified [CFURLError.unknownSchemeError](https://developer.apple.com/documentation/corefoundation/cfurlerror/unknownschemeerror)

|  | Declaration |
| --- | --- |
| From | ``` case UnknownSchemeError ``` |
| To | ``` case unknownSchemeError ``` |
...
Modified [CFURLPathStyle.cfurlhfsPathStyle](https://developer.apple.com/documentation/corefoundation/cfurlpathstyle/cfurlhfspathstyle)

|  | Declaration |
| --- | --- |
| From | ``` case CFURLHFSPathStyle ``` |
| To | ``` case cfurlhfsPathStyle ``` |
...
Modified [CFPreferencesCopyApplicationList(_: CFString, _: CFString) -> CFArray?](https://developer.apple.com/documentation/corefoundation/1515523-cfpreferencescopyapplicationlist)

|  | Declaration |
| --- | --- |
| From | ``` func CFPreferencesCopyApplicationList(_ userName: CFString!, _ hostName: CFString!) -> CFArray! ``` |
| To | ``` func CFPreferencesCopyApplicationList(_ userName: CFString, _ hostName: CFString) -> CFArray? ``` |
...
Modified [CFURLCreateDataAndPropertiesFromResource(_: CFAllocator!, _: CFURL!, _: UnsafeMutablePointer<Unmanaged<CFData>?>!, _: UnsafeMutablePointer<Unmanaged<CFDictionary>?>!, _: CFArray!, _: UnsafeMutablePointer<Int32>!) -> Bool](https://developer.apple.com/documentation/corefoundation/1420742-cfurlcreatedataandpropertiesfrom)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLCreateDataAndPropertiesFromResource(_ alloc: CFAllocator!, _ url: CFURL!, _ resourceData: UnsafeMutablePointer<Unmanaged<CFData>?>, _ properties: UnsafeMutablePointer<Unmanaged<CFDictionary>?>, _ desiredProperties: CFArray!, _ errorCode: UnsafeMutablePointer<Int32>) -> Bool ``` |
| To | ``` func CFURLCreateDataAndPropertiesFromResource(_ alloc: CFAllocator!, _ url: CFURL!, _ resourceData: UnsafeMutablePointer<Unmanaged<CFData>?>!, _ properties: UnsafeMutablePointer<Unmanaged<CFDictionary>?>!, _ desiredProperties: CFArray!, _ errorCode: UnsafeMutablePointer<Int32>!) -> Bool ``` |
...
Modified [CFURLCreateFromFSRef(_: CFAllocator!, _: OpaquePointer!) -> CFURL!](https://developer.apple.com/documentation/corefoundation/1584385-cfurlcreatefromfsref)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLCreateFromFSRef(_ allocator: CFAllocator!, _ fsRef: COpaquePointer) -> CFURL! ``` |
| To | ``` func CFURLCreateFromFSRef(_ allocator: CFAllocator!, _ fsRef: OpaquePointer!) -> CFURL! ``` |

Modified [CFURLCreatePropertyFromResource(_: CFAllocator!, _: CFURL!, _: CFString!, _: UnsafeMutablePointer<Int32>!) -> CFTypeRef!](https://developer.apple.com/documentation/corefoundation/1420715-cfurlcreatepropertyfromresource)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLCreatePropertyFromResource(_ alloc: CFAllocator!, _ url: CFURL!, _ property: CFString!, _ errorCode: UnsafeMutablePointer<Int32>) -> AnyObject! ``` |
| To | ``` func CFURLCreatePropertyFromResource(_ alloc: CFAllocator!, _ url: CFURL!, _ property: CFString!, _ errorCode: UnsafeMutablePointer<Int32>!) -> CFTypeRef! ``` |
...
Modified [CFURLDestroyResource(_: CFURL!, _: UnsafeMutablePointer<Int32>!) -> Bool](https://developer.apple.com/documentation/corefoundation/1420709-cfurldestroyresource)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLDestroyResource(_ url: CFURL!, _ errorCode: UnsafeMutablePointer<Int32>) -> Bool ``` |
| To | ``` func CFURLDestroyResource(_ url: CFURL!, _ errorCode: UnsafeMutablePointer<Int32>!) -> Bool ``` |
...
Modified [CFURLGetFSRef(_: CFURL!, _: OpaquePointer!) -> Bool](https://developer.apple.com/documentation/corefoundation/1584387-cfurlgetfsref)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLGetFSRef(_ url: CFURL!, _ fsRef: COpaquePointer) -> Bool ``` |
| To | ``` func CFURLGetFSRef(_ url: CFURL!, _ fsRef: OpaquePointer!) -> Bool ``` |
...
Modified [CFURLWriteDataAndPropertiesToResource(_: CFURL!, _: CFData!, _: CFDictionary!, _: UnsafeMutablePointer<Int32>!) -> Bool](https://developer.apple.com/documentation/corefoundation/1420723-cfurlwritedataandpropertiestores)

|  | Declaration |
| --- | --- |
| From | ``` func CFURLWriteDataAndPropertiesToResource(_ url: CFURL!, _ dataToWrite: CFData!, _ propertiesToWrite: CFDictionary!, _ errorCode: UnsafeMutablePointer<Int32>) -> Bool ``` |
| To | ``` func CFURLWriteDataAndPropertiesToResource(_ url: CFURL!, _ dataToWrite: CFData!, _ propertiesToWrite: CFDictionary!, _ errorCode: UnsafeMutablePointer<Int32>!) -> Bool ``` |
