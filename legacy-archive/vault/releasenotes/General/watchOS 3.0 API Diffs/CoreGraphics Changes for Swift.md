...
source_url: https://developer.apple.com/library/archive/releasenotes/General/watchOS30APIDiffs/Swift/CoreGraphics.html
archived_at: '2026-07-18T02:58:19.488995Z'
---
...
| --- | --- | --- | --- | --- |
| From | CGColorSpaceCopyICCProfile(_:) | ``` func CGColorSpaceCopyICCProfile(_ space: CGColorSpace?) -> CFData? ``` | watchOS 2.0 | -- |
| To | iccData | ``` var iccData: CFData? { get } ``` | watchOS 3.0 | yes |
...
Modified [CGContext.selectFont(name: UnsafePointer<Int8>, size: CGFloat, textEncoding: CGTextEncoding)](https://developer.apple.com/documentation/coregraphics/cgcontext/1586511-selectfont)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextSelectFont(_:_:_:_:) | ``` func CGContextSelectFont(_ c: CGContext?, _ name: UnsafePointer<Int8>, _ size: CGFloat, _ textEncoding: CGTextEncoding) ``` |
| To | selectFont(name:size:textEncoding:) | ``` func selectFont(name name: UnsafePointer<Int8>, size size: CGFloat, textEncoding textEncoding: CGTextEncoding) ``` |
...
Modified [CGContext.showGlyphs(g: UnsafePointer<CGGlyph>?, count: Int)](https://developer.apple.com/documentation/coregraphics/1586500-cgcontextshowglyphs)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextShowGlyphs(_:_:_:) | ``` func CGContextShowGlyphs(_ c: CGContext?, _ g: UnsafePointer<CGGlyph>, _ count: Int) ``` |
| To | showGlyphs(g:count:) | ``` func showGlyphs(g g: UnsafePointer<CGGlyph>?, count count: Int) ``` |

Modified [CGContext.showGlyphsAtPoint(x: CGFloat, y: CGFloat, glyphs: UnsafePointer<CGGlyph>?, count: Int)](https://developer.apple.com/documentation/coregraphics/1586502-cgcontextshowglyphsatpoint)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextShowGlyphsAtPoint(_:_:_:_:_:) | ``` func CGContextShowGlyphsAtPoint(_ c: CGContext?, _ x: CGFloat, _ y: CGFloat, _ glyphs: UnsafePointer<CGGlyph>, _ count: Int) ``` |
| To | showGlyphsAtPoint(x:y:glyphs:count:) | ``` func showGlyphsAtPoint(x x: CGFloat, y y: CGFloat, glyphs glyphs: UnsafePointer<CGGlyph>?, count count: Int) ``` |

Modified [CGContext.showGlyphsWithAdvances(glyphs: UnsafePointer<CGGlyph>?, advances: UnsafePointer<CGSize>?, count: Int)](https://developer.apple.com/documentation/coregraphics/cgcontext/1586503-showglyphswithadvances)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextShowGlyphsWithAdvances(_:_:_:_:) | ``` func CGContextShowGlyphsWithAdvances(_ c: CGContext?, _ glyphs: UnsafePointer<CGGlyph>, _ advances: UnsafePointer<CGSize>, _ count: Int) ``` |
| To | showGlyphsWithAdvances(glyphs:advances:count:) | ``` func showGlyphsWithAdvances(glyphs glyphs: UnsafePointer<CGGlyph>?, advances advances: UnsafePointer<CGSize>?, count count: Int) ``` |

Modified [CGContext.showText(string: UnsafePointer<Int8>, length: Int)](https://developer.apple.com/documentation/coregraphics/1586507-cgcontextshowtext)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextShowText(_:_:_:) | ``` func CGContextShowText(_ c: CGContext?, _ string: UnsafePointer<Int8>, _ length: Int) ``` |
| To | showText(string:length:) | ``` func showText(string string: UnsafePointer<Int8>, length length: Int) ``` |

Modified [CGContext.showTextAtPoint(x: CGFloat, y: CGFloat, string: UnsafePointer<Int8>, length: Int)](https://developer.apple.com/documentation/coregraphics/1586505-cgcontextshowtextatpoint)

|  | Name | Declaration |
| --- | --- | --- |
| From | CGContextShowTextAtPoint(_:_:_:_:_:) | ``` func CGContextShowTextAtPoint(_ c: CGContext?, _ x: CGFloat, _ y: CGFloat, _ string: UnsafePointer<Int8>, _ length: Int) ``` |
| To | showTextAtPoint(x:y:string:length:) | ``` func showTextAtPoint(x x: CGFloat, y y: CGFloat, string string: UnsafePointer<Int8>, length length: Int) ``` |
...
Modified [CGFloat.init(floatLiteral: CGFloat.NativeType)](https://developer.apple.com/documentation/coregraphics/cgfloat/1627945-init)
...
Modified [CGFloat.native](https://developer.apple.com/documentation/coregraphics/cgfloat/1627888-native)
...
|  | Declaration |
| --- | --- |
| From | ``` enum CGTextEncoding : Int32 {     case EncodingFontSpecific     case EncodingMacRoman } ``` |
| To | ``` enum CGTextEncoding : Int32 {     case encodingFontSpecific     case encodingMacRoman } ``` |

Modified [CGTextEncoding.encodingFontSpecific](https://developer.apple.com/documentation/coregraphics/cgtextencoding/kcgencodingfontspecific)

|  | Declaration |
| --- | --- |
| From | ``` case EncodingFontSpecific ``` |
| To | ``` case encodingFontSpecific ``` |

Modified [CGTextEncoding.encodingMacRoman](https://developer.apple.com/documentation/coregraphics/cgtextencoding/kcgencodingmacroman)

|  | Declaration |
| --- | --- |
| From | ``` case EncodingMacRoman ``` |
| To | ``` case encodingMacRoman ``` |
