...
source_url: https://developer.apple.com/library/archive/releasenotes/General/watchOS30APIDiffs/Swift/MachO.html
archived_at: '2026-07-18T02:58:31.160691Z'
---
...
| To | ``` var reserved: (UInt, UInt, UInt, UInt) ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` var ptr: UnsafeMutablePointer<Int8> ``` |
| To | ``` var ptr: UnsafeMutablePointer<Int8>! ``` |
...
| To | ``` func getsectbyname(_ segname: UnsafePointer<Int8>!, _ sectname: UnsafePointer<Int8>!) -> UnsafePointer<section>! ``` |
...
| To | ``` func getsectiondata(_ mhp: UnsafePointer<mach_header>!, _ segname: UnsafePointer<Int8>!, _ sectname: UnsafePointer<Int8>!, _ size: UnsafeMutablePointer<UInt>!) -> UnsafeMutablePointer<UInt8>! ``` |
...
| To | ``` func getsegbyname(_ segname: UnsafePointer<Int8>!) -> UnsafePointer<segment_command>! ``` |
...
| To | ``` func getsegmentdata(_ mhp: UnsafePointer<mach_header>!, _ segname: UnsafePointer<Int8>!, _ size: UnsafeMutablePointer<UInt>!) -> UnsafeMutablePointer<UInt8>! ``` |
