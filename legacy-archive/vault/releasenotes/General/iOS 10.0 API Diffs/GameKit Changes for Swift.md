...
source_url: https://developer.apple.com/library/archive/releasenotes/General/iOS10APIDiffs/Swift/GameKit.html
archived_at: '2026-07-18T02:55:27.209945Z'
---
...
Modified [GKAchievement.challengeComposeController(withPlayers: [String]?, message: String?, completionHandler: GameKit.GKChallengeComposeCompletionBlock?) -> UIViewController?](https://developer.apple.com/documentation/gamekit/gkachievement/1623556-challengecomposecontroller)

|  | Declaration |
| --- | --- |
| From | ``` func challengeComposeControllerWithPlayers(_ playerIDs: [String]?, message message: String?, completionHandler completionHandler: GKChallengeComposeCompletionBlock?) -> UIViewController? ``` |
| To | ``` func challengeComposeController(withPlayers playerIDs: [String]?, message message: String?, completionHandler completionHandler: GameKit.GKChallengeComposeCompletionBlock? = nil) -> UIViewController? ``` |
...
| --- | --- | --- |
| From | ``` case InvalidParameter ``` | iOS 8.0 |
| To | ``` case invalidParameter ``` | iOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case PlayerStatusInvalid ``` | iOS 8.0 |
| To | ``` case playerStatusInvalid ``` | iOS 10.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` case TurnBasedInvalidParticipant ``` | iOS 8.0 |
| To | ``` case turnBasedInvalidParticipant ``` | iOS 10.0 |
...
| To | ``` func addRecipients(withEmailAddresses emailAddresses: [String]) ``` | iOS 10.0 |
...
| To | ``` func loadFriendPlayers(completionHandler completionHandler: (@escaping ([GKPlayer]?, Error?) -> Swift.Void)? = nil) ``` | iOS 10.0 |
...
Modified [GKMatchDelegate.match(_: GKMatch, player: String, didChange: GKPlayerConnectionState)](https://developer.apple.com/documentation/gamekit/gkmatchdelegate/1502028-match)

|  | Declaration |
| --- | --- |
| From | ``` optional func match(_ match: GKMatch, player playerID: String, didChangeState state: GKPlayerConnectionState) ``` |
| To | ``` optional func match(_ match: GKMatch, player playerID: String, didChange state: GKPlayerConnectionState) ``` |
...
| To | ``` protocol GKPeerPickerControllerDelegate : NSObjectProtocol {     optional func peerPickerController(_ picker: GKPeerPickerController, didSelect type: GKPeerPickerConnectionType)     optional func peerPickerController(_ picker: GKPeerPickerController, sessionFor type: GKPeerPickerConnectionType) -> GKSession     optional func peerPickerController(_ picker: GKPeerPickerController, didConnectPeer peerID: String, to session: GKSession)     optional func peerPickerControllerDidCancel(_ picker: GKPeerPickerController) } ``` |

Modified [GKPeerPickerControllerDelegate.peerPickerController(_: GKPeerPickerController, didConnectPeer: String, to: GKSession)](https://developer.apple.com/documentation/gamekit/gkpeerpickercontrollerdelegate/1622153-peerpickercontroller)

|  | Declaration |
| --- | --- |
| From | ``` optional func peerPickerController(_ picker: GKPeerPickerController, didConnectPeer peerID: String, toSession session: GKSession) ``` |
| To | ``` optional func peerPickerController(_ picker: GKPeerPickerController, didConnectPeer peerID: String, to session: GKSession) ``` |

Modified [GKPeerPickerControllerDelegate.peerPickerController(_: GKPeerPickerController, didSelect: GKPeerPickerConnectionType)](https://developer.apple.com/documentation/gamekit/gkpeerpickercontrollerdelegate/1622163-peerpickercontroller)

|  | Declaration |
| --- | --- |
| From | ``` optional func peerPickerController(_ picker: GKPeerPickerController, didSelectConnectionType type: GKPeerPickerConnectionType) ``` |
| To | ``` optional func peerPickerController(_ picker: GKPeerPickerController, didSelect type: GKPeerPickerConnectionType) ``` |

Modified [GKPeerPickerControllerDelegate.peerPickerController(_: GKPeerPickerController, sessionFor: GKPeerPickerConnectionType) -> GKSession](https://developer.apple.com/documentation/gamekit/gkpeerpickercontrollerdelegate/1622156-peerpickercontroller)

|  | Declaration |
| --- | --- |
| From | ``` optional func peerPickerController(_ picker: GKPeerPickerController, sessionForConnectionType type: GKPeerPickerConnectionType) -> GKSession ``` |
| To | ``` optional func peerPickerController(_ picker: GKPeerPickerController, sessionFor type: GKPeerPickerConnectionType) -> GKSession ``` |
...
Modified [GKScore.challengeComposeController(withPlayers: [String]?, message: String?, completionHandler: GameKit.GKChallengeComposeCompletionBlock?) -> UIViewController?](https://developer.apple.com/documentation/gamekit/gkscore/1623555-challengecomposecontroller)
