...
source_url: https://developer.apple.com/library/archive/releasenotes/General/iOS10APIDiffs/Swift/Security.html
archived_at: '2026-07-18T02:55:38.179963Z'
---
...
Modified [SecAddSharedWebCredential(_: CFString, _: CFString, _: CFString?, _: (CFError?) -> Swift.Void)](https://developer.apple.com/documentation/security/1617986-secaddsharedwebcredential)
...
| To | ``` func SecAddSharedWebCredential(_ fqdn: CFString, _ account: CFString, _ password: CFString?, _ completionHandler: @escaping (CFError?) -> Swift.Void) ``` |
...
Modified [SecRequestSharedWebCredential(_: CFString?, _: CFString?, _: (CFArray?, CFError?) -> Swift.Void)](https://developer.apple.com/documentation/security/1617896-secrequestsharedwebcredential)

|  | Declaration |
| --- | --- |
| From | ``` func SecRequestSharedWebCredential(_ fqdn: CFString?, _ account: CFString?, _ completionHandler: (CFArray?, CFError?) -> Void) ``` |
| To | ``` func SecRequestSharedWebCredential(_ fqdn: CFString?, _ account: CFString?, _ completionHandler: @escaping (CFArray?, CFError?) -> Swift.Void) ``` |
