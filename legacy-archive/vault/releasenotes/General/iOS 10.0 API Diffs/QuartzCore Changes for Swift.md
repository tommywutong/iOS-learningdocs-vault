...
source_url: https://developer.apple.com/library/archive/releasenotes/General/iOS10APIDiffs/Swift/QuartzCore.html
archived_at: '2026-07-18T02:55:36.797481Z'
---
...
| --- | --- | --- |
| From | ``` class CABasicAnimation : CAPropertyAnimation {     var fromValue: AnyObject?     var toValue: AnyObject?     var byValue: AnyObject? } ``` | iOS 8.0 |
| To | ``` class CABasicAnimation : CAPropertyAnimation {     var fromValue: Any?     var toValue: Any?     var byValue: Any? } ``` | iOS 2.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` class CAKeyframeAnimation : CAPropertyAnimation {     var values: [AnyObject]?     var path: CGPath?     var keyTimes: [NSNumber]?     var timingFunctions: [CAMediaTimingFunction]?     var calculationMode: String     var tensionValues: [NSNumber]?     var continuityValues: [NSNumber]?     var biasValues: [NSNumber]?     var rotationMode: String? } ``` | iOS 8.0 |
| To | ``` class CAKeyframeAnimation : CAPropertyAnimation {     var values: [Any]?     var path: CGPath?     var keyTimes: [NSNumber]?     var timingFunctions: [CAMediaTimingFunction]?     var calculationMode: String     var tensionValues: [NSNumber]?     var continuityValues: [NSNumber]?     var biasValues: [NSNumber]?     var rotationMode: String? } ``` | iOS 2.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` class CAPropertyAnimation : CAAnimation {     convenience init(keyPath path: String?)     class func animationWithKeyPath(_ path: String?) -> Self     var keyPath: String?     var additive: Bool     var cumulative: Bool     var valueFunction: CAValueFunction? } ``` | iOS 8.0 |
| To | ``` class CAPropertyAnimation : CAAnimation {     convenience init(keyPath path: String?)     class func withKeyPath(_ path: String?) -> Self     var keyPath: String?     var isAdditive: Bool     var isCumulative: Bool     var valueFunction: CAValueFunction? } ``` | iOS 2.0 |
...
|  | Declaration | Protocols | Introduction |
| --- | --- | --- | --- |
| From | ``` class CATextLayer : CALayer {     @NSCopying var string: AnyObject?     var font: AnyObject?     var fontSize: CGFloat     var foregroundColor: CGColor?     var wrapped: Bool     var truncationMode: String     var alignmentMode: String     var allowsFontSubpixelQuantization: Bool } ``` | -- | iOS 8.0 |
...
|  | Declaration | Protocols | Introduction |
| --- | --- | --- | --- |
| From | ``` class CATiledLayer : CALayer {     class func fadeDuration() -> CFTimeInterval     var levelsOfDetail: Int     var levelsOfDetailBias: Int     var tileSize: CGSize } ``` | -- | iOS 8.0 |
...
|  | Declaration | Protocols | Introduction |
| --- | --- | --- | --- |
| From | ``` class CATransformLayer : CALayer { } ``` | -- | iOS 8.0 |
...
|  | Declaration | Introduction |
| --- | --- | --- |
| From | ``` class CATransition : CAAnimation {     var type: String     var subtype: String?     var startProgress: Float     var endProgress: Float     var filter: AnyObject? } ``` | iOS 8.0 |
| To | ``` class CATransition : CAAnimation {     var type: String     var subtype: String?     var startProgress: Float     var endProgress: Float     var filter: Any? } ``` | iOS 2.0 |
