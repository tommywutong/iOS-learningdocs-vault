...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12_1/Swift/QuickLook.html
archived_at: '2026-07-18T02:51:47.272143Z'
---
...
|  | Declaration |
| --- | --- |
| From | ``` func QLThumbnailDispatchAsync(_ thumbnail: QLThumbnail!, _ queue: DispatchQueue!, _ completion: (@escaping () -> Swift.Void)!) ``` |
| To | ``` func QLThumbnailDispatchAsync(_ thumbnail: QLThumbnail!, _ queue: DispatchQueue!, _ completion: (() -> Swift.Void)!) ``` |
