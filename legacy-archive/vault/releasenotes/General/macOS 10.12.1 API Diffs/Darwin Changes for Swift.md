...
source_url: https://developer.apple.com/library/archive/releasenotes/General/APIDiffsMacOS10_12_1/Swift/Darwin.html
archived_at: '2026-07-18T02:51:45.658015Z'
---
...
Added MAC_OS_X_VERSION_10_12_1Added MAP_FAILEDAdded timingsafe_bcmp(_: UnsafeRawPointer!, _: UnsafeRawPointer!, _: Int) -> Int32Added VM_MEMORY_DFRModified kmod_info [struct]
...
|  | Declaration |
| --- | --- |
| From | ``` func buf_clone(_ bp: buf_t!, _ io_offset: Int32, _ io_size: Int32, _ iodone: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |
| To | ``` func buf_clone(_ bp: buf_t!, _ io_offset: Int32, _ io_size: Int32, _ iodone: ((buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func buf_create_shadow(_ bp: buf_t!, _ force_copy: boolean_t, _ external_storage: UInt, _ iodone: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |
| To | ``` func buf_create_shadow(_ bp: buf_t!, _ force_copy: boolean_t, _ external_storage: UInt, _ iodone: ((buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ arg: UnsafeMutableRawPointer!) -> buf_t! ``` |

Modified buf_iterate(_: vnode_t!, _: ((buf_t?, UnsafeMutableRawPointer?) -> Int32)!, _: Int32, _: UnsafeMutableRawPointer!)

|  | Declaration |
| --- | --- |
| From | ``` func buf_iterate(_ vp: vnode_t!, _ callout: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Int32)!, _ flags: Int32, _ arg: UnsafeMutableRawPointer!) ``` |
| To | ``` func buf_iterate(_ vp: vnode_t!, _ callout: ((buf_t?, UnsafeMutableRawPointer?) -> Int32)!, _ flags: Int32, _ arg: UnsafeMutableRawPointer!) ``` |

Modified buf_setcallback(_: buf_t!, _: ((buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _: UnsafeMutableRawPointer!) -> errno_t

|  | Declaration |
| --- | --- |
| From | ``` func buf_setcallback(_ bp: buf_t!, _ callback: (@escaping (buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ transaction: UnsafeMutableRawPointer!) -> errno_t ``` |
| To | ``` func buf_setcallback(_ bp: buf_t!, _ callback: ((buf_t?, UnsafeMutableRawPointer?) -> Swift.Void)!, _ transaction: UnsafeMutableRawPointer!) -> errno_t ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func mach_msg_server(_ _: (@escaping (UnsafeMutablePointer<mach_msg_header_t>?, UnsafeMutablePointer<mach_msg_header_t>?) -> boolean_t)!, _ _: mach_msg_size_t, _ _: mach_port_t, _ _: mach_msg_options_t) -> mach_msg_return_t ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func mach_msg_server_importance(_ _: (@escaping (UnsafeMutablePointer<mach_msg_header_t>?, UnsafeMutablePointer<mach_msg_header_t>?) -> boolean_t)!, _ _: mach_msg_size_t, _ _: mach_port_t, _ _: mach_msg_options_t) -> mach_msg_return_t ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func mach_msg_server_once(_ _: (@escaping (UnsafeMutablePointer<mach_msg_header_t>?, UnsafeMutablePointer<mach_msg_header_t>?) -> boolean_t)!, _ _: mach_msg_size_t, _ _: mach_port_t, _ _: mach_msg_options_t) -> mach_msg_return_t ``` |
...
|  | Declaration |
| --- | --- |
| From | ``` func physio(_ f_strategy: (@escaping (buf_t?) -> Swift.Void)!, _ bp: buf_t!, _ dev: dev_t, _ flags: Int32, _ f_minphys: (@escaping (buf_t?) -> u_int)!, _ uio: OpaquePointer!, _ blocksize: Int32) -> Int32 ``` |
| To | ``` func physio(_ f_strategy: ((buf_t?) -> Swift.Void)!, _ bp: buf_t!, _ dev: dev_t, _ flags: Int32, _ f_minphys: ((buf_t?) -> u_int)!, _ uio: OpaquePointer!, _ blocksize: Int32) -> Int32 ``` |
