...
### 启用 App Shortcuts Flexible Matching
...
### 违反 Mach Interface Generator 约定
...
### 为仅含 Objective-C 的 target 构建多语言文档
...
### 从 Reference Object 中剥离 USDZ 文件
...
### Text-Based InstallAPI 反重整符号

**设置名称：** `TAPI_DEMANGLE`

构建 `Text-Based InstallAPI` 时显示反重整（demangle）后的符号。

### 为项目头文件启用 Text-Based InstallAPI
