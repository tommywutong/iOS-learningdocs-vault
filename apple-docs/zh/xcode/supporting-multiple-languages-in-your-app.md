...
- **纵向空间需求较大的语言**。使用 Dynamic Type 防止单词和字母被裁剪，并确保文本间距正确，因为有些语言需要显著更多的垂直空间，另一些语言则有特定的换行和连字符使用惯例。有关 Dynamic Type 的更多信息，请参阅[自动缩放字体](../uikit/scaling-fonts-automatically.md)和[文本与文本交互的新功能](https://developer.apple.com/videos/play/wwdc2023/10058/)。
...
- [使用智能体（agent）本地化 App](localizing-your-app-using-agents.md) — 使用智能体编码工具，将 App 中的字符串翻译成多种语言并适应多个地区。
