...
beta: false
deprecated: true
doc_path: /documentation/coretext/ctfontstylisticclass/transitionalserifsclass
source_url: 'https://developer.apple.com/documentation/coretext/ctfontstylisticclass/transitionalserifsclass'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coretext/ctfontstylisticclass/transitionalserifsclass.json'
content_hash: 'sha256:71862a6accfd03e1'
translated: false
---
...
- [kCTFontSymbolicClass](symbolicclass.md) — The font’s style is generally design independent. _(deprecated)_
