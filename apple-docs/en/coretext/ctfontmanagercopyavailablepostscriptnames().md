---
title: CTFontManagerCopyAvailablePostScriptNames()
framework: Core Text
symbol_kind: func
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/coretext/ctfontmanagercopyavailablepostscriptnames()
source_url: 'https://developer.apple.com/documentation/coretext/ctfontmanagercopyavailablepostscriptnames()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coretext/ctfontmanagercopyavailablepostscriptnames%28%29.json'
content_hash: 'sha256:fbf4fdb26968502f'
translated: false
---
