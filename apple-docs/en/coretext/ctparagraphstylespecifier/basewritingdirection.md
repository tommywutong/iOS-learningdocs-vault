---
title: CTParagraphStyleSpecifier.baseWritingDirection
framework: Core Text
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: /documentation/coretext/ctparagraphstylespecifier/basewritingdirection
source_url: 'https://developer.apple.com/documentation/coretext/ctparagraphstylespecifier/basewritingdirection'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coretext/ctparagraphstylespecifier/basewritingdirection.json'
content_hash: 'sha256:f09b7ad06ac83bda'
translated: false
---
...
Type: [CTWritingDirection](../ctwritingdirection.md). Default value: [kCTWritingDirectionNatural](../ctwritingdirection/natural.md). Affects: [CTFramesetter](../ctframesetter.md) and [CTTypesetter](../cttypesetter.md).
