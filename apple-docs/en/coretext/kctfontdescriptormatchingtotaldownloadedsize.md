---
title: kCTFontDescriptorMatchingTotalDownloadedSize
framework: Core Text
symbol_kind: var
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/coretext/kctfontdescriptormatchingtotaldownloadedsize
source_url: 'https://developer.apple.com/documentation/coretext/kctfontdescriptormatchingtotaldownloadedsize'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coretext/kctfontdescriptormatchingtotaldownloadedsize.json'
content_hash: 'sha256:41c37816326dd9d2'
translated: false
---
