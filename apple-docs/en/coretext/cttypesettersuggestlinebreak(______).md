---
title: 'CTTypesetterSuggestLineBreak(_:_:_:)'
framework: Core Text
symbol_kind: func
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/coretext/cttypesettersuggestlinebreak(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/coretext/cttypesettersuggestlinebreak(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coretext/cttypesettersuggestlinebreak%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:f336bee8b83d3dc3'
translated: false
---
...
A count of the characters from `startIndex` that would cause the line break. The value returned can be used to construct a character range for [CTTypesetterCreateLine](<cttypesettercreateline(____).md>).

## Discussion

The line break can be triggered either by a hard-break character in the stream or by filling the specified width with characters. This function is equivalent to [CTTypesetterSuggestLineBreakWithOffset](<cttypesettersuggestlinebreakwithoffset(________).md>) with an offset of 0.0.
