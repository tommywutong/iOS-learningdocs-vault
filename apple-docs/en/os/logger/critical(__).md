...
beta: false
deprecated: false
doc_path: '/documentation/os/logger/critical(_:)'
source_url: 'https://developer.apple.com/documentation/os/logger/critical(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/os/logger/critical%28_%3A%29.json'
content_hash: 'sha256:9591add49fa164cd'
translated: false
---
...
This method is functionally equivalent to the [fault(_:)](<fault(__).md>) method.
