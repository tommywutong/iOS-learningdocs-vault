...
beta: false
deprecated: false
doc_path: '/documentation/os/logger/notice(_:)'
source_url: 'https://developer.apple.com/documentation/os/logger/notice(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/os/logger/notice%28_%3A%29.json'
content_hash: 'sha256:861f056b66879de5'
translated: false
---
...
This method is functionally equivalent to the [log(_:)](<log(__).md>) method.
