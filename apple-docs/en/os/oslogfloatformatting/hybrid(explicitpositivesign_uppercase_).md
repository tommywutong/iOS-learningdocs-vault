---
title: 'hybrid(explicitPositiveSign:uppercase:)'
framework: os
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/os/oslogfloatformatting/hybrid(explicitpositivesign:uppercase:)'
source_url: 'https://developer.apple.com/documentation/os/oslogfloatformatting/hybrid(explicitpositivesign:uppercase:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/os/oslogfloatformatting/hybrid%28explicitpositivesign%3Auppercase%3A%29.json'
content_hash: 'sha256:a18b1531ba6aa9a9'
translated: false
---
