---
title: 'exponential(precision:explicitPositiveSign:uppercase:)'
framework: os
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/os/oslogfloatformatting/exponential(precision:explicitpositivesign:uppercase:)'
source_url: 'https://developer.apple.com/documentation/os/oslogfloatformatting/exponential(precision:explicitpositivesign:uppercase:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/os/oslogfloatformatting/exponential%28precision%3Aexplicitpositivesign%3Auppercase%3A%29.json'
content_hash: 'sha256:43a2fdb2b5de0a12'
translated: false
---
