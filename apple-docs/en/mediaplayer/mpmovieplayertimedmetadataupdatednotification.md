---
title: MPMoviePlayerTimedMetadataUpdatedNotification
framework: Media Player
symbol_kind: var
role: symbol
role_heading: Global Variable
platforms: [iOS 4.0+（9.0 起废弃）, iPadOS 4.0+（9.0 起废弃）, Mac Catalyst 13.1+（13.1 起废弃）, tvOS（9.0 起废弃）]
languages: [occ]
beta: false
deprecated: false
doc_path: /documentation/mediaplayer/mpmovieplayertimedmetadataupdatednotification
source_url: 'https://developer.apple.com/documentation/mediaplayer/mpmovieplayertimedmetadataupdatednotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mediaplayer/mpmovieplayertimedmetadataupdatednotification.json'
content_hash: 'sha256:a27f7ca7acaa73af'
translated: false
---
