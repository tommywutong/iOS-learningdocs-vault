---
title: MPMoviePlayerDidExitFullscreenNotification
...
beta: false
deprecated: false
doc_path: /documentation/mediaplayer/mpmovieplayerdidexitfullscreennotification
source_url: 'https://developer.apple.com/documentation/mediaplayer/mpmovieplayerdidexitfullscreennotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mediaplayer/mpmovieplayerdidexitfullscreennotification.json'
content_hash: 'sha256:903a69c5298283a3'
translated: false
---
...
A movie player can exit full screen mode programmatically (see the [- setFullscreen:animated:](<mpmovieplayercontroller/setfullscreen(__animated_).md>) method) or by user interaction. The movie player whose state has changed is available as the object associated with the notification.
