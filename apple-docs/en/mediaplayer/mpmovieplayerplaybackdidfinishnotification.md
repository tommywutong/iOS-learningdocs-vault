...
beta: false
deprecated: false
doc_path: /documentation/mediaplayer/mpmovieplayerplaybackdidfinishnotification
source_url: 'https://developer.apple.com/documentation/mediaplayer/mpmovieplayerplaybackdidfinishnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mediaplayer/mpmovieplayerplaybackdidfinishnotification.json'
content_hash: 'sha256:ace54f336e642b10'
translated: false
---
...
This notification is _not_ sent when a movie is displaying in fullscreen mode and the user taps Done. The Done button pauses playback and causes the movie player to exit fullscreen mode. To detect this scenario, register for other notifications such as [MPMoviePlayerDidExitFullscreenNotification](mpmovieplayerdidexitfullscreennotification.md).
...
- [MPMoviePlayerPlaybackStateDidChangeNotification](mpmovieplayerplaybackstatedidchangenotification.md) — Posted when a movie player’s playback state has changed. There is no `userInfo` dictionary. _(deprecated)_
