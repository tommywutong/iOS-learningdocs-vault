...
platforms: [iOS 16.4+, iPadOS 16.4+, Mac Catalyst 16.4+, Xcode 14.3+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: /documentation/storekittest/testing-and-validating-ad-impression-signatures-and-postbacks-for-skadnetwork
source_url: 'https://developer.apple.com/documentation/storekittest/testing-and-validating-ad-impression-signatures-and-postbacks-for-skadnetwork'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekittest/testing-and-validating-ad-impression-signatures-and-postbacks-for-skadnetwork.json'
content_hash: 'sha256:8747aba05f494146'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [StoreKit Test](../storekittest.md)
...
- A device running iOS 16.4 or later. iOS Simulator doesn’t support [SKAdNetwork](skadnetwork_linkid).
...
- [TestingAndValidatingAdImpressionSignaturesAndPostbacksForSKAdNetwork.zip](https://docs-assets.developer.apple.com/published/ed00341d878d/TestingAndValidatingAdImpressionSignaturesAndPostbacksForSKAdNetwork.zip)
