...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsdictionary/initwithobjectsandkeys:'
source_url: 'https://developer.apple.com/documentation/foundation/nsdictionary/initwithobjectsandkeys:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsdictionary/initwithobjectsandkeys%3A.json'
content_hash: 'sha256:130850a0bc3c15eb'
translated: false
---
...
This method is similar to [- initWithObjects:forKeys:](<init(objects_forkeys_).md>), differing only in the way in which the key-value pairs are specified.
