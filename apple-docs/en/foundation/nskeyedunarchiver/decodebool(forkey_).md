...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nskeyedunarchiver/decodebool(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nskeyedunarchiver/decodebool(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nskeyedunarchiver/decodebool%28forkey%3A%29.json'
content_hash: 'sha256:45e419d09753403e'
translated: false
---
...
The Boolean value associated with the key `key`. Returns [false](../../swift/false.md) if `key` does not exist.
