...
beta: false
deprecated: false
doc_path: '/documentation/foundation/filemanager/isexecutablefile(atpath:)'
source_url: 'https://developer.apple.com/documentation/foundation/filemanager/isexecutablefile(atpath:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/filemanager/isexecutablefile%28atpath%3A%29.json'
content_hash: 'sha256:dd3cd70e6a342e3b'
translated: false
---
...
[true](../../swift/true.md) if the current process has execute privileges for the file at `path`; otherwise [false](../../swift/false.md) if the process does not have execute privileges or the existence of the file could not be determined.
