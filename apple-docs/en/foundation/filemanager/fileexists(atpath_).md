...
beta: false
deprecated: false
doc_path: '/documentation/foundation/filemanager/fileexists(atpath:)'
source_url: 'https://developer.apple.com/documentation/foundation/filemanager/fileexists(atpath:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/filemanager/fileexists%28atpath%3A%29.json'
content_hash: 'sha256:37bdc6d8893ef46e'
translated: false
---
...
- `path` — The path of the file or directory. If `path` begins with a tilde (`~`), it must first be expanded with [stringByExpandingTildeInPath](../nsstring/expandingtildeinpath.md); otherwise, this method returns [false](../../swift/false.md). App Sandbox does not restrict which path values may be passed to this parameter.

## Return Value

[true](../../swift/true.md) if a file at the specified path exists, or [false](../../swift/false.md) if the file does not exist or its existence could not be determined.
