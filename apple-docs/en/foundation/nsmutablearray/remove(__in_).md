...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsmutablearray/remove(_:in:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsmutablearray/remove(_:in:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsmutablearray/remove%28_%3Ain%3A%29.json'
content_hash: 'sha256:3310b282cc8134cc'
translated: false
---
...
- `range` — The range from which to remove `anObject`. > [!important] Important > Raises an exception `NSRangeException` if `aRange` exceeds the bounds of the array.
