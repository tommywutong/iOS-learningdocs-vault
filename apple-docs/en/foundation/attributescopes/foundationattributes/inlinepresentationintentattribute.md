...
beta: false
deprecated: false
doc_path: /documentation/foundation/attributescopes/foundationattributes/inlinepresentationintentattribute
source_url: 'https://developer.apple.com/documentation/foundation/attributescopes/foundationattributes/inlinepresentationintentattribute'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/attributescopes/foundationattributes/inlinepresentationintentattribute.json'
content_hash: 'sha256:c9c061ebbab1b0b9'
translated: false
---
...
- [PresentationIntentAttribute](presentationintentattribute.md) — A type for using a presentation intent as an attribute.
