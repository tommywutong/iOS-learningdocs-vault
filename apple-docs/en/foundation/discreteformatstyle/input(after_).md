...
beta: false
deprecated: false
doc_path: '/documentation/foundation/discreteformatstyle/input(after:)'
source_url: 'https://developer.apple.com/documentation/foundation/discreteformatstyle/input(after:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/discreteformatstyle/input%28after%3A%29.json'
content_hash: 'sha256:be8d6efd7740c439'
translated: false
---
...
- [input(after:)](<input(after_)-3nkyz.md>) — The next input value after the given input.
- [input(after:)](<input(after_)-4op7c.md>) — The next input value after the given input.
- [input(after:)](<input(after_)-8exd1.md>) — The next input value after the given input.
- [input(after:)](<input(after_)-9h7f8.md>) — The next input value after the given input.
