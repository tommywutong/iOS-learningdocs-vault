---
title: MPMoviePlayerDidEnterFullscreen
...
beta: false
deprecated: true
doc_path: /documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerdidenterfullscreen
source_url: 'https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerdidenterfullscreen'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerdidenterfullscreen.json'
content_hash: 'sha256:6731a32cbe056a58'
translated: false
---
...
A movie player can enter full screen mode programmatically (see the [setFullscreen(_:animated:)](<../../../mediaplayer/mpmovieplayercontroller/setfullscreen(__animated_).md>) method) or by user interaction. The movie player whose state has changed is available as the object associated with the notification.
