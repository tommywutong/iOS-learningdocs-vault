...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsnotification/name-swift.struct/pdfdocumentdidendfind
source_url: 'https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/pdfdocumentdidendfind'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsnotification/name-swift.struct/pdfdocumentdidendfind.json'
content_hash: 'sha256:17f00048865cc548'
translated: false
---
...
The document posts this notification when [findString(_:withOptions:)](<../../../pdfkit/pdfdocument/findstring(__withoptions_).md>) returns.

The [beginFindString(_:withOptions:)](<../../../pdfkit/pdfdocument/beginfindstring(__withoptions_).md>) method returns immediately, so this notification is posted when the “find” operation is finished.
