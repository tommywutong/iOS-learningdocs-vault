---
title: MPMoviePlayerPlaybackDidFinish
...
beta: false
deprecated: true
doc_path: /documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerplaybackdidfinish
source_url: 'https://developer.apple.com/documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerplaybackdidfinish'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsnotification/name-swift.struct/mpmovieplayerplaybackdidfinish.json'
content_hash: 'sha256:b0ae5011685882eb'
translated: false
---
...
This notification is _not_ sent when a movie is displaying in fullscreen mode and the user taps Done. The Done button pauses playback and causes the movie player to exit fullscreen mode. To detect this scenario, register for other notifications such as [MPMoviePlayerDidExitFullscreen](mpmovieplayerdidexitfullscreen.md).
