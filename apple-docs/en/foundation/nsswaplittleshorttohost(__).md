---
title: 'NSSwapLittleShortToHost(_:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsswaplittleshorttohost(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsswaplittleshorttohost(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsswaplittleshorttohost%28_%3A%29.json'
content_hash: 'sha256:0799c3f238563af3'
translated: false
---
...
Converts the little-endian formatted value in `x` to the current endian format and returns the resulting value. If it is necessary to swap the bytes of `x`, this function calls [NSSwapShort](<nsswapshort(__).md>) to perform the swap.

## See Also

### Related Documentation

- [NSSwapHostShortToLittle](<nsswaphostshorttolittle(__).md>) — Swaps the bytes of a number.
