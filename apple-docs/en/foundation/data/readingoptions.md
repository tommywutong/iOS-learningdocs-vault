...
beta: false
deprecated: false
doc_path: /documentation/foundation/data/readingoptions
source_url: 'https://developer.apple.com/documentation/foundation/data/readingoptions'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/data/readingoptions.json'
content_hash: 'sha256:271a6e7c0d87191e'
translated: false
---
...
- [write(to:options:)](<write(to_options_).md>) — Writes the contents of the data buffer to a location.
