...
beta: false
deprecated: false
doc_path: '/documentation/foundation/data/base64encodeddata(options:)'
source_url: 'https://developer.apple.com/documentation/foundation/data/base64encodeddata(options:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/data/base64encodeddata%28options%3A%29.json'
content_hash: 'sha256:2782d16ae7e8b0d8'
translated: false
---
...
- [base64EncodedString(options:)](<base64encodedstring(options_).md>) — Returns a Base-64 encoded string.
