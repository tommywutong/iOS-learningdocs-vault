...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsmutablecharacterset/whitespaceandnewline()
source_url: 'https://developer.apple.com/documentation/foundation/nsmutablecharacterset/whitespaceandnewline()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsmutablecharacterset/whitespaceandnewline%28%29.json'
content_hash: 'sha256:e2518c82d5dfa2c9'
translated: false
---
...
- [+ lowercaseLetterCharacterSet](<lowercaseletter().md>) — Returns a character set containing the characters in Unicode General Category Ll.
