...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsorderedset/enumerateobjects(options:using:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsorderedset/enumerateobjects(options:using:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsorderedset/enumerateobjects%28options%3Ausing%3A%29.json'
content_hash: 'sha256:92837a56f4736fbb'
translated: false
---
...
- `block` — The block to apply to elements in the ordered set. The block takes three arguments: - **obj** — The element in the set. - **idx** — The index of the item in the set. - **stop** — A reference to a Boolean value. The block can set the value to [true](../../swift/true.md) to stop further processing of the set. The `stop` argument is an out-only argument. You should only ever set this value to [true](../../swift/true.md) within the block. The block returns a Boolean value that indicates whether `obj` passed the test.
