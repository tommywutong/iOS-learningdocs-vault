...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsorderedset/sortedarray(options:usingcomparator:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsorderedset/sortedarray(options:usingcomparator:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsorderedset/sortedarray%28options%3Ausingcomparator%3A%29.json'
content_hash: 'sha256:5e6eb1e90d6ffbae'
translated: false
---
