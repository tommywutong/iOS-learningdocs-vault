...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsorderedset/init(set:copyitems:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsorderedset/init(set:copyitems:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsorderedset/init%28set%3Acopyitems%3A%29.json'
content_hash: 'sha256:cd81ecb193eda57f'
translated: false
---
