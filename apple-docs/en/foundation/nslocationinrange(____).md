...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nslocationinrange(_:_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nslocationinrange(_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocationinrange%28_%3A_%3A%29.json'
content_hash: 'sha256:629dcb370f78736b'
translated: false
---
...
[true](../swift/true.md) if `loc` lies within `range`—that is, if it’s greater than or equal to `range.location` and less than `range.location` plus `range.length`.
