---
title: NSYearForWeekOfYearCalendarUnit
framework: Foundation
symbol_kind: property
role: symbol
role_heading: Type Property
platforms: [iOS 5.0+（8.0 起废弃）, iPadOS 5.0+（8.0 起废弃）, Mac Catalyst 13.1+（13.1 起废弃）, macOS 10.7+（10.10 起废弃）, tvOS 9.0+（9.0 起废弃）, visionOS 1.0+（1.0 起废弃）, watchOS 2.0+（2.0 起废弃）]
languages: [swift, swift, swift, swift, occ, occ, occ, occ]
beta: false
deprecated: true
doc_path: /documentation/foundation/nscalendar/unit/nsyearforweekofyearcalendarunit
source_url: 'https://developer.apple.com/documentation/foundation/nscalendar/unit/nsyearforweekofyearcalendarunit'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscalendar/unit/nsyearforweekofyearcalendarunit.json'
content_hash: 'sha256:fb37622acdd57868'
translated: false
---
...
- [NSWeekdayOrdinalCalendarUnit](nsweekdayordinalcalendarunit.md) — Specifies the ordinal weekday unit. _(deprecated)_
