---
title: NSCalendarCalendarUnit
framework: Foundation
symbol_kind: property
role: symbol
role_heading: Type Property
platforms: [iOS 4.0+（8.0 起废弃）, iPadOS 4.0+（8.0 起废弃）, Mac Catalyst 13.1+（13.1 起废弃）, macOS 10.7+（10.10 起废弃）, tvOS 9.0+（9.0 起废弃）, visionOS 1.0+（1.0 起废弃）, watchOS 2.0+（2.0 起废弃）]
languages: [swift, swift, swift, swift, occ, occ, occ, occ]
beta: false
deprecated: true
doc_path: /documentation/foundation/nscalendar/unit/nscalendarcalendarunit
source_url: 'https://developer.apple.com/documentation/foundation/nscalendar/unit/nscalendarcalendarunit'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscalendar/unit/nscalendarcalendarunit.json'
content_hash: 'sha256:ec40bea483a666ad'
translated: false
---
