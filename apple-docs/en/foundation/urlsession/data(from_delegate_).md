...
beta: false
deprecated: false
doc_path: '/documentation/foundation/urlsession/data(from:delegate:)'
source_url: 'https://developer.apple.com/documentation/foundation/urlsession/data(from:delegate:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlsession/data%28from%3Adelegate%3A%29.json'
content_hash: 'sha256:518e327e43b65077'
translated: false
---
...
Use this method to wait until the session finishes transferring data and receive it in a single [Data](../data.md) instance. To process the bytes as the session receives them, use [bytes(from:delegate:)](<bytes(from_delegate_).md>).
