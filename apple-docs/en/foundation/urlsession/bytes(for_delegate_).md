...
beta: false
deprecated: false
doc_path: '/documentation/foundation/urlsession/bytes(for:delegate:)'
source_url: 'https://developer.apple.com/documentation/foundation/urlsession/bytes(for:delegate:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlsession/bytes%28for%3Adelegate%3A%29.json'
content_hash: 'sha256:b5dae73ad6fc9c28'
translated: false
---
...
To wait until the session finishes transferring data and receive it in a single [Data](../data.md) instance, use [data(for:delegate:)](<data(for_delegate_).md>).
