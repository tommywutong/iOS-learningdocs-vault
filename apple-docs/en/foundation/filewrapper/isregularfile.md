...
beta: false
deprecated: false
doc_path: /documentation/foundation/filewrapper/isregularfile
source_url: 'https://developer.apple.com/documentation/foundation/filewrapper/isregularfile'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/filewrapper/isregularfile.json'
content_hash: 'sha256:a2e70363af77ec51'
translated: false
---
...
This property contains [true](../../swift/true.md) when the file wrapper object is a regular-file wrapper, otherwise it contains [false](../../swift/false.md). Invocations of [- readFromURL:options:error:](<read(from_options_).md>) may change the value of this property if the type of the file on disk has changed.
