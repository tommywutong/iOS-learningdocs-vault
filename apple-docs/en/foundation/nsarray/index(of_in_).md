...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsarray/index(of:in:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsarray/index(of:in:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsarray/index%28of%3Ain%3A%29.json'
content_hash: 'sha256:26add0400f175a98'
translated: false
---
...
Starting at `range.location`, each element of the array is passed as an argument to an [isEqual(_:)](<../../objectivec/nsobjectprotocol/isequal(__).md>) message sent to `anObject` until a match is found or the end of the `range` is reached. Objects are considered equal if [isEqual(_:)](<../../objectivec/nsobjectprotocol/isequal(__).md>) returns [true](../../swift/true.md).
