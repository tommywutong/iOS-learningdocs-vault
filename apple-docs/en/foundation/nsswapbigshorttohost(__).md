...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsswapbigshorttohost(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsswapbigshorttohost(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsswapbigshorttohost%28_%3A%29.json'
content_hash: 'sha256:109ac03639681f27'
translated: false
---
...
Converts the big-endian value in `x` to the current endian format and returns the resulting value. If it is necessary to swap the bytes of `x`, this function calls [NSSwapShort](<nsswapshort(__).md>) to perform the swap.
