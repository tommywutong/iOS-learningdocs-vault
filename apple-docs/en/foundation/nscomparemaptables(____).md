...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscomparemaptables(_:_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscomparemaptables(_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscomparemaptables%28_%3A_%3A%29.json'
content_hash: 'sha256:2aedf1fa297ab66d'
translated: false
---
...
[true](../swift/true.md) if the keys and corresponding values of `table1` and `table2` are the same, and the two tables are the same size, otherwise [false](../swift/false.md).
