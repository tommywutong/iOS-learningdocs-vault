...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsstring/initwithformat:locale:'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/initwithformat:locale:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/initwithformat%3Alocale%3A.json'
content_hash: 'sha256:5cdc67c943924a77'
translated: false
---
...
- `locale` — An [NSLocale](../nslocale.md) object specifying the locale to use. To use the current locale, pass `[NSLocale currentLocale]`. To use the system locale, pass `nil`. For legacy support, this may be an instance of `NSDictionary` containing locale information.

## Discussion

Pass comma-separated list of trailing variadic arguments to substitute into `format`.

Invokes [- initWithFormat:locale:arguments:](<init(format_locale_arguments_).md>) with `locale` as the locale.
