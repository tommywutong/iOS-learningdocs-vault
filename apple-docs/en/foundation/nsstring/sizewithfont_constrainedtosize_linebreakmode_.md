---
title: 'sizeWithFont:constrainedToSize:lineBreakMode:'
...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nsstring/sizewithfont:constrainedtosize:linebreakmode:'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/sizewithfont:constrainedtosize:linebreakmode:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/sizewithfont%3Aconstrainedtosize%3Alinebreakmode%3A.json'
content_hash: 'sha256:b9c5bd755734f856'
translated: false
---
...
> [!warning] Deprecated
> Use [- boundingRectWithSize:options:attributes:context:](<boundingrect(with_options_attributes_context_).md>) instead.
