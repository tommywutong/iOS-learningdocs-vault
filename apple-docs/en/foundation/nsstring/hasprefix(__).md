...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsstring/hasprefix(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/hasprefix(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/hasprefix%28_%3A%29.json'
content_hash: 'sha256:d90bbfd34530dd46'
translated: false
---
...
[true](../../swift/true.md) if `aString` matches the beginning characters of the receiver, otherwise [false](../../swift/false.md). Returns [false](../../swift/false.md) if `aString` is empty.
