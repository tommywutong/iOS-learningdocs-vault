...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsstring/range(of:options:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/range(of:options:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/range%28of%3Aoptions%3A%29.json'
content_hash: 'sha256:2ebf333020665751'
translated: false
---
...
- `mask` — A mask specifying search options. For possible values, see [CompareOptions](compareoptions.md).
...
Invokes [- rangeOfString:options:range:](<range(of_options_range_).md>) with the options specified by `mask` and the entire extent of the receiver as the range.
