...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsstring/isabsolutepath
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/isabsolutepath'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/isabsolutepath.json'
content_hash: 'sha256:b2e0f4899aefade4'
translated: false
---
...
[true](../../swift/true.md) if the receiver (if interpreted as a path) represents an absolute path, otherwise [false](../../swift/false.md).
...
Note that this method only works with file paths (not, for example, string representations of URLs). The method does not check the filesystem for the existence of the path (use [- fileExistsAtPath:](<../filemanager/fileexists(atpath_).md>) or similar methods in [FileManager](../filemanager.md) for that task).
