...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsstring/init(bytesnocopy:length:encoding:freewhendone:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/init(bytesnocopy:length:encoding:freewhendone:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/init%28bytesnocopy%3Alength%3Aencoding%3Afreewhendone%3A%29.json'
content_hash: 'sha256:a41316af4a040c32'
translated: false
---
...
If an error occurs during the creation of the string, then `bytes` isn’t freed even if `flag` is [true](../../swift/true.md). In this case, the caller is responsible for freeing the buffer. This allows the caller to continue trying to create a string with the buffer, without having the buffer deallocated.
