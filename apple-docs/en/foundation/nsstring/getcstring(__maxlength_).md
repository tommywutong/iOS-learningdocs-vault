...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nsstring/getcstring(_:maxlength:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/getcstring(_:maxlength:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/getcstring%28_%3Amaxlength%3A%29.json'
content_hash: 'sha256:c44f3ea1b6cdc9ac'
translated: false
---
...
Invokes [- getCString:maxLength:range:remainingRange:](<getcstring(__maxlength_range_remaining_).md>) with `maxLength` as the maximum length in char-sized units, the receiver’s entire extent as the range, and `NULL` for the remaining range.

> [!warning] Deprecated
> Use [- getCString:maxLength:encoding:](<getcstring(__maxlength_encoding_).md>) instead.
