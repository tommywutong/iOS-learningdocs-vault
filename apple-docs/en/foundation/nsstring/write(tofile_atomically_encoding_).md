...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsstring/write(tofile:atomically:encoding:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsstring/write(tofile:atomically:encoding:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsstring/write%28tofile%3Aatomically%3Aencoding%3A%29.json'
content_hash: 'sha256:93b406a2ab579b01'
translated: false
---
...
- `useAuxiliaryFile` — If [true](../../swift/true.md), the receiver is written to an auxiliary file, and then the auxiliary file is renamed to `path`. If [false](../../swift/false.md), the receiver is written directly to `path`. The [true](../../swift/true.md) option guarantees that `path`, if it exists at all, won’t be corrupted even if the system should crash during writing.
