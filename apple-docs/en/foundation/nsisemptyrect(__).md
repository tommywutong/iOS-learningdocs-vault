...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsisemptyrect(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsisemptyrect(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsisemptyrect%28_%3A%29.json'
content_hash: 'sha256:d3d022978ebc9328'
translated: false
---
...
[true](../swift/true.md) if `aRect` encloses no area at all—that is, if its width or height is 0 or negative, otherwise [false](../swift/false.md).
