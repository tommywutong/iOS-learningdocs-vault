...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsswaplittledoubletohost(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsswaplittledoubletohost(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsswaplittledoubletohost%28_%3A%29.json'
content_hash: 'sha256:cb3f05d2befc11d8'
translated: false
---
...
Converts the little-endian formatted value in `x` to the current endian format and returns the resulting value. If it is necessary to swap the bytes of `x`, this function calls [NSSwapDouble](<nsswapdouble(__).md>) to perform the swap.
