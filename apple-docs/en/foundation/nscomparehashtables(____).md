...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscomparehashtables(_:_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscomparehashtables(_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscomparehashtables%28_%3A_%3A%29.json'
content_hash: 'sha256:4c94557e8c9808dc'
translated: false
---
...
[true](../swift/true.md) if the two hash tables are equal—that is, if each element of `table1` is in `table2` and the two tables are the same size, otherwise [false](../swift/false.md).
