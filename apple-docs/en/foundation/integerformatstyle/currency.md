...
beta: false
deprecated: false
doc_path: /documentation/foundation/integerformatstyle/currency
source_url: 'https://developer.apple.com/documentation/foundation/integerformatstyle/currency'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/integerformatstyle/currency.json'
content_hash: 'sha256:c094735b046b0026'
translated: false
---
...
- [init(code:locale:)](<currency/init(code_locale_).md>) — Creates an integer currency format style that uses the given currency code and locale.
...
- [format(_:)](<currency/format(__).md>) — Formats an integer, using this style.
