...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsnextmapenumeratorpair(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsnextmapenumeratorpair(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsnextmapenumeratorpair%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:eb0c3eb38dfb11df'
translated: false
---
...
[false](../swift/false.md) if `enumerator` has already iterated over all the elements in the table that `enumerator` is associated with; otherwise, sets `key` and `value` to match the next key-value pair in the table and returns [true](../swift/true.md).
