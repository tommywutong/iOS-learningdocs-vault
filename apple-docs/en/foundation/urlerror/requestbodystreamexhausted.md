...
beta: false
deprecated: false
doc_path: /documentation/foundation/urlerror/requestbodystreamexhausted
source_url: 'https://developer.apple.com/documentation/foundation/urlerror/requestbodystreamexhausted'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlerror/requestbodystreamexhausted.json'
content_hash: 'sha256:40ac221453979018'
translated: false
---
...
This error applies to clients on iOS that send a `POST` request using a body stream but don’t implement the [URLSessionTaskDelegate](../urlsessiontaskdelegate.md) method [- URLSession:task:needNewBodyStream:](<../urlsessiontaskdelegate/urlsession(__task_neednewbodystream_).md>).
