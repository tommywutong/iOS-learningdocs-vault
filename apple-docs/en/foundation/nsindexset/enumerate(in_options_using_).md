---
title: 'enumerate(in:options:using:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsindexset/enumerate(in:options:using:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsindexset/enumerate(in:options:using:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsindexset/enumerate%28in%3Aoptions%3Ausing%3A%29.json'
content_hash: 'sha256:5514bf0b039a4a89'
translated: false
---
