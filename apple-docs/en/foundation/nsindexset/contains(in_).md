...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsindexset/contains(in:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsindexset/contains(in:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsindexset/contains%28in%3A%29.json'
content_hash: 'sha256:fa76c05d8d62c8b7'
translated: false
---
...
[true](../../swift/true.md) when the index set contains the indexes in `indexRange`, [false](../../swift/false.md) otherwise.
