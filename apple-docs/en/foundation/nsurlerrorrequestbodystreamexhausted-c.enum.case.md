---
title: NSURLErrorRequestBodyStreamExhausted
framework: Foundation
symbol_kind: case
role: symbol
role_heading: Enumeration Case
platforms: [iOS 3.0+, iPadOS 3.0+, Mac Catalyst 13.1+, macOS 10.7+, tvOS 9.0+, visionOS 1.0+, watchOS 2.0+]
languages: [occ]
beta: false
deprecated: false
doc_path: /documentation/foundation/nsurlerrorrequestbodystreamexhausted-c.enum.case
source_url: 'https://developer.apple.com/documentation/foundation/nsurlerrorrequestbodystreamexhausted-c.enum.case'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurlerrorrequestbodystreamexhausted-c.enum.case.json'
content_hash: 'sha256:b56ca5b60fc8cfc1'
translated: false
---
...
This impacts clients on iOS that send a `POST` request using a body stream but do not implement the [URLSessionTaskDelegate](urlsessiontaskdelegate.md) delegate method [- URLSession:task:needNewBodyStream:](<urlsessiontaskdelegate/urlsession(__task_neednewbodystream_).md>).
