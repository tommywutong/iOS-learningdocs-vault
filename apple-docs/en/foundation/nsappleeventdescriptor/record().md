...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsappleeventdescriptor/record()
source_url: 'https://developer.apple.com/documentation/foundation/nsappleeventdescriptor/record()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsappleeventdescriptor/record%28%29.json'
content_hash: 'sha256:fa3c2336bc20b405'
translated: false
---
...
Invoking this method is equivalent to allocating an instance of `NSAppleEventDescriptor` and invoking [- initRecordDescriptor](<init(recorddescriptor_).md>).
