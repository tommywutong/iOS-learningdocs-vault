...
beta: false
deprecated: false
doc_path: /documentation/foundation/nslocalizedstringfromtable
source_url: 'https://developer.apple.com/documentation/foundation/nslocalizedstringfromtable'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocalizedstringfromtable.json'
content_hash: 'sha256:68bd450c2ad02437'
translated: false
---
...
The result of invoking [- localizedStringForKey:value:table:](<bundle/localizedstring(forkey_value_table_).md>) on the main bundle, passing the specified `key` and `tableName`.
...
As of OS X 10.11 and iOS 9, [Bundle](bundle.md) is thread-safe. As such, you can safely call [NSLocalizedStringFromTable](nslocalizedstringfromtable.md) from any execution context.
