...
beta: false
deprecated: false
doc_path: /documentation/foundation/undomanager/willundochangemessage
source_url: 'https://developer.apple.com/documentation/foundation/undomanager/willundochangemessage'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/undomanager/willundochangemessage.json'
content_hash: 'sha256:4f042c96f31b68bf'
translated: false
---
...
The undo manager posts this message after you call [- undo](<undo().md>) or [- undoNestedGroup](<undonestedgroup().md>). Because this is a “will”-style message, the undo manager sends the message before it performs the undo.
...
This message interoperates with the notification [NSUndoManagerWillUndoChangeNotification](../nsnotification/name-swift.struct/nsundomanagerwillundochange.md). The system notifies observers of the message when the [NotificationCenter](../notificationcenter.md) posts the notification. Similarly, the system notifies observers of the notification when it posts the message.
...
- [init()](<willundochangemessage/init().md>) — Creates a will undo change message.
