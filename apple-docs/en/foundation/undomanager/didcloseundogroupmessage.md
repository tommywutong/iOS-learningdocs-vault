...
beta: false
deprecated: false
doc_path: /documentation/foundation/undomanager/didcloseundogroupmessage
source_url: 'https://developer.apple.com/documentation/foundation/undomanager/didcloseundogroupmessage'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/undomanager/didcloseundogroupmessage.json'
content_hash: 'sha256:0f17023b86dd5cf6'
translated: false
---
...
The undo manager posts this message after you call [- endUndoGrouping](<endundogrouping().md>). Because this is a “did”-style message, the undo manager sends the message after it closes the undo group.
...
This message interoperates with the notification [NSUndoManagerDidCloseUndoGroupNotification](../nsnotification/name-swift.struct/nsundomanagerdidcloseundogroup.md). The system notifies observers of the message when the [NotificationCenter](../notificationcenter.md) posts the notification. Similarly, the system notifies observers of the notification when it posts the message.
...
- [init(groupIsDiscardable:)](<didcloseundogroupmessage/init(groupisdiscardable_).md>) — Creates a did close undo group message.
