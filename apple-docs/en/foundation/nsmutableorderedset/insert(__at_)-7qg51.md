...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsmutableorderedset/insert(_:at:)-7qg51'
source_url: 'https://developer.apple.com/documentation/foundation/nsmutableorderedset/insert(_:at:)-7qg51'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsmutableorderedset/insert%28_%3Aat%3A%29-7qg51.json'
content_hash: 'sha256:41d77b6e1dd1d818'
translated: false
---
...
- `idx` — The index in the mutable ordered set at which to insert `object`. This value must not be greater than the count of elements in the array. > [!important] Important > Important: Raises an [NSRangeException](../nsexceptionname/rangeexception.md) if `idx` is greater than the number of elements in the mutable ordered set.
