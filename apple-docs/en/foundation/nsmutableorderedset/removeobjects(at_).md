...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsmutableorderedset/removeobjects(at:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsmutableorderedset/removeobjects(at:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsmutableorderedset/removeobjects%28at%3A%29.json'
content_hash: 'sha256:2f65ab38392039dd'
translated: false
---
...
This method is similar to [- removeObjectAtIndex:](<removeobject(at_).md>), but allows you to efficiently remove multiple objects with a single operation.
