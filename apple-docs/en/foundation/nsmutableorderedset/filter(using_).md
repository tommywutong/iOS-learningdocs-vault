...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsmutableorderedset/filter(using:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsmutableorderedset/filter(using:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsmutableorderedset/filter%28using%3A%29.json'
content_hash: 'sha256:0cb2fce6713d859e'
translated: false
---
