...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsswapbigdoubletohost(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsswapbigdoubletohost(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsswapbigdoubletohost%28_%3A%29.json'
content_hash: 'sha256:bdeafcf32806f78f'
translated: false
---
...
Converts the big-endian value in `x` to the current endian format and returns the resulting value. If it is necessary to swap the bytes of `x`, this function calls [NSSwapDouble](<nsswapdouble(__).md>) to perform the swap.
