---
title: ubiquitousItemDownloadRequested
...
beta: false
deprecated: false
doc_path: /documentation/foundation/urlresourcevalues/ubiquitousitemdownloadrequested
source_url: 'https://developer.apple.com/documentation/foundation/urlresourcevalues/ubiquitousitemdownloadrequested'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlresourcevalues/ubiquitousitemdownloadrequested.json'
content_hash: 'sha256:c082383fc3cf1239'
translated: false
---
...
You can request the download of a shared item with [- startDownloadingUbiquitousItemAtURL:error:](<../filemanager/startdownloadingubiquitousitem(at_).md>).
