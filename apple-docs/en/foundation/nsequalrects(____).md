...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsequalrects(_:_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsequalrects(_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsequalrects%28_%3A_%3A%29.json'
content_hash: 'sha256:be1d014fb6031e5b'
translated: false
---
...
[true](../swift/true.md) if `aRect` and `bRect` are identical, otherwise [false](../swift/false.md).
