...
beta: false
deprecated: false
doc_path: '/documentation/foundation/attributedstring/init(localized:defaultvalue:options:table:bundle:locale:comment:including:)-2elmp'
source_url: 'https://developer.apple.com/documentation/foundation/attributedstring/init(localized:defaultvalue:options:table:bundle:locale:comment:including:)-2elmp'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/attributedstring/init%28localized%3Adefaultvalue%3Aoptions%3Atable%3Abundle%3Alocale%3Acomment%3Aincluding%3A%29-2elmp.json'
content_hash: 'sha256:16c23ac3914a0a12'
translated: false
---
...
Use this initializer instead of [init(localized:options:table:bundle:locale:comment:including:)](<init(localized_options_table_bundle_locale_comment_including_)-8uknv.md>) if you prefer to use a symbolic string key, rather than use the development language’s string as the key.
