...
beta: false
deprecated: false
doc_path: '/documentation/foundation/attributedstring/transformingattributes(_:_:_:_:_:_:)-9hppo'
source_url: 'https://developer.apple.com/documentation/foundation/attributedstring/transformingattributes(_:_:_:_:_:_:)-9hppo'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/attributedstring/transformingattributes%28_%3A_%3A_%3A_%3A_%3A_%3A%29-9hppo.json'
content_hash: 'sha256:3c1af72c16498795'
translated: false
---
...
- `c` — A closure that receives five [SingleAttributeTransformer](singleattributetransformer.md) instances that you use to access and alter the attributes’ ranges and values.
