---
title: 'transformingAttributes(_:_:_:_:_:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/attributedstring/transformingattributes(_:_:_:_:_:)-9uodg'
source_url: 'https://developer.apple.com/documentation/foundation/attributedstring/transformingattributes(_:_:_:_:_:)-9uodg'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/attributedstring/transformingattributes%28_%3A_%3A_%3A_%3A_%3A%29-9uodg.json'
content_hash: 'sha256:ac2f5d0a426c20f8'
translated: false
---
...
- `c` — A closure that receives four [SingleAttributeTransformer](singleattributetransformer.md) instances that you use to access and alter the attributes’ ranges and values.
