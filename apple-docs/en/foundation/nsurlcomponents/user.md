...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsurlcomponents/user
source_url: 'https://developer.apple.com/documentation/foundation/nsurlcomponents/user'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurlcomponents/user.json'
content_hash: 'sha256:66bdb2d6b7e3c533'
translated: false
---
