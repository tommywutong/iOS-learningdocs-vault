...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsdata/datawithbytesnocopy:length:freewhendone:'
source_url: 'https://developer.apple.com/documentation/foundation/nsdata/datawithbytesnocopy:length:freewhendone:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsdata/datawithbytesnocopy%3Alength%3Afreewhendone%3A.json'
content_hash: 'sha256:7ecb41ec676cd5e9'
translated: false
---
...
- `bytes` — A buffer containing data for the new object. If `freeWhenDone` is [true](../../swift/true.md), `bytes` must point to a memory block allocated with `malloc`.
