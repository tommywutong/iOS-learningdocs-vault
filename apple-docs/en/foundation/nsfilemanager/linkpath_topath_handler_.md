...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nsfilemanager/linkpath:topath:handler:'
source_url: 'https://developer.apple.com/documentation/foundation/nsfilemanager/linkpath:topath:handler:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsfilemanager/linkpath%3Atopath%3Ahandler%3A.json'
content_hash: 'sha256:6df4154a7185a45b'
translated: false
---
...
> [!warning] Deprecated
> Use [- linkItemAtURL:toURL:error:](<../filemanager/linkitem(at_to_).md>) instead.
...
Because this method does not return error information, it has been deprecated as of OS X v10.5. Use [- removeItemAtPath:error:](<../filemanager/removeitem(atpath_).md>) instead.
