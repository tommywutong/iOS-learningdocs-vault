...
beta: false
deprecated: false
doc_path: /documentation/foundation/urlresourcekey/keysofunsetvalueskey
source_url: 'https://developer.apple.com/documentation/foundation/urlresourcekey/keysofunsetvalueskey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlresourcekey/keysofunsetvalueskey.json'
content_hash: 'sha256:770d1adeddf05896'
translated: false
---
...
Key for the resource properties that have not been set after the [- setResourceValues:error:](<../nsurl/setresourcevalues(__).md>) method returns an error, returned as an array of `NSString` objects.
