...
beta: false
deprecated: false
doc_path: /documentation/foundation/urlresourcekey/volumeidentifierkey
source_url: 'https://developer.apple.com/documentation/foundation/urlresourcekey/volumeidentifierkey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/urlresourcekey/volumeidentifierkey.json'
content_hash: 'sha256:ec47b33c5ce9fda9'
translated: false
---
...
This identifier can be used with the [isEqual(_:)](<../../objectivec/nsobjectprotocol/isequal(__).md>) method to determine whether two file system resources are on the same volume.
