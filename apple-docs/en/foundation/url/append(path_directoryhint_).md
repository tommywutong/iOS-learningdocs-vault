...
beta: false
deprecated: false
doc_path: '/documentation/foundation/url/append(path:directoryhint:)'
source_url: 'https://developer.apple.com/documentation/foundation/url/append(path:directoryhint:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/append%28path%3Adirectoryhint%3A%29.json'
content_hash: 'sha256:fe71e765d852cb49'
translated: false
---
...
This method doesn’t percent-encode any path separators (`/`) in the path component before appending the component to the path. If you want this encoding, use [append(component:directoryHint:)](<append(component_directoryhint_).md>) instead.
