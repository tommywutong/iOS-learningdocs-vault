...
beta: false
deprecated: false
doc_path: /documentation/foundation/url/documentsdirectory
source_url: 'https://developer.apple.com/documentation/foundation/url/documentsdirectory'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/documentsdirectory.json'
content_hash: 'sha256:df7895ce526e26cf'
translated: false
---
...
This computed property is equivalent to calling [NSSearchPathForDirectoriesInDomains](<../nssearchpathfordirectoriesindomains(______).md>) with the [NSDocumentDirectory](../filemanager/searchpathdirectory/documentdirectory.md) parameter.
