...
beta: false
deprecated: true
doc_path: /documentation/foundation/url/password
source_url: 'https://developer.apple.com/documentation/foundation/url/password'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/password.json'
content_hash: 'sha256:2f6e8acbfc87647e'
translated: false
---
...
New code should use [password(percentEncoded:)](<password(percentencoded_).md>) instead of this property.
