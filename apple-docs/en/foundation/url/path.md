...
beta: false
deprecated: true
doc_path: /documentation/foundation/url/path
source_url: 'https://developer.apple.com/documentation/foundation/url/path'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/path.json'
content_hash: 'sha256:9c6f32ab43426ff1'
translated: false
---
...
New code should use [path(percentEncoded:)](<path(percentencoded_).md>) instead of this property.
