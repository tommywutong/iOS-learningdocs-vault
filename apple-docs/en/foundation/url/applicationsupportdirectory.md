...
beta: false
deprecated: false
doc_path: /documentation/foundation/url/applicationsupportdirectory
source_url: 'https://developer.apple.com/documentation/foundation/url/applicationsupportdirectory'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/applicationsupportdirectory.json'
content_hash: 'sha256:0d000b166534ff06'
translated: false
---
...
This computed property is equivalent to calling [NSSearchPathForDirectoriesInDomains](<../nssearchpathfordirectoriesindomains(______).md>) with the [NSApplicationSupportDirectory](../filemanager/searchpathdirectory/applicationsupportdirectory.md) parameter.
