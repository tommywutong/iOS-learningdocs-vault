...
beta: false
deprecated: false
doc_path: /documentation/foundation/url/picturesdirectory
source_url: 'https://developer.apple.com/documentation/foundation/url/picturesdirectory'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/picturesdirectory.json'
content_hash: 'sha256:d7ac746cd278c81c'
translated: false
---
...
This computed property is equivalent to calling [NSSearchPathForDirectoriesInDomains](<../nssearchpathfordirectoriesindomains(______).md>) with the [NSPicturesDirectory](../filemanager/searchpathdirectory/picturesdirectory.md) parameter.
