...
beta: false
deprecated: true
doc_path: /documentation/foundation/url/query
source_url: 'https://developer.apple.com/documentation/foundation/url/query'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/query.json'
content_hash: 'sha256:e7844a7a343ae5d1'
translated: false
---
...
New code should use [query(percentEncoded:)](<query(percentencoded_).md>) instead of this property.
