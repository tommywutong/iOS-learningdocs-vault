...
beta: false
deprecated: false
doc_path: '/documentation/foundation/url/appending(component:directoryhint:)'
source_url: 'https://developer.apple.com/documentation/foundation/url/appending(component:directoryhint:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/appending%28component%3Adirectoryhint%3A%29.json'
content_hash: 'sha256:90763fd16239958b'
translated: false
---
...
This method percent-encodes any path separators (`/`) in the path component before appending the component to the path. If you don’t want this encoding, use [appending(path:directoryHint:)](<appending(path_directoryhint_).md>) instead.
