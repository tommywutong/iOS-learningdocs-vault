...
beta: false
deprecated: false
doc_path: /documentation/foundation/url/applicationdirectory
source_url: 'https://developer.apple.com/documentation/foundation/url/applicationdirectory'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/applicationdirectory.json'
content_hash: 'sha256:21f5c0cd8f068c05'
translated: false
---
...
This computed property is equivalent to calling [NSSearchPathForDirectoriesInDomains](<../nssearchpathfordirectoriesindomains(______).md>) with the [NSApplicationDirectory](../filemanager/searchpathdirectory/applicationdirectory.md) parameter.
