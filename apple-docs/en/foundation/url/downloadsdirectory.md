...
beta: false
deprecated: false
doc_path: /documentation/foundation/url/downloadsdirectory
source_url: 'https://developer.apple.com/documentation/foundation/url/downloadsdirectory'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/downloadsdirectory.json'
content_hash: 'sha256:16f315b542e528eb'
translated: false
---
...
This computed property is equivalent to calling [NSSearchPathForDirectoriesInDomains](<../nssearchpathfordirectoriesindomains(______).md>) with the [NSDownloadsDirectory](../filemanager/searchpathdirectory/downloadsdirectory.md) parameter.
