...
beta: false
deprecated: true
doc_path: /documentation/foundation/url/user
source_url: 'https://developer.apple.com/documentation/foundation/url/user'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/user.json'
content_hash: 'sha256:43d6434b6c824942'
translated: false
---
...
New code should use [user(percentEncoded:)](<user(percentencoded_).md>) instead of this property.
