...
beta: false
deprecated: false
doc_path: '/documentation/foundation/url/user(percentencoded:)'
source_url: 'https://developer.apple.com/documentation/foundation/url/user(percentencoded:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/url/user%28percentencoded%3A%29.json'
content_hash: 'sha256:11356eacc4a7a10a'
translated: false
---
