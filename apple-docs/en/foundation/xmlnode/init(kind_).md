...
beta: false
deprecated: false
doc_path: '/documentation/foundation/xmlnode/init(kind:)'
source_url: 'https://developer.apple.com/documentation/foundation/xmlnode/init(kind:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/xmlnode/init%28kind%3A%29.json'
content_hash: 'sha256:700857d51310f73b'
translated: false
---
...
This method invokes [- initWithKind:options:](<init(kind_options_).md>) with the `options` parameter set to `NSXMLNodeOptionsNone`.
