...
beta: false
deprecated: false
doc_path: /documentation/foundation/nslocalizedstring
source_url: 'https://developer.apple.com/documentation/foundation/nslocalizedstring'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocalizedstring.json'
content_hash: 'sha256:f8ab1c4fee9b7dec'
translated: false
---
...
- `key` — The key for a string in the default table. > [!note] Note > Xcode can’t export localizations for strings whose `key` is a string variable, `nil`, or an empty string.
...
The result of sending [- localizedStringForKey:value:table:](<bundle/localizedstring(forkey_value_table_).md>) to the main bundle, passing the specified `key`.
...
As of OS X 10.11 and iOS 9, [Bundle](bundle.md) is thread-safe. As such, you can safely call [NSLocalizedString](nslocalizedstring.md) from any execution context.
