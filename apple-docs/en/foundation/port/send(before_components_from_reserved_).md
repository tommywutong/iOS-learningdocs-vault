---
title: 'send(before:components:from:reserved:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/port/send(before:components:from:reserved:)'
source_url: 'https://developer.apple.com/documentation/foundation/port/send(before:components:from:reserved:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/port/send%28before%3Acomponents%3Afrom%3Areserved%3A%29.json'
content_hash: 'sha256:6615fb75d0874b1f'
translated: false
---
