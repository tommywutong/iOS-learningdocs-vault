...
beta: false
deprecated: false
doc_path: /documentation/foundation/floatingpointformatstyle/percent
source_url: 'https://developer.apple.com/documentation/foundation/floatingpointformatstyle/percent'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/floatingpointformatstyle/percent.json'
content_hash: 'sha256:4326a17db3760e7e'
translated: false
---
...
- [init(locale:)](<percent/init(locale_).md>) — Creates a floating-point percent format style that uses the given locale.
...
- [format(_:)](<percent/format(__).md>) — Formats an floating-point value, using this style.
...
- [Currency](currency.md) — A format style that converts between floating-point currency values and their textual representations.
