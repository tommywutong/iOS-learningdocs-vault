...
beta: false
deprecated: false
doc_path: /documentation/foundation/floatingpointformatstyle/currency
source_url: 'https://developer.apple.com/documentation/foundation/floatingpointformatstyle/currency'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/floatingpointformatstyle/currency.json'
content_hash: 'sha256:59374582efb02053'
translated: false
---
...
- [init(code:locale:)](<currency/init(code_locale_).md>) — Creates a floating-point currency format style that uses the given currency code and locale.
...
- [format(_:)](<currency/format(__).md>) — Formats a floating-point value, using this style.
