...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsswaplittlefloattohost(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsswaplittlefloattohost(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsswaplittlefloattohost%28_%3A%29.json'
content_hash: 'sha256:eeec6cccdd14f749'
translated: false
---
...
Converts the little-endian formatted value in `x` to the current endian format and returns the resulting value. If it is necessary to swap the bytes of `x`, this function calls [NSSwapFloat](<nsswapfloat(__).md>) to perform the swap.
