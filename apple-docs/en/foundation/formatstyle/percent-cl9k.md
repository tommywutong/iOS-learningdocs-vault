...
beta: false
deprecated: false
doc_path: /documentation/foundation/formatstyle/percent-cl9k
source_url: 'https://developer.apple.com/documentation/foundation/formatstyle/percent-cl9k'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/formatstyle/percent-cl9k.json'
content_hash: 'sha256:38b044f9c9183d76'
translated: false
---
...
Use the this type property when the call point allows the use of [IntegerFormatStyle](../integerformatstyle.md). You typically do this when calling the `formatted` methods of types that conform to [BinaryInteger](../../swift/binaryinteger.md).
...
- [percent](percent-1f0q.md) — A style for formatting 32-bit signed integers as a percent representation.
