...
beta: false
deprecated: false
doc_path: '/documentation/foundation/floatingpointparsestrategy/init(format:lenient:)-9g6wm'
source_url: 'https://developer.apple.com/documentation/foundation/floatingpointparsestrategy/init(format:lenient:)-9g6wm'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/floatingpointparsestrategy/init%28format%3Alenient%3A%29-9g6wm.json'
content_hash: 'sha256:fb22ed19e177d47c'
translated: false
---
...
- `format` — A configured [Currency](../floatingpointformatstyle/currency.md) that describes the currency string format to parse.
