---
title: 'didLoadBytes:loadComplete:'
...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nsurlhandle/didloadbytes:loadcomplete:'
source_url: 'https://developer.apple.com/documentation/foundation/nsurlhandle/didloadbytes:loadcomplete:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurlhandle/didloadbytes%3Aloadcomplete%3A.json'
content_hash: 'sha256:99a78b284572e29b'
translated: false
---
...
- `yorn` — [true](../../swift/true.md) if newBytes contains the last piece of data for the URL, [false](../../swift/false.md) otherwise.
