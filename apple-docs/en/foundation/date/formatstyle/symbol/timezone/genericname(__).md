...
beta: false
deprecated: false
doc_path: '/documentation/foundation/date/formatstyle/symbol/timezone/genericname(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/date/formatstyle/symbol/timezone/genericname(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/date/formatstyle/symbol/timezone/genericname%28_%3A%29.json'
content_hash: 'sha256:1a58bd3e2fbcbd0d'
translated: false
---
...
The value falls back to the value of [localizedGMT(_:)](<localizedgmt(__).md>) with a `short` width if unavailable. For example, `PT` ([Date.FormatStyle.Symbol.TimeZone.Width.short](width/short.md)) or `Pacific Time` ([Date.FormatStyle.Symbol.TimeZone.Width.long](width/long.md)).
