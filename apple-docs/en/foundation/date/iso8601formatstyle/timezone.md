...
beta: false
deprecated: false
doc_path: /documentation/foundation/date/iso8601formatstyle/timezone
source_url: 'https://developer.apple.com/documentation/foundation/date/iso8601formatstyle/timezone'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/date/iso8601formatstyle/timezone.json'
content_hash: 'sha256:33d15cd7d9c237f4'
translated: false
---
...
- [dateTimeSeparator(_:)](<datetimeseparator(__).md>) — Sets the character that specifies the date and time components.
