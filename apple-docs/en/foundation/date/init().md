...
beta: false
deprecated: false
doc_path: /documentation/foundation/date/init()
source_url: 'https://developer.apple.com/documentation/foundation/date/init()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/date/init%28%29.json'
content_hash: 'sha256:2c656c380cf4d286'
translated: false
---
...
- [init(timeInterval:since:)](<init(timeinterval_since_).md>) — Creates a date value initialized relative to another given date by a given number of seconds.
