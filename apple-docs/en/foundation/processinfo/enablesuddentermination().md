...
beta: false
deprecated: false
doc_path: /documentation/foundation/processinfo/enablesuddentermination()
source_url: 'https://developer.apple.com/documentation/foundation/processinfo/enablesuddentermination()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/processinfo/enablesuddentermination%28%29.json'
content_hash: 'sha256:e1e166e6f662ba30'
translated: false
---
...
- [- disableSuddenTermination](<disablesuddentermination().md>) — Disables the application for quickly killing using sudden termination.
