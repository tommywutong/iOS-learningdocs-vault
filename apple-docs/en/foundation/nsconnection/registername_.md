...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nsconnection/registername:'
source_url: 'https://developer.apple.com/documentation/foundation/nsconnection/registername:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsconnection/registername%3A.json'
content_hash: 'sha256:9125951ce2a51c54'
translated: false
---
...
To unregister an `NSConnection` object, simply invoke [registerName:](registername_.md) and supply `nil` as the connection name. Unregistering is currently only supported for [SocketPort](../socketport.md)-based connections.
