...
beta: false
deprecated: false
doc_path: '/documentation/foundation/scanner/scanhexdouble(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/scanner/scanhexdouble(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/scanner/scanhexdouble%28_%3A%29.json'
content_hash: 'sha256:fddc0b21b9147c60'
translated: false
---
...
[true](../../swift/true.md) if the receiver finds a valid double-point representation, otherwise [false](../../swift/false.md). Overflow or underflow are both considered valid floating-point representations.
