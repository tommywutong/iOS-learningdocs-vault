...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:forkey:)-9imtu'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-9imtu'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3Aforkey%3A%29-9imtu.json'
content_hash: 'sha256:1cc627ced0168f2d'
translated: false
---
...
- [- decodeSizeForKey:](<decodesize(forkey_).md>) — Decodes and returns an NSSize structure that was previously encoded with [- encodeSize:forKey:](<encode(__forkey_)-9imtu.md>).
