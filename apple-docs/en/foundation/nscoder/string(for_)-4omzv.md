...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/string(for:)-4omzv'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/string(for:)-4omzv'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/string%28for%3A%29-4omzv.json'
content_hash: 'sha256:da86dc3fdb64063b'
translated: false
---
...
A string that corresponds to `vector`. See [cgVector(for:)](<cgvector(for_).md>) for a discussion of the string format.
