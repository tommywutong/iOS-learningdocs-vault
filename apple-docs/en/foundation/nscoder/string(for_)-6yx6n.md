...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/string(for:)-6yx6n'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/string(for:)-6yx6n'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/string%28for%3A%29-6yx6n.json'
content_hash: 'sha256:84494e2b9bcab53a'
translated: false
---
...
A string that corresponds to `transform`. See [cgAffineTransform(for:)](<cgaffinetransform(for_).md>) for a discussion of the string format.
