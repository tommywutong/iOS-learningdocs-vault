...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:forkey:)-2knxx'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-2knxx'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3Aforkey%3A%29-2knxx.json'
content_hash: 'sha256:b3304b45e252a693'
translated: false
---
...
- [- decodeRectForKey:](<decoderect(forkey_).md>) — Decodes and returns an NSRect structure that was previously encoded with [- encodeRect:forKey:](<encode(__forkey_)-2knxx.md>).
