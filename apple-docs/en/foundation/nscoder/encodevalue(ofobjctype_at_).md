...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encodevalue(ofobjctype:at:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encodevalue(ofobjctype:at:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encodevalue%28ofobjctype%3Aat%3A%29.json'
content_hash: 'sha256:24eb7c02b391dd64'
translated: false
---
...
Subclasses must override this method, and match it with a subsequent [- decodeValueOfObjCType:at:](<decodevalue(ofobjctype_at_).md>) message.
