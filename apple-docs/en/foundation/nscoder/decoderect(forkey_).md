...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/decoderect(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decoderect(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decoderect%28forkey%3A%29.json'
content_hash: 'sha256:0c50d438764c1849'
translated: false
---
...
Decodes and returns an NSRect structure that was previously encoded with [- encodeRect:forKey:](<encode(__forkey_)-2knxx.md>).
