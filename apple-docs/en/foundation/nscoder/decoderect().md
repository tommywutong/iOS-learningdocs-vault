...
beta: false
deprecated: false
doc_path: /documentation/foundation/nscoder/decoderect()
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decoderect()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decoderect%28%29.json'
content_hash: 'sha256:d871bb5aeafbb4b5'
translated: false
---
...
Decodes and returns an NSRect structure that was previously encoded with [- encodeRect:](<encode(__)-3c1wz.md>).
