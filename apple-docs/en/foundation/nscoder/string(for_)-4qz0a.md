...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/string(for:)-4qz0a'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/string(for:)-4qz0a'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/string%28for%3A%29-4qz0a.json'
content_hash: 'sha256:c5e35eb46c2ac16d'
translated: false
---
...
A string that corresponds to `rect`. See [cgRect(for:)](<cgrect(for_).md>) for a discussion of the string format.
