...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/decodedouble(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decodedouble(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decodedouble%28forkey%3A%29.json'
content_hash: 'sha256:ed8f12b43a80be4a'
translated: false
---
...
Decodes and returns a double value that was previously encoded with either [- encodeFloat:forKey:](<encode(__forkey_)-84cez.md>) or [- encodeDouble:forKey:](<encode(__forkey_)-9xiiu.md>) and associated with the string `key`.
