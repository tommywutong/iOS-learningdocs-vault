...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:)-82i7c'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:)-82i7c'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3A%29-82i7c.json'
content_hash: 'sha256:ec553d9391db8d04'
translated: false
---
...
`NSCoder`’s implementation invokes [- encodeValueOfObjCType:at:](<encodevalue(ofobjctype_at_).md>) to encode `size`.

This method must be matched by a subsequent [- decodeSize](<decodesize().md>) message.
