...
beta: false
deprecated: true
doc_path: '/documentation/foundation/nscoder/encodenxobject:'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encodenxobject:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encodenxobject%3A.json'
content_hash: 'sha256:4f607e8dd6fe74b9'
translated: false
---
...
No sharing is done across separate [encodeNXObject:](encodenxobject_.md) invocations. Callers must have implemented an [- encodeWithCoder:](<../nscoding/encode(with_).md>), which parallels the `write:` methods, on all of their classes that may be touched by this operation.
