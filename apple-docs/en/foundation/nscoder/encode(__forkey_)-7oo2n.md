...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:forkey:)-7oo2n'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-7oo2n'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3Aforkey%3A%29-7oo2n.json'
content_hash: 'sha256:dff7ad0faeb56e74'
translated: false
---
...
When decoding the data from the archive, you pass the value in the key parameter to the corresponding [- decodeDirectionalEdgeInsetsForKey:](<decodedirectionaledgeinsets(forkey_).md>) method to retrieve the data.
