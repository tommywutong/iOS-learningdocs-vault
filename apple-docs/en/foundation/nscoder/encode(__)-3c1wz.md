...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:)-3c1wz'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:)-3c1wz'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3A%29-3c1wz.json'
content_hash: 'sha256:7069f0cb0d256315'
translated: false
---
...
`NSCoder`’s implementation invokes [- encodeValueOfObjCType:at:](<encodevalue(ofobjctype_at_).md>) to encode `rect`.

This method must be matched by a subsequent [- decodeRect](<decoderect().md>) message.
