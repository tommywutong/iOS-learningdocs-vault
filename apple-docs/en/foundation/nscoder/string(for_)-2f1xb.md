...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/string(for:)-2f1xb'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/string(for:)-2f1xb'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/string%28for%3A%29-2f1xb.json'
content_hash: 'sha256:be93280ecaa7de96'
translated: false
---
...
A string that corresponds to `size`. See [cgSize(for:)](<cgsize(for_).md>) for a discussion of the string format.
