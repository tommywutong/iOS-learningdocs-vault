...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encodebycopyobject(_:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encodebycopyobject(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encodebycopyobject%28_%3A%29.json'
content_hash: 'sha256:a35dd5f91fb4d95b'
translated: false
---
...
This method must be matched by a corresponding [- decodeObject](<decodeobject().md>) message.
