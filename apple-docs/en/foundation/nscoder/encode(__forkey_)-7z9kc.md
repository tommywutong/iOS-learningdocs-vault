...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/encode(_:forkey:)-7z9kc'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/encode(_:forkey:)-7z9kc'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/encode%28_%3Aforkey%3A%29-7z9kc.json'
content_hash: 'sha256:bc93cf8bcfdea65e'
translated: false
---
...
When decoding the data from the archive, you pass the value in the `key` parameter to the corresponding [- decodeCGPointForKey:](<decodecgpoint(forkey_).md>) method to retrieve the data.
