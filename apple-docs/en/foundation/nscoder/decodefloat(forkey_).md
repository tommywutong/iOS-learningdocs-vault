...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/decodefloat(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decodefloat(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decodefloat%28forkey%3A%29.json'
content_hash: 'sha256:79c231781faf06ef'
translated: false
---
...
Decodes and returns a float value that was previously encoded with [- encodeFloat:forKey:](<encode(__forkey_)-84cez.md>) or [- encodeDouble:forKey:](<encode(__forkey_)-9xiiu.md>) and associated with the string `key`.
