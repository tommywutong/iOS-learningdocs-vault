...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/string(for:)-6ix86'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/string(for:)-6ix86'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/string%28for%3A%29-6ix86.json'
content_hash: 'sha256:655f9b17e535c457'
translated: false
---
...
A string that corresponds to `point`. See [cgPoint(for:)](<cgpoint(for_).md>) for a discussion of the string format.
