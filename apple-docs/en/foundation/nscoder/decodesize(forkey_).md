...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/decodesize(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decodesize(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decodesize%28forkey%3A%29.json'
content_hash: 'sha256:9ee1dffa98d05111'
translated: false
---
...
Decodes and returns an NSSize structure that was previously encoded with [- encodeSize:forKey:](<encode(__forkey_)-9imtu.md>).
