...
beta: false
deprecated: false
doc_path: /documentation/foundation/nscoder/decodepoint()
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decodepoint()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decodepoint%28%29.json'
content_hash: 'sha256:f82ccdf0276f41bf'
translated: false
---
...
Decodes and returns an NSPoint structure that was previously encoded with [- encodePoint:](<encode(__)-75jv4.md>).
