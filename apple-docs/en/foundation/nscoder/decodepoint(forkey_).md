...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nscoder/decodepoint(forkey:)'
source_url: 'https://developer.apple.com/documentation/foundation/nscoder/decodepoint(forkey:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nscoder/decodepoint%28forkey%3A%29.json'
content_hash: 'sha256:d59d0fefdd174572'
translated: false
---
...
Decodes and returns an NSPoint structure that was previously encoded with [- encodePoint:forKey:](<encode(__forkey_)-27lif.md>).
