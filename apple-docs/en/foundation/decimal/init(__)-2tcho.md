...
beta: false
deprecated: false
doc_path: '/documentation/foundation/decimal/init(_:)-2tcho'
source_url: 'https://developer.apple.com/documentation/foundation/decimal/init(_:)-2tcho'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/decimal/init%28_%3A%29-2tcho.json'
content_hash: 'sha256:d008cecff845dff1'
translated: false
---
...
- [init(exactly:)](<init(exactly_).md>) — Creates a new decimal value exactly representing the provided integer.
