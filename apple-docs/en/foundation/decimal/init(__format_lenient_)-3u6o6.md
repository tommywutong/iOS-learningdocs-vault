...
beta: false
deprecated: false
doc_path: '/documentation/foundation/decimal/init(_:format:lenient:)-3u6o6'
source_url: 'https://developer.apple.com/documentation/foundation/decimal/init(_:format:lenient:)-3u6o6'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/decimal/init%28_%3Aformat%3Alenient%3A%29-3u6o6.json'
content_hash: 'sha256:053a006721470f6e'
translated: false
---
...
- `format` — A format style that describes percent formatting conventions used by the string. The initializer uses this format’s [ParseStrategy](parsestrategy.md) to parse the string.
