...
beta: false
deprecated: false
doc_path: /documentation/foundation/decimal/issubnormal
source_url: 'https://developer.apple.com/documentation/foundation/decimal/issubnormal'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/decimal/issubnormal.json'
content_hash: 'sha256:33c9cfd8c9219400'
translated: false
---
...
A _subnormal_ value is a nonzero number that has a lesser magnitude than the smallest normal number. Subnormal values do not use the full precision available to values of a type.
