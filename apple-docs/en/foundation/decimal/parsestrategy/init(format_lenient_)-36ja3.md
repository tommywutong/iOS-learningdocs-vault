...
beta: false
deprecated: false
doc_path: '/documentation/foundation/decimal/parsestrategy/init(format:lenient:)-36ja3'
source_url: 'https://developer.apple.com/documentation/foundation/decimal/parsestrategy/init(format:lenient:)-36ja3'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/decimal/parsestrategy/init%28format%3Alenient%3A%29-36ja3.json'
content_hash: 'sha256:fc80943b34fa942f'
translated: false
---
...
- `format` — A configured [FormatStyle](../formatstyle.md) that describes the percent string format to parse.
