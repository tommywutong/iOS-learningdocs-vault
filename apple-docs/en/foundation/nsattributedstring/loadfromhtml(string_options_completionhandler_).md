---
title: 'loadFromHTML(string:options:completionHandler:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsattributedstring/loadfromhtml(string:options:completionhandler:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsattributedstring/loadfromhtml(string:options:completionhandler:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsattributedstring/loadfromhtml%28string%3Aoptions%3Acompletionhandler%3A%29.json'
content_hash: 'sha256:2f717d08e44d1c29'
translated: false
---
