...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsregularexpression/matchingoptions/anchored
source_url: 'https://developer.apple.com/documentation/foundation/nsregularexpression/matchingoptions/anchored'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsregularexpression/matchingoptions/anchored.json'
content_hash: 'sha256:83f2c207672ce7f2'
translated: false
---
...
Specifies that matches are limited to those at the start of the search range. See [- enumerateMatchesInString:options:range:usingBlock:](<../enumeratematches(in_options_range_using_).md>) for a description of the constant in context.
