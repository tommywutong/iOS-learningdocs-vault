...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsfilehandle/getoffset:error:'
source_url: 'https://developer.apple.com/documentation/foundation/nsfilehandle/getoffset:error:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsfilehandle/getoffset%3Aerror%3A.json'
content_hash: 'sha256:afcbb6c90405c15b'
translated: false
---
...
- `offsetInFile` — When the return value is [true](../../swift/true.md), this provides the current position of the file pointer within the file.
