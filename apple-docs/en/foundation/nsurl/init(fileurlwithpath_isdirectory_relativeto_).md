---
title: 'init(fileURLWithPath:isDirectory:relativeTo:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsurl/init(fileurlwithpath:isdirectory:relativeto:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsurl/init(fileurlwithpath:isdirectory:relativeto:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurl/init%28fileurlwithpath%3Aisdirectory%3Arelativeto%3A%29.json'
content_hash: 'sha256:754a9688460db2f7'
translated: false
---
