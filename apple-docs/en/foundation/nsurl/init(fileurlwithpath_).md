...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsurl/init(fileurlwithpath:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsurl/init(fileurlwithpath:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurl/init%28fileurlwithpath%3A%29.json'
content_hash: 'sha256:e755b4cb6cbfb029'
translated: false
---
...
Invoking this method is equivalent to invoking [- initWithScheme:host:path:](<init(scheme_host_path_).md>) with scheme [NSURLFileScheme](../nsurlfilescheme.md), a `nil` host, and `path`.
...
As an alternative, consider using [- initFileURLWithPath:isDirectory:](<init(fileurlwithpath_isdirectory_).md>), which allows you to explicitly specify whether the returned `NSURL` object represents a file or directory.
