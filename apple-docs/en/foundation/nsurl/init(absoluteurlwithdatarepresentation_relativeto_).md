---
title: 'init(absoluteURLWithDataRepresentation:relativeTo:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nsurl/init(absoluteurlwithdatarepresentation:relativeto:)'
source_url: 'https://developer.apple.com/documentation/foundation/nsurl/init(absoluteurlwithdatarepresentation:relativeto:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsurl/init%28absoluteurlwithdatarepresentation%3Arelativeto%3A%29.json'
content_hash: 'sha256:3db378e5e769d531'
translated: false
---
