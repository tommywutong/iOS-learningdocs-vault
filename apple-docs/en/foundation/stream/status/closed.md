...
beta: false
deprecated: false
doc_path: /documentation/foundation/stream/status/closed
source_url: 'https://developer.apple.com/documentation/foundation/stream/status/closed'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/stream/status/closed.json'
content_hash: 'sha256:36f85a8b6e2de503'
translated: false
---
...
The stream is closed ([- close](<../close().md>) has been called on it).
