...
beta: false
deprecated: false
doc_path: /documentation/foundation/stream/status/error
source_url: 'https://developer.apple.com/documentation/foundation/stream/status/error'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/stream/status/error.json'
content_hash: 'sha256:a2e5b5d8e2d10aba'
translated: false
---
