---
title: 'date(byAdding:value:to:wrappingComponents:)'
...
beta: false
deprecated: false
doc_path: '/documentation/foundation/calendar/date(byadding:value:to:wrappingcomponents:)'
source_url: 'https://developer.apple.com/documentation/foundation/calendar/date(byadding:value:to:wrappingcomponents:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/calendar/date%28byadding%3Avalue%3Ato%3Awrappingcomponents%3A%29.json'
content_hash: 'sha256:7d54690974983640'
translated: false
---
