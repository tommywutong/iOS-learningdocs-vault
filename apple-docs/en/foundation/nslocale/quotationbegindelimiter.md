...
beta: false
deprecated: false
doc_path: /documentation/foundation/nslocale/quotationbegindelimiter
source_url: 'https://developer.apple.com/documentation/foundation/nslocale/quotationbegindelimiter'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocale/quotationbegindelimiter.json'
content_hash: 'sha256:3dc32d05de8d366f'
translated: false
---
...
This property contains the same value returned by the [- objectForKey:](<object(forkey_).md>) method when passing the [NSLocaleQuotationBeginDelimiterKey](key/quotationbegindelimiterkey.md) key.
