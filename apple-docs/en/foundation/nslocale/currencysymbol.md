...
beta: false
deprecated: false
doc_path: /documentation/foundation/nslocale/currencysymbol
source_url: 'https://developer.apple.com/documentation/foundation/nslocale/currencysymbol'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocale/currencysymbol.json'
content_hash: 'sha256:e68679efae9757a4'
translated: false
---
...
This property contains the same value returned by the [- objectForKey:](<object(forkey_).md>) method when passing the [NSLocaleCurrencySymbol](key/currencysymbol.md) key.
