...
beta: false
deprecated: false
doc_path: /documentation/foundation/nslocale/alternatequotationenddelimiter
source_url: 'https://developer.apple.com/documentation/foundation/nslocale/alternatequotationenddelimiter'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nslocale/alternatequotationenddelimiter.json'
content_hash: 'sha256:8ae77702722bb4bc'
translated: false
---
...
This property contains the same value returned by the [- objectForKey:](<object(forkey_).md>) method when passing the [NSLocaleAlternateQuotationEndDelimiterKey](key/alternatequotationenddelimiterkey.md) key.
