...
beta: false
deprecated: false
doc_path: '/documentation/foundation/nstextcheckingresult/datecheckingresult(range:date:)'
source_url: 'https://developer.apple.com/documentation/foundation/nstextcheckingresult/datecheckingresult(range:date:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nstextcheckingresult/datecheckingresult%28range%3Adate%3A%29.json'
content_hash: 'sha256:57af350300257080'
translated: false
---
...
- [+ dateCheckingResultWithRange:date:timeZone:duration:](<datecheckingresult(range_date_timezone_duration_).md>) — Creates and returns a text checking result with the specified date, time zone, and duration.
