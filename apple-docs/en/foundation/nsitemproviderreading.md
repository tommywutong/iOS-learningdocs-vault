...
beta: false
deprecated: false
doc_path: /documentation/foundation/nsitemproviderreading
source_url: 'https://developer.apple.com/documentation/foundation/nsitemproviderreading'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/foundation/nsitemproviderreading.json'
content_hash: 'sha256:6bdae6d02179781e'
translated: false
---
...
- [+ objectWithItemProviderData:typeIdentifier:error:](<nsitemproviderreading/object(withitemproviderdata_typeidentifier_).md>) — Creates a new instance of a class using the given data and UTI string.
