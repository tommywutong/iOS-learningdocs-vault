---
title: dispatch_introspection_hook_queue_item_complete
framework: Dispatch
symbol_kind: func
role: symbol
role_heading: Function
platforms: [iOS 7.1+, iPadOS 7.1+, Mac Catalyst 13.1+, macOS 10.10+, tvOS, visionOS 1.0+, watchOS 2.0+]
languages: [occ]
beta: false
deprecated: false
doc_path: /documentation/dispatch/dispatch_introspection_hook_queue_item_complete
source_url: 'https://developer.apple.com/documentation/dispatch/dispatch_introspection_hook_queue_item_complete'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/dispatch/dispatch_introspection_hook_queue_item_complete.json'
content_hash: 'sha256:97e1782522683663'
translated: false
---
...
```objc
extern void dispatch_introspection_hook_queue_item_complete(dispatch_object_t item);
```
