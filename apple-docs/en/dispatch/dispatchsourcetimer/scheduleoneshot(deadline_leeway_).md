---
title: 'scheduleOneshot(deadline:leeway:)'
framework: Dispatch
symbol_kind: method
role: symbol
...
beta: false
deprecated: true
doc_path: '/documentation/dispatch/dispatchsourcetimer/scheduleoneshot(deadline:leeway:)'
source_url: 'https://developer.apple.com/documentation/dispatch/dispatchsourcetimer/scheduleoneshot(deadline:leeway:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/dispatch/dispatchsourcetimer/scheduleoneshot%28deadline%3Aleeway%3A%29.json'
content_hash: 'sha256:89cf9c9cadb65609'
translated: false
---
