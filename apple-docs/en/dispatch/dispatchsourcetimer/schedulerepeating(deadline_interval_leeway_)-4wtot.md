...
beta: false
deprecated: true
doc_path: '/documentation/dispatch/dispatchsourcetimer/schedulerepeating(deadline:interval:leeway:)-4wtot'
source_url: 'https://developer.apple.com/documentation/dispatch/dispatchsourcetimer/schedulerepeating(deadline:interval:leeway:)-4wtot'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/dispatch/dispatchsourcetimer/schedulerepeating%28deadline%3Ainterval%3Aleeway%3A%29-4wtot.json'
content_hash: 'sha256:93770a22b9a8e7c6'
translated: false
---
...
> [!warning] Deprecated
> Use [schedule(deadline:repeating:leeway:)](<schedule(deadline_repeating_leeway_)-24w9r.md>) instead.
