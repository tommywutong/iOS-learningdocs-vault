...
beta: false
deprecated: true
doc_path: '/documentation/dispatch/dispatchsourcetimer/schedulerepeating(walldeadline:interval:leeway:)-6fiox'
source_url: 'https://developer.apple.com/documentation/dispatch/dispatchsourcetimer/schedulerepeating(walldeadline:interval:leeway:)-6fiox'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/dispatch/dispatchsourcetimer/schedulerepeating%28walldeadline%3Ainterval%3Aleeway%3A%29-6fiox.json'
content_hash: 'sha256:c20997bac5fb4bd4'
translated: false
---
...
> [!warning] Deprecated
> Use [schedule(wallDeadline:repeating:leeway:)](<schedule(walldeadline_repeating_leeway_)-21bay.md>) instead.
