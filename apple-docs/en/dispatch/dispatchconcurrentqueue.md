...
beta: false
deprecated: false
doc_path: /documentation/dispatch/dispatchconcurrentqueue
source_url: 'https://developer.apple.com/documentation/dispatch/dispatchconcurrentqueue'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/dispatch/dispatchconcurrentqueue.json'
content_hash: 'sha256:62f8cd6e83d60463'
translated: false
---
...
- [Attributes](dispatchconcurrentqueue/attributes.md)

### Initializers

- [init(label:qos:attributes:autoreleaseFrequency:target:)](<dispatchconcurrentqueue/init(label_qos_attributes_autoreleasefrequency_target_).md>)
