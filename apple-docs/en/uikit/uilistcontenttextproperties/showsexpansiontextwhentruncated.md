...
platforms: [iOS 14.0+, iPadOS 14.0+, Mac Catalyst 16.0+, tvOS 14.0+, visionOS 1.0+]
languages: [occ]
beta: false
deprecated: false
doc_path: /documentation/uikit/uilistcontenttextproperties/showsexpansiontextwhentruncated
source_url: 'https://developer.apple.com/documentation/uikit/uilistcontenttextproperties/showsexpansiontextwhentruncated'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uilistcontenttextproperties/showsexpansiontextwhentruncated.json'
content_hash: 'sha256:6e1646fdd3def6ba'
translated: false
---
