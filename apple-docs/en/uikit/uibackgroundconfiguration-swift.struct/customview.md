...
beta: false
deprecated: false
doc_path: /documentation/uikit/uibackgroundconfiguration-swift.struct/customview
source_url: 'https://developer.apple.com/documentation/uikit/uibackgroundconfiguration-swift.struct/customview'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uibackgroundconfiguration-swift.struct/customview.json'
content_hash: 'sha256:29e9d4d20030d590'
translated: false
---
...
The custom view must have [translatesAutoresizingMaskIntoConstraints](../uiview/translatesautoresizingmaskintoconstraints.md) set to [true](../../swift/true.md), but it can use Auto Layout constraints internally for layout of its subviews.
