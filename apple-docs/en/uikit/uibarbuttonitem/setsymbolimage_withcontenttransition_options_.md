---
title: 'setSymbolImage:withContentTransition:options:'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uibarbuttonitem/setsymbolimage:withcontenttransition:options:'
source_url: 'https://developer.apple.com/documentation/uikit/uibarbuttonitem/setsymbolimage:withcontenttransition:options:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uibarbuttonitem/setsymbolimage%3Awithcontenttransition%3Aoptions%3A.json'
content_hash: 'sha256:b2eab1ae2a7d679d'
translated: false
---
