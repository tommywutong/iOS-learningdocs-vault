...
beta: false
deprecated: true
doc_path: /documentation/uikit/uitableviewcell/detailtextlabel
source_url: 'https://developer.apple.com/documentation/uikit/uitableviewcell/detailtextlabel'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitableviewcell/detailtextlabel.json'
content_hash: 'sha256:5b74b5ccd76fc9bb'
translated: false
---
...
> [!warning] Deprecated
> Use a content configuration to manage the cell’s text instead. Use [defaultContentConfiguration()](<defaultcontentconfiguration().md>) to get a default list content configuration, set your secondary text to the [secondaryText](../uilistcontentconfiguration-swift.struct/secondarytext.md) property of the configuration, and apply the configuration by setting it to the [contentConfiguration](contentconfiguration-9ktox.md) property of the cell.
...
Holds the secondary (or detail) label of the cell. `UITableViewCell` adds an appropriate label when you create the cell in a style that supports secondary labels. If the style doesn’t support detail labels, `nil` returns. See [CellStyle](cellstyle.md) for descriptions of the main label in currently defined cell styles.
