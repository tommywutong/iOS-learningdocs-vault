...
beta: false
deprecated: true
doc_path: /documentation/uikit/uiapplication/beginignoringinteractionevents()
source_url: 'https://developer.apple.com/documentation/uikit/uiapplication/beginignoringinteractionevents()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiapplication/beginignoringinteractionevents%28%29.json'
content_hash: 'sha256:d1d1723fb5911ac2'
translated: false
---
...
You typically call this method before starting an animation or transition. Calls are nested with the [- endIgnoringInteractionEvents](<endignoringinteractionevents().md>) method.
