...
platforms: [iOS 3.0+（26.0 起废弃）, iPadOS 3.0+（26.0 起废弃）, Mac Catalyst 13.1+（26.0 起废弃）, visionOS 1.0+（26.0 起废弃）]
languages: [swift, swift, occ, occ]
beta: false
deprecated: true
doc_path: /documentation/uikit/uiapplication/launchoptionskey/remotenotification
source_url: 'https://developer.apple.com/documentation/uikit/uiapplication/launchoptionskey/remotenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiapplication/launchoptionskey/remotenotification.json'
content_hash: 'sha256:15d0e65fa5f7dd2e'
translated: false
---
