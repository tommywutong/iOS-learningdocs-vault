---
title: rotatingFooterView()
framework: UIKit
symbol_kind: method
role: symbol
role_heading: Instance Method
platforms: [iOS 2.0+（8.0 起废弃）, iPadOS 2.0+（8.0 起废弃）, Mac Catalyst 13.1+（13.1 起废弃）, visionOS 1.0+（1.0 起废弃）]
languages: [swift, occ]
beta: false
deprecated: true
doc_path: /documentation/uikit/uiviewcontroller/rotatingfooterview()
source_url: 'https://developer.apple.com/documentation/uikit/uiviewcontroller/rotatingfooterview()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiviewcontroller/rotatingfooterview%28%29.json'
content_hash: 'sha256:5990e1110bf45962'
translated: false
---
