...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uitableview/deselectrow(at:animated:)'
source_url: 'https://developer.apple.com/documentation/uikit/uitableview/deselectrow(at:animated:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitableview/deselectrow%28at%3Aanimated%3A%29.json'
content_hash: 'sha256:447a2ea216bc06cf'
translated: false
---
...
- `animated` — [true](../../swift/true.md) if you want to animate the deselection, and [false](../../swift/false.md) if the change should be immediate.

## Discussion

Calling this method doesn’t cause the delegate to receive a [- tableView:willDeselectRowAtIndexPath:](<../uitableviewdelegate/tableview(__willdeselectrowat_).md>) or [- tableView:didDeselectRowAtIndexPath:](<../uitableviewdelegate/tableview(__diddeselectrowat_).md>) message, nor does it send [UITableViewSelectionDidChangeNotification](selectiondidchangenotification.md) notifications to observers.
