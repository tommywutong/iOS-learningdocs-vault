---
title: 'setAnimationRepeatCount(_:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: true
doc_path: '/documentation/uikit/uiview/setanimationrepeatcount(_:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiview/setanimationrepeatcount(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiview/setanimationrepeatcount%28_%3A%29.json'
content_hash: 'sha256:afd980aa0c9657c2'
translated: false
---
...
If you pass the [UIViewAnimationOptionRepeat](animationoptions/repeat.md) option to the [+ animateWithDuration:delay:options:animations:completion:](<animate(withduration_delay_options_animations_completion_).md>) method without setting an explicit repeat count, the animation repeats indefinitely. If you want the animation to repeat a finite number of times, call this method from inside your block.
