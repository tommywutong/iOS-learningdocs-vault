---
title: UIView.Invalidations.Constraints
framework: UIKit
symbol_kind: struct
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/uikit/uiview/invalidations/constraints
source_url: 'https://developer.apple.com/documentation/uikit/uiview/invalidations/constraints'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiview/invalidations/constraints.json'
content_hash: 'sha256:8ade28fe13605ca4'
translated: false
---
...
- [init()](<constraints/init().md>) — Creates a constraints invalidation structure.
