...
beta: false
deprecated: false
doc_path: '/documentation/uikit/nslayoutmanager/glyphrange(for:)'
source_url: 'https://developer.apple.com/documentation/uikit/nslayoutmanager/glyphrange(for:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/nslayoutmanager/glyphrange%28for%3A%29.json'
content_hash: 'sha256:bd6e01c5634bf15c'
translated: false
---
...
This is a less efficient method than the similar [- textContainerForGlyphAtIndex:effectiveRange:](<textcontainer(forglyphat_effectiverange_).md>).
