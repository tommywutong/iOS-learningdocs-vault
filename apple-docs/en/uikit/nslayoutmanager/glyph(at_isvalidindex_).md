...
beta: false
deprecated: true
doc_path: '/documentation/uikit/nslayoutmanager/glyph(at:isvalidindex:)'
source_url: 'https://developer.apple.com/documentation/uikit/nslayoutmanager/glyph(at:isvalidindex:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/nslayoutmanager/glyph%28at%3Aisvalidindex%3A%29.json'
content_hash: 'sha256:447fd91ff956e30c'
translated: false
---
...
> [!warning] Deprecated
> Use [- CGGlyphAtIndex:isValidIndex:](<cgglyph(at_isvalidindex_).md>) instead.
...
- `isValidIndex` — If not `NULL`, on output, [true](../../swift/true.md) if the requested index is in range; otherwise [false](../../swift/false.md).
