---
title: 'setRightBarButtonItems(_:animated:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uinavigationitem/setrightbarbuttonitems(_:animated:)'
source_url: 'https://developer.apple.com/documentation/uikit/uinavigationitem/setrightbarbuttonitems(_:animated:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uinavigationitem/setrightbarbuttonitems%28_%3Aanimated%3A%29.json'
content_hash: 'sha256:174a1391315ec0dc'
translated: false
---
...
- `animated` — Specify [true](../../swift/true.md) to animate the transition to the custom bar items when this item is the top item. Specify [false](../../swift/false.md) to set the items immediately without animating the change.
