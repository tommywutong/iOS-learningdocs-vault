...
beta: false
deprecated: false
doc_path: /documentation/uikit/uiscrollview/alwaysbouncehorizontal
source_url: 'https://developer.apple.com/documentation/uikit/uiscrollview/alwaysbouncehorizontal'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiscrollview/alwaysbouncehorizontal.json'
content_hash: 'sha256:1df0df5f235bb268'
translated: false
---
...
If the value of this property is [true](../../swift/true.md) and [bouncesHorizontally](bounceshorizontally.md) is [true](../../swift/true.md), the scroll view allows horizontal dragging even if the content is smaller than the bounds of the scroll view. The default value is [false](../../swift/false.md).
