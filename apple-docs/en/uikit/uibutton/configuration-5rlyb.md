...
beta: false
deprecated: false
doc_path: /documentation/uikit/uibutton/configuration-5rlyb
source_url: 'https://developer.apple.com/documentation/uikit/uibutton/configuration-5rlyb'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uibutton/configuration-5rlyb.json'
content_hash: 'sha256:412374f658876905'
translated: false
---
...
Setting a configuration opts the button into a configuration system based on [Configuration](configuration-swift.struct.md). This configuration supports several options and behaviors unavailable with other configuration methods. Features include subtitle labels, extended control over background appearance, ways to transform the button configuration when the button changes state, and integration with macOS when building with Mac Catalyst.
