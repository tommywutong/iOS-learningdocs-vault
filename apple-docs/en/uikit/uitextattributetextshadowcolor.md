---
title: UITextAttributeTextShadowColor
framework: UIKit
symbol_kind: var
role: symbol
...
beta: false
deprecated: true
doc_path: /documentation/uikit/uitextattributetextshadowcolor
source_url: 'https://developer.apple.com/documentation/uikit/uitextattributetextshadowcolor'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitextattributetextshadowcolor.json'
content_hash: 'sha256:af08a2479cbf7b1d'
translated: false
---
...
- [UILineBreakMode](uilinebreakmode.md) — Options for wrapping and truncating text. _(deprecated)_
