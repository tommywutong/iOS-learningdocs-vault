---
title: UITraitSplitViewControllerLayoutEnvironment
framework: UIKit
symbol_kind: class
role: symbol
role_heading: Class
...
beta: false
deprecated: false
doc_path: /documentation/uikit/uitraitsplitviewcontrollerlayoutenvironment-c.class
source_url: 'https://developer.apple.com/documentation/uikit/uitraitsplitviewcontrollerlayoutenvironment-c.class'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitraitsplitviewcontrollerlayoutenvironment-c.class.json'
content_hash: 'sha256:5406eab5787fb5cc'
translated: false
---
...
- **Conforms To**: [UINSIntegerTraitDefinition](uinsintegertraitdefinition.md)
