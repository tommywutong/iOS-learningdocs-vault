---
title: 'init(localizedAttributedSuggestion:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uisearchsuggestionitem/init(localizedattributedsuggestion:)'
source_url: 'https://developer.apple.com/documentation/uikit/uisearchsuggestionitem/init(localizedattributedsuggestion:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uisearchsuggestionitem/init%28localizedattributedsuggestion%3A%29.json'
content_hash: 'sha256:1cd56d9b21a409c5'
translated: false
---
