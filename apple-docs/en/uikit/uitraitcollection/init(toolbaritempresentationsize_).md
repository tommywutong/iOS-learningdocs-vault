---
title: 'init(toolbarItemPresentationSize:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uitraitcollection/init(toolbaritempresentationsize:)'
source_url: 'https://developer.apple.com/documentation/uikit/uitraitcollection/init(toolbaritempresentationsize:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitraitcollection/init%28toolbaritempresentationsize%3A%29.json'
content_hash: 'sha256:7164d06cb35ccc65'
translated: false
---
