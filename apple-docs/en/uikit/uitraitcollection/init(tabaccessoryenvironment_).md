---
title: 'init(tabAccessoryEnvironment:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uitraitcollection/init(tabaccessoryenvironment:)'
source_url: 'https://developer.apple.com/documentation/uikit/uitraitcollection/init(tabaccessoryenvironment:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitraitcollection/init%28tabaccessoryenvironment%3A%29.json'
content_hash: 'sha256:86adc88e58031f88'
translated: false
---
