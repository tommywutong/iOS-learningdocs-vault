---
title: 'impactOccurred(intensity:at:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uiimpactfeedbackgenerator/impactoccurred(intensity:at:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiimpactfeedbackgenerator/impactoccurred(intensity:at:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiimpactfeedbackgenerator/impactoccurred%28intensity%3Aat%3A%29.json'
content_hash: 'sha256:d8e14729b8f75fe5'
translated: false
---
...
- [- impactOccurred](<impactoccurred().md>) — Triggers impact feedback.
