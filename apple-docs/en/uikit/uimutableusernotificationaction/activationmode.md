...
beta: false
deprecated: true
doc_path: /documentation/uikit/uimutableusernotificationaction/activationmode
source_url: 'https://developer.apple.com/documentation/uikit/uimutableusernotificationaction/activationmode'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uimutableusernotificationaction/activationmode.json'
content_hash: 'sha256:86c5fc1ca1eb1705'
translated: false
---
...
If the value in this property is [UIMutableUserNotificationAction](../uimutableusernotificationaction.md), the value of the [authenticationRequired](isauthenticationrequired.md) property is assumed to be [true](../../swift/true.md) regardless of its actual value.
