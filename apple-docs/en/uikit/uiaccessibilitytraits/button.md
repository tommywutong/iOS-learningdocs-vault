...
beta: false
deprecated: false
doc_path: /documentation/uikit/uiaccessibilitytraits/button
source_url: 'https://developer.apple.com/documentation/uikit/uiaccessibilitytraits/button'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiaccessibilitytraits/button.json'
content_hash: 'sha256:02e1e46d310c5104'
translated: false
---
