...
> Navigation: [Technologies](../technologies.md) · [UIKit](../uikit.md) · [Text display and fonts](text-display-and-fonts.md) · [UIFont](uifont.md)
...
<sub>On the left, a screenshot of the sample app showing the smallest text size. In the center, a screenshot showing the default text size. On the right, a screenshot showing the largest text size.</sub>
...
4. Click the _Settings_ icon (shaped like a gear).
5. Move the _Font size_ slider to change the size of text displayed in your app.
