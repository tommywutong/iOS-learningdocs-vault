...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uigesturerecognizer/canbeprevented(by:)'
source_url: 'https://developer.apple.com/documentation/uikit/uigesturerecognizer/canbeprevented(by:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uigesturerecognizer/canbeprevented%28by%3A%29.json'
content_hash: 'sha256:3a12c1916ea6f460'
translated: false
---
...
[true](../../swift/true.md) to indicate that `preventingGestureRecognizer` can block the receiver from recognizing its gesture, otherwise [false](../../swift/false.md).
