---
title: UIGestureRecognizer.State.failed
framework: UIKit
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: /documentation/uikit/uigesturerecognizer/state-swift.enum/failed
source_url: 'https://developer.apple.com/documentation/uikit/uigesturerecognizer/state-swift.enum/failed'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uigesturerecognizer/state-swift.enum/failed.json'
content_hash: 'sha256:8fc7d23231f81999'
translated: false
---
