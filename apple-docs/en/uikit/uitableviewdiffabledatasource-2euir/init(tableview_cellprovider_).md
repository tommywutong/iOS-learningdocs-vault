...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uitableviewdiffabledatasource-2euir/init(tableview:cellprovider:)'
source_url: 'https://developer.apple.com/documentation/uikit/uitableviewdiffabledatasource-2euir/init(tableview:cellprovider:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitableviewdiffabledatasource-2euir/init%28tableview%3Acellprovider%3A%29.json'
content_hash: 'sha256:efc1bce0e455c16f'
translated: false
---
...
- [CellProvider](cellprovider.md) — A closure that configures and returns a cell for a table view from its diffable data source.
