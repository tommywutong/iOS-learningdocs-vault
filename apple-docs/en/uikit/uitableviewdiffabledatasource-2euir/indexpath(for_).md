...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uitableviewdiffabledatasource-2euir/indexpath(for:)'
source_url: 'https://developer.apple.com/documentation/uikit/uitableviewdiffabledatasource-2euir/indexpath(for:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitableviewdiffabledatasource-2euir/indexpath%28for%3A%29.json'
content_hash: 'sha256:b14fc93a47063748'
translated: false
---
...
- [itemIdentifier(for:)](<itemidentifier(for_).md>) — Returns an identifier for the item at the specified index path in the table view.
