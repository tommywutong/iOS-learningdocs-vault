---
title: 'init(attributedName:image:actionHandler:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uiaccessibilitycustomaction/init(attributedname:image:actionhandler:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiaccessibilitycustomaction/init(attributedname:image:actionhandler:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiaccessibilitycustomaction/init%28attributedname%3Aimage%3Aactionhandler%3A%29.json'
content_hash: 'sha256:23d2c39437a6d729'
translated: false
---
