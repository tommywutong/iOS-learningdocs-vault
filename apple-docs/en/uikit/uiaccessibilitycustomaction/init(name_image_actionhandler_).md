---
title: 'init(name:image:actionHandler:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uiaccessibilitycustomaction/init(name:image:actionhandler:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiaccessibilitycustomaction/init(name:image:actionhandler:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiaccessibilitycustomaction/init%28name%3Aimage%3Aactionhandler%3A%29.json'
content_hash: 'sha256:711cae4b68a9a309'
translated: false
---
