---
title: 'constraint(greaterThanOrEqualTo:multiplier:constant:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/nslayoutdimension/constraint(greaterthanorequalto:multiplier:constant:)'
source_url: 'https://developer.apple.com/documentation/uikit/nslayoutdimension/constraint(greaterthanorequalto:multiplier:constant:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/nslayoutdimension/constraint%28greaterthanorequalto%3Amultiplier%3Aconstant%3A%29.json'
content_hash: 'sha256:a22a0b3970a600c6'
translated: false
---
