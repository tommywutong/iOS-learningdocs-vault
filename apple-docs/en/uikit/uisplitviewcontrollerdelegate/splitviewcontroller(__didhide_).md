---
title: 'splitViewController(_:didHide:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uisplitviewcontrollerdelegate/splitviewcontroller(_:didhide:)'
source_url: 'https://developer.apple.com/documentation/uikit/uisplitviewcontrollerdelegate/splitviewcontroller(_:didhide:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uisplitviewcontrollerdelegate/splitviewcontroller%28_%3Adidhide%3A%29.json'
content_hash: 'sha256:6c3c48193e5bbf97'
translated: false
---
...
- `column` — The column the system completed hiding. See [Column](../uisplitviewcontroller/column.md) for possible values.
