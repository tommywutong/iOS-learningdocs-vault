...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uiimage/symbolconfiguration-swift.class/init(textstyle:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiimage/symbolconfiguration-swift.class/init(textstyle:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiimage/symbolconfiguration-swift.class/init%28textstyle%3A%29.json'
content_hash: 'sha256:3c5740f6ff26ce49'
translated: false
---
...
- `textStyle` — A system text style that determines the initial appearance of your symbol image. For a list of possible values, see [TextStyle](../../uifont/textstyle.md).
