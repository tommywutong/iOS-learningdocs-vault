---
title: 'init(view:actionTarget:selector:)'
framework: UIKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uiupdatelink/init(view:actiontarget:selector:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiupdatelink/init(view:actiontarget:selector:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiupdatelink/init%28view%3Aactiontarget%3Aselector%3A%29.json'
content_hash: 'sha256:444338a92cf3610e'
translated: false
---
