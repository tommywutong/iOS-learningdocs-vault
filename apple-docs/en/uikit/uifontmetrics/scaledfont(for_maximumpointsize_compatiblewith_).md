---
title: 'scaledFont(for:maximumPointSize:compatibleWith:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uifontmetrics/scaledfont(for:maximumpointsize:compatiblewith:)'
source_url: 'https://developer.apple.com/documentation/uikit/uifontmetrics/scaledfont(for:maximumpointsize:compatiblewith:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uifontmetrics/scaledfont%28for%3Amaximumpointsize%3Acompatiblewith%3A%29.json'
content_hash: 'sha256:6ea148546e319fa5'
translated: false
---
