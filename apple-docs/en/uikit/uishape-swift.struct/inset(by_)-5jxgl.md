...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uishape-swift.struct/inset(by:)-5jxgl'
source_url: 'https://developer.apple.com/documentation/uikit/uishape-swift.struct/inset(by:)-5jxgl'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uishape-swift.struct/inset%28by%3A%29-5jxgl.json'
content_hash: 'sha256:941197b9e9d1390d'
translated: false
---
...
- [inset(by:)](<inset(by_)-7v5nk.md>) — Creates a new modified shape by applying the provided inset to this shape.
