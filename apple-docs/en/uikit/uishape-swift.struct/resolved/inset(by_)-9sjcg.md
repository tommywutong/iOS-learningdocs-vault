...
beta: false
deprecated: false
doc_path: '/documentation/uikit/uishape-swift.struct/resolved/inset(by:)-9sjcg'
source_url: 'https://developer.apple.com/documentation/uikit/uishape-swift.struct/resolved/inset(by:)-9sjcg'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uishape-swift.struct/resolved/inset%28by%3A%29-9sjcg.json'
content_hash: 'sha256:58cbbc8a9cefa8e5'
translated: false
---
...
- [inset(by:)](<inset(by_)-1r5gp.md>) — Creates a new modified shape by applying the provided inset to this shape.
