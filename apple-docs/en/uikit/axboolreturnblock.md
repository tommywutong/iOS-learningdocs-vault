...
beta: false
deprecated: false
doc_path: /documentation/uikit/axboolreturnblock
source_url: 'https://developer.apple.com/documentation/uikit/axboolreturnblock'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/axboolreturnblock.json'
content_hash: 'sha256:d8ea1470865406e7'
translated: false
---
...
```swift
@MainActor typealias AXBoolReturnBlock = () -> Bool
```
