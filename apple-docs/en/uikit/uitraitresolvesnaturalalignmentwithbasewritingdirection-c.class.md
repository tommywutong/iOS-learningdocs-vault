...
beta: false
deprecated: false
doc_path: /documentation/uikit/uitraitresolvesnaturalalignmentwithbasewritingdirection-c.class
source_url: 'https://developer.apple.com/documentation/uikit/uitraitresolvesnaturalalignmentwithbasewritingdirection-c.class'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uitraitresolvesnaturalalignmentwithbasewritingdirection-c.class.json'
content_hash: 'sha256:8a0b0f1cd514520f'
translated: false
---
...
- **Conforms To**: [UIObjectTraitDefinition](uiobjecttraitdefinition.md)
