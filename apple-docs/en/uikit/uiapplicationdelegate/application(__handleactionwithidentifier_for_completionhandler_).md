---
title: 'application(_:handleActionWithIdentifier:for:completionHandler:)'
framework: UIKit
symbol_kind: method
role: symbol
...
beta: false
deprecated: true
doc_path: '/documentation/uikit/uiapplicationdelegate/application(_:handleactionwithidentifier:for:completionhandler:)'
source_url: 'https://developer.apple.com/documentation/uikit/uiapplicationdelegate/application(_:handleactionwithidentifier:for:completionhandler:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/uikit/uiapplicationdelegate/application%28_%3Ahandleactionwithidentifier%3Afor%3Acompletionhandler%3A%29.json'
content_hash: 'sha256:1005d1b9c7954540'
translated: false
---
