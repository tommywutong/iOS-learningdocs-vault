...
platforms: [iOS 13.2+, iPadOS 13.2+, Mac Catalyst 13.0+, Xcode 11.4+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: /documentation/coredata/handling-different-data-types-in-core-data
source_url: 'https://developer.apple.com/documentation/coredata/handling-different-data-types-in-core-data'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coredata/handling-different-data-types-in-core-data.json'
content_hash: 'sha256:3d19459914342edb'
translated: false
---
...
In the case where `publishMonthID` is [`key-value observed`](../swift/using-key-value-observing-in-swift.md), the following code ensures that the observations are triggered when `publishDate` changes.
...
- [HandlingDifferentDataTypesInCoreData.zip](https://docs-assets.developer.apple.com/published/73ed48112035/HandlingDifferentDataTypesInCoreData.zip)
