---
title: didSaveObjectIDsNotification
framework: Core Data
...
beta: false
deprecated: false
doc_path: /documentation/coredata/nsmanagedobjectcontext/didsaveobjectidsnotification
source_url: 'https://developer.apple.com/documentation/coredata/nsmanagedobjectcontext/didsaveobjectidsnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coredata/nsmanagedobjectcontext/didsaveobjectidsnotification.json'
content_hash: 'sha256:35f78eef2119c209'
translated: false
---
...
The `userInfo` dictionary contains the identifiers of the inserted, updated, deleted, and invalidated managed objects. For the keys to access those objects, see [NotificationKey](notificationkey.md). It’s safe to capture the dictionary’s contents.
