...
beta: false
deprecated: false
doc_path: '/documentation/coredata/nsmanagedobjectcontext/count(for:)-93zbm'
source_url: 'https://developer.apple.com/documentation/coredata/nsmanagedobjectcontext/count(for:)-93zbm'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coredata/nsmanagedobjectcontext/count%28for%3A%29-93zbm.json'
content_hash: 'sha256:b22cf1a7363061f1'
translated: false
---
...
The number of objects a given fetch request would have returned if it had been passed to [fetch(_:)](<fetch(__)-38ys1.md>), or `NSNotFound` if an error occurs.
