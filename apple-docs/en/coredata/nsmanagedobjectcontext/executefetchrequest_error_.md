---
title: 'executeFetchRequest:error:'
framework: Core Data
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/coredata/nsmanagedobjectcontext/executefetchrequest:error:'
source_url: 'https://developer.apple.com/documentation/coredata/nsmanagedobjectcontext/executefetchrequest:error:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coredata/nsmanagedobjectcontext/executefetchrequest%3Aerror%3A.json'
content_hash: 'sha256:04850016eae6ff5a'
translated: false
---
