...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/didhideapplicationnotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/didhideapplicationnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/didhideapplicationnotification.json'
content_hash: 'sha256:f69df866a579d57a'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidHideApplicationMessage](didhideapplicationmessage.md).
