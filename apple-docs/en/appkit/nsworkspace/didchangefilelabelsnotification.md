...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/didchangefilelabelsnotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/didchangefilelabelsnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/didchangefilelabelsnotification.json'
content_hash: 'sha256:c77edb86cfc59445'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidChangeFileLabelsMessage](didchangefilelabelsmessage.md).
