---
title: didDeactivateApplicationNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/diddeactivateapplicationnotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/diddeactivateapplicationnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/diddeactivateapplicationnotification.json'
content_hash: 'sha256:8ab3464cb8cf15f6'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidDeactivateApplicationMessage](diddeactivateapplicationmessage.md).
