...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/sessiondidresignactivenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/sessiondidresignactivenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/sessiondidresignactivenotification.json'
content_hash: 'sha256:cec1b55d79d1c3d8'
translated: false
---
...
To observe this notification using Swift concurrency, use [SessionDidResignActiveMessage](sessiondidresignactivemessage.md).
