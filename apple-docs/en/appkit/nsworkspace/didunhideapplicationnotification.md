---
title: didUnhideApplicationNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/didunhideapplicationnotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/didunhideapplicationnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/didunhideapplicationnotification.json'
content_hash: 'sha256:25fe62682c376c7d'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidUnhideApplicationMessage](didunhideapplicationmessage.md).
