---
title: activeSpaceDidChangeNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsworkspace/activespacedidchangenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsworkspace/activespacedidchangenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsworkspace/activespacedidchangenotification.json'
content_hash: 'sha256:84ecb3a89fd74ee6'
translated: false
---
...
To observe this notification using Swift concurrency, use [ActiveSpaceDidChangeMessage](activespacedidchangemessage.md).
