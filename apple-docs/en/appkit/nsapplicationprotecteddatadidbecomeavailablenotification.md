...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplicationprotecteddatadidbecomeavailablenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplicationprotecteddatadidbecomeavailablenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplicationprotecteddatadidbecomeavailablenotification.json'
content_hash: 'sha256:c12418771d397cf9'
translated: false
---
...
To observe this notification using Swift concurrency, use [ProtectedDataDidBecomeAvailableMessage](nsapplication/protecteddatadidbecomeavailablemessage.md).
