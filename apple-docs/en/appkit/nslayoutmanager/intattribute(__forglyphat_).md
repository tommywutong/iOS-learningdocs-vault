...
beta: false
deprecated: true
doc_path: '/documentation/appkit/nslayoutmanager/intattribute(_:forglyphat:)'
source_url: 'https://developer.apple.com/documentation/appkit/nslayoutmanager/intattribute(_:forglyphat:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nslayoutmanager/intattribute%28_%3Aforglyphat%3A%29.json'
content_hash: 'sha256:476fe807c562b4ba'
translated: false
---
...
Subclasses that define their own custom attributes must override this method to access their own storage for the attribute values. Nonnegative tags are reserved by Apple; you can define your own attributes with negative tags and set values using [- setIntAttribute:value:forGlyphAtIndex:](<setintattribute(__value_forglyphat_).md>).
