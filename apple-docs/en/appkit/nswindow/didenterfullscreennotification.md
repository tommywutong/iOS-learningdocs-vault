...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/didenterfullscreennotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/didenterfullscreennotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/didenterfullscreennotification.json'
content_hash: 'sha256:76f78437cbde0c9d'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidEnterFullScreenMessage](didenterfullscreenmessage.md).
