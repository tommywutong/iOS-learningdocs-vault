---
title: didEnterVersionBrowserNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/didenterversionbrowsernotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/didenterversionbrowsernotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/didenterversionbrowsernotification.json'
content_hash: 'sha256:8e6ff8ceb973d27a'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidEnterVersionBrowserMessage](didenterversionbrowsermessage.md).
