---
title: didMiniaturizeNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/didminiaturizenotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/didminiaturizenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/didminiaturizenotification.json'
content_hash: 'sha256:5f56ad4a415f9650'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidMiniaturizeMessage](didminiaturizemessage.md).
