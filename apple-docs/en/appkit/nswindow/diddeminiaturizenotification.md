---
title: didDeminiaturizeNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/diddeminiaturizenotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/diddeminiaturizenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/diddeminiaturizenotification.json'
content_hash: 'sha256:00f9509d1439ee33'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidDeminiaturizeMessage](diddeminiaturizemessage.md).
