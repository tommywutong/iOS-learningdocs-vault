...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/didupdatenotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/didupdatenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/didupdatenotification.json'
content_hash: 'sha256:5fdbfc24f968cb21'
translated: false
---
...
The notification object is the `NSWindow` object that received the [- update](<update().md>) message. This notification doesn’t contain a `userInfo` dictionary.

To observe this notification using Swift concurrency, use [DidUpdateMessage](didupdatemessage.md).
