---
title: didBecomeMainNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/didbecomemainnotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/didbecomemainnotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/didbecomemainnotification.json'
content_hash: 'sha256:64caef3458fbc7bb'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidBecomeMainMessage](didbecomemainmessage.md).
