---
title: willExitVersionBrowserNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/willexitversionbrowsernotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/willexitversionbrowsernotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/willexitversionbrowsernotification.json'
content_hash: 'sha256:cedf7c0cc5313809'
translated: false
---
...
To observe this notification using Swift concurrency, use [WillExitVersionBrowserMessage](willexitversionbrowsermessage.md).
