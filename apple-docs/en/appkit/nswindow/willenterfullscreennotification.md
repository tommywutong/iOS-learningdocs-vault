---
title: willEnterFullScreenNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nswindow/willenterfullscreennotification
source_url: 'https://developer.apple.com/documentation/appkit/nswindow/willenterfullscreennotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nswindow/willenterfullscreennotification.json'
content_hash: 'sha256:c302d6a723f56d49'
translated: false
---
...
To observe this notification using Swift concurrency, use [WillEnterFullScreenMessage](willenterfullscreenmessage.md).
