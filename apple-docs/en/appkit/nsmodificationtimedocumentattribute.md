---
title: NSModificationTimeDocumentAttribute
framework: AppKit
symbol_kind: var
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsmodificationtimedocumentattribute
source_url: 'https://developer.apple.com/documentation/appkit/nsmodificationtimedocumentattribute'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsmodificationtimedocumentattribute.json'
content_hash: 'sha256:1fedb86c169bedfd'
translated: false
---
...
The value of this attribute is an [NSDate](../foundation/nsdate.md) object containing the modification date of the document contents.
