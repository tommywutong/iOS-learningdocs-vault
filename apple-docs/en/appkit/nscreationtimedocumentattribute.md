---
title: NSCreationTimeDocumentAttribute
framework: AppKit
symbol_kind: var
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nscreationtimedocumentattribute
source_url: 'https://developer.apple.com/documentation/appkit/nscreationtimedocumentattribute'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nscreationtimedocumentattribute.json'
content_hash: 'sha256:ff6ed93271c2f1d9'
translated: false
---
...
The value of this attribute is an [NSDate](../foundation/nsdate.md) object containing the creation date of the document; note that this is not the file system creation date of the file, but of the document.
