...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/willresignactivenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/willresignactivenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/willresignactivenotification.json'
content_hash: 'sha256:06136d7d113bdd0c'
translated: false
---
...
To observe this notification using Swift concurrency, use [WillResignActiveMessage](willresignactivemessage.md).
