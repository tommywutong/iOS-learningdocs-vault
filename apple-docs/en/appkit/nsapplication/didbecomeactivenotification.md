...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/didbecomeactivenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/didbecomeactivenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/didbecomeactivenotification.json'
content_hash: 'sha256:e9a367b6eee74732'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidBecomeActiveMessage](didbecomeactivemessage.md).
