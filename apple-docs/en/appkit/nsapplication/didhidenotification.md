...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/didhidenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/didhidenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/didhidenotification.json'
content_hash: 'sha256:ef854e82ce0223a6'
translated: false
---
...
Posted at the end of the [- hide:](<hide(__).md>) method to indicate that the app is now hidden.
...
To observe this notification using Swift concurrency, use [DidHideMessage](didhidemessage.md).
