---
title: willBecomeActiveNotification
framework: AppKit
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/willbecomeactivenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/willbecomeactivenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/willbecomeactivenotification.json'
content_hash: 'sha256:2ef6c07286974cd6'
translated: false
---
...
To observe this notification using Swift concurrency, use [WillBecomeActiveMessage](willbecomeactivemessage.md).
