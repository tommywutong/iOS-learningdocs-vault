...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/didunhidenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/didunhidenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/didunhidenotification.json'
content_hash: 'sha256:81bc0befb50eb1f1'
translated: false
---
...
Posted at the end of the [- unhideWithoutActivation](<unhidewithoutactivation().md>) method to indicate that the app is now visible.
...
To observe this notification using Swift concurrency, use [DidUnhideMessage](didunhidemessage.md).
