...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/didresignactivenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/didresignactivenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/didresignactivenotification.json'
content_hash: 'sha256:18d11c03f0b14e09'
translated: false
---
...
To observe this notification using Swift concurrency, use [DidResignActiveMessage](didresignactivemessage.md).
