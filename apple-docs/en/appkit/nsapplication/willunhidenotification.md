...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsapplication/willunhidenotification
source_url: 'https://developer.apple.com/documentation/appkit/nsapplication/willunhidenotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsapplication/willunhidenotification.json'
content_hash: 'sha256:b20d1cff9b3733a9'
translated: false
---
...
Posted at the start of the [- unhideWithoutActivation](<unhidewithoutactivation().md>) method to indicate that the app is about to become visible.
...
To observe this notification using Swift concurrency, use [WillUnhideMessage](willunhidemessage.md).
