...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsaccessibility-swift.struct/notification/resized
source_url: 'https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/notification/resized'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsaccessibility-swift.struct/notification/resized.json'
content_hash: 'sha256:fd76a95cbe97c24c'
translated: false
---
...
This notification is posted after an accessibility element’s size changes. Post this notification using the [NSAccessibilityPostNotification](<../post(element_notification_).md>) function instead of an `NSNotificationCenter` instance.
