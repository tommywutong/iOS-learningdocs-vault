...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsaccessibility-swift.struct/notification/sheetcreated
source_url: 'https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/notification/sheetcreated'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsaccessibility-swift.struct/notification/sheetcreated.json'
content_hash: 'sha256:148fdc53d03465a1'
translated: false
---
...
This notification is posted after a sheet appears.  Post this notification using the [NSAccessibilityPostNotification](<../post(element_notification_).md>) function instead of an `NSNotificationCenter` instance.
