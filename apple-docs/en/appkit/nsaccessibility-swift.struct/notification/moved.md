...
beta: false
deprecated: false
doc_path: /documentation/appkit/nsaccessibility-swift.struct/notification/moved
source_url: 'https://developer.apple.com/documentation/appkit/nsaccessibility-swift.struct/notification/moved'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nsaccessibility-swift.struct/notification/moved.json'
content_hash: 'sha256:2925b3c4b8effb07'
translated: false
---
...
This notification is posted after an accessibility element moves. Post this notification using the [NSAccessibilityPostNotification](<../post(element_notification_).md>) function instead of an `NSNotificationCenter` instance.
