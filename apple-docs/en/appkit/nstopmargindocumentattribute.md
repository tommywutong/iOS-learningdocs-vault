---
title: NSTopMarginDocumentAttribute
framework: AppKit
symbol_kind: var
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/appkit/nstopmargindocumentattribute
source_url: 'https://developer.apple.com/documentation/appkit/nstopmargindocumentattribute'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/appkit/nstopmargindocumentattribute.json'
content_hash: 'sha256:79ae66a5413ce903'
translated: false
---
...
The value of this attribute is an [NSNumber](../foundation/nsnumber.md) object containing a float, in points.
