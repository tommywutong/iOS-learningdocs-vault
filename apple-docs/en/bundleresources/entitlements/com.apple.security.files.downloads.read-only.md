---
title: com.apple.security.files.downloads.read-only
...
beta: false
deprecated: false
doc_path: /documentation/bundleresources/entitlements/com.apple.security.files.downloads.read-only
source_url: 'https://developer.apple.com/documentation/bundleresources/entitlements/com.apple.security.files.downloads.read-only'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/bundleresources/entitlements/com.apple.security.files.downloads.read-only.json'
content_hash: 'sha256:aec06598b463096e'
translated: false
---
