---
title: com.apple.security.assets.movies.read-only
...
beta: false
deprecated: false
doc_path: /documentation/bundleresources/entitlements/com.apple.security.assets.movies.read-only
source_url: 'https://developer.apple.com/documentation/bundleresources/entitlements/com.apple.security.assets.movies.read-only'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/bundleresources/entitlements/com.apple.security.assets.movies.read-only.json'
content_hash: 'sha256:3207f0c91c25a42b'
translated: false
---
