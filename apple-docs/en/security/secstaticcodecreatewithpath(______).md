...
beta: false
deprecated: false
doc_path: '/documentation/security/secstaticcodecreatewithpath(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/security/secstaticcodecreatewithpath(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/security/secstaticcodecreatewithpath%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:abba5dc5e3442488'
translated: false
---
...
It is possible to create a static code object from unsigned code. Although most uses of such an object cause the function to fail and return the result code `errSecCSUnsigned` error, you can call the [SecCodeCopyPath](<seccodecopypath(______).md>) and [SecCodeCopySigningInformation](<seccodecopysigninginformation(______).md>) functions for such objects.
