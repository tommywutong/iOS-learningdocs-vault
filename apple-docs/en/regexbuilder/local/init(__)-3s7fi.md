...
beta: false
deprecated: false
doc_path: '/documentation/regexbuilder/local/init(_:)-3s7fi'
source_url: 'https://developer.apple.com/documentation/regexbuilder/local/init(_:)-3s7fi'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/regexbuilder/local/init%28_%3A%29-3s7fi.json'
content_hash: 'sha256:a055f9c47e1fe6a1'
translated: false
---
