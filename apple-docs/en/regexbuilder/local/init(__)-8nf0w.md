...
beta: false
deprecated: false
doc_path: '/documentation/regexbuilder/local/init(_:)-8nf0w'
source_url: 'https://developer.apple.com/documentation/regexbuilder/local/init(_:)-8nf0w'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/regexbuilder/local/init%28_%3A%29-8nf0w.json'
content_hash: 'sha256:998d83d7ce6ca18f'
translated: false
---
