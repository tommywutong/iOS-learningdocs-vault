...
beta: false
deprecated: false
doc_path: '/documentation/regexbuilder/local/init(_:)-1pqmw'
source_url: 'https://developer.apple.com/documentation/regexbuilder/local/init(_:)-1pqmw'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/regexbuilder/local/init%28_%3A%29-1pqmw.json'
content_hash: 'sha256:0f4892fcc33bbb49'
translated: false
---
