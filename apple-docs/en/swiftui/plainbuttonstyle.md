...
beta: false
deprecated: false
doc_path: /documentation/swiftui/plainbuttonstyle
source_url: 'https://developer.apple.com/documentation/swiftui/plainbuttonstyle'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/plainbuttonstyle.json'
content_hash: 'sha256:9b287511aa650cf9'
translated: false
---
...
- [init()](<plainbuttonstyle/init().md>) — Creates a plain button style.

### Supporting types

- [makeBody(configuration:)](<plainbuttonstyle/makebody(configuration_).md>) — Creates a view that represents the body of a button.
