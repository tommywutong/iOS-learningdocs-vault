...
beta: false
deprecated: false
doc_path: /documentation/swiftui/toolbarcommands
source_url: 'https://developer.apple.com/documentation/swiftui/toolbarcommands'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/toolbarcommands.json'
content_hash: 'sha256:74ac857b384a4f95'
translated: false
---
...
- [init()](<toolbarcommands/init().md>) — A new value describing the built-in toolbar-related commands.
