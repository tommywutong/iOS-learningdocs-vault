...
beta: false
deprecated: false
doc_path: /documentation/swiftui/pointerstyle/zoomin
source_url: 'https://developer.apple.com/documentation/swiftui/pointerstyle/zoomin'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/pointerstyle/zoomin.json'
content_hash: 'sha256:0a44b51ff5b2ede8'
translated: false
---
...
This pointer style displays a magnifying glass with a plus symbol. You may apply this pointer style to a single view or a view hierarchy using the [pointerStyle(_:)](<../view/pointerstyle(__).md>) modifier.
