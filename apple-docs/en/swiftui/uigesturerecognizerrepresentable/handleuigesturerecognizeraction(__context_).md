...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/uigesturerecognizerrepresentable/handleuigesturerecognizeraction(_:context:)'
source_url: 'https://developer.apple.com/documentation/swiftui/uigesturerecognizerrepresentable/handleuigesturerecognizeraction(_:context:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/uigesturerecognizerrepresentable/handleuigesturerecognizeraction%28_%3Acontext%3A%29.json'
content_hash: 'sha256:8635b452bdf16c7d'
translated: false
---
...
- [handleUIGestureRecognizerAction(_:context:)](<handleuigesturerecognizeraction(__context_)-8u4zs.md>) — Handles recognition of the represented `UIGestureRecognizer`.
