...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/transition/offset(x:y:)'
source_url: 'https://developer.apple.com/documentation/swiftui/transition/offset(x:y:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/transition/offset%28x%3Ay%3A%29.json'
content_hash: 'sha256:26fe491cdde825e2'
translated: false
---
