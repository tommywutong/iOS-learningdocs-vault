...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/nsviewrepresentable/sizethatfits(_:nsview:context:)'
source_url: 'https://developer.apple.com/documentation/swiftui/nsviewrepresentable/sizethatfits(_:nsview:context:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/nsviewrepresentable/sizethatfits%28_%3Ansview%3Acontext%3A%29.json'
content_hash: 'sha256:4adefe04ce35d53c'
translated: false
---
...
- [sizeThatFits(_:nsView:context:)](<sizethatfits(__nsview_context_)-fuqx.md>) — Given a proposed size, returns the preferred size of the composite view.
