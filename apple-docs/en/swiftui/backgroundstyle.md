...
beta: false
deprecated: false
doc_path: /documentation/swiftui/backgroundstyle
source_url: 'https://developer.apple.com/documentation/swiftui/backgroundstyle'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/backgroundstyle.json'
content_hash: 'sha256:1386020aa04e7506'
translated: false
---
...
- **Conforms To**: [BitwiseCopyable](../swift/bitwisecopyable.md), [Copyable](../swift/copyable.md), [Sendable](../swift/sendable.md), [SendableMetatype](../swift/sendablemetatype.md), [ShapeStyle](shapestyle.md)

## Topics

### Creating a background style

- [init()](<backgroundstyle/init().md>) — Creates a background style instance.
