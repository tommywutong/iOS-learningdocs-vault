...
beta: false
deprecated: false
doc_path: /documentation/swiftui/pushtransition
source_url: 'https://developer.apple.com/documentation/swiftui/pushtransition'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/pushtransition.json'
content_hash: 'sha256:3ccc93ea9e427a3f'
translated: false
---
...
- [init(edge:)](<pushtransition/init(edge_).md>) — Creates a transition that animates a view by moving and fading it.
