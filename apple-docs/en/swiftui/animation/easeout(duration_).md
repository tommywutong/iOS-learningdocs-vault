...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/animation/easeout(duration:)'
source_url: 'https://developer.apple.com/documentation/swiftui/animation/easeout(duration:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/animation/easeout%28duration%3A%29.json'
content_hash: 'sha256:a5c951ca6d9cfecd'
translated: false
---
...
[A video that shows a circle enlarging for one second, then shrinking for another second to its original size using an ease-out animation.](https://docs-assets.developer.apple.com/published/92ca311034a62b23462b18ed658a99f9/animation-11-easeout-duration.mp4)
