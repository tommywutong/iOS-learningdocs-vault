...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/viewdimensions/subscript(explicit:)'
source_url: 'https://developer.apple.com/documentation/swiftui/viewdimensions/subscript(explicit:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/viewdimensions/subscript%28explicit%3A%29.json'
content_hash: 'sha256:c85bfbd79bfad057'
translated: false
---
...
- [subscript(_:)](<subscript(__).md>) — Gets the value of the given horizontal guide.
