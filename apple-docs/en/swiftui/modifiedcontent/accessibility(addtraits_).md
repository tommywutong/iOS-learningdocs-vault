...
beta: false
deprecated: true
doc_path: '/documentation/swiftui/modifiedcontent/accessibility(addtraits:)'
source_url: 'https://developer.apple.com/documentation/swiftui/modifiedcontent/accessibility(addtraits:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/modifiedcontent/accessibility%28addtraits%3A%29.json'
content_hash: 'sha256:f460f9dcb2b7e62d'
translated: false
---
...
> [!warning] Deprecated
> Use [accessibilityAddTraits(_:)](<accessibilityaddtraits(__).md>) instead.
