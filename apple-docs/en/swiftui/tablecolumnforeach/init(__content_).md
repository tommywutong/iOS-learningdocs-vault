...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/tablecolumnforeach/init(_:content:)'
source_url: 'https://developer.apple.com/documentation/swiftui/tablecolumnforeach/init(_:content:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/tablecolumnforeach/init%28_%3Acontent%3A%29.json'
content_hash: 'sha256:4902689b72e50183'
translated: false
---
...
- [init(_:id:content:)](<init(__id_content_).md>) — Creates an instance that uniquely identifies and creates table columns across updates based on the provided key path to the underlying data’s identifier.
