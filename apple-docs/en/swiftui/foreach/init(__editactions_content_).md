...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/foreach/init(_:editactions:content:)'
source_url: 'https://developer.apple.com/documentation/swiftui/foreach/init(_:editactions:content:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/foreach/init%28_%3Aeditactions%3Acontent%3A%29.json'
content_hash: 'sha256:e99212d1cd1bdf4e'
translated: false
---
...
- [init(_:id:editActions:content:)](<init(__id_editactions_content_).md>) — Creates an instance that uniquely identifies and creates views across updates based on the identity of the underlying data.
