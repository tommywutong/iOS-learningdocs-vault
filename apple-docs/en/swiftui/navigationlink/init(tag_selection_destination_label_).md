...
beta: false
deprecated: true
doc_path: '/documentation/swiftui/navigationlink/init(tag:selection:destination:label:)'
source_url: 'https://developer.apple.com/documentation/swiftui/navigationlink/init(tag:selection:destination:label:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/navigationlink/init%28tag%3Aselection%3Adestination%3Alabel%3A%29.json'
content_hash: 'sha256:f8b9735f6c4c28cc'
translated: false
---
