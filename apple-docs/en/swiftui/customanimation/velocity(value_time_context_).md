...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/customanimation/velocity(value:time:context:)'
source_url: 'https://developer.apple.com/documentation/swiftui/customanimation/velocity(value:time:context:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/customanimation/velocity%28value%3Atime%3Acontext%3A%29.json'
content_hash: 'sha256:1eea7bd1a0a718f3'
translated: false
---
...
- [velocity(value:time:context:)](<velocity(value_time_context_)-78qjv.md>) — Calculates the velocity of the animation at a specified time.
