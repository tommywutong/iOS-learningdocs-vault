...
beta: false
deprecated: false
doc_path: /documentation/swiftui/view/scaledtofill()
source_url: 'https://developer.apple.com/documentation/swiftui/view/scaledtofill()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/scaledtofill%28%29.json'
content_hash: 'sha256:912ad0f48ee6291c'
translated: false
---
...
![A screenshot of pink circle scaled to fill its](../../../../attachments/4ab1e312d479ab9a723369818edb421c/SwiftUI-View-scaledToFill-1@2x.png)

This method is equivalent to calling [aspectRatio(_:contentMode:)](<aspectratio(__contentmode_).md>) with a `nil` aspectRatio and a content mode of [ContentMode.fill](../contentmode/fill.md).
