...
platforms: [iOS 27.0+ beta, iPadOS 27.0+ beta, visionOS 27.0+ beta]
languages: [swift, swift]
beta: true
deprecated: false
doc_path: '/documentation/swiftui/view/musicpicker(ispresented:title:selection:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/musicpicker(ispresented:title:selection:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/musicpicker%28ispresented%3Atitle%3Aselection%3A%29.json'
content_hash: 'sha256:97d1c88e13123fbb'
translated: false
---
