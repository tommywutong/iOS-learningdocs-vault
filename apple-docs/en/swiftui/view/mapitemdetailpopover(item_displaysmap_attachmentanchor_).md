...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/mapitemdetailpopover(item:displaysmap:attachmentanchor:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/mapitemdetailpopover(item:displaysmap:attachmentanchor:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/mapitemdetailpopover%28item%3Adisplaysmap%3Aattachmentanchor%3A%29.json'
content_hash: 'sha256:7f8e88c563f0bea9'
translated: false
---
...
Use this modifier if you want the system to choose the best orientation of the popover’s arrow. If you want to specify a particular edge for the arrow, use [mapItemDetailPopover(item:displaysMap:attachmentAnchor:arrowEdge:)](<mapitemdetailpopover(item_displaysmap_attachmentanchor_arrowedge_).md>).
