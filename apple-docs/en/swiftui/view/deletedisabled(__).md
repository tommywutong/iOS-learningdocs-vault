...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/deletedisabled(_:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/deletedisabled(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/deletedisabled%28_%3A%29.json'
content_hash: 'sha256:298a6eb010bd4ecc'
translated: false
---
...
- [moveDisabled(_:)](<movedisabled(__).md>) — Adds a condition for whether the view’s view hierarchy is movable.
