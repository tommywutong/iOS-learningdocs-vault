...
platforms: [macOS 10.15+（12.0 起废弃）, tvOS 13.0+（15.0 起废弃）, watchOS 6.0+（8.0 起废弃）]
languages: [swift]
beta: false
deprecated: true
doc_path: '/documentation/swiftui/view/focusable(_:onfocuschange:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/focusable(_:onfocuschange:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/focusable%28_%3Aonfocuschange%3A%29.json'
content_hash: 'sha256:2f58712e479fffde'
translated: false
---
...
> [!warning] Deprecated
> Use the [focusable(_:)](<focusable(__).md>) method instead.
