---
title: 'task(name:executorPreference:priority:file:line:action:)'
framework: SwiftUI
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/task(name:executorpreference:priority:file:line:action:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/task(name:executorpreference:priority:file:line:action:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/task%28name%3Aexecutorpreference%3Apriority%3Afile%3Aline%3Aaction%3A%29.json'
content_hash: 'sha256:4891ec7f9a6b8ff9'
translated: false
---
