...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/keyframeanimator(initialvalue:trigger:content:keyframes:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/keyframeanimator(initialvalue:trigger:content:keyframes:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/keyframeanimator%28initialvalue%3Atrigger%3Acontent%3Akeyframes%3A%29.json'
content_hash: 'sha256:de0e8395593e1d52'
translated: false
---
...
- [keyframeAnimator(initialValue:repeating:content:keyframes:)](<keyframeanimator(initialvalue_repeating_content_keyframes_).md>) — Loops the given keyframes continuously, updating the view using the modifiers you apply in `body`.
