...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/textcontenttype(_:)-4dqqb'
source_url: 'https://developer.apple.com/documentation/swiftui/view/textcontenttype(_:)-4dqqb'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/textcontenttype%28_%3A%29-4dqqb.json'
content_hash: 'sha256:16de4751fffb882b'
translated: false
---
...
- `textContentType` — One of the content types available in the [WKTextContentType](../../watchkit/wktextcontenttype.md) structure that identify the semantic meaning expected for a text-entry area. These include support for email addresses, location names, URLs, and telephone numbers, to name just a few.
