...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/view/subscriptionstorecontrolicon(icon:)'
source_url: 'https://developer.apple.com/documentation/swiftui/view/subscriptionstorecontrolicon(icon:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/view/subscriptionstorecontrolicon%28icon%3A%29.json'
content_hash: 'sha256:4fa8fa3c741532d6'
translated: false
---
...
- `icon` — A closure that takes a [Product](../../storekit/product.md) and [Product.SubscriptionInfo](../../storekit/product/subscriptioninfo.md) and returns a view.
