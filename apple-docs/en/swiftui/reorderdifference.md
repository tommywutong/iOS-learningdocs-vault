...
beta: true
deprecated: false
doc_path: /documentation/swiftui/reorderdifference
source_url: 'https://developer.apple.com/documentation/swiftui/reorderdifference'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/reorderdifference.json'
content_hash: 'sha256:83424b0d57d6b6fa'
translated: false
---
...
- [destination](reorderdifference/destination-swift.property.md) — The end position of items to move during a reordering operation. _(beta)_
- [Destination](reorderdifference/destination-swift.struct.md) — The destination value of a reordering operation. _(beta)_
- [sources](reorderdifference/sources.md) — The identifiers of items to move during a reordering operation. _(beta)_
