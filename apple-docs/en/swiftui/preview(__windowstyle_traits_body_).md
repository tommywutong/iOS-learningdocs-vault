...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/preview(_:windowstyle:traits:body:)'
source_url: 'https://developer.apple.com/documentation/swiftui/preview(_:windowstyle:traits:body:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/preview%28_%3Awindowstyle%3Atraits%3Abody%3A%29.json'
content_hash: 'sha256:59b4148a6050045e'
translated: false
---
...
This preview macro behaves like [Preview(_:traits:_:body:)](<preview(__traits___body_).md>), except that it also enables you to define a scene context for the view. Specifically, it places the view in a window with the specified window style, like the [volumetric](windowstyle/volumetric.md) style:
...
Other preview macros provide different customization options. For example, if you want to see how the view appears in an immersive space rather than a window, you can use [Preview(_:immersionStyle:traits:body:)](<preview(__immersionstyle_traits_body_).md>). If you want to add custom, fixed viewpoints to a window-based preview, use [Preview(_:windowStyle:traits:body:cameras:)](<preview(__windowstyle_traits_body_cameras_).md>).
