...
beta: false
deprecated: false
doc_path: /documentation/swiftui/springkeyframe
source_url: 'https://developer.apple.com/documentation/swiftui/springkeyframe'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/springkeyframe.json'
content_hash: 'sha256:7670f4e9003084b9'
translated: false
---
...
- [init(_:duration:spring:startVelocity:)](<springkeyframe/init(__duration_spring_startvelocity_).md>) — Creates a new keyframe using the given value and timestamp.
