...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/windowgroup/init(_:id:for:content:defaultvalue:)'
source_url: 'https://developer.apple.com/documentation/swiftui/windowgroup/init(_:id:for:content:defaultvalue:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/windowgroup/init%28_%3Aid%3Afor%3Acontent%3Adefaultvalue%3A%29.json'
content_hash: 'sha256:380186f8cdc49587'
translated: false
---
...
- [init(id:for:content:defaultValue:)](<init(id_for_content_defaultvalue_).md>) — Creates a data-presenting window group with an identifier and a default value.
