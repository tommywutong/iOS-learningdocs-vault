...
beta: false
deprecated: true
doc_path: '/documentation/swiftui/alert/init(title:message:dismissbutton:)'
source_url: 'https://developer.apple.com/documentation/swiftui/alert/init(title:message:dismissbutton:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/alert/init%28title%3Amessage%3Adismissbutton%3A%29.json'
content_hash: 'sha256:d80b15729edee37a'
translated: false
---
