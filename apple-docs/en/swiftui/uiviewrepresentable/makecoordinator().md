...
beta: false
deprecated: false
doc_path: /documentation/swiftui/uiviewrepresentable/makecoordinator()
source_url: 'https://developer.apple.com/documentation/swiftui/uiviewrepresentable/makecoordinator()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/uiviewrepresentable/makecoordinator%28%29.json'
content_hash: 'sha256:cce99a9d44891461'
translated: false
---
...
- [makeCoordinator()](<makecoordinator()-9405l.md>) — Creates the custom instance that you use to communicate changes from your view to other parts of your SwiftUI interface.
