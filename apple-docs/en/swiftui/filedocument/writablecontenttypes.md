...
beta: false
deprecated: true
doc_path: /documentation/swiftui/filedocument/writablecontenttypes
source_url: 'https://developer.apple.com/documentation/swiftui/filedocument/writablecontenttypes'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/filedocument/writablecontenttypes.json'
content_hash: 'sha256:b0774bf62f7f05e8'
translated: false
---
...
- [writableContentTypes](writablecontenttypes-289b3.md) — The file types that the document supports saving or exporting to. _(deprecated)_
