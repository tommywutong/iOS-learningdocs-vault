...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/stepper/init(label:onincrement:ondecrement:oneditingchanged:)'
source_url: 'https://developer.apple.com/documentation/swiftui/stepper/init(label:onincrement:ondecrement:oneditingchanged:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/stepper/init%28label%3Aonincrement%3Aondecrement%3Aoneditingchanged%3A%29.json'
content_hash: 'sha256:b779d5a0150d8a9b'
translated: false
---
...
![A view displaying a stepper that uses a text view for stepper’s title](../../../../attachments/454b319c800c954fe79070014aaa7d83/SwiftUI-Stepper-increment-decrement-closures@2x.png)

## See Also

### Creating a stepper with change behavior

- [init(_:onIncrement:onDecrement:onEditingChanged:)](<init(__onincrement_ondecrement_oneditingchanged_).md>) — Creates a stepper that uses a title key and executes the closures you provide when the user clicks or taps the stepper’s increment and decrement buttons.
