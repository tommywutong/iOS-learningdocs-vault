...
beta: false
deprecated: false
doc_path: /documentation/swiftui/accessorycircularcapacitygaugestyle
source_url: 'https://developer.apple.com/documentation/swiftui/accessorycircularcapacitygaugestyle'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/accessorycircularcapacitygaugestyle.json'
content_hash: 'sha256:35cd23a76df69637'
translated: false
---
...
- [init()](<accessorycircularcapacitygaugestyle/init().md>) — Creates an accessory circular capacity gauge style.
