...
beta: false
deprecated: false
doc_path: /documentation/swiftui/movetransition
source_url: 'https://developer.apple.com/documentation/swiftui/movetransition'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/movetransition.json'
content_hash: 'sha256:c6d496a2f6ea87a2'
translated: false
---
...
- [init(edge:)](<movetransition/init(edge_).md>) — Creates a transition that moves the view away, towards the specified edge of the view.
