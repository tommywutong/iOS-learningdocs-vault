...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/meshgradient/init(width:height:points:colors:background:smoothscolors:colorspace:)'
source_url: 'https://developer.apple.com/documentation/swiftui/meshgradient/init(width:height:points:colors:background:smoothscolors:colorspace:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/meshgradient/init%28width%3Aheight%3Apoints%3Acolors%3Abackground%3Asmoothscolors%3Acolorspace%3A%29.json'
content_hash: 'sha256:d4977cdbca5ae25b'
translated: false
---
