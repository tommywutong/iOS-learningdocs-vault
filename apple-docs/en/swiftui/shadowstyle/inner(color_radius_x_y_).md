...
beta: false
deprecated: false
doc_path: '/documentation/swiftui/shadowstyle/inner(color:radius:x:y:)'
source_url: 'https://developer.apple.com/documentation/swiftui/shadowstyle/inner(color:radius:x:y:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftui/shadowstyle/inner%28color%3Aradius%3Ax%3Ay%3A%29.json'
content_hash: 'sha256:8cd2b46b243b2b2c'
translated: false
---
...
- [drop(color:radius:x:y:)](<drop(color_radius_x_y_).md>) — Creates a custom drop shadow style.
