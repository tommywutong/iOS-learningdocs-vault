...
beta: false
deprecated: false
doc_path: '/documentation/mapkit/marker/init(item:)'
source_url: 'https://developer.apple.com/documentation/mapkit/marker/init(item:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/marker/init%28item%3A%29.json'
content_hash: 'sha256:db68a66c5856edf8'
translated: false
---
