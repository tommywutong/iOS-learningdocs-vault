---
title: 'init(initialPosition:bounds:interactionModes:selection:scope:)'
framework: MapKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/mapkit/map/init(initialposition:bounds:interactionmodes:selection:scope:)'
source_url: 'https://developer.apple.com/documentation/mapkit/map/init(initialposition:bounds:interactionmodes:selection:scope:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/map/init%28initialposition%3Abounds%3Ainteractionmodes%3Aselection%3Ascope%3A%29.json'
content_hash: 'sha256:12f9615c5a7782ba'
translated: false
---
