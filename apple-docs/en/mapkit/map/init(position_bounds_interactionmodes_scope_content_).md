---
title: 'init(position:bounds:interactionModes:scope:content:)'
framework: MapKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/mapkit/map/init(position:bounds:interactionmodes:scope:content:)'
source_url: 'https://developer.apple.com/documentation/mapkit/map/init(position:bounds:interactionmodes:scope:content:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/map/init%28position%3Abounds%3Ainteractionmodes%3Ascope%3Acontent%3A%29.json'
content_hash: 'sha256:c61ddff75b6fdfb0'
translated: false
---
