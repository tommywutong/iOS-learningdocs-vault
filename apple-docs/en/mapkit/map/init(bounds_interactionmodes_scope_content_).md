---
title: 'init(bounds:interactionModes:scope:content:)'
framework: MapKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/mapkit/map/init(bounds:interactionmodes:scope:content:)'
source_url: 'https://developer.apple.com/documentation/mapkit/map/init(bounds:interactionmodes:scope:content:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/map/init%28bounds%3Ainteractionmodes%3Ascope%3Acontent%3A%29.json'
content_hash: 'sha256:a3d213f59e8cac0f'
translated: false
---
