...
beta: false
deprecated: true
doc_path: '/documentation/mapkit/map/init(coordinateregion:interactionmodes:showsuserlocation:usertrackingmode:annotationitems:annotationcontent:)'
source_url: 'https://developer.apple.com/documentation/mapkit/map/init(coordinateregion:interactionmodes:showsuserlocation:usertrackingmode:annotationitems:annotationcontent:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/map/init%28coordinateregion%3Ainteractionmodes%3Ashowsuserlocation%3Ausertrackingmode%3Aannotationitems%3Aannotationcontent%3A%29.json'
content_hash: 'sha256:cdbfd791fe1e1724'
translated: false
---
