---
title: 'init(coordinateRegion:interactionModes:showsUserLocation:userTrackingMode:)'
framework: MapKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: true
doc_path: '/documentation/mapkit/map/init(coordinateregion:interactionmodes:showsuserlocation:usertrackingmode:)'
source_url: 'https://developer.apple.com/documentation/mapkit/map/init(coordinateregion:interactionmodes:showsuserlocation:usertrackingmode:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/map/init%28coordinateregion%3Ainteractionmodes%3Ashowsuserlocation%3Ausertrackingmode%3A%29.json'
content_hash: 'sha256:27f0ec1b0f620b36'
translated: false
---
