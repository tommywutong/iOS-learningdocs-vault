...
platforms: [iOS 16.0+, iPadOS 16.0+, Mac Catalyst 16.0+, Xcode 16.0+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: /documentation/mapkit/displaying-an-updating-path-of-a-user-s-location-history
source_url: 'https://developer.apple.com/documentation/mapkit/displaying-an-updating-path-of-a-user-s-location-history'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/displaying-an-updating-path-of-a-user-s-location-history.json'
content_hash: 'sha256:412d51217f9f2e16'
translated: false
---
...
After the app calls [`startUpdatingLocation`](<../corelocation/cllocationmanager/startupdatinglocation().md>) on the location manager, Core Location provides location updates to the location manager’s delegate. Then the app forwards the location updates to other functions in the app responsible for maintaining the user’s location history.
...
A custom overlay renderer also needs to implement the [- drawMapRect:zoomScale:inContext:](<mkoverlayrenderer/draw(__zoomscale_in_).md>) method to draw the requested section of the overlay. The app draws only the portion of the overlay within the bounds of the provided `MKMapRect` into the provided [`CGContext`](../coregraphics/cgcontext.md).
...
- [DisplayingAnUpdatingPathOfAUsersLocationHistory.zip](https://docs-assets.developer.apple.com/published/c00f1c04d71b/DisplayingAnUpdatingPathOfAUsersLocationHistory.zip)
