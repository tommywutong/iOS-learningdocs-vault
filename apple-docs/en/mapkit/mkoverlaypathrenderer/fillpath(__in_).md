...
beta: false
deprecated: false
doc_path: '/documentation/mapkit/mkoverlaypathrenderer/fillpath(_:in:)'
source_url: 'https://developer.apple.com/documentation/mapkit/mkoverlaypathrenderer/fillpath(_:in:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/mapkit/mkoverlaypathrenderer/fillpath%28_%3Ain%3A%29.json'
content_hash: 'sha256:bef5e165ebc918e4'
translated: false
---
...
You must set the current fill color before calling this method. Typically you do this by calling the [- applyFillPropertiesToContext:atZoomScale:](<applyfillproperties(to_atzoomscale_).md>) method prior to drawing. If the [fillColor](fillcolor.md) property is currently `nil`, this method does nothing.
