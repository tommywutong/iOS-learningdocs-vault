...
beta: false
deprecated: false
doc_path: /documentation/widgetkit/staticcontrolconfiguration
source_url: 'https://developer.apple.com/documentation/widgetkit/staticcontrolconfiguration'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/widgetkit/staticcontrolconfiguration.json'
content_hash: 'sha256:9fa8e857be72f06d'
translated: false
---
...
- [init(kind:content:)](<staticcontrolconfiguration/init(kind_content_).md>) — Creates a configuration for a control, with no user-configurable options.
- [init(kind:provider:content:)](<staticcontrolconfiguration/init(kind_provider_content_).md>) — Creates a configuration for a control, with no user-configurable options.
