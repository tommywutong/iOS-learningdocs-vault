...
beta: false
deprecated: false
doc_path: '/documentation/synchronization/atomic/exchange(_:ordering:)-9kb4s'
source_url: 'https://developer.apple.com/documentation/synchronization/atomic/exchange(_:ordering:)-9kb4s'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/synchronization/atomic/exchange%28_%3Aordering%3A%29-9kb4s.json'
content_hash: 'sha256:5df830424a7093af'
translated: false
---
