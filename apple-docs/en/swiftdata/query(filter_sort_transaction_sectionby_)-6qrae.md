...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:transaction:sectionby:)-6qrae'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:transaction:sectionby:)-6qrae'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Atransaction%3Asectionby%3A%29-6qrae.json'
content_hash: 'sha256:6f4ec22db3443636'
translated: false
---
