...
beta: false
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:)-6kkiu'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:)-6kkiu'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3A%29-6kkiu.json'
content_hash: 'sha256:51ca625d2b9183e2'
translated: false
---
