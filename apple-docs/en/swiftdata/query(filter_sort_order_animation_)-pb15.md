...
beta: false
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:animation:)-pb15'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:animation:)-pb15'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Aanimation%3A%29-pb15.json'
content_hash: 'sha256:2af7d5125d5c6fc6'
translated: false
---
