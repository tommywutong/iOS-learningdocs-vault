...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:animation:sectionby:)-5wk67'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:animation:sectionby:)-5wk67'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aanimation%3Asectionby%3A%29-5wk67.json'
content_hash: 'sha256:ea5e6cb880d61467'
translated: false
---
