...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:order:transaction:sectionby:)-930wx'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:order:transaction:sectionby:)-930wx'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-930wx.json'
content_hash: 'sha256:60eecdbe05c9d797'
translated: false
---
