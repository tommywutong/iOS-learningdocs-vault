...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-7d51r'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-7d51r'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aorder%3Aanimation%3Asectionby%3A%29-7d51r.json'
content_hash: 'sha256:22c4741d414cc2f4'
translated: false
---
