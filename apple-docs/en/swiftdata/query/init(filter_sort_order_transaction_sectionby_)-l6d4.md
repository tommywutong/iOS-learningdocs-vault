...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:order:transaction:sectionby:)-l6d4'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:order:transaction:sectionby:)-l6d4'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-l6d4.json'
content_hash: 'sha256:c27ee1f6dab2d29e'
translated: false
---
