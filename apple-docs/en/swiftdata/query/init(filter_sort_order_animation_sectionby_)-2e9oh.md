...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-2e9oh'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-2e9oh'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aorder%3Aanimation%3Asectionby%3A%29-2e9oh.json'
content_hash: 'sha256:8d9ad3a662f320a2'
translated: false
---
