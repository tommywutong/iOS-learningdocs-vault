...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-4pdmu'
source_url: 'https://developer.apple.com/documentation/swiftdata/query/init(filter:sort:order:animation:sectionby:)-4pdmu'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query/init%28filter%3Asort%3Aorder%3Aanimation%3Asectionby%3A%29-4pdmu.json'
content_hash: 'sha256:ad5cdb04ae3b99ef'
translated: false
---
