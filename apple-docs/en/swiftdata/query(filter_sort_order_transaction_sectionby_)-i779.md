...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-i779'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-i779'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-i779.json'
content_hash: 'sha256:cfa561cf583590af'
translated: false
---
