...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-6c6ho'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-6c6ho'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-6c6ho.json'
content_hash: 'sha256:71b217d28b80d857'
translated: false
---
