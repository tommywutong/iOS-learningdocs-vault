...
beta: false
deprecated: false
doc_path: '/documentation/swiftdata/schema/attribute/option/transformable(by:)-9d4xh'
source_url: 'https://developer.apple.com/documentation/swiftdata/schema/attribute/option/transformable(by:)-9d4xh'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/schema/attribute/option/transformable%28by%3A%29-9d4xh.json'
content_hash: 'sha256:f03bce57baeecbd7'
translated: false
---
