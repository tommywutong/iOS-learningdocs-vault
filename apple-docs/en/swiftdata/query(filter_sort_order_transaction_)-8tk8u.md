...
beta: false
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:)-8tk8u'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:)-8tk8u'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3A%29-8tk8u.json'
content_hash: 'sha256:bde9a23682324f79'
translated: false
---
