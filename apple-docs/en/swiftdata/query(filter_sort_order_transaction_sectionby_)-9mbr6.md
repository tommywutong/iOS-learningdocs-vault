...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-9mbr6'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-9mbr6'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-9mbr6.json'
content_hash: 'sha256:20cc5d4d7a3e03cf'
translated: false
---
