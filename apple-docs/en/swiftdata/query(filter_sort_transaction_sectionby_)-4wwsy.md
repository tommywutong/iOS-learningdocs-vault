...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:transaction:sectionby:)-4wwsy'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:transaction:sectionby:)-4wwsy'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Atransaction%3Asectionby%3A%29-4wwsy.json'
content_hash: 'sha256:8faaa247bb067fec'
translated: false
---
