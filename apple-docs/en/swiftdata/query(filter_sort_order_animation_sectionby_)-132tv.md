...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:animation:sectionby:)-132tv'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:animation:sectionby:)-132tv'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Aanimation%3Asectionby%3A%29-132tv.json'
content_hash: 'sha256:4ae921f2e1a5177b'
translated: false
---
