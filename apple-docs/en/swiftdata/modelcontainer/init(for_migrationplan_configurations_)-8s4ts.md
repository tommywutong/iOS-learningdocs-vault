...
beta: false
deprecated: false
doc_path: '/documentation/swiftdata/modelcontainer/init(for:migrationplan:configurations:)-8s4ts'
source_url: 'https://developer.apple.com/documentation/swiftdata/modelcontainer/init(for:migrationplan:configurations:)-8s4ts'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/modelcontainer/init%28for%3Amigrationplan%3Aconfigurations%3A%29-8s4ts.json'
content_hash: 'sha256:1fd5826abfd5c81c'
translated: false
---
...
- [init(for:migrationPlan:configurations:)](<init(for_migrationplan_configurations_)-qof9.md>) — Creates a model container using the specified schema, migration plan, and zero or more configurations.
