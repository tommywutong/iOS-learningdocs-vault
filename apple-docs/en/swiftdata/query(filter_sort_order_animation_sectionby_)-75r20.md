...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:animation:sectionby:)-75r20'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:animation:sectionby:)-75r20'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Aanimation%3Asectionby%3A%29-75r20.json'
content_hash: 'sha256:a75cd98a99b3edb8'
translated: false
---
