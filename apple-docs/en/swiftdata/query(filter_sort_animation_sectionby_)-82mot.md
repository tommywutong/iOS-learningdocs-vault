...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:animation:sectionby:)-82mot'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:animation:sectionby:)-82mot'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aanimation%3Asectionby%3A%29-82mot.json'
content_hash: 'sha256:ded928985ccf6b01'
translated: false
---
