...
beta: true
deprecated: false
doc_path: '/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-3cn7t'
source_url: 'https://developer.apple.com/documentation/swiftdata/query(filter:sort:order:transaction:sectionby:)-3cn7t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swiftdata/query%28filter%3Asort%3Aorder%3Atransaction%3Asectionby%3A%29-3cn7t.json'
content_hash: 'sha256:12cbf4a75b6cfdbb'
translated: false
---
