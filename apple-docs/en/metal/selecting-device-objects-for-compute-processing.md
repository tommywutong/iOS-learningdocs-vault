...
platforms: [macOS 10.13+, Xcode 12.4+]
languages: [swift, swift, occ, occ]
beta: false
deprecated: false
doc_path: /documentation/metal/selecting-device-objects-for-compute-processing
source_url: 'https://developer.apple.com/documentation/metal/selecting-device-objects-for-compute-processing'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/selecting-device-objects-for-compute-processing.json'
content_hash: 'sha256:558ae5fe3c7130e2'
translated: false
---
...
![](../../../attachments/239dfde287be75deb3e951a6b772b82d/3-single-device-buffer.png)

<sub>A flowchart that shows the simulation with a single Metal buffer on the main thread. The simulation produces data and transfers it to a MTLBuffer. The renderer then draws the data in the MTLBuffer. Finally, the process repeats itself.</sub>
...
- [SelectingDeviceObjectsForComputeProcessing.zip](https://docs-assets.developer.apple.com/published/9dab948f9c4f/SelectingDeviceObjectsForComputeProcessing.zip)
