...
beta: false
deprecated: false
doc_path: '/documentation/metal/mtlcommandbuffer/pushdebuggroup(_:)'
source_url: 'https://developer.apple.com/documentation/metal/mtlcommandbuffer/pushdebuggroup(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlcommandbuffer/pushdebuggroup%28_%3A%29.json'
content_hash: 'sha256:424cb00bc6c912d0'
translated: false
---
...
- [- popDebugGroup](<popdebuggroup().md>) — Marks the end of a debug group and, if applicable, restores the previous group from a stack.
