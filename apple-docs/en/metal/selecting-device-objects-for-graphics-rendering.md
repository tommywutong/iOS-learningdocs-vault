...
beta: false
deprecated: false
doc_path: /documentation/metal/selecting-device-objects-for-graphics-rendering
source_url: 'https://developer.apple.com/documentation/metal/selecting-device-objects-for-graphics-rendering'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/selecting-device-objects-for-graphics-rendering.json'
content_hash: 'sha256:a2cd2b47b3c54daa'
translated: false
---
...
![](../../../attachments/dfb4637e8bc81ad32ee2cdd3f52af7d8/FastestDrawablePath_BuiltIn.png)

<sub>A system diagram that shows two possible pathways for a drawable. The recommended pathway renders a drawable with an integrated GPU and presents it on a built-in display. The not recommended pathway renders a drawable with a discrete GPU and transfers it to an integrated GPU before presenting it on a built-in display.</sub>

Another example is a Mac connected to an external GPU, where the external GPU drives an external display.

![](../../../attachments/d07ddebc4886354ce8389e6a00378aba/FastestDrawablePath_External.png)

<sub>A system diagram that shows two possible pathways for a drawable. The recommended pathway renders a drawable with an external GPU and presents it on an external display. The not recommended pathway renders a drawable with a discrete or integrated GPU and transfers it to an external GPU before presenting it on an external display.</sub>
...
- [SelectingDeviceObjectsForGraphicsRendering.zip](https://docs-assets.developer.apple.com/published/187f3109f6d8/SelectingDeviceObjectsForGraphicsRendering.zip)
