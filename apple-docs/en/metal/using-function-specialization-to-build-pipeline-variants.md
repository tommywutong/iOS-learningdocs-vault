...
beta: false
deprecated: false
doc_path: /documentation/metal/using-function-specialization-to-build-pipeline-variants
source_url: 'https://developer.apple.com/documentation/metal/using-function-specialization-to-build-pipeline-variants'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/using-function-specialization-to-build-pipeline-variants.json'
content_hash: 'sha256:d9467912b659daa4'
translated: false
---
...
![LOD with Function Specialization](../../../attachments/bb6ef3f8d62dddb3c52f3f6e0241987b/lod-with-function-constants-1-LODWithFunctionSpecialization@2x.png)
...
![Levels of Detail](../../../attachments/3cb45549fabb172c758319ac9d4dd546/lod-with-function-constants-2-LevelsOfDetail@2x.png)
...
The Metal _function specialization_ feature reduces branch performance costs, avoids code duplication, and leverages build time compilation. Function specialization allows you to create multiple executable versions of a single source function. You create specialized functions by declaring _function constants_ in your Metal shading language code and setting their values at runtime. Doing so allows the front-end compiler to precompile your source function at build time and the back-end compiler to compile the specialized function at runtime, when the pipeline is created.
...
- [UsingFunctionSpecializationToBuildPipelineVariants.zip](https://docs-assets.developer.apple.com/published/014f9e1b1a25/UsingFunctionSpecializationToBuildPipelineVariants.zip)
