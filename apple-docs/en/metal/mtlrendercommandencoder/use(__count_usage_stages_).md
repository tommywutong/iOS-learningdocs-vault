---
title: 'use(_:count:usage:stages:)'
framework: Metal
symbol_kind: method
role: symbol
...
beta: false
deprecated: true
doc_path: '/documentation/metal/mtlrendercommandencoder/use(_:count:usage:stages:)'
source_url: 'https://developer.apple.com/documentation/metal/mtlrendercommandencoder/use(_:count:usage:stages:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlrendercommandencoder/use%28_%3Acount%3Ausage%3Astages%3A%29.json'
content_hash: 'sha256:96ad8c94d2685cfc'
translated: false
---
