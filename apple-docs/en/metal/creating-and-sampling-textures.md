...
beta: false
deprecated: false
doc_path: /documentation/metal/creating-and-sampling-textures
source_url: 'https://developer.apple.com/documentation/metal/creating-and-sampling-textures'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/creating-and-sampling-textures.json'
content_hash: 'sha256:27f79bc0a558dd8e'
translated: false
---
...
You use textures to draw and process images in Metal. A texture is a structured collection of texture elements, often called _texels_ or _pixels_. The exact configuration of these texture elements depends on the type of texture. This sample uses a texture structured as a 2D array of elements, each of which contains color data, to hold an image. The texture is drawn onto geometric primitives through a process called _texture mapping_. The fragment function generates colors for each fragment by sampling the texture.
...
![Bit Layout of the BGRA8Unorm Pixel Format](../../../attachments/c3d70e8002863ea924bf136c372c5bcf/1-BGRA8UnormBitLayout.png)
...
Use an [MTLTextureDescriptor](mtltexturedescriptor.md) object to configure properties like texture dimensions and pixel format for an [MTLTexture](mtltexture.md) object. Then call the [- newTextureWithDescriptor:](<mtldevice/maketexture(descriptor_).md>) method to create a texture.
...
Call the [- replaceRegion:mipmapLevel:withBytes:bytesPerRow:](<mtltexture/replace(region_mipmaplevel_withbytes_bytesperrow_).md>) method on the texture to copy pixel data from the `AAPLImage` object into the texture.
...
![Visualizing Texture Coordinates](../../../attachments/a0dac218926802ccbb16373b9fb7c978/2-MetalTextureCoordinates.png)
...
- [CreatingAndSamplingTextures.zip](https://docs-assets.developer.apple.com/published/6f670b0b5d94/CreatingAndSamplingTextures.zip)
