...
beta: false
deprecated: false
doc_path: /documentation/metal/mtlcomputepipelinestate/reflection
source_url: 'https://developer.apple.com/documentation/metal/mtlcomputepipelinestate/reflection'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlcomputepipelinestate/reflection.json'
content_hash: 'sha256:c912ca73119445a0'
translated: false
---
...
The property is `nil` when you create a pipeline state from an[MTLDevice](../mtldevice.md) instance, such as with its [- newComputePipelineStateWithDescriptor:options:completionHandler:](<../mtldevice/makecomputepipelinestate(descriptor_options_completionhandler_).md>) method.
