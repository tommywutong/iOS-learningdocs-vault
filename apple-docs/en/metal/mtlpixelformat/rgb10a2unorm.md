...
beta: false
deprecated: false
doc_path: /documentation/metal/mtlpixelformat/rgb10a2unorm
source_url: 'https://developer.apple.com/documentation/metal/mtlpixelformat/rgb10a2unorm'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlpixelformat/rgb10a2unorm.json'
content_hash: 'sha256:1ef64907bd495e7c'
translated: false
---
...
<sub>Bit layout diagram showing the pixel data storage arrangement of the rgb10a2Unorm pixel format. The red component is stored in bits 0 to 9, the green component is stored in bits 10 to 19, the blue component is stored in bits 20 to 29, and the alpha component is stored in bits 30 to 31.</sub>
