---
title: MTLPixelFormat.pvrtc_rgba_2bpp_srgb
framework: Metal
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: true
doc_path: /documentation/metal/mtlpixelformat/pvrtc_rgba_2bpp_srgb
source_url: 'https://developer.apple.com/documentation/metal/mtlpixelformat/pvrtc_rgba_2bpp_srgb'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlpixelformat/pvrtc_rgba_2bpp_srgb.json'
content_hash: 'sha256:f91db1de40dc21b2'
translated: false
---
...
- [MTLPixelFormatPVRTC_RGBA_4BPP_sRGB](pvrtc_rgba_4bpp_srgb.md) — A compressed format that uses PVRTC compression and 4bpp for RGBA components with a conversion between sRGB and linear space. _(deprecated)_
