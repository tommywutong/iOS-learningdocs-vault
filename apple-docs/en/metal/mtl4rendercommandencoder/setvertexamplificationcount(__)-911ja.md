...
beta: false
deprecated: false
doc_path: '/documentation/metal/mtl4rendercommandencoder/setvertexamplificationcount(_:)-911ja'
source_url: 'https://developer.apple.com/documentation/metal/mtl4rendercommandencoder/setvertexamplificationcount(_:)-911ja'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtl4rendercommandencoder/setvertexamplificationcount%28_%3A%29-911ja.json'
content_hash: 'sha256:f9103ba7014f6df3'
translated: false
---
...
- [setVertexAmplificationCount(_:)](<setvertexamplificationcount(__)-85tu1.md>) — Sets the vertex amplification count and its view mapping for each amplification ID.
