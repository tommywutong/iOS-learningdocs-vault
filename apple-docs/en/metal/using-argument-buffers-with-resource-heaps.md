...
beta: false
deprecated: false
doc_path: /documentation/metal/using-argument-buffers-with-resource-heaps
source_url: 'https://developer.apple.com/documentation/metal/using-argument-buffers-with-resource-heaps'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/using-argument-buffers-with-resource-heaps.json'
content_hash: 'sha256:fb0646ba85df79e4'
translated: false
---
...
![](../../../attachments/c6d3fcaf3ae4a7586e95129c46cb72a5/argument-buffers-with-heaps-1-ArgumentBufferWithArrays.png)

<sub>Layout diagram that shows an array of textures, an array of buffers, and an array of constants all encoded into a single argument buffer.</sub>
...
- [UsingArgumentBuffersWithResourceHeaps.zip](https://docs-assets.developer.apple.com/published/514424a93273/UsingArgumentBuffersWithResourceHeaps.zip)
