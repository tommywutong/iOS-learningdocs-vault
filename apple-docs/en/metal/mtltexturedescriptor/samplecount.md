...
beta: false
deprecated: false
doc_path: /documentation/metal/mtltexturedescriptor/samplecount
source_url: 'https://developer.apple.com/documentation/metal/mtltexturedescriptor/samplecount'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtltexturedescriptor/samplecount.json'
content_hash: 'sha256:ad96f2e98f711cdd'
translated: false
---
...
Support for different sample count values varies by device. Call the [- supportsTextureSampleCount:](<../mtldevice/supportstexturesamplecount(__).md>) method to determine if your desired sample count value is supported.
