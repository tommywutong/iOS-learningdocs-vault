...
beta: false
deprecated: false
doc_path: '/documentation/metal/mtlcomputecommandencoder/useresources(_:usage:)'
source_url: 'https://developer.apple.com/documentation/metal/mtlcomputecommandencoder/useresources(_:usage:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtlcomputecommandencoder/useresources%28_%3Ausage%3A%29.json'
content_hash: 'sha256:2b73d9b6f39aa48d'
translated: false
---
...
- `usage` — All the applicable access types for use of these resources, including [MTLResourceUsageRead](../mtlresourceusage/read.md) and [MTLResourceUsageWrite](../mtlresourceusage/write.md). Your resource usage type applies to all resources passed to this method call. For applicable resources, you may be able to prevent the GPU from unnecessarily decompressing color attachments on some devices by setting `usage` to [MTLResourceUsageRead](../mtlresourceusage/read.md).
