...
beta: false
deprecated: false
doc_path: /documentation/metal/reading-pixel-data-from-a-drawable-texture
source_url: 'https://developer.apple.com/documentation/metal/reading-pixel-data-from-a-drawable-texture'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/reading-pixel-data-from-a-drawable-texture.json'
content_hash: 'sha256:71fc016ef14ad08f'
translated: false
---
...
- [ReadingPixelDataFromADrawableTexture.zip](https://docs-assets.developer.apple.com/published/6c0bd32987e6/ReadingPixelDataFromADrawableTexture.zip)
