...
beta: false
deprecated: false
doc_path: '/documentation/metal/mtltexture/getbytes(_:bytesperrow:bytesperimage:from:mipmaplevel:slice:)'
source_url: 'https://developer.apple.com/documentation/metal/mtltexture/getbytes(_:bytesperrow:bytesperimage:from:mipmaplevel:slice:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/metal/mtltexture/getbytes%28_%3Abytesperrow%3Abytesperimage%3Afrom%3Amipmaplevel%3Aslice%3A%29.json'
content_hash: 'sha256:60fcb9918963faca'
translated: false
---
...
- [- getBytes:bytesPerRow:fromRegion:mipmapLevel:](<getbytes(__bytesperrow_from_mipmaplevel_).md>) — Copies pixel data from the first slice of the texture to a buffer in system memory.
