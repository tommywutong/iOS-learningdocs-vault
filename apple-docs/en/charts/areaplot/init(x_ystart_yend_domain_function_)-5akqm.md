...
beta: false
deprecated: false
doc_path: '/documentation/charts/areaplot/init(x:ystart:yend:domain:function:)-5akqm'
source_url: 'https://developer.apple.com/documentation/charts/areaplot/init(x:ystart:yend:domain:function:)-5akqm'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/charts/areaplot/init%28x%3Aystart%3Ayend%3Adomain%3Afunction%3A%29-5akqm.json'
content_hash: 'sha256:eadf4fed1ad59a1a'
translated: false
---
