---
title: 'init(_:x:yStart:yEnd:width:stacking:)'
...
beta: false
deprecated: false
doc_path: '/documentation/charts/barplot/init(_:x:ystart:yend:width:stacking:)-680hw'
source_url: 'https://developer.apple.com/documentation/charts/barplot/init(_:x:ystart:yend:width:stacking:)-680hw'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/charts/barplot/init%28_%3Ax%3Aystart%3Ayend%3Awidth%3Astacking%3A%29-680hw.json'
content_hash: 'sha256:a30b0d9a5c06a736'
translated: false
---
