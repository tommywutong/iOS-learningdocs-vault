...
beta: false
deprecated: false
doc_path: '/documentation/charts/rectangleplot/init(_:xstart:xend:ystart:yend:)-741lz'
source_url: 'https://developer.apple.com/documentation/charts/rectangleplot/init(_:xstart:xend:ystart:yend:)-741lz'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/charts/rectangleplot/init%28_%3Axstart%3Axend%3Aystart%3Ayend%3A%29-741lz.json'
content_hash: 'sha256:6cbe8f1f8101b80b'
translated: false
---
...
- [init(_:xStart:xEnd:yStart:yEnd:)](<init(__xstart_xend_ystart_yend_)-4g377.md>)
