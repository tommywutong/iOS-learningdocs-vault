...
platforms: [iOS 2.0+, iPadOS 2.0+, Mac Catalyst 13.1+, macOS 10.4+, tvOS 9.0+, visionOS 1.0+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: /documentation/cfnetwork/kcfstreamsslvalidatescertificatechain
source_url: 'https://developer.apple.com/documentation/cfnetwork/kcfstreamsslvalidatescertificatechain'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cfnetwork/kcfstreamsslvalidatescertificatechain.json'
content_hash: 'sha256:5892ecbdfe2127ac'
translated: false
---
