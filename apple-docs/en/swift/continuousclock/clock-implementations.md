...
> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Time](../time-and-duration.md) · [ContinuousClock](../continuousclock.md)
...
- [measure(_:)](<measure(__)-73b0n.md>) — Measure the elapsed time to execute a closure.
- [measure(_:)](<measure(__)-9npzl.md>) — Measure the elapsed time to execute an asynchronous closure.
...
- [continuous](continuous.md) — A clock that measures time that always increments but does not stop incrementing while the system is asleep.
