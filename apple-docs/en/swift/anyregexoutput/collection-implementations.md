...
beta: false
deprecated: false
doc_path: /documentation/swift/anyregexoutput/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/anyregexoutput/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/anyregexoutput/collection-implementations.json'
content_hash: 'sha256:4896e2578d3b3bf3'
translated: false
---

> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Strings and Text](../strings-and-text.md) · [AnyRegexOutput](../anyregexoutput.md)
...
- [map(_:)](<map(__)-1uh24.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [trimmingPrefix(while:)](<trimmingprefix(while_).md>)

### Subscripts

- [subscript(_:)](<subscript(__)-60hc1.md>) — Accesses the element at the specified position.
- [subscript(_:)](<subscript(__)-smvg.md>) — Accesses a contiguous subrange of the collection’s elements.
