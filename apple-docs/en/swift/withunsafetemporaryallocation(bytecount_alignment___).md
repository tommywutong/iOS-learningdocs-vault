...
beta: false
deprecated: false
doc_path: '/documentation/swift/withunsafetemporaryallocation(bytecount:alignment:_:)'
source_url: 'https://developer.apple.com/documentation/swift/withunsafetemporaryallocation(bytecount:alignment:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/withunsafetemporaryallocation%28bytecount%3Aalignment%3A_%3A%29.json'
content_hash: 'sha256:720b9da5611f67ef'
translated: false
---
...
When `body` is called, the contents of the buffer pointer passed to it are in an unspecified, uninitialized state. `body` is responsible for initializing the buffer pointer before it is used _and_ for deinitializing it before returning, but deallocation is automatic.
