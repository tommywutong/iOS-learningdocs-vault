...
beta: false
deprecated: false
doc_path: '/documentation/swift/int/init(exactly:)-7qdwf'
source_url: 'https://developer.apple.com/documentation/swift/int/init(exactly:)-7qdwf'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/int/init%28exactly%3A%29-7qdwf.json'
content_hash: 'sha256:e830262379e58eca'
translated: false
---
