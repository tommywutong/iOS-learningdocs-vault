...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint8/words-swift.struct/drop(while:)'
source_url: 'https://developer.apple.com/documentation/swift/uint8/words-swift.struct/drop(while:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint8/words-swift.struct/drop%28while%3A%29.json'
content_hash: 'sha256:4e6fceff023bea4e'
translated: false
---
