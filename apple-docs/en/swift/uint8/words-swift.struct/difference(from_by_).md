...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint8/words-swift.struct/difference(from:by:)'
source_url: 'https://developer.apple.com/documentation/swift/uint8/words-swift.struct/difference(from:by:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint8/words-swift.struct/difference%28from%3Aby%3A%29.json'
content_hash: 'sha256:f54aac1ac84476cf'
translated: false
---
