...
beta: false
deprecated: false
doc_path: /documentation/swift/uint8/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint8/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint8/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:525c44a72578a894'
translated: false
---
...
- [map(_:)](<map(__)-8uu3w.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
