...
beta: false
deprecated: false
doc_path: /documentation/swift/int32/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/int32/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/int32/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:d5d8d57281296ef8'
translated: false
---
...
- [map(_:)](<map(__)-5jw3d.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
