...
beta: false
deprecated: false
doc_path: /documentation/swift/int32/signedinteger-implementations
source_url: 'https://developer.apple.com/documentation/swift/int32/signedinteger-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/int32/signedinteger-implementations.json'
content_hash: 'sha256:00eba2d7cead659e'
translated: false
---
...
- [init(_:)](<init(__)-47iba.md>) — Creates a new instance from the given integer.
- [init(exactly:)](<init(exactly_)-7er6b.md>)
