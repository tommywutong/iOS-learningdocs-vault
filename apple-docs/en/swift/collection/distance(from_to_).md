...
beta: false
deprecated: false
doc_path: '/documentation/swift/collection/distance(from:to:)'
source_url: 'https://developer.apple.com/documentation/swift/collection/distance(from:to:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/collection/distance%28from%3Ato%3A%29.json'
content_hash: 'sha256:fad4bd157010d121'
translated: false
---
...
- [distance(from:to:)](<../bidirectionalcollection/distance(from_to_)-5ofg0.md>)
- [distance(from:to:)](<../bidirectionalcollection/distance(from_to_)-6p3we.md>) — Returns the distance between two indices.

### Collection Implementations

- [distance(from:to:)](<distance(from_to_)-2rytr.md>)
- [distance(from:to:)](<distance(from_to_)-zoy0.md>) — Returns the distance between two indices.
