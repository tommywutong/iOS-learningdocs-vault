...
beta: false
deprecated: false
doc_path: '/documentation/swift/collection/index(_:offsetby:limitedby:)'
source_url: 'https://developer.apple.com/documentation/swift/collection/index(_:offsetby:limitedby:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/collection/index%28_%3Aoffsetby%3Alimitedby%3A%29.json'
content_hash: 'sha256:37046979196844db'
translated: false
---
...
- [index(_:offsetBy:limitedBy:)](<../bidirectionalcollection/index(__offsetby_limitedby_)-567lj.md>)
- [index(_:offsetBy:limitedBy:)](<../bidirectionalcollection/index(__offsetby_limitedby_)-8jlcd.md>) — Returns an index that is the specified distance from the given index, unless that distance is beyond a given limiting index.

### Collection Implementations

- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-4m1pi.md>)
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-7713p.md>) — Returns an index that is the specified distance from the given index, unless that distance is beyond a given limiting index.
