...
beta: false
deprecated: false
doc_path: '/documentation/swift/rangereplaceablecollection/reservecapacity(_:)'
source_url: 'https://developer.apple.com/documentation/swift/rangereplaceablecollection/reservecapacity(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/rangereplaceablecollection/reservecapacity%28_%3A%29.json'
content_hash: 'sha256:76ad08f091712af6'
translated: false
---
...
- [reserveCapacity(_:)](<reservecapacity(__)-1ewcj.md>) — Prepares the collection to store the specified number of elements, when doing so is appropriate for the underlying type.
