...
beta: false
deprecated: false
doc_path: '/documentation/swift/rangereplaceablecollection/insert(contentsof:at:)'
source_url: 'https://developer.apple.com/documentation/swift/rangereplaceablecollection/insert(contentsof:at:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/rangereplaceablecollection/insert%28contentsof%3Aat%3A%29.json'
content_hash: 'sha256:b2c40193ee7e4739'
translated: false
---
...
- [insert(contentsOf:at:)](<insert(contentsof_at_)-3h5sa.md>) — Inserts the elements of a sequence into the collection at the specified position.
