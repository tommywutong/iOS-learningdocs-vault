...
beta: false
deprecated: false
doc_path: /documentation/swift/joinedsequence/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/joinedsequence/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/joinedsequence/sequence-implementations.json'
content_hash: 'sha256:5ee36c9b67aa8883'
translated: false
---

> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Collections](../collections.md) · [Supporting Types](../supporting-types.md) · [JoinedSequence](../joinedsequence.md)
...
- [Iterator](iterator.md) — An iterator that presents the elements of the sequences traversed by a base iterator, concatenated using a given separator.
...
- [flatMap(_:)](<flatmap(__)-1dxn5.md>)
- [flatMap(_:)](<flatmap(__)-5cevu.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
...
- [joined(separator:)](<joined(separator_)-3n0qi.md>) — Returns the concatenated elements of this sequence of sequences, inserting the given separator between each element.
- [joined(separator:)](<joined(separator_)-5tb1r.md>) — Returns a new string by concatenating the elements of the sequence, adding the given separator between each element.
...
- [makeIterator()](<makeiterator().md>) — Return an iterator over the elements of this sequence.
