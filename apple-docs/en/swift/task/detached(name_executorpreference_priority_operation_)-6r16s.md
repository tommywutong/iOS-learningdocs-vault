...
beta: false
deprecated: false
doc_path: '/documentation/swift/task/detached(name:executorpreference:priority:operation:)-6r16s'
source_url: 'https://developer.apple.com/documentation/swift/task/detached(name:executorpreference:priority:operation:)-6r16s'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/task/detached%28name%3Aexecutorpreference%3Apriority%3Aoperation%3A%29-6r16s.json'
content_hash: 'sha256:376b8684804e2831'
translated: false
---
...
Runs the given throwing operation asynchronously as part of a new _unstructured_ _detached_ top-level task.
