...
beta: false
deprecated: false
doc_path: '/documentation/swift/task/immediatedetached(name:priority:executorpreference:operation:)-52ipd'
source_url: 'https://developer.apple.com/documentation/swift/task/immediatedetached(name:priority:executorpreference:operation:)-52ipd'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/task/immediatedetached%28name%3Apriority%3Aexecutorpreference%3Aoperation%3A%29-52ipd.json'
content_hash: 'sha256:dd1808bdb7a01b89'
translated: false
---
...
- [immediateDetached(name:priority:executorPreference:operation:)](<immediatedetached(name_priority_executorpreference_operation_)-7h41b.md>) — Create and immediately start running a new detached task in the context of the calling thread/task.
