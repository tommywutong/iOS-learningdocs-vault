...
beta: false
deprecated: false
doc_path: /documentation/swift/asyncthrowingfiltersequence
source_url: 'https://developer.apple.com/documentation/swift/asyncthrowingfiltersequence'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/asyncthrowingfiltersequence.json'
content_hash: 'sha256:34c8c0a0f2462a0e'
translated: false
---
...
- [Iterator](asyncthrowingfiltersequence/iterator.md) — The iterator that produces elements of the filter sequence.

### Type Aliases

- [Failure](asyncthrowingfiltersequence/failure.md) — The type of element produced by this asynchronous sequence.
