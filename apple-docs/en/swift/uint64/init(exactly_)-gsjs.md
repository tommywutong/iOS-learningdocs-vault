...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint64/init(exactly:)-gsjs'
source_url: 'https://developer.apple.com/documentation/swift/uint64/init(exactly:)-gsjs'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint64/init%28exactly%3A%29-gsjs.json'
content_hash: 'sha256:5d6ca356189e3c98'
translated: false
---
