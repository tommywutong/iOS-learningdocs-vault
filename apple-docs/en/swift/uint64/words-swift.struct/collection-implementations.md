...
beta: false
deprecated: false
doc_path: /documentation/swift/uint64/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint64/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint64/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:c26765a2519563b0'
translated: false
---
...
- [map(_:)](<map(__)-56c2z.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
