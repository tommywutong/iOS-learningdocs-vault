...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint64/words-swift.struct/firstindex(where:)'
source_url: 'https://developer.apple.com/documentation/swift/uint64/words-swift.struct/firstindex(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint64/words-swift.struct/firstindex%28where%3A%29.json'
content_hash: 'sha256:cb1e3bf6a51ee2f8'
translated: false
---
