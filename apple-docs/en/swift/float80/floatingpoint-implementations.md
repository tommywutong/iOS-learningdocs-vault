...
beta: false
deprecated: false
doc_path: /documentation/swift/float80/floatingpoint-implementations
source_url: 'https://developer.apple.com/documentation/swift/float80/floatingpoint-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/float80/floatingpoint-implementations.json'
content_hash: 'sha256:219966b55bb95e38'
translated: false
---
...
- [init(_:)](<init(__)-33oy4.md>) — Creates a new value, rounded to the closest possible representation.
- [init(_:)](<init(__)-42n91.md>) — Creates a new value, rounded to the closest possible representation.
- [init(exactly:)](<init(exactly_)-2t92j.md>) — Creates a new value, if the given integer can be represented exactly.
...
- [init(signOf:magnitudeOf:)](<init(signof_magnitudeof_)-t3cu.md>) — Creates a new floating-point value using the sign of one value and the magnitude of another.
