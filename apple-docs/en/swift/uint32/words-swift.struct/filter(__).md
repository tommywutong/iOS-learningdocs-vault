...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint32/words-swift.struct/filter(_:)'
source_url: 'https://developer.apple.com/documentation/swift/uint32/words-swift.struct/filter(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint32/words-swift.struct/filter%28_%3A%29.json'
content_hash: 'sha256:456db1e1517ed312'
translated: false
---
