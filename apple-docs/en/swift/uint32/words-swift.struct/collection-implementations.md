...
beta: false
deprecated: false
doc_path: /documentation/swift/uint32/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint32/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint32/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:41b60ccf8e342200'
translated: false
---
...
- [map(_:)](<map(__)-44w53.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
