...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint32/words-swift.struct/map(_:)-7y8u7'
source_url: 'https://developer.apple.com/documentation/swift/uint32/words-swift.struct/map(_:)-7y8u7'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint32/words-swift.struct/map%28_%3A%29-7y8u7.json'
content_hash: 'sha256:805d747c11cb20c9'
translated: false
---
