...
beta: false
deprecated: false
doc_path: /documentation/swift/uint128/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint128/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint128/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:4e5fd4a9590250b7'
translated: false
---
...
- [map(_:)](<map(__)-3232r.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
