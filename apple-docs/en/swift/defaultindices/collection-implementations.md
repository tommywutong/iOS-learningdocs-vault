...
- [map(_:)](<map(__)-5p6p7.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-1grsk.md>) — Accesses the element at the specified position.
- [subscript(_:)](<subscript(__)-392od.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-4ala2.md>)
- [subscript(_:)](<subscript(__)-4h7sp.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-8o3ct.md>) — Accesses a contiguous subrange of the collection’s elements.
