...
beta: false
deprecated: false
doc_path: '/documentation/swift/bidirectionalcollection/index(_:offsetby:limitedby:)'
source_url: 'https://developer.apple.com/documentation/swift/bidirectionalcollection/index(_:offsetby:limitedby:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/bidirectionalcollection/index%28_%3Aoffsetby%3Alimitedby%3A%29.json'
content_hash: 'sha256:67d07b866129cff3'
translated: false
---
...
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-567lj.md>)
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-8jlcd.md>) — Returns an index that is the specified distance from the given index, unless that distance is beyond a given limiting index.
