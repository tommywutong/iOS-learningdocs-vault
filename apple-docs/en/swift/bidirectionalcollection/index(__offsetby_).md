...
beta: false
deprecated: false
doc_path: '/documentation/swift/bidirectionalcollection/index(_:offsetby:)'
source_url: 'https://developer.apple.com/documentation/swift/bidirectionalcollection/index(_:offsetby:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/bidirectionalcollection/index%28_%3Aoffsetby%3A%29.json'
content_hash: 'sha256:f4f34d2bfb4f9afe'
translated: false
---
...
- [index(_:offsetBy:)](<index(__offsetby_)-1t7ir.md>)
- [index(_:offsetBy:)](<index(__offsetby_)-3cj6r.md>) — Returns an index that is the specified distance from the given index.
