...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint/words-swift.struct/min(by:)'
source_url: 'https://developer.apple.com/documentation/swift/uint/words-swift.struct/min(by:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint/words-swift.struct/min%28by%3A%29.json'
content_hash: 'sha256:4d978bc1b9562cda'
translated: false
---
