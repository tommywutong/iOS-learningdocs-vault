...
beta: false
deprecated: false
doc_path: /documentation/swift/uint/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:f1cbf6e2b1e33cce'
translated: false
---
...
- [map(_:)](<map(__)-2w7k9.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
