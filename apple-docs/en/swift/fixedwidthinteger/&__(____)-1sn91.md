...
beta: false
deprecated: false
doc_path: '/documentation/swift/fixedwidthinteger/&__(_:_:)-1sn91'
source_url: 'https://developer.apple.com/documentation/swift/fixedwidthinteger/&__(_:_:)-1sn91'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/fixedwidthinteger/%26__%28_%3A_%3A%29-1sn91.json'
content_hash: 'sha256:95eb5751ea090ad0'
translated: false
---
...
- [&\>\>(_:_:)](<&__(____)-6o5at.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the right, masking the shift amount to the type’s bit width.
- [&\>\>(_:_:)](<&__(____)-9b5yu.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the right, masking the shift amount to the type’s bit width.
