...
beta: false
deprecated: false
doc_path: /documentation/swift/collectionofone/bidirectionalcollection-implementations
source_url: 'https://developer.apple.com/documentation/swift/collectionofone/bidirectionalcollection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/collectionofone/bidirectionalcollection-implementations.json'
content_hash: 'sha256:cb6cdc985c973dc2'
translated: false
---
...
- [joined(separator:)](<joined(separator_)-7kra3.md>) — Returns a new string by concatenating the elements of the sequence, adding the given separator between each element.
