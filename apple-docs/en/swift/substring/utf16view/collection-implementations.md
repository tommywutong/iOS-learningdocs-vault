...
beta: false
deprecated: false
doc_path: /documentation/swift/substring/utf16view/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/substring/utf16view/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/substring/utf16view/collection-implementations.json'
content_hash: 'sha256:169eb4da8fc23970'
translated: false
---

> Navigation: [Technologies](../../../technologies.md) · [Swift](../../../swift.md) · [String](../../string.md) · [Substring](../../substring.md) · [StringProtocol Implementations](../stringprotocol-implementations.md) · [UTF16View](../utf16view.md)
...
- [map(_:)](<map(__)-2jwvg.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-20thk.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-2ljg7.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-3ijoy.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-5j3ao.md>)
- [subscript(_:)](<subscript(__)-ketw.md>) — Accesses the element at the specified position.
