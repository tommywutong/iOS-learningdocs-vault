...
beta: false
deprecated: false
doc_path: /documentation/swift/substring/utf16view/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/substring/utf16view/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/substring/utf16view/sequence-implementations.json'
content_hash: 'sha256:c5b79571bcb4e307'
translated: false
---
...
- [flatMap(_:)](<flatmap(__)-2i1gn.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
- [flatMap(_:)](<flatmap(__)-8ecws.md>)
...
- [map(_:)](<map(__)-7n24w.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
