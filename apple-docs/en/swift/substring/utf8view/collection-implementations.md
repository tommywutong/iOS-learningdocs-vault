...
beta: false
deprecated: false
doc_path: /documentation/swift/substring/utf8view/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/substring/utf8view/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/substring/utf8view/collection-implementations.json'
content_hash: 'sha256:d3fbf3d598e39f0d'
translated: false
---

> Navigation: [Technologies](../../../technologies.md) · [Swift](../../../swift.md) · [String](../../string.md) · [Substring](../../substring.md) · [StringProtocol Implementations](../stringprotocol-implementations.md) · [UTF8View](../utf8view.md)
...
- [map(_:)](<map(__)-3dhqn.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-3zacs.md>)
- [subscript(_:)](<subscript(__)-6liln.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-7hfz9.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-9ouv5.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-goc1.md>) — Accesses the element at the specified position.
