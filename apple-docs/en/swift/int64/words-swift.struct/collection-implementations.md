...
beta: false
deprecated: false
doc_path: /documentation/swift/int64/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/int64/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/int64/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:3a84ba0e28f299ad'
translated: false
---
...
- [map(_:)](<map(__)-79bxt.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
