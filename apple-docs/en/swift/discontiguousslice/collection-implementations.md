...
beta: false
deprecated: false
doc_path: /documentation/swift/discontiguousslice/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/discontiguousslice/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/discontiguousslice/collection-implementations.json'
content_hash: 'sha256:f9ad23e5c993c16a'
translated: false
---
...
- [Index](index.md) — A position in a `DiscontiguousSlice`.
...
- [distance(from:to:)](<distance(from_to_)-7p9uz.md>) — Returns the distance between two indices.
...
- [map(_:)](<map(__)-44xuh.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-5ji1p.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
...
- [subscript(_:)](<subscript(__)-1ra8t.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-1ytel.md>)
- [subscript(_:)](<subscript(__)-8h9i0.md>) — Accesses the element at the specified position.
