...
beta: false
deprecated: false
doc_path: /documentation/swift/lazydropwhilesequence/bidirectionalcollection-implementations
source_url: 'https://developer.apple.com/documentation/swift/lazydropwhilesequence/bidirectionalcollection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/lazydropwhilesequence/bidirectionalcollection-implementations.json'
content_hash: 'sha256:f0651b5232a457ac'
translated: false
---
...
- [distance(from:to:)](<distance(from_to_)-5dj4t.md>)
- [formIndex(before:)](<formindex(before_).md>) — Replaces the given index with its predecessor.
- [index(_:offsetBy:)](<index(__offsetby_)-7kg8e.md>)
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-269cw.md>)
- [index(before:)](<index(before_).md>) — Returns the position immediately before the given index.
- [joined(separator:)](<joined(separator_)-5cgwz.md>) — Returns a new string by concatenating the elements of the sequence, adding the given separator between each element.
