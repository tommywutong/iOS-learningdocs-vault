...
beta: false
deprecated: false
doc_path: /documentation/swift/float16/floatingpoint-implementations
source_url: 'https://developer.apple.com/documentation/swift/float16/floatingpoint-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/float16/floatingpoint-implementations.json'
content_hash: 'sha256:ac6d66e5185c328b'
translated: false
---
...
- [init(_:)](<init(__)-4iaoz.md>) — Creates a new value, rounded to the closest possible representation.
- [init(_:)](<init(__)-67cee.md>) — Creates a new value, rounded to the closest possible representation.
- [init(exactly:)](<init(exactly_)-2qxl0.md>) — Creates a new value, if the given integer can be represented exactly.
...
- [init(signOf:magnitudeOf:)](<init(signof_magnitudeof_)-1oylh.md>) — Creates a new floating-point value using the sign of one value and the magnitude of another.
