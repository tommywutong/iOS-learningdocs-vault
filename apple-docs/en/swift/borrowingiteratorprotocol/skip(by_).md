...
beta: true
deprecated: false
doc_path: '/documentation/swift/borrowingiteratorprotocol/skip(by:)'
source_url: 'https://developer.apple.com/documentation/swift/borrowingiteratorprotocol/skip(by:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/borrowingiteratorprotocol/skip%28by%3A%29.json'
content_hash: 'sha256:560dde7d7167552f'
translated: false
---
...
- [skip(by:)](<skip(by_)-1sm4a.md>) — Advances the position of this iterator by the specified offset, or until the end of the underlying type’s elements. _(beta)_
