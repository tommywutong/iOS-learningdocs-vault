...
beta: false
deprecated: false
doc_path: /documentation/swift/collectiondifference/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/collectiondifference/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/collectiondifference/collection-implementations.json'
content_hash: 'sha256:cbce59159d5a1677'
translated: false
---

> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Collections](../collections.md) · [Supporting Types](../supporting-types.md) · [CollectionDifference](../collectiondifference.md)
...
- [Index](index.md) — The position of a collection difference.
...
- [distance(from:to:)](<distance(from_to_)-945d8.md>) — Returns the distance between two indices.
...
- [formIndex(_:offsetBy:)](<formindex(__offsetby_)-21k4b.md>) — Offsets the given index by the specified distance.
...
- [map(_:)](<map(__)-zouk.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-1dhc.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
...
- [subscript(_:)](<subscript(__)-22qdy.md>) — Accesses a contiguous subrange of the collection’s elements.
