...
beta: false
deprecated: false
doc_path: '/documentation/swift/binaryinteger/ismultiple(of:)'
source_url: 'https://developer.apple.com/documentation/swift/binaryinteger/ismultiple(of:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/binaryinteger/ismultiple%28of%3A%29.json'
content_hash: 'sha256:d91cfbbb20400e02'
translated: false
---
...
- [isMultiple(of:)](<ismultiple(of_)-3ings.md>) — Returns `true` if this value is a multiple of the given value, and `false` otherwise.
- [isMultiple(of:)](<ismultiple(of_)-8eqba.md>) — Returns `true` if this value is a multiple of the given value, and `false` otherwise.
