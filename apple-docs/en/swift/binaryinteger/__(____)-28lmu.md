...
beta: false
deprecated: false
doc_path: '/documentation/swift/binaryinteger/__(_:_:)-28lmu'
source_url: 'https://developer.apple.com/documentation/swift/binaryinteger/__(_:_:)-28lmu'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/binaryinteger/__%28_%3A_%3A%29-28lmu.json'
content_hash: 'sha256:7ecd9af2eb4773c0'
translated: false
---
...
- [\<\<(_:_:)](<__(____)-570t7.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the left.
- [\<\<(_:_:)](<__(____)-9f03g.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the left.
