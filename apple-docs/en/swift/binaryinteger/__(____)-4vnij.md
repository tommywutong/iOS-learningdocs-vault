...
beta: false
deprecated: false
doc_path: '/documentation/swift/binaryinteger/__(_:_:)-4vnij'
source_url: 'https://developer.apple.com/documentation/swift/binaryinteger/__(_:_:)-4vnij'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/binaryinteger/__%28_%3A_%3A%29-4vnij.json'
content_hash: 'sha256:8cad1554489112d8'
translated: false
---
...
- [\>\>(_:_:)](<__(____)-6ne6o.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the right.
- [\>\>(_:_:)](<__(____)-7llmt.md>) — Returns the result of shifting a value’s binary representation the specified number of digits to the right.
