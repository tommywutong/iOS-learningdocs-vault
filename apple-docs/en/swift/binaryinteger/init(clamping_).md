...
beta: false
deprecated: false
doc_path: '/documentation/swift/binaryinteger/init(clamping:)'
source_url: 'https://developer.apple.com/documentation/swift/binaryinteger/init(clamping:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/binaryinteger/init%28clamping%3A%29.json'
content_hash: 'sha256:306640a006d85468'
translated: false
---
...
- [init(clamping:)](<init(clamping_)-6bply.md>) — Creates a new instance with the representable value that’s closest to the given integer.
