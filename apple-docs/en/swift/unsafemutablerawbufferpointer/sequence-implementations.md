...
beta: false
deprecated: false
doc_path: /documentation/swift/unsafemutablerawbufferpointer/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/unsafemutablerawbufferpointer/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unsafemutablerawbufferpointer/sequence-implementations.json'
content_hash: 'sha256:2ef3cf7facb4d9d5'
translated: false
---
...
- [flatMap(_:)](<flatmap(__)-6chty.md>)
- [flatMap(_:)](<flatmap(__)-i3n9.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
...
- [map(_:)](<map(__)-9jnov.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [withContiguousStorageIfAvailable(_:)](<withcontiguousstorageifavailable(__)-1ynsq.md>) — Executes a closure on the sequence’s contiguous storage.
