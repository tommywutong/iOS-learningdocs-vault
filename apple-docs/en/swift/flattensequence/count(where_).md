...
beta: false
deprecated: false
doc_path: '/documentation/swift/flattensequence/count(where:)'
source_url: 'https://developer.apple.com/documentation/swift/flattensequence/count(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/flattensequence/count%28where%3A%29.json'
content_hash: 'sha256:42caf9a1a3acaed2'
translated: false
---
