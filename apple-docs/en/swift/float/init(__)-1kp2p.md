...
beta: false
deprecated: false
doc_path: '/documentation/swift/float/init(_:)-1kp2p'
source_url: 'https://developer.apple.com/documentation/swift/float/init(_:)-1kp2p'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/float/init%28_%3A%29-1kp2p.json'
content_hash: 'sha256:fb2334f9ea3df8bf'
translated: false
---
