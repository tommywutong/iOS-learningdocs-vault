...
beta: false
deprecated: false
doc_path: /documentation/swift/float/floatingpoint-implementations
source_url: 'https://developer.apple.com/documentation/swift/float/floatingpoint-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/float/floatingpoint-implementations.json'
content_hash: 'sha256:40eabd65608c03a8'
translated: false
---
...
- [init(exactly:)](<init(exactly_)-uz92.md>) — Creates a new value, if the given integer can be represented exactly.
...
- [init(signOf:magnitudeOf:)](<init(signof_magnitudeof_)-6i9uw.md>) — Creates a new floating-point value using the sign of one value and the magnitude of another.
