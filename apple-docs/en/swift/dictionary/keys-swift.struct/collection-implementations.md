...
beta: false
deprecated: false
doc_path: /documentation/swift/dictionary/keys-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/dictionary/keys-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/dictionary/keys-swift.struct/collection-implementations.json'
content_hash: 'sha256:eb584dcda4fbd0e4'
translated: false
---
...
- [map(_:)](<map(__)-6ax5v.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
