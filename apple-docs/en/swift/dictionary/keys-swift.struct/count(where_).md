...
beta: false
deprecated: false
doc_path: '/documentation/swift/dictionary/keys-swift.struct/count(where:)'
source_url: 'https://developer.apple.com/documentation/swift/dictionary/keys-swift.struct/count(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/dictionary/keys-swift.struct/count%28where%3A%29.json'
content_hash: 'sha256:4cf826d99596190d'
translated: false
---
