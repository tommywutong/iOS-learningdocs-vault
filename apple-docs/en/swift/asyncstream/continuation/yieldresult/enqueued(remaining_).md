---
title: 'AsyncStream.Continuation.YieldResult.enqueued(remaining:)'
framework: Swift
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: '/documentation/swift/asyncstream/continuation/yieldresult/enqueued(remaining:)'
source_url: 'https://developer.apple.com/documentation/swift/asyncstream/continuation/yieldresult/enqueued(remaining:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/asyncstream/continuation/yieldresult/enqueued%28remaining%3A%29.json'
content_hash: 'sha256:6e95a358ed331ce9'
translated: false
---
