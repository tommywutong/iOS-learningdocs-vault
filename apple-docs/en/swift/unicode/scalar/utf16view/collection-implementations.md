...
beta: false
deprecated: false
doc_path: /documentation/swift/unicode/scalar/utf16view/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/unicode/scalar/utf16view/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unicode/scalar/utf16view/collection-implementations.json'
content_hash: 'sha256:c75c8a535f9faee5'
translated: false
---
...
- [map(_:)](<map(__)-1zmqr.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
