...
beta: false
deprecated: false
doc_path: /documentation/swift/unicode/scalar/utf8view/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/unicode/scalar/utf8view/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unicode/scalar/utf8view/sequence-implementations.json'
content_hash: 'sha256:1f41c360f00eec56'
translated: false
---
...
- [flatMap(_:)](<flatmap(__)-5hatl.md>)
- [flatMap(_:)](<flatmap(__)-5jiot.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
...
- [map(_:)](<map(__)-7dggx.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
