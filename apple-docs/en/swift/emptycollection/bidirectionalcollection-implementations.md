...
beta: false
deprecated: false
doc_path: /documentation/swift/emptycollection/bidirectionalcollection-implementations
source_url: 'https://developer.apple.com/documentation/swift/emptycollection/bidirectionalcollection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/emptycollection/bidirectionalcollection-implementations.json'
content_hash: 'sha256:8a44d50d99ea543b'
translated: false
---
...
- [joined(separator:)](<joined(separator_)-rq8f.md>) — Returns a new string by concatenating the elements of the sequence, adding the given separator between each element.
