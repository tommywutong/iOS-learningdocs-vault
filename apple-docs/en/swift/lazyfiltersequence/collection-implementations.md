...
beta: false
deprecated: false
doc_path: /documentation/swift/lazyfiltersequence/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/lazyfiltersequence/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/lazyfiltersequence/collection-implementations.json'
content_hash: 'sha256:b27ac4b7a9d010a2'
translated: false
---

> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Collections](../collections.md) · [Supporting Types](../supporting-types.md) · [LazyFilterSequence](../lazyfiltersequence.md)
...
- [distance(from:to:)](<distance(from_to_)-64w60.md>) — Returns the distance between two indices.
...
- [formIndex(_:offsetBy:)](<formindex(__offsetby_)-4fulw.md>) — Offsets the given index by the specified distance.
- [formIndex(_:offsetBy:limitedBy:)](<formindex(__offsetby_limitedby_)-94oyz.md>) — Offsets the given index by the specified distance, or so that it equals the given limiting index.
- [formIndex(after:)](<formindex(after_).md>) — Replaces the given index with its successor.
- [formIndex(after:)](<formindex(after_)-8eya1.md>) — Replaces the given index with its successor.
- [index(_:offsetBy:)](<index(__offsetby_).md>) — Returns an index that is the specified distance from the given index.
- [index(_:offsetBy:)](<index(__offsetby_)-ghrd.md>) — Returns an index that is the specified distance from the given index.
...
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-6rs60.md>) — Returns an index that is the specified distance from the given index, unless that distance is beyond a given limiting index.
...
- [map(_:)](<map(__)-8n620.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-f04l.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
- [suffix(from:)](<suffix(from_).md>) — Returns a subsequence from the specified position to the end of the collection.

### Subscripts

- [subscript(_:)](<subscript(__)-4caas.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-4syjt.md>) — Accesses the element at `position`.
- [subscript(_:)](<subscript(__)-6uzbx.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-7ge85.md>)
- [subscript(_:)](<subscript(__)-lelz.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
