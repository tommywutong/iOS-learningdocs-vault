...
beta: false
deprecated: false
doc_path: '/documentation/swift/mutablecollection/withcontiguousmutablestorageifavailable(_:)'
source_url: 'https://developer.apple.com/documentation/swift/mutablecollection/withcontiguousmutablestorageifavailable(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/mutablecollection/withcontiguousmutablestorageifavailable%28_%3A%29.json'
content_hash: 'sha256:ac868b1a16d73200'
translated: false
---
...
- [withContiguousMutableStorageIfAvailable(_:)](<withcontiguousmutablestorageifavailable(__)-83khw.md>) — Executes a closure on the collection’s contiguous storage.
