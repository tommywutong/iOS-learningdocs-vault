...
beta: false
deprecated: false
doc_path: '/documentation/swift/string/init(bytes:encoding:)'
source_url: 'https://developer.apple.com/documentation/swift/string/init(bytes:encoding:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/init%28bytes%3Aencoding%3A%29.json'
content_hash: 'sha256:9ead24d336647d8a'
translated: false
---
