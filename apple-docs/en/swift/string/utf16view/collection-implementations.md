...
beta: false
deprecated: false
doc_path: /documentation/swift/string/utf16view/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/string/utf16view/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/utf16view/collection-implementations.json'
content_hash: 'sha256:2f6d67dc80e694f5'
translated: false
---
...
- [map(_:)](<map(__)-28kz8.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-2785k.md>)
- [subscript(_:)](<subscript(__)-5x88v.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-6mt4v.md>) — Accesses a view of this collection with the elements at the given indices.
