...
beta: false
deprecated: false
doc_path: '/documentation/swift/string/init(cstring:)-6kr8s'
source_url: 'https://developer.apple.com/documentation/swift/string/init(cstring:)-6kr8s'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/init%28cstring%3A%29-6kr8s.json'
content_hash: 'sha256:05a6dfcfcdbc9c55'
translated: false
---
