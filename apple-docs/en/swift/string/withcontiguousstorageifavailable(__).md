...
beta: false
deprecated: false
doc_path: '/documentation/swift/string/withcontiguousstorageifavailable(_:)'
source_url: 'https://developer.apple.com/documentation/swift/string/withcontiguousstorageifavailable(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/withcontiguousstorageifavailable%28_%3A%29.json'
content_hash: 'sha256:5e34a31c86f18eb6'
translated: false
---
...
- [init(stringInterpolation:)](<init(stringinterpolation_).md>) — Creates a new instance from an interpolated string literal.
