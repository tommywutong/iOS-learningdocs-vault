...
- [map(_:)](<map(__)-56zez.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-4i2sy.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-gee0.md>) — Accesses a view of this collection with the elements at the given indices.
