...
beta: false
deprecated: false
doc_path: /documentation/swift/string/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/string/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/sequence-implementations.json'
content_hash: 'sha256:20d1f22319108158'
translated: false
---
...
- [filter(_:)](<filter(__)-7pg66.md>) — Returns an array containing, in order, the elements of the sequence that satisfy the given predicate.
...
- [map(_:)](<map(__)-9jnnv.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
