...
beta: false
deprecated: false
doc_path: /documentation/swift/string/utf8view/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/string/utf8view/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/utf8view/sequence-implementations.json'
content_hash: 'sha256:9bdc32efff5602a7'
translated: false
---
...
- [flatMap(_:)](<flatmap(__)-3i8lk.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
- [flatMap(_:)](<flatmap(__)-83zdf.md>)
...
- [map(_:)](<map(__)-6zfwg.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [withContiguousStorageIfAvailable(_:)](<withcontiguousstorageifavailable(__)-3fk9a.md>) — Executes a closure on the sequence’s contiguous storage.
