...
beta: false
deprecated: false
doc_path: /documentation/swift/string/utf8view/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/string/utf8view/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/string/utf8view/collection-implementations.json'
content_hash: 'sha256:11ebdfa524506dbb'
translated: false
---
...
- [index(after:)](<index(after_).md>) — Returns the next consecutive position after `i`.
...
- [map(_:)](<map(__)-4exvs.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [subscript(_:)](<subscript(__)-227fo.md>)
- [subscript(_:)](<subscript(__)-25vyw.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-3gfsv.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-3wo7k.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-6nubh.md>) — Accesses the code unit at the given position.
