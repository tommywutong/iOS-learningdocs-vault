...
beta: false
deprecated: false
doc_path: '/documentation/swift/set/contains(where:)'
source_url: 'https://developer.apple.com/documentation/swift/set/contains(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/set/contains%28where%3A%29.json'
content_hash: 'sha256:41f45dea9e79dc0c'
translated: false
---
