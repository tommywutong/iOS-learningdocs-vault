...
beta: false
deprecated: false
doc_path: '/documentation/swift/set/first(where:)'
source_url: 'https://developer.apple.com/documentation/swift/set/first(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/set/first%28where%3A%29.json'
content_hash: 'sha256:815af8c98cd9d6ee'
translated: false
---
