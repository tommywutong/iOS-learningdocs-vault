...
beta: false
deprecated: false
doc_path: '/documentation/swift/set/withcontiguousstorageifavailable(_:)'
source_url: 'https://developer.apple.com/documentation/swift/set/withcontiguousstorageifavailable(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/set/withcontiguousstorageifavailable%28_%3A%29.json'
content_hash: 'sha256:c8621c534b0162d0'
translated: false
---
...
- [init(arrayLiteral:)](<init(arrayliteral_).md>) — Creates a set containing the elements of the given array literal.
