...
beta: false
deprecated: false
doc_path: /documentation/swift/unsafebufferpointer/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/unsafebufferpointer/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unsafebufferpointer/collection-implementations.json'
content_hash: 'sha256:73960af864bf4ce7'
translated: false
---
...
- [drop(while:)](<drop(while_)-37wp5.md>) — Returns a subsequence by skipping elements while `predicate` returns `true` and returning the remaining elements.
- [dropFirst(_:)](<dropfirst(__)-1rupy.md>) — Returns a subsequence containing all but the given number of initial elements.
- [dropLast(_:)](<droplast(__)-6rw21.md>) — Returns a subsequence containing all but the specified number of final elements.
...
- [map(_:)](<map(__)-5p6pc.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
- [prefix(_:)](<prefix(__)-1n68g.md>) — Returns a subsequence, up to the specified maximum length, containing the initial elements of the collection.
...
- [prefix(while:)](<prefix(while_)-3ariq.md>) — Returns a subsequence containing the initial elements until `predicate` returns `false` and skipping the remaining elements.
...
- [split(maxSplits:omittingEmptySubsequences:whereSeparator:)](<split(maxsplits_omittingemptysubsequences_whereseparator_)-4pbpp.md>) — Returns the longest possible subsequences of the collection, in order, that don’t contain elements satisfying the given predicate.
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-3dglg.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
- [suffix(_:)](<suffix(__)-qdda.md>) — Returns a subsequence, up to the given maximum length, containing the final elements of the collection.
- [suffix(from:)](<suffix(from_).md>) — Returns a subsequence from the specified position to the end of the collection.

### Subscripts

- [subscript(_:)](<subscript(__)-6ynnu.md>) — Accesses a contiguous subrange of the buffer’s elements.
- [subscript(_:)](<subscript(__)-9vykr.md>) — Accesses the element at the specified position.
