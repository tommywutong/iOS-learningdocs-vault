...
beta: false
deprecated: false
doc_path: /documentation/swift/rangeset/ranges-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/rangeset/ranges-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/rangeset/ranges-swift.struct/collection-implementations.json'
content_hash: 'sha256:8c596bff3b48ace4'
translated: false
---
...
- [map(_:)](<map(__)-90u99.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
