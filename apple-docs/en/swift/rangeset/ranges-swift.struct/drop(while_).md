...
beta: false
deprecated: false
doc_path: '/documentation/swift/rangeset/ranges-swift.struct/drop(while:)'
source_url: 'https://developer.apple.com/documentation/swift/rangeset/ranges-swift.struct/drop(while:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/rangeset/ranges-swift.struct/drop%28while%3A%29.json'
content_hash: 'sha256:0e8bedaa1ac4ed10'
translated: false
---
