...
beta: false
deprecated: false
doc_path: /documentation/swift/iteratorsequence/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/iteratorsequence/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/iteratorsequence/sequence-implementations.json'
content_hash: 'sha256:561ed7cff7cf7c58'
translated: false
---

> Navigation: [Technologies](../../technologies.md) · [Swift](../../swift.md) · [Swift Standard Library](../swift-standard-library.md) · [Collections](../collections.md) · [Supporting Types](../supporting-types.md) · [IteratorSequence](../iteratorsequence.md)
...
- [flatMap(_:)](<flatmap(__)-1o4bm.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
- [flatMap(_:)](<flatmap(__)-2tee.md>)
...
- [joined(separator:)](<joined(separator_)-2g7pm.md>) — Returns the concatenated elements of this sequence of sequences, inserting the given separator between each element.
- [joined(separator:)](<joined(separator_)-4ve6o.md>) — Returns a new string by concatenating the elements of the sequence, adding the given separator between each element.
