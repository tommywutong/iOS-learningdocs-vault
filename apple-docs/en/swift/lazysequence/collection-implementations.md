...
beta: false
deprecated: false
doc_path: /documentation/swift/lazysequence/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/lazysequence/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/lazysequence/collection-implementations.json'
content_hash: 'sha256:348da1ccd77051af'
translated: false
---
...
- [count](count.md) — Returns the number of elements.
...
- [distance(from:to:)](<distance(from_to_)-396sb.md>) — Returns the distance between two indices.
...
- [index(_:offsetBy:)](<index(__offsetby_)-t8sl.md>) — Returns an index that is the specified distance from the given index.
...
- [index(_:offsetBy:limitedBy:)](<index(__offsetby_limitedby_)-62vws.md>) — Returns an index that is the specified distance from the given index, unless that distance is beyond a given limiting index.
...
- [map(_:)](<map(__)-7wx5z.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-ki1c.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
- [suffix(from:)](<suffix(from_).md>) — Returns a subsequence from the specified position to the end of the collection.

### Subscripts

- [subscript(_:)](<subscript(__).md>) — Accesses the element at `position`.
- [subscript(_:)](<subscript(__)-1iwxl.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-1rlj.md>)
- [subscript(_:)](<subscript(__)-8iflg.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-9kt1v.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
