...
beta: false
deprecated: false
doc_path: /documentation/swift/dropwhilesequence
source_url: 'https://developer.apple.com/documentation/swift/dropwhilesequence'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/dropwhilesequence.json'
content_hash: 'sha256:5132c2f8fda0c97e'
translated: false
---
...
- [drop(while:)](<dropwhilesequence/drop(while_).md>)

### Type Aliases

- [Element](dropwhilesequence/element.md) — A type representing the sequence’s elements.
