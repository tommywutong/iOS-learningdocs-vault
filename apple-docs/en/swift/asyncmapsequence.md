...
beta: false
deprecated: false
doc_path: /documentation/swift/asyncmapsequence
source_url: 'https://developer.apple.com/documentation/swift/asyncmapsequence'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/asyncmapsequence.json'
content_hash: 'sha256:04500353aed54eb8'
translated: false
---
...
- [Iterator](asyncmapsequence/iterator.md) — The iterator that produces elements of the map sequence.

### Type Aliases

- [Failure](asyncmapsequence/failure.md) — The type of the error that can be produced by the sequence.
