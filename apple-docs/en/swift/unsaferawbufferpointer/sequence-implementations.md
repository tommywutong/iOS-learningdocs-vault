...
beta: false
deprecated: false
doc_path: /documentation/swift/unsaferawbufferpointer/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/unsaferawbufferpointer/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unsaferawbufferpointer/sequence-implementations.json'
content_hash: 'sha256:8e351085cfd77e84'
translated: false
---
...
- [Iterator](iterator.md) — An iterator over the bytes viewed by a raw buffer pointer.
...
- [flatMap(_:)](<flatmap(__)-6chuu.md>)
- [flatMap(_:)](<flatmap(__)-i3md.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
...
- [makeIterator()](<makeiterator().md>) — Returns an iterator over the bytes of this sequence.
- [map(_:)](<map(__)-9jnnz.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [withContiguousStorageIfAvailable(_:)](<withcontiguousstorageifavailable(__)-1ynru.md>) — Executes a closure on the sequence’s contiguous storage.
