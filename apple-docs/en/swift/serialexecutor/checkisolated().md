...
beta: false
deprecated: false
doc_path: /documentation/swift/serialexecutor/checkisolated()
source_url: 'https://developer.apple.com/documentation/swift/serialexecutor/checkisolated()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/serialexecutor/checkisolated%28%29.json'
content_hash: 'sha256:b71257fd4a1dc8e4'
translated: false
---
...
- [checkIsolated()](<checkisolated()-76lg2.md>) — Last resort “fallback” isolation check, called when the concurrency runtime is comparing executors e.g. during `assumeIsolated()` and is unable to prove serial equivalence between the expected (this object), and the current executor.
