---
title: 'moveInitialize(from:count:)'
framework: Swift
symbol_kind: method
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/swift/unsafemutablepointer/moveinitialize(from:count:)'
source_url: 'https://developer.apple.com/documentation/swift/unsafemutablepointer/moveinitialize(from:count:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/unsafemutablepointer/moveinitialize%28from%3Acount%3A%29.json'
content_hash: 'sha256:ce382f0692f66c7b'
translated: false
---
