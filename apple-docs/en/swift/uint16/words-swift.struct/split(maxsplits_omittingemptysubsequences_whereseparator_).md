...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint16/words-swift.struct/split(maxsplits:omittingemptysubsequences:whereseparator:)'
source_url: 'https://developer.apple.com/documentation/swift/uint16/words-swift.struct/split(maxsplits:omittingemptysubsequences:whereseparator:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/words-swift.struct/split%28maxsplits%3Aomittingemptysubsequences%3Awhereseparator%3A%29.json'
content_hash: 'sha256:d5e7c2070235f5f0'
translated: false
---
