...
beta: false
deprecated: false
doc_path: /documentation/swift/uint16/words-swift.struct/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/uint16/words-swift.struct/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/words-swift.struct/collection-implementations.json'
content_hash: 'sha256:45409d03749d1c4e'
translated: false
---
...
- [map(_:)](<map(__)-2jx8u.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
