...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint16/words-swift.struct/difference(from:by:)'
source_url: 'https://developer.apple.com/documentation/swift/uint16/words-swift.struct/difference(from:by:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/words-swift.struct/difference%28from%3Aby%3A%29.json'
content_hash: 'sha256:0239602c9bfae310'
translated: false
---
