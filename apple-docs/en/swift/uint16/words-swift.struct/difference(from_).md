...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint16/words-swift.struct/difference(from:)'
source_url: 'https://developer.apple.com/documentation/swift/uint16/words-swift.struct/difference(from:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/words-swift.struct/difference%28from%3A%29.json'
content_hash: 'sha256:fc451399920ab2a8'
translated: false
---
