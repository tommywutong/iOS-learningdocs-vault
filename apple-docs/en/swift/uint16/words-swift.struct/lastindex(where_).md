...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint16/words-swift.struct/lastindex(where:)'
source_url: 'https://developer.apple.com/documentation/swift/uint16/words-swift.struct/lastindex(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/words-swift.struct/lastindex%28where%3A%29.json'
content_hash: 'sha256:afcb90cbc574960d'
translated: false
---
