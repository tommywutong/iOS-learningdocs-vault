...
beta: false
deprecated: false
doc_path: '/documentation/swift/uint16/init(truncatingifneeded:)'
source_url: 'https://developer.apple.com/documentation/swift/uint16/init(truncatingifneeded:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/uint16/init%28truncatingifneeded%3A%29.json'
content_hash: 'sha256:f7102350b9bccf73'
translated: false
---
