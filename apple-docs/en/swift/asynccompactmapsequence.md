...
beta: false
deprecated: false
doc_path: /documentation/swift/asynccompactmapsequence
source_url: 'https://developer.apple.com/documentation/swift/asynccompactmapsequence'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/asynccompactmapsequence.json'
content_hash: 'sha256:8a134d1a8db5656e'
translated: false
---
...
- [Iterator](asynccompactmapsequence/iterator.md) — The iterator that produces elements of the compact map sequence.

### Type Aliases

- [Failure](asynccompactmapsequence/failure.md) — The type of the error that can be produced by the sequence.
