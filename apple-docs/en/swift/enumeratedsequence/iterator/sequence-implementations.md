...
beta: false
deprecated: false
doc_path: /documentation/swift/enumeratedsequence/iterator/sequence-implementations
source_url: 'https://developer.apple.com/documentation/swift/enumeratedsequence/iterator/sequence-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/enumeratedsequence/iterator/sequence-implementations.json'
content_hash: 'sha256:969979c419b80007'
translated: false
---

> Navigation: [Technologies](../../../technologies.md) · [Swift](../../../swift.md) · [Swift Standard Library](../../swift-standard-library.md) · [Collections](../../collections.md) · [Supporting Types](../../supporting-types.md) · [EnumeratedSequence](../../enumeratedsequence.md) · [Sequence Implementations](../sequence-implementations.md) · [Iterator](../iterator.md)
...
- [flatMap(_:)](<flatmap(__)-50wvd.md>)
- [flatMap(_:)](<flatmap(__)-98frp.md>) — Returns an array containing the concatenated results of calling the given transformation with each element of this sequence.
