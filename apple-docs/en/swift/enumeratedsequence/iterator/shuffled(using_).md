...
beta: false
deprecated: false
doc_path: '/documentation/swift/enumeratedsequence/iterator/shuffled(using:)'
source_url: 'https://developer.apple.com/documentation/swift/enumeratedsequence/iterator/shuffled(using:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/enumeratedsequence/iterator/shuffled%28using%3A%29.json'
content_hash: 'sha256:bbc2e6cfde29d2ec'
translated: false
---
