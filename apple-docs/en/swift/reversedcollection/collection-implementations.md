...
beta: false
deprecated: false
doc_path: /documentation/swift/reversedcollection/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/reversedcollection/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/reversedcollection/collection-implementations.json'
content_hash: 'sha256:cf88dc528ca7282b'
translated: false
---
...
- [map(_:)](<map(__)-7zsm6.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-7uzmt.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
