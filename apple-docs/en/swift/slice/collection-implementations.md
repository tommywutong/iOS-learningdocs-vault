...
beta: false
deprecated: false
doc_path: /documentation/swift/slice/collection-implementations
source_url: 'https://developer.apple.com/documentation/swift/slice/collection-implementations'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/slice/collection-implementations.json'
content_hash: 'sha256:25011e19aceef2a5'
translated: false
---
...
- [map(_:)](<map(__)-3jfli.md>) — Returns an array containing the results of mapping the given closure over the sequence’s elements.
...
- [removeFirst()](<removefirst()-2564w.md>) — Removes and returns the first element of the collection.
- [removeFirst(_:)](<removefirst(__)-3pkd7.md>) — Removes the specified number of elements from the beginning of the collection.
...
- [split(separator:maxSplits:omittingEmptySubsequences:)](<split(separator_maxsplits_omittingemptysubsequences_)-5z4op.md>) — Returns the longest possible subsequences of the collection, in order, around elements equal to the given element.
...
- [subscript(_:)](<subscript(__)-1rloy.md>) — Accesses the element at the specified position.
- [subscript(_:)](<subscript(__)-3p40a.md>) — Accesses a view of this collection with the elements at the given indices.
- [subscript(_:)](<subscript(__)-520wp.md>)
- [subscript(_:)](<subscript(__)-5pgrv.md>) — Accesses a contiguous subrange of the collection’s elements.
- [subscript(_:)](<subscript(__)-5rdkr.md>) — Accesses the contiguous subrange of the collection’s elements specified by a range expression.
- [subscript(_:)](<subscript(__)-7bg96.md>) — Accesses a contiguous subrange of the collection’s elements.
