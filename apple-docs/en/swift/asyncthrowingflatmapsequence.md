...
beta: false
deprecated: false
doc_path: /documentation/swift/asyncthrowingflatmapsequence
source_url: 'https://developer.apple.com/documentation/swift/asyncthrowingflatmapsequence'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/asyncthrowingflatmapsequence.json'
content_hash: 'sha256:6ba5139cce5d1d83'
translated: false
---
...
- [Iterator](asyncthrowingflatmapsequence/iterator.md) — The iterator that produces elements of the flat map sequence.

### Type Aliases

- [Failure](asyncthrowingflatmapsequence/failure.md) — The type of error produced by this asynchronous sequence.
