...
beta: false
deprecated: false
doc_path: '/documentation/swift/rawrepresentable/init(from:)-4ibll'
source_url: 'https://developer.apple.com/documentation/swift/rawrepresentable/init(from:)-4ibll'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/swift/rawrepresentable/init%28from%3A%29-4ibll.json'
content_hash: 'sha256:25cbeb8dbfa387c1'
translated: false
---
...
- [init(from:)](<init(from_)-6z4x4.md>) — Creates a new instance by decoding from the given decoder, when the type’s `RawValue` is `UInt16`.
