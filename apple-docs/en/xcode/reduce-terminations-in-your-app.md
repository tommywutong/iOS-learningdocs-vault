...
<sub>Screenshot of the Terminations pane in the Xcode Organizer. From left to right is the list of metrics and reports, Report List, the foreground and background terminations charts, and the Inspector with additional details for the selected and latest app versions.  </sub>
