...
![A diagram that shows the difference between app binary structure and size in debug and release builds.](../../../attachments/4d30d76e7fd1cf9d1def67b3378d1684/configuring-your-project-to-use-mergeable-libraries@2x.png)
...
> [!note] Note
> Xcode does not automatically build indirect dependencies as mergeable in release builds. To configure indirect dependencies for merging, see the [Manually configure merging](#Manually-configure-merging) section below.
