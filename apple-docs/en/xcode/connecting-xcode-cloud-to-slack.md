---
title: Connecting Xcode Cloud to Slack
framework: xcode
symbol_kind: article
role: article
...
3. Click the Add button (+) next to Post-Actions and choose Notify to add a post-action for sending notifications.
  ...
  ![A screenshot of workflow in Xcode where the Notify - Successes and Failures post-action is visible.](../../../attachments/8613e5cc41a84566c0f05c7590bc6ff0/Connecting-Xcode-Cloud-to-Slack-1@2x.png)
