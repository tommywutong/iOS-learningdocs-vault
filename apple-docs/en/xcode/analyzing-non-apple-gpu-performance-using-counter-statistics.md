...
![A screenshot of the Counters viewer, consisting of a counters timeline and a table for either passes or commands.](../../../attachments/080dc9cc88071641b45ac6b4fa49df86/gputools-metal-debugger-cg-overview@2x.png)
...
![A screenshot of the per-pass counters timeline. The pass with the longest shader GPU time is selected.](../../../attachments/f871c426a724014f50044dde3874e846/gputools-metal-debugger-cg-gpu-time@2x.png)
...
![A screenshot of the Adjust Editor Options menu highlighting the Assistant menu item.](../../../attachments/911dcbdabb78263180376f773de3943f/gputools-metal-debugger-cg-menu-enable-assistant-editor@2x.png)
...
![A screenshot of the Metal debugger showing the Counters viewer and the Performance Statistics viewer side by side.](../../../attachments/a5e835e74f9444d6f12808b75d075141/gputools-metal-debugger-cg-performance@2x.png)
...
![A screenshot of the Metal debugger showing the Counters viewer and the Pipeline Statistics viewer side by side.](../../../attachments/6a9052cfd46b81ec845e0795c1631239/gputools-metal-debugger-cg-pipeline-statistics@2x.png)
