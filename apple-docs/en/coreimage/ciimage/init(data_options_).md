...
beta: false
deprecated: false
doc_path: '/documentation/coreimage/ciimage/init(data:options:)'
source_url: 'https://developer.apple.com/documentation/coreimage/ciimage/init(data:options:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciimage/init%28data%3Aoptions%3A%29.json'
content_hash: 'sha256:f88793e8f39ac8b8'
translated: false
---
