...
beta: false
deprecated: false
doc_path: '/documentation/coreimage/ciimage/init(image:)'
source_url: 'https://developer.apple.com/documentation/coreimage/ciimage/init(image:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciimage/init%28image%3A%29.json'
content_hash: 'sha256:0892df7cde2f6aa1'
translated: false
---
