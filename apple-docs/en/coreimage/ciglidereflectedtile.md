...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciglidereflectedtile
source_url: 'https://developer.apple.com/documentation/coreimage/ciglidereflectedtile'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciglidereflectedtile.json'
content_hash: 'sha256:05a1973f7db7745e'
translated: false
---
...
- [+ glideReflectedTileFilter](<cifilter-swift.class/glidereflectedtile().md>) — Tiles an image by rotating and reflecting a tile from the image.
