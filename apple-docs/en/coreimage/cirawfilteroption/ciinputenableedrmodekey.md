---
title: ciInputEnableEDRModeKey
framework: Core Image
symbol_kind: property
role: symbol
role_heading: Type Property
platforms: [iOS 12.0+（27.0 起废弃）, iPadOS 12.0+（27.0 起废弃）, Mac Catalyst 13.1+（27.0 起废弃）, macOS 10.14+（27.0 起废弃）, tvOS 12.0+（27.0 起废弃）, visionOS 1.0+（27.0 起废弃）]
languages: [swift, occ]
beta: false
deprecated: true
doc_path: /documentation/coreimage/cirawfilteroption/ciinputenableedrmodekey
source_url: 'https://developer.apple.com/documentation/coreimage/cirawfilteroption/ciinputenableedrmodekey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cirawfilteroption/ciinputenableedrmodekey.json'
content_hash: 'sha256:d21d640b56650479'
translated: false
---
