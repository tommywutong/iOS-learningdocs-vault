---
title: ciInputLocalToneMapAmountKey
framework: Core Image
symbol_kind: property
role: symbol
role_heading: Type Property
platforms: [iOS 14.3+（27.0 起废弃）, iPadOS 14.3+（27.0 起废弃）, Mac Catalyst 14.3+（27.0 起废弃）, macOS 11.1+（27.0 起废弃）, tvOS 14.3+（27.0 起废弃）, visionOS 1.0+（27.0 起废弃）]
languages: [swift, occ]
beta: false
deprecated: true
doc_path: /documentation/coreimage/cirawfilteroption/ciinputlocaltonemapamountkey
source_url: 'https://developer.apple.com/documentation/coreimage/cirawfilteroption/ciinputlocaltonemapamountkey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cirawfilteroption/ciinputlocaltonemapamountkey.json'
content_hash: 'sha256:debcb655b23acb4b'
translated: false
---
