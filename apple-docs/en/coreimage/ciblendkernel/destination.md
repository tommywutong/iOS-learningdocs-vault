...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/destination
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/destination'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/destination.json'
content_hash: 'sha256:a122a24d4c5af949'
translated: false
---
...
![The result of using the destination blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/a63ddec93d00a89c915e0e060285232d/media-2926859@2x.png)
