...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/source
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/source'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/source.json'
content_hash: 'sha256:9879ea758fc3ffbe'
translated: false
---
...
![The result of using the source blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/e9689178f88b1fbb7ea979a037f7d30b/media-2926885@2x.png)
