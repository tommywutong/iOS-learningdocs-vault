...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/lighten
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/lighten'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/lighten.json'
content_hash: 'sha256:c354dc4fdc30ae8d'
translated: false
---
...
![The result of using the lighten blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/88ea435b9d78d945a2ab87d97e614527/media-2926869@2x.png)
