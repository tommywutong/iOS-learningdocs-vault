...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/saturation
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/saturation'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/saturation.json'
content_hash: 'sha256:aa67c535a31e323c'
translated: false
---
...
![The result of using the saturation blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/0d16ff472dadd4d9ec75f7fb345c7dc3/media-2926876@2x.png)
