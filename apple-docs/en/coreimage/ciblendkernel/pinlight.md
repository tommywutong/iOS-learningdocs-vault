...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/pinlight
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/pinlight'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/pinlight.json'
content_hash: 'sha256:665cc6c8b3a51e7f'
translated: false
---
...
![The result of using the pin light blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/16c6d0fddde6b46dcdc88b95c42cfbfb/media-2926877@2x.png)
