...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/destinationin
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/destinationin'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/destinationin.json'
content_hash: 'sha256:e85670dd1072f0fa'
translated: false
---
...
![The result of using the destination in blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/e81a2601621e838f0471ccd8c4e6f1f5/media-2926861@2x.png)
