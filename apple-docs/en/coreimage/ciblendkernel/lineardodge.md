...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/lineardodge
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/lineardodge'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/lineardodge.json'
content_hash: 'sha256:27ac4d16f85078e4'
translated: false
---
...
![The result of using the linear dodge blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/39d6fe5a49a241ce148d7531b12b1ec9/media-2926874@2x.png)
