...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/linearlight
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/linearlight'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/linearlight.json'
content_hash: 'sha256:db6a9bb402148d1e'
translated: false
---
...
![The result of using the linear light blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/25b055a971adaf158512466aa26a0037/media-2926873@2x.png)
