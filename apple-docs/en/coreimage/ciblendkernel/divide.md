...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/divide
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/divide'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/divide.json'
content_hash: 'sha256:0aa89b1db6ed57d4'
translated: false
---
...
![The result of using the divide blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/49b26a031a14cff0f673f1c62e1580e7/media-2926864@2x.png)
