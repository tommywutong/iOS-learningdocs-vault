...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/colordodge
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/colordodge'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/colordodge.json'
content_hash: 'sha256:51043ae0d779e57a'
translated: false
---
...
![The result of using the color dodge blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/e3dbcbfe6354ff3cbdaf8ab2105e177a/media-2926851@2x.png)
