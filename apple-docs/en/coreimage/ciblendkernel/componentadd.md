...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/componentadd
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/componentadd'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/componentadd.json'
content_hash: 'sha256:2aa8e7bf04b7e8e4'
translated: false
---
...
![The result of using the component add blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/6b2c1469b6b8526d2c542d843ddd0a74/media-2926853@2x.png)
