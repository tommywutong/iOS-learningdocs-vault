...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/sourcein
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/sourcein'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/sourcein.json'
content_hash: 'sha256:8e4fb432b2c461a1'
translated: false
---
...
![The result of using the source in blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/4741d83ee96cda9ec8de36e07e1e52cb/media-2926883@2x.png)
