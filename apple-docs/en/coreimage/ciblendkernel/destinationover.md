...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/destinationover
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/destinationover'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/destinationover.json'
content_hash: 'sha256:441957e2accc779c'
translated: false
---
...
![The result of using the destination over blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/13a152f8fc708aac6250322275a18a72/media-2926860@2x.png)
