...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/vividlight
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/vividlight'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/vividlight.json'
content_hash: 'sha256:6322c03647564d13'
translated: false
---
...
![The result of using the vivid light blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/8c62673d8ab81285bf31c6f7d365032b/media-2926888@2x.png)
