...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/componentmax
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/componentmax'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/componentmax.json'
content_hash: 'sha256:8ade20cd14a6c66c'
translated: false
---
...
![The result of using the component max blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/421b54bd5b74c7ff0f6ae07982710adb/media-2926854@2x.png)
