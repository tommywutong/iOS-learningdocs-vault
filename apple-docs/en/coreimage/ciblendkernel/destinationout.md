...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/destinationout
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/destinationout'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/destinationout.json'
content_hash: 'sha256:eef13f000d411c69'
translated: false
---
...
![The result of using the destination out blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/11d7d7d3c21f289ec8e4cb1b7a6d49ed/media-2926862@2x.png)
