...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/sourceover
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/sourceover'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/sourceover.json'
content_hash: 'sha256:832f25412dcf85a0'
translated: false
---
...
![The result of using the source over blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/0350b6a017603e0bfac0b4bf10dd6ed9/media-2926884@2x.png)
