...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/color
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/color'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/color.json'
content_hash: 'sha256:3f7fe51f7e2705df'
translated: false
---
...
![The result of using the color blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/33f36aca98480572130d6655b404442e/media-2926849@2x.png)
