...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/linearburn
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/linearburn'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/linearburn.json'
content_hash: 'sha256:87bb06cfabb4739f'
translated: false
---
...
![The result of using the linear burn blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/bd38636e320900ec285433b2d55bc788/media-2926872@2x.png)
