...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/sourceatop
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/sourceatop'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/sourceatop.json'
content_hash: 'sha256:1c7ca277f03c34fc'
translated: false
---
...
![The result of using the source atop blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/0f190b60d6f39645eb2cfc8f6c5ac2b6/media-2926887@2x.png)
