...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/subtract
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/subtract'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/subtract.json'
content_hash: 'sha256:1ed8971a8df9c448'
translated: false
---
...
![The result of using the subtract blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/8056ccc356a2072b1685c9e3b45ab803/media-2926848@2x.png)
