...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/darkercolor
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/darkercolor'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/darkercolor.json'
content_hash: 'sha256:3e2a80fbe331a69c'
translated: false
---
...
![The result of using the darker color blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/02fd8e646805703a4b4b41e6bf133b3e/media-2926857@2x.png)
