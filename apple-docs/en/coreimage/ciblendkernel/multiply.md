...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/multiply
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/multiply'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/multiply.json'
content_hash: 'sha256:8094593a12286c4f'
translated: false
---
...
![The result of using the multiply blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/c21af3f4413072cae4a4679038aceeea/media-2926879@2x.png)
