...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/difference
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/difference'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/difference.json'
content_hash: 'sha256:8ee1e4dd2a450b55'
translated: false
---
...
![The result of using the difference blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/fda1b546a320cd65554bf49fc08f4b03/media-2926863@2x.png)
