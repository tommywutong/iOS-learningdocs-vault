...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/exclusiveor
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/exclusiveor'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/exclusiveor.json'
content_hash: 'sha256:f547639711317ebd'
translated: false
---
...
![The result of using the exclusive or blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/ff95f6cecde4306464b00a64823f0023/media-2926866@2x.png)
