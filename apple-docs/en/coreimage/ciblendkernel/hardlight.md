...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/hardlight
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/hardlight'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/hardlight.json'
content_hash: 'sha256:697f4374222595dd'
translated: false
---
...
![The result of using the hard light blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/c95a2dd85e9eb4354559cff298cd8d7e/media-2926867@2x.png)
