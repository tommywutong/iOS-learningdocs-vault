...
beta: false
deprecated: false
doc_path: /documentation/coreimage/ciblendkernel/componentmultiply
source_url: 'https://developer.apple.com/documentation/coreimage/ciblendkernel/componentmultiply'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/ciblendkernel/componentmultiply.json'
content_hash: 'sha256:671edb5532c66f9b'
translated: false
---
...
![The result of using the component multiply blend kernel (background image is top left, foreground image is bottom left)](../../../../attachments/1dba8c201e4d0b5e383e1fa0c8a1e99a/media-2926856@2x.png)
