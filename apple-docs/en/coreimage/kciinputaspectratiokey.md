---
title: kCIInputAspectRatioKey
framework: Core Image
symbol_kind: var
role: symbol
role_heading: Global Variable
platforms: [iOS 7.0+, iPadOS 7.0+, Mac Catalyst 13.1+, macOS 10.5+, tvOS, visionOS 1.0+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: /documentation/coreimage/kciinputaspectratiokey
source_url: 'https://developer.apple.com/documentation/coreimage/kciinputaspectratiokey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/kciinputaspectratiokey.json'
content_hash: 'sha256:bbfe7cf44835976d'
translated: false
---
