---
title: 'depthBlurEffectFilter(for:disparityImage:portraitEffectsMatte:hairSemanticSegmentation:orientation:options:)'
...
beta: false
deprecated: false
doc_path: '/documentation/coreimage/cicontext/depthblureffectfilter(for:disparityimage:portraiteffectsmatte:hairsemanticsegmentation:orientation:options:)'
source_url: 'https://developer.apple.com/documentation/coreimage/cicontext/depthblureffectfilter(for:disparityimage:portraiteffectsmatte:hairsemanticsegmentation:orientation:options:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cicontext/depthblureffectfilter%28for%3Adisparityimage%3Aportraiteffectsmatte%3Ahairsemanticsegmentation%3Aorientation%3Aoptions%3A%29.json'
content_hash: 'sha256:ec71884eafdf7c0c'
translated: false
---
