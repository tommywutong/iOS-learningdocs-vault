...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cikaleidoscope
source_url: 'https://developer.apple.com/documentation/coreimage/cikaleidoscope'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cikaleidoscope.json'
content_hash: 'sha256:eebd65718c989b2f'
translated: false
---
...
- [+ kaleidoscopeFilter](<cifilter-swift.class/kaleidoscope().md>) — Creates a 12-way kaleidoscopic image from an image.
