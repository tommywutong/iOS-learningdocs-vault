...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cirawfilter/properties
source_url: 'https://developer.apple.com/documentation/coreimage/cirawfilter/properties'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cirawfilter/properties.json'
content_hash: 'sha256:7077ee9b449c459d'
translated: false
---
...
This dictionary contains the same contents as the [Image Properties](../../imageio/image-properties.md) accessed using [CGImageSourceCopyProperties(_:_:)](<../../imageio/cgimagesourcecopyproperties(____).md>).
