...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cifilter-swift.class/photoeffectprocess()
source_url: 'https://developer.apple.com/documentation/coreimage/cifilter-swift.class/photoeffectprocess()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cifilter-swift.class/photoeffectprocess%28%29.json'
content_hash: 'sha256:52deb47cdc520a02'
translated: false
---
...
![](../../../../attachments/9635af252323165ec282cc7c01c4d943/media-3545027@2x.png)

<sub>Two pictures of a pink flower surrounded by foliage. The photo on the left shows a single flower photographed close-up, in focus, with good light and no effects. In the photo on the right, a photo effect process filter is applied, transforming the colors in the image to be a lower contrast.</sub>
