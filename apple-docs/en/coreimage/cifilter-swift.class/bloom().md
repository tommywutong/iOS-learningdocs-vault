...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cifilter-swift.class/bloom()
source_url: 'https://developer.apple.com/documentation/coreimage/cifilter-swift.class/bloom()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cifilter-swift.class/bloom%28%29.json'
content_hash: 'sha256:48bd8b3032b37d6e'
translated: false
---
...
![](../../../../attachments/bed79e81180210637a412e2b9f295592/media-3599995@2x.png)

<sub>Two photographs of multiple sets of small purple flowers surrounded by other flowers and a blue sky. The photo on the left is clear and crisp. In the photo on the right, a bloom filter is applied and the image is brighter and looks slightly fuzzy or hazy.</sub>
