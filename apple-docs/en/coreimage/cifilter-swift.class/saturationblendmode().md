...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cifilter-swift.class/saturationblendmode()
source_url: 'https://developer.apple.com/documentation/coreimage/cifilter-swift.class/saturationblendmode()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cifilter-swift.class/saturationblendmode%28%29.json'
content_hash: 'sha256:bcfd4f61b14583e7'
translated: false
---
...
![](../../../../attachments/714ca45e3700dec0fffcad8ad45cbd39/media-3546404@2x.png)

<sub>The image on the top left shows a beach with multiple palm trees and a rainbow arching across the blue sky.  The image below is a gradient image displaying a gradual color shift from purple to a dark orange. The image on the right shows the output from applying a saturation-blend mode filter. The result displays a gray beach with not much visible detail and only the colors from the gradient photo visible.</sub>
