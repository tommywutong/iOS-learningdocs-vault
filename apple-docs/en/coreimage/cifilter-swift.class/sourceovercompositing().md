...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cifilter-swift.class/sourceovercompositing()
source_url: 'https://developer.apple.com/documentation/coreimage/cifilter-swift.class/sourceovercompositing()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cifilter-swift.class/sourceovercompositing%28%29.json'
content_hash: 'sha256:a7011945e1ec86a8'
translated: false
---
...
![](../../../../attachments/6d9377d9cdb80cb42d9fdd83f3de78b9/media-3546395@2x.png)

<sub>The image on the top left shows a beach with multiple palm trees and a rainbow arching across the blue sky.  The image below is a gradient image displaying a gradual color shift from purple to a dark orange. The image on the right shows the output from applying a source-over compositing filter. The gradient image is overlaid on the beach photo image.</sub>
