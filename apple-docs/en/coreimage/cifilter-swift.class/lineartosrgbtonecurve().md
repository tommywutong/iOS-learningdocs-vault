...
beta: false
deprecated: false
doc_path: /documentation/coreimage/cifilter-swift.class/lineartosrgbtonecurve()
source_url: 'https://developer.apple.com/documentation/coreimage/cifilter-swift.class/lineartosrgbtonecurve()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/cifilter-swift.class/lineartosrgbtonecurve%28%29.json'
content_hash: 'sha256:0692ee2f069aebb1'
translated: false
---
...
![](../../../../attachments/e908adb6e0ae0a589871d898bcadbfe8/media-3545000@2x.png)

<sub>Two versions of a photograph side by side. The photo on the left shows a small bunch of flowers photographed close up, in focus, with good light and no effects. In the photo on the right, a linear to sRGB tone curve filter is applied, resulting in a brighter image with less contrast.</sub>
