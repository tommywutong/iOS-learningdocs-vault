...
beta: false
deprecated: false
doc_path: /documentation/coreimage/citriangletile
source_url: 'https://developer.apple.com/documentation/coreimage/citriangletile'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coreimage/citriangletile.json'
content_hash: 'sha256:aaec1dc34ff2f4c2'
translated: false
---
...
- [+ triangleTileFilter](<cifilter-swift.class/triangletile().md>) — Tiles a triangular area of an image.
