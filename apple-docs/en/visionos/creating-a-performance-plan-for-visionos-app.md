...
beta: false
deprecated: false
doc_path: /documentation/visionos/creating-a-performance-plan-for-visionos-app
source_url: 'https://developer.apple.com/documentation/visionos/creating-a-performance-plan-for-visionos-app'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/visionos/creating-a-performance-plan-for-visionos-app.json'
content_hash: 'sha256:9d59df60e203953a'
translated: false
---
...
For more information on performance tuning, see [Improving your app’s performance](../xcode/improving-your-app-s-performance.md).
...
- **XCTest** — Use [XCTest](../xctest.md) APIs to collect performance data.
...
- Use the [XCTest](../xctest.md) framework to build test cases to collect performance metrics. XCTest lets you gather several different metrics, including the time it takes to perform operations, the amount of CPU activity that occurs during the test, details about memory or storage use, and more.
...
For information about how to write test cases for your app, see [Testing](../xcode/testing.md). For information about how to automate testing with Xcode Cloud, see [Xcode Cloud](../xcode/xcode-cloud.md).
