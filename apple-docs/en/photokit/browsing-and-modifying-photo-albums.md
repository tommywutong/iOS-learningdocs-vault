...
platforms: [iOS 11.0+, iPadOS 11.0+, Mac Catalyst 11.0+, tvOS 13.2+, Xcode 11.3+]
languages: [swift]
beta: false
deprecated: false
doc_path: /documentation/photokit/browsing-and-modifying-photo-albums
source_url: 'https://developer.apple.com/documentation/photokit/browsing-and-modifying-photo-albums'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/photokit/browsing-and-modifying-photo-albums.json'
content_hash: 'sha256:ffc050434f35c0c0'
translated: false
---
...
Implement the `UICollectionView` delegate method [cellForItem(at:)](<../uikit/uicollectionview/cellforitem(at_).md>) to use thumbnails instead of full assets. PhotoKit allows you to request assets directly, and even badge Live Photos to set them apart:
...
After the user picks a filter, the app applies it and outputs the saved asset immediately. There’s no UI state for having chosen—but not yet committed—an edit. As such, there’s no role for reading adjustment data to resume in-progress edits, since PhotoBrowse has no notion of _in-progress_. However, it’s still good practice to write adjustment data so that potential future versions of the app—or other apps that understand your adjustment data format—could make use of it.
...
- [BrowsingAndModifyingPhotoAlbums.zip](https://docs-assets.developer.apple.com/published/f3bb304e42b4/BrowsingAndModifyingPhotoAlbums.zip)
