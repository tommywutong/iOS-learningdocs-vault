---
title: PDFDocumentDidUnlockNotification
framework: PDFKit
symbol_kind: var
role: symbol
...
beta: false
deprecated: false
doc_path: /documentation/pdfkit/pdfdocumentdidunlocknotification
source_url: 'https://developer.apple.com/documentation/pdfkit/pdfdocumentdidunlocknotification'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/pdfkit/pdfdocumentdidunlocknotification.json'
content_hash: 'sha256:4921a21691741554'
translated: false
---
...
A notification that a document unlocks after a [- unlockWithPassword:](<pdfdocument/unlock(withpassword_).md>) message.
