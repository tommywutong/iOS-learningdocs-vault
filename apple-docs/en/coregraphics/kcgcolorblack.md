...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/kcgcolorblack
source_url: 'https://developer.apple.com/documentation/coregraphics/kcgcolorblack'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/kcgcolorblack.json'
content_hash: 'sha256:a39a626e6e51b55f'
translated: false
---
...
```objc
extern CFStringRef const kCGColorBlack;
```
