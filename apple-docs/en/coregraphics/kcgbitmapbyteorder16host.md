---
title: kCGBitmapByteOrder16Host
framework: Core Graphics
symbol_kind: var
role: symbol
role_heading: Global Variable
platforms: [iOS（27.0 起废弃）, iPadOS（27.0 起废弃）, Mac Catalyst（27.0 起废弃）, macOS（27.0 起废弃）, tvOS（27.0 起废弃）, visionOS（27.0 起废弃）, watchOS（27.0 起废弃）]
languages: [swift, swift, occ, occ]
beta: false
deprecated: true
doc_path: /documentation/coregraphics/kcgbitmapbyteorder16host
source_url: 'https://developer.apple.com/documentation/coregraphics/kcgbitmapbyteorder16host'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/kcgbitmapbyteorder16host.json'
content_hash: 'sha256:c47dec8dd9a4fcec'
translated: false
---
