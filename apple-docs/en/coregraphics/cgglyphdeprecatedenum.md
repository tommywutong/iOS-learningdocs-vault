...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cgglyphdeprecatedenum
source_url: 'https://developer.apple.com/documentation/coregraphics/cgglyphdeprecatedenum'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgglyphdeprecatedenum.json'
content_hash: 'sha256:8324dddc6f007991'
translated: false
---
...
- [CGGlyphMax](cgglyphdeprecatedenum/max.md) — Maximum font index value. _(deprecated)_
- [CGGlyphMin](cgglyphdeprecatedenum/min.md) — Minimum font index value. _(deprecated)_

### Initializers

- [init(rawValue:)](<cgglyphdeprecatedenum/init(rawvalue_).md>)
