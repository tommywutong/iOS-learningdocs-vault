...
beta: false
deprecated: false
doc_path: '/documentation/coregraphics/cgpdfarraygetinteger(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgpdfarraygetinteger(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgpdfarraygetinteger%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:4dba3de50b01cedf'
translated: false
---
...
Returns [true](../swift/true.md) if there is a PDF integer at the specified index, otherwise [false](../swift/false.md).
