...
platforms: [iOS 2.0+, iPadOS 2.0+, Mac Catalyst 13.1+, macOS 10.1+, tvOS, visionOS 1.0+, watchOS 2.0+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: '/documentation/coregraphics/cgimage/init(jpegdataprovidersource:decode:shouldinterpolate:intent:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgimage/init(jpegdataprovidersource:decode:shouldinterpolate:intent:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgimage/init%28jpegdataprovidersource%3Adecode%3Ashouldinterpolate%3Aintent%3A%29.json'
content_hash: 'sha256:9410c9265983101e'
translated: false
---
