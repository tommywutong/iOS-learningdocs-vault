...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cgcharcode
source_url: 'https://developer.apple.com/documentation/coregraphics/cgcharcode'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgcharcode.json'
content_hash: 'sha256:28e673a747e0f873'
translated: false
---
...
This data type represents a 16-bit character code. Values of this type may or may not correspond to UTF-16 character codes. See the function [CGPostKeyboardEvent](<cgpostkeyboardevent(______).md>).
