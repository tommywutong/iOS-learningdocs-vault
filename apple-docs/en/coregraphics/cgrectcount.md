...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cgrectcount
source_url: 'https://developer.apple.com/documentation/coregraphics/cgrectcount'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgrectcount.json'
content_hash: 'sha256:e69fb5e33054b67e'
translated: false
---
...
For example, see the function [CGWaitForScreenRefreshRects](<cgwaitforscreenrefreshrects(____).md>).
