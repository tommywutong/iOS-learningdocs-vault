...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cgeventtapinformation
source_url: 'https://developer.apple.com/documentation/coregraphics/cgeventtapinformation'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgeventtapinformation.json'
content_hash: 'sha256:fa45538620fa8653'
translated: false
---
...
To learn how to obtain information about event taps, see the function [CGGetEventTapList](<cggeteventtaplist(______).md>).
