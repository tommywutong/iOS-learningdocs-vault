...
beta: false
deprecated: false
doc_path: '/documentation/coregraphics/cgpdfdictionarygetnumber(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgpdfdictionarygetnumber(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgpdfdictionarygetnumber%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:eccc94c4df94f950'
translated: false
---
...
Returns [true](../swift/true.md) if there is a PDF number associated with the specified key; otherwise, [false](../swift/false.md).
