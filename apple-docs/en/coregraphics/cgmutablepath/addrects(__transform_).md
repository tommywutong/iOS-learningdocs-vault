...
beta: false
deprecated: false
doc_path: '/documentation/coregraphics/cgmutablepath/addrects(_:transform:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgmutablepath/addrects(_:transform:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgmutablepath/addrects%28_%3Atransform%3A%29.json'
content_hash: 'sha256:441e4de88410092f'
translated: false
---
...
Calling this convenience method is equivalent to repeatedly calling the [addRect(_:transform:)](<addrect(__transform_).md>) method for each rectangle in the array.
