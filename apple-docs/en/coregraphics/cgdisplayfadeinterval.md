...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cgdisplayfadeinterval
source_url: 'https://developer.apple.com/documentation/coregraphics/cgdisplayfadeinterval'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgdisplayfadeinterval.json'
content_hash: 'sha256:6e82506a22547641'
translated: false
---
...
Quartz uses this data type to specify the duration of both fade-out and fade-in operations. Values may range from 0 to `kCGMaxDisplayReservationInterval` seconds. A 0 value means fade immediately—see [CGDisplayFade](<cgdisplayfade(________________).md>).
