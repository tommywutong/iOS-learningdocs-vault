...
platforms: [iOS 12.6+（14.0 起废弃）, iPadOS 12.6+（14.0 起废弃）, Mac Catalyst 13.1+（14.0 起废弃）, macOS 10.15.6+（11.0 起废弃）, tvOS 12.0+（14.0 起废弃）, visionOS 1.0+（1.0 起废弃）, watchOS 5.0+（7.0 起废弃）]
languages: [swift, occ]
beta: false
deprecated: true
doc_path: /documentation/coregraphics/cgcolorspace/itur_2020_hlg
source_url: 'https://developer.apple.com/documentation/coregraphics/cgcolorspace/itur_2020_hlg'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgcolorspace/itur_2020_hlg.json'
content_hash: 'sha256:11ec055f9e380287'
translated: false
---
