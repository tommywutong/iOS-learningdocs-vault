...
platforms: [iOS 13.4+（14.0 起废弃）, iPadOS 13.4+（14.0 起废弃）, Mac Catalyst 13.4+（14.0 起废弃）, macOS 10.15.4+（11.0 起废弃）, tvOS 13.4+（14.0 起废弃）, visionOS 1.0+（1.0 起废弃）, watchOS 6.2+（7.0 起废弃）]
languages: [swift, occ]
beta: false
deprecated: true
doc_path: /documentation/coregraphics/cgcolorspace/itur_2020_pq
source_url: 'https://developer.apple.com/documentation/coregraphics/cgcolorspace/itur_2020_pq'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgcolorspace/itur_2020_pq.json'
content_hash: 'sha256:c2ce3c7a2b104b76'
translated: false
---
