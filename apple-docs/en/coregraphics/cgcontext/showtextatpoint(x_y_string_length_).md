...
beta: false
deprecated: true
doc_path: '/documentation/coregraphics/cgcontext/showtextatpoint(x:y:string:length:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgcontext/showtextatpoint(x:y:string:length:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgcontext/showtextatpoint%28x%3Ay%3Astring%3Alength%3A%29.json'
content_hash: 'sha256:8d7f82acd0bfe5c2'
translated: false
---
