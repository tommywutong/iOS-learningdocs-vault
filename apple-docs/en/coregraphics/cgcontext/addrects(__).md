...
beta: false
deprecated: false
doc_path: '/documentation/coregraphics/cgcontext/addrects(_:)'
source_url: 'https://developer.apple.com/documentation/coregraphics/cgcontext/addrects(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cgcontext/addrects%28_%3A%29.json'
content_hash: 'sha256:e89c10af334f34c3'
translated: false
---
...
Calling this convenience method is equivalent to repeatedly calling the [CGContextAddRect](<addrect(__).md>) method for each rectangle in the array.
