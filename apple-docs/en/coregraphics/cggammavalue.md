...
beta: false
deprecated: false
doc_path: /documentation/coregraphics/cggammavalue
source_url: 'https://developer.apple.com/documentation/coregraphics/cggammavalue'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/coregraphics/cggammavalue.json'
content_hash: 'sha256:ed1c5052ce1176f6'
translated: false
---
...
In macOS, the Display panel in System Preferences is used to set the default gamma for a display. Quartz also allows an application to provide its own custom gamma information, using functions such as [CGSetDisplayTransferByTable](<cgsetdisplaytransferbytable(__________).md>) and [CGSetDisplayTransferByFormula](<cgsetdisplaytransferbyformula(____________________).md>).
