...
beta: false
deprecated: false
doc_path: /documentation/network/nw_error_domain_t
source_url: 'https://developer.apple.com/documentation/network/nw_error_domain_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_error_domain_t.json'
content_hash: 'sha256:3252321330da8489'
translated: false
---
...
- [init(_:)](<nw_error_domain_t/init(__).md>)
- [init(rawValue:)](<nw_error_domain_t/init(rawvalue_).md>)
