...
beta: false
deprecated: false
doc_path: /documentation/network/nw_txt_record_access_key_t
source_url: 'https://developer.apple.com/documentation/network/nw_txt_record_access_key_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_txt_record_access_key_t.json'
content_hash: 'sha256:f90a019665e7d0d1'
translated: false
---
