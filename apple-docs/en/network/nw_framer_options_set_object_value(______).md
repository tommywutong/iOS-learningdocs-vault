---
title: 'nw_framer_options_set_object_value(_:_:_:)'
framework: Network
symbol_kind: func
role: symbol
role_heading: Function
platforms: [iOS 15.4+, iPadOS 15.4+, Mac Catalyst 15.4+, macOS 12.3+, tvOS 15.4+, visionOS 1.0+, watchOS 8.4+]
languages: [swift, occ]
beta: false
deprecated: false
doc_path: '/documentation/network/nw_framer_options_set_object_value(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_framer_options_set_object_value(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_framer_options_set_object_value%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:421a6ccf5c5c0b09'
translated: false
---
