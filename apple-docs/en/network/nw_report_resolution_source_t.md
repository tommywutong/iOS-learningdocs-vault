...
beta: false
deprecated: false
doc_path: /documentation/network/nw_report_resolution_source_t
source_url: 'https://developer.apple.com/documentation/network/nw_report_resolution_source_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_report_resolution_source_t.json'
content_hash: 'sha256:ccac4282ea02b2b2'
translated: false
---
...
- [init(_:)](<nw_report_resolution_source_t/init(__).md>)
- [init(rawValue:)](<nw_report_resolution_source_t/init(rawvalue_).md>)
