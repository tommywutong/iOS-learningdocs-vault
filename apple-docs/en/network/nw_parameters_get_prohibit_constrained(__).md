...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_parameters_get_prohibit_constrained(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_parameters_get_prohibit_constrained(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_parameters_get_prohibit_constrained%28_%3A%29.json'
content_hash: 'sha256:24d43589817a6bac'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [Network](../network.md)

# nw_parameters_get_prohibit_constrained(_:)
