...
beta: false
deprecated: false
doc_path: /documentation/network/nw_report_resolution_protocol_t
source_url: 'https://developer.apple.com/documentation/network/nw_report_resolution_protocol_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_report_resolution_protocol_t.json'
content_hash: 'sha256:264c91074e1d222e'
translated: false
---
...
- [init(_:)](<nw_report_resolution_protocol_t/init(__).md>)
- [init(rawValue:)](<nw_report_resolution_protocol_t/init(rawvalue_).md>)
