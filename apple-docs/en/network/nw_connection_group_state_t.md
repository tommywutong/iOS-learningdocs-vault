...
beta: false
deprecated: false
doc_path: /documentation/network/nw_connection_group_state_t
source_url: 'https://developer.apple.com/documentation/network/nw_connection_group_state_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_connection_group_state_t.json'
content_hash: 'sha256:3b77dd707c654ad9'
translated: false
---
...
- [init(_:)](<nw_connection_group_state_t/init(__).md>)
- [init(rawValue:)](<nw_connection_group_state_t/init(rawvalue_).md>)
