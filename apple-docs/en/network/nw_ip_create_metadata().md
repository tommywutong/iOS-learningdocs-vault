...
beta: false
deprecated: false
doc_path: /documentation/network/nw_ip_create_metadata()
source_url: 'https://developer.apple.com/documentation/network/nw_ip_create_metadata()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_ip_create_metadata%28%29.json'
content_hash: 'sha256:60c27bba91277f56'
translated: false
---
