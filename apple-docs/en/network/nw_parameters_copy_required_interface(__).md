...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_parameters_copy_required_interface(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_parameters_copy_required_interface(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_parameters_copy_required_interface%28_%3A%29.json'
content_hash: 'sha256:739fd6686c9cee47'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [Network](../network.md)

# nw_parameters_copy_required_interface(_:)
