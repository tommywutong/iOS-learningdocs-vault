...
beta: false
deprecated: false
doc_path: /documentation/network/nw_path_monitor_create_for_ethernet_channel()
source_url: 'https://developer.apple.com/documentation/network/nw_path_monitor_create_for_ethernet_channel()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_path_monitor_create_for_ethernet_channel%28%29.json'
content_hash: 'sha256:3fba70536406b1f1'
translated: false
---
