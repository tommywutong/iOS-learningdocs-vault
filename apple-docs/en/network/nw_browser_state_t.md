...
beta: false
deprecated: false
doc_path: /documentation/network/nw_browser_state_t
source_url: 'https://developer.apple.com/documentation/network/nw_browser_state_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_browser_state_t.json'
content_hash: 'sha256:0f61d0724c525e2b'
translated: false
---
...
- [init(_:)](<nw_browser_state_t/init(__).md>)
- [init(rawValue:)](<nw_browser_state_t/init(rawvalue_).md>)
