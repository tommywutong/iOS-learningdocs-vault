...
beta: false
deprecated: false
doc_path: /documentation/network/nw_data_transfer_report_state_t
source_url: 'https://developer.apple.com/documentation/network/nw_data_transfer_report_state_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_data_transfer_report_state_t.json'
content_hash: 'sha256:da2693f7032cdb48'
translated: false
---
...
- [init(_:)](<nw_data_transfer_report_state_t/init(__).md>)
- [init(rawValue:)](<nw_data_transfer_report_state_t/init(rawvalue_).md>)
