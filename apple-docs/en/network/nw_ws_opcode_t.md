...
beta: false
deprecated: false
doc_path: /documentation/network/nw_ws_opcode_t
source_url: 'https://developer.apple.com/documentation/network/nw_ws_opcode_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_ws_opcode_t.json'
content_hash: 'sha256:ecdacfd3e810646c'
translated: false
---
...
- [init(_:)](<nw_ws_opcode_t/init(__).md>)
- [init(rawValue:)](<nw_ws_opcode_t/init(rawvalue_).md>)
