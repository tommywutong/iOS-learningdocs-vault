...
beta: false
deprecated: false
doc_path: /documentation/network/nw_udp_create_options()
source_url: 'https://developer.apple.com/documentation/network/nw_udp_create_options()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_udp_create_options%28%29.json'
content_hash: 'sha256:7a0599c796955ed0'
translated: false
---
