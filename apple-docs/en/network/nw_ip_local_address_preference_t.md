...
beta: false
deprecated: false
doc_path: /documentation/network/nw_ip_local_address_preference_t
source_url: 'https://developer.apple.com/documentation/network/nw_ip_local_address_preference_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_ip_local_address_preference_t.json'
content_hash: 'sha256:97677560915e26d9'
translated: false
---
...
- [init(_:)](<nw_ip_local_address_preference_t/init(__).md>)
- [init(rawValue:)](<nw_ip_local_address_preference_t/init(rawvalue_).md>)
