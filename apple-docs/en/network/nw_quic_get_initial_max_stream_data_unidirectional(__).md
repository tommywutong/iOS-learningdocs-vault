...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_quic_get_initial_max_stream_data_unidirectional(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_quic_get_initial_max_stream_data_unidirectional(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_quic_get_initial_max_stream_data_unidirectional%28_%3A%29.json'
content_hash: 'sha256:b6b5e1d2decb523c'
translated: false
---
