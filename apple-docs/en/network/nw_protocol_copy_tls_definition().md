...
beta: false
deprecated: false
doc_path: /documentation/network/nw_protocol_copy_tls_definition()
source_url: 'https://developer.apple.com/documentation/network/nw_protocol_copy_tls_definition()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_protocol_copy_tls_definition%28%29.json'
content_hash: 'sha256:827ca83f4bfeb80c'
translated: false
---
