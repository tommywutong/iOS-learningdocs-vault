...
beta: false
deprecated: false
doc_path: /documentation/network/nw_txt_record_access_bytes_t
source_url: 'https://developer.apple.com/documentation/network/nw_txt_record_access_bytes_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_txt_record_access_bytes_t.json'
content_hash: 'sha256:2e8151ac7e923bf3'
translated: false
---
...
The return value is passed back to the caller of [nw_txt_record_access_bytes](<nw_txt_record_access_bytes(____).md>).
