...
beta: false
deprecated: false
doc_path: /documentation/network/nw_interface_type_t
source_url: 'https://developer.apple.com/documentation/network/nw_interface_type_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_interface_type_t.json'
content_hash: 'sha256:2e8ba5effcfc6976'
translated: false
---
...
- [init(_:)](<nw_interface_type_t/init(__).md>) — Creates an instance of the interface type structure.
- [init(rawValue:)](<nw_interface_type_t/init(rawvalue_).md>) — Creates an instance of the interface type structure.
