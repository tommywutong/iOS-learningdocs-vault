---
title: 'nw_proxy_config_clear_excluded_domains(_:)'
framework: Network
symbol_kind: func
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_proxy_config_clear_excluded_domains(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_proxy_config_clear_excluded_domains(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_proxy_config_clear_excluded_domains%28_%3A%29.json'
content_hash: 'sha256:194d428de994e0be'
translated: false
---
