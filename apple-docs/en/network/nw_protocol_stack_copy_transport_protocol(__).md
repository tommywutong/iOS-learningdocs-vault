...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_protocol_stack_copy_transport_protocol(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_protocol_stack_copy_transport_protocol(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_protocol_stack_copy_transport_protocol%28_%3A%29.json'
content_hash: 'sha256:d5664a3264d9b080'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [Network](../network.md)

# nw_protocol_stack_copy_transport_protocol(_:)
