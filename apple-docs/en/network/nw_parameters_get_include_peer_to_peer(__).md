...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_parameters_get_include_peer_to_peer(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_parameters_get_include_peer_to_peer(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_parameters_get_include_peer_to_peer%28_%3A%29.json'
content_hash: 'sha256:ffa904eabedd5f5f'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [Network](../network.md)

# nw_parameters_get_include_peer_to_peer(_:)
