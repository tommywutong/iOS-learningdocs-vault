...
beta: false
deprecated: false
doc_path: /documentation/network/nw_txt_record_create_dictionary()
source_url: 'https://developer.apple.com/documentation/network/nw_txt_record_create_dictionary()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_txt_record_create_dictionary%28%29.json'
content_hash: 'sha256:6785d5a1dff04d8d'
translated: false
---
