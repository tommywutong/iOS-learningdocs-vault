...
beta: false
deprecated: false
doc_path: '/documentation/network/tlv/init(type:length:_:)-h8s'
source_url: 'https://developer.apple.com/documentation/network/tlv/init(type:length:_:)-h8s'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/tlv/init%28type%3Alength%3A_%3A%29-h8s.json'
content_hash: 'sha256:d65688343c557951'
translated: false
---
