...
beta: false
deprecated: false
doc_path: /documentation/network/nw_ws_response_status_t
source_url: 'https://developer.apple.com/documentation/network/nw_ws_response_status_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_ws_response_status_t.json'
content_hash: 'sha256:a94b5710026e464e'
translated: false
---
...
- [init(_:)](<nw_ws_response_status_t/init(__).md>)
- [init(rawValue:)](<nw_ws_response_status_t/init(rawvalue_).md>)
