...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_parameters_get_reuse_local_address(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_parameters_get_reuse_local_address(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_parameters_get_reuse_local_address%28_%3A%29.json'
content_hash: 'sha256:221f85961dceec99'
translated: false
---

> Navigation: [Technologies](../technologies.md) · [Network](../network.md)

# nw_parameters_get_reuse_local_address(_:)
