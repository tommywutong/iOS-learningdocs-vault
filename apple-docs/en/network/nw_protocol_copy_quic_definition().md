...
beta: false
deprecated: false
doc_path: /documentation/network/nw_protocol_copy_quic_definition()
source_url: 'https://developer.apple.com/documentation/network/nw_protocol_copy_quic_definition()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_protocol_copy_quic_definition%28%29.json'
content_hash: 'sha256:a200631af050784b'
translated: false
---
