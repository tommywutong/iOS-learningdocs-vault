...
beta: false
deprecated: false
doc_path: '/documentation/network/coder/init(_:using:_:)-61vdl'
source_url: 'https://developer.apple.com/documentation/network/coder/init(_:using:_:)-61vdl'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/coder/init%28_%3Ausing%3A_%3A%29-61vdl.json'
content_hash: 'sha256:b4ea72f6db30a93b'
translated: false
---
