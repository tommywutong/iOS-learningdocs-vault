...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_connection_set_better_path_available_handler(_:_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_connection_set_better_path_available_handler(_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_connection_set_better_path_available_handler%28_%3A_%3A%29.json'
content_hash: 'sha256:aa1b7b9919bc22d6'
translated: false
---
