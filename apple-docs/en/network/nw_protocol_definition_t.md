...
beta: false
deprecated: false
doc_path: /documentation/network/nw_protocol_definition_t
source_url: 'https://developer.apple.com/documentation/network/nw_protocol_definition_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_protocol_definition_t.json'
content_hash: 'sha256:b17ef3f1259faebb'
translated: false
---
...
- [nw_protocol_definition_is_equal](<nw_protocol_definition_is_equal(____).md>) — Compares two protocol definitions, and returns true if they represent the same protocol implementation.
