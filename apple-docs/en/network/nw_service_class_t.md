...
beta: false
deprecated: false
doc_path: /documentation/network/nw_service_class_t
source_url: 'https://developer.apple.com/documentation/network/nw_service_class_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_service_class_t.json'
content_hash: 'sha256:ae5b4fcf8c4a82ff'
translated: false
---
...
- [init(_:)](<nw_service_class_t/init(__).md>) — Creates an instance of the service class structure.
- [init(rawValue:)](<nw_service_class_t/init(rawvalue_).md>) — Creates an instance of the service class structure.
