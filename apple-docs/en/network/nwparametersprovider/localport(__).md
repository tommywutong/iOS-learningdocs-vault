...
beta: false
deprecated: false
doc_path: '/documentation/network/nwparametersprovider/localport(_:)'
source_url: 'https://developer.apple.com/documentation/network/nwparametersprovider/localport(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nwparametersprovider/localport%28_%3A%29.json'
content_hash: 'sha256:a79ed67209f827db'
translated: false
---
...
- [localPort(_:)](<localport(__)-9twr6.md>) — Specify a specific port to use as the local endpoint, letting the system select the address.
