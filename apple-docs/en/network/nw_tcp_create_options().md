...
beta: false
deprecated: false
doc_path: /documentation/network/nw_tcp_create_options()
source_url: 'https://developer.apple.com/documentation/network/nw_tcp_create_options()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_tcp_create_options%28%29.json'
content_hash: 'sha256:d972e1914b37b8e1'
translated: false
---
