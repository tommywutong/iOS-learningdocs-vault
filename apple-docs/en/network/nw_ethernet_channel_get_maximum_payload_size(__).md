---
title: 'nw_ethernet_channel_get_maximum_payload_size(_:)'
framework: Network
symbol_kind: func
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/network/nw_ethernet_channel_get_maximum_payload_size(_:)'
source_url: 'https://developer.apple.com/documentation/network/nw_ethernet_channel_get_maximum_payload_size(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_ethernet_channel_get_maximum_payload_size%28_%3A%29.json'
content_hash: 'sha256:bd0feb4a61856078'
translated: false
---
