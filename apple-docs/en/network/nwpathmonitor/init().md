...
beta: false
deprecated: false
doc_path: /documentation/network/nwpathmonitor/init()
source_url: 'https://developer.apple.com/documentation/network/nwpathmonitor/init()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nwpathmonitor/init%28%29.json'
content_hash: 'sha256:512d8b23fb671ada'
translated: false
---
