...
beta: false
deprecated: false
doc_path: /documentation/network/nw_listener_new_connection_group_handler_t
source_url: 'https://developer.apple.com/documentation/network/nw_listener_new_connection_group_handler_t'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_listener_new_connection_group_handler_t.json'
content_hash: 'sha256:61590314195454f9'
translated: false
---
