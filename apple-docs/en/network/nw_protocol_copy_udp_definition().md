...
beta: false
deprecated: false
doc_path: /documentation/network/nw_protocol_copy_udp_definition()
source_url: 'https://developer.apple.com/documentation/network/nw_protocol_copy_udp_definition()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_protocol_copy_udp_definition%28%29.json'
content_hash: 'sha256:d4ca9000fd262ab5'
translated: false
---
