...
beta: false
deprecated: false
doc_path: '/documentation/network/networkconnection/init(to:using:)-6yzx9'
source_url: 'https://developer.apple.com/documentation/network/networkconnection/init(to:using:)-6yzx9'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/networkconnection/init%28to%3Ausing%3A%29-6yzx9.json'
content_hash: 'sha256:d7f06030155545d4'
translated: false
---
