...
beta: false
deprecated: false
doc_path: /documentation/network/nw_quic_create_options()
source_url: 'https://developer.apple.com/documentation/network/nw_quic_create_options()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_quic_create_options%28%29.json'
content_hash: 'sha256:c1dedcaa988351f9'
translated: false
---
