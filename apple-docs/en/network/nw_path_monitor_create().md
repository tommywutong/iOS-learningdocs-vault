...
beta: false
deprecated: false
doc_path: /documentation/network/nw_path_monitor_create()
source_url: 'https://developer.apple.com/documentation/network/nw_path_monitor_create()'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/network/nw_path_monitor_create%28%29.json'
content_hash: 'sha256:d4de397a0fc80932'
translated: false
---
