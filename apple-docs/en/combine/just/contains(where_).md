...
beta: false
deprecated: false
doc_path: '/documentation/combine/just/contains(where:)'
source_url: 'https://developer.apple.com/documentation/combine/just/contains(where:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/combine/just/contains%28where%3A%29.json'
content_hash: 'sha256:020229dbbfbe9dae'
translated: false
---
