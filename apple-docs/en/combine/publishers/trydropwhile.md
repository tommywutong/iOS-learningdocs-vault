...
beta: false
deprecated: false
doc_path: /documentation/combine/publishers/trydropwhile
source_url: 'https://developer.apple.com/documentation/combine/publishers/trydropwhile'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/combine/publishers/trydropwhile.json'
content_hash: 'sha256:10230b3834f11bbf'
translated: false
---
...
- [init(upstream:predicate:)](<trydropwhile/init(upstream_predicate_).md>) — Creates a publisher that omits elements from an upstream publisher until a given error-throwing closure returns false.

### Declaring supporting types

- [Output](trydropwhile/output.md) — The kind of values published by this publisher.
- [Failure](trydropwhile/failure.md) — The kind of errors this publisher might publish.
