...
beta: false
deprecated: false
doc_path: /documentation/combine/publishers/print/output
source_url: 'https://developer.apple.com/documentation/combine/publishers/print/output'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/combine/publishers/print/output.json'
content_hash: 'sha256:98ad4f7323645e50'
translated: false
---
