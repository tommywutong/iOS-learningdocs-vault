...
beta: false
deprecated: false
doc_path: /documentation/combine/publishers/merge
source_url: 'https://developer.apple.com/documentation/combine/publishers/merge'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/combine/publishers/merge.json'
content_hash: 'sha256:018122ba486b1740'
translated: false
---
...
- [init(_:_:)](<merge/init(____).md>) — Creates a publisher created by applying the merge function to two upstream publishers.

### Merging elements

- [merge(with:)](<merge/merge(with_).md>)
- [merge(with:_:)](<merge/merge(with___).md>)
- [merge(with:_:_:)](<merge/merge(with_____).md>)
- [merge(with:_:_:_:)](<merge/merge(with_______).md>)
- [merge(with:_:_:_:_:)](<merge/merge(with_________).md>)
- [merge(with:_:_:_:_:_:)](<merge/merge(with___________).md>)

### Declaring supporting types

- [Output](merge/output.md) — The kind of values published by this publisher.
- [Failure](merge/failure.md) — The kind of errors this publisher might publish.
...
- [==(_:_:)](<merge/==(____).md>) — Returns a Boolean value that indicates whether two publishers are equivalent.
