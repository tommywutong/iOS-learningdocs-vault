...
beta: false
deprecated: false
doc_path: '/documentation/combine/publisher/map(_:_:_:)'
source_url: 'https://developer.apple.com/documentation/combine/publisher/map(_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/combine/publisher/map%28_%3A_%3A_%3A%29.json'
content_hash: 'sha256:8543681e3e60989a'
translated: false
---
...
In the following example, the [map(_:_:_:)](<map(______).md>) operator uses the Swift key path syntax to access the `die1`, `die2`, and `die3` members of the `DiceRoll` structure published by the [Just](../just.md) publisher.
