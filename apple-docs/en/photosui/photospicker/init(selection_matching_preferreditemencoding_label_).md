---
title: 'init(selection:matching:preferredItemEncoding:label:)'
framework: PhotosUI
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/photosui/photospicker/init(selection:matching:preferreditemencoding:label:)'
source_url: 'https://developer.apple.com/documentation/photosui/photospicker/init(selection:matching:preferreditemencoding:label:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/photosui/photospicker/init%28selection%3Amatching%3Apreferreditemencoding%3Alabel%3A%29.json'
content_hash: 'sha256:d52678a33d8af7a6'
translated: false
---
