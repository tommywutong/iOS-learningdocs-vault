...
beta: false
deprecated: false
doc_path: /documentation/storekit/testing-ad-attributions-with-a-downloaded-profile
source_url: 'https://developer.apple.com/documentation/storekit/testing-ad-attributions-with-a-downloaded-profile'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/testing-ad-attributions-with-a-downloaded-profile.json'
content_hash: 'sha256:f41d4370d815272d'
translated: false
---
...
> [!important] Important
> To download the latest profile, see the [AdAttributionKit](../adattributionkit.md) article on [Testing ad attributions with a downloaded profile](../adattributionkit/testing-ad-attributions-with-a-downloaded-profile.md). This profile is compatible with both AdAttributionKit and SKAdNetwork.
