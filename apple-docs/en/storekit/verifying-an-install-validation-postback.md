...
beta: false
deprecated: false
doc_path: /documentation/storekit/verifying-an-install-validation-postback
source_url: 'https://developer.apple.com/documentation/storekit/verifying-an-install-validation-postback'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/verifying-an-install-validation-postback.json'
content_hash: 'sha256:5b94305a98f69cd9'
translated: false
---
