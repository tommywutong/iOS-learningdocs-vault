...
beta: false
deprecated: false
doc_path: /documentation/storekit/testing-at-all-stages-of-development-with-xcode-and-the-sandbox
source_url: 'https://developer.apple.com/documentation/storekit/testing-at-all-stages-of-development-with-xcode-and-the-sandbox'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/testing-at-all-stages-of-development-with-xcode-and-the-sandbox.json'
content_hash: 'sha256:95a7609fc87803dc'
translated: false
---
...
- **StoreKit Testing in Xcode** — For early development, continuous integration, and debugging. For more information, see [StoreKit Test](../storekittest.md).
...
| Finish a transaction with [finish()](<transaction/finish().md>) or [- finishTransaction:](<skpaymentqueue/finishtransaction(__).md>) | Yes | Yes |
...
| Manage subscriptions within your app with [showManageSubscriptions(in:)](<appstore/showmanagesubscriptions(in_).md>) and [manageSubscriptionsSheet(isPresented:)](<../swiftui/view/managesubscriptionssheet(ispresented_).md>) | Yes | Yes |
