...
beta: false
deprecated: false
doc_path: '/documentation/storekit/transaction/beginrefundrequest(for:in:)-9mscy'
source_url: 'https://developer.apple.com/documentation/storekit/transaction/beginrefundrequest(for:in:)-9mscy'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/transaction/beginrefundrequest%28for%3Ain%3A%29-9mscy.json'
content_hash: 'sha256:b5a051c6e35283ae'
translated: false
---
...
- `controller` — The [NSViewController](../../appkit/nsviewcontroller.md) that the system displays the sheet on.
