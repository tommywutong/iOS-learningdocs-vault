...
beta: false
deprecated: false
doc_path: /documentation/storekit/testing-win-back-offers-in-the-sandbox-environment
source_url: 'https://developer.apple.com/documentation/storekit/testing-win-back-offers-in-the-sandbox-environment'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/testing-win-back-offers-in-the-sandbox-environment.json'
content_hash: 'sha256:e47bf1c8d22fe02f'
translated: false
---
...
4. StoreKit views automatically chooses an offer to display. If there are multiple offers, your app indicates a preference using the [preferredSubscriptionOffer(_:)](<../swiftui/view/preferredsubscriptionoffer(__).md>) API.
