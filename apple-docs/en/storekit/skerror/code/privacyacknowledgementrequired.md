---
title: SKError.Code.privacyAcknowledgementRequired
framework: StoreKit
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: /documentation/storekit/skerror/code/privacyacknowledgementrequired
source_url: 'https://developer.apple.com/documentation/storekit/skerror/code/privacyacknowledgementrequired'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/skerror/code/privacyacknowledgementrequired.json'
content_hash: 'sha256:45b2b0cd50f03690'
translated: false
---
