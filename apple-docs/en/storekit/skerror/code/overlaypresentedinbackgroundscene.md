---
title: SKError.Code.overlayPresentedInBackgroundScene
framework: StoreKit
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: /documentation/storekit/skerror/code/overlaypresentedinbackgroundscene
source_url: 'https://developer.apple.com/documentation/storekit/skerror/code/overlaypresentedinbackgroundscene'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/skerror/code/overlaypresentedinbackgroundscene.json'
content_hash: 'sha256:a802d2322a952a82'
translated: false
---
