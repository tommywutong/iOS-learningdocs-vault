---
title: SKError.Code.cloudServicePermissionDenied
framework: StoreKit
symbol_kind: case
role: symbol
role_heading: Case
...
beta: false
deprecated: false
doc_path: /documentation/storekit/skerror/code/cloudservicepermissiondenied
source_url: 'https://developer.apple.com/documentation/storekit/skerror/code/cloudservicepermissiondenied'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/skerror/code/cloudservicepermissiondenied.json'
content_hash: 'sha256:02e5eb670b7ad73a'
translated: false
---
