---
title: 'init(isIncluded:marketingContent:)'
framework: StoreKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/storekit/subscriptionoptiongroup/init(isincluded:marketingcontent:)'
source_url: 'https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(isincluded:marketingcontent:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/subscriptionoptiongroup/init%28isincluded%3Amarketingcontent%3A%29.json'
content_hash: 'sha256:8b708131d99c63ba'
translated: false
---
