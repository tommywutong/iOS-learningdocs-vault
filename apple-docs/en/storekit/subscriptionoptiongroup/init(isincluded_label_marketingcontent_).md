---
title: 'init(isIncluded:label:marketingContent:)'
framework: StoreKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/storekit/subscriptionoptiongroup/init(isincluded:label:marketingcontent:)'
source_url: 'https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(isincluded:label:marketingcontent:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/subscriptionoptiongroup/init%28isincluded%3Alabel%3Amarketingcontent%3A%29.json'
content_hash: 'sha256:1f88ee510aaa8647'
translated: false
---
