---
title: 'init(content:label:marketingContent:)'
framework: StoreKit
symbol_kind: init
role: symbol
...
beta: false
deprecated: false
doc_path: '/documentation/storekit/subscriptionoptiongroup/init(content:label:marketingcontent:)'
source_url: 'https://developer.apple.com/documentation/storekit/subscriptionoptiongroup/init(content:label:marketingcontent:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/subscriptionoptiongroup/init%28content%3Alabel%3Amarketingcontent%3A%29.json'
content_hash: 'sha256:fca0079472aaf542'
translated: false
---
