...
beta: false
deprecated: false
doc_path: /documentation/storekit/supporting-win-back-offers-in-your-app
source_url: 'https://developer.apple.com/documentation/storekit/supporting-win-back-offers-in-your-app'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/supporting-win-back-offers-in-your-app.json'
content_hash: 'sha256:1d135c456bbd66b0'
translated: false
---
...
4. Your app calls the [purchase(options:)](<product/purchase(options_).md>) method on the [product](purchaseintent/product.md) of the [PurchaseIntent](purchaseintent.md) to enable the customer to complete the purchase. Be sure to add the win-back offer to the purchase options.
