...
beta: false
deprecated: false
doc_path: /documentation/storekit/testing-win-back-offers-in-xcode
source_url: 'https://developer.apple.com/documentation/storekit/testing-win-back-offers-in-xcode'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/testing-win-back-offers-in-xcode.json'
content_hash: 'sha256:7ba684c05157a6c4'
translated: false
---
...
- **Offer type** — The payment mode of the offer. For more information, see [PaymentMode](product/subscriptionoffer/paymentmode-swift.struct.md).
