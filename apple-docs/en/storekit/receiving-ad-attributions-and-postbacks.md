...
beta: false
deprecated: false
doc_path: /documentation/storekit/receiving-ad-attributions-and-postbacks
source_url: 'https://developer.apple.com/documentation/storekit/receiving-ad-attributions-and-postbacks'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/receiving-ad-attributions-and-postbacks.json'
content_hash: 'sha256:aeda4af22153d20f'
translated: false
---
...
Use the [StoreKit Test](../storekittest.md) framework to validate your ad impressions and test your postbacks by creating unit tests. For more information, see [SKAdTestSession](../storekittest/skadtestsession.md) and [Testing and validating ad impression signatures and postbacks for SKAdNetwork](../storekittest/testing-and-validating-ad-impression-signatures-and-postbacks-for-skadnetwork.md).
