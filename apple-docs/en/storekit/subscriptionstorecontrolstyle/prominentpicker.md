...
beta: false
deprecated: false
doc_path: /documentation/storekit/subscriptionstorecontrolstyle/prominentpicker
source_url: 'https://developer.apple.com/documentation/storekit/subscriptionstorecontrolstyle/prominentpicker'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/subscriptionstorecontrolstyle/prominentpicker.json'
content_hash: 'sha256:586443f8affb3ef6'
translated: false
---
...
You can also use [subscriptionStoreControlStyle(_:)](<../../swiftui/view/subscriptionstorecontrolstyle(__).md>) with [prominentPicker](prominentpicker.md) as the parameter to construct this style.
