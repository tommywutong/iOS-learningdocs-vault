...
beta: false
deprecated: false
doc_path: /documentation/storekit/registering-an-ad-network
source_url: 'https://developer.apple.com/documentation/storekit/registering-an-ad-network'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/registering-an-ad-network.json'
content_hash: 'sha256:e4b584dd737217ba'
translated: false
---
...
In the command, replace `companyname` with the name of your company. For example, the name of the private key file for a company named _Example_ is `example_skadnetwork_private_key.pem`.
