...
beta: false
deprecated: false
doc_path: /documentation/storekit/testing-family-sharing
source_url: 'https://developer.apple.com/documentation/storekit/testing-family-sharing'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/testing-family-sharing.json'
content_hash: 'sha256:f2395fa9b693c283'
translated: false
---
...
![](../../../attachments/08ba8ae02734a6799040e16023c5eeeb/media-4312484@2x.png)

<sub>The settings page titled Family Sharing. The top of the page has a label that reads Sandbox Family Members. A list box lists five Sandbox Apple Accounts that comprise the Sandbox Test Family. Each Apple Account has a label underneath that reads Sharing. A link below the list is labeled Stop Sharing Purchases. </sub>
