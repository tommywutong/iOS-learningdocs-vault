...
beta: false
deprecated: false
doc_path: '/documentation/storekit/appstore/requestreview(in:)-1q8qs'
source_url: 'https://developer.apple.com/documentation/storekit/appstore/requestreview(in:)-1q8qs'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/storekit/appstore/requestreview%28in%3A%29-1q8qs.json'
content_hash: 'sha256:9f1232e5b583e211'
translated: false
---
...
> [!note] Note
> Because this method may not present an alert, don’t call [+ requestReview](<../skstorereviewcontroller/requestreview().md>) or [requestReview(in:)](<requestreview(in_)-1q8qs.md>) in response to a button tap or other user action.
...
- [requestReview(in:)](<requestreview(in_)-4r0y9.md>) — Tells StoreKit to request an App Store rating or review from the user, if appropriate, using the specified view controller.
