...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/mldsa87/privatekey
source_url: 'https://developer.apple.com/documentation/cryptokit/mldsa87/privatekey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/mldsa87/privatekey.json'
content_hash: 'sha256:1b82a04f01795a2d'
translated: false
---
...
- [init()](<privatekey/init().md>) — Creates a random MLDSA87 private key.
...
- [PublicKey](publickey.md) — The public key for MLDSA87.
