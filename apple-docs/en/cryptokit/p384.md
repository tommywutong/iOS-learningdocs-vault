...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/p384
source_url: 'https://developer.apple.com/documentation/cryptokit/p384'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/p384.json'
content_hash: 'sha256:21cb3427decd02a3'
translated: false
---
...
- [KeyAgreement](p384/keyagreement.md) — A mechanism used to create a shared secret between two users by performing NIST P-384 elliptic curve Diffie Hellman (ECDH) key exchange.
- [Signing](p384/signing.md) — A mechanism used to create or verify a cryptographic signature using the NIST P-384 elliptic curve digital signature algorithm (ECDSA).
