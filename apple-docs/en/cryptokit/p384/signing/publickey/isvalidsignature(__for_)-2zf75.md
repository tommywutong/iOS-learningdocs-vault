...
beta: false
deprecated: false
doc_path: '/documentation/cryptokit/p384/signing/publickey/isvalidsignature(_:for:)-2zf75'
source_url: 'https://developer.apple.com/documentation/cryptokit/p384/signing/publickey/isvalidsignature(_:for:)-2zf75'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/p384/signing/publickey/isvalidsignature%28_%3Afor%3A%29-2zf75.json'
content_hash: 'sha256:45ec6641ac9d3437'
translated: false
---
...
- [isValidSignature(_:for:)](<isvalidsignature(__for_)-1hrtv.md>) — Verifies an elliptic curve digital signature algorithm (ECDSA) signature on a digest over the P-384 elliptic curve.
