...
beta: false
deprecated: false
doc_path: '/documentation/cryptokit/p256/signing/publickey/isvalidsignature(_:for:)-2rsb5'
source_url: 'https://developer.apple.com/documentation/cryptokit/p256/signing/publickey/isvalidsignature(_:for:)-2rsb5'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/p256/signing/publickey/isvalidsignature%28_%3Afor%3A%29-2rsb5.json'
content_hash: 'sha256:0f97bd8c74d2b3bb'
translated: false
---
...
- [isValidSignature(_:for:)](<isvalidsignature(__for_)-3da2m.md>) — Verifies an elliptic curve digital signature algorithm (ECDSA) signature on a block of data over the P-256 elliptic curve.
