...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/p256/signing/privatekey
source_url: 'https://developer.apple.com/documentation/cryptokit/p256/signing/privatekey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/p256/signing/privatekey.json'
content_hash: 'sha256:dc70409cfd23c25f'
translated: false
---
...
- [init(rawRepresentation:)](<privatekey/init(rawrepresentation_).md>) — Creates a P-256 private key for signing from a collection of bytes.
- [init(compactRepresentable:)](<privatekey/init(compactrepresentable_).md>) — Creates a random P-256 private key for signing.
- [init(derRepresentation:)](<privatekey/init(derrepresentation_).md>) — Creates a P-256 private key for signing from a Distinguished Encoding Rules (DER) encoded representation.
- [init(pemRepresentation:)](<privatekey/init(pemrepresentation_).md>) — Creates a P-256 private key for signing from a Privacy-Enhanced Mail PEM) representation.
- [init(x963Representation:)](<privatekey/init(x963representation_).md>) — Creates a P-256 private key for signing from an ANSI x9.63 representation.
...
- [PublicKey](publickey.md) — A P-256 public key used to verify cryptographic signatures.
