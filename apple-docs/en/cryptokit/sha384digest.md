...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/sha384digest
source_url: 'https://developer.apple.com/documentation/cryptokit/sha384digest'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/sha384digest.json'
content_hash: 'sha256:4f2f972772335ad7'
translated: false
---
...
- [hash(into:)](<sha384digest/hash(into_).md>) — Hashes the essential components of the digest by feeding them into the given hash function.
