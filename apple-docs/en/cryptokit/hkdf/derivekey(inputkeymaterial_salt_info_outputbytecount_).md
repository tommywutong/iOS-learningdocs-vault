---
title: 'deriveKey(inputKeyMaterial:salt:info:outputByteCount:)'
...
beta: false
deprecated: false
doc_path: '/documentation/cryptokit/hkdf/derivekey(inputkeymaterial:salt:info:outputbytecount:)'
source_url: 'https://developer.apple.com/documentation/cryptokit/hkdf/derivekey(inputkeymaterial:salt:info:outputbytecount:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/hkdf/derivekey%28inputkeymaterial%3Asalt%3Ainfo%3Aoutputbytecount%3A%29.json'
content_hash: 'sha256:cdc13ce8e26210a7'
translated: false
---
...
- [deriveKey(inputKeyMaterial:outputByteCount:)](<derivekey(inputkeymaterial_outputbytecount_).md>) — Derives a symmetric encryption key from a main key or passcode using HKDF key derivation.
