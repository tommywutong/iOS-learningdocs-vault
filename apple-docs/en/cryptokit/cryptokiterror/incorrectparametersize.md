---
title: CryptoKitError.incorrectParameterSize
...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/cryptokiterror/incorrectparametersize
source_url: 'https://developer.apple.com/documentation/cryptokit/cryptokiterror/incorrectparametersize'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/cryptokiterror/incorrectparametersize.json'
content_hash: 'sha256:107736419c7436ee'
translated: false
---
...
- [CryptoKitError.underlyingCoreCryptoError(error:)](<underlyingcorecryptoerror(error_).md>) — The underlying corecrypto library is unable to complete the requested action.
