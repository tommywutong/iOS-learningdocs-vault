...
beta: false
deprecated: false
doc_path: /documentation/cryptokit/chachapoly/sealedbox
source_url: 'https://developer.apple.com/documentation/cryptokit/chachapoly/sealedbox'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/cryptokit/chachapoly/sealedbox.json'
content_hash: 'sha256:53b72b866218ffb5'
translated: false
---
...
- [init(combined:)](<sealedbox/init(combined_).md>) — Creates a sealed box from the given data.
