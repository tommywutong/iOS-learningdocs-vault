---
title: 'init(postProcessingAsVideoLayer:containingLayer:)'
...
beta: false
deprecated: false
doc_path: '/documentation/avfoundation/avvideocompositioncoreanimationtool/configuration/init(postprocessingasvideolayer:containinglayer:)'
source_url: 'https://developer.apple.com/documentation/avfoundation/avvideocompositioncoreanimationtool/configuration/init(postprocessingasvideolayer:containinglayer:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avvideocompositioncoreanimationtool/configuration/init%28postprocessingasvideolayer%3Acontaininglayer%3A%29.json'
content_hash: 'sha256:a4eb5976ecd6571f'
translated: false
---
