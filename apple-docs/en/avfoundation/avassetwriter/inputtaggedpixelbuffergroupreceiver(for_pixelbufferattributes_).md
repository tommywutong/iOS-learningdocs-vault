---
title: 'inputTaggedPixelBufferGroupReceiver(for:pixelBufferAttributes:)'
...
beta: false
deprecated: false
doc_path: '/documentation/avfoundation/avassetwriter/inputtaggedpixelbuffergroupreceiver(for:pixelbufferattributes:)'
source_url: 'https://developer.apple.com/documentation/avfoundation/avassetwriter/inputtaggedpixelbuffergroupreceiver(for:pixelbufferattributes:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avassetwriter/inputtaggedpixelbuffergroupreceiver%28for%3Apixelbufferattributes%3A%29.json'
content_hash: 'sha256:a000e73c910c0d1e'
translated: false
---
