...
beta: false
deprecated: false
doc_path: /documentation/avfoundation/avassetreadervideocompositionoutput
source_url: 'https://developer.apple.com/documentation/avfoundation/avassetreadervideocompositionoutput'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avassetreadervideocompositionoutput.json'
content_hash: 'sha256:268ef625f869a07e'
translated: false
---
...
- [- initWithVideoTracks:videoSettings:](<avassetreadervideocompositionoutput/init(videotracks_videosettings_).md>) — Creates an object that reads composited video frames from the specified video tracks.
