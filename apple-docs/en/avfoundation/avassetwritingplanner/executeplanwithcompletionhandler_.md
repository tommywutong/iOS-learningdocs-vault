---
title: 'executePlanWithCompletionHandler:'
...
beta: true
deprecated: false
doc_path: '/documentation/avfoundation/avassetwritingplanner/executeplanwithcompletionhandler:'
source_url: 'https://developer.apple.com/documentation/avfoundation/avassetwritingplanner/executeplanwithcompletionhandler:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avassetwritingplanner/executeplanwithcompletionhandler%3A.json'
content_hash: 'sha256:eed5e0a960048d19'
translated: false
---
...
- [executePlanOnQueue:withCompletionHandler:](executeplanonqueue_withcompletionhandler_.md) — Starts the incremental segment writing on a given dispatch queue _(beta)_
