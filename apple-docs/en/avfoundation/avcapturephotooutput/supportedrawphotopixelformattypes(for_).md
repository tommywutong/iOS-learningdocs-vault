---
title: 'supportedRawPhotoPixelFormatTypes(for:)'
...
beta: false
deprecated: false
doc_path: '/documentation/avfoundation/avcapturephotooutput/supportedrawphotopixelformattypes(for:)'
source_url: 'https://developer.apple.com/documentation/avfoundation/avcapturephotooutput/supportedrawphotopixelformattypes(for:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avcapturephotooutput/supportedrawphotopixelformattypes%28for%3A%29.json'
content_hash: 'sha256:4dc0176f8ed0a2b0'
translated: false
---
