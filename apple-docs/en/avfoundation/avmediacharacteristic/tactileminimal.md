...
beta: false
deprecated: false
doc_path: /documentation/avfoundation/avmediacharacteristic/tactileminimal
source_url: 'https://developer.apple.com/documentation/avfoundation/avmediacharacteristic/tactileminimal'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/avfoundation/avmediacharacteristic/tactileminimal.json'
content_hash: 'sha256:54e744176f2b7d07'
translated: false
---
...
The value of this characteristic is `public.haptics.minimal`. Query the [- hasMediaCharacteristic:](<../avassettrack/hasmediacharacteristic(__).md>) method of [AVAssetTrack](../avassettrack.md) or the [- hasMediaCharacteristic:](<../avmediaselectionoption/hasmediacharacteristic(__).md>) of [AVMediaSelectionOption](../avmediaselectionoption.md) to determine whether the media contains this characteristic.
