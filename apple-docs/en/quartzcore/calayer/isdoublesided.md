...
beta: false
deprecated: false
doc_path: /documentation/quartzcore/calayer/isdoublesided
source_url: 'https://developer.apple.com/documentation/quartzcore/calayer/isdoublesided'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/quartzcore/calayer/isdoublesided.json'
content_hash: 'sha256:8ac41cfc4c6ac0e5'
translated: false
---
...
When the value in this property is [false](../../swift/false.md), the layer hides its content when it faces away from the viewer. The default value of this property is [true](../../swift/true.md).
