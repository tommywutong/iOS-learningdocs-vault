...
beta: false
deprecated: true
doc_path: '/documentation/objectivec/nsobject-swift.class/values(forkeys:)'
source_url: 'https://developer.apple.com/documentation/objectivec/nsobject-swift.class/values(forkeys:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/objectivec/nsobject-swift.class/values%28forkeys%3A%29.json'
content_hash: 'sha256:9f8e32d26b9ccee4'
translated: false
---
...
> [!warning] Deprecated
> Use [- dictionaryWithValuesForKeys:](<dictionarywithvalues(forkeys_).md>) instead.
