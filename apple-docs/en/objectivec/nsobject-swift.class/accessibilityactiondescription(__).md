...
beta: false
deprecated: true
doc_path: '/documentation/objectivec/nsobject-swift.class/accessibilityactiondescription(_:)'
source_url: 'https://developer.apple.com/documentation/objectivec/nsobject-swift.class/accessibilityactiondescription(_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/objectivec/nsobject-swift.class/accessibilityactiondescription%28_%3A%29.json'
content_hash: 'sha256:4569951f6c165374'
translated: false
---
...
User interface classes must implement this method to return descriptions for all actions returned from [- accessibilityActionNames](<accessibilityactionnames().md>). A button, for example, might return the string “press” for the `NSAccessibilityPressAction` action. Subclasses should invoke the superclass’s implementation, if it exists, to obtain the descriptions of any inherited actions.
