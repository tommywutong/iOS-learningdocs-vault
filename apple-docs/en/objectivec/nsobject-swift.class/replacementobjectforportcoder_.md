---
title: 'replacementObjectForPortCoder:'
...
beta: false
deprecated: true
doc_path: '/documentation/objectivec/nsobject-swift.class/replacementobjectforportcoder:'
source_url: 'https://developer.apple.com/documentation/objectivec/nsobject-swift.class/replacementobjectforportcoder:'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/objectivec/nsobject-swift.class/replacementobjectforportcoder%3A.json'
content_hash: 'sha256:554e2fcece2d02fe'
translated: false
---
...
This method is invoked by `NSPortCoder`. `NSObject`’s implementation returns an `NSDistantObject` object for the object returned by [- replacementObjectForCoder:](<replacementobject(for_)-2l8ox.md>), enabling all objects to be distributed by proxy as the default. However, if [- replacementObjectForCoder:](<replacementobject(for_)-2l8ox.md>) returns `nil`, `NSObject`’s implementation will also return `nil`.
...
- [classForPortCoder](classforportcoder.md) — Class to substitute for the receiver in distribution encoding. _(deprecated)_
