...
beta: false
deprecated: true
doc_path: '/documentation/objectivec/nsobject-swift.class/takevalues(from:)'
source_url: 'https://developer.apple.com/documentation/objectivec/nsobject-swift.class/takevalues(from:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/objectivec/nsobject-swift.class/takevalues%28from%3A%29.json'
content_hash: 'sha256:c8bdaf94e10cd830'
translated: false
---
...
> [!warning] Deprecated
> Use [- setValuesForKeysWithDictionary:](<setvaluesforkeys(__).md>) instead.
