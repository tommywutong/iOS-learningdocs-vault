---
title: kCFURLVolumeIdentifierKey
...
beta: false
deprecated: false
doc_path: /documentation/corefoundation/kcfurlvolumeidentifierkey
source_url: 'https://developer.apple.com/documentation/corefoundation/kcfurlvolumeidentifierkey'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/corefoundation/kcfurlvolumeidentifierkey.json'
content_hash: 'sha256:82a9af54190c7701'
translated: false
---
...
This identifier can be used with the [CFEqual](<cfequal(____).md>) function to determine whether two file system resources are on the same volume.
