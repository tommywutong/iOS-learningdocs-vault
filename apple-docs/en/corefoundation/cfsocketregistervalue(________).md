...
beta: false
deprecated: false
doc_path: '/documentation/corefoundation/cfsocketregistervalue(_:_:_:_:)'
source_url: 'https://developer.apple.com/documentation/corefoundation/cfsocketregistervalue(_:_:_:_:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/corefoundation/cfsocketregistervalue%28_%3A_%3A_%3A_%3A%29.json'
content_hash: 'sha256:59e6ab47feb5ae93'
translated: false
---
...
To remove a registered value from the name server, use [CFSocketUnregister](<cfsocketunregister(______).md>).
