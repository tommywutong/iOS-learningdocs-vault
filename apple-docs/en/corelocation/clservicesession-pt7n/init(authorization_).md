...
beta: false
deprecated: false
doc_path: '/documentation/corelocation/clservicesession-pt7n/init(authorization:)'
source_url: 'https://developer.apple.com/documentation/corelocation/clservicesession-pt7n/init(authorization:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/corelocation/clservicesession-pt7n/init%28authorization%3A%29.json'
content_hash: 'sha256:bf14e2e1b4438af8'
translated: false
---
...
- [init(authorization:fullAccuracyPurposeKey:)](<init(authorization_fullaccuracypurposekey_).md>) — Creates a services session by using the authorization mode and purpose key you specify.
