...
beta: false
deprecated: true
doc_path: '/documentation/corelocation/clgeocoder/geocodeaddressdictionary(_:completionhandler:)'
source_url: 'https://developer.apple.com/documentation/corelocation/clgeocoder/geocodeaddressdictionary(_:completionhandler:)'
doc_json: 'https://developer.apple.com/tutorials/data/documentation/corelocation/clgeocoder/geocodeaddressdictionary%28_%3Acompletionhandler%3A%29.json'
content_hash: 'sha256:ef7708db1e912750'
translated: false
---
...
> [!warning] Deprecated
> Use [- geocodePostalAddress:preferredLocale:completionHandler:](<geocodepostaladdress(__preferredlocale_completionhandler_).md>) or [- geocodePostalAddress:completionHandler:](<geocodepostaladdress(__completionhandler_).md>) instead.
