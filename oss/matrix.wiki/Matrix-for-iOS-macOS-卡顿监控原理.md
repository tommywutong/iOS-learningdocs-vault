...
![画微信logo](images/blockmonitor/draw-wechat-logo.png)
...
![耗时堆栈提取](images/blockmonitor/time-cost-stack-fetch.png)
...
![栈回溯](images/blockmonitor/stack-back.png)
...
![应用被杀原因检查](images/blockmonitor/why-app-killed.png)
...
以上即是 iOS 微信卡顿监控的介绍，它同样可以使用在 macOS 平台上。在日常开发中，微信iOS团队通过卡顿监控上报的堆栈，找到微信的代码不合理之处或者是一些性能瓶颈；通过卡顿监控的辅助，尽可能地提升微信的流畅性，给用户带来更加极致美好的体验。

卡顿监控依然在不断进行优化，不断扩展能力，近期我们计划会为它增添捕获应用耗电堆栈的能力，使其功能更加完备。

我们将卡顿监控作为 Matrix 的一部分进行开源，希望能获得大家的意见和建议。开源地址：https://github.com/tencent/matrix 请给 Matrix 一个 Star！欢迎提出你的 issue 和 PR。
