...
source_url: 'https://southpeak.github.io/2014/08/02/reactivecocoa-tutorial-the-definitive-introduction-1/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:051bbfb38ede7af2'
translated: n/a
---

> 原文：[ReactiveCocoa Tutorial – The Definitive Introduction: Part 1/2](https://southpeak.github.io/2014/08/02/reactivecocoa-tutorial-the-definitive-introduction-1/)　·　南峰子 (southpeak)
...
_注意：`RACSignal`组合方法可以组合任何数量的信号，而`reduce`块的参数会对应每一个信号。_
