...
source_url: 'https://southpeak.github.io/2015/10/26/objectivecbridgeable-protocol-for-objectivec-class-and-swift-struct/'
original_language: zh
published: 2016-08-28
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:ee8ba0dd657338b7'
translated: n/a
---

> 原文：[使用_ObjectiveCBridgeable协议实现Objective-C类与Swift结构体的无缝互转](https://southpeak.github.io/2015/10/26/objectivecbridgeable-protocol-for-objectivec-class-and-swift-struct/)　·　南峰子 (southpeak)
...
_(注意：整型类型只有`Int`与`UInt`实现了接口，而其它诸如`Int16`，`Uint32`，`Int8`等则没有）_
