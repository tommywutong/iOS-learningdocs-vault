...
source_url: 'https://southpeak.github.io/2014/12/01/quartz2d-4/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:2b1dd099d56c87b4'
translated: n/a
---

> 原文：[Quartz 2D编程指南之四：颜色与颜色空间](https://southpeak.github.io/2014/12/01/quartz2d-4/)　·　南峰子 (southpeak)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table4-1.png?raw=true)
...
**destination = (alpha _source) + (1 - alpha)_ destination**
...
1. `L*a*b`是非线性转换，它属于Munsell颜色符号系统(该系统使用色度、值、饱和度来指定颜色)。 L组件表示亮度值，a组件表示绿色与红色之间的值，b组件表示蓝色与黄色之间的值。该颜色空间设计用于模拟人脑解码颜色。使用函数CGColorSpaceCreateLab来创建。
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table4-2.png?raw=true)
