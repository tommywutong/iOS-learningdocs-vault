---
title: iOS知识小集 第3期(2015.06.30)
source: 南峰子 (southpeak)
source_key: southpeak
source_url: 'https://southpeak.github.io/2015/06/30/ios-techset-3/'
original_language: zh
published: 2016-08-31
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:9520762d731496bb'
translated: n/a
---

> 原文：[iOS知识小集 第3期(2015.06.30)](https://southpeak.github.io/2015/06/30/ios-techset-3/)　·　南峰子 (southpeak)
...
_注：有些控件的特定组成部件的tint color由特定的属性控制，例如进度就有2个tint color：一个用于进度条本身，另一个用于背景。_
...
_注：在WWDC 2014的[“Sharing code between iOS and OS X”](https://developer.apple.com/videos/wwdc/2014/)一节(session 233)中，Elizabeth Reid将这种方式称为Shimming_
