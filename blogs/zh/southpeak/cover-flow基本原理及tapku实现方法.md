...
source_url: 'https://southpeak.github.io/2014/07/05/cover-flow/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:9da6121b91f87cd4'
translated: n/a
---

> 原文：[Cover flow基本原理及Tapku实现方法](https://southpeak.github.io/2014/07/05/cover-flow/)　·　南峰子 (southpeak)

这篇是两年前在CocoaChina上写的，现在把它归集到这边来。大家也可以查看[原文](http://www.cocoachina.com/bbs/read.php?tid=75699)。

Cover flow是苹果首创的将多首歌曲的封面以3D界面的形式显示出来的方式。如下图所示：

![image](https://github.com/southpeak/Blog-images/blob/master/Cove%20flow.png?raw=true)
