...
source_url: 'https://southpeak.github.io/2014/11/16/quartz2d-3/'
original_language: zh
published: 2017-01-12
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:adcf670cd4cb9204'
translated: n/a
---

> 原文：[Quartz 2D编程指南之三：路径(Path)](https://southpeak.github.io/2014/11/16/quartz2d-3/)　·　南峰子 (southpeak)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-1.png?raw=true)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-2.png?raw=true)

linecap指定如何绘制直线的端点。Quartz支持表3-3所示的线帽类型。默认的是butt cap。

**Table 3-3 Line cap styles**

![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-3.png?raw=true)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-4.png?raw=true)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-5.png?raw=true)
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table3-6.png?raw=true)
