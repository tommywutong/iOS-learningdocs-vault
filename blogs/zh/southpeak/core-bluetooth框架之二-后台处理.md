...
source_url: 'https://southpeak.github.io/2014/07/31/core-bluetooth-programming-guide-2/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b98792ee051d3eac'
translated: n/a
---

> 原文：[Core Bluetooth框架之二：后台处理](https://southpeak.github.io/2014/07/31/core-bluetooth-programming-guide-2/)　·　南峰子 (southpeak)
...
_对于选择性加入保存与恢复特性的应用来说，这些方法是程序启动到后台以完成一些蓝牙相关任务所调用的第一个方法。而对于非选择性加入特性的应用来说，会首先调用centralManagerDidUpdateState:和peripheralManagerDidUpdateState:代理方法。_
