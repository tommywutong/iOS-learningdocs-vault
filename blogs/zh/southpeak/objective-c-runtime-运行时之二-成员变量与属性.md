...
source_url: 'https://southpeak.github.io/2014/10/30/objective-c-runtime-2/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:db056f5d1e54e48d'
translated: n/a
---

> 原文：[Objective-C Runtime 运行时之二：成员变量与属性](https://southpeak.github.io/2014/10/30/objective-c-runtime-2/)　·　南峰子 (southpeak)
...
_注：Objective-C不支持long double类型。@encode(long double)返回d，与double是一样的。_
