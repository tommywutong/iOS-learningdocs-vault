...
source_url: 'https://southpeak.github.io/2014/11/11/quartz2d-2/'
original_language: zh
published: 2016-08-27
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b525bda0bf8537ee'
translated: n/a
---

> 原文：[Quartz 2D编程指南之二：图形上下文(Graphics Contexts)](https://southpeak.github.io/2014/11/11/quartz2d-2/)　·　南峰子 (southpeak)
...
_注：NSView的drawRect:方法在每次视图需要绘制时自动调用。_
...
_注：位图Graphics Context有时用于后台绘制。CGLayer对象优化了后台绘制，因为Quartz在显卡上缓存了层。_
...
![image](https://github.com/southpeak/Blog-images/blob/master/quartz-2d-table2-1.png?raw=true)
