...
source_url: 'https://southpeak.github.io/2015/07/20/cocoa-uikit-uiapearance/'
original_language: zh
published: 2016-08-28
status: frozen
license: © 2017 南峰子（页脚）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:51c773bfdd17096b'
translated: n/a
---

> 原文：[UIKit: UIApearance](https://southpeak.github.io/2015/07/20/cocoa-uikit-uiapearance/)　·　南峰子 (southpeak)
...
_补充：文章中的示例代码已放到`github`中，可以在[这里](https://github.com/southpeak/iOS-Dev-Examples/tree/master/UIKit/UIApearance)查看(不保证在`iOS 9.0`以下能正常进行，嘿嘿)_
