...
source_url: 'http://leichunfeng.github.io/blog/2014/11/11/use-octopress-plus-github-pages-to-setup-a-personal-blog/'
...
> 原文：[使用 Octopress+GitHub Pages 搭建个人博客](http://leichunfeng.github.io/blog/2014/11/11/use-octopress-plus-github-pages-to-setup-a-personal-blog/)　·　雷纯锋

# 使用 Octopress+GitHub Pages 搭建个人博客

Nov 11th, 2014 9:47 pm
...
到这里，本文就已经接近尾声了，不过我们对博客访问速度的追求仍然没有结束。因为 GitHub 毕竟是国外的（你懂的）代码托管网站，所以我们博客的访问速度始终还是比较慢的。在下一篇博文中我将向大家介绍如何[《将 Octopress 博客从 GitHub 迁移到 GitCafe》](http://leichunfeng.github.io/blog/2014/11/15/migrate-octopress-blog-from-github-to-gitcafe/)，到时你的博客的访问速度也会跟我的一样，飞一般的感觉。
