...
source_url: 'http://leichunfeng.github.io/blog/2015/11/08/functor-applicative-and-monad/'
...
> 原文：[Functor、Applicative 和 Monad](http://leichunfeng.github.io/blog/2015/11/08/functor-applicative-and-monad/)　·　雷纯锋

# Functor、Applicative 和 Monad

Nov 8th, 2015 10:53 am
...
![maybe](http://leichunfeng.github.io/images/maybe.png)
...
![just2](http://leichunfeng.github.io/images/just2.png)
...
![normal2](http://leichunfeng.github.io/images/normal2.png)

我们如何将函数 `(+3)` 应用到这个值上呢？我想上过小学的朋友应该都知道，这就是一个简单的加法运算：

![value_apply](http://leichunfeng.github.io/images/value_apply.png)
...
![fmap](http://leichunfeng.github.io/images/fmap.png)
...
![fmap_just](http://leichunfeng.github.io/images/fmap_just.png)
...
![fmap_nothing](http://leichunfeng.github.io/images/fmap_nothing.png)
...
![justadd3](http://leichunfeng.github.io/images/justadd3.png)

那么，我们如何将一个在上下文中的函数应用到一个在上下文中的值呢？

![apply_justadd3_just2](http://leichunfeng.github.io/images/apply_justadd3_just2.png)
...
![applicative_just](http://leichunfeng.github.io/images/applicative_just.png)
...
![bind](http://leichunfeng.github.io/images/bind.png)
...
![half](http://leichunfeng.github.io/images/half.png)
...
![monad_chain](http://leichunfeng.github.io/images/monad_chain.png)
