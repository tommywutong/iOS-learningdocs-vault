...
source_url: 'http://leichunfeng.github.io/blog/2015/05/18/objective-c-category-implementation-principle/'
original_language: zh
published: 2015-05-18
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:2de91cd5171eff7a'
translated: n/a
---

> 原文：[Objective-C Category 的实现原理](http://leichunfeng.github.io/blog/2015/05/18/objective-c-category-implementation-principle/)　·　雷纯锋
...
在这里分了两种情况进行处理：Category 中的实例方法和属性被整合到主类中；而类方法则被整合到元类中（关于对象、类和元类的更多细节，可以参考我前面的博文[《Objective-C 对象模型》](http://leichunfeng.github.io/blog/2015/04/25/objective-c-object-model/)）。另外，对协议的处理比较特殊，Category 中的协议被同时整合到了主类和元类中。
...
[https://developer.apple.com/library/ios/documentation/General/Conceptual/DevPedia-CocoaCore/Category.html#//apple_ref/doc/uid/TP40008195-CH5-SW1](https://developer.apple.com/library/ios/documentation/General/Conceptual/DevPedia-CocoaCore/Category.html#//apple_ref/doc/uid/TP40008195-CH5-SW1) [http://stackoverflow.com/questions/5272451/overriding-methods-using-categories-in-objective-c](http://stackoverflow.com/questions/5272451/overriding-methods-using-categories-in-objective-c)
