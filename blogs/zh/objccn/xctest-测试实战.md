...
source_key: objccn
source_url: 'https://objccn.io/issue-15-2'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5105d7ad379d8e12'
translated: n/a
---

> 原文：[XCTest 测试实战](https://objccn.io/issue-15-2)　·　ObjC 中国 (objccn.io)
...
我们有一个运行在 release 分支上的 Xcode Server 的自定义_触发器_。这个_触发器_脚本把生成好的 Xcode archive 上传到文件服务器上。这样一来，我们就有了基于版本控制的存档。 UI 小组就可以从文件服务器上下载预编译好的框架的指定版本。
