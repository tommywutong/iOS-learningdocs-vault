...
source_key: objccn
source_url: 'https://objccn.io/issue-7-1'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:942f8cdd37e995b2'
translated: n/a
---

> 原文：[基础集合类](https://objccn.io/issue-7-1)　·　ObjC 中国 (objccn.io)
...
首先，我们需要一些理论知识。效率通常用[大 O 符号](https://en.wikipedia.org/wiki/Big_O_notation)描述。它定义了一个函数的_极限特征_，通常被用于描绘其算法效率。O 定义了函数增长率的上限。不同量级的差异非常巨大，可以看看通常使用的 O 符号的量级以及它们所对应需要的操作数的关系。
...
最大的好处是什么？**线程安全**。不可变的集合完全是线程安全的，可以同时在多个线程中迭代，避免各种转变时出现异常的风险。你的 API _绝不_应该暴露一个可变的集合。
...
其实也有_一些_同步的，线程安全的可以使用的可变集合案例，它们往往只需要用几行代码，通过子类和组合的方法建立，比如这个 [`NSDictionary`](https://gist.github.com/steipete/7746843) 或这个 [`NSArray`](https://github.com/Cue/TheKitchenSync/blob/master/Classes/Collections/CueSyncArray.mm)。
...
| 类 / 时间 [ms] | #1.000 | #10.000 | #1.000.000 | #10.000.000 | #1.000.000, iPad Mini iOS 6 |
|---|---|---|---|---|---|
