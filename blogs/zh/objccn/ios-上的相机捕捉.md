...
source_key: objccn
source_url: 'https://objccn.io/issue-21-3'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:64e7ccc48bc8c207'
translated: n/a
---

> 原文：[iOS 上的相机捕捉](https://objccn.io/issue-21-3)　·　ObjC 中国 (objccn.io)
...
- 提供来自设备的数据。
- 是一个抽象类，描述 capture session 的结果。以下是三种关于静态图片捕捉的具体子类：
...
- 是
  ...
  的子类，可被用于自动显示相机产生的实时图像。它还有几个工具性质的方法，可将 layer 上的坐标转化到设备上。它看起来像输出，但其实不是。另外，它

  session (outputs 被 session
...
> 编者注 关于相位对焦和反差对焦，可以参看[这篇文章](http://ask.zealer.com/post/149)。

`AVCaptureFocusMode` 是个枚举，描述了可用的对焦模式：

- 指镜片处于固定位置
- 指一开始相机会先自动对焦一次，然后便处于
