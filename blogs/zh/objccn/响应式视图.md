...
source_key: objccn
source_url: 'https://objccn.io/issue-22-5'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:72cadd4b2c4abb2c'
translated: n/a
---

> 原文：[响应式视图](https://objccn.io/issue-22-5)　·　ObjC 中国 (objccn.io)
...
- 的 API 来宣言性地表达静态的动画。比如说，一个组件可以指明在第一次出现的时候使用渐入的效果。
- 的威力。
