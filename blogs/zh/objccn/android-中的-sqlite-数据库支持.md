---
title: Android 中的 SQLite 数据库支持
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-11-5'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:603519ba722b0427'
translated: n/a
---

> 原文：[Android 中的 SQLite 数据库支持](https://objccn.io/issue-11-5)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

Android 中的 SQLite 数据库支持

[zinc](http://weibo.com/p/1005051822396587)
...
![](https://objccn.io/images/issues/authors/2014/Mar/zinc.jpg)
