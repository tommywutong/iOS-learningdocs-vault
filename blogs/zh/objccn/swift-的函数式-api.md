---
title: Swift 的函数式 API
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-16-4'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:c2a8f7f52c10f1c2'
translated: n/a
---

> 原文：[Swift 的函数式 API](https://objccn.io/issue-16-4)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

Swift 的函数式 API

[汪海洋](http://blog.callmewhy.com)
...
![](https://objccn.io/images/issues/authors/2014/Aug/callmewhy.jpg)
