...
source_key: objccn
source_url: 'https://objccn.io/issue-21-4'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:2fcc968ac7f717ef'
translated: n/a
---

> 原文：[照片框架](https://objccn.io/issue-21-4)　·　ObjC 中国 (objccn.io)
...
![.AutoPick Example](https://objccn.io/images/issues/issue-21/photos-burst-example.jpg)
...
- 设置成
  ...
  。
- 是否是最终结果的低质量格式。当高质量图像正在下载时，这个可以让你给用户先展示一个预览图像 ——
...
![](https://objccn.io/images/issues/authors/2015/Mar/crazyzombie.png)
