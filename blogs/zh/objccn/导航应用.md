...
source_key: objccn
source_url: 'https://objccn.io/issue-8-3'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:be9ad16f57360976'
translated: n/a
---

> 原文：[导航应用](https://objccn.io/issue-8-3)　·　ObjC 中国 (objccn.io)
...
- 用来设定目标位置，计算飞行航线，以及飞行距离。
- 用来把从

  获取的导航的距离和方向发送命令到

  。
- 有一个简单的界面，用来初始化其他的类并把它们连接起来，这部分应该用不同的类来完成，但是在我们的设想中，我们的app足够简单所以放到一个类就可以了。
