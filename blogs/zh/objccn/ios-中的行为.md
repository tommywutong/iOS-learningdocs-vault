...
source_key: objccn
source_url: 'https://objccn.io/issue-13-3'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:c7ba9a5992203c71'
translated: n/a
---

> 原文：[iOS 中的行为](https://objccn.io/issue-13-3)　·　ObjC 中国 (objccn.io)
...
![](https://objccn.io/images/issues/issue-13/cornerRadius.png)

当在 Interface Builder 中创建行为时，你将重度依赖运行时属性去设置行为选项。最终将会带来更多的典型运行时属性：

![](https://objccn.io/images/issues/issue-13/runtimeAttributes.png)
