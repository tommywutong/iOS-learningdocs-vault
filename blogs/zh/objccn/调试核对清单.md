...
source_key: objccn
source_url: 'https://objccn.io/issue-19-3'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:6a31a816afbed749'
translated: n/a
---

> 原文：[调试核对清单](https://objccn.io/issue-19-3)　·　ObjC 中国 (objccn.io)
...
有一种解决方法是创建不可变对象。这样，当你访问对象时，你就知道这个操作是无法改变它的状态的。关于这点有太多可讲，不过更多的信息，我们建议你阅读以下文章：[结构体和值类型](http://objccn.io/issue-16-2)，[值对象](http:/objccn.io/issue-7-2)，[对象的可变性](https://developer.apple.com/library/mac/documentation/General/Conceptual/CocoaEncyclopedia/ObjectMutability/ObjectMutability.html)和[关于可变性](http://www.bignerdranch.com/blog/about-mutability/)。
