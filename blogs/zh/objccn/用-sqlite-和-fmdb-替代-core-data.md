---
title: 用 SQLite 和 FMDB 替代 Core Data
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-4-3'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:31cd1ed1ecf35f80'
translated: n/a
---

> 原文：[用 SQLite 和 FMDB 替代 Core Data](https://objccn.io/issue-4-3)　·　ObjC 中国 (objccn.io)
...
但是，像这样的事情应该小心处理。app 可以提供足够的内存吗？它真的简化编程_并且_提高性能了吗？
