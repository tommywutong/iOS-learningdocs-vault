...
source_key: objccn
source_url: 'https://objccn.io/issue-19-2'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:f094adade4281f45'
translated: n/a
---

> 原文：[与调试器共舞 - LLDB 的华尔兹](https://objccn.io/issue-19-2)　·　ObjC 中国 (objccn.io)
...
![](https://objccn.io/images/issues/issue-19/Image_2014-11-20_at_10.01.46_PM.png)
...
![](https://objccn.io/images/issues/issue-19/Image_2014-11-20_at_10.09.38_PM.png)
...
![](https://objccn.io/images/issues/issue-19/Image_2014-11-20_at_10.15.01_PM.png)
...
![](https://objccn.io/images/issues/issue-19/Image_2014-11-22_at_10.53.52_AM.png)
...
![](https://objccn.io/images/issues/issue-19/Image_2014-11-22_at_11.38.24_AM.png)
...
看编辑断点弹出窗口的底部，你还会看到一个选项： _"Automatically continue after evaluation actions."_ 。它仅仅是一个选择框，但是却很强大。选中它，调试器会运行你所有的命令，然后继续运行。看起来就像没有执行任何断点一样 (除非断点太多，运行需要一段时间，拖慢了你的程序)。
...
![](https://objccn.io/images/issues/authors/2014/Dec/nangege.png)
