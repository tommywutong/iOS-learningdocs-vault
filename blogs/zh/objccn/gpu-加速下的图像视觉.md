...
source_key: objccn
source_url: 'https://objccn.io/issue-21-8'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:190487051abe7b62'
translated: n/a
---

> 原文：[GPU 加速下的图像视觉](https://objccn.io/issue-21-8)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

GPU 加速下的图像视觉

[dopcn](http://blog.fengweizhou.com/)
...
![Original image](https://objccn.io/images/issues/issue-21/MV-Chair.png) ![Sobel edge detection image](https://objccn.io/images/issues/issue-21/MV-Sobel.png)

正如我上面提到的，这项技术通常用来实现一些视觉效果。如果在上面的图片中将颜色进行反转，最明显的边界用黑色代表而不是白色，那么我们就得到了一张类似铅笔素描效果的图片。

![Sketch filtered image](https://objccn.io/images/issues/issue-21/MV-Sketch.png)
...
![Canny edge detection image](https://objccn.io/images/issues/issue-21/MV-Canny.png)
...
其中 I~x 是 X 方向梯度值 (模糊后图片中红色部分)，I~y 是 Y 梯度值 (绿色部分)，I~xy 是 XY 值的乘积 (蓝色部分)，k 是一个灵敏性常数，R 是计算出来的这个像素是边角的确定程度。Shi，Tomasi[6] 和 Noble[7] 提出过这种计算的另一种实现方法但是结果其实是十分接近的。
...
![Harris corner detector test image](https://objccn.io/images/issues/issue-21/MV-HarrisSquares.png)

经过前面的计算过程得到的结果如下图：

![Harris cornerness intermediate image](https://objccn.io/images/issues/issue-21/MV-HarrisCornerness.png)
...
![Harris corners](https://objccn.io/images/issues/issue-21/MV-HarrisCorners.png)
...
![An example line](https://objccn.io/images/issues/issue-21/MV-ParallelCoordinateSpace.png)
...
![Points transformed into parallel coordinate space](https://objccn.io/images/issues/issue-21/MV-ParallelCoordinateTransform.png)
...
![Sample image for line detection](https://objccn.io/images/issues/issue-21/MV-HoughSampleImage.png)

下面是我们在平行坐标空间中得到的 (我已经将负值对称过来使图片高度减半)

![Hough parallel coordinate space](https://objccn.io/images/issues/issue-21/MV-HoughParallel.png)

图中的亮点就是我们探测到线段的地方。进行一个非最大值转化来找到区域最值并将其他地方变为黑色。然后，点被转化回线段的斜率和截距，得到下面的结果：

![Hough transform line detection](https://objccn.io/images/issues/issue-21/MV-HoughLines.png)
...
![](https://objccn.io/images/issues/authors/2014/Oct/1253817.jpg)
