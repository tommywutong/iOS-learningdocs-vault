...
source_key: objccn
source_url: 'https://objccn.io/issue-12-1'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:7c3bd40b6417b39d'
translated: n/a
---

> 原文：[动画解释](https://objccn.io/issue-12-1)　·　ObjC 中国 (objccn.io)
...
![](https://objccn.io/images/issues/issue-12/form.gif)
...
![](https://objccn.io/images/issues/issue-12/planets.gif)
...
![](https://objccn.io/images/issues/issue-12/planets-incorrect.gif)
...
![](https://objccn.io/images/issues/issue-12/lerp-with-easing.png)

最简单的 easing 函数是 _linear_。它在整个动画上维持一个恒定的速度。在 Core Animation 中，这个功能由 `CAMediaTimingFunction` 类表示。

![](https://objccn.io/images/issues/issue-12/rect-linear.gif)
...
- Ease in (`kCAMediaTimingFunctionEaseIn`):
  ...
  ![](https://objccn.io/images/issues/issue-12/rect-easein.gif)
- Ease out (`kCAMediaTimingFunctionEaseOut`):

  ![](https://objccn.io/images/issues/issue-12/rect-easeout.gif)
- Ease in ease out (`kCAMediaTimingFunctionEaseInEaseOut`):

  ![](https://objccn.io/images/issues/issue-12/rect-easeineaseout.gif)
- 默认 (`kCAMediaTimingFunctionDefault`):

  ![](https://objccn.io/images/issues/issue-12/rect-default.gif)
...
![](https://objccn.io/images/issues/issue-12/rocket-custom.gif)
...
![](https://objccn.io/images/issues/issue-12/bezier.png)
...
![](https://objccn.io/images/issues/issue-12/anticipate.gif)
...
![](https://objccn.io/images/issues/issue-12/bounce.gif)
...
![](https://objccn.io/images/issues/issue-12/covers.gif)
