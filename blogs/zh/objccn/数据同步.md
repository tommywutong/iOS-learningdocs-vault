...
source_key: objccn
source_url: 'https://objccn.io/issue-10-1'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:162ac48da43fbb1e'
translated: n/a
---

> 原文：[数据同步](https://objccn.io/issue-10-1)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

数据同步

[郭中强](http://weibo.com/onetaway)
...
|  | **同步** | **异步** |
|---|---|---|
| **客户端-服务端** | [Parse](https://parse.com) [StackMob](https://www.stackmob.com) [Windows Azure Mobile Services](http://www.windowsazure.com/en-us/services/mobile-services/) [Helios](http://helios.io) Custom Web Service | [Dropbox Datastore](https://www.dropbox.com/developers/datastore) [TouchDB](http://labs.couchbase.com/TouchDB-iOS/) [Wasabi Sync](http://www.wasabisync.com) [Zumero](http://zumero.com) |
| **对等方式** | iTunes/iPod Palm Pilot | [Core Data with iCloud](https://developer.apple.com/library/ios/documentation/General/Conceptual/iCloudDesignGuide/Chapters/DesignForCoreDataIniCloud.html) [TICoreDataSync](https://github.com/nothirst/TICoreDataSync) [Core Data Ensembles](https://github.com/drewmccormack/ensembles) |
...
![Synchronous Peer-to-Peer](https://objccn.io/images/issues/issue-10/sp2p.png)  
 _Synchronous Peer-to-Peer (S-P2P)_
...
![Synchronous Client-Server](https://objccn.io/images/issues/issue-10/scs.png)  
...
![Asynchronous Client-Server](https://objccn.io/images/issues/issue-10/acs.png)  
...
![Asynchronous Peer-to-Peer](https://objccn.io/images/issues/issue-10/ap2p.png)  
...
![Orphaned object](https://objccn.io/images/issues/issue-10/orphan.png)  
...
![](https://objccn.io/images/issues/authors/2014/Sep/onetaway.jpg)
