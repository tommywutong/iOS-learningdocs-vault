---
title: 依赖注入和注解，为什么 Java 比你想象的要好
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-11-6'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:0e4d6666cf09b211'
translated: n/a
---

> 原文：[依赖注入和注解，为什么 Java 比你想象的要好](https://objccn.io/issue-11-6)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

依赖注入和注解，为什么 Java 比你想象的要好

[赵帅](http://bayonetta.github.io)
...
![](https://objccn.io/images/issues/authors/2014/Apr/Bayonetta.jpg)
