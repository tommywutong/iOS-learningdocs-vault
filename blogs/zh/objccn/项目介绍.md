...
source_key: objccn
source_url: 'https://objccn.io/issue-8-1'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:5188ee386f0d8d19'
translated: n/a
---

> 原文：[项目介绍](https://objccn.io/issue-8-1)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

项目介绍

[KooFrank](http://koofrank.com)
...
![iphone-above](https://objccn.io/images/issues/issue-8/iphone-above.jpg)
...
![iphone-below](https://objccn.io/images/issues/issue-8/iphone-below.jpg)

## 导航应用

就像上面提到的那样，搭载在飞行器上的iPhone的通过 WiFi 连接另外一个 iPhone，通过这个连接我们可以通过 UDP API 来发送导航命令，虽然这一切看上去比较的晦涩，但是一旦我们搞清楚这个原理基础，就会工作的很好。Daniel 在[这篇文章](http://objccn.io/issue-8-2/)中详细的介绍了 Core Foundation networking 这个类如何使用才能让它工作。

通过使用 iPhone 和飞行器之前的通讯，导航应用也需要处理导航部分内容，这个应用通过 Core Location 来处理它当前位置和方向然后计算它与目的地的距离，你可以通过[这篇文章](http://objccn.io/issue-8-3/)了解它是如何工作的。

## 客户端应用

这个客户端应用唯一的工作就是发送目的地坐标给搭载飞行器的 iPhone 和一些基础的命令例如起飞和降落。它会通过 multipeer connection 来通知它自己和简单的广播它的位置给所有连接的 peers。

![connect_map](https://objccn.io/images/issues/issue-8/client-app.jpg)
...
其实这是一个非常有趣的项目，我们实验了很多有趣的APIs。您可以查看后续的关于 [Core Foundation networking](http://objccn.io/issue-8-2/)，[导航应用](http://objccn.io/issue-8-3/)和[客户端](http://objccn.io/issue-8-4/)的文章的具体细节。
...
![](https://objccn.io/images/issues/authors/2014/Mar/koofrank.jpg)
