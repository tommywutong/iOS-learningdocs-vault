---
title: 从 NSURLConnection 到 NSURLSession
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-5-4'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:8e757ee62a30f807'
translated: n/a
---

> 原文：[从 NSURLConnection 到 NSURLSession](https://objccn.io/issue-5-4)　·　ObjC 中国 (objccn.io)
...
![NSURLSessionTask class diagram](https://objccn.io/images/issues/issue-5/NSURLSession.png)
...
> 编者注 原文中这块代码以及上文的表述中存有一些问题，详见这个 [issue](https://github.com/objcio/articles/issues/24)，本文已进行更正，如果您有不同意见，欢迎在 [Github](https://github.com/objccn/articles) 上给我们反馈。
...
`+backgroundSessionConfiguration:(NSString *)identifier` 的独特之处在于，它会创建一个_后台 session_。后台 session 不同于常规的，普通的 session，它甚至可以在应用程序挂起，退出或者崩溃的情况下运行上传和下载任务。初始化时指定的标识符，被用于向任何可能在进程外恢复后台传输的**守护进程（daemon）**提供上下文。
