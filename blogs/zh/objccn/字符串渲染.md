...
source_key: objccn
source_url: 'https://objccn.io/issue-9-5'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:3b97b2528932f6f2'
translated: n/a
---

> 原文：[字符串渲染](https://objccn.io/issue-9-5)　·　ObjC 中国 (objccn.io)
...
不幸的是，`UITextView` 在 iOS 7 中还有些问题，目前还是 1.0 版本。它是基于 OS X Text Kit 从头开始重新实现的。在 iOS 7 之前，它是基于 Webkit 的，并且功能很少。我们可以看看 [Peter](http://petersteinberger.com/blog/2014/fixing-uitextview-on-ios-7/) 和 [Brent](http://inessential.com/2014/01/07/uitextview_the_solution) 关于这方面的文章。
...
![Table view with quotes](https://objccn.io/images/issues/issue-9/uitableview-finished.png)
...
![Layout-Example-1](https://objccn.io/images/issues/issue-9/Layout-Example-1.png)
...
![Layout-Example-2](https://objccn.io/images/issues/issue-9/Layout-Example-2.png)
...
![Layout-Example-3](https://objccn.io/images/issues/issue-9/Layout-Example-3.png)
