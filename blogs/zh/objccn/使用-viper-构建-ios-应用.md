---
title: 使用 VIPER 构建 iOS 应用
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-13-5'
...
> 原文：[使用 VIPER 构建 iOS 应用](https://objccn.io/issue-13-5)　·　ObjC 中国 (objccn.io)
...
![VIPER stands for View Interactor Presenter Entity Routing.](https://objccn.io/images/issues/issue-13/2014-06-07-viper-intro.jpg)
...
![VIPER breaks down an app into different components based around use cases, including components that create the user interface and the logic that powers it.](https://objccn.io/images/issues/issue-13/2014-06-07-viper-wireframe.png)
