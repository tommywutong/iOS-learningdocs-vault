---
title: Playground 快速原型制作
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-16-5'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:756f8db1c232f3cf'
translated: n/a
---

> 原文：[Playground 快速原型制作](https://objccn.io/issue-16-5)　·　ObjC 中国 (objccn.io)
...
> 编者注 在[这里](http://swifter.natecook.com)有一份自动生成和整理的 Swift 标准库文档，可以作为参考。
...
![](https://objccn.io/images/issues/issue-16/Sine1.png)
...
![](https://objccn.io/images/issues/issue-16/Sine2.png)
...
![](https://objccn.io/images/issues/issue-16/SineCombined.png)
...
![](https://objccn.io/images/issues/issue-16/FFT12.png)

叠加的正弦波看起来像这样：

![](https://objccn.io/images/issues/issue-16/FFTCombined.png)
