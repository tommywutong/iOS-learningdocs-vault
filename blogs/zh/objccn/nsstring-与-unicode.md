---
title: NSString 与 Unicode
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-9-1'
...
> 原文：[NSString 与 Unicode](https://objccn.io/issue-9-1)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

NSString 与 Unicode

[陈彬彬](http://weibo.com/cbbcd)
...
我已经提到过，纯文本文件，和文件格式或者网络协议应该选择 UTF-8 编码，除非有特别的需要只能用其它的编码。要向文件中写入文本，使用 [`writeToURL:atomically:encoding:error:`](https://developer.apple.com/library/ios/documentation/cocoa/reference/foundation/classes/NSString_Class/Reference/NSString.html#//apple_ref/occ/instm/NSString/writeToURL:atomically:encoding:error:) 这个方法。
...
![](https://objccn.io/images/issues/authors/2014/Apr/cbb.jpg)
