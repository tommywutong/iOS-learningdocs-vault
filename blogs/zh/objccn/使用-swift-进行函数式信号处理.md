---
title: 使用 Swift 进行函数式信号处理
source: ObjC 中国 (objccn.io)
source_key: objccn
source_url: 'https://objccn.io/issue-24-2'
original_language: zh
published: ''
status: frozen
license: 页脚「© 2015 至今」→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:e4620cc9e1a6abda'
translated: n/a
---

> 原文：[使用 Swift 进行函数式信号处理](https://objccn.io/issue-24-2)　·　ObjC 中国 (objccn.io)

[返回期刊列表](https://objccn.io/issues/)

使用 Swift 进行函数式信号处理

[李子轩](http://scoooter.io)

2015/05/21

---

作为一个和 Core Audio 打过很长时间交道的工程师，苹果发布 Swift 让我感到兴奋又疑惑。兴奋是因为 Swift 是一个为性能打造的现代编程语言，但是我又不是非常确定函数式编程是否可以应用到 “我的世界”。幸运的是，很多人已经[探索和克服了](http://sourceforge.net/projects/faudiostream/)这些问题，所以我决定将我从这些项目中学习到的东西应用到 Swift 编程语言中去。
...
我们如何才能以更灵活的方式在信号和处理器之间建立联系，来让信号处理更接近于我们所想呢？有很多流行的环境，比如说 [Max](https://cycling74.com/products/max/) 和 [PureData](http://puredata.info)，这些环境会建立信号处理的 “blocks”，并以此来创造强大的音效和演奏工具。

[Faust](http://sourceforge.net/projects/faudiostream/) 是一个为此设计出来的函数式编程语言，它是一个用来编写高度复杂 (而且高性能) 的信号处理代码的强大工具。Faust 定义了一系列运算符来让你建立 blocks (处理器)，这和信号流图像很相似。
...
一组并行运行的 blocks 将输入和输出结合在一起，并创建了一个更大的 block。比如一对产生的正弦波的 `Block` 组合在一起可以创建一个 [DTMF 音调](http://zh.wikipedia.org/wiki/双音多频)，或者两个单频延迟的 `Block` 可以组成一个立体延迟 `Block` 等。这个概念在实践中是非常强大的。
...
现在有了这些运算符，你可以建立一些有趣的 blocks “图”。比如说 [DTMF 音调](http://zh.wikipedia.org/wiki/双音多频)发生器：
...
如果我今天要开始做一个要求最高性能以及丰富功能的新项目，我会毫不犹豫的使用 [Faust](http://sourceforge.net/projects/faudiostream/)。如果你对函数式音频编程感兴趣的话，我极力推荐 Faust。
...
![](https://objccn.io/images/issues/authors/2014/Sep/lizixuan.jpg)
