...
source_key: onevcat
source_url: 'https://onevcat.com/2013/09/spring-list-like-ios7-message/'
original_language: zh
published: 2013-09-01
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:1876758ee97100f6'
translated: n/a
---

> 原文：[WWDC 2013 Session笔记 - iOS7中弹簧式列表的制作](https://onevcat.com/2013/09/spring-list-like-ios7-message/)　·　onevcat (王巍/喵神)
...
![iOS7中信息app的弹簧效果](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![向上拖动时的锚点变化示意](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![带有弹性效果的collecitonView](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
