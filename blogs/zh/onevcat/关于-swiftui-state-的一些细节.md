...
source_key: onevcat
source_url: 'https://onevcat.com/2021/01/swiftui-state/'
original_language: zh
published: 2021-01-22
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:968d4106f48dda25'
translated: n/a
---

> 原文：[关于 SwiftUI State 的一些细节](https://onevcat.com/2021/01/swiftui-state/)　·　onevcat (王巍/喵神)

> ### 2021 年 9 月更新
> 
> 在评论区里，[@CrystDragon 指出](https://github.com/onevcat/OneV-s-Den-Comments/issues/7#issuecomment-906893521)原文章的部分 内容已经在新版本 SwiftUI 中发生了变化。不过这也带来了另一方面更加让人迷惑的问题。因此我对部分内容进行了更新和额外说明，更新部分会作为评注内 容写在相关原文的后面。
...
在[之前的一篇文章](https://onevcat.com/2020/06/stateobject/) 中，我们已经详细探讨了这方面的内容。如果有兴趣的话，不妨花时间读读看。
