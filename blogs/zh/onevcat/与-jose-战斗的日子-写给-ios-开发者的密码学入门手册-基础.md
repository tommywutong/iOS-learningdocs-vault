...
source_key: onevcat
source_url: 'https://onevcat.com/2018/12/jose-1/'
original_language: zh
published: 2018-12-03
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:f4059e7ac9253aa4'
translated: n/a
---

> 原文：[与 JOSE 战斗的日子 - 写给 iOS 开发者的密码学入门手册 (基础)](https://onevcat.com/2018/12/jose-1/)　·　onevcat (王巍/喵神)
...
系列文章后面两篇，会分别针对 [JOSE 中的签名和验证过程](https://onevcat.com/2018/12/jose-2/))以及作为 iOS 开发者如何[使用 Security.frame 来处理 JOSE 相关的概念实践](https://onevcat.com/2018/12/jose-3/)进行更详细的说明。
