...
source_key: onevcat
source_url: 'https://onevcat.com/2026/07/sim-use/'
original_language: zh
published: 2026-07-03
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:43b634f5d4cfaad0'
translated: n/a
---

> 原文：[sim-use - 给 agent 装上眼睛和手，让 mobile 开发跟上 AI 时代](https://onevcat.com/2026/07/sim-use/)　·　onevcat (王巍/喵神)
...
_图 1：同一个 LINE 新闻页面，JSON 是 24 KB / 1600 行，outline 是 1.2 KB / 28 行 —— token 消耗压到 1/20。_
...
_图 3：UITabBar 的 `accessibilityChildren` 是空的，但 quadtree 探针通过粗 seed 网格、命中即标已覆盖（命中元素之外的剩余条带会重新入队继续探）、nil 即四分细分，最终把 4 个 tab 按钮全部探出来。_
