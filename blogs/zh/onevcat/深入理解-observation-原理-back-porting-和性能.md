...
source_key: onevcat
source_url: 'https://onevcat.com/2023/08/observation-framework/'
original_language: zh
published: 2023-08-07
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:de6d1b15c1eb3ace'
translated: n/a
---

> 原文：[深入理解 Observation - 原理，back porting 和性能](https://onevcat.com/2023/08/observation-framework/)　·　onevcat (王巍/喵神)
