...
source_key: onevcat
source_url: 'https://onevcat.com/2014/07/ios-ui-unique/'
original_language: zh
published: 2014-07-29
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:420dbda39c49a240'
translated: n/a
---

> 原文：[WWDC 2014 Session笔记 - iOS界面开发的大一统](https://onevcat.com/2014/07/ios-ui-unique/)　·　onevcat (王巍/喵神)

![size-classes](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![根据 Size Classes 指定图片](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
