...
source_key: onevcat
source_url: 'https://onevcat.com/2025/06/foundation-models/'
original_language: zh
published: 2025-06-17
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:14073659f51a08ea'
translated: n/a
---

> 原文：[Foundation Models：苹果设备端模型的边界探索](https://onevcat.com/2025/06/foundation-models/)　·　onevcat (王巍/喵神)
