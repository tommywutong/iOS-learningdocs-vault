...
source_key: onevcat
source_url: 'https://onevcat.com/2012/03/opencv-build-and-config/'
original_language: zh
published: 2012-03-03
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:fd5f20ddb213ed86'
translated: n/a
---

> 原文：[OpenCV 在 iOS 开发环境下的编译和配置](https://onevcat.com/2012/03/opencv-build-and-config/)　·　onevcat (王巍/喵神)
