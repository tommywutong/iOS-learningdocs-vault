...
source_key: onevcat
source_url: 'https://onevcat.com/2013/10/vc-transition-in-ios7/'
original_language: zh
published: 2013-10-11
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:064112d15df41890'
translated: n/a
---

> 原文：[WWDC 2013 Session笔记 - iOS7中的ViewController切换](https://onevcat.com/2013/10/vc-transition-in-ios7/)　·　onevcat (王巍/喵神)
...
![BouncePresentAnimation的实际效果](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![交互驱动的VC转移](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
