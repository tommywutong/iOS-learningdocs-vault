...
source_key: onevcat
source_url: 'https://onevcat.com/2018/05/mvc-wrong-use/'
original_language: zh
published: 2018-05-11
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:473a69486ebf1862'
translated: n/a
---

> 原文：[关于 MVC 的一个常见的误用](https://onevcat.com/2018/05/mvc-wrong-use/)　·　onevcat (王巍/喵神)
