...
source_key: onevcat
source_url: 'https://onevcat.com/2012/06/introducing-collection-views/'
original_language: zh
published: 2012-06-30
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:83a77b7eeb37df1b'
translated: n/a
---

> 原文：[WWDC 2012 Session笔记——205 Introducing Collection Views](https://onevcat.com/2012/06/introducing-collection-views/)　·　onevcat (王巍/喵神)
...
![iOS6 iPad版时钟应用](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 ) 最简单的UICollectionView就是一个GridView，可以以多列的方式将数据进行展示。标准的UICollectionView包含三个部分，它们都是UIView的子类：
...
关于上面几种自定义Layout和实现细节，和其他高级CollectionView应用，将在[下一篇笔记](http://www.onevcat.com/2012/08/advanced-collection-view/)中进行详细说明～
