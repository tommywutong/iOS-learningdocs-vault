...
source_key: onevcat
source_url: 'https://onevcat.com/2015/01/swift-pointer/'
original_language: zh
published: 2015-01-19
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:f50a1941e5c7935b'
translated: n/a
---

> 原文：[Swift 中的指针使用](https://onevcat.com/2015/01/swift-pointer/)　·　onevcat (王巍/喵神)
