...
source_key: onevcat
source_url: 'https://onevcat.com/2018/11/tools-i-am-using/'
original_language: zh
published: 2018-11-16
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:e6555f7fedb2e22d'
translated: n/a
---

> 原文：[我所使用的工具们](https://onevcat.com/2018/11/tools-i-am-using/)　·　onevcat (王巍/喵神)
...
[数码荔枝](https://www.lizhi.io/)作为国内有名的软件经销商，为我们争取到了很多中国区特供的优惠价格，文中部分工具也提供了优惠合作的购买链接，您可以先 [拿到优惠券](https://partner.lizhi.io/onevcat/cp)，然后以中国地区的专供价格进行购买，通常会比到官网购买便宜很多。通过这样购买的软件我可以拿到一定的 分成，可能可以 cover 这个站点的运营成本。如果您正好需要购买某个 app 的话，还请不妨考虑这种方式。先谢谢啦！
