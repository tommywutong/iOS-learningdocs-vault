...
source_key: onevcat
source_url: 'https://onevcat.com/2013/06/uikit-dynamics-started/'
original_language: zh
published: 2013-06-15
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:d0514c8fc8e8b9ba'
translated: n/a
---

> 原文：[WWDC 2013 Session笔记 - UIKit Dynamics入门](https://onevcat.com/2013/06/uikit-dynamics-started/)　·　onevcat (王巍/喵神)
...
![重力作用下的UIview](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![碰撞和重力同时作用的动力UI](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![Drag & Drop](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
