...
source_key: onevcat
source_url: 'https://onevcat.com/2014/05/kiwi-mock-stub-test/'
original_language: zh
published: 2014-05-09
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:89cdd2bd637f9cac'
translated: n/a
---

> 原文：[Kiwi 使用进阶 Mock, Stub, 参数捕获和异步测试](https://onevcat.com/2014/05/kiwi-mock-stub-test/)　·　onevcat (王巍/喵神)
...
![mock](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
