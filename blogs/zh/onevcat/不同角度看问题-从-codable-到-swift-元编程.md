...
source_key: onevcat
source_url: 'https://onevcat.com/2018/03/swift-meta/'
original_language: zh
published: 2018-03-12
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:bce5272a9bbe0e99'
translated: n/a
---

> 原文：[不同角度看问题 - 从 Codable 到 Swift 元编程](https://onevcat.com/2018/03/swift-meta/)　·　onevcat (王巍/喵神)
...
乍一看上去可能有些可怕，不过其实仔细辨识的话基底依然是 Swift。模板中被 `{% %}` 包含的内容将被作为代码执行，`{{ }}` 中的内容将被求值并嵌入到生成的文本中，而其他部分被直接作为文本复制到目标文件里。
