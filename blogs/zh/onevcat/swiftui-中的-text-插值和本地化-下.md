...
source_key: onevcat
source_url: 'https://onevcat.com/2021/03/swiftui-text-2/'
original_language: zh
published: 2021-03-26
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:56c7eaf4422a9f16'
translated: n/a
---

> 原文：[SwiftUI 中的 Text 插值和本地化 (下)](https://onevcat.com/2021/03/swiftui-text-2/)　·　onevcat (王巍/喵神)

在[上篇中](https://onevcat.com/2021/03/swiftui-text-1/)，我们已经看到为什么 `Text`，或者更准确地说，`LocalizedStringKey`，可以接受 `Image` 和 `Date`，而不能接受 `Bool` 或者自定义的 `Person` 类型了。在这下篇中，让我们具体看看有哪些方法能让 `Text` 支持其他类型。
