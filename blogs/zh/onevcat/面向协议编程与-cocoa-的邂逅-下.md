...
source_key: onevcat
source_url: 'https://onevcat.com/2016/12/pop-cocoa-2/'
original_language: zh
published: 2016-12-01
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:eaffe8a213ff96b3'
translated: n/a
---

> 原文：[面向协议编程与 Cocoa 的邂逅 (下)](https://onevcat.com/2016/12/pop-cocoa-2/)　·　onevcat (王巍/喵神)
...
在[上半部分](https://onevcat.com/2016/11/pop-cocoa-1/)主要介绍了一些理论方面的内容，包括面向对象编程存在的问题，面向协议的基本概念和决策模型等。本文 (下) 主要展示了一些笔者日常使用面向协议思想和 Cocoa 开发结合的示例代码，并对其进行了一些解说。
