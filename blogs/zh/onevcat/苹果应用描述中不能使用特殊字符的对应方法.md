...
source_key: onevcat
source_url: 'https://onevcat.com/2014/04/itc-special-characters/'
original_language: zh
published: 2014-04-28
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:26c9a9cfaadad5f4'
translated: n/a
---

> 原文：[苹果应用描述中不能使用特殊字符的对应方法](https://onevcat.com/2014/04/itc-special-characters/)　·　onevcat (王巍/喵神)
