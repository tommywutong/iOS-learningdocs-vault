...
source_key: onevcat
source_url: 'https://onevcat.com/2024/11/type-as-state/'
original_language: zh
published: 2024-11-11
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:08cd515e559ca38b'
translated: n/a
---

> 原文：[编译器，靠你了！使用类型改善状态设计](https://onevcat.com/2024/11/type-as-state/)　·　onevcat (王巍/喵神)
...
当然，你可能会认为这是逻辑错误或误用：毕竟，只要我们不写出这样的代码，就不会引发安全问题。然而，这一假设并不可靠，我们需要更稳妥的保障。没错，或许你已经想到了，[上一篇文章](https://onevcat.com/2024/11/noncopyable/)中提到的不可复制类型，正是在这个场景下编译器能够提供的可靠保障。
