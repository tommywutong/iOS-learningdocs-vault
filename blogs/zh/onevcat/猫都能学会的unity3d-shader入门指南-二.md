...
source_key: onevcat
source_url: 'https://onevcat.com/2013/08/shader-tutorial-2/'
original_language: zh
published: 2013-08-31
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:4b290d8eddf45434'
translated: n/a
---

> 原文：[猫都能学会的Unity3D Shader入门指南（二）](https://onevcat.com/2013/08/shader-tutorial-2/)　·　onevcat (王巍/喵神)
...
![一张典型的法线图](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![Half Lambert下发现贴图的表现](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![添加了积雪效果的Shader](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
