...
source_key: onevcat
source_url: 'https://onevcat.com/2018/10/swift-result-error/'
original_language: zh
published: 2018-10-31
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:8150d6ea981d9245'
translated: n/a
---

> 原文：[Result<T> 还是 Result<T, E: Error>](https://onevcat.com/2018/10/swift-result-error/)　·　onevcat (王巍/喵神)
...
[![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )](https://partner.lizhi.io/onevcat/pdf_expert_for_mac)
