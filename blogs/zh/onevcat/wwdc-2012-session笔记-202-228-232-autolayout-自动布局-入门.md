...
source_key: onevcat
source_url: 'https://onevcat.com/2012/09/autoayout/'
original_language: zh
published: 2012-09-20
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:28e53cc835c3bf65'
translated: n/a
---

> 原文：[WWDC 2012 Session笔记——202, 228, 232 AutoLayout（自动布局）入门](https://onevcat.com/2012/09/autoayout/)　·　onevcat (王巍/喵神)
...
选中某个约束条件后，在右边的Attributes inspector中可以更改约束的条件，距离值和优先度等： ![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )

对于没有自动添加的约束，可以在IB中手动添加。选择需要添加约束的view，点击菜单的Edit-\>Pin里的需要的选项，或者是点击IB主视图右下角的![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )按钮，即可添加格外的约束条件。
...
- H:
  ...
  -[Find]-[FindNext]-[FindField(\>=20)]-
    ...
    - 水平布局，Find距离父view左边缘默认间隔宽度，之后是FindNext距离Find间隔默认宽度；再之后是宽度不小于20的FindField，它和FindNext以及父view右边缘的间距都是默认宽度。（竖线’
