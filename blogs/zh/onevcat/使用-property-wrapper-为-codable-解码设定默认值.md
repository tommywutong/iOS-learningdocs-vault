...
source_key: onevcat
source_url: 'https://onevcat.com/2020/11/codable-default/'
original_language: zh
published: 2020-11-10
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:3977efaed92bdb65'
translated: n/a
---

> 原文：[使用 Property Wrapper 为 Codable 解码设定默认值](https://onevcat.com/2020/11/codable-default/)　·　onevcat (王巍/喵神)
