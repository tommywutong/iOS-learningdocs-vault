...
source_key: onevcat
source_url: 'https://onevcat.com/2020/06/stateobject/'
original_language: zh
published: 2020-06-25
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:a93540b4c163845f'
translated: n/a
---

> 原文：[@StateObject 和 @ObservedObject 的区别和使用](https://onevcat.com/2020/06/stateobject/)　·　onevcat (王巍/喵神)
