...
[本文的下半部分](https://onevcat.com/2016/12/pop-cocoa-2/)将展示一些笔者日常使用面向协议思想和 Cocoa 开发结合的示例代码，并对其进行了一些解说。
