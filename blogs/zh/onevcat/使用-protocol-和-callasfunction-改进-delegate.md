...
source_key: onevcat
source_url: 'https://onevcat.com/2020/03/improve-delegate/'
original_language: zh
published: 2020-03-12
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:2198f432112c1d34'
translated: n/a
---

> 原文：[使用 protocol 和 callAsFunction 改进 Delegate](https://onevcat.com/2020/03/improve-delegate/)　·　onevcat (王巍/喵神)
