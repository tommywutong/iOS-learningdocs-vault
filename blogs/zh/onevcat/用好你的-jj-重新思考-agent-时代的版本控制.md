...
source_key: onevcat
source_url: 'https://onevcat.com/2026/03/jj-for-agent-era/'
original_language: zh
published: 2026-03-16
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:a4e0bec777562991'
translated: n/a
---

> 原文：[用好你的 jj - 重新思考 Agent 时代的版本控制](https://onevcat.com/2026/03/jj-for-agent-era/)　·　onevcat (王巍/喵神)
...
[用 OMA 安装 onevcat-jj](oma://github.com/onevcat/skills/tree/master/skills/onevcat-jj)
