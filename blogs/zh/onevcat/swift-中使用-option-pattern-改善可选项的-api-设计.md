...
source_key: onevcat
source_url: 'https://onevcat.com/2020/10/use-options-pattern/'
original_language: zh
published: 2020-10-21
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:7007732a794404f9'
translated: n/a
---

> 原文：[Swift 中使用 Option Pattern 改善可选项的 API 设计](https://onevcat.com/2020/10/use-options-pattern/)　·　onevcat (王巍/喵神)
