...
source_key: onevcat
source_url: 'https://onevcat.com/2022/10/spm-in-xcode/'
original_language: zh
published: 2022-10-14
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:a47b7dcf6c92363a'
translated: n/a
---

> 原文：[Xcode 中使用 SPM 和 Build Configuration 的一些坑](https://onevcat.com/2022/10/spm-in-xcode/)　·　onevcat (王巍/喵神)
