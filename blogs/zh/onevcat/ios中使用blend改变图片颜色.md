...
source_key: onevcat
source_url: 'https://onevcat.com/2013/04/using-blending-in-ios/'
original_language: zh
published: 2013-04-29
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:74fd430c5c28cb6e'
translated: n/a
---

> 原文：[iOS中使用blend改变图片颜色](https://onevcat.com/2013/04/using-blending-in-ios/)　·　onevcat (王巍/喵神)
...
![要处理的原图](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![使用kCGBlendModeDestinationIn模式的结果](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![使用kCGBlendModeOverlay模式的结果](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
![使用kCGBlendModeOverlay和kCGBlendModeDestinationIn模式的结果](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
