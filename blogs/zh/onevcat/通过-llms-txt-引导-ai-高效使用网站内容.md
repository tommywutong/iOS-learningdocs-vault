...
source_key: onevcat
source_url: 'https://onevcat.com/2025/04/llmtxt/'
original_language: zh
published: 2025-04-01
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:f87123bc474c5657'
translated: n/a
---

> 原文：[通过 llms.txt 引导 AI 高效使用网站内容](https://onevcat.com/2025/04/llmtxt/)　·　onevcat (王巍/喵神)

> 作为示例，本站也开始提供 `llms.txt` 和 `llms-full.txt` 的支持，可以参看下面的链接获取相关文件。
> 
> [llms.txt](https://onevcat.com/llms.txt)
> 
> [llms-full.txt](https://onevcat.com/llms-full.txt)
