...
source_key: onevcat
source_url: 'https://onevcat.com/2012/08/advanced-collection-view/'
original_language: zh
published: 2012-08-28
status: active
license: CC BY 4.0（页脚明示）→ 可公开，须署名并保留原文链接
archived_at: 2026-07-27
content_hash: 'sha256:a6ef2d361c24c950'
translated: n/a
---

> 原文：[WWDC 2012 Session笔记——219 Advanced Collection Views and Building Custom Layouts](https://onevcat.com/2012/08/advanced-collection-view/)　·　onevcat (王巍/喵神)
...
[![](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )](http://www.onevcat.com/wp-content/uploads/2012/08/QQ20120828-1-e1346145550225.png)
...
![CircleLayout](data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7 )
...
> 更正：正式版中API发生了变化（而且不止一次变化 initialLayoutAttributesForInsertedItemAtIndexPath:在正式版中已经被废除。现在在insert或者delete之前，prepareForCollectionViewUpdates:会被调用，可以使用这个方法来完成添加/删除的布局。关于更多这方面的内容以及新的示例demo，可以参看[这篇博文](http://markpospesel.wordpress.com/2012/10/25/fixing-circlelayout/)（需要翻墙）。新的示例demo在Github上也有，[链接](https://github.com/mpospese/CircleLayout)
