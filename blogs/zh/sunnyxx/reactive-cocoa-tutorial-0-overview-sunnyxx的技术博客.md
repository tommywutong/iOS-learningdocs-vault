---
title: 'Reactive Cocoa Tutorial [0] = Overview · sunnyxx的技术博客'
source: sunnyxx (孙源)
source_key: sunnyxx
source_url: 'http://blog.sunnyxx.com/2014/03/06/rac_0_overview/'
original_language: zh
published: 2014-03-06
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:8fed98af8770c005'
translated: n/a
---

> 原文：[Reactive Cocoa Tutorial [0] = Overview · sunnyxx的技术博客](http://blog.sunnyxx.com/2014/03/06/rac_0_overview/)　·　sunnyxx (孙源)
...
> PS:  
> 这篇文章原来发布在blogcn上，[http://www.cnblogs.com/sunnyxx，](http://www.cnblogs.com/sunnyxx，)  
> 现在建了自己的blog后会在这上面继续写了。

---

### [#废话少说-–-gt-RAC](#废话少说-–-gt-RAC)废话少说 –\> **RAC**

是什么？怎么来的？干啥用的？ 怎么用的？ 可以观摩无网不剩的blog RAC介绍1和2，在此不啰唆了，简而言之，就是一个函数响应式编程思想在Cocoa下的实现。

### [#说说在RAC框架下做了一个项目的赶脚吧：](#说说在RAC框架下做了一个项目的赶脚吧：)说说在RAC框架下做了一个项目的赶脚吧：
