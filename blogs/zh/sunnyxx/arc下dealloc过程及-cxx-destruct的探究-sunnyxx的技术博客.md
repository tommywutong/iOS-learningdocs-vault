---
title: ARC下dealloc过程及.cxx_destruct的探究 · sunnyxx的技术博客
source: sunnyxx (孙源)
source_key: sunnyxx
source_url: 'http://blog.sunnyxx.com/2014/04/02/objc_dig_arc_dealloc/'
...
> 原文：[ARC下dealloc过程及.cxx_destruct的探究 · sunnyxx的技术博客](http://blog.sunnyxx.com/2014/04/02/objc_dig_arc_dealloc/)　·　sunnyxx (孙源)
...
[http://clang.llvm.org/doxygen/CodeGenModule_8cpp-source.html](http://clang.llvm.org/doxygen/CodeGenModule_8cpp-source.html)  
位于1827行，删减掉离题部分如下：
...
注：真实的实现可以参考 [http://clang.llvm.org/doxygen/CGObjC_8cpp_source.html](http://clang.llvm.org/doxygen/CGObjC_8cpp_source.html) 2078行
