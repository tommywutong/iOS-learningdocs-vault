---
title: 64-bit Tips · sunnyxx的技术博客
source: sunnyxx (孙源)
source_key: sunnyxx
source_url: 'http://blog.sunnyxx.com/2014/12/20/64-bit-tips/'
original_language: zh
published: 2014-12-20
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:93b478c33df68d2c'
translated: n/a
---

> 原文：[64-bit Tips · sunnyxx的技术博客](http://blog.sunnyxx.com/2014/12/20/64-bit-tips/)　·　sunnyxx (孙源)
...
## [#拒绝基本数据类型和隐式转换](#拒绝基本数据类型和隐式转换)拒绝基本数据类型和隐式转换
...
## [#替代Format字符串](#替代Format字符串)替代Format字符串
...
## [#64-bit下的BOOL](#64-bit下的BOOL)64-bit下的BOOL
...
## [#解决第三方lib依赖和lipo命令](#解决第三方lib依赖和lipo命令)解决第三方lib依赖和lipo命令
...
### [#打印Mach-O文件支持的架构](#打印Mach-O文件支持的架构)打印Mach-O文件支持的架构
...
## [#支持64-bit后程序包会变大么？](#支持64-bit后程序包会变大么？)支持64-bit后程序包会变大么？

会，支持64-bit后，多了一个`arm64`架构，理论上每个架构一套指令，但相比原来会大多少还不好说，我们这里增加了大概50%，还有听说会增加一倍的。

## [#一个lib包含了很多的架构，会打到最后的包里么？](#一个lib包含了很多的架构，会打到最后的包里么？)一个lib包含了很多的架构，会打到最后的包里么？
...
[http://www.bignerdranch.com/blog/64-bit-smorgasbord/](http://www.bignerdranch.com/blog/64-bit-smorgasbord/)  
[http://www.bignerdranch.com/blog/bools-sharp-corners/](http://www.bignerdranch.com/blog/bools-sharp-corners/)
