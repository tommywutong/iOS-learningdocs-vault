...
source: ibireme (郭曜源)
source_key: ibireme
source_url: 'https://blog.ibireme.com/2015/11/02/mobile_image_benchmark/'
original_language: zh
published: 2015-11-02
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:c3392f57bcbbe526'
translated: n/a
---

> 原文：[移动端图片格式调研](https://blog.ibireme.com/2015/11/02/mobile_image_benchmark/)　·　ibireme (郭曜源)
...
BPG 是著名程序员 Fabrice Bellard 在去年 (2014年) 发布的一款超高压缩比的图片格式。这个程序员有些人可能感觉面生，但说起他的作品 FFmpeg、QEMU 大家想必是都知道的。BPG 使用 HEVC (即 H.265) 帧内编码作为其算法基础，就这点而言，它毋庸置疑是当下最为先进的图片压缩格式。相对于 JP2、JPEG-XR、WebP 来说，同等体积下 BPG 能提供更高的图像质量。另外，得益于它本身基于视频编码算法的特性，它能以非常小的文件体积保存多帧动画。 Fabrice Bellard 聪明的地方在于，他知道自己一个人无法得到各大浏览器厂商的支持，所以他还特地开发了 Javascript 版的解码器，任何浏览器只要加载了这个 76KB 大小的 JS 文件，就可以直接显示 BPG 格式的图片了。目前阻碍它流行的原因就是 HEVC 的版权问题和它较长的编码解码时间。尽管这个图片格式才刚刚发布一年，但已经有不少厂子开始试用了，比如[阿里](http://www.infoq.com/cn/news/2015/08/onesdk-shoutao)和[腾讯](http://www.infoq.com/cn/articles/how-subject-test-works)。

## 移动端图片类型的支持情况

目前主流的移动端对图片格式的支持情况如何呢？我们分别来看一下 Android 和 iOS 目前的图片编解码架构吧：

[![mobile_image_arch](https://blog.ibireme.com/wp-content/uploads/2015/11/mobile_image_arch.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/mobile_image_arch.png)
...
[![dribbble512_pngcrush](https://blog.ibireme.com/wp-content/uploads/2015/11/dribbble512_pngcrush.png)![lena512_weibo](https://blog.ibireme.com/wp-content/uploads/2015/11/lena512_weibo.jpg)](https://blog.ibireme.com/wp-content/uploads/2015/11/dribbble512_pngcrush.png)
...
[![jpeg_bench_dribbble](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_bench_dribbble.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_bench_dribbble.png) [![jpeg_bench_lena](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_bench_lena.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_bench_lena.png)
...
[![jpeg_png_bench](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_png_bench.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/jpeg_png_bench.png)
...
[![png_tools_bench](https://blog.ibireme.com/wp-content/uploads/2015/11/png_tools_bench.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/png_tools_bench.png)
...
quality: [0~100] 图像质量，0表示最差质量，文件体积最小，细节损失严重，100表示最高图像质量，文件体积较大。该参数只针对有损压缩有明显效果。Google 官方的建议是 75，腾讯在[对 WebP 评测](http://isux.tencent.com/introduction-of-webp.html)时给出的建议也是 75。在这个值附近，WebP 能在压缩比、图像质量上取得较好的平衡。
...
[![webp_bench](https://blog.ibireme.com/wp-content/uploads/2015/11/webp_bench.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/webp_bench.png)
...
![bpg_demo](https://blog.ibireme.com/wp-content/uploads/2015/11/bpg_demo.png)
...
[![bpg_bench](https://blog.ibireme.com/wp-content/uploads/2015/11/bpg_bench.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/bpg_bench.png)
...
[![bench_gif_demo](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo.gif)](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo.gif)

这张表情由 6 幅静态图构成，每幅图片有一定的存活时间，连贯播放就形成了动画：

[![bench_gif_demo1](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo1.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo1.png)

这几张图中，大部分内容是相近的，为了压缩文件体积，通常动图格式都支持一些特殊的方式对相似图片进行裁剪，只保留前后帧不同的部分：

[![bench_gif_demo2](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo2.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/bench_gif_demo2.png)
...
[![gif_apng_demo](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_apng_demo.gif)](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_apng_demo.gif)

上面这是腾讯博客里的一张演示图，可以看到 GIF 由于 Alpha 通道的问题，产生了严重的“毛边”现象。目前通常的解决方案是在图片的边缘加一圈白边，以减轻这种视觉效果：

[![gif_wrong_demo](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_wrong_demo.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_wrong_demo.png)

可以仔细观察一下 QQ、微信等 App 里面的动画表情，几乎每个表情都被一圈白边所环绕，不得不说是一种很无奈的解决方案。

GIF 的制作工具有很多，但效果好、压缩比高的工具非常少。对于已经制作好的 GIF 来说，用 [imagemagick](http://www.imagemagick.org/script/index.php) 处理一下可以把文件体积压缩不少。如果需要将视频转为 GIF，[Cinemagraph Pro](https://flixel.com/products/mac/cinemagraph-pro/) 是个不错的傻瓜化工具。[这里](http://www.oschina.net/translate/high-quality-gif-with-ffmpeg)有一篇文章介绍如何用 ffmpeg 压缩 GIF，虽然参数调节有点麻烦，但效果非常理想。

下面是没有经过优化的 GIF 和经过 ffmpeg 优化编码的 GIF，可以看到差距非常大。

[![bbb-trans](https://blog.ibireme.com/wp-content/uploads/2015/11/bbb-trans.gif) ![bbb-nodither](https://blog.ibireme.com/wp-content/uploads/2015/11/bbb-nodither.gif)](https://blog.ibireme.com/wp-content/uploads/2015/11/bbb-nodither.gif)

### **APNG**

APNG 目前并没有被 PNG 官方所接受，所以 libpng 并不能直接解码 APNG。但由于 APNG 只是基于 PNG 的一个简单扩展，所以在已经支持 PNG 的平台上，可以很轻松的用少量代码实现 APNG 的编解码。Chromium 为了支持 APNG 播放，只增加了[不到](https://codereview.chromium.org/1312843006/)[600](https://codereview.chromium.org/1312843006/)[行代码](https://codereview.chromium.org/1312843006/) ，我自己也用[大概 500 行 C 代码](https://github.com/ibireme/YYWebImage/blob/master/YYWebImage/Image/YYImageCoder.m#L149-L628)实现了一个简单的 APNG 编解码工具。另外，在支持 canvas 的浏览器上，可以用 [apng-canvas](https://github.com/davidmz/apng-canvas) 直接显示 APNG 动画。APNG 压缩最好的工具目前是 [apngasm](http://sourceforge.net/projects/apngasm/)，大部分图形化工具比如腾讯的 [iSparta](http://isparta.github.io/index.html) 都是基于这个工具开发的。
...
[![gif_ermilio](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_ermilio.gif)](https://blog.ibireme.com/wp-content/uploads/2015/11/gif_ermilio.gif)

评测结果如下：

[![anim_bench](https://blog.ibireme.com/wp-content/uploads/2015/11/anim_bench.png)](https://blog.ibireme.com/wp-content/uploads/2015/11/anim_bench.png)
...
上面提到的所有评测数据表格：[image_benchmark.xlsx](https://blog.ibireme.com/wp-content/uploads/2015/11/image_benchmark.xlsx) 推荐用 Excel 打开查看。
