...
source: ibireme (郭曜源)
source_key: ibireme
source_url: 'https://blog.ibireme.com/2015/05/18/runloop/'
original_language: zh
published: 2015-05-18
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:6d83c3bcd6ef17c0'
translated: n/a
---

> 原文：[深入理解RunLoop](https://blog.ibireme.com/2015/05/18/runloop/)　·　ibireme (郭曜源)
...
Index  
 [RunLoop 的概念](#base)  
 [RunLoop 与线程的关系](#thread)  
 [RunLoop 对外的接口](#api)  
 [RunLoop 的 Mode](#mode)  
 [RunLoop 的内部逻辑](#inner)  
 [RunLoop 的底层实现](#core)  
 [苹果用 RunLoop 实现的功能](#apple)  
 [AutoreleasePool](#autorelease)  
 [事件响应](#event)  
 [手势识别](#gesture)  
 [界面更新](#ui)  
 [定时器](#timer)  
 [PerformSelecter](#perform)  
 [关于GCD](#gce)  
 [关于网络请求](#network)  
 [RunLoop 的实际应用举例](#example)  
...
[![RunLoop_network](https://blog.ibireme.com/wp-content/uploads/2015/05/RunLoop_network.png)](https://blog.ibireme.com/wp-content/uploads/2015/05/RunLoop_network.png)
