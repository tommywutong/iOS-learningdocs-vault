...
source_url: 'http://yulingtianxia.com/blog/2020/08/22/DartNative-Automatic-Memory-Management/'
original_language: zh
published: 2020-09-28
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:99c27d9cf4f72425'
translated: n/a
---

> 原文：[DartNative 内存自动管理](http://yulingtianxia.com/blog/2020/08/22/DartNative-Automatic-Memory-Management/)　·　杨萧玉

# [DartNative 内存自动管理](http://yulingtianxia.com/blog/2020/08/22/DartNative-Automatic-Memory-Management/)
...
2. 2. 实现原理
    ...
    1. 2.1. Dart 封装的 NSObject 对象
    2. 2.2. 由 Dart Function 创建的 Block 对象
3. 3. 结论
4. 4. Reference
...
### [#Dart-封装的-NSObject-对象](#Dart-封装的-NSObject-对象)Dart 封装的 NSObject 对象
...
### [#由-Dart-Function-创建的-Block-对象](#由-Dart-Function-创建的-Block-对象)由 Dart Function 创建的 Block 对象
