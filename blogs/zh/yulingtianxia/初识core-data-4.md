...
source_url: 'http://yulingtianxia.com/blog/2015/07/25/%E5%88%9D%E8%AF%86Core-Data-4/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:61b4eca66c5a759d'
translated: n/a
---

> 原文：[初识Core Data(4)](http://yulingtianxia.com/blog/2015/07/25/%E5%88%9D%E8%AF%86Core-Data-4/)　·　杨萧玉

# [初识Core Data(4)](http://yulingtianxia.com/blog/2015/07/25/初识Core-Data-4/)
...
1. 1. 批量操作
2. 2. 聚合操作
3. 3. WWDC2015 Core Data 的一些新特性

    1. 3.1. NSManagedObject 新增 API

          1. 3.1.1. hasPersistentChangedValues
          2. 3.1.2. objectIDsForRelationshipNamed
    2. 3.2. NSManagedObjectContext 新增 API

          1. 3.2.1. refreshAllObjects
          2. 3.2.2. mergeChangesFromRemoteContextSave
          3. 3.2.3. shouldDeleteInaccessibleFaults
    3. 3.3. NSPersistentStoreCoordinator 新增 API

          1. 3.3.1. destroyPersistentStoreAtURL
          2. 3.3.2. replacePersistentStoreAtURL
    4. 3.4. Unique Constraints
    5. 3.5. Model Caching
    6. 3.6. Generated Subclasses
...
## [#WWDC2015-Core-Data-的一些新特性](#WWDC2015-Core-Data-的一些新特性)WWDC2015 Core Data 的一些新特性
...
### [#NSManagedObject-新增-API](#NSManagedObject-新增-API)NSManagedObject 新增 API

#### [#hasPersistentChangedValues](#hasPersistentChangedValues)hasPersistentChangedValues
...
#### [#objectIDsForRelationshipNamed](#objectIDsForRelationshipNamed)objectIDsForRelationshipNamed
...
### [#NSManagedObjectContext-新增-API](#NSManagedObjectContext-新增-API)NSManagedObjectContext 新增 API

#### [#refreshAllObjects](#refreshAllObjects)refreshAllObjects
...
#### [#mergeChangesFromRemoteContextSave](#mergeChangesFromRemoteContextSave)mergeChangesFromRemoteContextSave
...
#### [#shouldDeleteInaccessibleFaults](#shouldDeleteInaccessibleFaults)shouldDeleteInaccessibleFaults
...
### [#NSPersistentStoreCoordinator-新增-API](#NSPersistentStoreCoordinator-新增-API)NSPersistentStoreCoordinator 新增 API

增加这两个新的 API 的原因是很多开发者绕过 Core Data 的 API 来直接操作底层数据库文件.因为`NSFileManager` 和 POSIX 对数据库都不友好,并且如果此时文件的 open 连接没关闭的话会损坏文件.

#### [#destroyPersistentStoreAtURL](#destroyPersistentStoreAtURL)destroyPersistentStoreAtURL
...
#### [#replacePersistentStoreAtURL](#replacePersistentStoreAtURL)replacePersistentStoreAtURL
...
### [#Model-Caching](#Model-Caching)Model Caching

这是个轻量级的数据版本自动迁移解决方案.它会缓存旧版本数据中已创建的 `NSManagedObject` 对象会被缓存到 store 中,并被迁移到合适的 store 中.

### [#Generated-Subclasses](#Generated-Subclasses)Generated Subclasses
