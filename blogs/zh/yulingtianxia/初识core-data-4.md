...
1. [1. 批量操作](#批量操作)
2. [2. 聚合操作](#聚合操作)
3. [3. WWDC2015 Core Data 的一些新特性](#WWDC2015-Core-Data-的一些新特性)

    1. [3.1. NSManagedObject 新增 API](#NSManagedObject-新增-API)

          1. [3.1.1. hasPersistentChangedValues](#hasPersistentChangedValues)
          2. [3.1.2. objectIDsForRelationshipNamed](#objectIDsForRelationshipNamed)
    2. [3.2. NSManagedObjectContext 新增 API](#NSManagedObjectContext-新增-API)

          1. [3.2.1. refreshAllObjects](#refreshAllObjects)
          2. [3.2.2. mergeChangesFromRemoteContextSave](#mergeChangesFromRemoteContextSave)
          3. [3.2.3. shouldDeleteInaccessibleFaults](#shouldDeleteInaccessibleFaults)
    3. [3.3. NSPersistentStoreCoordinator 新增 API](#NSPersistentStoreCoordinator-新增-API)

          1. [3.3.1. destroyPersistentStoreAtURL](#destroyPersistentStoreAtURL)
          2. [3.3.2. replacePersistentStoreAtURL](#replacePersistentStoreAtURL)
    4. [3.4. Unique Constraints](#Unique-Constraints)
    5. [3.5. Model Caching](#Model-Caching)
    6. [3.6. Generated Subclasses](#Generated-Subclasses)
