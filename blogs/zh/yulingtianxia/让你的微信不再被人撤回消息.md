...
source_url: 'http://yulingtianxia.com/blog/2016/05/06/Let-your-WeChat-for-Mac-never-revoke-messages/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:ad3e1111c38c353e'
translated: n/a
---

> 原文：[让你的微信不再被人撤回消息](http://yulingtianxia.com/blog/2016/05/06/Let-your-WeChat-for-Mac-never-revoke-messages/)　·　杨萧玉
...
1. 1. 为什么不对 iOS 动刀 Mac 和 iOS 双管齐下
2. 2. 脑洞和胆子都要大
3. 3. iOS 要稍微折腾一些
4. 4. 后记
...
# [#为什么不对-iOS-动刀-Mac-和-iOS-双管齐下](#为什么不对-iOS-动刀-Mac-和-iOS-双管齐下)~~为什么不对 iOS 动刀~~ Mac 和 iOS 双管齐下
...
# [#iOS-要稍微折腾一些](#iOS-要稍微折腾一些)iOS 要稍微折腾一些
