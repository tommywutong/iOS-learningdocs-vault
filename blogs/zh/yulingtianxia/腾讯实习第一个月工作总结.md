...
1. [1. 让 UIAlertController 兼容 iOS7](#让-UIAlertController-兼容-iOS7)
    ...
    4. [1.4. 解决思路](#解决思路)
          ...
          1. [1.4.1. 构建 TBAlertAction 替代 UIAlertAction](#构建-TBAlertAction-替代-UIAlertAction)
          2. [1.4.2. 构建 TBAlertController 属性](#构建-TBAlertController-属性)
          3. [1.4.3. 构建 TBAlertController 方法](#构建-TBAlertController-方法)
          4. [1.4.4. hook presentViewController: 方法](#hook-presentViewController-方法)
          5. [1.4.5. 还需要注意的地方](#还需要注意的地方)
    5. [1.5. 感悟&总结](#感悟-amp-总结)
2. [2. LLDB 调试 UI 的技巧](#LLDB-调试-UI-的技巧)

    1. [2.1. 问题背景](#问题背景-1)
    2. [2.2. 用 LLDB 改变视图](#用-LLDB-改变视图)
    3. [2.3. 使用 Chisel 简化 LLDB 命令](#使用-Chisel-简化-LLDB-命令)
    4. [2.4. 我的实践与感悟](#我的实践与感悟)
3. [3. 项目实践管理经验](#项目实践管理经验)

    1. [3.1. 图片资源管理](#图片资源管理)
    2. [3.2. 文案管理](#文案管理)

          1. [3.2.1. 文案是可复用的](#文案是可复用的)
          2. [3.2.2. 重复的文案在多处 hardcode 会降低效率](#重复的文案在多处-hardcode-会降低效率)
          3. [3.2.3. 我的解决方案：文案与代码分离](#我的解决方案：文案与代码分离)
          4. [3.2.4. 解决方案的分析](#解决方案的分析)
    3. [3.3. project.pbxproj文件](#project-pbxproj文件)
