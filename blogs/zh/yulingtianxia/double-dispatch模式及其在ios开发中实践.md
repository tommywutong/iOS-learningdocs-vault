...
1. [1. 本文内容](#本文内容)
2. [2. 引子](#引子)
3. [3. C++中的Double Dispatch实例](#C-中的Double-Dispatch实例)
4. [4. Java中的Double Dispatch实例](#Java中的Double-Dispatch实例)

    1. [4.1. 1 根据对象来选择行为问题](#1-根据对象来选择行为问题)
    2. [4.2. 2 Double Dispatch Pattern](#2-Double-Dispatch-Pattern)
5. [5. Objective-C中实现碰撞检测用到的Visitor模式](#Objective-C中实现碰撞检测用到的Visitor模式)
