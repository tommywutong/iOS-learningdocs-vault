...
source_url: 'http://yulingtianxia.com/blog/2019/06/19/BlockHook-with-Private-Data/'
original_language: zh
published: 2020-08-22
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:42b5ada325c3a3c2'
translated: n/a
---

> 原文：[BlockHook with Private Data](http://yulingtianxia.com/blog/2019/06/19/BlockHook-with-Private-Data/)　·　杨萧玉
...
1. 1. Block 为何会有 Private Data

    1. 1.1. 特殊的 invoke 函数
    2. 1.2. 获取 Private Data
2. 2. 适配 BlockHook

    1. 2.1. Hook 真正要执行的 Block
    2. 2.2. 获取 Block 当前 Hook Token
3. 3. 总结
...
## [#Block-为何会有-Private-Data](#Block-为何会有-Private-Data)Block 为何会有 Private Data
...
### [#特殊的-invoke-函数](#特殊的-invoke-函数)特殊的 invoke 函数
...
### [#获取-Private-Data](#获取-Private-Data)获取 Private Data
...
## [#适配-BlockHook](#适配-BlockHook)适配 BlockHook
...
### [#Hook-真正要执行的-Block](#Hook-真正要执行的-Block)Hook 真正要执行的 Block
...
### [#获取-Block-当前-Hook-Token](#获取-Block-当前-Hook-Token)获取 Block 当前 Hook Token
...
代码地址: [https://github.com/yulingtianxia/BlockHook](https://github.com/yulingtianxia/BlockHook)
