...
1. [1. Block 为何会有 Private Data](#Block-为何会有-Private-Data)

    1. [1.1. 特殊的 invoke 函数](#特殊的-invoke-函数)
    2. [1.2. 获取 Private Data](#获取-Private-Data)
2. [2. 适配 BlockHook](#适配-BlockHook)

    1. [2.1. Hook 真正要执行的 Block](#Hook-真正要执行的-Block)
    2. [2.2. 获取 Block 当前 Hook Token](#获取-Block-当前-Hook-Token)
3. [3. 总结](#总结)
