...
1. [1. Shader](#Shader)
2. [2. Lighting and Shadows](#Lighting-and-Shadows)
3. [3. New Physics](#New-Physics)

    1. [3.1. Per-Pixel Physics](#Per-Pixel-Physics)
    2. [3.2. Constrains](#Constrains)
    3. [3.3. Inverse Kinematics](#Inverse-Kinematics)
    4. [3.4. Physics Fields](#Physics-Fields)
4. [4. Integration with SceneKit](#Integration-with-SceneKit)
5. [5. Tools](#Tools)
6. [6. Improvements](#Improvements)

    1. [6.1. SKScene](#SKScene)
    2. [6.2. SKTexture](#SKTexture)
    3. [6.3. SKShapeNode](#SKShapeNode)
    4. [6.4. Physics Updates](#Physics-Updates)
    5. [6.5. SKTexture Atlas](#SKTexture-Atlas)
...
- `SKMutableTexture`是`SKTexture`新加的子类，它的内容可以通过`modifyPixelDataWithBlock:`方法动态地修改。
- `SKTexture`现在可以生成“noise textures”，参见`textureVectorNoiseWithSmoothness:size:`和`textureNoiseWithSmoothness:size:grayscale:`
