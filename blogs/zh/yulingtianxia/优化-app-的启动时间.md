...
1. [1. App 运行理论](#App-运行理论)

    1. [1.1. 理论速成](#理论速成)

          1. [1.1.1. Mach-O 术语](#Mach-O-术语)
          2. [1.1.2. Mach-O 镜像文件](#Mach-O-镜像文件)
          3. [1.1.3. Mach-O Universal 文件](#Mach-O-Universal-文件)
          4. [1.1.4. 虚拟内存](#虚拟内存)
          5. [1.1.5. Mach-O 镜像 加载](#Mach-O-镜像-加载)
          6. [1.1.6. 安全](#安全)
    2. [1.2. 从 exec() 到 main()](#从-exec-到-main)
    3. [1.3. dyld 加载 dylib 文件](#dyld-加载-dylib-文件)

          1. [1.3.1. 加载 Dylib](#加载-Dylib)
          2. [1.3.2. Fix-ups](#Fix-ups)
          3. [1.3.3. Rebasing 和 Binding](#Rebasing-和-Binding)
          4. [1.3.4. Rebasing](#Rebasing)
          5. [1.3.5. Binding](#Binding)
          6. [1.3.6. ObjC Runtime](#ObjC-Runtime)
          7. [1.3.7. Initializers](#Initializers)
2. [2. 改善启动时间](#改善启动时间)

    1. [2.1. 测量启动时间](#测量启动时间)
    2. [2.2. 优化启动时间](#优化启动时间)

          1. [2.2.1. 加载 Dylib](#加载-Dylib-1)
          2. [2.2.2. Rebase/Binding](#Rebase-Binding)
          3. [2.2.3. ObjC Setup](#ObjC-Setup)
          4. [2.2.4. Initializer](#Initializer)
