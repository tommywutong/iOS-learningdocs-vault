...
source_url: 'http://yulingtianxia.com/blog/2014/06/16/swiftzhong-zai-yun-suan-fu/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:7bf9845989fd1c02'
translated: n/a
---

> 原文：[Swift重载和自定义运算符](http://yulingtianxia.com/blog/2014/06/16/swiftzhong-zai-yun-suan-fu/)　·　杨萧玉
...
### [#前缀和后缀运算符的重载](#前缀和后缀运算符的重载)前缀和后缀运算符的重载
...
### [#组合赋值运算符的重载](#组合赋值运算符的重载)组合赋值运算符的重载
