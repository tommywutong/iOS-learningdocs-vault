...
source_url: 'http://yulingtianxia.com/blog/2015/04/06/Communication-between-your-App-and-Extensions/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:62aa5cd6830b654e'
translated: n/a
---

> 原文：[App与Extensions间通信共享数据](http://yulingtianxia.com/blog/2015/04/06/Communication-between-your-App-and-Extensions/)　·　杨萧玉

# [App与Extensions间通信共享数据](http://yulingtianxia.com/blog/2015/04/06/Communication-between-your-App-and-Extensions/)

By [杨萧玉](https://plus.google.com/106642427004837273341?rel=author)

发表于 2015-04-06

1. 1. App Groups & Framework
2. 2. Container app 与 Extension的通信

    1. 2.1. CFNotificationCenterGetDarwinNotifyCenter
    2. 2.2. MMWormhole
    3. 2.3. Swift与CoreFoundation
    4. 2.4. 在Framework中混编OC
3. 3. 总结
...
## [#App-Groups-amp-Framework](#App-Groups-amp-Framework)App Groups & Framework
...
## [#Container-app-与-Extension的通信](#Container-app-与-Extension的通信)Container app 与 Extension的通信
...
### [#CFNotificationCenterGetDarwinNotifyCenter](#CFNotificationCenterGetDarwinNotifyCenter)CFNotificationCenterGetDarwinNotifyCenter
...
### [#MMWormhole](#MMWormhole)MMWormhole
...
### [#Swift与CoreFoundation](#Swift与CoreFoundation)Swift与CoreFoundation
...
3. ，Type就是函数的类型，但还不允许你将Swift写的函数或闭包转化成

  ，也就是干脆没提供建立

  实例的方法，只能通过外部引入C的函数。这就涉及到了Swift与OC混编，请戳

  Swift and Objective-C in the Same Project

### [#在Framework中混编OC](#在Framework中混编OC)在Framework中混编OC
