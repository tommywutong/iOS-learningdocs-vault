...
source_url: 'http://yulingtianxia.com/blog/2014/07/17/a-ios-game-developed-by-swift-and-spritekit/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:76c21809bedf2326'
translated: n/a
---

> 原文：[用Swift和SpriteKit开发iOS游戏](http://yulingtianxia.com/blog/2014/07/17/a-ios-game-developed-by-swift-and-spritekit/)　·　杨萧玉

# [用Swift和SpriteKit开发iOS游戏](http://yulingtianxia.com/blog/2014/07/17/a-ios-game-developed-by-swift-and-spritekit/)
...
![](http://yulingtianxia.com/resources/140557437844.gif)
...
## [#绘制基本界面](#绘制基本界面)绘制基本界面

这部分的工作主要是绘制出螺旋线作为地图，并让四种精灵节点动起来。

### [#螺旋线的绘制](#螺旋线的绘制)螺旋线的绘制
...
## [#Swift中用访问者模式处理碰撞](#Swift中用访问者模式处理碰撞)Swift中用访问者模式处理碰撞
...
## [#按钮的绘制和截图分享](#按钮的绘制和截图分享)按钮的绘制和截图分享
