...
2. [2. MVVM](#MVVM)
    ...
    1. [2.1. 定义 MVVM](#定义-MVVM)
    2. [2.2. 关于 view-model 的更多内容](#关于-view-model-的更多内容)
3. [3. MVC 世界中的 MVVM](#MVC-世界中的-MVVM)
4. [4. View-Model 和 View Controller, 在一起，但独立](#View-Model-和-View-Controller-在一起，但独立)

    1. [4.1. View-Model 实例](#View-Model-实例)

          1. [4.1.1. view-model 不做的事儿](#view-model-不做的事儿)
    2. [4.2. View Controller(视图控制器)](#View-Controller-视图控制器)

          1. [4.2.1. 视图控制器从 view-model 获取的数据将用来:](#视图控制器从-view-model-获取的数据将用来)
          2. [4.2.2. 视图控制器将对 view-model 起如下作用:](#视图控制器将对-view-model-起如下作用)
          3. [4.2.3. 视图控制器不做的事儿:](#视图控制器不做的事儿)
5. [5. 子 View-Model](#子-View-Model)

    1. [5.1. View-Model 从哪来?](#View-Model-从哪来)

          1. [5.1.1. View-Model 产生 View-Model](#View-Model-产生-View-Model)
          2. [5.1.2. View-Model 列表](#View-Model-列表)
6. [6. Functional Core, Imperative Shell](#Functional-Core-Imperative-Shell)

    1. [6.1. Functional Core](#Functional-Core)
    2. [6.2. Imperative (Declarative?) Shell](#Imperative-Declarative-Shell)
    3. [6.3. 可测试的核心](#可测试的核心)
7. [7. 连接一切](#连接一切)
8. [8. 进入 ReactiveCocoa](#进入-ReactiveCocoa)

    1. [8.1. RACSignal](#RACSignal)

          1. [8.1.1. 那么什么是信号呢?这是一个信号:](#那么什么是信号呢-这是一个信号)
          2. [8.1.2. 信号发送的值是从哪获得的?](#信号发送的值是从哪获得的)
          3. [8.1.3. 什么是订阅者?](#什么是订阅者)
          4. [8.1.4. 转换数据流](#转换数据流)
    2. [8.2. 多个订阅者, 副作用, 昂贵的操作](#多个订阅者-副作用-昂贵的操作)
9. [9. Tweetboat Plus](#Tweetboat-Plus)

    1. [9.0.1. 福利-消除更多的状态](#福利-消除更多的状态)
