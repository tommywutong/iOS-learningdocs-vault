...
source_url: 'http://yulingtianxia.com/blog/2014/06/17/swiftzhong-de-arc/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:93972381d9f22315'
translated: n/a
---

> 原文：[Swift中的ARC](http://yulingtianxia.com/blog/2014/06/17/swiftzhong-de-arc/)　·　杨萧玉

# [Swift中的ARC](http://yulingtianxia.com/blog/2014/06/17/swiftzhong-de-arc/)
...
## [#类实例之间强引用循环的产生](#类实例之间强引用循环的产生)类实例之间强引用循环的产生
...
## [#如何解决实例间强引用循环](#如何解决实例间强引用循环)如何解决实例间强引用循环
...
### [#无主引用以及隐式解析可选属性](#无主引用以及隐式解析可选属性)无主引用以及隐式解析可选属性
...
## [#闭包引起的强引用循环](#闭包引起的强引用循环)闭包引起的强引用循环
...
## [#解决闭包引起的循环强引用](#解决闭包引起的循环强引用)解决闭包引起的循环强引用

Swift 提供了一种优雅的方法来解决这个问题，称之为闭包捕获列表（closuer capture list）

### [#定义捕获列表](#定义捕获列表)定义捕获列表
...
### [#捕获列表中的弱引用和无主引用](#捕获列表中的弱引用和无主引用)捕获列表中的弱引用和无主引用
