...
1. [1. 简介](#简介)
2. [2. 类实例之间强引用循环的产生](#类实例之间强引用循环的产生)
3. [3. 如何解决实例间强引用循环](#如何解决实例间强引用循环)

    1. [3.1. 弱引用](#弱引用)
    2. [3.2. 无主引用](#无主引用)
    3. [3.3. 无主引用以及隐式解析可选属性](#无主引用以及隐式解析可选属性)
    4. [3.4. 总结](#总结)
4. [4. 闭包引起的强引用循环](#闭包引起的强引用循环)
5. [5. 解决闭包引起的循环强引用](#解决闭包引起的循环强引用)

    1. [5.1. 定义捕获列表](#定义捕获列表)
    2. [5.2. 捕获列表中的弱引用和无主引用](#捕获列表中的弱引用和无主引用)
