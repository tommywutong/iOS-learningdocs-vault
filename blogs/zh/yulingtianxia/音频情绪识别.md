...
source_url: 'http://yulingtianxia.com/blog/2019/03/30/Audio-Emotion-Recognition/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:d10adb65aee6a015'
translated: n/a
---

> 原文：[音频情绪识别](http://yulingtianxia.com/blog/2019/03/30/Audio-Emotion-Recognition/)　·　杨萧玉
...
1. 1. Dataset
2. 2. Turicreate Sound Classifier

    1. 2.1. 加载音频文件
    2. 2.2. 自定义神经网络
    3. 2.3. 部署到 Core ML
3. 3. Put features to Keras
4. 4. Reference
...
Python 工程和 iOS Sample 开源在 GitHub 上了：[https://github.com/yulingtianxia/AudioEmotion](https://github.com/yulingtianxia/AudioEmotion)
...
## [#Turicreate-Sound-Classifier](#Turicreate-Sound-Classifier)Turicreate Sound Classifier
...
### [#部署到-Core-ML](#部署到-Core-ML)部署到 Core ML
...
## [#Put-features-to-Keras](#Put-features-to-Keras)Put features to Keras
