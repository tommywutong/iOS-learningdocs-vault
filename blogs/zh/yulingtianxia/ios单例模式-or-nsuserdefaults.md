...
source_url: 'http://yulingtianxia.com/blog/2014/04/07/iosdan-li-mo-shi-ornsuserdefaults/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:041891c54b15d60e'
translated: n/a
---

> 原文：[iOS单例模式 or NSUserDefaults](http://yulingtianxia.com/blog/2014/04/07/iosdan-li-mo-shi-ornsuserdefaults/)　·　杨萧玉
...
1. 1. iOS的单例模式
2. 2. NSUserDefaults
3. 3. 总结：iOS单例模式 and NSUserDefaults
...
# [#NSUserDefaults](#NSUserDefaults)NSUserDefaults
...
# [#总结：iOS单例模式-and-NSUserDefaults](#总结：iOS单例模式-and-NSUserDefaults)总结：iOS单例模式 and NSUserDefaults
