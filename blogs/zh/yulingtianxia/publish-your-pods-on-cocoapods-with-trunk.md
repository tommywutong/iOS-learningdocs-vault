...
source_url: 'http://yulingtianxia.com/blog/2014/05/26/publish-your-pods-on-cocoapods-with-trunk/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:e8b7077b8cf2e6e5'
translated: n/a
---

> 原文：[Publish Your Pods on CocoaPods with Trunk](http://yulingtianxia.com/blog/2014/05/26/publish-your-pods-on-cocoapods-with-trunk/)　·　杨萧玉
...
2014年5月20日，CocoaPods不再接受向[CocoaPods/Specs](http://yulingtianxia.com/blog/2014/05/26/publish-your-pods-on-cocoapods-with-trunk/git@github.com:CocoaPods/Specs.git)的pull request，官方的说法是为了安全考虑，防止每个人的pod被其他人修改，于是CocoaPods团队开发了trunk服务，这样每个人都是其发布的pod的owner，没有权限的人无法修改，这样更安全。
...
这里给出一个官方的介绍链接：[http://blog.cocoapods.org/CocoaPods-Trunk/#transition](http://blog.cocoapods.org/CocoaPods-Trunk/#transition)
...
就像文章最开始的架构图描述的那样，你在trunk中的操作依然会在[CocoaPods/Specs](http://yulingtianxia.com/blog/2014/05/26/publish-your-pods-on-cocoapods-with-trunk/git@github.com:CocoaPods/Specs.git)仓库中更新。以后再做更改时只需要更新版本号然后通过trunk来提交，不用向[CocoaPods/Specs](http://yulingtianxia.com/blog/2014/05/26/publish-your-pods-on-cocoapods-with-trunk/git@github.com:CocoaPods/Specs.git)pull request并等待审核和merge了。
...
## [#将其他人加入到你的Pod](#将其他人加入到你的Pod)将其他人加入到你的Pod
