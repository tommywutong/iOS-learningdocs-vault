...
source_url: 'http://yulingtianxia.com/blog/2020/06/25/Codegen-for-DartNative/'
original_language: zh
published: 2020-11-07
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:efdecf2ef9fc4c65'
translated: n/a
---

> 原文：[告别 Flutter Channel，调用 Native API 仅需一行代码！](http://yulingtianxia.com/blog/2020/06/25/Codegen-for-DartNative/)　·　杨萧玉
...
## [#DartNative-整体解决方案-amp-展望](#DartNative-整体解决方案-amp-展望)DartNative 整体解决方案&展望

1. : 自研超级通道，性能甩开官方 Flutter Channel 好几倍，支持 Native 绝大部分类型
2. : 将 Native API 转为 Dart API，可在 Flutter 工程中直接调用
3. : 各平台 API 终究是有差异的，且只能靠开发者手动抹平。通过分发机制为开发者提供一个抹平平台差异代码的地方。
4. ：基于 DartNative 的开源组件市场，未来会有越来越多的 Native 组件通过 DartNative 转为 Flutter 组件。
...
1. DartNative
  ...
  开源后陆陆续续出现了一些相同 idea 的项目，但都没有走我这条最艰难的路。不仅技术有难度，设计方案也要反复推翻，打磨，优化。。。做新的解决方案就是很漫长，我最然做的很早，但是战线拉得太长。
...
## [#Codegen-的用法](#Codegen-的用法)Codegen 的用法
