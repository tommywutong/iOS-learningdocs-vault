...
source_url: 'http://yulingtianxia.com/blog/2016/08/29/Some-Experience-of-Gesture/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:24a00c19bca163a7'
translated: n/a
---

> 原文：[处理手势冲突和错乱的一点经验](http://yulingtianxia.com/blog/2016/08/29/Some-Experience-of-Gesture/)　·　杨萧玉
...
2. 2. 处理界面复杂引发的手势错乱
    ...
    3. 2.3. 解决问题
          ...
          1. 2.3.1. 处理 Pinch 手势
                  ...
                  1. 2.3.1.1. 分辨率
                  2. 2.3.1.2. 坐标
          2. 2.3.2. 处理 Rotation 手势
3. 3. 总结
4. 4. Reference

如果一个页面上包含着很多视图，而且界面上业务逻辑比较复杂，那么手势响应冲突或者错乱很容易发生。这时就得猥琐点啦，见招拆招。

## [#处理界面多变引发的手势冲突](#处理界面多变引发的手势冲突)处理界面多变引发的手势冲突
...
### [#使用状态机的构想方案](#使用状态机的构想方案)使用状态机的构想方案
...
## [#处理界面复杂引发的手势错乱](#处理界面复杂引发的手势错乱)处理界面复杂引发的手势错乱
...
#### [#对手势统一处理和分发](#对手势统一处理和分发)对手势统一处理和分发
...
#### [#处理-Pinch-手势](#处理-Pinch-手势)处理 Pinch 手势
...
#### [#处理-Rotation-手势](#处理-Rotation-手势)处理 Rotation 手势
...
[http://stackoverflow.com/questions/5927223/scaling-uitextview-using-contentscalefactor-property](http://stackoverflow.com/questions/5927223/scaling-uitextview-using-contentscalefactor-property)
