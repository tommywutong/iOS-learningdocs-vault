...
1. [1. 处理界面多变引发的手势冲突](#处理界面多变引发的手势冲突)

    1. [1.1. 分析问题](#分析问题)
    2. [1.2. 使用状态机的构想方案](#使用状态机的构想方案)
2. [2. 处理界面复杂引发的手势错乱](#处理界面复杂引发的手势错乱)

    1. [2.1. 情景还原](#情景还原)
    2. [2.2. 分析问题](#分析问题-1)

          1. [2.2.1. 对手势统一处理和分发](#对手势统一处理和分发)
          2. [2.2.2. 计算响应手势的视图](#计算响应手势的视图)
    3. [2.3. 解决问题](#解决问题)

          1. [2.3.1. 处理 Pinch 手势](#处理-Pinch-手势)

                  1. [2.3.1.1. 分辨率](#分辨率)
                  2. [2.3.1.2. 坐标](#坐标)
          2. [2.3.2. 处理 Rotation 手势](#处理-Rotation-手势)
3. [3. 总结](#总结)
