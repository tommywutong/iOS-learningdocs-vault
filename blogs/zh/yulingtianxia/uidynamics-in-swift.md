...
1. [1. 魁首：UIDynamicAnimator](#魁首：UIDynamicAnimator)
2. [2. 最简单的行为：UIGravityBehavior](#最简单的行为：UIGravityBehavior)
3. [3. 反弹的墙壁：UICollisionBehavior](#反弹的墙壁：UICollisionBehavior)
4. [4. Core Motion](#Core-Motion)
5. [5. 其他的行为](#其他的行为)
