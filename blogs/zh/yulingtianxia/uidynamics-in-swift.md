...
source_url: 'http://yulingtianxia.com/blog/2015/03/01/UIDynamics-in-Swift/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:3c6b401c10c2cdef'
translated: n/a
---

> 原文：[UIDynamics in Swift](http://yulingtianxia.com/blog/2015/03/01/UIDynamics-in-Swift/)　·　杨萧玉

# [UIDynamics in Swift](http://yulingtianxia.com/blog/2015/03/01/UIDynamics-in-Swift/)

By [杨萧玉](https://plus.google.com/106642427004837273341?rel=author)

发表于 2015-03-01

1. 1. 魁首：UIDynamicAnimator
2. 2. 最简单的行为：UIGravityBehavior
3. 3. 反弹的墙壁：UICollisionBehavior
4. 4. Core Motion
5. 5. 其他的行为
...
## [#魁首：UIDynamicAnimator](#魁首：UIDynamicAnimator)魁首：UIDynamicAnimator
...
## [#最简单的行为：UIGravityBehavior](#最简单的行为：UIGravityBehavior)最简单的行为：UIGravityBehavior
...
## [#反弹的墙壁：UICollisionBehavior](#反弹的墙壁：UICollisionBehavior)反弹的墙壁：UICollisionBehavior
...
## [#Core-Motion](#Core-Motion)Core Motion
