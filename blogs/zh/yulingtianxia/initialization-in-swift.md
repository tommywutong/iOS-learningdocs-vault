...
source_url: 'http://yulingtianxia.com/blog/2014/06/24/initialization-in-swift/'
original_language: zh
published: 2019-05-26
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:02f6604cd2d041c2'
translated: n/a
---

> 原文：[Initialization in Swift](http://yulingtianxia.com/blog/2014/06/24/initialization-in-swift/)　·　杨萧玉

# [Initialization in Swift](http://yulingtianxia.com/blog/2014/06/24/initialization-in-swift/)
...
5. 5. 类的继承和构造过程
    ...
    3. 5.3. 两段式构造过程
    4. 5.4. 构造器的继承和重载
6. 6. 可失败构造器(Failable Initializers)

    1. 6.1. 枚举的可失败构造器
    2. 6.2. 带有原始值枚举的可失败构造器
    3. 6.3. 类的可失败构造器
    4. 6.4. 可失败构造器的传播
    5. 6.5. 可失败构造器的重载
    6. 6.6. init!可失败构造器
7. 7. 必需构造器(Required Initializers)
8. 8. 通过闭包和函数来设置属性的默认值
...
## [#可失败构造器-Failable-Initializers](#可失败构造器-Failable-Initializers)可失败构造器(Failable Initializers)
...
### [#带有原始值枚举的可失败构造器](#带有原始值枚举的可失败构造器)带有原始值枚举的可失败构造器
...
### [#init-可失败构造器](#init-可失败构造器)init!可失败构造器
...
## [#必需构造器-Required-Initializers](#必需构造器-Required-Initializers)必需构造器(Required Initializers)
...
## [#通过闭包和函数来设置属性的默认值](#通过闭包和函数来设置属性的默认值)通过闭包和函数来设置属性的默认值
