...
source_url: 'https://halfrost.com/ios_block/'
source_domain: halfrost.com
source_group: single-site
original_language: zh
published: 2016-08-27
archived_at: 2026-07-27
content_hash: 'sha256:af523dc4cf91d162'
plan_ref: 第二周：weak、属性关键字与 Block / Day 4｜在结构体基础上研究捕获与复制（对应 W2-10、W2-11）
plan_week: 第二周：weak、属性关键字与 Block
plan_day: Day 4｜在结构体基础上研究捕获与复制（对应 W2-10、W2-11）
container: '//*[contains(@class,''post-content'')]'
container_source: guess
---

> 原文：[深入研究 Block 捕获外部变量和 __block 实现原理](https://halfrost.com/ios_block/)
...
这里就有2点需要弄清楚了  
 1.为什么在 Block 里面不加 __block 不允许更改变量？  
 2.为什么自动变量的值没有增加，而其他几个变量的值是增加的？自动变量是什么状态下被 block 捕获进去的？

为了弄清楚这2点，我们用 clang 转换一下源码出来分析分析。
...
根据[官方文档](https://halfrost.com/ios_block/developer.apple.com/library/ios/documentation/Cocoa/Conceptual/Blocks/Articles/bxVariables.html#//apple_ref/doc/uid/TP40007502-CH6-SW1)我们可以了解到，苹果要求我们在自动变量前加入 **__block**关键字(__block storage-class-specifier存储域类说明符)，就可以在Block里面改变外部自动变量的值了。
