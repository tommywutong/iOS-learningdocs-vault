...
source_domain: javaguide.cn
source_group: single-site
original_language: zh
published: 2026-06-14
archived_at: 2026-07-27
content_hash: 'sha256:a8af5c73ab28d056'
...
> 原文：[TCP 三次握手和四次挥手（传输层）](https://javaguide.cn/cs-basics/network/tcp-connection-and-disconnection.html)
...
#### [1. 确认双方收发能力，并同步初始序列号](#_1-确认双方收发能力-并同步初始序列号)
...
#### [2. 防止已失效的连接请求被错误建立](#_2-防止已失效的连接请求被错误建立)
...
### [第 2 次握手已经传回 ACK，为什么还要传回 SYN？](#第-2-次握手已经传回-ack-为什么还要传回-syn)
...
### [为什么通常不能把服务端发送的 ACK 和 FIN 合并起来，变成三次挥手？](#为什么通常不能把服务端发送的-ack-和-fin-合并起来-变成三次挥手)
...
### [CLOSE_WAIT 为什么会堆积？](#close-wait-为什么会堆积)
...
### [如果第二次挥手时服务端的 ACK 没有送达客户端，会怎样？](#如果第二次挥手时服务端的-ack-没有送达客户端-会怎样)
...
### [为什么第四次挥手后要等待 2MSL？](#为什么第四次挥手后要等待-2msl)
...
## [TIME_WAIT 常见问题：为什么要等、会不会出问题、能不能复用？](#time-wait-常见问题-为什么要等、会不会出问题、能不能复用)
...
- RFC 1122: Requirements for Internet Hosts - Communication Layers：[https://www.rfc-editor.org/rfc/rfc1122](https://www.rfc-editor.org/rfc/rfc1122)
...
- tcp(7) - Linux manual page：[https://www.man7.org/linux/man-pages/man7/tcp.7.html](https://www.man7.org/linux/man-pages/man7/tcp.7.html)
...
- Linux 内核 `include/net/tcp.h`：[https://codebrowser.dev/linux/linux/include/net/tcp.h.html](https://codebrowser.dev/linux/linux/include/net/tcp.h.html)
