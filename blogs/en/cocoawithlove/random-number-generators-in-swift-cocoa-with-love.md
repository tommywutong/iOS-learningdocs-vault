...
- – 64 bit integers generated with
- – data read from /dev/urandom
- – a 3 register linear-feedback shift register with period
- – a 5 register linear-feedback shift register with period
- – a Swift implementation of MT19937_64
- – the Mersenne Twister as generated by

  mt19937-64.c

  by Takuji Nishimura and Makoto Matsumoto.
- – 64-bit integers generated by this custom xor/shift generator
- – the
...
- – baseline that returns a constant 64-bit number
