...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/16-swift/swift-functions'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:dea186044995c2fa'
translated: false
---

> 原文：[The Many Faces of Swift Functions](https://www.objc.io/issues/16-swift/swift-functions)　·　objc.io
...
In Swift, there is a concept of an _external parameter name_ to clarify this confusion:
...
When encapsulated in a class (or struct or enum), the first parameter name of a method is _not_ included externally, while all following parameter names are included externally when the method is called:
...
Another note about variadic parameters: the variadic parameter must be the _last_ parameter in your function's parameter list!
