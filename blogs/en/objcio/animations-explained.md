...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/12-animations/animations-explained'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:8c19bd5a533f60a5'
translated: false
---

> 原文：[Animations Explained](https://www.objc.io/issues/12-animations/animations-explained)　·　objc.io
...
Instead, Core Animation maintains two parallel layer hierarchies: the _model layer tree_ and the _presentation layer tree_. ^[1](#fnref1) Layers in the former reflect the well-known state of the layers, whereas only layers in the latter approximate the in-flight values of animations.
...
![](https://www.objc.io/images/issue-12/rocket-linear@2x_7374a30.gif)
...
![](https://www.objc.io/images/issue-12/lerp_95dfd78.png)
...
![](https://www.objc.io/images/issue-12/form_5deac21.gif)
...
Setting the `keyTimes` property allows us to specify at which point in time the keyframes occur. They are specified as fractions of the total duration of the keyframe animation. ^[2](#fnref2)
...
![](https://www.objc.io/images/issue-12/planets_f3b515a.gif)
...
![](https://www.objc.io/images/issue-12/planets-incorrect_c611265.gif)

You can achieve a couple of interesting effects using animations with paths; fellow objc.io author [Ole Begemann](https://twitter.com/olebegemann) wrote [a great post](http://oleb.net/blog/2010/12/animating-drawing-of-cgpath-with-cashapelayer) about how you can combine path-based animations with `CAShapeLayer` to create cool drawing animations with only a couple of lines of code.
...
![](https://www.objc.io/images/issue-12/lerp-with-easing_65cdc94.png)

The simplest easing function is _linear_. It maintains a constant speed throughout the animation and is effectively what we see above. In Core Animation, this function is represented by the `CAMediaTimingFunction` class:

![](https://www.objc.io/images/issue-12/rect-linear@2x_be30464.gif)
...
- Ease in (`kCAMediaTimingFunctionEaseIn`):   
  ![](https://www.objc.io/images/issue-12/rect-easein@2x_0ebfcb9.gif)
- Ease out (`kCAMediaTimingFunctionEaseOut`):   
  ![](https://www.objc.io/images/issue-12/rect-easeout@2x_264875a.gif)
- Ease in ease out (`kCAMediaTimingFunctionEaseInEaseOut`):   
  ![](https://www.objc.io/images/issue-12/rect-easeineaseout@2x_dacae1f.gif)
- Default (`kCAMediaTimingFunctionDefault`):   
  ![](https://www.objc.io/images/issue-12/rect-default@2x_9fb331c.gif)

It's also possible, within limits, to create your own easing function using `+functionWithControlPoints::::`. ^[3](#fnref3) By passing in the _x_ and _y_ components of two control points of a cubic Bézier curve, you can easily create custom easing functions, such as the one I chose for our little red rocket:

![](https://www.objc.io/images/issue-12/rocket-custom@2x_831b9fa.gif)
...
![](https://www.objc.io/images/issue-12/bezier_420b242.png)
...
![](https://www.objc.io/images/issue-12/bounce@2x_9fc60d7.gif)
...
![](https://www.objc.io/images/issue-12/covers_e9fb9d4.gif)
...
Facebook recently made [Pop](https://github.com/facebook/pop), the animation engine that powers Paper, open source. Conceptually, it sits somewhere between Core Animation and UIKit Dynamics. It makes prominent use of spring animations, and target values can be manipulated while the animation is running, without having to replace it. It's also available on OS X and allows us to animate arbitrary properties on every `NSObject` subclass.
...
1. There is actually a third layer tree called the _rendering tree_. Since it's private to Core Animation, we won't cover it here. [↩](#fnref-rev1)
2. Note how I chose different values for transitions from 0 to 30 and from 30 to -30 to maintain a constant velocity. [↩](#fnref-rev2)
3. This method is infamous for having three nameless parameters, not something that we recommend you make use of in your APIs. [↩](#fnref-rev3)
