...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/23-video/videotoolbox'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:4990231da90c099f'
translated: false
---

> 原文：[Video Toolbox and Hardware Acceleration](https://www.objc.io/issues/23-video/videotoolbox)　·　objc.io
...
![](https://www.objc.io/images/issue-23/qt1_1_c36adae.gif) [Image source](http://www.emaculation.com/forum/viewtopic.php?t=5060)
...
Apple never exposed a public API, so DVD playback was limited to its own application until the introduction of Mac OS X in 2001, which initially did not include a DVD playback application at all. ^[1](#fnref2)
...
1. DVD Player as we know it was introduced in OS X 10.1. Until then, third-party tools like VLC media player were the only playback option for DVDs on OS X. [↩](#fnref-rev2)
2. Sorenson Spark, On2 TrueMotion VP6 [↩](#fnref-rev3)
3. `kVDADecoderHardwareNotSupportedErr`, `kVDADecoderFormatNotSupportedErr`, `kVDADecoderConfigurationError`, `kVDADecoderDecoderFailedErr` [↩](#fnref-rev4)
4. Apple published a job description for a management position in HEVC development in summer 2013. [↩](#fnref-rev5)
5. Namely the `kCMFormatDescriptionExtension_SampleDescriptionExtensionAtoms` _ESDS_ or respectively _avcC_. [↩](#fnref-rev6)
6. Remember, "memcpy is murder." Mans Rullgard, Embedded Linux Conference 2013, [http://free-electrons.com/blog/elc-2013-videos/](http://free-electrons.com/blog/elc-2013-videos/) [↩](#fnref-rev7)
