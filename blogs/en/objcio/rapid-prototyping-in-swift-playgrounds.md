...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/16-swift/rapid-prototyping-in-swift-playgrounds'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:a535ef1dff756f2c'
translated: false
---

> 原文：[Rapid Prototyping in Swift Playgrounds](https://www.objc.io/issues/16-swift/rapid-prototyping-in-swift-playgrounds)　·　objc.io
...
> The Playground will almost certainly have an impact on how we TDD. I think we’ll go faster, by using Playground’s ability to show us quickly what we can do. But will we go _better_, with the same solid scaffolding of tests that we’re used to with TDD? Or will we take a hit in quality, either through defects or less refactoring?
...
![](https://www.objc.io/images/issue-16/Sine1_c01aba9.png)
...
![](https://www.objc.io/images/issue-16/Sine2_99d43b3.png)
...
![](https://www.objc.io/images/issue-16/SineCombined_3ccd0fd.png)
...
![](https://www.objc.io/images/issue-16/FFT12_a0a180c.png)

And they look like this for the combined sine wave:

![](https://www.objc.io/images/issue-16/FFTCombined_4b39cfa.png)
