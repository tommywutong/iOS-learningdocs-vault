...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/11-android/sqlite-database-support-in-android'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:7402709b37089e0c'
translated: false
---

> 原文：[SQLite Database Support in Android](https://www.objc.io/issues/11-android/sqlite-database-support-in-android)　·　objc.io
