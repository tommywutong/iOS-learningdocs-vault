...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/3-views/custom-controls'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:2ac31198e759931d'
translated: false
---

> 原文：[Custom Controls](https://www.objc.io/issues/3-views/custom-controls)　·　objc.io
...
A common misconception is that this area is defined by the view's frame. In reality, the frame is actually a property that is derived, most notably from the combination of center and bounds. When not doing Auto Layout, most people use the frame to position and size the view. Be warned, because [the documentation](https://developer.apple.com/library/ios/#documentation/UIKit/Reference/UIView_Class/UIView/UIView.html#//apple_ref/occ/instp/UIView/frame) spells out a caveat:
...
Now, let's move on to the visual bit: custom rendering. As Daniel mentioned in [his article](https://www.objc.io/issue-3/moving-pixels-onto-the-screen.html), you probably want to avoid doing rendering on the CPU, but instead offload it to the GPU. There is one rule of thumb to achieve this: try to avoid `drawRect:`, and instead compose your custom views out of existing views.
...
![](https://www.objc.io/images/issue-3/issue-3-rounded-corners@2x_6232653.png)
