...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/11-android/android_101_for_ios_developers'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:0082d9ed124d2d1b'
translated: false
---

> 原文：[Android 101 for iOS Developers](https://www.objc.io/issues/11-android/android_101_for_ios_developers)　·　objc.io

As the mobile software industry evolves, it is becoming increasingly impractical to target only iOS for a mobile product. Android market share is approaching 80 percent for smartphones, ^[1](#fnref1) and the number of potential users that it can bring to a product can hardly be ignored.
...
Tablets are a great fragment use case example: you can place a list fragment on the left and a detail fragment on the right. ^[4](#fnref4) Fragments allow you to break up your UI and controller logic into smaller, reusable chunks. But beware! The fragment lifecycle, detailed below, is more nuanced.

![](https://www.objc.io/images/issue-11/multipane_view_tablet_1088585.png)

Fragments are the new way of structuring apps on Android, just like `UICollectionView` is the new way of structuring list data instead of `UITableview` for iOS. ^[5](#fnref5) While it is initially easier to avoid using fragments and instead use nothing but activities, you could regret this decision later on. That said, resist the urge to give up on activities entirely by swapping fragments on a single activity -- this can leave you in a bind when wanting to take advantage of intents and using multiple fragments on the same activity.
...
![](https://www.objc.io/images/issue-11/IMG_0095_9bc0f2c.PNG)
...
![](https://www.objc.io/images/issue-11/Screenshot_2014-03-25-11-42-16_d14e7ea.png)
...
![](https://www.objc.io/images/issue-11/Android-Activity-Lifecycle_a11b7b4.png)
...
![](https://www.objc.io/images/issue-11/fragment_lifecycle_a94a933.png)
...
![](https://www.objc.io/images/issue-11/Screenshot_2014-03-24-13-12-00_84117d4.png)
...
![](https://www.objc.io/images/issue-11/iOS_Screen1_e9c81f5.png)

![](https://www.objc.io/images/issue-11/iOSConstraints_5cff261.png)
...
See the the [responsive android applications](https://www.objc.io/issues/11-android/responsive-android-applications/) article for more tips on this.
...
1. Source: [http://www.prnewswire.com/news-releases/strategy-analytics-android-captures-79-percent-share-of-global-smartphone-shipments-in-2013-242563381.html](http://www.prnewswire.com/news-releases/strategy-analytics-android-captures-79-percent-share-of-global-smartphone-shipments-in-2013-242563381.html) [↩](#fnref-rev1)
2. See Google's documentation for supporting multiple screen sizes [here](http://developer.android.com/guide/practices/screens_support.html). [↩](#fnref-rev2)
3. [Intents documentation](http://developer.android.com/reference/android/content/Intent.html) [↩](#fnref-rev3)
4. See Google's documentation for [multi-pane tablet view](http://developer.android.com/design/patterns/multi-pane-layouts.html) for more information. [↩](#fnref-rev4)
5. Thanks, [NSHipster](http://nshipster.com/uicollectionview/). [↩](#fnref-rev5)
