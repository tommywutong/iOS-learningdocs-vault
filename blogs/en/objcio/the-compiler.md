...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/6-build-tools/compiler'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:892776705d86cd7f'
translated: false
---

> 原文：[The Compiler](https://www.objc.io/issues/6-build-tools/compiler)　·　objc.io
...
In this article, we'll focus on phases one and two. In [Mach-O Executables](https://www.objc.io/issue-6/mach-o-executables.html), Daniel explains phases three and four.
