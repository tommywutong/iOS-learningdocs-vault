...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/19-debugging/lldb-debugging'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:7cf71376071fbd88'
translated: false
---

> 原文：[Dancing in the Debugger — A Waltz with LLDB](https://www.objc.io/issues/19-debugging/lldb-debugging)　·　objc.io
...
![](https://www.objc.io/images/issue-19/Image_2014-11-20_at_10.01.46_PM_b33a671.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-20_at_10.09.38_PM_ccd9e8d.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-20_at_10.15.01_PM_c5deafe.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_10.37.45_AM_13d89bd.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_10.53.52_AM_ac1689f.png)
...
Xcode offers a bunch of tools for creating and manipulating breakpoints. We'll go through each and describe the equivalent commands in LLDB that would create the same breakpoint (yes, you can add breakpoints from _inside_ the debugger).
...
![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_11.38.24_AM_e9e38e8.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_11.52.50_AM_b444d4e.png)

Then choose the third option:

![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_11.54.44_AM_17f4619.png)
...
![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_11.58.06_AM_c9fbc11.png)
...
![](https://www.objc.io/images/issue-19/Screen_Shot_2014-11-22_at_12.01.32_PM_cfa4028.png)

You can also add multiple actions, which can be debugger commands, shell commands, or more robust printing:

![](https://www.objc.io/images/issue-19/Image_2014-11-22_at_12.06.34_PM_fcedf7b.png)
...
![](https://www.objc.io/images/issue-19/Screen_Shot_2014_11_22_at_1_50_56_PM_7f13d7a.png)
...
Imagine a hypothetical case where you have a `UIView` that was somehow having its `_layer` instance variable being overwritten (uh oh!). Since there might not be a method involved, we can't use a symbolic breakpoint. Instead, we want to _watch_ when an address is written to.
