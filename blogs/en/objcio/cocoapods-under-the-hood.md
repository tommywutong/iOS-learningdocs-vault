...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/6-build-tools/cocoapods-under-the-hood'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:36b59558a91a3d60'
translated: false
---

> 原文：[CocoaPods Under The Hood](https://www.objc.io/issues/6-build-tools/cocoapods-under-the-hood)　·　objc.io
