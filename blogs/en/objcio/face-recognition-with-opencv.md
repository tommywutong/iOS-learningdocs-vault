...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/21-camera-and-photos/face-recognition-with-opencv'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:2915c0972b477ded'
translated: false
---

> 原文：[Face Recognition with OpenCV](https://www.objc.io/issues/21-camera-and-photos/face-recognition-with-opencv)　·　objc.io
...
![](https://www.objc.io/images/issue-21/blocks-face-recognition-objcio_02b311a.jpg)
...
The parameter files can be found under the `data/haarcascades` folder inside the OpenCV distribution. After the face detector has been initialized with the desired parameters, it can be used to detect faces:
