...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/9-strings/string-rendering'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:44c6257f9fe5c13e'
translated: false
---

> 原文：[String Rendering](https://www.objc.io/issues/9-strings/string-rendering)　·　objc.io
...
![](https://www.objc.io/images/issue-9/uitableview-finished_401422d.png)
...
![](https://www.objc.io/images/issue-9/deprecated-methods_af50a71.png)

Another option for dynamically sized table view cells is to use Auto Layout, for example, as explained in [this blog post](http://blog.amyworrall.com/post/66085151655/using-auto-layout-to-calculate-table-cell-height). You can then piggyback on the `intrinsicContentSize` of the contained labels. However, Auto Layout is currently a lot slower than calculating things manually. For prototyping, however, it is perfect: it allows you to quickly adjust constraints and move things around (this is especially important if you have more than one element on your cell). Once you have finished the design iterations, you can then rewrite it to do the layout manually.
...
![](https://www.objc.io/images/issue-9/Layout-Example-1_f4d67f2.png)
...
![](https://www.objc.io/images/issue-9/Layout-Example-2_f78a44e.png)
...
![](https://www.objc.io/images/issue-9/Layout-Example-3_52a3685.png)
