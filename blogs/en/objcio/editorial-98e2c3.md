...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/6-build-tools/editorial'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5b95e926d625497d'
translated: false
---

> 原文：[Editorial](https://www.objc.io/issues/6-build-tools/editorial)　·　objc.io
...
We've added a [subscription](https://www.objc.io/subscribe.html) page to give you a better overview of all the ways to stay up-to-date. Next to the new objc.io app, we've also added support for Maverick's website push notifications.

Now objc.io wouldn't be the same without all the fantastic contributions from the community. Thus far, fifteen developers have guest-authored sixteen articles in the first six issues. To make their contributions more visible, we've added a [contributors](https://www.objc.io/contributors.html) page. Thank you so much for helping out!
