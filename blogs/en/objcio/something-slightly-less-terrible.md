...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/20-interviews/loren-brichter'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:80a4994701e9096b'
translated: false
---

> 原文：[Something Slightly Less Terrible](https://www.objc.io/issues/20-interviews/loren-brichter)　·　objc.io
