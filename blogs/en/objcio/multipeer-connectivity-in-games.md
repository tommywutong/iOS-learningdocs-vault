...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/18-games/multipeer-connectivity-for-games'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:fb4555f5d032d009'
translated: false
---

> 原文：[Multipeer Connectivity in Games](https://www.objc.io/issues/18-games/multipeer-connectivity-for-games)　·　objc.io

Since its unveiling at WWDC 2013, [Multipeer Connectivity](https://developer.apple.com/library/IOs/documentation/MultipeerConnectivity/Reference/MultipeerConnectivityFramework/index.html) (or MPC as we'll refer to it here) has garnered much hype, but relatively few products have successfully integrated it in meaningful ways. So let's see what MPC is and how to leverage it to build impressive experiences, especially in games.

## What is Multipeer Connectivity?

Multipeer Connectivity is an Apple framework that offers transport-agnostic mechanisms for network discoverability, creation, and communication. It's the spiritual successor to [Bonjour](https://www.apple.com/support/bonjour), which was mostly useful for device discoverability on LAN and Wi-Fi networks.
...
Most MPC functionality is also available through the higher-level [GameKit framework](https://developer.apple.com/LIBRARY/ios/documentation/GameKit/Reference/GameKit_Collection/index.html). Using GameKit to power your game can allow developers to work with very useful game concepts to abstract the underlying networking protocols.
...
![](https://www.objc.io/images/issue-18/browser_774d682.png)
...
![](https://www.objc.io/images/issue-18/dedicated_9942fc7.gif)
...
![](https://www.objc.io/images/issue-18/zero-config_cbc8f92.gif)
...
One challenge that arises when all peers transceive is contention. There can be many peers attempting to mutually connect to each other's advertised sessions. This is a thoroughly researched type of problem called [leader election](http://en.wikipedia.org/wiki/Leader_election), with several well-known solutions.
...
Much like the [TCP/UDP dichotomy](http://en.wikipedia.org/wiki/User_Datagram_Protocol#Comparison_of_UDP_and_TCP), MPC allows sending data in both reliable and unreliable modes. The [`MCSessionSendDataMode`](https://developer.apple.com/library/IOs/documentation/MultipeerConnectivity/Reference/MCSessionClassRef/index.html#//apple_ref/doc/c_ref/MCSessionSendDataMode) contains the values for both modes.
...
It's clear that Apple has put a lot of thought into [GameKit](https://developer.apple.com/LIBRARY/ios/documentation/GameKit/Reference/GameKit_Collection/index.html). Though it enforces certain models and architectural paradigms, and requires relinquishing some control over session connectivity details, the framework also abstracts away much of the lower-level inner workings.
...
Several websocket libraries are available both for Swift ([starscream](https://github.com/daltoniam/starscream)) and Objective-C ([SocketRocket](https://github.com/square/SocketRocket), [jetfire](https://github.com/acmacalister/jetfire)).
