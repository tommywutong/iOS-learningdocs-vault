...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/10-syncing-data/data-synchronization'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:830e3614aa59980e'
translated: false
---

> 原文：[Data Synchronization](https://www.objc.io/issues/10-syncing-data/data-synchronization)　·　objc.io
...
|---|---|---|
| **Client-Server** | [Parse](https://parse.com) StackMob [Windows Azure Mobile Services](http://www.windowsazure.com/en-us/services/mobile-services/) [Helios](http://helios.io) Custom Web Service | [Dropbox Datastore](https://www.dropbox.com/developers/datastore) [TouchDB](http://labs.couchbase.com/TouchDB-iOS/) [Wasabi Sync](http://www.wasabisync.com) [Zumero](http://zumero.com) |
| **Peer-to-Peer** | iTunes/iPod Palm Pilot | [Core Data with iCloud](https://developer.apple.com/library/ios/documentation/General/Conceptual/iCloudDesignGuide/Chapters/DesignForCoreDataIniCloud.html) [TICoreDataSync](https://github.com/nothirst/TICoreDataSync) [Core Data Ensembles](https://github.com/drewmccormack/ensembles) |
...
![](https://www.objc.io/images/issue-10/sp2p_4870ebb.png) _Synchronous Peer-to-Peer (S–P2P)_
...
![](https://www.objc.io/images/issue-10/scs_e41f015.png)   
...
![](https://www.objc.io/images/issue-10/acs_17baf8c.png)   
...
![](https://www.objc.io/images/issue-10/ap2p_e19304a.png)   
...
![](https://www.objc.io/images/issue-10/orphan_203cddf.png)   
