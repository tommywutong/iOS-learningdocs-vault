...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/13-architecture/mvvm'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:6dad9096ca26349c'
translated: false
---

> 原文：[Introduction to MVVM](https://www.objc.io/issues/13-architecture/mvvm)　·　objc.io
...
![](https://www.objc.io/images/issue-13/mvvm1_16d8161.png)
...
![](https://www.objc.io/images/issue-13/mvvm_b27768d.png)
...
So now that we know _what_ MVVM is, _why_ would one want to use it? The motivation behind MVVM on iOS, for me, anyway, is that it reduces the complexity of one's view controllers and makes one's presentation logic easier to test. We'll see how it accomplishes these goals with some examples.
...
So, as you can see, not a lot changed from our MVC architecture. It's the same code, just moved around. It's compatible with MVC, leads to [lighter view controllers](https://www.objc.io/issues/1-view-controllers/), and is more testable.
