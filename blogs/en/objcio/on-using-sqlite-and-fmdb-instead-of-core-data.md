...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/4-core-data/SQLite-instead-of-core-data'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:2be58b7453bbc9ab'
translated: false
---

> 原文：[On Using SQLite and FMDB Instead of Core Data](https://www.objc.io/issues/4-core-data/SQLite-instead-of-core-data)　·　objc.io
