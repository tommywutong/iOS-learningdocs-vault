...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/17-security/inside-code-signing'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:e8ae9d2d1e223a1a'
translated: false
---

> 原文：[Inside Code Signing](https://www.objc.io/issues/17-security/inside-code-signing)　·　objc.io
...
There are many nice APIs you might encounter while building apps for iOS or OS X. You could do [beautiful animations](https://www.objc.io/issues/1-view-controllers/), [test your app](https://www.objc.io/issues/15-testing) really well, or store your data safely in [Core Data](https://www.objc.io/issues/4-core-data). But at some point, you will encounter code signing and provisioning. And more often than not, this is when you will start cursing.
...
![](https://www.objc.io/images/issue-17/iphone-developer-keychain_7422f3e.png)
...
![](https://www.objc.io/images/issue-17/ios-dev-certificate_7541f71.png)
...
![](https://www.objc.io/images/issue-17/xcode-code-signing-idenity_ff9f53f.png)
...
The `codesign` tool also gives you information about the code signing status of an executable, something that can be especially helpful if things go wrong. For example, `$ codesign -vv -d Example.app` will tell you a few things about the code signing status of `Example.app`:
...
![](https://www.objc.io/images/issue-17/xcode-provisioning-profile_cc086f3.png)
