...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/22-scale/omni-group'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5b5233adf1d2ff65'
translated: false
---

> 原文：[Inside Omni](https://www.objc.io/issues/22-scale/omni-group)　·　objc.io

The Omni Group is an employee-owned company where people bring their dogs to work.

In other words: when you think about managing large projects, think about culture _first_. It almost doesn’t matter what the details are — how we’re organized, what we use for source control management, and so on — because a great culture makes for a happy team that will figure out how to work together. And Omni has done a _great_ job with that.
...
We have a number of scripts that help with this. For instance, when I want to get the latest changes to OmniFocus, I type `./Update OmniFocus
								` and it updates my working copy (I usually do this once a day, first thing). I don’t have OmniGraffle in my working copy, since I haven’t had a need to look at it. But I could get it by typing `./Update OmniGraffle
								`.
...
But it’s our job to make sure that _our_ code doesn’t crash — and that if we note a crashing bug in system frameworks, we find a way to work around it.
...
And lunches. Work _and_ lunches. We all eat together. It makes a difference.
