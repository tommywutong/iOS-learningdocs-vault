...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/24-audio/audio-api-overview'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:d07284acda64aab9'
translated: false
---

> 原文：[Audio API Overview](https://www.objc.io/issues/24-audio/audio-api-overview)　·　objc.io
