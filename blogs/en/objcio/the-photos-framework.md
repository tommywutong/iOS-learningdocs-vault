...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/21-camera-and-photos/the-photos-framework'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:f1a2647b727829b3'
translated: false
---

> 原文：[The Photos Framework](https://www.objc.io/issues/21-camera-and-photos/the-photos-framework)　·　objc.io
...
![](https://www.objc.io/images/issue-21/photos-burst-example_4232147.jpg)
...
You can read more about this aspect of the framework in Sam Davies' [article on Photo Extensions](https://www.objc.io/issues/21-camera-and-photos/photo-extensions/).
