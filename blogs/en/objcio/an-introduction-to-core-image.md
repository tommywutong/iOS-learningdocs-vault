...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/21-camera-and-photos/core-image-intro'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:e982562cb95b01d1'
translated: false
---

> 原文：[An Introduction to Core Image](https://www.objc.io/issues/21-camera-and-photos/core-image-intro)　·　objc.io
...
![](https://www.objc.io/images/issue-21/quartz_c4a7e45.png)
...
![](https://www.objc.io/images/issue-21/color-controls_e12d56a.png)
...
![](https://www.objc.io/images/issue-21/photo-filters_6bd1eff.png)
...
For a take on writing Core Image code in a more functional style, see Florian Kugler's [article in objc.io issue #16](https://www.objc.io/issues/16-swift/functional-swift-apis/).
