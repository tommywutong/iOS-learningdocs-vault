...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/6-build-tools/mach-o-executables'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:9ab7dc7e55768934'
translated: false
---

> 原文：[Mach-O Executables](https://www.objc.io/issues/6-build-tools/mach-o-executables)　·　objc.io
...
The compiler of choice nowadays is `clang` (pronounced /klæŋ/). Chris writes in more detail [about the compiler](https://www.objc.io/issues/6-build-tools/compiler/).
