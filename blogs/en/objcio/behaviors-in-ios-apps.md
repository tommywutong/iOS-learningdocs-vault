...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/13-architecture/behaviors'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b70642d21bcea4bd'
translated: false
---

> 原文：[Behaviors in iOS Apps](https://www.objc.io/issues/13-architecture/behaviors)　·　objc.io

_Update_: There is [sample code](https://github.com/objcio/BehavioursExample) and a [follow-up blogpost](http://merowing.info/2014/06/behaviours-and-xcode-6/).
...
![](https://www.objc.io/images/issue-13/cornerRadius_d9b8667.png)
...
![](https://www.objc.io/images/issue-13/runtimeAttributes_0db8153.png)
