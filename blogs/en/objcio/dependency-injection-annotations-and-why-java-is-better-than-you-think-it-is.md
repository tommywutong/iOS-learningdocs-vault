...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/11-android/dependency-injection-in-java'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5fb50305faa32525'
translated: false
---

> 原文：[Dependency Injection, Annotations, and why Java is Better Than you Think it is](https://www.objc.io/issues/11-android/dependency-injection-in-java)　·　objc.io
