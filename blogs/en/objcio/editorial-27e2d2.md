...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/8-quadcopter/editorial'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:d6bd65d5e716d30b'
translated: false
---

> 原文：[Editorial](https://www.objc.io/issues/8-quadcopter/editorial)　·　objc.io
...
We briefly outline the overall goals of the project in the [overview article](https://www.objc.io/issues/8-quadcopter/the-quadcopter-project/). There, we also talk about how the project changed while we were working on it. The [other articles in this issue](https://www.objc.io/issues/8-quadcopter) will go into more technical detail regarding how we implemented this project.
