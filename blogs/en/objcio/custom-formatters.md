...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/7-foundation/nsformatter'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:a3476fd6a220fc1d'
translated: false
---

> 原文：[Custom Formatters](https://www.objc.io/issues/7-foundation/nsformatter)　·　objc.io
...
Our 'known' colors are a dictionary keyed by a `UIColor` with the English name as values. I'll leave the implementation of the `initWithColors:` method to your imagination. Or, if you're that person who looks at the answers on the last page of the puzzle book, go ahead and take a look at the [Github repo](https://github.com/klaaspieter/KPAColorFormatter).
...
The first thing we need to do is translate the color strings. Messing with genstring, and `*.lprojs` is outside of the scope of this article. I mean, you have to get back to work at some point right? If not, [there](https://developer.apple.com/internationalization/) [are](http://nshipster.com/nslocalizedstring/) [a](https://developer.apple.com/library/mac/documentation/MacOSX/Conceptual/BPInternational/Introduction/Introduction.html) [bunch](http://www.tethras.com/apple) [of](http://www.ibabbleon.com/iphone_app_localization.html) [articles](http://www.getlocalization.com/library/get-localization-mac/) [about](http://www.daveoncode.com/2010/05/15/iphone-applications-localization/) [it](http://useyourloaf.com/blog/2010/12/15/localize-iphone-application-name.html). Read them all? Awesome! No more work, time to go home.
...
That said, we ended up with a pretty solid formatter. All the code (with an OS X example) is available on [Github](https://github.com/klaaspieter/KPAColorFormatter). My implementation is also available on [CocoaPods](http://cocoapods.org). If you desperately need this functionality in your app, add `pod "KPAColorFormatter"` to your Podfile and have fun experimenting!
