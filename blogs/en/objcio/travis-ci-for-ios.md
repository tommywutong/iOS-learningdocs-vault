...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/6-build-tools/travis-ci'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:4d0a2095efadcfe7'
translated: false
---

> 原文：[Travis CI for iOS](https://www.objc.io/issues/6-build-tools/travis-ci)　·　objc.io
...
![](https://www.objc.io/images/issue-6/github_ready_to_merge_4a9e8dc.jpg)

In case the build doesn't succeed, the page will be colored accordingly on GitHub:

![](https://www.objc.io/images/issue-6/github_merge_with_caution_bed3909.jpg)
...
![](https://www.objc.io/images/issue-6/objc_travis_flick_da88947.jpg)
...
![](https://www.objc.io/images/issue-6/objc_shared_schemes_38ea14d.jpg)
...
![](https://www.objc.io/images/issue-6/dist_cert_keychain_35300ba.jpg)
...
![](https://www.objc.io/images/issue-6/TravisExample-iOS_a96fb1c.png)
