...
source: objc.io
source_key: objcio
source_url: 'https://www.objc.io/issues/1-view-controllers/containment-view-controller'
original_language: en
published: ''
status: frozen
license: 未声明（页面无版权声明，文章版权归各作者）→ 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:03d6dc38b258bb57'
translated: false
---

> 原文：[View Controller Containment](https://www.objc.io/issues/1-view-controllers/containment-view-controller)　·　objc.io
...
![](https://www.objc.io/images/issue-1/view-insertion@2x_1cf22c0.png)
...
When you were a kid playing in the sand, did your parents ever tell you that if you kept digging with your little shovel you would end up in China? Mine did, and I made a small demo app called _Tunnel_ to test this claim. You can clone the [GitHub repo](https://github.com/objcio/issue-1-view-controller-containment) and run the app, which will make it easier to understand the example code. _(Spoiler: digging through the earth from western Denmark lands you somewhere in the South Pacific Ocean.)_

![](https://www.objc.io/images/issue-1/tunnel-screenshot@2x_c00fe39.png)
