---
title: Fake Ads as a Business Model
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2016/03/fake-ads-as-a-business-model/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b9226c66dfd3522c'
translated: false
---

> 原文：[Fake Ads as a Business Model](https://oleb.net/blog/2016/03/fake-ads-as-a-business-model/)　·　Ole Begemann
...
That makes total sense. And it made me think if this would be a viable business model for one of my (fictional) apps. The problem is [I really hate advertising](https://oleb.net/blog/2015/08/is-it-immoral-to-not-block-ads/), so I would probably not add ads to my app. I simply wouldn’t want to expose my users to tracking, nor would I want to support the ad industry in general.
