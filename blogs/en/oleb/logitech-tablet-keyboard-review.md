---
title: Logitech Tablet Keyboard Review
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2013/04/logitech-tablet-keyboard-review/'
...
> 原文：[Logitech Tablet Keyboard Review](https://oleb.net/blog/2013/04/logitech-tablet-keyboard-review/)　·　Ole Begemann

# Logitech Tablet Keyboard Review

I recently bought the [Logitech Tablet Keyboard for iPad](http://www.logitech.com/en-us/product/tablet-keyboard-ipad) to write and edit longer texts (such as this article) on my iPad, and I like it a lot.
...
1. The only key placement that bothers me is the dedicated Spotlight key to the left of the cursor keys. I find myself often hitting the Search key by accident when I want to hit the right Option key. [↩︎](#fnref:1)
