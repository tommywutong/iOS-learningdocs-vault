...
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2017/07/mental-models-in-api-design/'
...
> 原文：[Mental models in API design](https://oleb.net/blog/2017/07/mental-models-in-api-design/)　·　Ole Begemann
...
1. Yes, you can also do `str.components(separatedBy: " ")`, and that returns `[String]`. But only if you import Foundation. The weird mix between native `String` APIs and Foundation APIs that come from `NSString` is another unintuitive gap newcomers have to, uhm, bridge. [↩︎](#fnref:components)
