---
title: Steve Jobs Confirmed Native iPhone Apps in 2007
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2012/06/steve-jobs-confirmed-native-iphone-apps-in-2007/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:66139f0d34e67d26'
translated: false
---

> 原文：[Steve Jobs Confirmed Native iPhone Apps in 2007](https://oleb.net/blog/2012/06/steve-jobs-confirmed-native-iphone-apps-in-2007/)　·　Ole Begemann

# Steve Jobs Confirmed Native iPhone Apps in 2007

A final post about the [Steve Jobs interviews at the D conference](http://allthingsd.com/20120530/steve-jobs-at-d-podcasts/): at D5 in 2007, Jobs not only appeared in a joint session with Bill Gates. He also had his [customary interview with Walt Mossberg](http://allthingsd.com/20070627/steve-jobs-the-entire-d5-interview-with-walt-mossberg/). And in the Q&A session after this interview, Jobs pretty much confirmed that Apple would provide a way for third-party developers to write native iPhone apps in the future.
...
Again, this was just a few days before WWDC 2007 where Jobs announced, [to the dismay of all developers in the room](http://daringfireball.net/2007/06/wwdc_2007_keynote), that the perfect way to write iPhone apps would be HTML and Javascript in Safari. Listening to this conversation, I do not think Jobs was alluding to web apps here, though. He talked about native apps, even though he would say something different at WWDC a week later.
