---
title: Thoughts on the Apple TV After Six Months
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2016/04/apple-tv-thoughts/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:a96b41cc3913e9f3'
translated: false
---

> 原文：[Thoughts on the Apple TV After Six Months](https://oleb.net/blog/2016/04/apple-tv-thoughts/)　·　Ole Begemann

# Thoughts on the Apple TV After Six Months

[![The fourth generation Apple TV](https://oleb.net/media/apple-tv.jpg)](https://oleb.net/media/apple-tv.jpg)
...
1. It’s (nearly) impossible to tell which side is up without looking at it (hint: home theaters are often dark). I hit the wrong button all the time right after picking it up.
2. If the buttons were recessed (as on [Apple’s old IR remote](https://en.wikipedia.org/wiki/Apple_Remote#/media/File:Apple_Remote_2009.jpg)), they’d be much less likely to activate accidentally when the remote inevitably falls between the sofa cushions.
3. Unlike the [Magic Mouse](https://www.ifixit.com/Teardown/Magic+Mouse+2+Teardown/51058), [Magic Trackpad](https://www.ifixit.com/Teardown/Magic+Trackpad+2+Teardown/51032), and [Magic Keyboard](https://www.ifixit.com/Teardown/Magic+Keyboard+Teardown/50995), the remote doesn’t have an off switch. This means you have to unplug the Apple TV every time you want to properly clean the remote. Not cool for a device that people routinely handle with fatty potato chips fingers.

I wish Apple took a cue from their [Smart Battery Case’s](http://arstechnica.com/apple/2015/12/mini-review-a-week-with-apples-lumpy-new-iphone-battery-case/) focus on function over form for the next revision of the remote.
...
I’m not a fan of the ubiquitous [tab bar](https://developer.apple.com/tvos/human-interface-guidelines/ui-elements/#tab-bars) navigation. It’s way too easy to accidentally swipe slightly-up-and-then-right when you actually meant to swipe right on the touch surface, causing you to switch tabs and often lose your scroll position on the original tab.

---

I continue to not be a fan of voice interaction on any device. Siri is too slow and unreliable. The ability to dictate in text fields ([added in tvOS 9.2](http://9to5mac.com/2016/03/21/tvos-9-2-apple-tv-update/)) is welcome, but only semi-useful if you want to use it with multiple languages. Siri only understands one language at a time, and there is no convenient way to change the dictation language when you’re in a text field. I estimate my search queries are split about 50–50 between German and English, so it sucks either way.
