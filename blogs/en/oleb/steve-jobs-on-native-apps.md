---
title: Steve Jobs on Native Apps
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2012/06/steve-jobs-on-native-apps/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:10c7b8745c4f09ee'
translated: false
---

> 原文：[Steve Jobs on Native Apps](https://oleb.net/blog/2012/06/steve-jobs-on-native-apps/)　·　Ole Begemann

# Steve Jobs on Native Apps

Here’s another Steve Jobs quote from the collection of [Jobs’s appearances at the D conference](http://allthingsd.com/20120530/steve-jobs-at-d-podcasts/), this time from the [2007 interview he gave together with Bill Gates](http://allthingsd.com/20070530/d5-gates-jobs-interview/).
...
Remember, this was on May 30th, 2007, just before the first iPhone went on sale a month later (but after the introduction of the iPhone in January of that year). This was just a few days before Jobs would tell developers at WWDC [that web apps would be the only way to do iPhone development](http://www.apple.com/pr/library/2007/06/11iPhone-to-Support-Third-Party-Web-2-0-Applications.html). And here sits Steve Jobs and talks excitedly about a native app whose user experience could not be created in a browser.

We know from the Isaacson biography that [Jobs was initially opposed to having third-party apps on the iPhone](http://www.guardian.co.uk/technology/appsblog/2011/oct/24/steve-jobs-apps-iphone) and that it was only once the device was available that Jobs relented. So at the time, Jobs still resisted the idea. Even though he was aware of the tradeoff Apple was making, his desire to control the experience was probably still greater and remained so until they came up with the App Store review process, [as Art Levinson told the Guardian](http://www.guardian.co.uk/technology/appsblog/2011/oct/24/steve-jobs-apps-iphone).

(Bill Gates agreed, by the way. You’re going to have rich local functionality. At least that’s our bet., he said.)
