---
title: Deleting RSS Feed Items
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2015/11/rss-feed-item-deletions/'
...
> 原文：[Deleting RSS Feed Items](https://oleb.net/blog/2015/11/rss-feed-item-deletions/)　·　Ole Begemann
...
I hate when this happens because I value the quality of my feed. (For example, I make sure [my feed doesn’t show old items](https://oleb.net/blog/2014/01/preserving-rss-feed-read-status/) when I switch to a new blogging system.)
...
~~As far as I know, there exists no similar proposal for [RSS](https://en.wikipedia.org/wiki/RSS).~~

**Update December 2, 2015:** [A commenter on Hacker News](https://news.ycombinator.com/item?id=10651365) pointed me to a recommendation from the RSS Advisory Board for the [Media RSS specification](http://www.rssboard.org/media-rss) to support Dublin Core’s [`dcterms:valid`](http://dublincore.org/documents/dcmi-terms/#terms-valid) element. This is usually used to specify an item’s expiry date, but an entry that expires at the same time it was published can be seen as deleted. I have no idea if any RSS services support this.

To my knowledge, no popular news aggregator service or app currently supports the Atom extension. Nonetheless, I added support for deleted entries to my feed. This is how it looks:
