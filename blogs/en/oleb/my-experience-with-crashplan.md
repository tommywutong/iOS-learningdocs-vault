...
5. After the file scan is complete, I move the files I want to the external drive. To the CrashPlan app, this looks at first as if I am _adding_ hundreds of gigabytes to my backup because it does not recognize immediately that the files are being moved. I start to wonder, did I do anything wrong? Will I have to re-upload these files?
