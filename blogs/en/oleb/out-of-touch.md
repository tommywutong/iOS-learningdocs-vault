...
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2014/12/apple-out-of-touch/'
...
> 原文：[Out of Touch](https://oleb.net/blog/2014/12/apple-out-of-touch/)　·　Ole Begemann

# Out of Touch

## Has Apple Management Lost Touch With Reality?
...
Greg Gardner, developer of Launcher, [recounts his conversations with Apple’s app review team](https://cromulentlabs.wordpress.com/2014/12/07/launcher-followup-and-thoughts-on-the-app-store-review-system/):
...
This is so messed up. What does it say about Apple’s priorities when app review spends its time policing developers for building features that are innovative, useful, _and entirely opt-in anyway?_

At around the same time, Twitter announced that [their app is now spying on users in a new way](https://support.twitter.com/articles/20172069-what-is-app-graph-on-twitter), using a public API for a purpose it was clearly not intended for. I would argue that this practice, if not against the letter of the [Review Guidelines](https://developer.apple.com/app-store/review/guidelines/), is much more harmful to users. It’s stuff like this that should warrant action from the app review team.

If, instead of making capricious decisions for people how they can use their phones, Apple cracked down on Twitter for privacy violations, or had done so in the past [with Path](http://www.theverge.com/2012/2/7/2782947/path-ios-app-user-information-collected-privacy), for example, or the countless developers who use push notifications for spam, app review could actually help position the iOS platform in a way that’s consistent with [company policy](http://www.apple.com/privacy/).
...
**Update December 12, 2014:** [Apple has reversed the rejection of Transmit](http://www.panic.com/blog/transmit-ios-1-1-1/).

**Update December 18, 2014:** [The Drafts widget is back, too](http://www.macrumors.com/2014/12/17/drafts-notification-center-widget-reinstated/).

1. I’m excluding the [Launcher rejection](http://al.cromulentlabs.com/thanks/) here because, unlike the other apps, it seems to actually violate an explicit rule from the [App Store Review Guidelines](https://developer.apple.com/app-store/review/guidelines/) that has existed for some time (“10.4 Apps that create alternate desktop/home screen environments or simulate multi-App widget experiences will be rejected.”). We can argue whether this rule makes sense, but at least Apple did not have to pull some [ridiculous](https://twitter.com/jamesthomson/status/527498251176796160) [justifications](http://www.panic.com/blog/transmit-ios-1-1-1/) out of thin air. [↩︎](#fnref:1)
