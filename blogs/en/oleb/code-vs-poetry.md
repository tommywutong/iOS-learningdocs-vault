---
title: Code vs. Poetry
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2015/01/code-vs-poetry/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:96ad14a805b7cc96'
translated: false
---

> 原文：[Code vs. Poetry](https://oleb.net/blog/2015/01/code-vs-poetry/)　·　Ole Begemann

# Code vs. Poetry

## An Interview With Google Engineer Nina Kang

David Plotz did an interesting [interview with Google engineer Nina Kang](http://www.slate.com/articles/podcasts/working/2014/12/google_software_engineer_nina_kang_talks_about_the_differences_between_writing.html) for the [Working podcast](http://www.slate.com/articles/podcasts/working.html). Here’s an excerpt (edited for clarity):
...
> 
> **Q:** Great word there, _poetic_. What does that mean when you say, some people find it poetic?
> 
...
> 
> **A:** Yes. I have an [MFA](https://en.wikipedia.org/wiki/Master_of_Fine_Arts) in poetry from [Warren Wilson](https://en.wikipedia.org/wiki/Warren_Wilson_College).
> 
