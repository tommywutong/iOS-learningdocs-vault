---
title: Ranges and Intervals in Swift
source: Ole Begemann
source_key: oleb
source_url: 'https://oleb.net/blog/2015/09/swift-ranges-and-intervals/'
original_language: en
published: ''
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:7d71f4c934475b92'
translated: false
---

> 原文：[Ranges and Intervals in Swift](https://oleb.net/blog/2015/09/swift-ranges-and-intervals/)　·　Ole Begemann

# Ranges and Intervals in Swift

**Note:** This article is based on Swift 2.x. Please check out [Ranges in Swift 3](https://oleb.net/blog/2016/09/swift-3-ranges) for an overview of what changed in Swift 3.

In my previous [post on pattern matching](https://oleb.net/blog/2015/09/swift-pattern-matching/), I mentioned that the standard library includes overloads of the pattern matching operator `~=` for ranges and intervals.
...
[Download this article as a playground](https://oleb.net/media/swift-ranges-and-intervals.playground.zip) for Xcode 7.
