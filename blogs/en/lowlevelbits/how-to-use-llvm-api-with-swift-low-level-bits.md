---
title: How to use LLVM API with Swift - Low Level Bits 🇺🇦
source: Low Level Bits (Alex Denisov)
source_key: lowlevelbits
source_url: 'https://lowlevelbits.org/how-to-use-llvm-api-with-swift/'
...
> 原文：[How to use LLVM API with Swift - Low Level Bits 🇺🇦](https://lowlevelbits.org/how-to-use-llvm-api-with-swift/)　·　Low Level Bits (Alex Denisov)

# How to use LLVM API with Swift

_Published on Nov 30, 2015_
...
**UPD:** There is a second part of the article. It shows how to actually use JIT engine: [http://lowlevelbits.org/how-to-use-llvm-api-with-swift-addendum](https://lowlevelbits.org/how-to-use-llvm-api-with-swift-addendum)
