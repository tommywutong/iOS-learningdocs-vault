---
title: Setting up gitweb on Shared Hosting
source: Belkadan (Jordan Rose, 前 Swift 编译器工程师)
source_key: belkadan
source_url: 'https://belkadan.com/blog/2020/01/Gitweb-on-Shared-Hosting/'
original_language: en
published: 2020-01-22
status: active
license: Copyright 2012–2020 Jordan Rose → 仅私有归档
archived_at: 2026-07-26
content_hash: 'sha256:11c20064e3f923cb'
translated: false
---

> 原文：[Setting up gitweb on Shared Hosting](https://belkadan.com/blog/2020/01/Gitweb-on-Shared-Hosting/)　·　Belkadan (Jordan Rose, 前 Swift 编译器工程师)
