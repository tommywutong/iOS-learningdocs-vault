...
source_key: fbeng
source_url: 'https://engineering.fb.com/2020/03/02/data-infrastructure/messenger/'
original_language: en
published: 2020-03-02
status: active
license: © Meta → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:d930616fa2ada271'
translated: false
---

> 原文：[Project LightSpeed: Rewriting the Messenger codebase for a faster, smaller, and simpler messaging app](https://engineering.fb.com/2020/03/02/data-infrastructure/messenger/)　·　Meta Engineering — iOS
...
One of our main goals was to minimize code complexity and eliminate redundancies. We knew a unified architecture would allow for global optimization (instead of having each feature focused on local optimizations) and allow code to be reused in smart ways. To build this unified architecture, we established four principles: Use the OS, reuse the UI, leverage the SQLite database, and push to the server.
...
![we used the UI framework available on the device’s native OS to support a wider variety of application feature needs. This reduced not only size, by avoiding the need to cache/load large custom-built frameworks, but also complexity.](https://engineering.fb.com/wp-content/uploads/2020/03/Reuse_UI_V2.gif)
...
_We’d like to thank everyone who contributed to Project LightSpeed for their contributions._
