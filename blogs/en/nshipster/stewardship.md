...
source_url: 'https://nshipster.com/stewardship/'
original_language: en
published: 2014-01-27
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:b499b1d30a26654f'
translated: false
---

> 原文：[Stewardship](https://nshipster.com/stewardship/)　·　NSHipster (Mattt)

# [Stewardship](https://nshipster.com/stewardship/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  January 27^th, 2014
...
A README is the most important part of any open source project. It describes why someone would want to use the code, and how they may start to do so. All good READMEs have the following:
