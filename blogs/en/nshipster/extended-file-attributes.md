...
source_url: 'https://nshipster.com/extended-file-attributes/'
original_language: en
published: 2014-01-20
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:b2a78ce9af056002'
translated: false
---

> 原文：[Extended File Attributes](https://nshipster.com/extended-file-attributes/)　·　NSHipster (Mattt)

# [Extended File Attributes](https://nshipster.com/extended-file-attributes/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  January 20^th, 2014
