...
source_url: 'https://nshipster.com/swift-system-version-checking/'
original_language: en
published: 2014-10-06
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:48f67099a1e36afc'
translated: false
---

> 原文：[Swift System Version Checking](https://nshipster.com/swift-system-version-checking/)　·　NSHipster (Mattt)

# [Swift System Version Checking](https://nshipster.com/swift-system-version-checking/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  October 6^th, 2014
...
Unfortunately, `os()` doesn’t offer any insight into the specific version of macOS or iOS, which means that checks must be made at runtime. And with Swift’s less-forgiving [treatment of `nil`](https://nshipster.com/nil/), checking for constants Objective-C-style results in a crash.
