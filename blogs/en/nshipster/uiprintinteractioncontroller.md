...
source_url: 'https://nshipster.com/uiprintinteractioncontroller/'
original_language: en
published: 2014-11-17
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:47e10d45b7b44c56'
translated: false
---

> 原文：[UIPrintInteractionController](https://nshipster.com/uiprintinteractioncontroller/)　·　NSHipster (Mattt)

# [UIPrint​Interaction​Controller](https://nshipster.com/uiprintinteractioncontroller/)

Written by  [Nate Cook](https://nshipster.com/authors/nate-cook/)  November 17^th, 2014
...
> The “printed” images throughout this article are taken from Apple’s _Printer Simulator_. (The yellow edges represent the non-printable margins of the paper)
> 
> As of Xcode 6, the printer simulator must be downloaded as part of the _[Hardware IO Tools for Xcode](https://developer.apple.com/downloads/index.action?name=hardware%20io%20tools)_.

![Download Hardware I/O Tools from Apple Developer Website](https://nshipster.com/assets/uiprintinteractioncontroller-hardware-io-tools-download-50a450b93b5ae9747bcd276ee3baba17279d05085be7dd09c9d6ffb8d40da9beb46fc59a33ad290b70da24089cb17a657199b432931bfe4a7e208dfb60c5552b.png)

![PrintSimulator App Info](https://nshipster.com/assets/uiprintinteractioncontroller-printer-simulator-app-42b2728dda0f77db1901df5d90047a2215f28f8d4c89d15a41e8ded615b7d062ea8a5f765702a6851fa6d35c0466e6690dd1e67cdf7eda706dead499e99d52fb.png)

![PrintSimulator App Load Paper](https://nshipster.com/assets/uiprintinteractioncontroller-printersimulator-load-paper.pnd-2d69b0e68b8797fc587b6a79896ebc06551d15151349b1cb49defffba461a50fbbd8e532fa649eae34836f9dfbdfb763f1b66e665177344843975d166c9915cc.png)
...
> - `printerID`_`String?`_: An ID for a particular printer—you can retrieve this only _after_ the user has selected a printer through the UI and save it to use as a preset for a future print job.
...
![Print with .printingItem](https://nshipster.com/assets/uiprintinteractioncontroller-image-print-ee29ef26bdfb9e584fa8f09762dfba88c0d286768e5524284828b770160f65081d4709f37dd61a35faec5078d631ff79a1882cab1f599cd773a24a565506cdbb.png)
...
> - `contentInsets`_`UIEdgeInsets`_: A set of insets from the edges of the page for the entire block of content. The left and right insets are applied on every page, but the top inset is _only_ applied on the first page. The bottom inset is ignored.
> - `perPageContentInsets`_`UIEdgeInsets`_ (iOS 8 only): A set of insets from the edges of the page for _every page_ of formatted content.
...
![Print with UIMarkupTextPrintFormatter](https://nshipster.com/assets/uiprintinteractioncontroller-html-print-04af76e5be2f4f0f0227e22fa501c418c67eebaea039a8c69bb2bde2ef0552dcde330c8cf08cdde4404d8c84a699f970bd121c7463739c2c2a45d08c3e37bee7.png)
...
![Print with UITextView](https://nshipster.com/assets/uiprintinteractioncontroller-textview-print-3b5134509e243f42a4d33155eb4ed372cfa5c8c5af9e7d2e53046cfe7a83f476f46f45e0bba39ff74a1b67c8267125d83aa2fbc3bbf204cb45c2503100917894.png)

#### 2) UIWebView

![Print with UIWebView](https://nshipster.com/assets/uiprintinteractioncontroller-webview-print-92889a62089e61880f073fe67ac1ba2adeb5ec05037a2d843d8871bb75167d50cb809c1d3f0030128218568670bbb88f8615ebed1fbbc3b9f56921dd4ebfc107.png)

#### 3) MKMapView

![Print with MKMapView](https://nshipster.com/assets/uiprintinteractioncontroller-mapview-print-960a6f8faa581a5a5252a7363469ce48a5ca9f07849495a74448059e2717b1a58e28d085b5b88c86dbce587ba8e967234f5be6f9e82546888675af605c92f16f.png)

## UIPrintPageRenderer

The built-in formatters are fine, but for the _most_ control over the printed page, you can implement a subclass of `UIPrintPageRenderer`. In your subclass you can combine the print formatters we saw above with your own custom drawing routines to create terrific layouts for your app’s content. Let’s look at one more way of printing a recipe, this time using a page renderer to add a header and to draw the images alongside the text of the recipe.
...
![Print with UIPrintPageRenderer subclass](https://nshipster.com/assets/uiprintinteractioncontroller-renderer-print-f6abe9c0d70d6373a2f5b003874c6dbe14dbcb126237baa49fd712abfdc1a009baa4b113cc18cbdd859f289b6e7fed1c51059e20322a1cb7d63d8af9ce30a707.png)

## Printing via a Share Sheet

With the tools we’ve learned above, adding printing capability in a share sheet is simple. Instead of using `UIPrintInteractionController` to present the printing UI, we pass off our configured `UIPrintInfo` and printing item(s), formatter, or renderer to a `UIActivityViewController`. If the user selects the _Print_ button in the share sheet, the printing UI will be displayed with all our configurations intact.
