...
source_url: 'https://nshipster.com/ios7/'
original_language: en
published: 2013-09-23
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:305a74806b7e5233'
translated: false
---

> 原文：[iOS 7](https://nshipster.com/ios7/)　·　NSHipster (Mattt)

# [iOS 7](https://nshipster.com/ios7/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  September 23^rd, 2013
...
Even though the number of people who have actually read something saved for later is only marginally greater than [the number of people who have ever used a QR code](https://picturesofpeoplescanningqrcodes.tumblr.com), it’s nice that iOS 7 adds a way to add items to the Safari reading list with the new Safari Services framework.
