...
source_url: 'https://nshipster.com/c-storage-classes/'
original_language: en
published: 2013-03-18
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:d8e9e41f6248bd45'
translated: false
---

> 原文：[C Storage Classes](https://nshipster.com/c-storage-classes/)　·　NSHipster (Mattt)

# [C Storage Classes](https://nshipster.com/c-storage-classes/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  March 18^th, 2013
