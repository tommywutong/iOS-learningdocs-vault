...
source_url: 'https://nshipster.com/uitextinputpasswordrules/'
original_language: en
published: 2018-07-23
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:bfeffa4ab55d9f0d'
translated: false
---

> 原文：[Password Rules / UITextInputPasswordRules](https://nshipster.com/uitextinputpasswordrules/)　·　NSHipster (Mattt)

# [Password Rules / UIText​Input​Password​Rules](https://nshipster.com/uitextinputpasswordrules/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  July 23^rd, 2018

It’s no wonder why hipsters obsess over artisanal _this_ and handcrafted _that_. Whether it’s a thick slice of avocado toast, a bottle of small batch (nondairy) golden milk, or a perfect cup of pour-over coffee — there’s no replacement for a human touch.
...
Apple’s [Password Rules Validation Tool](https://developer.apple.com/password-rules/) allows you to experiment with different rules and get real-time feedback of their results. You can even generate and download passwords by the thousands to use during development and testing!

![Password Rules Validation Tool](https://nshipster.com/assets/password-rules-validation-tool-b6611d4419163e61552957190e4dea645c38e9a97a5343da4e76a9fa18aa584de0380a87ad0ffa7e703bb010ca6e6f9c8ff6729f443571783846fff4703fc81e.png)

For more information about Password Rules syntax, check out Apple’s [“Customizing Password AutoFill Rules”](https://developer.apple.com/documentation/security/password_autofill/customizing_password_autofill_rules).
...
Here’s one way to encapsulate Password Rules in a Swift API ([also available as a Swift package](https://github.com/NSHipster/PasswordRules)):
