...
source_url: 'https://nshipster.com/random/'
original_language: en
published: 2013-08-12
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:264693e287fbc42e'
translated: false
---

> 原文：[rand(3) / random(3) / arc4random(3) / et al.](https://nshipster.com/random/)　·　NSHipster (Mattt)

# [rand(3) / random(3) / arc4random(3) / et al.](https://nshipster.com/random/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  August 12^th, 2013
