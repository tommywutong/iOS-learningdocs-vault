...
source_url: 'https://nshipster.com/nsurlprotocol/'
original_language: en
published: 2012-11-05
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:ef04d4192abcf896'
translated: false
---

> 原文：[NSURLProtocol](https://nshipster.com/nsurlprotocol/)　·　NSHipster (Mattt)

# [NSURLProtocol](https://nshipster.com/nsurlprotocol/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  November 5^th, 2012
