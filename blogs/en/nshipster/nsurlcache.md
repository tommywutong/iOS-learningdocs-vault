...
source_url: 'https://nshipster.com/nsurlcache/'
original_language: en
published: 2013-02-11
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:556ad37d021ed066'
translated: false
---

> 原文：[NSURLCache](https://nshipster.com/nsurlcache/)　·　NSHipster (Mattt)

# [NSURLCache](https://nshipster.com/nsurlcache/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  February 11^th, 2013
...
| `reloadIgnoringLocalAndRemoteCacheData` | Seriously, don't use any caches along the way |
| `returnCacheDataElseLoad` | Use the cache (no matter how out of date), or if no cached response exists, load from the network |
| `returnCacheDataDontLoad` | Offline mode: use the cache (no matter how out of date), but _don't_ load from the network |
