...
source_url: 'https://nshipster.com/inter-process-communication/'
original_language: en
published: 2014-10-17
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:804d9eacd73520e1'
translated: false
---

> 原文：[Inter-Process Communication](https://nshipster.com/inter-process-communication/)　·　NSHipster (Mattt)

# [Inter-Process Communication](https://nshipster.com/inter-process-communication/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  October 17^th, 2014
