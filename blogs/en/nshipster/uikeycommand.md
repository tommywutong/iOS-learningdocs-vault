...
source_url: 'https://nshipster.com/uikeycommand/'
original_language: en
published: 2015-07-27
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:62f488af77e973b3'
translated: false
---

> 原文：[UIKeyCommand](https://nshipster.com/uikeycommand/)　·　NSHipster (Mattt)

# [UIKey​Command](https://nshipster.com/uikeycommand/)

Written by  [Nate Cook](https://nshipster.com/authors/nate-cook/)  July 27^th, 2015
...
No longer. As part of the push for greater productivity on the iPad, iOS 9 adds _Discoverability_, an overlay showing the currently available key commands inside an app. This small change suddenly makes key commands far more viable on the iPad and, with it, makes `UIKeyCommand` a necessary addition to your app.
...
- `modifierFlags`: One or more `UIKeyModifierFlags`, describing the modifier keys that should be pressed in combination with `input`:
    ...
    - `.AlphaShift`: Indicates that the CapsLock key should be _pressed_ as part of the combination, rather than just engaged.
...
- `discoverabilityTitle`_(iOS 9 only)_: An optional label to display for the key command in the Discoverability layover. Only key commands with a title set will be listed.
...
![Discoverability Layover](https://nshipster.com/assets/uikeycommand-discoverability-1ffcdffc59a17228ebd595e99099e1557db093b6e3233ef2418abe8c2eecc0dd6312818f19821c3630f841ff33de15f2deae931a6bffca97b4836e772cf9684a.png)

_Voila!_ Secrets, revealed!
