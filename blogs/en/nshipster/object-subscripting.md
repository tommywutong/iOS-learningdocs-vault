...
source_url: 'https://nshipster.com/object-subscripting/'
original_language: en
published: 2013-06-17
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:983a5e9a8ba18c6a'
translated: false
---

> 原文：[Object Subscripting](https://nshipster.com/object-subscripting/)　·　NSHipster (Mattt)

# [Object Subscripting](https://nshipster.com/object-subscripting/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  June 17^th, 2013
...
Clang 3.1 added three features to Objective-C whose aesthetic & cosmetic impact is comparable to the changes brought about in Objective-C 2.0: [`NSNumber` Literals](http://clang.llvm.org/docs/ObjectiveCLiterals.html#nsnumber-literals), [Collection Literals](http://clang.llvm.org/docs/ObjectiveCLiterals.html#container-literals), and [Object Subscripting](http://clang.llvm.org/docs/ObjectiveCLiterals.html#object-subscripting).
...
> In fact, for non-general-purpose collections, indexed and keyed subscripting can get and set _any_ Objective-C object pointer type, not just `id`.
