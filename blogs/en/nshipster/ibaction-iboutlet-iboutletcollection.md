...
source_url: 'https://nshipster.com/ibaction-iboutlet-iboutletcollection/'
original_language: en
published: 2014-05-05
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:af2463a193a034dd'
translated: false
---

> 原文：[IBAction / IBOutlet / IBOutletCollection](https://nshipster.com/ibaction-iboutlet-iboutletcollection/)　·　NSHipster (Mattt)

# [IBAction / IBOutlet / IBOutlet​Collection](https://nshipster.com/ibaction-iboutlet-iboutletcollection/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  May 5^th, 2014
...
> Well actually, there’s more than meets the eye. Scrying the [Clang source code](https://llvm.org/svn/llvm-project/cfe/trunk/test/SemaObjC/iboutlet.m), we see that they’re actually defined by [**attribute**](https://nshipster.com/__attribute__/)-backed attributes:
