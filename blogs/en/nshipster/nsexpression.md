...
source_url: 'https://nshipster.com/nsexpression/'
original_language: en
published: 2013-07-08
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:13109ec57bc7778d'
translated: false
---

> 原文：[NSExpression](https://nshipster.com/nsexpression/)　·　NSHipster (Mattt)

# [NSExpression](https://nshipster.com/nsexpression/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  July 8^th, 2013
...
In addition to these built-in functions, it’s possible to invoke custom functions in an `NSExpression`. [This article by Dave DeLong](https://funwithobjc.tumblr.com/post/2922267976/using-custom-functions-with-nsexpression) describes the process.
