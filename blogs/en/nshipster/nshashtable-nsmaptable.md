...
source_url: 'https://nshipster.com/nshashtable-and-nsmaptable/'
original_language: en
published: 2013-08-19
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:63faa622e770e89f'
translated: false
---

> 原文：[NSHashTable & NSMapTable](https://nshipster.com/nshashtable-and-nsmaptable/)　·　NSHipster (Mattt)

# [NSHash​Table & NSMap​Table](https://nshipster.com/nshashtable-and-nsmaptable/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  August 19^th, 2013
...
> _Note:_ `NSMapTable`’s focus on strong and weak references means that Swift’s prevalent value types are a no go—reference types only, please.
