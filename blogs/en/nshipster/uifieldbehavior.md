...
source_url: 'https://nshipster.com/uifieldbehavior/'
original_language: en
published: 2018-09-24
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:a11412dd3dd46e3f'
translated: false
---

> 原文：[UIFieldBehavior](https://nshipster.com/uifieldbehavior/)　·　NSHipster (Mattt)

# [UIField​Behavior](https://nshipster.com/uifieldbehavior/)

Written by  [Jordan Morgan](https://nshipster.com/authors/jordan-morgan/)  September 24^th, 2018
...
Recently, `UIFieldBehavior` has been my dust-covered tome sitting idly inside UIKit. An API built to model complex field physics for UI elements isn’t a typical use case, nor is it likely to be the hot topic among fellow engineers. But, when you need it, you _need_ it, and not much else will do. And as purveyors of the oft-forgotten or seldom used, it serves as an excellent topic for this week’s NSHipster article.

---

With the design refresh of iOS in its 7th release, skeuomorphic design was famously sunset. In its place, a new paradigm emerged, in which UI controls were made to _feel_ like physical objects rather than simply look like them. New APIs would be needed to usher in this new era of UI design, and so we were introduced to [UIKit Dynamics](https://developer.apple.com/documentation/uikit/animation_and_haptics/uikit_dynamics).
...
![FaceTime](https://nshipster.com/assets/facetime-picture-in-picture-23cb401da9ed13fb26dd57fbb0d5b74c2a0d458bd65101bff06e881adcdc8a3992405c6fc69fdb0612c699266ec6301b0b44f930113ff2c6f2676ac57b5bda46.png)
...
![](https://nshipster.com/assets/uidynamicanimator-debug-adc60be676cf2290c75792ae6e9ae9346f4ab85cb86c1cb7a639f5aacd5da889c5a0cd95b67b4133469326ce41e954153d22058eb8449bdf07122c6798639a54.jpg)
...
Fortunately, we can mitigate all of these undesirable side effects. To wit, they are rather trivial fixes, but it’s the _reason_ why they’re needed that’s key.
...
iOS has largely parted ways with skeuomorphism, and user experience has come a long way as a result. We no longer necessarily require [green felt](https://nshipster.com/assets/game-center-felt-f76184c0d1369a629342eab45201ce0a8ec9042bc9526a69cf162921303f93ac65eaa6917881cebd8a6294b2b56d53000adbb211c00237c8e7923d594701a127.jpg) to know that Game Center represents games and how we can manage them.
