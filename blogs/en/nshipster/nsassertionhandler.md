...
source_url: 'https://nshipster.com/nsassertionhandler/'
original_language: en
published: 2013-02-25
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:22d970953716e551'
translated: false
---

> 原文：[NSAssertionHandler](https://nshipster.com/nsassertionhandler/)　·　NSHipster (Mattt)

# [NSAssertion​Handler](https://nshipster.com/nsassertionhandler/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  February 25^th, 2013
