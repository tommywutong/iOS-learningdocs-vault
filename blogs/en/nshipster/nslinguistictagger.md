...
source_url: 'https://nshipster.com/nslinguistictagger/'
original_language: en
published: 2012-10-22
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:117daffdafd8672f'
translated: false
---

> 原文：[NSLinguisticTagger](https://nshipster.com/nslinguistictagger/)　·　NSHipster (Mattt)

# [NSLinguistic​Tagger](https://nshipster.com/nslinguistictagger/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  October 22^nd, 2012
...
> What: _Pronoun_ is: _Verb_ the: _Determiner_ weather: _Noun_ in: _Preposition_ San Francisco: _PlaceName_
