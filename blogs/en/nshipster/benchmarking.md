...
source_url: 'https://nshipster.com/benchmarking/'
original_language: en
published: 2014-05-19
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:ea8dc84a7713c3cc'
translated: false
---

> 原文：[Benchmarking](https://nshipster.com/benchmarking/)　·　NSHipster (Mattt)

# [Benchmarking](https://nshipster.com/benchmarking/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  May 19^th, 2014
...
Because the underlying factors of everything from the operating system down to the metal itself are extremely variable, performance should be measured across a large number of trials. For most applications, something on the order of 10^5 to 10^8 samples should be acceptable.
