...
source_url: 'https://nshipster.com/uiappearance/'
original_language: en
published: 2013-03-11
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:5b9263276bf2d52e'
translated: false
---

> 原文：[UIAppearance](https://nshipster.com/uiappearance/)　·　NSHipster (Mattt)

# [UIAppearance](https://nshipster.com/uiappearance/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  March 11^th, 2013
...
As of iOS 7, UIAppearance now returns [`instancetype`](https://nshipster.com/instancetype/), which allows for code completion to work as expected. Huzzah!
