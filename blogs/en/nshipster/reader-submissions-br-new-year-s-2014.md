...
source_url: 'https://nshipster.com/new-years-2014/'
original_language: en
published: 2014-01-01
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:07f6a362d1879368'
translated: false
---

> 原文：[Reader Submissions -<br/> New Year's 2014](https://nshipster.com/new-years-2014/)　·　NSHipster (Mattt)

# [Reader Submissions - New Year's 2014](https://nshipster.com/new-years-2014/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  January 1^st, 2014
...
Let’s make this official: **NSHipster’s Objective-C trend of 2013 is code block evaluation assignment**. Recommended by both [Jim Kubicek](https://github.com/jkubicek) and [Maximilian Tagher](https://github.com/MaxGabriel) (citing [this blog post](https://cocoa-dom.tumblr.com/post/56517731293/new-thing-i-do-in-code) by [Dominik Wagner](https://github.com/monkeydom)), this trick does wonders to make code cleaner, safer, and more concise.
...
> Relatively little-known feature of iOS 7: you can turn off Apple’s own maps now with `MKTileOverlay`, `MKTileOverlayRenderer`, and `canReplaceMapContent`, unlike you could before with Apple or (pre-iOS 6) Google. And check out [MBXMapKit](https://github.com/mapbox/mbxmapkit) if you’d like to do it in one line of code.
...
And thanks to you, dear reader, for sticking with NSHipster for another 52 weeks. Between the [WWDC session](https://asciiwwdc.com/2013/sessions/228?q=NSHipster) and [the book](https://gumroad.com/l/nshipster), 2013 has been a bellwether year for NSHipster. Thank you for your support and enthusiasm for the site—it really does mean the world to me.
