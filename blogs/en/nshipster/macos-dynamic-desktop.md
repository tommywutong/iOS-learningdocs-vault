...
source_url: 'https://nshipster.com/macos-dynamic-desktop/'
original_language: en
published: 2018-10-01
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:48139cc04ec6949c'
translated: false
---

> 原文：[macOS Dynamic Desktop](https://nshipster.com/macos-dynamic-desktop/)　·　NSHipster (Mattt)

# [macOS Dynamic Desktop](https://nshipster.com/macos-dynamic-desktop/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  October 1^st, 2018
...
![](https://nshipster.com/assets/desktop-and-screen-saver-preference-pane-de72ffff1ebe52535992cb607d7412205eadbfce9e6b12de26b18bd0dc718aca93d35019cb260ef625ceaa73585477ff3494e15bbcd5a0a9c1209f40b12b1771.png)
...
_But how does it work, exactly?_  
...
![](https://nshipster.com/assets/go-to-library-desktop-pictures-84682c4aa20dda596e577962d971bc5dcd048e394bb01c6137dd548a5f3b0725fb4eba09c67756c0b27fe5547564e893b23d03c20c3aa3d15dae570a0df03f83.png)

In this directory, you should find a file named “Mojave.heic”. Double-click it to open it in Preview.

![](https://nshipster.com/assets/mojave-heic-f482f5c7a638d406d250963753f40fa37cbaefa2bbdfd07a5e9aea3616a85743369389de9e8dd60b02ee72ffb3a891bf5fd23fdad2f88a8cce25ae45c543b4b2.png)
...
![](https://nshipster.com/assets/mojave-dynamic-desktop-images-529add047cca1d994a44cf7800b3c0509ce208777b838f14b7b81ce86bf67fbaf3c1100ce6ed299ca5abd56c8e10d69de93113f727c3b74332683f2ddfa659db.png)

If we select “Tools \> Show Inspector” (⌘I), we get some general information about what we’re looking at:

![](https://nshipster.com/assets/mojave-heic-preview-info-8395088c4aa077c318aa02acf222e9d5dd33a343bd8b8f8f1174b7216552210f7e5887e71e7b9596453c5026187c136154c0b6155307dd352a47576bdd39ed45.png)
...
Most of us would look at that wall of text and quietly close the lid of our MacBook Pro. But, as some of you surely noticed, this text looks an awful lot like it’s [Base64-encoded](https://en.wikipedia.org/wiki/Base64).
...
The good news is that astronomers can tell you — with perfect accuracy — where the sun is in the sky for any location or time. The bad news is that the necessary calculations are [complicated](https://en.wikipedia.org/wiki/Position_of_the_Sun) to say the least.

Honestly, we don’t really understand it ourselves, and are pretty much just porting whatever code we manage to find online. After some trial and error, we were able to arrive at [something that seems to work](https://github.com/NSHipster/DynamicDesktop/blob/master/SolarPosition.playground) (PRs welcome!):
...
![](https://nshipster.com/assets/solar-position-watch-faces-aafbaaba2a0063df1c980d59a10166e53b37dfd64126cfbdc1c063449816f55dc79513d36fb1267feb5387037e88878f85cb976d739894220a7c0ebec635752e.jpg)

### Extending Our Understanding of XMP

Alright, enough astronomy for the moment. Let’s ground ourselves in something much more banal: _de facto_ XML metadata standards.

Remember the `hasXMP` metadata key from before? Yeah, _that_.
...
By default, the camera on most phones captures [Exif metadata](https://en.wikipedia.org/wiki/Exif) each time a photo is snapped. This metadata can include the time which the photo was taken and the GPS coordinates of the device at the time.
...
Mount your phone against a window, plug it into a charger, set the Camera to Timelapse mode, and hit the “Record” button. By extracting key frames from the resulting video, you can make your very own _bespoke_ Dynamic Desktop.
...
We’re personally fans of the the [24 Hour Wallpaper](https://www.jetsoncreative.com/24hourwallpaper/) app. If you have any other recommendations, [@ us on Twitter!](https://twitter.com/NSHipster/).
