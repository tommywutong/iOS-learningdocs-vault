...
source_url: 'https://nshipster.com/unit-testing/'
original_language: en
published: 2013-05-27
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:0786f79b723a7ad2'
translated: false
---

> 原文：[Unit Testing](https://nshipster.com/unit-testing/)　·　NSHipster (Mattt)

# [Unit Testing](https://nshipster.com/unit-testing/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  May 27^th, 2013
...
| [OCMock](https://github.com/erikdoe/ocmock) | [Erik Doernenburg](https://github.com/erikdoe) |
|---|---|
| [OCMockito](https://github.com/jonreid/OCMockito) | [Jon Reid](https://github.com/jonreid) |
| [Expecta](https://github.com/specta/expecta) | [Peter Jihoon Kim](https://github.com/petejkim) |
| [OCHamcrest](https://github.com/hamcrest/OCHamcrest) | [Jon Reid](https://github.com/jonreid) |
| [Specta](https://github.com/specta/specta) | [Peter Jihoon Kim](https://github.com/petejkim) |
| [Kiwi](https://github.com/kiwi-bdd/Kiwi) | [Allen Ding](https://github.com/allending) |
| [Cedar](https://github.com/pivotal/cedar) | [Pivotal Labs](https://github.com/pivotal) |
| [GHUnit](https://github.com/gh-unit/gh-unit/) | [Gabriel Handford](https://github.com/gabriel) |
