...
source_url: 'https://nshipster.com/nsnotification-and-nsnotificationcenter/'
original_language: en
published: 2013-12-02
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:54bee3a0eadab85f'
translated: false
---

> 原文：[NSNotification &<br/>NSNotificationCenter](https://nshipster.com/nsnotification-and-nsnotificationcenter/)　·　NSHipster (Mattt)

# [NSNotification &NSNotification​Center](https://nshipster.com/nsnotification-and-nsnotificationcenter/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  December 2^nd, 2013
...
All sorts of notifications are constantly passing through `NSNotificationCenter`.^* But like a tree falling in the woods, a notification is moot unless there’s something listening for it.
