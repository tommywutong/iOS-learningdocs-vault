...
source_url: 'https://nshipster.com/addressbookui/'
original_language: en
published: 2012-10-15
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:a656b832609fbba6'
translated: false
---

> 原文：[AddressBookUI](https://nshipster.com/addressbookui/)　·　NSHipster (Mattt)

# [Address​Book​UI](https://nshipster.com/addressbookui/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  October 15^th, 2012
