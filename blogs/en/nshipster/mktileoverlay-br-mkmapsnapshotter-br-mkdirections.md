...
source_url: 'https://nshipster.com/mktileoverlay-mkmapsnapshotter-mkdirections/'
original_language: en
published: 2014-02-03
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:90dc84002f19bf31'
translated: false
---

> 原文：[MKTileOverlay,<br/>MKMapSnapshotter &<br/> MKDirections](https://nshipster.com/mktileoverlay-mkmapsnapshotter-mkdirections/)　·　NSHipster (Mattt)

# [MKTile​Overlay,MKMap​Snapshotter &MKDirections](https://nshipster.com/mktileoverlay-mkmapsnapshotter-mkdirections/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  February 3^rd, 2014
...
> Just like [OpenStreetMap](https://www.openstreetmap.org) and [Google Maps](https://maps.google.com), MKTileOverlay uses [spherical mercator projection (EPSG:3857)](https://en.wikipedia.org/wiki/Mercator_projection#The_spherical_model).
