...
source_url: 'https://nshipster.com/launch-options/'
original_language: en
published: 2013-12-16
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:424d301aeff9cd86'
translated: false
---

> 原文：[UIApplicationDelegate launchOptions](https://nshipster.com/launch-options/)　·　NSHipster (Mattt)

# [UIApplication​Delegate launch​Options](https://nshipster.com/launch-options/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  December 16^th, 2013
