...
source_url: 'https://nshipster.com/swift-literals/'
original_language: en
published: 2014-08-18
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:7b7b7050c3735148'
translated: false
---

> 原文：[Swift Literals](https://nshipster.com/swift-literals/)　·　NSHipster (Mattt)

# [Swift Literals](https://nshipster.com/swift-literals/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  August 22^nd, 2018 ([revised](https://github.com/nshipster/articles/commits/master/2014-08-18-swift-literals.md))

In 1911, linguist [Franz Boas](https://en.wikipedia.org/wiki/Franz_Boas) observed that speakers of [Eskimo–Aleut languages](https://en.wikipedia.org/wiki/Eskimo%E2%80%93Aleut_languages) used different words to distinguish falling snowflakes from snow on the ground. By comparison, English speakers typically refer to both as “snow,” but create a similar distinction between raindrops and puddles.
...
![Swift Playgrounds Color Literal Picker](https://nshipster.com/assets/color-literal-picker-8d09cf93b59ebcf49dfb3c41dfd000d407d1c15f644004819818470c86b789bd3090e0efa327f2f0b2c2036f498d56dc60f63d95bbfc31eea93d11f18f2e295d.png)
...
At the time of writing, [Swift Evolution proposal 0200](https://github.com/apple/swift-evolution/blob/master/proposals/0200-raw-string-escaping.md) is in active review. If it’s accepted, future versions of Swift will support “raw” strings, or string literals that ignores escape sequences.
