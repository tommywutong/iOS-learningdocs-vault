...
source_url: 'https://nshipster.com/instancetype/'
original_language: en
published: 2012-12-10
status: active
license: CC BY-NC（页脚明示）→ 可非商业再分发，须署名
archived_at: 2026-07-27
content_hash: 'sha256:f0ae5a9c8f56ae05'
translated: false
---

> 原文：[instancetype](https://nshipster.com/instancetype/)　·　NSHipster (Mattt)

# [instancetype](https://nshipster.com/instancetype/)

Written by  [Mattt](https://nshipster.com/authors/mattt/)  December 10^th, 2012
...
Whether or not this becomes an accepted convention in Objective-C, it’s fascinating to how a low-level feature like `instancetype` can be used to change shape of the language (in this case, making it look more like [C#](https://en.wikipedia.org/wiki/C_Sharp_(programming_language))).
