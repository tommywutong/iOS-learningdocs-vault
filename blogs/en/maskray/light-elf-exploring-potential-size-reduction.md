...
source: MaskRay (宋方睿)
source_key: maskray
source_url: 'https://maskray.me/blog/2024-04-01-light-elf-exploring-potential-size-reduction'
original_language: en
published: 2024-04-01
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:226eff9574b3fc89'
translated: false
---

> 原文：[Light ELF: exploring potential size reduction](https://maskray.me/blog/2024-04-01-light-elf-exploring-potential-size-reduction)　·　MaskRay (宋方睿)

[2024-04-01](https://maskray.me/blog/2024-04-01-light-elf-exploring-potential-size-reduction)
...
Light ELF utilizes [CREL](https://maskray.me/blog/2024-03-09-a-compact-relocation-format-for-elf) for relocations. [REL and RELA](https://maskray.me/blog/2024-01-14-exploring-object-file-formats#relocations) from traditional ELF are unused.
...
Traditional ELF (version 1) [section header tables](https://maskray.me/blog/2024-01-14-exploring-object-file-formats#sections) can be large. Light ELF addresses this through a compact section header table format signaled by `e_shentsize == 0` in the ELF header.

[A compact section header table for ELF](https://maskray.me/blog/2024-03-31-a-compact-section-header-table-for-elf) contains the detail. Its current version is copied below for your convenience.
...
Like other sections, [symbol table](https://maskray.me/blog/2024-01-14-exploring-object-file-formats#symbols) and string table sections (`SHT_SYMTAB` and `SHT_STRTAB`) can be [compressed through `SHF_COMPRESSED`](https://maskray.me/blog/2023-07-07-compressed-arbitrary-sections). However, compressing the dynamic symbol table (`.dynsym`) and its associated string table (`.dynstr`) is not recommended.
