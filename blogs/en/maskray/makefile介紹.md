...
source: MaskRay (宋方睿)
source_key: maskray
source_url: 'https://maskray.me/blog/2012-02-25-introduction-to-makefile'
original_language: en
published: 2012-02-25
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5a0b06789ee01e76'
translated: false
---

> 原文：[Makefile介紹](https://maskray.me/blog/2012-02-25-introduction-to-makefile)　·　MaskRay (宋方睿)

[2012-02-25](https://maskray.me/blog/2012-02-25-introduction-to-makefile)

# Makefile介紹

[slide下載](https://maskray.me/static/introduction_to_makefile.pdf)
...
- This slide incorporate some stuff from Roded Sharan's [http://www.cs.tau.ac.il/~roded/courses/softp-b06/Makefile.ppt](http://www.cs.tau.ac.il/~roded/courses/softp-b06/Makefile.ppt)
- Markdown [http://daringfireball.net/projects/markdown/](http://daringfireball.net/projects/markdown/) in which this slide source is written.
- Pandoc [http://johnmacfarlane.net/pandoc/](http://johnmacfarlane.net/pandoc/) by which this slide is generated.
- Haskell [http://www.haskell.org/](http://www.haskell.org/) in which Pandoc is implemented.

## References

- GNU Make Manual [http://www.gnu.org/software/make/manual/](http://www.gnu.org/software/make/manual/)
