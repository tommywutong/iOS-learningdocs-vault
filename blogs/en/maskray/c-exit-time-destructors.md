...
source: MaskRay (宋方睿)
source_key: maskray
source_url: 'https://maskray.me/blog/2024-03-17-c++-exit-time-destructors'
original_language: en
published: 2024-03-17
status: active
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:9bfe82b96bb75982'
translated: false
---

> 原文：[C++ exit-time destructors](https://maskray.me/blog/2024-03-17-c++-exit-time-destructors)　·　MaskRay (宋方睿)

[2024-03-17](https://maskray.me/blog/2024-03-17-c++-exit-time-destructors)
...
- July 2018 discussion: [https://discourse.llvm.org/t/rfc-suppress-c-static-destructor-registration/49128](https://discourse.llvm.org/t/rfc-suppress-c-static-destructor-registration/49128)
- Patch: [https://reviews.llvm.org/D50994](https://reviews.llvm.org/D50994) with follow-up [https://reviews.llvm.org/D54344](https://reviews.llvm.org/D54344)
- Documentation: [https://clang.llvm.org/docs/AttributeReference.html#no-destroy](https://clang.llvm.org/docs/AttributeReference.html#no-destroy)
