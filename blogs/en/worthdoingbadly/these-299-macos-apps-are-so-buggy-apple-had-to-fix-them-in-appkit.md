...
source_url: 'https://worthdoingbadly.com/appkitcompat/'
...
> 原文：[These 299 macOS apps are so buggy, Apple had to fix them in AppKit](https://worthdoingbadly.com/appkitcompat/)　·　worthdoingbadly (Zhuowei Zhang)
...
Here’s the [full list of bundle IDs](https://worthdoingbadly.com/assets/blog/appkitcompat/appkit_processed.html), along with the functions that checks for them, and the first caller to those functions. It’s also available in [CSV format](https://worthdoingbadly.com/assets/blog/appkitcompat/appkit.csv).
...
> 
> ![](https://worthdoingbadly.com/assets/blog/appkitcompat/b3ll_tweet.jpg)
> 
...
![](https://worthdoingbadly.com/assets/blog/appkitcompat/nsopenglcontext.png)
...
![](https://worthdoingbadly.com/assets/blog/appkitcompat/nsbundle_unload.png)
