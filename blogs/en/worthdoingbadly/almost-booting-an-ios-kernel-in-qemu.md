...
source_url: 'https://worthdoingbadly.com/xnuqemu/'
...
> 原文：[Almost booting an iOS kernel in QEMU](https://worthdoingbadly.com/xnuqemu/)　·　worthdoingbadly (Zhuowei Zhang)
...
_This is Part 1 of a series on the iOS boot process. [Part 2 is here](https://worthdoingbadly.com/xnuqemu2/). **[Sign up with your email](http://eepurl.com/duBpCH)** to be the first to read new posts._
