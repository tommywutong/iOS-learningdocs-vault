...
source_url: 'https://worthdoingbadly.com/gpupassthrough/'
...
> 原文：[Use GPU passthrough with Intel integrated graphics to accelerate QEMU on Fedora](https://worthdoingbadly.com/gpupassthrough/)　·　worthdoingbadly (Zhuowei Zhang)
...
I [made a script](https://worthdoingbadly.com/assets/blog/gpupassthrough/prepareIntelGPUPassthrough.sh) that automates these steps: you can just run, in an SSH session,
