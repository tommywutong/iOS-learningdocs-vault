...
source_url: 'https://worthdoingbadly.com/xnuqemu3/'
...
> 原文：[Booting a macOS Apple Silicon kernel in QEMU](https://worthdoingbadly.com/xnuqemu3/)　·　worthdoingbadly (Zhuowei Zhang)
...
!["No." - Craig Federighi, WWDC 2018](https://worthdoingbadly.com/assets/blog/xnuqemu3/wwdc2018_no.jpg)
...
I already had a [modified QEMU to boot an iOS kernel](https://worthdoingbadly.com/xnuqemu2/) (which has inspired others, such as [Aleph Security](https://alephsecurity.com), to build much better open-source iOS emulation platforms)
...
Like the [iOS in QEMU experiments](https://worthdoingbadly.com/xnuqemu2/), I first disabled every piece of hardware in the device tree except the serial port.
