...
source_url: 'https://worthdoingbadly.com/disablesameorigin/'
...
> 原文：[Disable Same Origin Policy in iOS WKWebView with private API](https://worthdoingbadly.com/disablesameorigin/)　·　worthdoingbadly (Zhuowei Zhang)
