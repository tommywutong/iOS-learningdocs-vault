...
source_url: 'https://worthdoingbadly.com/aixqemu/'
...
> 原文：[Tutorial - emulate AIX 7.2 in QEMU](https://worthdoingbadly.com/aixqemu/)　·　worthdoingbadly (Zhuowei Zhang)

# Tutorial - emulate AIX 7.2 in QEMU

Sep 6, 2018

QEMU 3.0.0 can boot IBM’s AIX to a shell prompt. AIX is IBM’s version of Unix for their Power Systems line of PowerPC servers. I’ve been [researching emulation](https://worthdoingbadly.com/xnuqemu2/), so I wrote a tutorial for running AIX on your computer.
...
**Step 2**: (optional) If you want the Diagnostics disk to give you an AIX shell prompt instead of running diagnostics, apply [this patch](https://worthdoingbadly.com/assets/blog/aixqemu/patch_cd72220.py) to your ISO file:
...
The full boot log [can be found here](https://worthdoingbadly.com/assets/blog/aixqemu/aixboot.txt).
