...
source_url: 'https://worthdoingbadly.com/familytree/'
...
> 原文：[How a kids’ novel inspired me to simulate a gene drive on 86 million genealogy profiles](https://worthdoingbadly.com/familytree/)　·　worthdoingbadly (Zhuowei Zhang)
...
I plugged five initial ratios into their formula: **1%, 5%, 10%, 15%, 20%**. (5%, if you recall, is the estimated prevelance for witchcraft given in the books). See [Appendix A](https://worthdoingbadly.com/assets/blog/familytree/appendix.html#appendix-a-gene-drive-math) for the calculations.
...
![array of 6 cells; the two rightmost cells are green](https://worthdoingbadly.com/assets/blog/familytree/sim_diagram_1.png)

Now, for each generation:

1. I shuffle the list of people.

![the above array shuffled](https://worthdoingbadly.com/assets/blog/familytree/sim_diagram_2.png)
...
![Each pair in the shuffled array produces two offspring](https://worthdoingbadly.com/assets/blog/familytree/sim_diagram_3.png)
...
![Simulation result for starting ratios of 1, 5, 10, 15, and 20 percent, with fixed population size.](https://worthdoingbadly.com/assets/blog/familytree/sim_twochildren.png)
...
![Graph of number of people alive for each year in the dataset](https://worthdoingbadly.com/assets/blog/familytree/familinx_aliveperyear.png)
...
![Graph of male/female ratio in the dataset for each year; starts at 56% and drops to 50%](https://worthdoingbadly.com/assets/blog/familytree/familinx_malefemaleratio.png)
...
![Picture of a very simple family tree, with each node marked with a number](https://worthdoingbadly.com/assets/blog/familytree/testgraph_num.dot.png)

Each person is assigned a numerical ID, because that’s how anonymized Familylinx data identifies each individual. (Also, for this made-up example tree, to avoid spoilers. [Here’s the version with spoilers](https://worthdoingbadly.com/assets/blog/familytree/testgraph.dot.png).)
...
![Same family tree with all descendants of one ancestor marked in green](https://worthdoingbadly.com/assets/blog/familytree/testgraph_num_onlyAmbersonMother.dot.png)
...
![Same family tree with two ancestors and their descendants highlighted](https://worthdoingbadly.com/assets/blog/familytree/testgraph_num_AmbersonMotherAndCollingwoodMother.dot.png)
...
![Graph of number of people with the trait](https://worthdoingbadly.com/assets/blog/familytree/familinx_absolute_descendants.png)
...
![Graph of ratio of people with the trait](https://worthdoingbadly.com/assets/blog/familytree/familinx_relative_descendants.png)
...
![Picture of the simple family tree, with almost all nodes behind half-transparency](https://worthdoingbadly.com/assets/blog/familytree/testgraph_num_noauntcousins.png)
