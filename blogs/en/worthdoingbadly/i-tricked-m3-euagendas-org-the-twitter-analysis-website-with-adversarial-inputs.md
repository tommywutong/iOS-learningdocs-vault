...
source_url: 'https://worthdoingbadly.com/nn-adversarial/'
...
> 原文：[I tricked m3.euagendas.org, the Twitter analysis website, with adversarial inputs](https://worthdoingbadly.com/nn-adversarial/)　·　worthdoingbadly (Zhuowei Zhang)
...
![Screenshot of two m3.euagendas.org results for two Twitter accounts, with "Age: >=40" circled on the right one](https://worthdoingbadly.com/assets/blog/nn-adversarial/cover.png)
...
- your age
- gender
- whether you’re a corporate account (Brand™)
...
![screenshot of m3inference on @AskVoco](https://worthdoingbadly.com/assets/blog/nn-adversarial/askvoco.png)

Here’s what it outputs for a person: [@zijianwang30](https://twitter.com/zijianwang30), one of the authors who built m3inference.

![screenshot of m3inference on @zijianwang30](https://worthdoingbadly.com/assets/blog/nn-adversarial/zijianwang30.png)
...
![screenshot of m3inference on @zhuowei, saying that I'm a corporate account](https://worthdoingbadly.com/assets/blog/nn-adversarial/zhuowei_is_a_brand.png)
...
![screenshot of m3inference on @1zhuowei, with @zhuowei's age results besides: it's a lot less confident about my age group now](https://worthdoingbadly.com/assets/blog/nn-adversarial/1zhuowei_age.png)
...
Surely it can’t be that simple: there’s no way just swapping the avatar would change its prediction of my account from Brand™ to real person.

![screenshot of m3inference on @1zhuowei, with a new avatar (rocket taking off): "Non-Org" with 99% confidence](https://worthdoingbadly.com/assets/blog/nn-adversarial/new_avatar.png)
...
![screenshot of neural network from paper](https://worthdoingbadly.com/assets/blog/nn-adversarial/network.png)
...
![Original](https://worthdoingbadly.com/assets/blog/nn-adversarial/2zhuowei_224x224.png) ![Result - looks the same](https://worthdoingbadly.com/assets/blog/nn-adversarial/adversarial_output.png)

My reaction:

![Pam from "The Office" saying "They're the same picture"](https://worthdoingbadly.com/assets/blog/nn-adversarial/same_picture.jpg)
...
![the plume shows a bunch of wavy changes, resembling hair, or wrinkles](https://worthdoingbadly.com/assets/blog/nn-adversarial/adversarial_noise_enhance.png) ![a face drawn in the plume](https://worthdoingbadly.com/assets/blog/nn-adversarial/adversarial_silhouette.png)
...
![m3inference result on @2Zhuowei: Age: 19-29](https://worthdoingbadly.com/assets/blog/nn-adversarial/before_2zhuowei.png)

With the modified picture, m3inference says my age is greater than 40 with 64.49% accuracy:

![m3inference result on @2Zhuowei: Age: >=40](https://worthdoingbadly.com/assets/blog/nn-adversarial/after_2zhuowei.png)
...
Finally, transforming the image before providing it as input works well for rejecting adversarial inputs: just the JPEG compression used by Twitter lowered m3inference’s certainty from 90% to 64.49%. However, as more transforms are added, the neural network [becomes worse](https://devblogs.nvidia.com/combating-adversarial-attacks-barrage-random-transforms/) at recognizing actual valid input.
