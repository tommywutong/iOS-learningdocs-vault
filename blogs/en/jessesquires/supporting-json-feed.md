...
A couple of weeks ago I finally got around to adding support for Brent Simmons’ and Manton Reece’s [JSON Feed](https://jsonfeed.org/version/1) for this blog. You can subscribe to the feed [here](https://www.jessesquires.com/feed.json). It was simple and fun to implement.
...
That’s all. When you run `jekyll build`, your [full feed](https://www.jessesquires.com/feed.json) will be generated. Now, go add JSON Feed support to your blog, too.
