...
source_url: 'https://www.jessesquires.com/blog/2022/02/01/decimal-vs-double/'
original_language: en
published: 2022-02-01
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:c5339273136becb8'
translated: false
---

> 原文：[When should you use Decimal instead of Double?](https://www.jessesquires.com/blog/2022/02/01/decimal-vs-double/)　·　Jesse Squires
...
> `Decimal` is for when you care about _decimal_ values. Money is a very common example. If it’s critical that 0.1 + 0.2 is _precisely_ 0.3, then you need a `Decimal`. If, on the other hand, you need 1/3 * 3 to _precisely_ equal 1, then you need a rational type.
> 
...
> 
> Double isn’t an imprecise number format. It’s _extremely_ precise. It just isn’t in base-10, so some common base-10 values are repeating fractions. If 1/3 were a really common value, then base-10 would be horrible, and we’d talk about storing in base-3 to avoid losing precision.
