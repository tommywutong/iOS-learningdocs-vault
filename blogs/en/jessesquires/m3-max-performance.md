...
After [setting up my new M3 MacBook Pro](https://www.jessesquires.com/blog/2023/12/04/new-m3-mbp/), I decided to do some quick performance comparisons with my old Intel machine. Anecdotally, I would have told you that it is insanely faster but seeing the data made my jaw drop.
...
Do I really _need_ an M3 Max? Probably not, but I waited until the _third generation_ of M-series chips to upgrade, I wanted to make it count, and I want to keep this machine for years to come. Also, as [an indie dev](https://www.jessesquires.com/blog/2023/04/10/going-indie/) I get to write this off on my taxes as a business expense. :)
