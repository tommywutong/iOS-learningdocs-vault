...
##### [Update](#updated-09-february-2018)  _09 February 2018_

Apparently the direct links to the instructions below are not working, even if you are logged-in to your Apple developer account. You can find all sysdiagnose instructions on the [official Bug Reporting page](https://developer.apple.com/bug-reporting/profiles-and-logs/?name=sysdiagnose).

##### [Update](#updated-05-january-2019)  _05 January 2019_

Many thanks to Michael Prentice for [pointing out](https://github.com/jessesquires/jessesquires.com/issues/87#issuecomment-450595104) that you can also run sysdiagnose on the iOS simulator. To do this, run `xcrun simctl diagnose` and the output will be placed in `/private/tmp/`.

![Apple Bug Report](https://www.jessesquires.com/img/blog/apple-bug-report.png)

<sub>[Source](https://dribbble.com/shots/3617982-Apple-Bug-Report-iOS)</sub>
...
Peter Steinberger already wrote a great guide to [writing good bug reports](https://pspdfkit.com/blog/2016/writing-good-bug-reports/). In addition to all of his excellent advice, often attaching a sysdiagnose can be a huge help — even if you have reliable steps to reproduce or a specific crash report. A sysdiagnose contains additional helpful information. It’s easy to do and available on all platforms.
