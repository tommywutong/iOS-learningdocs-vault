...
UIKit provides two diffable data source APIs, one for [collections](https://developer.apple.com/documentation/uikit/uicollectionviewdiffabledatasource-9tqpa) and one for [tables](https://developer.apple.com/documentation/uikit/uitableviewdiffabledatasource-2euir). Recently, while working on [ReactiveCollectionKit](https://www.jessesquires.com/blog/2024/10/18/introducing-reactivecollectionskit/), I noticed that the APIs were updated for Swift Concurrency in the iOS 18 SDK, but the annotations were inconsistent with the documentation.
