...
source_url: 'https://www.jessesquires.com/blog/2021/11/13/xcode-13-device-orientation-bug/'
original_language: en
published: 2021-11-13
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:cdffb311559e567a'
translated: false
---

> 原文：[Xcode 13 device orientation options bug](https://www.jessesquires.com/blog/2021/11/13/xcode-13-device-orientation-bug/)　·　Jesse Squires
...
![Xcode project device orientation options](https://www.jessesquires.com/img/blog/xcode13-device-orientation.jpg)

<sub>Xcode project "Device Orientation" options.</sub>

The way this works — or _should work_ — is that it modifies the underlying property list for your app, the `Info.plist` file. Specifically, these check boxes should update the value for the `UISupportedInterfaceOrientations` key. If you have iPhone-specific or iPad-specific orientation values, the keys are `UISupportedInterfaceOrientations~iphone` and `UISupportedInterfaceOrientations~ipad`, respectively.
