...
source_url: 'https://www.jessesquires.com/blog/2021/10/24/git-aliases-to-improve-productivity/'
original_language: en
published: 2021-10-24
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:1d750a81ac4e6dd8'
translated: false
---

> 原文：[Git aliases to improve productivity](https://www.jessesquires.com/blog/2021/10/24/git-aliases-to-improve-productivity/)　·　Jesse Squires

Using [git aliases](https://git-scm.com/book/en/v2/Git-Basics-Git-Aliases) came up at work the other day. It’s been awhile since [I’ve written about git](https://www.jessesquires.com/blog/2017/08/08/customizing-git-log/), so I thought it might be a good time to share all the aliases I’ve built up over the years.
...
Below is a list of my current git aliases. That is, the output of `git config --global -l | grep alias` — for which I have created an alias, of course. I’ll list each alias with a brief description of what it does and the command to add it your git config.
...
If you have any favorite aliases that are not listed here, [please let me know](https://twitter.com/jesse_squires)!
...
This produces a very pretty log, similar to `hg smartlog`, which [I wrote about in-depth here](https://www.jessesquires.com/blog/2017/08/08/customizing-git-log/). It display the commit hash, date, author, and title in a beautiful, easy to read format. This is probably my favorite and most-used alias.
