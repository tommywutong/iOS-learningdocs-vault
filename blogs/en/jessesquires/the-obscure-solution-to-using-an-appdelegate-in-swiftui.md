...
source_url: 'https://www.jessesquires.com/blog/2021/11/13/using-an-appdelegate-in-swiftui/'
original_language: en
published: 2021-11-13
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b1800446a2225aa9'
translated: false
---

> 原文：[The obscure solution to using an AppDelegate in SwiftUI](https://www.jessesquires.com/blog/2021/11/13/using-an-appdelegate-in-swiftui/)　·　Jesse Squires
...
I went down this path [while investigating this bug](https://www.jessesquires.com/blog/2021/11/13/xcode-13-device-orientation-bug/). It turns out I don’t need this solution. However, I learned some useful information to share and it helped me articulate some of SwiftUI’s shortcomings.
...
I’m not sure if I would have arrived at this solution — which made me realize: this is _rather obscure_ when you think about it. This situation highlights two significant problems with SwiftUI: discoverability of SwiftUI APIs and the framework’s sparse documentation.
