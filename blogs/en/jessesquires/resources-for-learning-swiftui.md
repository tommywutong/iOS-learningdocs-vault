...
Despite not yet using SwiftUI, I _do want to_. And I know that eventually, I will _need_ to. That is why I have been reading blog posts and [keeping notes](https://github.com/jessesquires/TIL/blob/main/apple_platform/swiftui.md). All of these notes live in my public [TIL repo](https://github.com/jessesquires/TIL). Side note: it has been really great to move all of this content out of my OmniFocus projects and into these public notes. It is a better organizational practice for me (I now just link to these notes in OmniFocus) and it makes them available for others to learn, too. A win-win. You can find the nicely rendered [HTML page here](https://jessesquires.github.io/TIL/apple_platform/swiftui.html).

Also, if you have resources you would like to share, [pull requests are welcome](https://github.com/jessesquires/TIL/pulls).

For the purposes of this post, I am going to reproduce the current notes I have below. However, if you want to stay updated you should [watch the repo](https://github.com/jessesquires/TIL) on GitHub for changes, or [bookmark this page](https://jessesquires.github.io/TIL/apple_platform/swiftui.html). I intend to keep updating these notes.
