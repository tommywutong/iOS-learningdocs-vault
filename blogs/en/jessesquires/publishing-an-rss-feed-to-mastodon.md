...
source_url: 'https://www.jessesquires.com/blog/2022/12/15/rss-to-mastodon/'
original_language: en
published: 2022-12-15
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:6c908f1549587c1d'
translated: false
---

> 原文：[Publishing an RSS feed to Mastodon](https://www.jessesquires.com/blog/2022/12/15/rss-to-mastodon/)　·　Jesse Squires
...
3. Provide the URL. For example, [https://ifttt.com](https://ifttt.com).
...
1. Create a new Zap.
2. Add the “RSS by Zapier” action with “New Item in Feed” as the event.
3. Add your feed URL.
4. For the next action, choose “Webhooks by Zapier”.
5. Set the event to “POST”.
6. Set the URL to `https://mastodon.social/api/v1/statuses?access_token=YOUR_ACCESS_TOKEN`.
7. Payload Type should be “form”.
8. For the Data section, enter “status” as the key.
9. For the value, select the feed item title and link. (This is the content to be posted.)
...
2. Add the “New feed item” RSS action.
3. Enter your feed URL.
4. Next, add the “Make a web request” webhooks action.
5. Set the URL to `https://mastodon.social/api/v1/statuses`.
6. Set the Method to “POST”.
7. Set the Content Type to `application/x-www-form-URLencoded`.
8. Set Additional Headers to “Authorization: Bearer YOUR_ACCESS_TOKEN”
9. Set the body to “status={{EntryTitle}} {{EntryUrl}}”
10. Save and activate!
