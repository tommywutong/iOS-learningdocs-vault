...
source_url: 'https://www.jessesquires.com/blog/2021/03/26/a-better-approach-to-writing-a-userdefaults-property-wrapper/'
original_language: en
published: 2021-03-26
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:8c96a868c231817a'
translated: false
---

> 原文：[A better approach to writing a UserDefaults Property Wrapper](https://www.jessesquires.com/blog/2021/03/26/a-better-approach-to-writing-a-userdefaults-property-wrapper/)　·　Jesse Squires
...
If you think you know everything there is to know about `UserDefaults`, wait until you read David Smith’s excellent (“unofficial”) documentation, [_NSUserDefaults in Practice_](http://dscoder.com/defaults.html). You will likely learn something new.
...
Related to the “default value problem” is the use of optionals. Most developers agree that we should try to [eliminate optionals in Swift as much as possible](https://www.jessesquires.com/blog/2015/04/06/swift-failable-initializers-revisited/). If you provide a default value using `register(defaults:)`, then retrieving it will _always_ return _something_ (i.e., a non-optional value). This means that in many cases we can be sure a value exists in `UserDefaults`.
...
Again, from [_NSUserDefaults in Practice_](http://dscoder.com/defaults.html):
...
2. Eliminates having to deal with optionals when possible
3. Provide a practical, simple, and lightweight implementation
...
All other types can use the generic methods `set(_:, forKey:)` and `object(forKey:)` and work as expected. Very odd. Upon re-reading [_NSUserDefaults in Practice_](http://dscoder.com/defaults.html), I learned why:
