...
source_url: 'https://www.jessesquires.com/blog/2021/11/03/xcode-13-framework-test-fail/'
original_language: en
published: 2021-11-03
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:511aa9f2a60869ce'
translated: false
---

> 原文：[Workaround: Xcode 13 failure after running framework project tests](https://www.jessesquires.com/blog/2021/11/03/xcode-13-framework-test-fail/)　·　Jesse Squires
...
This week, I’ve been updating CI for all of my open source projects to use Xcode 13 — specifically Xcode 13.1 (13A1030d). My projects use GitHub Actions, so I expected this to be a quick change like usual — update the workflow to use the latest Xcode, specify the latest simulators in `xcodebuild`, open a pull request to make sure everything works, then merge.
...
![Xcode 13 test failure](https://www.jessesquires.com/img/blog/xcode-13-test-fail.png)

<sub>Xcode 13 test failure for framework tests</sub>
...
All platforms are affected — iOS, tvOS, watchOS, and macOS. It appears to be some issue with code signing and/or the debugger? I don’t really understand it. However, my code signing settings have not changed for any of my projects since Xcode 12 — which, again, did not experience this issue. The signing settings are:
...
For iOS, the workaround I found was [running tests via a Swift package instead](https://www.jessesquires.com/blog/2021/11/03/swift-package-ios-tests/). Again, this is a framework project. I distribute my libraries via SwiftPM and CocoaPods, so I already had a `Package.swift` file for this project.

Because I also use an Xcode project, on GitHub Actions I needed to delete that project first. This will force `xcodebuild` [to use the Swift package](https://www.jessesquires.com/blog/2021/11/03/swift-package-ios-tests/) instead.
...
Again, [using Foil as an example](https://github.com/jessesquires/Foil), I can reproduce this consistently for all platforms — iOS, tvOS, watchOS, and macOS.
