...
source_url: 'https://www.jessesquires.com/blog/2021/12/03/please-dont-copy-my-site/'
original_language: en
published: 2021-12-03
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:b64735ec4d644e3c'
translated: false
---

> 原文：[Please don't copy my site. Here's a template!](https://www.jessesquires.com/blog/2021/12/03/please-dont-copy-my-site/)　·　Jesse Squires

As many of you know, [this site is open source](https://github.com/jessesquires/jessesquires.com). Most of the time, this does not cause any trouble. But occasionally, it does.

The primary reason for open sourcing my blog is to encourage feedback (by [opening](https://github.com/jessesquires/jessesquires.com/issues/new) a GitHub issue) and to allow folks to submit corrections if I make a mistake or publish a typo. This has been a great experience overall. Using GitHub issues for [comments and feedback](https://github.com/jessesquires/jessesquires.com/issues?q=label%3A%22blog+comments+%26+questions%22+is%3Aclosed) is much better than trying to implement and maintain a “real” commenting system, in my opinion. And GitHub’s pull request workflow makes submitting a correction easy.

The other main reason for making this site open source is to give other folks an opportunity to learn. I recently [wrote about starting your own blog](https://www.jessesquires.com/blog/2021/11/01/how-to-start-a-blog/) as well. However, this is the part that has caused some headaches.
...
However, most of the time, this copying is not done with malicious intent — I realize that. And if that’s what you’ve done accidentally — that’s ok! We can fix it. If I discover a fork or direct copy, usually I can open an issue or submit a pull request to help the other person resolve the issue. It’s not ideal, because it consumes some of my time, but ultimately I’m happy to have the issues resolved and the other person is happy to have a working website.

### How to use my open source website, _The Right Way™_

What you **do not** want to do is fork or copy my site, because this approach is _very_ prone to error. There are _many_ personal files to delete and configurations to change — like my PGP public key and CV information. Perhaps the most significant issue is forgetting to remove my analytics code, and then you’ll be spamming my server with imposter data.
