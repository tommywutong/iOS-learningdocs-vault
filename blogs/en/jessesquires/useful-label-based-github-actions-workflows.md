...
source_url: 'https://www.jessesquires.com/blog/2021/08/24/useful-label-based-github-actions-workflows/'
original_language: en
published: 2021-08-24
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:5d43f053c06c4518'
translated: false
---

> 原文：[Useful label-based GitHub Actions workflows](https://www.jessesquires.com/blog/2021/08/24/useful-label-based-github-actions-workflows/)　·　Jesse Squires
...
##### [Update](#updated-21-march-2022)  _21 March 2022_

Thanks to my friend [Ben Asher](https://benasher.co) for [sharing](https://twitter.com/benasher44/status/1503460237331734528) an improvement to the ‘Do Not Merge’ workflow, which can be rewritten **without** using third-party actions. You can find it below.
