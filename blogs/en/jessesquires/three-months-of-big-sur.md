...
source_url: 'https://www.jessesquires.com/blog/2021/06/01/three-months-of-big-sur/'
original_language: en
published: 2021-06-01
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:a594aa217fdf6c82'
translated: false
---

> 原文：[Three months of Big Sur](https://www.jessesquires.com/blog/2021/06/01/three-months-of-big-sur/)　·　Jesse Squires
...
Generally, my experiences upgrading over the past few years have not been great — really, ever since the California-themed releases started. The initial releases never feel as polished as they used to. So I usually wait until the .1 release. This time I waited even longer. I really do miss the stability and polish of the [Big Cat-themed versions of Mac OS X](http://morrick.me/archives/9220).
...
- My [Time Machine bug](https://www.jessesquires.com/blog/2021/04/07/time-machine-error-45-big-sur/) appears to be fixed!
...
- Some of the new icons for Apple’s apps look great — Safari, Xcode, Preview, Contacts, TextEdit, Time Machine, Font Book. Other icons, however, are just fucking ridiculous — QuickTime, Keychain Access, Disk Utility. I mean… what is that.
...
- Speaking of trash — Mac Catalyst apps. [They are just terrible](https://pilky.me/apples-developer-app/). Two quick examples:
...
A reader [has pointed out](https://github.com/jessesquires/jessesquires.com/issues/150) that Books.app is, in fact, _not_ a Catalyst app. So it really is just that bad. You can confirm using `otool -L`.

#### * * *

Despite the issues, I would still say I enjoy Big Sur. It works. It hasn’t crashed or lost any of my data. My gripes are about tiny cuts and the UI regressions — all of which can be easily fixed. The problem, however, is if Apple is committed to fixing them or willing to ignore them for multiple years — [like those keyboards](https://www.jessesquires.com/blog/2020/09/15/dont-forget-the-keyboards/).
