...
source_url: 'https://www.jessesquires.com/blog/2021/03/09/fixing-macos-search-bugs/'
original_language: en
published: 2021-03-09
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:590dda0130b5b706'
translated: false
---

> 原文：[Fixing macOS Big Sur search bugs](https://www.jessesquires.com/blog/2021/03/09/fixing-macos-search-bugs/)　·　Jesse Squires
...
[OnyX](https://titanium-software.fr/en/onyx.html) has been around for ages — since Mac OS X Jaguar 10.2! It is an indispensable utility and one of the first apps that I install on a new machine, or after a clean install of macOS.
...
I always assumed it was a well-known app, but I’m not so sure anymore. In any case, I have used it to fix all sorts of issues over the years — just weird, inexplicable, random bugs. Two of my friends recently used OnyX to successfully fix bugs they were experiencing on macOS Big Sur, so I figured it’s worth writing a brief post about.
...
Similarly, I’ve experienced issues over the years with Spotlight returning garbage results — bizarre system files, files from git repos (random files from `.git/objects/`), or just not finding the correct files. Rebuilding the index with OnyX always resolved the issue.
