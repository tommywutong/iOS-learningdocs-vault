...
source_url: 'https://www.jessesquires.com/blog/2024/01/04/simctl-status_bar-still-broken/'
original_language: en
published: 2024-01-04
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:ab458c7d9203fc9d'
translated: false
---

> 原文：[Workaround: Xcode simctl status_bar is still broken for iOS 17 simulators](https://www.jessesquires.com/blog/2024/01/04/simctl-status_bar-still-broken/)　·　Jesse Squires

While working on updating iOS screenshots for the App Store recently, I discovered that `simctl status_bar` is [**still broken**](https://www.jessesquires.com/blog/2022/12/14/simctrl-status_bar-broken/). And unfortunately, I do not expect it to be fixed any time soon.
...
I’ve written before about [automating perfect status bar overrides](https://www.jessesquires.com/blog/2020/04/13/fully-automating-perfect-status-bar-overrides-for-ios-simulators/) for the iOS simulator using my utility, [Nine41](https://github.com/jessesquires/Nine41). The current bug in `simctl status_bar` not only prevents Nine41 from working, but also breaks every third-party tool like [fastlane](https://fastlane.tools), [SimGenie](https://simgenie.app), etc. that offer a status bar override feature — because those all use `simctl status_bar` under-the-hood.

#### * * *

[Previously](https://www.jessesquires.com/blog/2022/12/14/simctrl-status_bar-broken/), I realized you could still use the iOS 16.0 simulators and earlier. However, if your app is targeting iOS 17 and above — my current situation since dropping iOS 16 — then this workaround will no longer suffice because your app no longer runs on iOS 16.
