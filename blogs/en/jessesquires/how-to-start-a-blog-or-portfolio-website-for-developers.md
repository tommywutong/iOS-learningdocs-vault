...
source_url: 'https://www.jessesquires.com/blog/2021/11/01/how-to-start-a-blog/'
original_language: en
published: 2021-11-01
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:49a73bd54edd67ae'
translated: false
---

> 原文：[How to start a blog or portfolio website, for developers](https://www.jessesquires.com/blog/2021/11/01/how-to-start-a-blog/)　·　Jesse Squires
...
What I highly recommend to folks is using [GitHub Pages](https://pages.github.com) to get started. It’s a great place to experiment, get started quickly, and build a great-looking site. Maintenance is also near zero if hosting on GitHub. And — it’s free.
...
I occasionally write about [Bootstrap](https://www.jessesquires.com/blog/tags/bootstrap/) and [Jekyll](https://www.jessesquires.com/blog/tags/nearlyfreespeech/) on this blog. You may find those posts interesting as you advance.

This entire website [is open source](https://github.com/jessesquires/jessesquires.com) if you need examples or want to see how all the pieces fit together. My only request is that you don’t reproduce an exact (or near-exact) copy of my site. The intent is to learn from it, not to duplicate it.
...
[daiyi (chris)](https://twitter.com/daiyitastic) just published an interesting article, [_How to automate previews for Github Pages_](https://daiyi.co/blog/pr-previews-for-github-pages/). It’s a pretty neat hack to get previews for website changes without having to run Jekyll locally or publish first. If you are going all-in on a GitHub pages site, this might be of interest to you.
