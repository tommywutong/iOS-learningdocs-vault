...
source_url: 'https://www.jessesquires.com/blog/2023/04/04/exploring-a-new-ios-codebase/'
original_language: en
published: 2023-04-04
status: active
license: © 2014–2026 Jesse Squires → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:29a181623c3ce7ee'
translated: false
---

> 原文：[Exploring a new iOS codebase](https://www.jessesquires.com/blog/2023/04/04/exploring-a-new-ios-codebase/)　·　Jesse Squires
...
Each time a new view appears, you’ll see the name of the corresponding view controller class name! Then you can simply search Xcode for that view controller class and find where you need to make edits. If you are still stuck, don’t worry. You can ask your team for help, but this time you’ll already know roughly _where_ you need to make changes. Also, I recommend that you [share this breakpoint](https://www.jessesquires.com/blog/2023/02/21/xcode-tip-sharing-breakpoints/) to reuse it in other projects.
