...
- **Mach ports:** The fundamental IPC mechanism in mach. Fast, light-weight, extremely capable, and difficult to use. Mach ports will not only let you talk to other processes, but do things as drastic as [inject code into other people's programs](http://rentzsch.com/mach_inject/). The poor state of the [mach documentation](http://web.mit.edu/darwin/src/modules/xnu/osfmk/man/) makes it hard to get started and easy to [make](http://www.rogueamoeba.com/utm/2008/12/12/an-raoperationqueue-fix/)[mistakes](http://www.rogueamoeba.com/utm/2009/01/10/raoperationqueue-102/) with it. On the other hand, the core `mach_msg` function is probably the most optimized syscall in the system, so they're really fast to use, and your machine will barely blink if you decide to allocate million mach ports at once.
...
[Comments RSS feed for this page](https://www.mikeash.com/commentsrss.py?page=pyblog/friday-qa-2009-01-16.html)
