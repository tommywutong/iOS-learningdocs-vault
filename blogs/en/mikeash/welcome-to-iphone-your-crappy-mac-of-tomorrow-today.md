---
title: 'Welcome to iPhone: Your Crappy Mac of Tomorrow, Today!'
source: 'mikeash.com Friday Q&A'
source_key: mikeash
source_url: 'https://www.mikeash.com/pyblog/welcome-to-iphone-your-crappy-mac-of-tomorrow-today.html'
original_language: en
published: ''
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:6630e050e95c255f'
translated: false
---

> 原文：[Welcome to iPhone: Your Crappy Mac of Tomorrow, Today!](https://www.mikeash.com/pyblog/welcome-to-iphone-your-crappy-mac-of-tomorrow-today.html)　·　mikeash.com Friday Q&A

Posted at 2008-08-01 17:23 | [RSS feed](https://www.mikeash.com/pyblog/rss.py) ([Full text feed](https://www.mikeash.com/pyblog/rss.py?mode=fulltext)) | [Blog Index](https://www.mikeash.com/pyblog/)  
Next article: [Late Night Cocoa](https://www.mikeash.com/pyblog/late-night-cocoa.html)  
Previous article: [WWDC 08 Followup](https://www.mikeash.com/pyblog/wwdc--followup.html)  
...
Suddenly I notice my App Store icon has a badge. I have some updates! Ah, maybe an AIM update will make it suck less. A Twinkle update too. And a few others, no doubt all good. I click update. Enter my password. Again. For a bunch of _free_ updates. They begin to download and install. Ah yes, this takes a while. To pass the time, I'll go read the latest updates on Twinkle.

Hmm, my Twinkle icon is gone. Oh, it's moved to the next page. Oh, I can't run it, because it's downloading and installing. Crap. I'll just stare at the progress bar until it's done. Waiting... it's done! It's _still_ on the next page! Now let's pass the time by manually moving AIM, Twinkle, and the three other apps that got updated _back to where they started_.

Oh yeah, and not only did they all forget where I had placed their icons, but half of them [just forgot everything they knew about me](http://www.appletell.com/apple/comment/data-loss-from-app-store-updates/).
...
Wait, I have the perfect solution. Let's just write our own browser, and music player, and Twitter client, and chat client, and mail client, and app updater, _all in the same application_. And then we can stick a launcher front-end on it. And then, since it's all the same application, we can multitask and switch and run in the background as much as we want. After all, who needs an operating system with process management. [AppleWorks](http://modena.intergate.ca/personal/gslj/appleworks.html) showed us just how well the highly integrated application can work. Single-tasking is how it was done on the Apple II, it was how it was done on the original Mac, and by god, it's good enough for the iPhone.

Well, unless you're Apple, of course. After all, you wouldn't want "Music" to quit just because you launched Safari. Never mind that the third-party music players that I _actually want to listen to_ can't do it.

Reprisal

After spending a month or so really using this thing, I feel like I've gone back to the dark ages. This is GS/OS 4.0. Mac System 1. But unlike those, Apple isn't letting us developers patch over their holes. There will be no [MultiGS](http://modena.intergate.ca/personal/gslj/iigsfreeware.html), no [Switcher](http://www.folklore.org/StoryView.py?project=Macintosh&story=Switcher.txt). No plugins, no launchers, no daemons, no services, no _improvements_.

Unless Apple makes them, of course.

But do you think they will?

I'm going to keep using this thing. Despite all the flaws, it's still a useful device to have, especially when I didn't have to pay for it myself. But right now, I'm only getting maybe 10% of the hardware's potential, and this is _all Apple's fault_.
...
First, some miscellaneous things like Apple's long time pointless usage of the `ptrace()` call in an attempt to protect iTunes, DVD Player, and any other program that uses Apple's DVDPlayback.framework from being debugged. There are also [encrypted binaries](http://www.osxbook.com/book/bonus/chapter7/binaryprotection/) which showed up in 10.4 as part of the Intel switch.
