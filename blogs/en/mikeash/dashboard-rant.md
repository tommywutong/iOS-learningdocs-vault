...
It's a problem for developers because they have to actually,

these unique interfaces if they want to fit in with Dashboard. (Apple explicitly discourages using standard Aqua widgets; you're not even supposed to use a standard HMTL submit button, but rather create your own graphical submit button.) So every time you want a button, a scroll bar, a slider, a radio button, a checkbox... you have to make your own graphics and write a bunch of support code behind it.
...
Dude, if you want IB, build a Cocoa app!!! Dashboard is

for you! It’s for the rest of us!
...
http://4haks.blogspot.com/2005/06/overco..
...
http://developer.apple.com/technotes/tn2..
