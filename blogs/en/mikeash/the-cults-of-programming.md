---
title: The Cults of Programming
source: 'mikeash.com Friday Q&A'
source_key: mikeash
source_url: 'https://www.mikeash.com/pyblog/the-cults-of-programming.html'
original_language: en
published: ''
status: frozen
license: 未声明 → 仅私有归档
archived_at: 2026-07-27
content_hash: 'sha256:0b24b6f69b5f4dc3'
translated: false
---

> 原文：[The Cults of Programming](https://www.mikeash.com/pyblog/the-cults-of-programming.html)　·　mikeash.com Friday Q&A

Posted at 2007-12-31 05:51 | [RSS feed](https://www.mikeash.com/pyblog/rss.py) ([Full text feed](https://www.mikeash.com/pyblog/rss.py?mode=fulltext)) | [Blog Index](https://www.mikeash.com/pyblog/)  
Next article: [Performance Comparisons of Common Operations, Leopard Edition](https://www.mikeash.com/pyblog/performance-comparisons-of-common-operations-leopard-edition.html)  
Previous article: [Leopard: First Impressions](https://www.mikeash.com/pyblog/leopard-first-impressions.html)  
Tags: [humor](https://www.mikeash.com/pyblog/?tag=humor) [programming](https://www.mikeash.com/pyblog/?tag=programming) [rant](https://www.mikeash.com/pyblog/?tag=rant)
...
_Prognosis: may be led toward greater independence if shown that doing new things is actually possible._

**Optimization Cult**   
Members of the Optimization Cult value fast code over all other virtues. They are often found asking questions of the form, "What's the fastest way to...?" They are horrified when presented with any suggestion which doesn't fit with their view of what is fast, but also have a hilariously wrong view of just [which operations are fast](https://www.mikeash.com/pyblog/autorelease-is-fast.html) and [which aren't](https://www.mikeash.com/pyblog/performance-comparisons-of-common-operations.html).   
_Prognosis: may eventually become productive with education on the actual capabilities of modern hardware, the true speeds of various operations, and the need to properly optimize programmer time._
...
_Prognosis: if persistent enough, may outgrow these tendencies after finishing a reasonably sized project._
...
_Prognosis: may be rehabilitated with frequent examples of the utility of experimentation, research, and tools, but often hopeless._
...
_Prognosis: when starved of information, may realize that it's possible to begin a trip without knowing the location of every footfall in advance._
