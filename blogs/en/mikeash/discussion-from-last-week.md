---
title: discussion from last week
source: 'mikeash.com Friday Q&A'
source_key: mikeash
source_url: 'http://www.mikeash.com/pyblog/friday-qa-2010-02-26-futures.html'
...
> 原文：[discussion from last week](http://www.mikeash.com/pyblog/friday-qa-2010-02-26-futures.html)　·　mikeash.com Friday Q&A

Posted at 2010-02-26 18:19 | [RSS feed](http://www.mikeash.com/pyblog/rss.py) ([Full text feed](http://www.mikeash.com/pyblog/rss.py?mode=fulltext)) | [Blog Index](http://www.mikeash.com/pyblog/)  
Next article: [Friday Q&A 2010-03-05: Compound Futures](http://www.mikeash.com/pyblog/friday-qa-2010-03-05-compound-futures.html)  
Previous article: [Friday Q&A 2010-02-19: Character Encodings](http://www.mikeash.com/pyblog/friday-qa-2010-02-19-character-encodings.html)  
Tags: [blocks](http://www.mikeash.com/pyblog/?tag=blocks) [fridayqna](http://www.mikeash.com/pyblog/?tag=fridayqna) [futures](http://www.mikeash.com/pyblog/?tag=futures)
...
In Objective-C, it's natural to represent the calculation using a block. Futures are created by simply calling a function which takes a block representing the calculation. They return a [proxy object](http://www.mikeash.com/pyblog/friday-qa-2009-03-27-objective-c-message-forwarding.html) which captures messages sent to that object and resolves the future as needed. My code has two kinds of futures.
...
Instead, I chose a third route: implement my own proxy class. `MAProxy` is a true minimalistic proxy class. It implements memory management methods and `-isProxy`. It also implements `+initialize`, which the runtime requires to exist in every class. The [header](http://www.mikeash.com/svn/MAFuture/MAProxy.h) is really basic and the [implementation](http://www.mikeash.com/svn/MAFuture/MAProxy.m) nearly as simple. The only tricky stuff at work is the inline reference count using atomic functions for thread safety.
