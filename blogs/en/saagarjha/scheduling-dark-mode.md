...
source_url: 'https://saagarjha.com/blog/2018/12/01/scheduling-dark-mode/'
original_language: en
published: 2018-12-01
status: active
license: CC BY-SA 4.0 → 可再分发，但译文必须同样 BY-SA 并署名
archived_at: 2026-07-27
content_hash: 'sha256:94aeec4cf37c7aa5'
translated: false
---

> 原文：[Scheduling Dark Mode](https://saagarjha.com/blog/2018/12/01/scheduling-dark-mode/)　·　Saagar Jha
...
![The "General" preference pane in macOS Mojave, showing the appearance settings](https://saagarjha.com/blog/2018/12/01/scheduling-dark-mode/AppearanceSettings.png)

Since System Preferences needs to do the same thing that _we_ want to do, we might be able to take a look at what it is doing and replicate it ourselves. A bit of digging shows that we want to look at `/System/Library/PreferencePanes/Appearance.prefPane/`, which provides the implementation for the “General” preference pane. Let’s load the binary into Hopper and search for “theme”:

![Hopper disassembly of the Appearance preference pane focused on -[AppearanceShared setTheme:]](https://saagarjha.com/blog/2018/12/01/scheduling-dark-mode/HopperAppearance.png)
