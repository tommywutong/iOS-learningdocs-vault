...
source_url: 'https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/'
...
> 原文：[Debugging Python Operator Precedence With MacsBug](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/)　·　Saagar Jha
...
![The resources contained in the HyperCard stack, including some BITs, STR#, PICT, and XCMD resources, one of which is watnesssolver](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/HyperCardPreviewResources.png)
...
![The WatnessSolver XKMD loaded into Ghidra, showing automatic code detection and function recovery](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/GhidraWatnessSolver.png)

## Reversing

With CTF challenges, we’ve often had to cobble together toolchains to work with strange, obscure, or old platforms, so getting something that would run the stack was not too challenging: we already knew about [SheepShaver](http://sheepshaver.cebix.net), and a quick search [gave us](https://jamesfriend.com.au/running-hypercard-stack-2014) a prebuilt “sheepvm” that we could download and run immediately. By this time Michele had drifted off to bed (this was a 48 hour CTF, after all, and it was past 2 AM in Italy) but the promise of a challenge based on _The Witness_ was enough to lure in Eric–in addition to his excellent blob reversing skills, he was one of the few team members who had actually played the game. He instantly recognized the screenshot I sent him from SheepShaver:

![Screenshot of The Watness 2 HyperCard stack running in SheepShaver, showing a striking similarity to the setting of The Witness](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/SheepShaverTheWitness.png)
...
![Mac OS setup screen in QEMU, on the "Tell me more about the internet" screen](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/QEMUMacOSSetup.png)

With a bit of fiddling around I got MacsBug installed:

![Mac OS boot screen in QEMU, showing that the debugger has been installed](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/QEMUDebuggerInstalled.png)
...
![MacsBug in QEMU, with a breakpoint set on `ENTRYPOINT` and the instruction listing confirming that the code matches our XCMD](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/QEMUMacsBug.png)
...
![HyperCard running on QEMU showing the flag for The Watness 2](https://saagarjha.com/blog/2020/04/22/debugging-python-operator-precedence-with-macsbug/QEMUFlag.png)
